...
export const LINKS_GAPS: Record<string, string[]> = {
  ...
  "pyqtw-0450": ["surgery-office-spinal-anaesthesia"],

  // Ketamine.
  "pyqtw-0453": ["surgery-office-procedural-sedation-ketamine"],

  // Tracheostomy.
  "pyqtw-0417": ["surgery-office-tracheostomy"],
  ...
  "pyqtw-0644": ["infectious-fever-hiv-art"],
  ...
  "pyqtw-0587": ["pediatrics-congenital-heart-disease"],

  // Absence seizures in a 5-year-old.
  "pyqtw-0588": ["neurology-seizures-epilepsy"],

  // Nocturnal enuresis.
  "pyqtw-0653": ["pediatrics-nocturnal-enuresis"],

  // Oral thrush.
  "pyqtw-0654": ["pediatrics-oral-thrush"],

  // Uterine prolapse and the ligaments of the female pelvis.
  "pyqtw-0790": ["gynaecology-uterine-prolapse"],
  ...
  "pyqtw-0701": ["preventive-disaster-management"],
  "pyqtw-0703": ["preventive-disaster-management"],
  "pyqtw-0704": ["preventive-disaster-management"],

  // Climate change and the determinants of health.
  "pyqtw-0705": ["preventive-climate-change-health"],

  // Health communication: IEC, social marketing and social mobilisation.
  "pyqtw-0740": ["preventive-iec-social-marketing"],
  "pyqtw-0752": ["preventive-iec-social-marketing"],
  "pyqtw-0753": ["preventive-iec-social-marketing"],
  "pyqtw-0754": ["preventive-iec-social-marketing"],

  // Health planning and management: SWOT analysis, the planning cycle and
  // network analysis.
  "pyqtw-0750": ["preventive-health-planning-management"],
  "pyqtw-0784": ["preventive-health-planning-management"],

  // Geographic information systems in public health.
  "pyqtw-0737": ["preventive-health-information-gis"],

  // The declining child sex ratio and the PCPNDT Act.
  "pyqtw-0729": ["preventive-sex-ratio-pcpndt"],

  // Legislation for children and women: the Juvenile Justice Act and the
  // National Policy for the Empowerment of Women, 2001.
  "pyqtw-0648": ["preventive-child-women-legislation"],
  "pyqtw-0557": ["preventive-child-women-legislation"],
