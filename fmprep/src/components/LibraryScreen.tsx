              ...
              return (
                ...
                >
                  <span className="flex items-baseline justify-between gap-2">
                    <span className="text-[17px] font-bold text-slate-900">{subject?.title ?? meta.title}</span>
                    <Chip tone="blue">Paper {meta.papers.join(", ")}</Chip>
                  </span>
                  <span className="mt-1.5 block text-[13.5px] leading-[1.55] text-slate-600">{meta.blurb}</span>
                  {subject ? (
                    <>
                    ...
                    <span className="mt-2 block text-[13px] text-slate-400">Opens on first tap</span>
                  )}
                </button>
              );
            })}
