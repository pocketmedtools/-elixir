  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**At a facility with no caesarean capacity, crossing the alert line is the signal to refer** - the four-hour gap to the action line is the travelling time. [MoHFW SBA]",
