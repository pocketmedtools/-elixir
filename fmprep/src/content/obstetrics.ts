  ...
  tables: [
    {
      ...
      columns: ["Contact", "Government of India (4 visits)", "WHO 2016 (8 contacts)", "Key action", "Why this window"],
      rows: [
        ["1", "Within 12 weeks", "Up to 12 weeks", "Registration, MCP card, full investigation panel, dating scan, Td-1", "Dating and first-trimester screening are only valid this early"],
        ["2", "14-26 weeks", "20 and 26 weeks", "Anomaly scan at 18-20 weeks, IFA and calcium, albendazole, Td-2", "Carries the anomaly scan and the first anaemia recheck"],
        ["3", "28-34 weeks", "30 weeks", "Repeat haemoglobin and blood sugar, anti-D at 28 weeks if Rh negative", "Pre-eclampsia, growth restriction and anaemia declare themselves"],
        ["4", "36 weeks to term", "34, 36, 38 and 40 weeks", "Presentation and lie, birth plan, danger signs, place of delivery", "Fixes presentation and the place of delivery"],
      ],
    },
    {
    ...
    {
      heading: "The four aims of antenatal care [MoHFW ANC 2010]",
      columns: ["Aim", "What it means", "Why it matters"],
      rows: [
        ["1. Confirm and date", "Dating drives every later decision", "Screening windows and induction all depend on it"],
        ["2. Screen and treat", "Anaemia, hypertensive disorders, diabetes, infection", "These are the conditions that kill"],
        ["3. Immunise and supplement", "Td, iron-folic acid and calcium", "Prevent tetanus, anaemia and pre-eclampsia"],
        ["4. Prepare and stratify", "Institutional delivery, high risk found early", "Referral must happen before the emergency"],
      ],
    },
    {
      heading: "National maternity schemes and what each covers",
      columns: ["Scheme", "Year", "What it provides", "Why it matters"],
      rows: [
        ["Janani Suraksha Yojana (JSY)", "2005", "Cash incentive for institutional delivery, paid to the woman and the ASHA", "Transport cost stops deciding the place of birth"],
        ["Janani Shishu Suraksha Karyakram (JSSK)", "2011", "Free delivery, drugs, diagnostics, diet, blood and transport", "Cost never delays arrival"],
        ["JSSK, newborn component", "2011", "The same free package for the sick newborn", "A family that can pay for delivery often cannot pay for neonatal care"],
        ["Pradhan Mantri Matru Vandana Yojana (PMMVY)", "2017", "Maternity cash benefit for the first live birth", "Part-compensates wage loss around delivery"],
      ],
    },
    {
      heading: "What is recorded at every antenatal visit [MoHFW ANC 2010]",
      columns: ["Item", "From when", "What it is for"],
      rows: [
        ["Weight, blood pressure, pallor, oedema", "Every visit", "Blood pressure has no meaning without the earlier readings"],
        ["Urine albumin and sugar", "Every visit", "New proteinuria with a raised BP is pre-eclampsia until disproved"],
        ["Symphysio-fundal height, fetal heart rate", "FHR after 20 weeks", "The serial curve detects growth restriction"],
        ["Fetal lie and presentation", "After 32 weeks", "Malpresentation found in labour is too late for version"],
        ["Danger-sign counselling", "Every visit", "What is said once at booking is not remembered at 36 weeks"],
        ["Birth preparedness", "From the third visit", "Place of delivery, the person who will accompany, transport"],
        ["Birth plan details", "From the third visit", "102/108 ambulance number, money, blood group, two donors; PPH kills in hours"],
      ],
    },
    {
      heading: "Dating: when the scan overrides the LMP [Williams 26e]",
      columns: ["Gestation at scan", "Scan wins if apart by", "Why"],
      rows: [
        ["Before 14 weeks", "More than 7 days", "Crown-rump length is accurate to about 5 days"],
        ["14 to 22 weeks", "More than 10 days", "Biometric scatter widens, so the tolerance widens"],
        ["After 22 weeks", "More than 14 days", "Late biometry measures size, not age, so it rarely wins"],
      ],
    },
    {
      heading: "High-risk markers to flag on the MCP card [PMSMA 2016]",
      columns: ["Group", "Markers", "Why it is marked"],
      rows: [
        ["Age and build", "Age under 18 or over 35; height under 145 cm", "Extremes of age and short stature predict obstructed labour"],
        ["Obstetric", "Severe anaemia, previous caesarean, malpresentation at term, multiple pregnancy", "Each predicts haemorrhage or operative delivery"],
        ["Medical and past history", "Hypertensive disorder, diabetes, heart disease, previous stillbirth, grand multiparity", "Each needs a planned delivery"],
      ],
    },
  ],
  redFlags: [
