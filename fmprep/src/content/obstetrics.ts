  ...
  sections: [
    {
      ...
      points: [
        "Aim 1: confirm and date the pregnancy - dating drives every later decision, from screening windows to induction. [MoHFW ANC Guidelines]",
        "Aim 2: screen and treat the conditions that kill - **anaemia, hypertensive disorders, diabetes, infection**. [MoHFW ANC Guidelines]",
        "Aim 3: immunise against tetanus and supplement iron-folic acid and calcium. [MoHFW ANC Guidelines]",
        "Aim 4: prepare for institutional delivery and identify the high-risk woman early enough to refer her in time. [MoHFW ANC Guidelines]",
        "**Register every pregnancy within 12 weeks** of the last menstrual period. [MoHFW ANC Guidelines]",
        "Dating, first-trimester screening, anaemia correction and the MTP window all depend on registration before 12 weeks.",
        "The **Mother and Child Protection (MCP) Card** is the clinical and legal record, and is held by the woman. [MoHFW ANC Guidelines]",
        "MCP card carries identification, obstetric history, every weight and blood pressure, all investigations, the birth plan and the immunisation schedule.",
        "Write in the MCP card at **every visit** - it is the only record that travels with the woman to the referral facility.",
        "India's maternal mortality ratio is **97 per 100,000 live births**. [SRS 2018-20]",
        "SDG target for maternal mortality ratio is **70 per 100,000 by 2030**. [SDG 3.1]",
        "The fall in maternal mortality is attributed to institutional delivery, skilled birth attendance and anaemia control - not to any new technology.",
        "**Janani Suraksha Yojana (JSY):** cash incentive for institutional delivery. [MoHFW]",
        "**Janani Shishu Suraksha Karyakram (JSSK):** free delivery, drugs, diagnostics, diet, blood and transport for mother and sick newborn. [MoHFW]",
        "**Pradhan Mantri Matru Vandana Yojana (PMMVY):** maternity cash benefit for the first live birth. [MoHFW]",
        "The family physician's specific value is continuity - preconception, pregnancy, delivery or referral, postnatal period and contraception.",
        "Preconception folic acid, drug review and chronic disease optimisation are the family physician's responsibility, not the obstetrician's.",
      ],
    },
    {
      heading: "The visit schedule: Indian minimum and the WHO model",
      points: [
        "**Government of India minimum: four antenatal visits.** [MoHFW ANC Guidelines]",
        "Visit 1: within **12 weeks**, at registration. [MoHFW ANC Guidelines]",
        "Visit 2: between **14 and 26 weeks**. [MoHFW ANC Guidelines]",
        "Visit 3: between **28 and 34 weeks**. [MoHFW ANC Guidelines]",
        "Visit 4: between **36 weeks and term**. [MoHFW ANC Guidelines]",
        "WHO recommends **eight antenatal contacts**, not four - eight reduce perinatal mortality. [WHO ANC 2016]",
        "WHO contacts: one in the first trimester, two in the second (**20 and 26 weeks**), five in the third (**30, 34, 36, 38, 40 weeks**). [WHO ANC 2016]",
        "India has adopted the eight-contact model in principle while the programme indicator remains four visits. [MoHFW ANC Guidelines]",
        "**PMSMA runs on the 9th of every month** - a free, assured, quality antenatal check-up. [PMSMA 2016]",
        "PMSMA covers every woman in her **second or third trimester**, seen by an obstetrician or trained medical officer at a designated facility. [PMSMA 2016]",
        "PMSMA's stated purpose is detecting and colour-coding high-risk pregnancy, not routine care. [PMSMA 2016]",
        "**e-PMSMA adds named follow-up** of the woman identified as high risk. [e-PMSMA 2022]",
        "The high-risk woman gets a **red sticker** on her MCP card and is tracked by name through the ANMOL/RCH portal. [e-PMSMA 2022]",
        "An incentive is paid for completing **four high-risk antenatal visits**. [e-PMSMA 2022]",
        "Every visit records weight, blood pressure, pallor and oedema. [MoHFW ANC Guidelines]",
        "Every visit tests urine for **albumin and sugar**. [MoHFW ANC Guidelines]",
        "Every visit measures symphysio-fundal height, and the fetal heart rate **after 20 weeks**. [MoHFW ANC Guidelines]",
        "Record fetal lie and presentation at every visit **after 32 weeks**. [MoHFW ANC Guidelines]",
        "Repeat danger-sign counselling at every visit, without exception. [MoHFW ANC Guidelines]",
        "**Birth preparedness is discussed from the third visit** - place of delivery, the person who will accompany, and transport. [MoHFW ANC Guidelines]",
        "Birth plan records the **102/108 ambulance number**, money set aside, the blood group and **two potential donors**. [MoHFW ANC Guidelines]",
      ],
    },
    {
      heading: "Dating the pregnancy and the first-visit history",
      points: [
        "**Naegele's rule:** expected date of delivery = first day of the last menstrual period **+ 9 months + 7 days**. [Williams 26e]",
        "Naegele's rule is valid only for a certain LMP with regular **28-day** cycles. [Williams 26e]",
        "Add or subtract the difference from 28 days when cycles are longer or shorter. [Williams 26e]",
        "**First-trimester crown-rump length is the most accurate dating tool.** [Williams 26e]",
        "Before **14 weeks**, the scan overrides the LMP if they differ by more than **7 days**. [Williams 26e]",
        "Between **14 and 22 weeks**, the scan overrides the LMP if they differ by more than **10 days**. [Williams 26e]",
        "After **22 weeks**, the scan overrides the LMP if they differ by more than **14 days**. [Williams 26e]",
        "Booking history: age, parity and the obstetric formula - **gravida, para, living, abortions**. [MoHFW ANC Guidelines]",
        "Ask the interpregnancy interval and any previous caesarean or instrumental delivery. [MoHFW ANC Guidelines]",
        "Ask previous stillbirth or neonatal death, previous pre-eclampsia, gestational diabetes or postpartum haemorrhage - all recur. [FOGSI ANC 2019]",
        "Medical history that changes the plan: hypertension, diabetes, heart disease, thyroid disease, epilepsy. [FOGSI ANC 2019]",
        "Also ask tuberculosis, asthma, chronic kidney disease, sickle cell disease and thalassaemia trait. [FOGSI ANC 2019]",
        "Record **every drug**, including ayurvedic and over-the-counter preparations. [FOGSI ANC 2019]",
        "Actively ask about **consanguinity, family history of thalassaemia and a previous baby with a congenital anomaly**. [FOGSI ANC 2019]",
        "Carrier screening for beta-thalassaemia and haemoglobinopathies is recommended at booking in high-prevalence communities. [FOGSI ANC 2019]",
        "Ask about tobacco in every form, alcohol, domestic violence and mental health at booking and again in the third trimester. [WHO ANC 2016]",
        "**Never ask about domestic violence with a family member present** - disclosure falls to near zero. [WHO ANC 2016]",
      ],
    },
    {
      heading: "Investigations and what each one changes",
      points: [
        "At registration: haemoglobin, blood group with Rh typing, urine routine and microscopy. [MoHFW ANC Guidelines]",
        "At registration: blood sugar by the **DIPSI 75 g test**, HIV, VDRL/RPR and HBsAg. [MoHFW ANC Guidelines]",
        "At registration: a dating ultrasound, plus malaria and thalassaemia screening where prevalent. [MoHFW ANC Guidelines]",
        "Repeat haemoglobin at each of the four visits, and always at **28-30 weeks and at 36 weeks**. [AMB 2018]",
        "**The third trimester is when anaemia decompensates** - plasma volume peaks and cardiac reserve is least. [AMB 2018]",
        "**Rh-negative women** need an indirect Coombs test at booking and again at **28 weeks**. [Williams 26e]",
        "Check the husband's blood group in every Rh-negative woman. [Williams 26e]",
        "**Anti-D 300 microgram IM at 28 weeks**, and again **within 72 hours** of delivery of an Rh-positive baby. [Williams 26e]",
        "**Every ultrasound requires a signed Form F** under the PCPNDT Act. [PCPNDT Act 1994]",
        "The machine and centre must be registered, with a conspicuous notice that sex determination is a punishable offence. [PCPNDT Act 1994]",
        "Scan 1: dating scan at **6-11 weeks**. [MoHFW ANC Guidelines]",
        "Scan 2: nuchal translucency with the dual marker at **11-13+6 weeks**. [FOGSI ANC 2019]",
        "Scan 3: anomaly scan at **18-20 weeks**. [FOGSI ANC 2019]",
        "Growth scan at **32-36 weeks** where indicated. [FOGSI ANC 2019]",
        "**HIV testing in pregnancy is opt-out** under the National AIDS Control Programme. [NACO]",
        "A reactive HIV test triggers **immediate lifelong antiretroviral therapy** for the mother. [NACO]",
        "Maternal antiretroviral therapy cuts vertical transmission from about **30% to under 2%**. [NACO]",
        "**Syphilis screening with VDRL is mandatory** in pregnancy. [MoHFW ANC Guidelines]",
        "Reactive VDRL: **benzathine penicillin 2.4 million units IM as a single dose**. [NACO]",
        "Late latent syphilis needs **three weekly doses** of benzathine penicillin 2.4 million units IM. [NACO]",
        "Untreated maternal syphilis causes stillbirth, prematurity and congenital syphilis. [WHO ANC 2016]",
      ],
    },
    {
      heading: "Supplementation, immunisation and routine prescriptions",
      points: [
        "**One red IFA tablet = 60 mg elemental iron plus 500 microgram folic acid.** [AMB 2018]",
        "Give IFA once daily from the **second trimester** in every non-anaemic pregnant woman. [AMB 2018]",
        "IFA runs for **180 days antenatally and 180 days postpartum**. [AMB 2018]",
        "**Folic acid 400 microgram daily** is started preconceptionally and continued through the first trimester. [WHO ANC 2016]",
        "Folic acid dose is **5 mg daily** after a previous neural tube defect or on antiepileptics. [FOGSI ANC 2019]",
        "Folic acid 5 mg daily also applies in diabetes, obesity or a haemoglobinopathy. [FOGSI ANC 2019]",
        "**Calcium 500 mg twice daily (1 g elemental calcium per day) with vitamin D from 14 weeks.** [WHO ANC 2016]",
        "Calcium runs **six months antenatally and six months postpartum** - it reduces pre-eclampsia and protects maternal bone. [WHO ANC 2016]",
        "**Take calcium and IFA at different times of day** - calcium blocks iron absorption. [AMB 2018]",
        "**Albendazole 400 mg as a single dose after the first trimester**, usually in the second, in hookworm-endemic areas. [AMB 2018]",
        "Albendazole is part of the Anemia Mukt Bharat package. [AMB 2018]",
        "**Td: two doses 4 weeks apart**, the first as early as possible in pregnancy. [MoHFW ANC Guidelines]",
        "Td has replaced the older TT schedule. [MoHFW ANC Guidelines]",
        "A **single Td booster** suffices if the woman had two doses within the preceding **3 years**. [MoHFW ANC Guidelines]",
        "**Low-dose aspirin 75-150 mg at night from 12-16 weeks until 36 weeks** in women at high risk of pre-eclampsia. [FOGSI ANC 2019]",
        "Aspirin is the single most effective preventive prescription in antenatal care.",
      ],
    },
    {
      heading: "Danger signs, high-risk marking and referral",
      points: [
        "**Danger signs the woman must repeat back:** bleeding per vaginum, and severe headache with blurred vision. [MoHFW ANC Guidelines]",
        "Danger signs: **convulsions or loss of consciousness**, and fever with or without foul discharge. [MoHFW ANC Guidelines]",
        "Danger signs: severe abdominal pain, leaking of fluid, and **reduced or absent fetal movements**. [MoHFW ANC Guidelines]",
        "Danger signs: breathlessness at rest, and swelling of the face and hands. [MoHFW ANC Guidelines]",
        "**Reduced fetal movement is the commonest late danger sign to be dismissed.** [FOGSI ANC 2019]",
        "Teach the daily fetal movement count from **28 weeks** - the Cardiff count-to-ten method. [FOGSI ANC 2019]",
        "**Fewer than ten movements in twelve hours** is an indication for same-day assessment. [FOGSI ANC 2019]",
        "Mark high risk on the MCP card: age **under 18 or over 35**, height **under 145 cm**. [PMSMA 2016]",
        "Mark high risk: severe anaemia, previous caesarean, malpresentation at term, multiple pregnancy. [PMSMA 2016]",
        "Mark high risk: hypertensive disorder, diabetes, heart disease, previous stillbirth, grand multiparity. [PMSMA 2016]",
        "High-risk women are referred to deliver at a facility with **blood and an operating theatre**. [PMSMA 2016]",
        "**Symphysio-fundal height in cm equals gestational age in weeks, plus or minus 2 cm, between 24 and 36 weeks.** [Williams 26e]",
        "A lag of **more than 3 cm** means growth restriction, oligohydramnios or wrong dates until ultrasound says otherwise. [Williams 26e]",
        "Nutrition: an extra **350 kcal and 23 g of protein a day** in the second and third trimesters.",
        "Advise rest and avoidance of heavy work in late pregnancy. [MoHFW ANC Guidelines]",
        "**No radiological, dental or minor surgical procedure need be denied to a pregnant woman if it is genuinely indicated.**",
        "Every referral must be **written**, stating the reason and the findings. [MoHFW ANC Guidelines]",
        "Refer to a **named facility** and send the MCP card with the woman. [MoHFW ANC Guidelines]",
        "**An oral referral is the commonest reason a woman never arrives.**",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Register **within 12 weeks** of the last menstrual period. [MoHFW ANC Guidelines]",
            "Issue the **Mother and Child Protection Card** - the woman-held clinical and legal record. [MoHFW ANC Guidelines]",
            "Confirm the pregnancy and calculate the expected date of delivery by **Naegele's rule: LMP + 9 months + 7 days**. [Williams 26e]",
            "Confirm dating by **crown-rump length** on a first-trimester scan. [Williams 26e]",
            "Take a full obstetric, medical, surgical, drug and family history. [MoHFW ANC Guidelines]",
            "Social history must include **consanguinity, tobacco and alcohol use, domestic violence and mental health**. [WHO ANC 2016]",
            "Examine height, weight and body mass index, and record pallor, pulse and blood pressure. [MoHFW ANC Guidelines]",
            "Examine the thyroid, breast, cardiovascular and respiratory systems, and the abdomen. [MoHFW ANC Guidelines]",
          ],
        },
        {
          heading: "2. The visit schedule",
          points: [
            "**Government of India minimum is four antenatal visits.** [MoHFW ANC Guidelines]",
            "Four-visit timing: within **12 weeks**, **14-26 weeks**, **28-34 weeks**, and **36 weeks to term**. [MoHFW ANC Guidelines]",
            "**WHO recommends eight contacts** - 12, 20, 26, 30, 34, 36, 38 and 40 weeks. [WHO ANC 2016]",
            "Eight contacts reduce perinatal mortality compared with four. [WHO ANC 2016]",
            "**PMSMA gives a free specialist antenatal check on the 9th of each month** in the second and third trimesters. [PMSMA 2016]",
            "PMSMA colour-codes risk; **e-PMSMA** adds named follow-up of the high-risk woman. [e-PMSMA 2022]",
            "At every visit: weight, blood pressure, pallor, oedema, urine albumin and sugar. [MoHFW ANC Guidelines]",
            "At every visit: symphysio-fundal height, fetal heart rate **after 20 weeks**, lie and presentation **after 32 weeks**. [MoHFW ANC Guidelines]",
          ],
        },
        {
          heading: "3. Investigations and their justification",
          points: [
            "**Haemoglobin at booking and repeated at every visit** - anaemia complicates over half of Indian pregnancies. [AMB 2018]",
            "Anaemia is a leading indirect cause of maternal death in India. [AMB 2018]",
            "**Blood group and Rh typing** - identifies the Rh-negative woman needing indirect Coombs testing and anti-D. [Williams 26e]",
            "Blood grouping also allows donors to be arranged before delivery. [MoHFW ANC Guidelines]",
            "**Urine routine and microscopy** - asymptomatic bacteriuria is treated to prevent pyelonephritis and preterm labour. [MoHFW ANC Guidelines]",
            "Urine albumin at every visit screens for pre-eclampsia. [MoHFW ANC Guidelines]",
            "**DIPSI 75 g oral glucose test at booking, repeated at 24-28 weeks.** [FOGSI ANC 2019]",
            "Gestational diabetes affects **10-15% of Indian women** - among the highest rates worldwide. [FOGSI ANC 2019]",
            "**HIV testing is opt-out**; VDRL and HBsAg are routine at booking. [NACO]",
            "HIV, syphilis and hepatitis B all have effective interventions that prevent vertical transmission. [NACO]",
            "Ultrasound: dating at **6-11 weeks**, nuchal translucency with dual marker at **11-13+6 weeks**. [FOGSI ANC 2019]",
            "Ultrasound: anomaly scan at **18-20 weeks**, growth scan at **32-36 weeks** if indicated. [FOGSI ANC 2019]",
            "**Every scan needs a signed PCPNDT Form F.** [PCPNDT Act 1994]",
          ],
        },
        {
          heading: "4. Supplementation, immunisation and advice",
          points: [
            "**Folic acid 400 microgram daily until 12 weeks.** [WHO ANC 2016]",
            "**IFA: 60 mg elemental iron with 500 microgram folic acid daily from the second trimester.** [AMB 2018]",
            "IFA continues for **180 days antenatally and 180 days postpartum**. [AMB 2018]",
            "**Calcium 500 mg twice daily from 14 weeks for six months.** [WHO ANC 2016]",
            "**Albendazole 400 mg as a single dose after the first trimester.** [AMB 2018]",
            "**Td two doses four weeks apart**, or a single booster if two doses were given within the last **three years**. [MoHFW ANC Guidelines]",
            "Nutrition: an additional **350 kcal and 23 g of protein daily**.",
            "Advise rest, avoidance of heavy work in late pregnancy, and continued normal activity otherwise. [MoHFW ANC Guidelines]",
            "Counsel the danger signs and **confirm the woman can repeat them back at every visit**. [MoHFW ANC Guidelines]",
          ],
        },
        {
          heading: "5. Identifying and acting on high risk",
          points: [
            "Mark high risk: age **under 18 or over 35**, height **under 145 cm**, primigravida or grand multipara. [PMSMA 2016]",
            "Mark high risk: severe anaemia, previous caesarean, previous stillbirth or neonatal death. [PMSMA 2016]",
            "Mark high risk: hypertensive disorder, diabetes, heart disease, multiple pregnancy. [PMSMA 2016]",
            "Mark high risk: malpresentation at term, or **Rh-negative status**. [PMSMA 2016]",
            "**Aspirin 75-150 mg at night from 12-16 weeks** where pre-eclampsia risk is high. [FOGSI ANC 2019]",
            "High-risk women get additional visits and a planned delivery at a facility with **blood and an operating theatre**. [e-PMSMA 2022]",
            "Birth plan: place of delivery, escort, transport with the **108/102** number, money set aside. [MoHFW ANC Guidelines]",
            "Birth plan records the blood group and **two identified donors**. [MoHFW ANC Guidelines]",
            "Refer in writing, to a named facility, with the MCP card, stating the reason and the findings. [MoHFW ANC Guidelines]",
            "Use the **JSY, JSSK and PMMVY** entitlements to remove the financial barrier. [MoHFW]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**PMSMA is held on the 9th of every month** at designated government health facilities. [PMSMA 2016]",
            "If the 9th is a holiday, the PMSMA session runs on the next working day. [PMSMA 2016]",
            "Care is provided by an obstetrician, a physician or a trained medical officer. [PMSMA 2016]",
            "Private-sector doctors volunteer through the **I Pledge for 9** initiative. [PMSMA 2016]",
            "PMSMA services are **free** - clinical examination, a full investigation panel, and ultrasound where available. [PMSMA 2016]",
            "PMSMA also delivers IFA and calcium, Td immunisation and counselling. [PMSMA 2016]",
            "Every woman receives a sticker on her MCP card: **green for normal, red for high risk**. [PMSMA 2016]",
          ],
        },
        {
          heading: "Extended PMSMA (e-PMSMA)",
          points: [
            "**e-PMSMA closes the gap between identification and treatment** of high-risk pregnancy. [e-PMSMA 2022]",
            "The high-risk woman is tracked **by name** through the RCH portal and the ANMOL application. [e-PMSMA 2022]",
            "The ASHA is incentivised for ensuring **four additional high-risk antenatal visits**. [e-PMSMA 2022]",
            "The ASHA incentive also requires delivery at an appropriate facility. [e-PMSMA 2022]",
            "Each high-risk pregnancy is linked to a delivery point capable of managing it. [e-PMSMA 2022]",
            "The linked plan includes a **written birth plan and blood arrangement**. [e-PMSMA 2022]",
          ],
        },
        {
          heading: "High-risk conditions specifically sought",
          points: [
            "**Severe anaemia is haemoglobin below 7 g/dL** - actively sought at PMSMA. [AMB 2018]",
            "Sought at PMSMA: hypertensive disorders of pregnancy, gestational diabetes and hypothyroidism. [PMSMA 2016]",
            "Sought at PMSMA: previous caesarean section, malpresentation and multiple pregnancy. [PMSMA 2016]",
            "Sought at PMSMA: **Rh-negative status** and a bad obstetric history. [PMSMA 2016]",
            "Sought at PMSMA: age **under 18 or over 35**, and short stature. [PMSMA 2016]",
            "Sought at PMSMA: any medical disorder - heart disease, tuberculosis, HIV or epilepsy. [PMSMA 2016]",
          ],
        },
        {
          heading: "Significance and limitations",
          points: [
            "PMSMA has substantially raised the proportion of women receiving **at least one specialist antenatal check**. [PMSMA 2016]",
            "PMSMA has improved detection of high-risk pregnancy. [PMSMA 2016]",
            "**A single monthly session cannot substitute for continuous antenatal care** - that is its main limitation.",
            "PMSMA yield depends on an obstetrician and an ultrasound actually being available at the session.",
            "For the family physician, the 9th is the day to send every second- and third-trimester woman not yet specialist-reviewed. [PMSMA 2016]",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Bleeding per vaginum **before 20 weeks**: suspect abortion or ectopic pregnancy. [Williams 26e]",
            "Bleeding per vaginum **after 20 weeks**: suspect placenta praevia or abruption. [Williams 26e]",
            "**Do not perform a vaginal examination** in antepartum haemorrhage - it can provoke torrential bleeding in praevia. [Williams 26e]",
            "Secure intravenous access and refer to a facility with **blood and an operating theatre**. [MoHFW ANC Guidelines]",
            "Severe continuous abdominal pain with a **tense tender uterus**: abruptio placentae or uterine rupture. [Williams 26e]",
            "Resuscitate and transfer immediately in suspected abruption or uterine rupture. [MoHFW ANC Guidelines]",
          ],
        },
        {
          heading: "Hypertensive and neurological",
          points: [
            "**Severe headache with blurring of vision, epigastric pain or vomiting means impending eclampsia.** [Williams 26e]",
            "In impending eclampsia, check blood pressure and urine albumin at once. [MoHFW ANC Guidelines]",
            "Give an antihypertensive and a **magnesium sulphate loading dose** before referral. [MoHFW ANC Guidelines]",
            "Convulsions or loss of consciousness in pregnancy is **eclampsia** until proved otherwise. [Williams 26e]",
            "Eclampsia first steps: left lateral position, airway, oxygen. [MoHFW ANC Guidelines]",
            "**Magnesium sulphate 4 g IV over 5-15 minutes plus 10 g IM**, then transfer. [MoHFW ANC Guidelines]",
            "Swelling of the face and hands, or **sudden weight gain over 2 kg in a week**: assess for pre-eclampsia. [Williams 26e]",
          ],
        },
        {
          heading: "Infective and respiratory",
          points: [
            "**Fever above 38 degrees C**, with or without foul-smelling discharge: chorioamnionitis, urinary infection or malaria. [MoHFW ANC Guidelines]",
            "In fever, investigate, start antibiotics, and refer if the woman is unwell. [MoHFW ANC Guidelines]",
            "Breathlessness at rest, orthopnoea or palpitations: **severe anaemia or heart disease**. [AMB 2018]",
            "Sit the woman up, give oxygen, and refer the **same day**. [MoHFW ANC Guidelines]",
            "Burning micturition with loin pain and fever: **pyelonephritis**, which precipitates preterm labour. [Williams 26e]",
            "Admit pyelonephritis in pregnancy for **intravenous antibiotics**. [Williams 26e]",
          ],
        },
        {
          heading: "Fetal and membrane-related",
          points: [
            "**Fewer than ten fetal movements in twelve hours after 28 weeks** needs same-day cardiotocography or ultrasound. [FOGSI ANC 2019]",
            "Leaking of watery fluid per vaginum is **premature rupture of membranes**. [Williams 26e]",
            "In PROM do a **sterile speculum examination only - no digital examination** - each digital exam raises chorioamnionitis risk. [Williams 26e]",
            "PROM needs antibiotics and referral. [Williams 26e]",
            "Uterine contractions **before 37 weeks** are preterm labour. [Williams 26e]",
            "Refer preterm labour for tocolysis, **antenatal corticosteroids**, and magnesium sulphate for neuroprotection. [Williams 26e]",
          ],
        },
      ],
      markSplit: [
