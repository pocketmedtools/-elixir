  ...
  sections: [
    {
      ...
      points: [
        "**Acute otitis media (AOM)**: rapid onset of middle ear inflammation with a middle ear effusion. [AAP AOM 2013]",
        "AOM symptoms: otalgia, fever and irritability. [AAP AOM 2013]",
        "AOM sign: a **bulging, opaque or red tympanic membrane that is immobile on pneumatic otoscopy**. [AAP AOM 2013]",
        "Redness alone in a crying child is not enough - **bulging or reduced mobility** is the diagnostic sign. [AAP AOM 2013]",
        "**Otitis media with effusion (glue ear)**: fluid behind an intact drum without acute inflammation. [NICE NG98 2016]",
        "Glue ear drum is retracted or amber, with an air-fluid level or bubbles. [Dhingra 8e]",
        "Glue ear gives conductive hearing loss but no fever and no significant pain. [NICE NG98 2016]",
        "**Acute otitis externa**: diffuse inflammation of the external auditory canal. [Dhingra 8e]",
        "Otitis externa sign: **pain on pulling the pinna or pressing the tragus**, with canal oedema, debris and scanty discharge. [Dhingra 8e]",
        "The tympanic membrane in otitis externa is intact though often unseen, and hearing is normal or mildly reduced by canal occlusion. [Dhingra 8e]",
        "**Chronic suppurative otitis media (CSOM)**: a perforated drum with persistent or recurrent discharge for more than **2 weeks**. [WHO CSOM 2004]",
        "WHO uses 2 weeks for CSOM; many texts use 6 weeks. [WHO CSOM 2004]",
        "CSOM divides into **tubotympanic (safe, mucosal)** and **atticoantral (unsafe, squamous)** disease with cholesteatoma. [Dhingra 8e]",
        "Bedside sequence: inspect the pinna and mastoid, press the tragus, insert the largest speculum that fits. [Dhingra 8e]",
        "Then clear wax or debris under vision, and examine the pars tensa quadrant by quadrant. [Dhingra 8e]",
        ...
        "**Tuning fork tests and pneumatic otoscopy** convert an opinion into a finding. [Dhingra 8e]",
        "Conductive loss with a normal-looking drum suggests effusion or ossicular disease. [Dhingra 8e]",
        "A mobile drum with a normal Rinne points to **referred otalgia** from teeth, temporomandibular joint, tonsil or cervical spine. [Dhingra 8e]",
      ],
    },
    {
      heading: "Acute otitis media: who gets it, what causes it and how it behaves",
      points: [
        "AOM peaks at **6 to 24 months** of age. [AAP AOM 2013]",
        "The infant Eustachian tube is shorter, wider and more horizontal - reflux from the nasopharynx is easy. [Dhingra 8e]",
        "Adenoid hypertrophy and viral upper respiratory infection obstruct the Eustachian tube. [Dhingra 8e]",
        "Risk factors: **bottle feeding in the supine position** and absence of breastfeeding. [AAP AOM 2013]",
        "Risk factors: day care attendance, passive smoking and biomass fuel smoke. [AAP AOM 2013]",
        "Risk factors: cleft palate, Down syndrome, allergic rhinitis and winter season. [Dhingra 8e]",
        "Three classical bacteria: **Streptococcus pneumoniae, non-typeable Haemophilus influenzae and Moraxella catarrhalis**. [AAP AOM 2013]",
        "**Streptococcus pyogenes** matters in older children and is more likely to perforate the drum. [Dhingra 8e]",
        "Viruses precede or accompany most AOM episodes. [AAP AOM 2013]",
        "**About 80% of AOM episodes settle within 3 days without an antibiotic.** [NICE NG91 2018]",
        ...
        "Stage 1 tubal occlusion; stage 2 pre-suppuration with a red drum, throbbing pain and fever. [Dhingra 8e]",
        "Stage 3 suppuration with a bulging drum and severe pain. [Dhingra 8e]",
        "Stage 4 **resolution after spontaneous perforation** - sudden relief of pain with mucopurulent discharge. [Dhingra 8e]",
        "Stage 5 is either complete healing, or progression to complication or chronic disease. [Dhingra 8e]",
        "**The ear that stops hurting the moment it starts discharging has perforated.** [Dhingra 8e]",
    ...
    },
    {
      ...
      points: [
        "**Analgesia is the first prescription, not the antibiotic.** [NICE NG91 2018]",
        "**Paracetamol 15 mg/kg six-hourly or ibuprofen 10 mg/kg eight-hourly**, regularly for 48 to 72 hours. [IAP STG 2022]",
        "Give an antibiotic immediately if the child is **under 6 months**. [AAP AOM 2013]",
        "Give an antibiotic immediately if aged 6 to 24 months with **bilateral AOM**. [AAP AOM 2013]",
        "Give an antibiotic immediately for **otorrhoea from a fresh perforation**. [AAP AOM 2013]",
        "Give an antibiotic immediately if systemically unwell or toxic, or with severe otalgia. [NICE NG91 2018]",
        "Give an antibiotic immediately if temperature is **above 39 degrees C**. [AAP AOM 2013]",
        "Give an antibiotic immediately for immunodeficiency, craniofacial anomaly or a cochlear implant. [AAP AOM 2013]",
        ...
        "First line is **amoxicillin 80 to 90 mg/kg/day in two or three divided doses**. [AAP AOM 2013]",
        "Adult dose is **amoxicillin 500 mg to 1 g three times daily**. [Dhingra 8e]",
        "Duration is **10 days under 2 years** and in severe or perforated disease. [AAP AOM 2013]",
        "Duration is **5 to 7 days in children over 2 years** with mild disease. [AAP AOM 2013]",
        "**Amoxicillin-clavulanate 90/6.4 mg/kg/day** if there has been an antibiotic in the last 30 days. [AAP AOM 2013]",
        ...
        "Amoxicillin-clavulanate if amoxicillin has failed after 48 to 72 hours. [AAP AOM 2013]",
        "Penicillin allergy: **azithromycin 10 mg/kg on day 1 then 5 mg/kg for 4 days**, or cefuroxime axetil 30 mg/kg/day. [IAP STG 2022]",
        "Macrolide resistance among pneumococci in India is high - azithromycin is a fallback, not a first choice. [IAP STG 2022]",
        "**Topical drops have no role in AOM with an intact drum.** [NICE NG91 2018]",
        "If the drum has perforated, keep the ear dry and add **ciprofloxacin 0.3% ear drops five drops twice daily**. [Dhingra 8e]",
        "Avoid aminoglycoside drops through an open middle ear - they are potentially ototoxic. [Dhingra 8e]",
        "**Myringotomy** for a severely bulging drum with intractable pain. [Dhingra 8e]",
        "Myringotomy for AOM not settling on adequate antibiotics, or in an immunocompromised or neonatal patient. [Dhingra 8e]",
        "Myringotomy when a complication such as incipient mastoiditis or facial palsy is suspected. [Dhingra 8e]",
      ],
    },
    {
      heading: "Otitis externa, including the diabetic emergency",
      points: [
        "Otitis externa follows loss of the protective acid cerumen layer. [Dhingra 8e]",
        "Causes: **water in the ear (swimmer's ear)**, cotton bud or hairpin trauma. [Dhingra 8e]",
        "Causes: hearing aid or ear-plug occlusion, eczema, psoriasis and diabetes. [Dhingra 8e]",
        "**Pseudomonas aeruginosa and Staphylococcus aureus** dominate the bacteriology. [Dhingra 8e]",
        "**Aspergillus niger and Candida** cause otomycosis. [Dhingra 8e]",
        "Hallmark is **pain on tragal pressure or on pulling the pinna, absent in otitis media**. [Dhingra 8e]",
        "Also canal oedema, debris and scanty discharge, with an intact drum when it can be seen. [Dhingra 8e]",
        "**Aural toilet under vision is the single most effective treatment** - drops cannot reach an occluded canal. [Dhingra 8e]",
        "Aural toilet means dry mopping, suction, or gentle syringing only if the drum is known intact. [Dhingra 8e]",
        "If the canal is closed, insert a **medicated wick with 8% aluminium acetate or an antibiotic-steroid preparation for 48 hours**. [Dhingra 8e]",
        "Topical treatment for **7 to 10 days**: ciprofloxacin 0.3% with dexamethasone, or neomycin-polymyxin-hydrocortisone drops three to four times daily. [Dhingra 8e]",
        ...
        "**Otomycosis** shows blotting-paper wet debris with black-headed conidiophores (Aspergillus niger) or white curd (Candida). [Dhingra 8e]",
        "Otomycosis treatment: meticulous suction clearance plus **clotrimazole 1% solution twice daily for 2 to 3 weeks**. [Dhingra 8e]",
        "Antibiotic drops alone make otomycosis worse. [Dhingra 8e]",
        "**Furunculosis** of the outer cartilaginous canal is exquisitely tender staphylococcal folliculitis. [Dhingra 8e]",
        "Furunculosis: **cloxacillin 500 mg six-hourly** or amoxicillin-clavulanate, analgesia and local heat; incise only when it points. [Dhingra 8e]",
        "**Malignant (necrotising) otitis externa** is osteomyelitis of the temporal bone in an elderly diabetic or immunocompromised patient. [Dhingra 8e]",
        "Its hallmark is **severe unremitting nocturnal otalgia out of proportion to the findings**. [Dhingra 8e]",
        "Signs: **granulation tissue at the bony-cartilaginous junction of the canal floor** and a raised ESR. [Dhingra 8e]",
        "Cranial nerve palsies begin with the **facial nerve** - a late and ominous sign. [Dhingra 8e]",
        "Management: admission, blood sugar control, and contrast CT or MRI with a gallium or technetium scan. [Scott-Brown 8e]",
        "Give **6 to 8 weeks of systemic anti-pseudomonal therapy such as ciprofloxacin 750 mg twice daily**. [Dhingra 8e]",
      ],
    },
    {
      heading: "Chronic suppurative otitis media: safe versus unsafe",
      points: [
        "**Tubotympanic (mucosal, safe) CSOM** has a **central perforation of the pars tensa** with a visible rim of annulus. [Dhingra 8e]",
        "Its discharge is profuse, mucoid and odourless, intermittent, and worsens with upper respiratory infection or water entry. [Dhingra 8e]",
        "Tubotympanic CSOM gives a conductive hearing loss of **20 to 40 dB**. [Dhingra 8e]",
        "**Atticoantral (squamous, unsafe) CSOM** has an **attic or posterosuperior marginal perforation, or a retraction pocket**. [Dhingra 8e]",
        "Its discharge is scanty and **foul-smelling**, with granulation tissue or an aural polyp. [Dhingra 8e]",
        "Cholesteatoma is keratinising squamous epithelium trapped in the middle ear. [Dhingra 8e]",
        "Cholesteatoma erodes bone by pressure, enzymes and osteoclast activation. [Dhingra 8e]",
        "**Foul smell, granulation, polyp, attic crust, vertigo, facial weakness or a sensorineural component demand imaging and ENT referral.** [Dhingra 8e]",
        "Those features indicate bone erosion, not simply infection. [Dhingra 8e]",
        "Active mucosal disease: regular aural toilet plus **ciprofloxacin 0.3% drops five drops twice daily for 7 to 10 days**. [WHO CSOM 2004]",
        "Dry ear precautions: no swimming, a cotton plug smeared with petroleum jelly for bathing, no oil instillation. [WHO CSOM 2004]",
        ...
        "Mucosal disease: **tympanoplasty with or without cortical mastoidectomy once the ear has been dry for 6 to 8 weeks**. [Dhingra 8e]",
        "Squamous disease: **canal wall down modified radical mastoidectomy** - a safe dry ear first, hearing second. [Dhingra 8e]",
        "Untreated CSOM in India is an important cause of **preventable hearing loss and school failure**. [NPPCD MoHFW]",
        "CSOM rarely causes death from intracranial complications, and the deafness programme targets it directly. [NPPCD MoHFW]",
      ],
    },
    {
      heading: "Complications, prevention and the family physician's follow-up",
      points: [
        "**Acute mastoiditis**: postauricular swelling with the pinna pushed down, out and forward. [Dhingra 8e]",
        "Mastoiditis also gives tenderness over the mastoid antrum and sagging of the posterosuperior canal wall. [Dhingra 8e]",
        "Other extracranial complications: subperiosteal abscess and **Bezold abscess** in the neck. [Dhingra 8e]",
        "Other extracranial complications: facial nerve palsy and labyrinthitis. [Dhingra 8e]",
        "Petrositis gives the **Gradenigo triad of otorrhoea, retro-orbital pain and lateral rectus palsy**. [Dhingra 8e]",
        "**Masked mastoiditis** follows partial antibiotic treatment - few signs, ongoing bone destruction. [Dhingra 8e]",
        "Intracranial complications: **meningitis is the commonest**. [Dhingra 8e]",
        "Also extradural and subdural abscess, and brain abscess of the temporal lobe or cerebellum. [Dhingra 8e]",
        "**Lateral sinus thrombophlebitis**: picket-fence fever with a positive Griesinger sign. [Dhingra 8e]",
        "Otitic hydrocephalus is a further intracranial complication. [Dhingra 8e]",
        "**Fever, headache, vomiting, neck stiffness or altered sensorium in a discharging ear means admission today.** [Dhingra 8e]",
        "Prevention: **exclusive breastfeeding for 6 months** and feeding the infant propped up rather than supine. [AAP AOM 2013]",
        "Prevention: avoid household tobacco and biomass smoke. [AAP AOM 2013]",
        ...
        "Review after AOM at **6 to 12 weeks** to confirm the effusion has cleared and hearing has returned. [NICE NG98 2016]",
        "Persistent bilateral effusion beyond **3 months** with hearing loss above **25 to 30 dB** needs audiometry and ENT referral for grommets. [NICE NG98 2016]",
        "Refer earlier if there is speech delay or poor school performance. [NICE NG98 2016]",
        "Recurrent AOM is **three episodes in 6 months or four in a year**. [AAP AOM 2013]",
        "In recurrent AOM examine the nose for **adenoid hypertrophy and allergic rhinitis**. [Dhingra 8e]",
        "In recurrent AOM check feeding position and smoke exposure, and consider grommets with or without adenoidectomy. [NICE NG98 2016]",
        "**Document hearing at every visit** in a child with ear disease. [NPPCD MoHFW]",
        "The family physician contributes early detection, not surgery - an undetected conductive loss in a school child is a preventable educational disability. [NPPCD MoHFW]",
      ],
    },
  ],
  tables: [
