  ...
  sections: [
    {
      ...
      points: [
        ...
        "Red eye with **pain, photophobia and reduced vision is a referral** - all three mean the inflammation is inside the eye. [STG Ophthalmology MoHFW]",
        "Red eye with grittiness, discharge and normal vision can be treated in the clinic, since the disease has stayed on the surface. [STG Ophthalmology MoHFW]",
      ],
    },
    {
      ...
      points: [
        ...
        "Microbial keratitis is the commonest cause of **unilateral corneal blindness in rural India** - agricultural trauma and late referral. [NPCBVI MoHFW]",
    ...
    },
    {
      ...
      points: [
        ...
        "Inspect with a torch from the side and then straight on - oblique light shows a shallow chamber and any corneal irregularity. [WHO PEC SEARO]",
        "Look at lids and lashes, the pattern of redness, and corneal clarity - a dull corneal light reflex means the surface is not intact. [WHO PEC SEARO]",
        "Then assess chamber depth and contents, and pupil size, shape and reaction - the pupil alone separates uveitis from angle closure. [WHO PEC SEARO]",
        "**Evert the upper lid** in every red eye with a foreign body sensation, since the particle is usually held under the upper tarsus. [WHO PEC SEARO]",
    ...
    },
    {
      ...
      points: [
        "In the clinic: bacterial, viral and allergic conjunctivitis, and subconjunctival haemorrhage - none of them threatens the sight. [STG Ophthalmology MoHFW]",
        "Also in the clinic: simple episcleritis, superficial abrasion and a removable surface foreign body, since all heal without a scar. [STG Ophthalmology MoHFW]",
        "**Refer the same day** any red eye with reduced vision, true pain or photophobia - these three mark intraocular inflammation. [STG Ophthalmology MoHFW]",
        "Refer the same day: corneal opacity or staining beyond a simple abrasion, since an untreated ulcer can perforate within days. [STG Ophthalmology MoHFW]",
        "Refer the same day: an abnormal pupil, a hard globe or a hypopyon - each means uveitis, angle closure or infection inside. [STG Ophthalmology MoHFW]",
        "Refer the same day: a contact lens ulcer or a red eye after surgery, since Pseudomonas and endophthalmitis both move in hours. [STG Ophthalmology MoHFW]",
        "Corneal abrasion: **chloramphenicol 1% ointment four times daily for 5 days** - it lubricates and prevents secondary infection. [STG Ophthalmology MoHFW]",
        "Add oral analgesia rather than a topical anaesthetic, since the anaesthetic is toxic to the healing epithelium. [STG Ophthalmology MoHFW]",
        "Add a cycloplegic such as **homatropine 2% twice daily** for ciliary spasm - it rests the ciliary muscle, so the deep ache settles. [STG Ophthalmology MoHFW]",
        "Review at 48 hours, since an abrasion that has not healed by then is an ulcer rather than a graze. [STG Ophthalmology MoHFW]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "Dry ear precautions: no swimming, and a petroleum-jelly cotton plug for bathing - water through a perforation restarts the discharge. [WHO CSOM 2004]",
        "Never instil oil or traditional drops, since they carry organisms straight into an open middle ear. [WHO CSOM 2004]",
        "Treat the nose too - allergic rhinitis, sinusitis and adenoids feed the middle ear through the Eustachian tube. [Dhingra 8e]",
        "**Avoid aminoglycoside drops (neomycin, gentamicin, framycetin) in a perforated ear** - ototoxic risk. [WHO CSOM 2004]",
        "**Fluoroquinolone drops are the safe choice** in a perforated ear - a point examiners look for. [WHO CSOM 2004]",
        ...
        "Untreated CSOM in India is a leading cause of **preventable hearing loss and school failure** - a child who cannot hear is thought slow. [NPPCD MoHFW]",
        "CSOM can still kill through intracranial complications, which is why the national deafness programme targets it directly. [NPPCD MoHFW]",
      ],
    },
    {
      ...
      points: [
        ...
        "Prevention: **pneumococcal conjugate and influenza vaccination** - PCV is in India's Universal Immunisation Programme and reduces AOM episodes. [NPPCD MoHFW]",
        ...
        "**Document hearing at every visit** in a child with ear disease - only a written trend shows a loss that is failing to recover. [NPPCD MoHFW]",
        "The family physician contributes early detection, not surgery - the loss is found in the clinic long before it reaches ENT. [NPPCD MoHFW]",
        "An undetected conductive loss in a school child is a preventable educational disability, so hearing must be checked, not assumed. [NPPCD MoHFW]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "**Never use aminoglycoside drops through a perforation** - ototoxic risk. [WHO CSOM 2004]",
          ],
        },
        {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "Swab for culture if discharge is persistent, since persistent otorrhoea usually means Pseudomonas or a resistant organism. [WHO CSOM 2004]",
        ...
        },
        {
          ...
          points: [
            ...
            "Safe disease: strict dry ear precautions and treatment of rhinitis, sinusitis and adenoids, since the middle ear is refilled from the nose. [WHO CSOM 2004]",
            ...
            "**Never use aminoglycoside drops through a perforation** - they reach the round window and destroy cochlear hair cells. [WHO CSOM 2004]",
            "Avoid syringing an ear with a suspected labyrinthine fistula - it provokes vertigo. [Dhingra 8e]",
            "Counsel on dry ear precautions, and a hearing aid where surgery is not possible, since an unaided loss costs speech and schooling. [NPPCD MoHFW]",
            "Arrange school hearing assessment in children with CSOM - a loss found at school is corrected before it costs a year of learning. [NPPCD MoHFW]",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        ...
        "**About 70 to 85% of sore throats in adults and 60 to 70% in children are viral** - so no antibiotic is the default and treating is the exception. [IDSA 2012]",
        "Viral causes: rhinovirus, coronavirus, adenovirus, influenza, parainfluenza and **Epstein-Barr virus** - none of them answer to penicillin. [IDSA 2012]",
        "**Group A Streptococcus causes 15 to 30% of sore throats in children aged 5 to 15 years** - the age band that carries the rheumatic fever risk. [IDSA 2012]",
        "GABHS causes only **5 to 15% of adult sore throats** - so an unselected adult is likelier to be harmed by penicillin than helped by it. [IDSA 2012]",
        "GABHS is uncommon under 3 years and rarely causes rheumatic fever there - so routine testing and treating under 3 buys nothing. [IDSA 2012]",
        ...
        "**Antibiotics started within 9 days of onset still prevent rheumatic fever** - there is time to test or observe. [IDSA 2012]",
        "Antibiotics do **not** prevent post-streptococcal glomerulonephritis - the immune complex injury is already under way when the throat is seen. [IDSA 2012]",
    ...
    },
    {
      ...
      points: [
        ...
        "Ask about **cough and coryza - both point away from streptococcus**. [IDSA 2012]",
        "Ask about rash, and abdominal pain and vomiting in children - a scarlatiniform rash and gut symptoms both raise the odds of GABHS. [IDSA 2012]",
        "Ask about recent contact with a proven case - a household contact raises pre-test probability enough to shift a borderline score. [IDSA 2012]",
        "Ask **immunisation status** - unimmunised means diphtheria is possible. [NCDC Diphtheria MoHFW]",
        ...
        "Favouring GABHS: sudden onset and **fever above 38 degrees C** - viral pharyngitis builds over days behind a coryzal prodrome. [IDSA 2012]",
        "Favouring GABHS: **tonsillar exudate** and tender anterior cervical nodes - those nodes drain the tonsil, so tenderness localises the sepsis. [IDSA 2012]",
        "Favouring GABHS: palatal petechiae, scarlatiniform rash and strawberry tongue - all are erythrogenic toxin effects, so they are near specific. [IDSA 2012]",
        "Favouring GABHS: **absence of cough, coryza, hoarseness, conjunctivitis and diarrhoea** - streptococcus stays in the pharynx, a virus does not. [IDSA 2012]",
        "Favouring a virus: cough, coryza, hoarseness and conjunctivitis - each marks spread beyond the pharynx to nose, larynx and eye. [IDSA 2012]",
        "Favouring a virus: ulcers or vesicles, diarrhoea, and a **diffusely injected pharynx without exudate** - streptococcus does not vesiculate. [IDSA 2012]",
        "Tender **anterior** cervical nodes suggest streptococcus - they are the first drainage station of the tonsillar bed. [IDSA 2012]",
        ...
        "**RADT specificity is 90 to 95% but sensitivity only 70 to 90%** - so a positive can be trusted and a negative in a child cannot. [IDSA 2012]",
        "A positive rapid antigen test justifies an antibiotic without culture - false positives are rare at 90 to 95% specificity. [IDSA 2012]",
        "A negative rapid test in a child needs **throat culture, the gold standard** - a missed GABHS at this age is a missed rheumatic fever. [IDSA 2012]",
        "Culture takes **24 to 48 hours**, so start nothing while waiting unless the child is toxic or the score is 4 to 5. [IDSA 2012]",
        "**Do not use anti-streptolysin O titre to diagnose acute pharyngitis** - it rises only 2 to 3 weeks after infection. [IDSA 2012]",
    ...
    },
    {
      ...
      points: [
        "**Centor: a point each for tonsillar exudate, tender anterior cervical nodes, fever by history and no cough** - the four features that track GABHS. [IDSA 2012]",
        "**McIsaac adds one point for age 3 to 14 years** - the age of peak GABHS carriage and peak rheumatic fever risk. [IDSA 2012]",
        "McIsaac adds zero points for age 15 to 44 years - GABHS prevalence is middling here, so age carries no information. [IDSA 2012]",
        "**McIsaac subtracts one point at 45 years or older**, range -1 to 5 - GABHS pharyngitis is rare then, so the same signs mean less. [IDSA 2012]",
        "McIsaac 0 to 1 point: GABHS probability about **1 to 10%** - low enough that a test would return mostly false positives. [IDSA 2012]",
        "McIsaac 2 points: about **11 to 17%** - too high to ignore and too low to treat blind, so this is test territory. [IDSA 2012]",
        "McIsaac 3 points: about **28 to 35%** - two in three would still be treated needlessly if you prescribed on the score alone. [IDSA 2012]",
        "McIsaac 4 to 5 points: about **51 to 53%** - a coin toss, which is why empirical treatment is defensible where rheumatic fever is common. [IDSA 2012]",
        "**Score 0 to 1: no test and no antibiotic** - symptomatic treatment and safety-netting only. [IDSA 2012]",
        "**Score 2 to 3: test with RADT or culture and treat only if positive** - most at this probability are viral, so the test spares them. [IDSA 2012]",
    ...
    },
    {
      ...
      points: [
        ...
        "**First line is penicillin V (phenoxymethylpenicillin) for 10 days** - the narrowest drug that eradicates GABHS from the pharynx. [IDSA 2012]",
        "Penicillin V **250 mg twice or three times daily** under 27 kg - twice daily suffices because streptococcus stays exquisitely sensitive. [IDSA 2012]",
        "Penicillin V **500 mg twice daily** for adults - the dose doubles for body size while the frequency stays the same. [IDSA 2012]",
        "The 10-day course is for eradication, not symptoms - these settle by day 3, but a short course leaves carriage and the rheumatic risk. [IDSA 2012]",
        "**Amoxicillin 50 mg/kg once daily, maximum 1000 mg, for 10 days** in children - better tasting and once daily, so adherence is higher. [IDSA 2012]",
        ...
        "**A single deep intramuscular benzathine penicillin G** is the option when adherence to 10 days is doubtful - one dose covers the course. [IDSA 2012]",
        "Benzathine penicillin G **600,000 units under 27 kg, 1.2 million units at 27 kg or above** - give it deep intramuscular, never intravenous. [IDSA 2012]",
        ...
        "Penicillin allergy without anaphylaxis: **cephalexin 20 mg/kg twice daily for 10 days** - cross-reaction is low if the reaction was a rash. [IDSA 2012]",
        "Penicillin anaphylaxis: **azithromycin 12 mg/kg once daily for 5 days** - a macrolide has no beta-lactam ring to cross-react. [IDSA 2012]",
        "Clindamycin 7 mg/kg three times daily for 10 days is the other option, useful since it also clears the streptococcal carrier state. [IDSA 2012]",
        "Macrolide resistance in Streptococcus pyogenes is rising, so macrolides are second choices. [IDSA 2012]",
        "**Group A Streptococcus has never been reported resistant to penicillin** - so a failure means poor adherence or the wrong diagnosis. [IDSA 2012]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Post-streptococcal glomerulonephritis follows by 1 to 2 weeks** and antibiotics do not prevent it, so check urine and pressure at review. [IDSA 2012]",
        ...
        "**Diphtheria**: think of it in an unimmunised or partly immunised child - immunisation gaps persist and delay is what kills. [NCDC Diphtheria MoHFW]",
        "Diphtheria gives a **greyish-white membrane that bleeds on removal** - it is necrotic mucosa, so peeling tears the vessels beneath. [NCDC Diphtheria MoHFW]",
        "Diphtheria also gives bull neck and toxaemia out of proportion to the fever - the exotoxin, not local infection, drives the illness. [NCDC Diphtheria MoHFW]",
        "Later diphtheria features are palatal palsy and myocarditis - once toxin binds nerve and myocardium, antitoxin cannot undo it. [NCDC Diphtheria MoHFW]",
        "Diphtheria treatment: **antitoxin, penicillin or erythromycin, isolation and notification - do not wait for culture**. [NCDC Diphtheria MoHFW]",
    ...
    },
    {
      ...
      points: [
        ...
        "Return to school or work **24 hours after starting an effective antibiotic** - by then the throat no longer carries transmissible organisms. [IDSA 2012]",
        "Treat household contacts only if symptomatic, or if rheumatic fever has occurred in the family - treating well carriers achieves nothing. [IDSA 2012]",
      ...
      answer: [
        {
          heading: "1. Aetiology",
          points: [
            "Viral: rhinovirus, coronavirus and **adenovirus causing pharyngoconjunctival fever** - conjunctivitis with a sore throat rules streptococcus out. [IDSA 2012]",
            "Viral: influenza and parainfluenza - both bring myalgia and cough, which streptococcal pharyngitis does not. [IDSA 2012]",
            ...
            "Bacterial: **group A beta-haemolytic Streptococcus** principally - the only organism here whose treatment prevents a later cardiac lesion. [IDSA 2012]",
        ...
        },
        {
          ...
          points: [
            "History: onset, fever, odynophagia, cough, coryza, hoarseness - these are the items the Centor score is built from. [IDSA 2012]",
            "History: rash, abdominal pain and contact history - each raises the streptococcal probability before any test is done. [IDSA 2012]",
            ...
            "Examination: temperature, tonsillar size and exudate, palatal petechiae, anterior nodes - these are the signs the score can actually use. [IDSA 2012]",
            ...
            "Favouring streptococcus: sudden onset, fever, exudate, tender anterior nodes - infection confined to the pharynx and its first nodes. [IDSA 2012]",
            "Favouring streptococcus: palatal petechiae, scarlatiniform rash and **absence of cough and coryza** - toxin signs without viral airway spread. [IDSA 2012]",
            "Favouring a virus: cough, coryza, hoarseness, conjunctivitis, ulcers and diarrhoea - inflammation beyond the pharynx means a virus. [IDSA 2012]",
          ],
        },
        {
          heading: "3. Clinical scoring",
          points: [
            "**Centor criteria: tonsillar exudate, tender anterior cervical nodes, history of fever, absence of cough - one point each.** [IDSA 2012]",
            "McIsaac: **add one point for age 3 to 14 years** - peak GABHS incidence and peak rheumatic fever risk both fall in this band. [IDSA 2012]",
            "McIsaac: none for age 15 to 44 years and **subtract one at 45 or over**, since streptococcal pharyngitis is rare in later life. [IDSA 2012]",
            "**Score 0 to 1, risk 1 to 10%: no test and no antibiotic** - at this probability a test returns mostly false positives. [IDSA 2012]",
            "**Score 2 to 3, risk 11 to 35%: rapid antigen test or culture** - too likely to ignore, too unlikely to treat blind. [IDSA 2012]",
            ...
            "**Score 4 to 5, risk about 51 to 53%: test if available** - about half are still viral, so a test spares those patients. [IDSA 2012]",
            ...
            "**Rapid antigen tests: specificity 90 to 95%, sensitivity only 70 to 90%** - a positive can be believed, a negative cannot. [IDSA 2012]",
            "A negative rapid antigen test in a child should be confirmed by culture, since a missed GABHS at this age is a missed rheumatic fever. [IDSA 2012]",
            "**ASO titre has no role in acute diagnosis** - it rises only 2 to 3 weeks later. [IDSA 2012]",
          ],
        },
        {
          heading: "4. Treatment",
          points: [
            ...
            "**Penicillin V 250 mg two to three times daily under 27 kg** for 10 days - the narrowest drug that eradicates GABHS. [IDSA 2012]",
            "**Penicillin V 500 mg twice daily in adults** for 10 days - the dose doubles for body size, the frequency does not change. [IDSA 2012]",
            "The full 10 days is for eradication, not symptoms - a shorter course leaves pharyngeal carriage and the rheumatic fever risk. [IDSA 2012]",
            "**Amoxicillin 50 mg/kg once daily for 10 days** as an alternative - once daily and palatable, so a child actually finishes it. [IDSA 2012]",
            "**Benzathine penicillin G 600,000 units under 27 kg, or 1.2 million units**, as a single intramuscular dose - one shot covers the course. [IDSA 2012]",
            "Non-anaphylactic penicillin allergy: **cephalexin 20 mg/kg twice daily for 10 days** - cross-reaction is low if the reaction was a rash. [IDSA 2012]",
            "Penicillin anaphylaxis: **azithromycin 12 mg/kg daily for 5 days** - a macrolide has no beta-lactam ring, so it cannot cross-react. [IDSA 2012]",
            "**Antibiotics started up to 9 days from onset still prevent rheumatic fever** - so there is time to test rather than prescribe on sight. [IDSA 2012]",
            "Antibiotics do not prevent post-streptococcal glomerulonephritis - the immune complex injury is already under way at presentation. [IDSA 2012]",
            "Return to school **24 hours after starting an effective antibiotic** - by then the throat no longer carries transmissible organisms. [IDSA 2012]",
          ],
        },
        {
          ...
          points: [
            ...
            "Non-suppurative: **post-streptococcal glomerulonephritis at 1 to 2 weeks** - so check urine and blood pressure at the follow-up visit. [IDSA 2012]",
            ...
            "Refer for neck swelling or stiffness, toxaemia or suspected diphtheria, since antitoxin and drainage are not primary care treatments. [NCDC Diphtheria MoHFW]",
        ...
        },
        {
          ...
          points: [
            "Cough and hand hygiene, and no shared utensils - GABHS spreads by large droplets and direct contact within the household. [IDSA 2012]",
            "Treat symptomatic household contacts only, since treating well carriers achieves nothing and breeds resistance. [IDSA 2012]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "Suspect bacterial infection when **symptoms persist beyond 10 days without improvement** - a viral cold is already improving by then. [IDSA 2012]",
        "Also on **fever above 39 degrees C with purulent discharge for 3 to 4 days** from the outset - a viral cold rarely starts that way. [IDSA 2012]",
        "Suspect bacterial infection on **double sickening** - initial improvement then worsening after 5 to 6 days. [EPOS 2020]",
        "Common organisms: **Streptococcus pneumoniae, Haemophilus influenzae and Moraxella catarrhalis** - the same trio as acute otitis media. [IDSA 2012]",
        ...
        "**Sinus radiographs are not recommended for diagnosis** - mucosal thickening is common in asymptomatic people and simple colds. [AAO-HNS 2015]",
        ...
        "Children: **amoxicillin-clavulanate 90/6.4 mg/kg/day in two divided doses** - the high amoxicillin share overcomes resistant pneumococci. [IDSA 2012]",
        "Penicillin allergy in adults: **doxycycline 100 mg twice daily** - it covers all three organisms and carries no beta-lactam ring. [IDSA 2012]",
        "**Levofloxacin 500 mg daily** only where a fluoroquinolone is unavoidable, since tendon rupture and resistance are real costs. [IDSA 2012]",
        "**Azithromycin and cotrimoxazole are poor choices** because of pneumococcal resistance. [IDSA 2012]",
      ],
    },
    {
      ...
      answer: [
        {
          ...
          points: [
            "**Symptoms persisting beyond 10 days without any improvement** - a viral cold is already on the mend by day 10. [IDSA 2012]",
            "**Severe onset with fever above 39 degrees C and purulent discharge for 3 to 4 days** - a cold rarely begins that violently. [IDSA 2012]",
            ...
            "**The colour of discharge alone is not discriminating** - green comes from neutrophil myeloperoxidase, present in viral colds too. [AAO-HNS 2015]",
            "**Plain sinus radiographs are not recommended for diagnosis** - mucosal thickening appears in healthy people and in simple colds. [AAO-HNS 2015]",
          ],
        },
        {
          heading: "Organisms",
          points: [
            "**Streptococcus pneumoniae, non-typeable Haemophilus influenzae and Moraxella catarrhalis** - the same trio as acute otitis media. [IDSA 2012]",
        ...
        },
        {
          ...
          points: [
            ...
            "Children: **amoxicillin-clavulanate 90/6.4 mg/kg/day in two divided doses** - the high amoxicillin share beats resistant pneumococci. [IDSA 2012]",
            "Penicillin allergy: **doxycycline 100 mg twice daily**, or levofloxacin 500 mg daily - both cover the trio without a beta-lactam ring. [IDSA 2012]",
            "**Azithromycin and cotrimoxazole are poor choices** because of pneumococcal resistance. [IDSA 2012]",
