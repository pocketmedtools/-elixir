  ...
  sections: [
    {
      ...
      points: [
        "**Allergic rhinitis is IgE-mediated inflammation of the nasal mucosa** following allergen exposure. [ARIA 2020]",
        "Diagnose on **two or more of watery rhinorrhoea, sneezing, nasal obstruction and nasal or ocular itching**. [ARIA 2020]",
        "Symptoms must last **more than one hour on most days**. [ARIA 2020]",
        "Allergic rhinitis affects **roughly 20 to 30% of the Indian population**. [ICMR AMR 2022]",
        "It worsens asthma control and causes otitis media with effusion. [ARIA 2020]",
        "It causes chronic rhinosinusitis and nasal polyps. [EPOS 2020]",
        "It impairs sleep, school performance and work productivity. [ARIA 2020]",
        "**The ARIA classification replaced seasonal and perennial.** [ARIA 2020]",
        "**Intermittent: symptoms on fewer than 4 days a week, or for fewer than 4 consecutive weeks.** [ARIA 2020]",
        "**Persistent: 4 or more days a week and for more than 4 weeks.** [ARIA 2020]",
        "**Mild: normal sleep, normal daily activities, sport and work, and no troublesome symptoms.** [ARIA 2020]",
        "**Moderate-severe: one or more of sleep, activity, sport, work or symptom burden is impaired.** [ARIA 2020]",
        "The two axes together give four categories that determine treatment. [ARIA 2020]",
        "**State the united airway concept in any answer.** [ARIA 2020]",
        "**About 80% of asthmatics have rhinitis**, and 20 to 40% of patients with rhinitis have asthma. [ARIA 2020]",
        "Ask every rhinitis patient about wheeze, nocturnal cough and exercise limitation. [ARIA 2020]",
        "Examine the nose in every asthmatic. [ARIA 2020]",
        "Common Indian allergens: **house dust mite (Dermatophagoides), cockroach, moulds and animal dander**. [ICMR AMR 2022]",
        "Common Indian pollens: **Parthenium, Prosopis juliflora, grasses and Artemisia**. [ICMR AMR 2022]",
        "Biomass smoke, traffic pollution and tobacco act as non-allergic aggravators. [ARIA 2020]",
      ],
    },
    {
      ...
      points: [
        ...
        "Ask about seasonality and response to previous antihistamines. [ARIA 2020]",
        "Ask for family history of atopy, and personal eczema, asthma or conjunctivitis. [ARIA 2020]",
        "Sign: **pale, boggy, bluish inferior turbinates with clear watery secretions**. [Dhingra 8e]",
        "Sign: a transverse nasal crease from the **allergic salute**. [Dhingra 8e]",
        "Sign: **allergic shiners** - infraorbital venous congestion. [Dhingra 8e]",
        "Sign: Dennie-Morgan lines and cobblestoning of the posterior pharyngeal wall. [Dhingra 8e]",
        "Sign: **adenoid facies with mouth breathing** in children. [Dhingra 8e]",
        "**Always examine for nasal polyps** - pale, insensitive, mobile, non-bleeding grape-like masses from the middle meatus. [Dhingra 8e]",
        "**A unilateral polyp or a bleeding mass is not allergic** and needs urgent referral. [EPOS 2020]",
        "Investigations are usually unnecessary in primary care. [ARIA 2020]",
        "Where diagnosis is doubtful or immunotherapy is planned, use **skin prick testing (first choice) or specific serum IgE**. [ARIA 2020]",
        "**Total IgE and absolute eosinophil count are neither sensitive nor specific** and must not make the diagnosis. [ARIA 2020]",
        ...
        "Differential: infective rhinitis. [Dhingra 8e]",
        "Differential: **rhinitis medicamentosa after more than 5 to 7 days of topical decongestant**. [Dhingra 8e]",
        "Differential: drug-induced rhinitis from **beta-blockers, ACE inhibitors, aspirin or oral contraceptives**. [Dhingra 8e]",
        "Differential: hormonal rhinitis of pregnancy. [ARIA 2020]",
        "Differential: **CSF rhinorrhoea after trauma** - unilateral clear fluid positive for beta-2 transferrin. [Dhingra 8e]",
        "In children, **unilateral foul purulent nasal discharge is a foreign body until proved otherwise**. [Dhingra 8e]",
        "Adenoid hypertrophy is the commonest cause of chronic mouth breathing and snoring in children. [Dhingra 8e]",
      ],
    },
    {
      heading: "Treating allergic rhinitis, stepwise",
      points: [
        "**Allergen avoidance first**: mattress and pillow covers, and weekly hot washing of bedding. [ARIA 2020]",
        "Remove carpets and soft toys from the bedroom. [ARIA 2020]",
        "Control damp and mould, and control cockroaches. [ARIA 2020]",
        "Keep windows shut during high pollen periods. [ARIA 2020]",
        "Complete avoidance of tobacco and biomass smoke. [ARIA 2020]",
        "**Saline nasal irrigation 5 to 10 mL per nostril once or twice daily**, isotonic or hypertonic. [EPOS 2020]",
        ...
        "**Intranasal corticosteroids are the single most effective drug class** and first line in persistent or moderate-severe disease. [ARIA 2020]",
        "**Fluticasone propionate 50 microgram per spray, two sprays per nostril once daily** in adults. [ARIA 2020]",
        "**Mometasone furoate 50 microgram, two sprays once daily** in adults. [ARIA 2020]",
        "Children 6 to 11 years take **one spray per nostril once daily**. [ARIA 2020]",
        ...
        "Blow the nose, tilt the head slightly forward, and do not sniff hard. [ARIA 2020]",
        ...
        "**Second-generation oral antihistamines** are first line in mild intermittent disease and add-on otherwise. [ARIA 2020]",
        "**Levocetirizine 5 mg once daily**, or 2.5 mg for children 6 to 11 years. [ARIA 2020]",
        "Alternatives: **cetirizine 10 mg, loratadine 10 mg, or fexofenadine 120 to 180 mg once daily**. [ARIA 2020]",
        ...
        "**Intranasal azelastine added to an intranasal steroid** works faster than either alone in moderate-severe disease. [ARIA 2020]",
        "**Montelukast 10 mg at night, children 5 mg**, is a reasonable add-on where asthma coexists. [ARIA 2020]",
        "Montelukast carries a warning for neuropsychiatric effects and should not be first line. [ARIA 2020]",
        "**Avoid oral pseudoephedrine in hypertension, ischaemic heart disease, glaucoma, prostatism and children under 6.** [ARIA 2020]",
        "**Limit topical oxymetazoline to 3 to 5 days** - longer causes rhinitis medicamentosa. [Dhingra 8e]",
        "**Allergen immunotherapy, subcutaneous or sublingual, for 3 to 5 years** is the only disease-modifying treatment. [ARIA 2020]",
        "Immunotherapy is for proven single or few allergen sensitisation with inadequate response to drugs. [ARIA 2020]",
        "Immunotherapy can prevent progression to asthma. [ARIA 2020]",
      ],
    },
    {
      heading: "Acute rhinosinusitis: diagnosis and the antibiotic decision",
      points: [
        "**Acute rhinosinusitis is symptomatic inflammation of the nose and paranasal sinuses lasting under 12 weeks.** [EPOS 2020]",
        "Diagnose on **nasal blockage or obstruction plus nasal discharge**, anterior or posterior. [EPOS 2020]",
        "Plus **facial pain or pressure, and/or reduction of smell**. [EPOS 2020]",
        ...
        "Suspect bacterial infection when **symptoms persist beyond 10 days without improvement**. [IDSA 2012]",
        "Suspect bacterial infection on **severe onset with fever above 39 degrees C and purulent discharge for at least 3 to 4 consecutive days**. [IDSA 2012]",
        ...
        "Staphylococcus aureus and anaerobes matter in chronic and dental-origin disease. [Dhingra 8e]",
        ...
        "**Contrast CT of the sinuses and orbit** is reserved for suspected complications, unilateral disease, failure to respond, or preoperative planning. [EPOS 2020]",
        "Symptomatic treatment: saline irrigation plus **intranasal mometasone 2 sprays twice daily**, which has evidence in acute rhinosinusitis. [EPOS 2020]",
        "Add analgesia, steam inhalation and adequate fluids. [EPOS 2020]",
        "Topical decongestants for **no more than 3 to 5 days**. [Dhingra 8e]",
        "When an antibiotic is indicated: **amoxicillin-clavulanate 625 mg three times daily in adults for 5 to 10 days**. [ICMR AMR 2022]",
        "Children: **amoxicillin-clavulanate 90/6.4 mg/kg/day in two divided doses**. [IDSA 2012]",
        "Penicillin allergy in adults: **doxycycline 100 mg twice daily**. [IDSA 2012]",
        "**Levofloxacin 500 mg daily** only where a fluoroquinolone is unavoidable. [IDSA 2012]",
    ...
    },
    {
      ...
      points: [
        "**Chronic rhinosinusitis is the same symptom complex lasting 12 weeks or more.** [EPOS 2020]",
        "It is subdivided into chronic rhinosinusitis **with** nasal polyps and **without** nasal polyps. [EPOS 2020]",
        ...
        "Contributing factor: allergic rhinitis and asthma. [EPOS 2020]",
        "Contributing factor: **Samter triad of asthma, nasal polyps and aspirin sensitivity**. [EPOS 2020]",
        "Contributing factor: deviated nasal septum. [Dhingra 8e]",
        "Contributing factor: **dental infection of upper premolars and molars**. [Dhingra 8e]",
        "Contributing factor: immunodeficiency. [EPOS 2020]",
        "Contributing factor in children: **cystic fibrosis and primary ciliary dyskinesia**. [EPOS 2020]",
        "Contributing factor: biomass or occupational exposure. [ICMR AMR 2022]",
        "Treatment: **long-term intranasal corticosteroid**, with high-volume steroid irrigation in polyp disease. [EPOS 2020]",
        "Treatment: saline irrigation and treatment of the underlying allergy. [EPOS 2020]",
        "Severe polyposis: **oral prednisolone 0.5 mg/kg for 5 to 7 days** under supervision. [EPOS 2020]",
        "Prolonged low-dose macrolide is used by ENT in selected non-polypoid cases. [EPOS 2020]",
        "**Functional endoscopic sinus surgery (FESS)** after failure of maximal medical treatment. [EPOS 2020]",
        "FESS also for complications, mucocoele, fungal disease and antrochoanal polyp. [Dhingra 8e]",
        "FESS treats the obstructed drainage pathway - it is not a cure for allergy. [EPOS 2020]",
        "**Invasive fungal rhinosinusitis (mucormycosis)**: consider in uncontrolled diabetes and ketoacidosis. [ICMR Mucormycosis 2021]",
        "Also in transplant recipients, and after systemic steroid or prolonged oxygen exposure. [ICMR Mucormycosis 2021]",
        "Mucormycosis signs: **black necrotic eschar on the palate or turbinate**, facial numbness or swelling. [ICMR Mucormycosis 2021]",
        "Mucormycosis signs: orbital pain, ophthalmoplegia and proptosis. [ICMR Mucormycosis 2021]",
        "Mucormycosis is a **surgical emergency - urgent biopsy, liposomal amphotericin B and debridement**. [ICMR Mucormycosis 2021]",
        "**Unilateral nasal symptoms are the referral rule of this topic.** [EPOS 2020]",
        "Refer unilateral obstruction, unilateral blood-stained discharge, or a unilateral polyp. [EPOS 2020]",
        "Refer facial numbness, proptosis, epiphora or a loose upper tooth. [Dhingra 8e]",
    ...
    },
    {
      ...
      points: [
        "**Chandler grading of orbital complications: preseptal cellulitis, orbital cellulitis, subperiosteal abscess, orbital abscess, cavernous sinus thrombosis.** [Dhingra 8e]",
        "They arise most often from **ethmoid sinusitis in children through the thin lamina papyracea**. [Dhingra 8e]",
        "**Preseptal versus orbital cellulitis is the bedside distinction that must be made.** [Dhingra 8e]",
        "Preseptal cellulitis: lid swelling with **normal vision, normal eye movements and no proptosis**. [Dhingra 8e]",
        "Orbital cellulitis: **proptosis, painful or restricted eye movements, diplopia, chemosis**. [Dhingra 8e]",
        "Orbital cellulitis: reduced acuity or colour vision - the sign of optic nerve compromise. [Dhingra 8e]",
        "Orbital cellulitis requires **admission, intravenous antibiotics and urgent contrast CT**. [Dhingra 8e]",
        "Intracranial complications: meningitis, and extradural, subdural and frontal lobe abscess. [Dhingra 8e]",
        "Intracranial complication: cavernous sinus thrombosis. [Dhingra 8e]",
        ...
        "Review allergic rhinitis at **2 to 4 weeks after starting an intranasal steroid**. [ARIA 2020]",
        "**Check spray technique and adherence before adding a second drug.** [ARIA 2020]",
        "Reassess asthma control at every rhinitis review. [ARIA 2020]",
        "Step down in the off-season while continuing avoidance measures. [ARIA 2020]",
        "**Allergic rhinitis is controlled, not cured**, unless immunotherapy is used. [ARIA 2020]",
        "Give every patient a written plan naming the drug, the dose, the technique and the review date. [ARIA 2020]",
        "Document **school days or work days lost, sleep disturbance and asthma exacerbations**. [ARIA 2020]",
        "Those are the outcome measures that justify escalating treatment and that examiners expect a family physician to record.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Intermittent: fewer than 4 days a week, or fewer than 4 consecutive weeks.** [ARIA 2020]",
            "**Persistent: 4 or more days a week and more than 4 weeks.** [ARIA 2020]",
            "**Mild: normal sleep, daily activities, sport and work, and no troublesome symptoms.** [ARIA 2020]",
            "**Moderate-severe: one or more of those is impaired.** [ARIA 2020]",
        ...
        },
        {
          ...
          points: [
            "History: pattern, seasonality, and indoor and outdoor triggers. [ARIA 2020]",
            "History: occupation, pets, damp housing, and biomass and tobacco smoke exposure. [ARIA 2020]",
            "History: family history of atopy and previous drug response. [ARIA 2020]",
            "Ask about asthma symptoms - **wheeze, nocturnal cough, exercise limitation**. [ARIA 2020]",
            "Ask about eczema, conjunctivitis, snoring and daytime somnolence. [ARIA 2020]",
            "Examination: **pale boggy bluish turbinates with clear secretions**. [Dhingra 8e]",
            "Examination: allergic salute crease, allergic shiners, Dennie-Morgan lines. [Dhingra 8e]",
            "Examination: pharyngeal cobblestoning, and adenoid facies in children. [Dhingra 8e]",
            "Examination: a deliberate search for **nasal polyps and septal deviation**. [Dhingra 8e]",
            "Investigations: **none routinely** in primary care. [ARIA 2020]",
            "**Skin prick testing or specific serum IgE** when the diagnosis is doubtful or immunotherapy is planned. [ARIA 2020]",
            "**Total IgE and absolute eosinophil count are not diagnostic.** [ARIA 2020]",
            "Differential: vasomotor and other non-allergic rhinitis, and infective rhinitis. [Dhingra 8e]",
            "Differential: **rhinitis medicamentosa** and drug-induced rhinitis. [Dhingra 8e]",
            "Differential: hormonal rhinitis of pregnancy, nasal polyposis and deviated septum. [Dhingra 8e]",
            "Differential in a child: **a nasal foreign body**. [Dhingra 8e]",
          ],
        },
        {
          heading: "3. Non-pharmacological management",
          points: [
            "Allergen avoidance: mattress and pillow covers, and weekly hot washing of bedding. [ARIA 2020]",
            "Allergen avoidance: remove carpets and soft toys from the bedroom. [ARIA 2020]",
            "Allergen avoidance: damp and mould control, cockroach control, windows closed in the pollen season. [ARIA 2020]",
            "**Complete avoidance of tobacco smoke** and reduction of biomass fuel exposure. [ARIA 2020]",
            "Switch to LPG or improved stoves where possible. [ICMR AMR 2022]",
            ...
            "Educate on the chronic relapsing nature of the illness. [ARIA 2020]",
        ...
        },
        {
          ...
          points: [
            "Mild intermittent: an oral second-generation antihistamine as required. [ARIA 2020]",
            "**Levocetirizine 5 mg or fexofenadine 120 to 180 mg once daily.** [ARIA 2020]",
            "Persistent or moderate-severe: **intranasal corticosteroid first line**. [ARIA 2020]",
            "**Fluticasone propionate or mometasone furoate 2 sprays per nostril once daily.** [ARIA 2020]",
            "Continue the intranasal steroid for at least **2 to 4 weeks** before judging response. [ARIA 2020]",
            "Inadequate control: add **intranasal azelastine**, or combine an intranasal steroid with an antihistamine. [ARIA 2020]",
            "Consider **montelukast 10 mg at night** where asthma coexists, with counselling about neuropsychiatric effects. [ARIA 2020]",
            "Short-term topical decongestant for **3 to 5 days only**, for severe blockage. [Dhingra 8e]",
            "**Avoid oral decongestants in hypertension, ischaemic heart disease, glaucoma and prostatism.** [ARIA 2020]",
            "Avoid first-generation antihistamines - sedation and anticholinergic effects. [ARIA 2020]",
            "**Avoid depot steroid injections entirely.** [ARIA 2020]",
            "**Allergen immunotherapy, subcutaneous or sublingual for 3 to 5 years**, is the only disease-modifying option. [ARIA 2020]",
            "Immunotherapy is considered for proven mono-sensitisation with inadequate control. [ARIA 2020]",
          ],
        },
        {
          ...
          points: [
            "**About 80% of asthmatics have rhinitis**, and 20 to 40% of patients with rhinitis have asthma. [ARIA 2020]",
            "Untreated rhinitis worsens asthma control and increases exacerbations and emergency visits. [ARIA 2020]",
            "Treating rhinitis improves asthma symptoms and reduces rescue inhaler use. [ARIA 2020]",
            "**Assess asthma control at every rhinitis visit** with peak flow or spirometry where available. [ARIA 2020]",
            "Other co-morbidities: otitis media with effusion, and chronic rhinosinusitis with or without polyps. [EPOS 2020]",
            "Other co-morbidities: sleep-disordered breathing and allergic conjunctivitis. [ARIA 2020]",
          ],
        },
        {
          heading: "6. Follow-up and referral",
          points: [
            "Review at **2 to 4 weeks**: check symptom control, spray technique, adherence and adverse effects before escalating. [ARIA 2020]",
            "**Refer for unilateral symptoms or blood-stained discharge** - malignancy until proved otherwise. [EPOS 2020]",
            "Refer nasal polyps not responding to medical treatment. [EPOS 2020]",
            "Refer suspected **CSF rhinorrhoea**. [Dhingra 8e]",
            "Refer for consideration of immunotherapy or surgery. [ARIA 2020]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Symptoms persisting beyond 10 days without any improvement.** [IDSA 2012]",
            "**Severe onset with temperature above 39 degrees C and purulent nasal discharge for at least 3 to 4 consecutive days.** [IDSA 2012]",
            "**Double sickening** - initial improvement followed by clear worsening after 5 to 6 days. [EPOS 2020]",
            "Supporting features: unilateral localised facial pain and tenderness, and unilateral purulent discharge. [EPOS 2020]",
            "Supporting feature: raised inflammatory markers. [EPOS 2020]",
            "**The colour of discharge alone is not discriminating.** [AAO-HNS 2015]",
            "**Plain sinus radiographs are not recommended for diagnosis.** [AAO-HNS 2015]",
          ],
        },
        {
          heading: "Organisms",
          points: [
            "**Streptococcus pneumoniae, non-typeable Haemophilus influenzae and Moraxella catarrhalis.** [IDSA 2012]",
            "**Staphylococcus aureus and anaerobes** in dental-origin and chronic disease. [Dhingra 8e]",
            "**Fungi** in the immunocompromised and the uncontrolled diabetic. [ICMR Mucormycosis 2021]",
          ],
        },
        {
          heading: "Management",
          points: [
            "Symptomatic in all: saline nasal irrigation. [EPOS 2020]",
            "Intranasal corticosteroid such as **mometasone 2 sprays twice daily**. [EPOS 2020]",
            "Analgesia with paracetamol or ibuprofen, plus steam inhalation and fluids. [EPOS 2020]",
            "Topical decongestant for **no more than 3 to 5 days**. [Dhingra 8e]",
            "Antibiotic when bacterial criteria are met: **amoxicillin-clavulanate 625 mg three times daily for 5 to 10 days** in adults. [ICMR AMR 2022]",
            "Children: **amoxicillin-clavulanate 90/6.4 mg/kg/day in two divided doses**. [IDSA 2012]",
            "Penicillin allergy: **doxycycline 100 mg twice daily**, or levofloxacin 500 mg daily. [IDSA 2012]",
            "**Azithromycin and cotrimoxazole are poor choices** because of pneumococcal resistance. [IDSA 2012]",
            "**Contrast CT of sinuses and orbit only for suspected complications**, unilateral disease, failure to respond, immunocompromise or preoperative planning. [EPOS 2020]",
            "Refer for recurrent acute rhinosinusitis - **four or more episodes a year**. [EPOS 2020]",
            "Refer after failure of two antibiotic courses, or for anatomical obstruction needing FESS. [EPOS 2020]",
          ],
        },
        {
          heading: "Complications",
          points: [
            "**Chandler orbital grading: preseptal cellulitis, orbital cellulitis, subperiosteal abscess, orbital abscess, cavernous sinus thrombosis.** [Dhingra 8e]",
            "**Painful or restricted eye movement, proptosis, chemosis or reduced vision means orbital involvement and admission.** [Dhingra 8e]",
            "Bony: frontal bone osteomyelitis with a boggy forehead swelling - **Pott puffy tumour**. [Dhingra 8e]",
            "Bony: osteomyelitis of the maxilla in infants. [Dhingra 8e]",
            "Intracranial: meningitis, and extradural, subdural and frontal lobe abscess. [Dhingra 8e]",
            "Intracranial: cavernous sinus thrombosis. [Dhingra 8e]",
            "Descending infection: pharyngitis, otitis media, bronchitis, and exacerbation of asthma. [Dhingra 8e]",
          ],
        },
      ],
      mustDraw: [
