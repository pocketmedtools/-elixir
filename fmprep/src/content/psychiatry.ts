      ...
      answer: [
        {
          ...
          points: [
            "Ask the **PHQ-2** screening questions first, then all nine PHQ-9 items over the past two weeks.",
            "Record the **PHQ-9 total (0-27)** and the tenth functional-difficulty item.",
            ...
            "Ask for past depression and a **family history of depression or suicide**.",
          ],
        },
        {
          heading: "2. Suicide risk assessment",
          points: [
            "Ask directly and in graded steps - the enquiry itself is protective.",
            "Graded steps: life not worth living, thoughts of ending life, a method, preparation, previous attempts.",
            "Record **ideation, plan, means (pesticides, tablets), intent and past attempts**.",
            "Record risk multipliers: alcohol, isolation, hopelessness, chronic illness.",
            "Record protective factors: children, faith, family support.",
            "Classify the risk as **low, moderate or high** and write the classification in the notes.",
            "**High risk** = plan plus means plus intent, or a recent attempt.",
            "High risk means **same-day psychiatric assessment and admission with a family member**.",
            "Moderate or low risk: write a **safety plan** and involve a named relative.",
            "Remove means from the house and give the **Tele-MANAS number 14416**.",
        ...
        },
        {
          ...
          points: [
            ...
            "Assess thought content including **guilt and suicidal ideas**, and cognition.",
        ...
        },
        {
          ...
          points: [
            ...
            "**Mild (PHQ-9 5-9)**: behavioural activation, daily walking, sleep hygiene, problem-solving counselling.",
            "Mild depression: review in **two weeks** before considering a drug. [NICE NG222 2022]",
            "**Moderate to severe (PHQ-9 10 or more)**: escitalopram 10 mg in the morning or sertraline 50 mg daily.",
            ...
            "**Avoid amitriptyline if there is any suicide risk** - lethal in overdose.",
            ...
            "Link to the **District Mental Health Programme** for free drugs and a counsellor.",
          ],
        },
        {
          heading: "5. Follow-up and referral",
          points: [
            "Review at **2 weeks**: side effects, adherence, suicide enquiry.",
            "Review at **4 weeks** with a repeat PHQ-9.",
            "Review at **6-8 weeks**: increase the dose or switch if the score has not fallen by half.",
            "Target **remission - PHQ-9 under 5**, not merely improvement.",
            ...
            "Refer for **high suicide risk, psychosis or bipolar features**.",
            "Refer for failure of **two adequate trials**, or refusal of food and fluids.",
          ],
        },
      ],
      mustDraw: [
