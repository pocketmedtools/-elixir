  ...
  sections: [
    {
      ...
      points: [
        ...
        "In the Indian family practice waiting room depression presents as **bodily complaints** - fatigue, headache, generalised body pain, burning, gas, poor sleep and appetite.",
        "The mood symptom emerges only when asked for - this is the culturally normal idiom of distress, not denial.",
        ...
        "**PHQ-2** asks, over the last two weeks: little interest or pleasure in doing things, and feeling down, depressed or hopeless.",
        "PHQ-2 score **3 or more out of 6** is positive - sensitivity about **80%**; follow it with the full PHQ-9.",
        "Screen every patient with unexplained multiple somatic symptoms, **more than 3 visits in 3 months**, poorly controlled chronic disease, or a recent loss.",
    ...
    },
    {
      ...
      points: [
        ...
        "**PHQ-9** scores each of the nine symptoms **0 (not at all) to 3 (nearly every day)** over the past two weeks, total 0-27.",
        "PHQ-9 bands: **0-4 none, 5-9 mild, 10-14 moderate, 15-19 moderately severe, 20-27 severe**.",
        "PHQ-9 **10 or more**: 88% sensitivity and 88% specificity for major depression - the drug-treatment threshold.",
        "PHQ-9 is validated in **Hindi, Tamil, Kannada, Malayalam** and other Indian languages - use the patient's own language version.",
        "**PHQ-9 item 9** - better off dead or hurting yourself - is a screening item, not a suicide risk assessment.",
        "Any positive item 9 means a **direct suicide enquiry at the same visit**.",
        "The tenth PHQ-9 question, on functional difficulty, is what decides **treatment intensity**.",
        "Ask about **mania or hypomania** before calling it unipolar - an antidepressant alone in bipolar disorder precipitates mania.",
    ...
    },
    {
      ...
      points: [
        ...
        "**Asking about suicide does not increase risk** - it is the single most protective act in the consultation.",
        ...
        "Record **five dimensions** of risk: ideation, plan, means, intent and preparation, and past attempts.",
        ...
        "**A previous attempt is the strongest single predictor** of completed suicide.",
        ...
        "Further multipliers: psychosis, severe hopelessness, family history of suicide, **access to pesticides** in farming households.",
        "Protective factors to elicit: dependent children, religious beliefs against suicide, a spouse or parent who can stay with the patient.",
        "Also protective: willingness to engage with treatment, and **a reason for living the patient can name** when asked.",
        "**High risk**: active ideation with plan, means and intent, or a recent attempt, or psychosis.",
        "High risk needs **same-day psychiatric assessment and admission** - never a prescription and an appointment next week.",
        "**Moderate risk**: ideation without plan or intent and no past attempt.",
        "Moderate risk: inform the family, remove means, write a safety plan, start treatment, review within **48-72 hours**.",
        "**Low risk**: fleeting passive thoughts, no plan, good supports - weekly review plus the safety plan.",
        "The **safety plan** is written with the patient and lists warning signs, coping steps, people to call and the physician's number.",
        "Give the **Tele-MANAS helpline 14416** (or 1-800-891-4416) - 24-hour counselling in regional languages.",
        "A **named relative commits** to keeping pesticides, ropes and tablets out of the house.",
        "Dispense antidepressants in **small quantities** to anyone at suicide risk.",
        "Avoid tricyclics at suicide risk - **a week's supply of amitriptyline is lethal in overdose**.",
      ],
    },
    {
      ...
      points: [
        ...
        "Mild depression: psychoeducation plus **behavioural activation** - a daily schedule of small pleasurable and mastery activities.",
        ...
        "**Escitalopram 10 mg once daily in the morning** - 5 mg in the elderly, maximum 20 mg.",
        ...
        "Tell the patient the antidepressant is **not habit-forming** - the commonest reason for refusal in India.",
        ...
        "**Mirtazapine 7.5-30 mg at night** where insomnia and weight loss dominate, or SSRIs cause sexual dysfunction.",
        "**Amitriptyline 25-75 mg at night** only when there is coexisting neuropathic pain or migraine.",
        "Never amitriptyline in cardiac disease, the elderly, or a patient at suicide risk.",
        "Avoid **paroxetine** in pregnancy and in the elderly - anticholinergic effects and severe withdrawal.",
        "SSRI **hyponatraemia** in the elderly: check sodium at **2 weeks** if over 65 or on a diuretic.",
        "SSRI with an NSAID or aspirin raises **GI bleeding** risk - add a proton pump inhibitor.",
        "SSRIs cause **sexual dysfunction** - ask directly, it is a silent cause of stopping.",
        "Transient rise in anxiety and suicidal thinking in the **under-25s** in the first weeks - review weekly.",
        ...
        "Then switch to another SSRI, or mirtazapine, or **venlafaxine 75-150 mg** - watch blood pressure.",
        "Refer after **two adequate trials fail**, or if there are psychotic features, or if bipolarity is suspected.",
        ...
        "Discontinuation symptoms are worst with **paroxetine and venlafaxine**, least with fluoxetine.",
      ],
    },
    {
      heading: "Follow-up, special groups and the system around the patient",
      points: [
        "Review at **2 weeks**: side effects, adherence and a repeat suicide enquiry.",
        "Review at **4 weeks** with the **PHQ-9 repeated** - measure, do not guess.",
        "Review at **6-8 weeks** to decide on dose increase or switch, then monthly.",
        "**Response = a 50% fall in the PHQ-9**; **remission = a score under 5**, which is the target.",
        "Residual symptoms predict relapse - treat to remission, not to improvement.",
        ...
        "In the elderly depression masquerades as memory complaints (**pseudodementia**), somatic preoccupation and agitation.",
        "Elderly: start **escitalopram 5 mg or sertraline 25 mg**, check sodium, and watch for falls.",
        "In adolescents **fluoxetine is the only SSRI with clear evidence**, started at **10 mg**.",
        "Review adolescents **weekly for the first month** - early rise in suicidal ideation. [NICE NG222 2022]",
        ...
        "The **District Mental Health Programme** provides free psychiatric drugs at district hospitals and community health centres.",
        "**Tele-MANAS (14416)** offers 24-hour counselling in regional languages.",
        ...
        "Refer to a psychiatrist for **high suicide risk**, psychotic symptoms or bipolar features.",
        "Refer after **failure of two adequate antidepressant trials**.",
        "Refer severe depression with **refusal of food and fluids** - needs admission and possibly ECT.",
