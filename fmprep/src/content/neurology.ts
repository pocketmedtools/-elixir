  ...
  sections: [
    {
      ...
      points: [
        ...
        "A normal scan excludes none of the primary headaches and does not treat the patient.",
        ...
        "Both counts are also the outcome measure you follow at review.",
      ],
    },
    {
      ...
      points: [
        ...
        "Prodrome: yawning, food craving, irritability and neck stiffness, hours to a day before the pain.",
        "Then aura, then headache, then postdrome - the washed-out day after.",
        ...
        "Menstrual attacks are longer, more severe and less responsive to treatment.",
        ...
        "These need imaging to exclude TIA, focal seizure, arteriovenous malformation or a structural lesion.",
      ],
    },
    {
      ...
      points: [
        ...
        "It is the commonest headache in the population but the least often brought to the doctor.",
        ...
        "These are conjunctival injection, lacrimation, nasal congestion or rhinorrhoea, eyelid oedema, ptosis and miosis.",
        "**Restlessness and pacing** during the attack - the migraineur instead lies still in a dark room.",
        "Cluster favours men and smokers, with alcohol as a trigger during a bout.",
        "Circadian periodicity often wakes the patient at the same hour each night.",
        "Circannual clustering gives pain-free remissions of months to years between bouts.",
        ...
        "Titrate verapamil with a baseline and serial ECG - it causes PR prolongation and heart block.",
        ...
        "Triggered by chewing, talking, shaving, cold wind or touching a trigger zone, with a refractory period between paroxysms.",
        ...
        "That MRI is to exclude multiple sclerosis or a cerebellopontine angle tumour.",
        "Hemicrania continua and paroxysmal hemicrania respond **absolutely to indomethacin 25-75 mg TDS**.",
        "The indomethacin response is itself the diagnostic test.",
        "A strictly unilateral daily headache with autonomic features deserves an indomethacin trial with gastric protection.",
      ],
    },
    {
      ...
      points: [
        ...
        "Add CT or MR angiography if suspicion persists after CT and lumbar puncture.",
        "Also consider reversible cerebral vasoconstriction syndrome, cervical artery dissection and pituitary apoplexy.",
        "Fever with headache and neck stiffness is meningitis until proved otherwise.",
        "**Do not delay the first dose of antibiotic** for imaging or for the lumbar puncture.",
        ...
        "Use **intravenous methylprednisolone** instead if there is visual loss.",
        ...
        "With papilloedema this means a mass lesion, cerebral venous sinus thrombosis or idiopathic intracranial hypertension.",
        "Idiopathic intracranial hypertension classically affects a young obese woman.",
        ...
        "Treat with **acetazolamide and weight loss**, and refer urgently if vision is threatened.",
        "Headache in pregnancy or the puerperium: check **blood pressure and urine protein first, always**. [SNNOOP10 2019]",
        "Then exclude cerebral venous sinus thrombosis and posterior reversible encephalopathy syndrome.",
        "Headache in an immunosuppressed or HIV-positive patient needs contrast imaging and usually cerebrospinal fluid examination.",
        "Cryptococcal meningitis, cerebral toxoplasmosis, tuberculoma and primary CNS lymphoma all present with slowly progressive headache and few signs.",
        "**Non-contrast CT** is the test for acute haemorrhage and trauma. [NICE CG150 2021]",
        "**MRI** is the test for posterior fossa and pituitary lesions and for low- and high-pressure syndromes.",
        "**MR venography** is the test for cerebral venous sinus thrombosis.",
        "**CT or MR angiography** is the test for aneurysm and arterial dissection.",
      ],
    },
    {
      ...
      points: [
        ...
        "Triptans are avoided rather than absolutely forbidden in pregnancy.",
        ...
        "Ergot adds vascular risk on top of that poor efficacy.",
        ...
        "Clinic rescue for a severe or prolonged attack starts with intravenous fluids.",
    ...
    },
    {
      ...
      points: [
        ...
        "Avoid propranolol in asthma, in bradycardia and in depression.",
        "Propranolol blunts the tachycardia of hypoglycaemia in a diabetic.",
        ...
        "Avoid amitriptyline in glaucoma, prostatism and cardiac conduction disease.",
        ...
        "Topiramate produces paraesthesiae, word-finding difficulty and renal stones.",
        ...
        "Bridge the withdrawal with naproxen or a short prednisolone taper.",
        ...
        "Avoid imposing long elimination diets - they rarely help and often harm nutrition.",
      ],
    },
    {
      ...
      points: [
        ...
        "NSAIDs are also avoided near conception.",
        "Metoclopramide is safe in pregnancy.",
        "Accumulated registry data for **sumatriptan** in pregnancy are reassuring.",
        "For prevention in pregnancy use **low-dose propranolol or amitriptyline**.",
        ...
        "Migraine improves in about **two-thirds** of women during the second and third trimesters.",
        "Migraine typically worsens again postpartum and around the perimenopause.",
        ...
        "Abdominal pain, motion sickness and travel-related vomiting are prominent in children.",
        ...
        "Flunarizine and propranolol are the usual paediatric preventives.",
        "New headache in a person over **50 years** is secondary until proved otherwise. [SNNOOP10 2019]",
        "Consider giant cell arteritis, subdural haematoma, a mass lesion, cervical spondylosis and glaucoma.",
        "Ask specifically about a fall or anticoagulation when subdural haematoma is possible.",
        "Migraine with aura roughly **doubles** the risk of ischaemic stroke.",
        "That risk multiplies further with smoking and combined oral contraceptives.",
        "Smoking cessation and contraceptive review are therefore part of migraine care, not a separate consultation.",
        "Idiopathic intracranial hypertension: obese young woman with headache, transient visual obscurations, pulsatile tinnitus and papilloedema.",
        "Assess **visual fields urgently** - vision, not headache, is what is lost permanently.",
        "First line is weight loss plus **acetazolamide 250-500 mg PO twice daily**.",
        "Failing vision is an indication for shunting or optic nerve sheath fenestration.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          heading: "1. History",
          points: [
            "Ask how many distinct types of headache she has, and take each type separately.",
            "For each type: onset, site, character, severity, duration, frequency and **headache days per month**.",
            "Associated features: nausea, vomiting, photophobia, phonophobia and osmophobia.",
            "Aura: visual scintillations spreading over minutes and lasting **under an hour**. [ICHD-3 2018]",
            "Ask about prodrome and postdrome - patients report them only when asked directly.",
            "Behaviour during the attack, and effect on work and family.",
            "Record disability objectively with the **MIDAS or HIT-6 score**.",
            "Triggers: sleep deprivation, missed meals, menstruation, and stress or the let-down after stress.",
            "Also bright light and travel, and the relationship of attacks to the menstrual cycle.",
            "Drug history is critical: name every analgesic she uses.",
            ...
            "Ask about every preventive already tried, with its dose and duration.",
        ...
        },
        {
          ...
          points: [
            "Blood pressure and temperature at every headache visit.",
            "**Fundus examination for papilloedema** - the one sign that changes management immediately.",
            "Cranial nerves including visual fields, then motor and sensory screen, gait and neck movements.",
            "Palpate the temporal arteries and the temporomandibular joints.",
            "Examine the sinuses and teeth for a local cause.",
            ...
            "Haemoglobin, blood sugar and thyroid function only if the picture is atypical.",
            "Refraction assessment if the headache is eye-strain related.",
        ...
        },
        {
          ...
          points: [
            ...
            "Regularise sleep and meal times, and ensure hydration.",
            "Encourage **30 minutes of aerobic exercise most days**.",
            "Treat coexistent anxiety, depression and neck pain - untreated they drive chronification.",
            "Keep a **headache diary**: headache days, severity, analgesic days and menstrual relationship. [NICE CG150 2021]",
            "The diary is both the diagnostic tool and the outcome measure.",
            "Identify triggers but do not obsess over them.",
            "Avoid long elimination diets.",
          ],
        },
        {
        ...
        },
        {
          ...
          points: [
            ...
            "Refer for diagnostic doubt, failure of **two adequate preventives**, or chronic migraine.",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "That suggests subarachnoid haemorrhage, reversible cerebral vasoconstriction syndrome, cervical artery dissection or pituitary apoplexy.",
            "Systemic symptoms - fever, neck stiffness, rash, weight loss. [SNNOOP10 2019]",
            "Those suggest meningitis, encephalitis, brain abscess or malignancy.",
            "Neurological deficit, seizure, altered consciousness or personality change. [SNNOOP10 2019]",
            "Those suggest a space-occupying lesion, stroke or encephalitis.",
            "Onset after **50 years** with scalp tenderness or jaw claudication - giant cell arteritis. [SNNOOP10 2019]",
            "Onset in a child with morning vomiting - posterior fossa tumour.",
            "Papilloedema, or headache worsened by lying flat, coughing or straining. [SNNOOP10 2019]",
            "That means raised intracranial pressure, venous sinus thrombosis or idiopathic intracranial hypertension.",
            ...
            "Painful red eye with haloes - acute angle-closure glaucoma.",
        ...
        },
        {
          ...
          points: [
            ...
            "Then CT or MR angiography if suspicion persists.",
            "Fever with meningism: blood cultures, then the **first dose of ceftriaxone** without waiting.",
            "Then CT if there are focal signs or altered sensorium.",
            "Then lumbar puncture for cell count, protein, glucose, Gram stain and culture.",
            "Add CBNAAT and India ink where tuberculosis or cryptococcus is possible.",
            "Suspected giant cell arteritis: **ESR and C-reactive protein immediately**. [API 11e 2019]",
            "Give **prednisolone the same day**, before the biopsy.",
            "Temporal artery biopsy **within 1-2 weeks**.",
            "Raised intracranial pressure: **MRI brain with MR venography** first. [NICE CG150 2021]",
            "Then lumbar puncture with **opening pressure**, once a mass is excluded.",
            "Focal deficit or seizure: **contrast MRI brain**.",
            "MRI is superior to CT for posterior fossa, temporal lobe and small lesions.",
            "Immunosuppression: contrast MRI plus cerebrospinal fluid studies.",
            "Cerebrospinal fluid for India ink, cryptococcal antigen, CBNAAT for tuberculosis and toxoplasma serology.",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Cluster pain is boring and excruciating; migraine pain is pulsating and moderate to severe.",
            ...
            "Cluster often wakes the patient at a fixed hour - circadian periodicity is characteristic.",
            "Ipsilateral autonomic features are the hallmark of cluster and are absent or minor in migraine.",
            "These are lacrimation, conjunctival injection, rhinorrhoea, ptosis, miosis and eyelid oedema.",
            "Behaviour: cluster patients are **restless and pace**; migraineurs **lie still in a dark room**.",
            "Alcohol reliably triggers a cluster attack during a bout but not in remission.",
            "Migraine triggers are sleep disturbance, hunger, stress and menstruation.",
          ],
        },
        {
          ...
          points: [
            ...
            "Oxygen aborts the attack in most patients and has no drug interactions.",
            ...
            "Oral analgesics, oral triptans and opioids are useless - they act too slowly for an attack this short.",
          ],
        },
        {
          heading: "Prophylaxis",
          points: [
            ...
            "Baseline ECG and a repeat ECG after each increment - verapamil causes PR prolongation and heart block.",
            "**Prednisolone 60 mg daily for 5 days then tapered over 2-3 weeks** bridges until verapamil works.",
            "A greater occipital nerve block is an alternative bridge.",
            "Lithium, topiramate and melatonin are second-line preventives.",
            "Refer chronic cluster headache to neurology.",
            "Advise complete abstinence from alcohol and tobacco during a bout.",
  ...
  sections: [
    {
      ...
      points: [
        ...
        "Headache, vomiting, early depressed consciousness and very high blood pressure make haemorrhage more likely.",
        ...
        "The outcome determinant a general practice can influence is the **interval from onset to the CT scanner**.",
    ...
    },
    {
      ...
      points: [
        ...
        "Adding balance and eyes to the original FAST captures posterior circulation strokes that FAST misses.",
        ...
        "Other mimics: Todd paresis after a seizure, complicated migraine with aura, hypertensive encephalopathy.",
        "Other mimics: subdural haematoma, brain tumour, conversion disorder, and sepsis unmasking an old deficit.",
        "Bell palsy involves the forehead; stroke **spares the forehead** - the separating sign.",
    ...
    },
    {
      ...
      points: [
        ...
        "Never send a suspected stroke to the scanner without a glucose number.",
        ...
        "Secure an intravenous line in the **non-paretic arm**.",
        ...
        "Never give sublingual nifedipine - the uncontrolled drop extends the infarct.",
        "Never give intramuscular injections - they preclude thrombolysis.",
        "Never catheterise as a reflex - catheterise only for retention.",
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        ...
        "Those signs are loss of grey-white differentiation, insular ribbon sign, hyperdense middle cerebral artery and sulcal effacement.",
        "**A normal CT does not exclude infarction** - it excludes blood only.",
        ...
        "It presents with headache, seizures, papilloedema and deficits that cross arterial territories.",
        "Suspect it in a postpartum or dehydrated patient.",
    ...
    },
    {
      ...
      points: [
        ...
        "Prevent aspiration by feeding sitting upright, with thickened fluids and small boluses.",
        ...
        "Prevent shoulder subluxation with correct positioning and by **never pulling on the paretic arm**.",
        "Treat constipation and urinary retention actively.",
        ...
        "**Post-stroke depression affects about a third of survivors** and is under-treated.",
        "Screen at follow-up with the **PHQ-9**.",
        "Treat with an SSRI - sertraline or escitalopram - plus counselling.",
        "Also screen for post-stroke pain, spasticity, seizures and vascular cognitive impairment.",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Secure intravenous access in the **non-paretic arm** with normal saline.",
            "Avoid dextrose-containing fluids - they worsen cerebral oedema.",
            "Avoid intramuscular injections - they preclude thrombolysis.",
            "Record blood pressure, pulse, temperature and Glasgow Coma Scale.",
            "Score the **NIHSS** for a reproducible baseline. [AHA/ASA 2019]",
            "Take an ECG looking for atrial fibrillation.",
          ],
        },
        {
          heading: "2. Focused examination",
          points: [
            "Confirm the vascular syndrome: face, arm and leg power, sensory loss, visual fields and gaze deviation.",
            "Test speech for fluency, comprehension, naming and repetition.",
            "Test for neglect and check the plantar responses.",
            "Look for the cause: irregular pulse suggesting atrial fibrillation.",
            "Listen for the murmur of rheumatic mitral stenosis and for a carotid bruit.",
            "Measure blood pressure in **both arms** - a difference suggests aortic dissection.",
            "Exclude mimics: examine for signs of head injury.",
            "Tongue bite or incontinence suggests a seizure with Todd paresis.",
            "Fever suggests sepsis or meningitis rather than stroke.",
          ],
        },
        {
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Note whether the forehead is spared - **stroke spares it, Bell palsy involves it**.",
          ],
        },
        {
          ...
          points: [
            ...
            "Intravenous normal saline in the **non-paretic arm**.",
        ...
        },
        {
          ...
          points: [
            ...
            "Community rehabilitation with dysphagia and aspiration prevention.",
            "Home safety and fall prevention, plus carer training and support.",
            "Screen and treat post-stroke depression, spasticity and seizures.",
  ...
  sections: [
    {
      ...
      points: [
        ...
        "An event lasting more than an hour usually leaves an infarct and is a minor stroke.",
    ...
    },
    {
      ...
      points: [
        ...
        "**Vertigo alone is almost never a TIA** - it needs other posterior circulation features alongside.",
        "Onset is **sudden and maximal at the start**, with complete resolution. [NICE NG128 2022]",
        "A march of symptoms over minutes suggests migraine aura, not TIA.",
        "A march over seconds with positive symptoms suggests a focal seizure.",
        ...
        "Mimic: migraine with aura - positive visual phenomena, gradual march, headache follows.",
        "Mimic: focal seizure with Todd paresis.",
        "Mimic: hypoglycaemia, syncope and vestibular disorders.",
        "Mimic: subdural haematoma, brain tumour, multiple sclerosis in the young, functional neurological disorder.",
        "**Crescendo TIA** is two or more attacks in a week, or rising frequency, duration or severity.",
        "Crescendo TIA carries a very high stroke risk and warrants admission. [NICE NG128 2022]",
        "Ask about neck pain, recent neck trauma or manipulation - cervical artery dissection.",
        "Ask about palpitation - paroxysmal atrial fibrillation.",
        "Ask about claudication and previous vascular surgery, and take a drug and contraceptive history.",
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        ...
        "Non-contrast CT is acceptable where MRI is unavailable, but a normal CT proves nothing.",
        ...
        "That means a murmur, rheumatic heart disease, prosthetic valve, recent myocardial infarction, a young patient, or no other cause found.",
        "Add a **bubble study for patent foramen ovale** in the young. [AHA/ASA 2021]",
        "Complete blood count - for polycythaemia, thrombocytosis and anaemia.",
        ...
        "In the young or where no cause is found, add thrombophilia and antiphospholipid antibodies.",
    ...
    },
    {
      ...
      points: [
        ...
        "Treat obstructive sleep apnoea - it drives both hypertension and recurrence.",
    ...
    },
    {
      ...
      points: [
        ...
        "At each review check blood pressure, adherence, bleeding and symptoms of recurrence.",
        "Check HbA1c, and lipids annually. [AHA/ASA 2021]",
        "Check renal function on an ACE inhibitor or diuretic.",
        ...
        "Check for and treat atrial fibrillation, heart failure and peripheral arterial disease.",
        "Check for and treat chronic kidney disease and obstructive sleep apnoea.",
        "Document driving advice and work restrictions.",
        "Occupational drivers need a formal fitness assessment before returning.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Take the history from the patient **and a witness**.",
            "Confirm sudden onset, maximal at onset, with focal negative symptoms.",
            "Confirm complete resolution, and record the duration in minutes.",
            "Determine the territory: right arm weakness with dysarthria is a **left carotid** event.",
            "Ask specifically about **amaurosis fugax in the left eye** - it localises to the left carotid.",
            "Exclude hypoglycaemia - ask whether he was on a sulfonylurea or insulin.",
            "Exclude focal seizure with Todd paresis, migraine aura and syncope.",
            "Exclude vestibular disorder and functional symptoms.",
            "Ask about previous similar events and current antiplatelet or anticoagulant use.",
            "Ask about palpitation, neck trauma and claudication.",
          ],
        },
        {
          heading: "2. Examination",
          points: [
            "Full neurological examination to confirm **no deficit remains** - a residual deficit means this is a stroke.",
            "Feel the pulse for atrial fibrillation.",
            "Blood pressure in **both arms**.",
            "Listen for carotid bruits and cardiac murmurs.",
            "Palpate the peripheral pulses for coexisting peripheral arterial disease.",
            "Fundus examination for retinal emboli and for hypertensive or diabetic retinopathy.",
        ...
        },
        {
          ...
          points: [
            ...
            "CT if MRI is unavailable, accepting that a normal CT proves nothing.",
            ...
            "Complete blood count, lipid profile, creatinine and electrolytes.",
            "ESR, and prothrombin time with INR.",
          ],
        },
        {
          ...
          points: [
            ...
            "Admit if there is no reliable access to rapid assessment.",
          ],
        },
        {
          ...
          points: [
            ...
            "Written care plan and driving advice.",
            "Warning symptoms taught to the family.",
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "Weight to a **BMI below 23 kg/m2** by Asian-Indian criteria. [IAN 2022]",
            "Screen and treat obstructive sleep apnoea.",
            "Screen and treat depression and physical deconditioning.",
        ...
        },
        {
          ...
          points: [
            ...
            "Structured follow-up with a written plan.",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Minutes** means transient ischaemic attack or panic.",
        ...
        "Take a full drug history: **aminoglycosides and high-dose furosemide are vestibulotoxic**.",
        "Antihypertensives, alpha blockers, nitrates, tricyclics and antipsychotics all cause dizziness by other routes.",
        "So do anticonvulsants, benzodiazepines and alcohol.",
        "**Phenytoin toxicity** produces vertigo with gaze-evoked nystagmus and ataxia.",
        ...
        "Examine the ears with an otoscope for wax, perforation, effusion and cholesteatoma.",
        "Do a **Rinne and Weber test** at the bedside.",
        "Arrange **pure tone audiometry** whenever there is any hearing symptom or unilateral tinnitus. [AAO-HNS 2017]",
        "Check for **nystagmus in primary gaze and on lateral gaze without fixation** where possible.",
        "Do finger-nose and heel-shin testing, and look for dysarthria and dysmetria.",
    ...
    },
    {
      ...
      points: [
        ...
        "Lingering nausea and unsteadiness persist between episodes.",
        ...
        "Seat the patient with enough room to lie back with the head over the end of the couch.",
        ...
        "The vertigo the patient reports mirrors the nystagmus exactly.",
        "**The side that provokes the nystagmus is the affected side**. [AAO-HNS 2017]",
        "That determines which way the Epley manoeuvre is performed - getting the side wrong is the commonest reason a manoeuvre fails.",
        ...
        "Central positional vertigo is most often a posterior fossa lesion at the fourth ventricle or cerebellar nodulus.",
    ...
    },
    {
      ...
      points: [
        ...
        "Mirror the whole sequence for left-sided BPPV.",
        ...
        "Semont is easier in the obese, the kyphotic and those who cannot extend the neck.",
        "**Brandt-Daroff exercises** are done at home in sets of five to each side, three times a day. [AAO-HNS 2017]",
        "They are less effective than an Epley but are right when the manoeuvre cannot be done in clinic or symptoms recur.",
    ...
    },
    {
      ...
      points: [
        ...
        "A **normal** head impulse - eyes stay locked on your nose - means the vestibulo-ocular reflex is intact.",
        ...
        "Evidence for better symptomatic outcome with steroids is weak, and **antivirals do not help**.",
      ],
    },
    {
      ...
      points: [
        ...
        "Manage acute attacks with an antiemetic and an NSAID or triptan.",
        ...
        "Surgery is the final option where hearing is still useful.",
        "Treat acute Meniere attacks with prochlorperazine and fluids.",
        ...
        "**Acoustic neuroma (vestibular schwannoma)** rarely causes true vertigo - it grows slowly and allows compensation.",
        "It presents with **progressive unilateral sensorineural hearing loss**, unilateral tinnitus and unsteadiness.",
        "Any asymmetric sensorineural hearing loss on audiometry needs an **MRI of the internal auditory meatus with gadolinium**.",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "A preceding viral illness favours vestibular neuritis.",
            "Sudden onset with headache or neck pain suggests **vertebral artery dissection**.",
            "Ask for double vision, slurred speech and difficulty swallowing.",
            "Ask for facial or limb numbness, weakness and hiccups.",
        ...
        },
        {
          ...
          points: [
            "A peripheral patient is unsteady but can walk with support, and falls to the affected side.",
            "**Inability to stand or walk unaided is central**. [HINTS Stroke 2009]",
            "Limb ataxia, dysmetria, dysarthria and Horner syndrome are all central signs.",
            "Assess hearing by finger rub or whispered voice, then arrange audiometry. [AAO-HNS 2017]",
            "Check the pulse for irregularity - atrial fibrillation.",
            "Blood pressure in **both arms**, and listen for a carotid bruit.",
        ...
        },
        {
          ...
          points: [
            "Intravenous fluids and an antiemetic for the vomiting.",
            ...
            "Antivirals are not indicated in vestibular neuritis.",
    ...
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            "Seat the patient so the head can extend beyond the end of the couch.",
  ...
  sections: [
    {
      ...
      points: [
        ...
        "**Mononeuropathy** is one nerve only.",
        "Examples: carpal tunnel median neuropathy, ulnar neuropathy at the elbow, meralgia paraesthetica.",
        "Common peroneal palsy at the fibular neck causes **foot drop**.",
    ...
    },
    {
      ...
      points: [
        ...
        "Other drug causes: metronidazole in prolonged courses, phenytoin, dapsone, nitrofurantoin and linezolid.",
        "Chemotherapy causes: vincristine, cisplatin, taxanes and thalidomide.",
        "Also amiodarone, and older antiretrovirals such as stavudine and didanosine.",
        ...
        "In an elderly patient with a mild, slowly progressive, purely sensory neuropathy that is an acceptable conclusion.",
    ...
    },
    {
      ...
      points: [
        ...
        "It is burning, shooting, stabbing or electric-shock pain, worse at night, with allodynia so the bedsheet hurts.",
    ...
    },
    {
      ...
      points: [
        ...
        "Or simply treat and reassess if the clinical picture fits.",
        ...
        "Also to confirm a treatable entrapment before surgery.",
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "History: onset and progression, and the character of the pain.",
