...
topics.push({
  ...
  mcqs: [
    ...
    },
    {
      ...
      answer: 1,
      explanation:
        "This is typical childhood absence epilepsy with absence seizures only, and ethosuximide is first line: in the Glauser randomised trial it matched sodium valproate for efficacy (about 45% seizure freedom at 16 weeks against 21% for lamotrigine) but caused significantly less attentional dysfunction, which matters in a school-age child. Carbamazepine and phenytoin are absolutely wrong here - both aggravate absence and myoclonic seizures and can precipitate absence status epilepticus, and prescribing carbamazepine for a misclassified generalised epilepsy is the classic error. Levetiracetam has only weak evidence in absence epilepsy and is a later option. Clobazam is an adjunct for clustering or catamenial seizures, not initial monotherapy. Sodium valproate would be the alternative first-line drug, and would be preferred if generalised tonic-clonic seizures coexisted or if ethosuximide were unavailable, which happens in India.",
      difficulty: "easy",
    },
    {
