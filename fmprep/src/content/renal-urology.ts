...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "**Anaemia in CKD** is normocytic normochromic - erythropoietin production fails and hepcidin traps iron in stores. [KDIGO 2012]",
        "Investigate anaemia when Hb falls below 12 g/dL in women or 13 g/dL in men, because CKD is a diagnosis of exclusion for anaemia. [KDIGO 2012]",
        "Correct iron first - target transferrin saturation above 30% and ferritin above 200-500 ng/mL, or an ESA will simply not work. [KDIGO 2012]",
        "Use IV iron sucrose or ferric carboxymaltose - hepcidin blocks duodenal absorption, so oral iron fails in uraemia. [KDIGO 2012]",
        "Start an erythropoiesis-stimulating agent only when **Hb is below 10 g/dL** - earlier starts gave no benefit and more harm. [KDIGO 2012]",
        "Aim Hb **10-11.5 g/dL and never above 13 g/dL** - CHOIR and TREAT showed higher targets increase stroke and death. [KDIGO 2012]",
        "Exclude blood loss, B12 and folate deficiency, and hypothyroidism before labelling renal anaemia, as all are commoner and cheaper to treat. [KDIGO 2012]",
