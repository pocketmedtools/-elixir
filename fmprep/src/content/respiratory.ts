  ...
  sections: [
    {
      ...
      points: [
        "**Variable respiratory symptoms plus documented variable expiratory airflow limitation** together define asthma - either half alone is not a diagnosis. [GINA 2024]",
        "Symptoms favour asthma when there is **more than one symptom, worse at night or on waking, varying over time**, and triggered by exercise, cold air, dust, smoke or laughter. [GINA 2024]",
        "India holds about 34 million asthmatics: **13% of the world's cases but over 40% of the world's asthma deaths** - a treatment gap, not a severity gap. [GBD India State-Level 2018]",
        "That mortality gap is behavioural: **inhalers believed addictive or last-resort**, oral salbutamol and theophylline syrups, OTC and ayurvedic steroids, reliever-only use. [GINA 2024]",
        "**Three or more salbutamol canisters a year predicts exacerbation and twelve or more predicts death** - a dispensing count is an audit you can run on your own clinic. [GINA 2024]",
        "Name the Indian modifiers you will actually remove: **outdoor particulates, biomass and coil smoke, incense, damp housing and Aspergillus sensitisation**. [GINA 2024]",
      ],
    },
    {
      heading: "Confirming the diagnosis objectively",
      points: [
        "**Bronchodilator reversibility is a rise in FEV1 over 12% AND over 200 mL**, 10-15 minutes after 200-400 microgram salbutamol - one criterion alone does not count. [GINA 2024]",
        "Reversibility only counts on a background of obstruction - **FEV1/FVC below the lower limit of normal, roughly under 0.75-0.80 in adults** - or there is nothing to reverse. [GINA 2024]",
        "Without a spirometer, **average daily diurnal PEF variability over 10% in adults and over 13% in children across two weeks** confirms variable airflow limitation. [GINA 2024]",
        "Diurnal variability is (highest minus lowest) divided by the mean of the two; **a PEF rise over 20% after 4 weeks of anti-inflammatory treatment** confirms equally well. [GINA 2024]",
        "A positive exercise challenge is a **fall in FEV1 over 10% and over 200 mL** - the test to use when resting spirometry is normal and symptoms are purely exertional. [GINA 2024]",
        "**Normal spirometry never excludes asthma** - airflow limitation is variable by definition, so repeat when symptomatic rather than discarding the diagnosis. [GINA 2024]",
        "Confirm before the first controller dose: **ICS abolishes reversibility**, and the label then becomes unverifiable for life. [GINA 2024]",
        "If treatment cannot wait, **record a baseline PEF and re-test at 6-8 weeks or during a step-down** - that is the only later chance to prove the diagnosis. [GINA 2024]",
        "**Inspiratory stridor with a normal expiratory flow-volume limb** is inducible laryngeal obstruction, not asthma - it will not respond to ICS or salbutamol. [GINA 2024]",
        "Exclude by history: **COPD in a smoker over 40 with fixed obstruction**, upper airway cough syndrome, reflux, cardiac failure, and unilateral wheeze from endobronchial TB. [GINA 2024]",
      ],
    },
    {
      heading: "Assessing control and future risk at every visit",
      points: [
        "**GINA control, four questions over 4 weeks:** daytime symptoms over twice weekly, any night waking, reliever over twice weekly excluding pre-exercise, any activity limitation. [GINA 2024]",
        "None positive is well controlled, one or two partly controlled, **three or four uncontrolled** - grade in those words, because 'doing all right' earns no mark. [GINA 2024]",
        "**Exacerbation risk is independent of symptom control**: any exacerbation in 12 months, SABA over-use, poor adherence, wrong technique, smoking, obesity, eosinophilia. [GINA 2024]",
        "**FEV1 under 60% predicted independently predicts exacerbation** even in a patient who reports no symptoms - which is why lung function is measured, not assumed. [GINA 2024]",
        "Fixed airflow limitation is driven by **absent ICS treatment**, tobacco and biomass exposure, occupational exposure, chronic mucus hypersecretion and severe exacerbations. [GINA 2024]",
        "Before any step-up, in order: **count the doses left in the box, then watch the inhaler being used**, then treat rhinitis, reflux, obesity, sleep apnoea and anxiety. [GINA 2024]",
        "**Technique is wrong in 70-80% of users** - correcting it gains more than any step-up and costs nothing, and it is the manoeuvre an examiner asks you to demonstrate. [GINA 2024]",
      ],
    },
    {
      heading: "The GINA treatment tracks, translated into Indian prescriptions",
      points: [
        "**No adult or adolescent should receive SABA alone**, a rule since GINA 2019 - SABA-only relievers raise exacerbation risk even when symptoms seem controlled. [GINA 2024]",
        "**Track 1 is preferred: low-dose ICS-formoterol is the reliever at every step** - as-needed only at Steps 1-2, maintenance and reliever therapy at Steps 3-5. [GINA 2024]",
        "MART halves severe exacerbations against a SABA reliever because **the anti-inflammatory dose rises automatically** at the exact moment the airway is inflamed. [GINA 2024]",
        "**Track 2 is the fallback**: daily ICS with a SABA reliever, or ICS whenever SABA is taken - for when ICS-formoterol is unaffordable, unavailable or refused. [GINA 2024]",
        "Indian formulations: **budesonide-formoterol 100/6, 200/6 and 400/6** as rotacaps, DPI capsules or pMDI, and beclometasone-formoterol 100/6 pMDI - all usable as MART. [GINA 2024]",
        "**Fluticasone-salmeterol 125/25 and 250/25 is a controller only** - salmeterol is slow in onset, so among LABAs only formoterol can ever serve as a reliever. [GINA 2024]",
        "**Write MART out in full**: budesonide-formoterol 200/6, one inhalation twice daily plus one as needed, maximum 12 inhalations a day, with no separate salbutamol. [GINA 2024]",
        "Tell the patient that **the same device treats the symptom and the inflammation** - otherwise the as-needed doses are skipped and MART silently becomes plain maintenance. [GINA 2024]",
        "Step 5: add **tiotropium 5 microgram once daily by soft mist inhaler**, phenotype the patient, and refer before ever accepting maintenance oral steroids. [GINA 2024]",
        "Choose the biologic by phenotype - **omalizumab for allergic, mepolizumab or dupilumab for eosinophilic** disease - since neither works in the other phenotype. [GINA 2024]",
        "**Montelukast is a weak controller** for allergic rhinitis with asthma and exercise-induced symptoms, never an ICS substitute, and carries a boxed neuropsychiatric warning. [US FDA 2020]",
        "Oral salbutamol, theophylline syrup and long-term oral steroids mark untreated Indian asthma - **replace all three with one correctly used ICS inhaler**. [GINA 2024]",
      ],
    },
    {
      heading: "Acute exacerbation: assessment and treatment",
      points: [
        "Mild-moderate attack: **speaks in sentences, sits up, pulse under 100, PEF over 50% of best, SpO2 over 95%** - treat in the clinic with spacer salbutamol and oral steroid. [GINA 2024]",
        "Severe attack: **cannot complete sentences, sits forward, pulse over 120, respiratory rate over 30, PEF 50% or less, SpO2 under 90%** - treat and admit. [GINA 2024]",
        "**A normal or rising PaCO2 in a tiring asthmatic is pre-terminal** - a hyperventilating patient should be hypocapnic, so a normal gas means exhaustion, not improvement. [GINA 2024]",
        "Life-threatening signs are **drowsiness, confusion, silent chest, cyanosis, feeble effort, bradycardia or hypotension** - call for help and prepare to ventilate. [GINA 2024]",
        "**Titrate oxygen to SpO2 93-95% in adults and 94-98% in children** - uncontrolled high-flow oxygen worsens outcome through V/Q mismatch and CO2 retention. [GINA 2024]",
        "**Salbutamol 4-10 puffs by pMDI with a spacer every 20 minutes for the first hour** matches a nebulisation, costs less and spreads no aerosol - preferred outside critical care. [GINA 2024]",
        "**Prednisolone 40-50 mg orally within one hour** - oral equals intravenous if she can swallow, and the benefit only begins at about 4 hours, so delay is what kills. [GINA 2024]",
        "Add **ipratropium 4-8 puffs or 500 microgram nebulised every 20 minutes for the first hour** in severe attacks - with salbutamol it reduces hospital admission. [GINA 2024]",
        "**Magnesium sulphate 2 g intravenously over 20 minutes** as a single dose if there is no response after the first hour or FEV1 is under 25-30% predicted. [GINA 2024]",
        "**Antibiotics are not routine** - exacerbations are viral or allergen-driven, so treat only a documented pneumonia or purulent sinusitis. [GINA 2024]",
        "**Sedatives are absolutely contraindicated** in an acute attack - they remove the respiratory drive that is compensating for the obstruction. [GINA 2024]",
        "Discharge on **prednisolone 40-50 mg daily for 5-7 days with no taper** - tapering is needed only for courses beyond about 2 weeks or repeated courses. [GINA 2024]",
        "**Never discharge on the regimen that failed**: start or step up the ICS controller, correct technique, give a written action plan and review within 2-7 days. [GINA 2024]",
      ],
    },
    {
      heading: "Special situations and the questions that follow them",
      points: [
        "**Continue ICS, LABA and oral steroids in pregnancy** - uncontrolled asthma causes low birth weight, prematurity and pre-eclampsia, and budesonide has the largest safety database. [GINA 2024]",
        "**Aspirin-exacerbated respiratory disease is asthma with nasal polyps and NSAID sensitivity** - avoid every COX-1 inhibitor, and treat the polyps as part of the asthma. [GINA 2024]",
        "In AERD use **paracetamol under 1 g cautiously or a selective COX-2 inhibitor** - cross-reactivity is dose-dependent at COX-1, not idiosyncratic. [GINA 2024]",
        "Suspect ABPA when asthma resists treatment with **fleeting infiltrates, thick mucus plugs, proximal bronchiectasis or eosinophilia** - untreated it destroys lung irreversibly. [ISHAM 2024]",
        "Screen ABPA with **Aspergillus-specific IgE and total IgE over 1000 IU/mL**, then treat with oral prednisolone plus itraconazole. [ISHAM 2024]",
        "**Occupational asthma improves on holidays and relapses at work** - prove it with serial peak flows on and off work, and remove exposure early or impairment is permanent. [GINA 2024]",
        "**Exercise-induced bronchoconstriction signals poor underlying control** - answer it with regular ICS, a warm-up, and low-dose ICS-formoterol before exertion on Track 1. [GINA 2024]",
        "**Step down only after 3 months of good control**, by 25-50% of the ICS dose, never stopping ICS in an adult, and never without a follow-up date and action plan. [GINA 2024]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Ask for **more than one symptom, worse at night or on waking, varying in intensity**, provoked by dust, smoke, cold air, exercise, viral infection or laughter. [GINA 2024]",
            "Record atopy, allergic rhinitis, eczema and seasonality, plus exposure to **flour, chemicals, biomass smoke, mosquito coils, incense or damp** - each is removable. [GINA 2024]",
            "**Quantify reliever use in canisters per year**, steroid courses, emergency visits, admissions and any intubation - a previous intubation defines high-risk asthma. [GINA 2024]",
            "Ask what she already takes, including **oral salbutamol, theophylline syrup and OTC steroid preparations**, and elicit the belief behind inhaler avoidance. [GINA 2024]",
          ],
        },
        {
          heading: "2. Examination and objective confirmation",
          points: [
            "Examination is often normal between attacks - look for **polyphonic expiratory wheeze, hyperinflation, nasal polyps, rhinitis and eczema**, and record height, weight and BMI. [GINA 2024]",
            "**Spirometry with post-bronchodilator reversibility is confirmatory**: baseline obstruction with FEV1 rising over 12% and over 200 mL 15 minutes after 200-400 microgram salbutamol. [GINA 2024]",
            "Without spirometry, **twice-daily PEF for two weeks showing over 10% average diurnal variability** confirms, as does over 20% improvement after four weeks of ICS. [GINA 2024]",
            "**A normal test between episodes does not exclude asthma** - repeat when symptomatic or document the response to treatment instead. [GINA 2024]",
            "Chest radiograph only for atypical features - fever, weight loss, haemoptysis, focal signs, clubbing - because **tuberculosis is the Indian chronic-cough differential**. [NTEP TOG 2024]",
          ],
        },
        {
          heading: "3. Assessing control and future risk",
          points: [
            "**Three or four positives on the four GINA questions is uncontrolled asthma** - reliever use five times a week alone already places this patient there. [GINA 2024]",
            "Record future risk: **exacerbation in the last year, SABA over-use, poor adherence, wrong technique, low FEV1, smoking, obesity, rhinosinusitis, pregnancy**. [GINA 2024]",
            "Treat the comorbidities that hold control back - **rhinitis, reflux, obesity, obstructive sleep apnoea and anxiety**, and ABPA in the resistant case. [GINA 2024]",
          ],
        },
        {
          heading: "4. Pharmacological management",
          points: [
            "**Track 1 is preferred**: low-dose ICS-formoterol as the reliever, and from Step 3 the same inhaler as maintenance and reliever therapy. [GINA 2024]",
            "Start **budesonide-formoterol 200/6 one inhalation twice daily plus one as needed, maximum 12 a day**, and withdraw the salbutamol-only inhaler at the same visit. [GINA 2024]",
            "If ICS-formoterol is unaffordable, **daily budesonide 200-400 microgram with a salbutamol reliever** works only if the ICS is taken on symptom-free days too. [GINA 2024]",
            "Escalate in order - medium dose, add a LAMA, treat the rhinitis - and **refer for phenotyping and biologics only at Step 5**. [GINA 2024]",
            "**Montelukast is an adjunct for coexisting allergic rhinitis**, never a replacement for ICS, because it does not control eosinophilic airway inflammation. [GINA 2024]",
            "**Review at 4-8 weeks**, then step down only after 3 months of control by 25-50% of the ICS dose, never stopping ICS altogether. [GINA 2024]",
          ],
        },
        {
          heading: "5. Non-drug management and self-management education",
          points: [
            "**Demonstrate the inhaler, then take it back and watch her use it** - teaching without teach-back leaves most technique errors uncorrected. [GINA 2024]",
            "Supply a **spacer with any pMDI and teach mouth rinsing after ICS** - the spacer halves oropharyngeal deposition, preventing candidiasis and dysphonia. [GINA 2024]",
            "A **written action plan** states her usual doses, the worsening signs - falling PEF, rising reliever use, night waking - and when to increase the ICS-containing treatment. [GINA 2024]",
            "The plan must say **when to start prednisolone 40-50 mg and when to come to hospital** - a plan without those two triggers does not reduce admissions. [GINA 2024]",
            "Trigger control: **tobacco and second-hand smoke, biomass, indoor damp and mould, pets, dust**, and NSAIDs if there is any suggestion of aspirin sensitivity. [GINA 2024]",
            "**Annual influenza vaccination**, intranasal steroid for rhinitis, weight reduction if obese, and breathing exercises as an adjunct only. [GINA 2024]",
            "**Asthma drugs are continued in pregnancy** - uncontrolled asthma is more dangerous to the fetus than any inhaled drug she will be given. [GINA 2024]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Assess **speech, posture, accessory muscle use, respiratory rate, pulse, blood pressure, SpO2 and PEF** alongside treatment, never before it. [GINA 2024]",
            "Life-threatening features: **silent chest, cyanosis, feeble effort, bradycardia, arrhythmia, hypotension, exhaustion, confusion, PEF under 33%**. [BTS/SIGN 2019]",
            "Take an arterial gas if **SpO2 remains under 92%** or any life-threatening feature is present - a normal or rising PaCO2 means a tiring patient and near-fatal asthma. [BTS/SIGN 2019]",
            "Look for the precipitant and the mimics - **pneumothorax, pneumonia, anaphylaxis, pulmonary embolism, inhaled foreign body and cardiac failure**. [GINA 2024]",
          ],
        },
        {
          heading: "Immediate treatment in the first hour",
          points: [
            "**Oxygen titrated to SpO2 93-95%** by face mask or nasal prongs - do not withhold it while awaiting a gas, and do not run it wide open. [GINA 2024]",
            "**Salbutamol 4-10 puffs by pMDI with spacer, or 2.5-5 mg nebulised, every 20 minutes for one hour**, then hourly; continuous nebulisation in the severest cases. [GINA 2024]",
            "**Ipratropium 500 microgram nebulised or 4-8 puffs every 20 minutes for the first hour** in severe attacks - it is the add-on that reduces admission. [GINA 2024]",
            "**Prednisolone 40-50 mg orally, or hydrocortisone 100 mg intravenously** if she cannot swallow, within the first hour - the benefit starts only at about 4 hours. [GINA 2024]",
            "**Magnesium sulphate 2 g intravenously over 20 minutes** as a single dose if there is no response after the first hour or FEV1 is under 25-30% predicted. [GINA 2024]",
            "**No sedatives at any severity** - they abolish the respiratory drive compensating for the obstruction; no routine antibiotics, physiotherapy or mucolytics either. [GINA 2024]",
          ],
        },
        {
          heading: "Monitoring, escalation and discharge",
          points: [
            "Reassess clinically and with PEF after each treatment cycle and at one hour - **PEF above 60-80% of best with settled symptoms** allows discharge planning. [GINA 2024]",
            "Escalate to intensive care for **exhaustion, deteriorating gases, drowsiness or refractory hypoxaemia** - intubating an asthmatic is high risk and needs the senior hand. [GINA 2024]",
            "Ventilate with **low tidal volumes, low rates, long expiratory times and permissive hypercapnia** - dynamic hyperinflation, not hypoxia, kills the ventilated asthmatic. [GINA 2024]",
            "Discharge on **prednisolone 40-50 mg daily for 5-7 days without taper**, controller started or stepped up, technique corrected, action plan given, review in 2-7 days. [GINA 2024]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Asthma begins in childhood or early adult life; COPD after 40** on cumulative tobacco or biomass exposure - age at onset is the first discriminator. [GOLD 2024]",
            "**Asthma varies day to day with symptom-free intervals** and is worse at night; COPD is slowly progressive daily breathlessness with little variation. [GOLD 2024]",
            "Atopy, rhinitis, eczema and a family history favour asthma; **twenty or more pack-years, or decades of chulha smoke**, favour COPD. [GOLD 2024]",
            "Asthma is stable between attacks; COPD progresses to **falling exercise tolerance, weight loss in emphysema and cor pulmonale**. [GOLD 2024]",
          ],
        },
        {
          heading: "Investigational differences",
          points: [
            "Spirometry is the discriminator: asthma shows obstruction with **significant reversibility, FEV1 rising over 12% and over 200 mL**, and may normalise completely. [GINA 2024]",
            "COPD shows a **post-bronchodilator FEV1/FVC under 0.70 that persists** - the ratio must be post-bronchodilator or reversible asthma gets labelled COPD for life. [GOLD 2024]",
            "**PEF variability over 10% a day favours asthma**; a fixed low PEF with no diurnal swing favours COPD. [GINA 2024]",
            "**Blood and sputum eosinophilia with raised total IgE favour asthma**; neutrophilic sputum favours COPD and predicts a poor ICS response. [GOLD 2024]",
        ...
        },
        {
          ...
          points: [
            "Asthma-COPD overlap is a smoker with long-standing asthma showing **persistent airflow limitation plus significant reversibility and eosinophilia**. [GINA 2024]",
            "**Never give a LABA or LAMA without an ICS in overlap** - unopposed bronchodilation of an eosinophilic airway increases exacerbations and asthma deaths. [GINA 2024]",
            "When the diagnosis is uncertain, **treat as asthma and always include an ICS** - untreated asthmatic inflammation is the more dangerous of the two errors. [GINA 2024]",
            "In India, **exclude tuberculosis and post-tuberculous obstructive airway disease** before either label in a productive cough. [NTEP TOG 2024]",
          ],
        },
      ],
      mustDraw: [
