  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Category C is breathlessness, chest pain, drowsiness, hypotension, haemoptysis or cyanosis** - each means the lung or circulation is failing. [MoHFW 2009]",
        "Worsening chronic disease also counts - **test, admit and treat now**, without waiting for the swab result. [MoHFW 2009]",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Look for Category C: **breathlessness, rate over 24 or SpO2 under 94%** - hypoxia in pregnancy reaches the fetus first. [MoHFW 2009]",
            "Category C also includes **chest pain, drowsiness, hypotension, cyanosis or reduced fetal movements**, as each means admission today. [MoHFW 2009]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Category C means admission** and RT-PCR on nasopharyngeal and throat swab through the VRDL, because the diagnosis must be confirmed. [MoHFW 2009]",
            "Start **oseltamivir before the result**, as the benefit falls away after the first 48 hours of symptoms. [MoHFW 2009]",
            "**She is Category B(ii)** - pregnancy alone makes her high risk, so oseltamivir starts without a test. [MoHFW 2009]",
            "Any breathlessness, hypoxaemia or obstetric concern makes her Category C, because she then needs obstetric and intensive care together. [MoHFW 2009]",
          ],
        },
        {
          heading: "3. Treatment",
