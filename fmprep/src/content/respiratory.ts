  ...
  sections: [
    {
      ...
      points: [
        ...
        "Asthma is likely with **more than one symptom, worse at night, varying over time**, set off by exercise or smoke - variability marks a twitchy airway. [GINA 2024]",
        ...
        "The gap is behavioural: **inhalers believed addictive**, salbutamol syrups, OTC steroids, reliever-only use - each leaves the airway inflammation untreated. [GINA 2024]",
        ...
        "Indian triggers to remove by name: **particulates, biomass and coil smoke, incense, damp, Aspergillus** - each drives inflammation no inhaler can out-dose. [GINA 2024]",
      ],
    },
    {
      ...
      points: [
        ...
        "No spirometer: **diurnal PEF variability over 10% in adults and over 13% in children across two weeks** confirms - a fixed lesion cannot swing that much. [GINA 2024]",
        "Variability is (highest minus lowest) over their mean; **a PEF rise over 20% after 4 weeks of ICS** confirms equally, since only inflamed airways respond. [GINA 2024]",
        ...
        "Exclude **COPD over 40 with fixed obstruction**, rhinitis, reflux, heart failure and unilateral wheeze from endobronchial TB - each fails ICS in its own way. [GINA 2024]",
      ],
    },
    {
      heading: "Assessing control and future risk at every visit",
      points: [
        "**Control over 4 weeks:** day symptoms over twice weekly, night waking, reliever over twice weekly, activity limit - any yes is live inflammation. [GINA 2024]",
        ...
        "**Risk runs independent of symptoms**: exacerbation in 12 months, SABA over-use, poor adherence, bad technique, obesity - a quiet patient can still die. [GINA 2024]",
        ...
        "Fixed airflow limitation follows **absent ICS**, tobacco and biomass, occupational dust, severe attacks - inflammation remodels the wall. [GINA 2024]",
        "Before any step-up: **count the doses left, then watch her inhale**, then treat rhinitis, reflux, obesity, apnoea, anxiety - most failure is not drug failure. [GINA 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "India stocks **budesonide-formoterol 100/6, 200/6 and 400/6** and beclometasone-formoterol 100/6 - fast-onset formoterol lets one inhaler relieve. [GINA 2024]",
        ...
        "**Write MART out**: budesonide-formoterol 200/6 one puff twice daily plus one as needed, maximum 12 inhalations a day - the cap holds formoterol at 72 mcg. [GINA 2024]",
        "**A child of 6-11 gets the 100/6 strength and a ceiling of 8 inhalations in 24 hours**, not the adult 200/6 and 12 - seek care above it. [GINA 2026]",
        "**MART is not recommended at Step 5 in children 6-11** - at Step 4 they take one inhalation twice daily plus one as needed, and then they are referred. [GINA 2026]",
        ...
        "Step 5: add **tiotropium 5 microgram once daily by soft mist inhaler**, phenotype, refer before oral steroids - biologics spare bone and adrenal. [GINA 2024]",
        ...
        "**Montelukast is a weak controller** for rhinitis with asthma, never an ICS substitute, and has a neuropsychiatric warning - it blocks one mediator of many. [US FDA 2020]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Magnesium sulphate 2 g intravenously over 20 minutes**, once, if no response at one hour or FEV1 under 25-30% predicted - calcium blockade relaxes muscle. [GINA 2024]",
        ...
        "**A child takes prednisolone 1-2 mg/kg daily to a maximum of 40 mg, for 3-5 days** - a shorter course and a lower ceiling than the adult. [GINA 2026]",
        "**Never discharge on the regimen that failed**: step up the ICS, fix technique, action plan, review in 2-7 days - the attack proved the plan inadequate. [GINA 2024]",
      ],
    },
    {
      ...
      points: [
        ...
        "Suspect ABPA in resistant asthma with **fleeting infiltrates, mucus plugs, proximal bronchiectasis or eosinophilia** - fungal IgE outruns ICS. [ISHAM 2024]",
        "Screen ABPA with **Aspergillus-specific IgE and total IgE over 1000 IU/mL**, then prednisolone and itraconazole - steroid for host, azole for antigen. [ISHAM 2024]",
        ...
        "**Step down only after 3 months of control**, by 25-50% of the ICS dose, never to zero ICS in an adult - stopping ICS entirely brings back exacerbation risk. [GINA 2024]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Ask for **more than one symptom, worse at night, varying in intensity**, provoked by dust, smoke, cold air or exercise - cough alone is rarely asthma. [GINA 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Post-bronchodilator reversibility confirms**: FEV1 rises over 12% and over 200 mL 15 minutes after 200-400 microgram salbutamol - both limits exclude noise. [GINA 2024]",
            "No spirometry: **twice-daily PEF for two weeks with over 10% diurnal variability**, or over 20% gain after four weeks of ICS - each proves reversibility. [GINA 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "Record risk: **exacerbation last year, SABA over-use, poor adherence, wrong technique, low FEV1, smoking, obesity, rhinosinusitis** - each predicts attacks. [GINA 2024]",
        ...
        },
        {
          ...
          points: [
            "**Track 1 is preferred**: low-dose ICS-formoterol as reliever, from Step 3 also as maintenance - every reliever puff carries steroid. [GINA 2024]",
            "Start **budesonide-formoterol 200/6 one puff twice daily plus one as needed, maximum 12 a day**, stop salbutamol - a SABA in the pocket undoes MART. [GINA 2024]",
            ...
            "**Review at 4-8 weeks**; step down after 3 months of control by 25-50% of the ICS dose, never stopping ICS - the lowest dose that holds control is the target. [GINA 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "Trigger control: **tobacco and second-hand smoke, biomass, mould, pets, dust**, plus NSAIDs if aspirin-sensitive - COX-1 blockade floods leukotrienes. [GINA 2024]",
            "**Annual influenza vaccination**, intranasal steroid for rhinitis, weight loss if obese, breathing exercises as adjunct - influenza drives the worst attacks. [GINA 2024]",
      ...
      answer: [
        {
          ...
          points: [
            "Assess **speech, posture, accessory muscles, rate, pulse, blood pressure, SpO2 and PEF** while treating, never before - the first bronchodilator cannot wait. [GINA 2024]",
            "Life-threatening: **silent chest, cyanosis, feeble effort, bradycardia, arrhythmia, hypotension, exhaustion, PEF under 33%** - airflow too low to wheeze. [BTS/SIGN 2019]",
            ...
            "Seek the mimics: **pneumothorax, pneumonia, anaphylaxis, pulmonary embolism, inhaled foreign body, cardiac failure** - each wheezes, none answers salbutamol. [GINA 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "**Magnesium sulphate 2 g intravenously over 20 minutes**, once, if no response at 1 hour or FEV1 under 25-30% predicted - it relaxes what salbutamol cannot. [GINA 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "Discharge on **prednisolone 40-50 mg for 5-7 days without taper**, controller stepped up, review in 2-7 days - a short course needs no taper. [GINA 2024]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "**Asthma varies day to day with symptom-free intervals**; COPD is progressive daily breathlessness with little variation - destroyed alveoli do not recover. [GOLD 2024]",
            "Atopy, rhinitis, eczema and family history favour asthma; **twenty or more pack-years or decades of chulha smoke** favour COPD - smoke dose destroys the lung. [GOLD 2024]",
            "Asthma is stable between attacks; COPD progresses to **falling exercise tolerance, weight loss and cor pulmonale** - chronic hypoxia loads the right heart. [GOLD 2024]",
          ],
        },
        {
          heading: "Investigational differences",
          points: [
            "Asthma shows obstruction with **reversibility over 12% and over 200 mL** and may normalise between attacks - muscle relaxes, destroyed parenchyma does not. [GINA 2024]",
            ...
            "**PEF variability over 10% a day favours asthma**; a fixed low PEF with no diurnal swing favours COPD, because emphysema does not vary with the clock. [GINA 2024]",
            "**Eosinophilia and raised total IgE favour asthma**; neutrophilic sputum favours COPD and predicts poor ICS response - steroids act on eosinophils only. [GOLD 2024]",
            "**DLCO is normal in asthma and reduced in emphysema** - the test that separates them when spirometry is equivocal. [GOLD 2024]",
            "Radiology is normal in asthma; COPD shows **hyperinflation with flat diaphragms, or emphysema on HRCT** - air trapping and lost alveolar walls are structural. [GOLD 2024]",
          ],
        },
        {
          heading: "Overlap and practical rule",
          points: [
            "Overlap is the asthmatic smoker, **persistent airflow limitation plus significant reversibility and eosinophilia** - which is why ICS is never withheld. [GINA 2024]",
            ...
            "In India, **exclude tuberculosis and post-TB obstructive airway disease** before either label in a productive cough - ICS given to active TB spreads it. [NTEP TOG 2024]",
          ],
        },
      ],
      mustDraw: [
...
topics.push({
  ...
  sections: [
    {
      ...
      points: [
        ...
        "COPD is the **second leading cause of death and of DALYs in India** after ischaemic heart disease, some 55 million cases - most undiagnosed until late. [GBD India 2019]",
        ...
        "Tobacco as cigarettes, bidis and hookah dominates, but **biomass chulha smoke drives COPD in non-smoking rural women** - hours daily at an open fire. [NFHS-5 2021]",
        ...
        "Name the other causes: **occupational dust and fumes, childhood infection, post-tuberculous obstructive airway disease**, old asthma - each scars the airway. [GOLD 2024]",
        "**Alpha-1 antitrypsin deficiency** is rare in India but is why a young non-smoker with basal emphysema needs a level - unopposed elastase eats the bases. [GOLD 2024]",
        "'Pink puffer' is emphysema with weight loss and pursed lips; **'blue bloater' is bronchitic with hypercapnia, oedema and cor pulmonale** - blunted drive. [Harrison 21e]",
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        ...
        "**Group E: LABA plus LAMA, adding ICS if blood eosinophils are 300 cells/microlitre or more**, or with a history of asthma - eosinophils predict ICS response. [GOLD 2024]",
    ...
    },
    {
      ...
      points: [
        "**Smoking cessation is the only measure that alters the rate of FEV1 decline**, and it works at every stage - the decline slows to the non-smoker's. [GOLD 2024]",
        "Use the **5A framework with nicotine replacement, bupropion or varenicline**, and refer to a cessation centre or quitline - drugs double quit rates. [NTCP MoHFW 2023]",
    ...
    },
    {
      ...
      points: [
        "An exacerbation is **worsening dyspnoea, cough or sputum over less than 14 days**, from infection, pollution or nothing found - a longer course is not one. [GOLD 2024]",
        ...
        "Give **salbutamol 2.5 mg with ipratropium 500 microgram nebulised every 4-6 hours**, or the same by pMDI with spacer - two receptors relax more than one. [GOLD 2024]",
        ...
        "Choose for 5 days: **amoxicillin-clavulanate 625 mg thrice daily, doxycycline 100 mg twice daily, or azithromycin 500 mg daily** - each covers H. influenzae. [GOLD 2024]",
        ...
        "Exclude the mimics before saying 'exacerbation': **pneumonia, pneumothorax, pulmonary embolism, left ventricular failure, arrhythmia** - steroids treat none. [GOLD 2024]",
        ...
        "Before discharge **confirm technique, optimise maintenance, vaccinate, refer for rehab and follow up within 4 weeks** - readmission strikes in month one. [GOLD 2024]",
  ...
  pearls: [
    ...
    "Blood eosinophils decide the inhaled corticosteroid: **300 cells/microlitre or more** supports it, under 100 argues against it - and prior tuberculosis or repeated pneumonia argues against it strongly. [GOLD 2024]",
      ...
      answer: [
        {
          ...
          points: [
            "**Quantify exposure in pack-years or bidi-years**, then ask separately about biomass, occupational dust and past tuberculosis - each is a distinct cause. [GOLD 2024]",
            ...
            "Ask for the mimics: **haemoptysis, weight loss, fever, orthopnoea, paroxysmal nocturnal dyspnoea and chest pain** - cancer, TB and heart failure mimic it. [GOLD 2024]",
            "Hyperinflation signs: **barrel chest, reduced cricosternal distance, hyper-resonance, obliterated cardiac dullness** - trapped air pushes all outward. [Harrison 21e]",
            "Look for **cyanosis, flapping tremor, tracheal tug, accessory muscle use and prolonged expiration with rhonchi**, then for cor pulmonale - the flap is CO2. [Harrison 21e]",
          ],
        },
        {
          heading: "2. Investigations",
          points: [
            "**Spirometry before and after bronchodilator** confirms the diagnosis and grades severity as GOLD 1-4 by FEV1 percent predicted - no sign is specific. [GOLD 2024]",
            ...
            "**A complete blood count with eosinophils** drives the ICS decision and reveals the polycythaemia of chronic hypoxaemia - both change treatment. [GOLD 2024]",
            ...
            "**Alpha-1 antitrypsin level only in the young non-smoker** with basal emphysema or a strong family history - the deficiency is rare in India. [GOLD 2024]",
          ],
        },
        {
        ...
        },
        {
          heading: "4. Pharmacological management",
          points: [
            "Group B or E: start **indacaterol-glycopyrronium 110/50 microgram once daily** or another LABA-LAMA, not a single bronchodilator - dual cuts more attacks. [GOLD 2024]",
            "**Add ICS only at eosinophils 300/microlitre or more**, or when he exacerbates on LABA-LAMA with eosinophils of 100 or more - below that ICS adds pneumonia. [GOLD 2024]",
            ...
            "**Roflumilast 500 microgram daily** in chronic bronchitis with FEV1 under 50%; azithromycin in exacerbators after QTc and NTM checks - each cuts attacks. [GOLD 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Pulmonary rehabilitation** with nutritional advice, or a home exercise programme where none is available - muscle, not lung, limits walking. [GOLD 2024]",
            "Vaccinate with **influenza annually, plus pneumococcal, COVID-19 and Tdap** - infection triggers most exacerbations. [GOLD 2024]",
            "Assess long-term oxygen when stable: **PaO2 55 mmHg or less, or SpO2 88% or less**, used at least 15 hours a day - survival benefit exists only there. [GOLD 2024]",
            ...
            "Give a **written exacerbation action plan and review 3-monthly** for symptoms and exacerbation count - early self-treatment shortens attacks. [GOLD 2024]",
            "Treat comorbid depression, and discuss palliation with **opioids for refractory breathlessness** in advanced disease - they blunt the sense of air hunger. [GOLD 2024]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "Assessment",
          points: [
            "Grade severity by **speech, respiratory rate, accessory muscle use, consciousness, SpO2 and haemodynamics** at the bedside - drowsiness means CO2 retention. [GOLD 2024]",
            "Investigate with **chest radiograph, ECG, arterial gas, counts, sugar and electrolytes**; culture sputum in severe or frequent cases - the gas decides NIV. [GOLD 2024]",
            "Exclude the imitators: **pneumonia, pneumothorax, pulmonary embolism, acute left ventricular failure and arrhythmia** - each needs a different treatment. [GOLD 2024]",
          ],
        },
        {
          heading: "Drug treatment",
          points: [
            "**Salbutamol 2.5 mg with ipratropium 500 microgram nebulised every 4-6 hours**, or the equivalent by pMDI with a spacer - two pathways relax more than one. [GOLD 2024]",
            ...
            "**Prednisolone 40 mg orally once daily for 5 days** shortens recovery and reduces relapse; longer courses add only harm - 5 days matched 14. [REDUCE trial 2013]",
            ...
            "Use **amoxicillin-clavulanate, doxycycline or azithromycin**, and treat comorbid heart failure, arrhythmia and hyperglycaemia too - each adds hypoxia. [GOLD 2024]",
        ...
        },
        {
          ...
          points: [
            "**Controlled oxygen to SpO2 88-92%**, ideally by 24-28% Venturi mask, with a repeat gas at 30-60 minutes - excess oxygen unmasks hypercapnia. [GOLD 2024]",
            ...
            "NIV also applies to **persistent hypoxaemia despite oxygen**, the highest-yield step in an exacerbation answer - it halves intubation and death. [GOLD 2024]",
            "Intubate for **NIV failure or intolerance, arrest, impaired consciousness, massive aspiration or haemodynamic instability** - a mask cannot guard the airway. [GOLD 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "Provide an action plan and **follow up in 1-4 weeks**, then reassess oxygenation at 8-12 weeks before committing to long-term oxygen - it often recovers. [GOLD 2024]",
          ],
        },
      ],
      ...
      answer: [
        {
          heading: "Indications",
          points: [
            "**Resting PaO2 55 mmHg or less, or SpO2 88% or less** on room air, confirmed on two occasions three weeks apart - one reading may be a lingering attack. [GOLD 2024]",
            "**PaO2 56-59 mmHg, about SpO2 89%, with cor pulmonale, right heart failure, oedema or pulmonary hypertension** also qualifies - the heart is already strained. [GOLD 2024]",
            "Secondary **polycythaemia with haematocrit above 55%** is the other qualifier at that borderline PaO2 - the marrow is proving the hypoxia is chronic. [GOLD 2024]",
            "**Sleep or exercise desaturation may justify oxygen in selected patients**, but survival evidence exists only for resting hypoxaemia - trials showed no gain. [GOLD 2024]",
          ],
        },
        {
          heading: "Prescription",
          points: [
            "Titrate flow to **PaO2 above 60 mmHg or SpO2 90% or more at rest**, usually 1-3 L/min by nasal cannula - higher targets risk CO2 retention. [GOLD 2024]",
            ...
            "An **oxygen concentrator is the practical home device in India**, with cylinders as backup and portable concentrators for mobility - it never runs out. [GOLD 2024]",
        ...
        },
        {
          ...
          points: [
            "**Recheck gases or oximetry at 60-90 days** to confirm continuing need and flow adequacy, then at least annually - some no longer qualify. [GOLD 2024]",
            "**Watch for hypercapnia after starting or increasing flow**, especially where the baseline PaCO2 is already raised - oxygen worsens V/Q mismatch and Haldane. [GOLD 2024]",
  ...
  sections: [
    {
      ...
      points: [
        "India holds **about a quarter of global TB cases**, 25.5 lakh notified in 2023, a record - better case-finding, not more disease. [India TB Report 2024]",
        ...
        "Confirmed pulmonary TB runs at **316 per 100,000 at age 15 and over** - half had no cough, so symptom screening misses them. [National TB Prevalence Survey 2019-21]",
        ...
        "RNTCP became the **National TB Elimination Programme in 2020**, aiming at under 1 per lakh by 2025, before the SDG 2030 - control became elimination. [NTEP TOG 2024]",
        "The four NTEP pillars are **Detect, Treat, Prevent and Build** - the skeleton of any programme answer. [NTEP TOG 2024]",
        "**Presumptive pulmonary TB: cough or fever of two weeks or more, weight loss, haemoptysis, or any radiograph abnormality** - it catches smear-negatives. [NTEP TOG 2024]",
        ...
        "**Notification is mandatory for every provider, public and private**, by the 2012 Gazette order amended 2018, via Ni-kshay - private cases were invisible. [NTEP TOG 2024]",
        "Not notifying is an offence under **sections 269 and 270 of the penal code**, now the Bharatiya Nyaya Sanhita - unreported cases keep spreading. [Gazette of India 2018]",
      ],
    },
    {
      ...
      points: [
        ...
        "**Truenat is the point-of-care platform** for peripheral institutions and Ayushman Arogya Mandirs beyond CBNAAT's reach - it runs on battery. [NTEP TOG 2024]",
        ...
        "Smear on **two samples, a spot and an early-morning specimen** by Ziehl-Neelsen or fluorescence serves where NAAT is absent - morning sputum is richest. [NTEP TOG 2024]",
        ...
        "For extrapulmonary TB send **NAAT plus cytology or histopathology and culture** on fluid, aspirate, CSF or pus - paucibacillary sites need every method. [NTEP TOG 2024]",
        ...
        "All get the comorbidity package: **HIV test, blood sugar, tobacco and alcohol screening, nutrition with BMI** - each is treatable and hurts cure. [NTEP TOG 2024]",
        "**Culture on liquid MGIT or solid Lowenstein-Jensen with line probe assay** is for rifampicin-resistant cases and failures - NAAT reads no second line. [NTEP TOG 2024]",
        "**First-line LPA covers isoniazid and rifampicin, second-line the fluoroquinolones and injectables**, in C-DST laboratories - mutations read in days. [NTEP TOG 2024]",
      ],
    },
    {
      ...
      points: [
        ...
        "Drugs come as **fixed dose combinations in a free patient-wise box**, with 99DOTS, video- or family-observed adherence - FDC stops selective dropping. [NTEP TOG 2024]",
        ...
        "**Pyridoxine 10 mg daily with isoniazid** prevents neuropathy, more in pregnancy, malnutrition, alcohol, diabetes, HIV - isoniazid drains B6 they lack. [NTEP TOG 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Follow-up smear at the end of the intensive phase (month 2) and of treatment (month 6)**, or on deterioration - a month-2 positive flags resistance. [NTEP TOG 2024]",
        ...
        "**Cured** means confirmed at diagnosis and negative at the end of treatment plus on at least one earlier occasion - two negatives exclude sampling luck. [NTEP TOG 2024]",
        "**Treatment completed** is a finished course with no evidence of failure but no documented end negativity; both are success, since the result is the same. [NTEP TOG 2024]",
        "**Lost to follow-up is treatment interrupted one consecutive month or more**; the rest are failed, died, not evaluated - a month off breeds resistance. [NTEP TOG 2024]",
        ...
        "Restart when **ALT falls below twice normal and bilirubin normalises**, adding rifampicin, then isoniazid, then pyrazinamide - least toxic first. [NTEP TOG 2024]",
        ...
        "**Isoniazid causes peripheral neuropathy and rarely psychosis**, while pyrazinamide causes arthralgia with hyperuricaemia - it blocks urate excretion. [NTEP TOG 2024]",
        ...
        "**Rifampicin is a powerful enzyme inducer**, weakening contraceptives, warfarin, sulfonylureas, phenytoin and antiretrovirals - CYP3A4 clears them faster. [NTEP TOG 2024]",
        "**All four first-line drugs are safe in pregnancy and treatment must not be delayed**; streptomycin is contraindicated, since it deafens the fetus. [NTEP TOG 2024]",
        ...
        "In liver disease use a **modified regimen with fewer hepatotoxic drugs**, the number set by how severe the liver disease is - less reserve, fewer insults. [NTEP TOG 2024]",
      ],
    },
    {
      heading: "Drug-resistant tuberculosis (PMDT)",
      points: [
        "**MDR-TB is resistance to at least isoniazid and rifampicin**; mono-resistance is to a single first-line drug - losing both pillars fails the regimen. [NTEP PMDT 2021]",
        ...
        "**XDR-TB is MDR/RR-TB with fluoroquinolone resistance plus resistance to bedaquiline or linezolid**, by the 2021 WHO definition - the core of BPaL is gone. [WHO 2021]",
        "**BPaLM is the preferred regimen for MDR/RR-TB and pre-XDR-TB**, rolled out under NTEP from 2024 - six months, all oral, higher cure. [NTEP PMDT 2024]",
        ...
        "Eligible: **age 15 years and over with under one month of exposure** to bedaquiline, pretomanid, linezolid or delamanid - exposure bred resistance. [NTEP PMDT 2024]",
        "**Fluoroquinolone susceptibility must be confirmed for BPaLM**; if resistant, moxifloxacin is dropped for BPaL - a dead drug adds only toxicity. [NTEP PMDT 2024]",
        ...
        "The **shorter oral bedaquiline-containing regimen runs 9-11 months and the longer oral M/XDR regimen 18-20 months** - fewer active drugs need more time. [NTEP PMDT 2024]",
        ...
        "**Group B is clofazimine and cycloserine**; Group C adds ethambutol, delamanid, pyrazinamide, carbapenems, amikacin, ethionamide and PAS - ranked by efficacy. [WHO 2022]",
        ...
        "**Monthly blood count for linezolid myelosuppression**, with acuity and colour vision checks, and enquiry for neuropathy - it poisons mitochondria. [NTEP PMDT 2024]",
        "Add **thyroid function on ethionamide and PAS**, liver and renal function, and audiometry if an injectable is ever used - both drugs block iodine uptake. [NTEP PMDT 2024]",
        "Care runs through **Nodal and District DR-TB Centres** with free drugs, a supporter, safety monitoring, Ni-kshay review - toxicity needs specialist eyes. [NTEP PMDT 2024]",
      ],
    },
    {
      heading: "Support, prevention and infection control",
      points: [
        "**Ni-kshay Poshan Yojana rose from Rs 500 to Rs 1,000 a month from 1 November 2024**, by direct transfer for the whole course - undernutrition doubles death. [MoHFW 2024]",
        ...
        "**Pradhan Mantri TB Mukt Bharat Abhiyaan, launched September 2022, enlists Ni-kshay Mitras** who adopt patients with a monthly food basket - food is drug. [MoHFW 2024]",
        "A Ni-kshay Mitra may be an individual, institution, corporate or elected representative, and **supports for at least six months** - the length of a course. [MoHFW 2024]",
        "**The treatment supporter gets an honorarium, higher in drug-resistant cases**, and private providers a notification incentive - payment buys completion. [NTEP TOG 2024]",
        "**An informant incentive covers referral from difficult and tribal areas**, and tribal patients a transport allowance - distance loses patients. [NTEP TOG 2024]",
        ...
        "Administrative measures are **early identification and fast-tracking of coughing patients**, cough hygiene and a patient mask - waiting rooms transmit. [NTEP TOG 2024]",
        "Environmental control is **a separate waiting area with cross-ventilation and exhaust**, and sputum collected outdoors - dilution kills the aerosol. [NTEP TOG 2024]",
        ...
        "**BCG at birth, or as soon as possible up to one year**, protects children from disseminated and meningeal TB only - not from infection. [NIS MoHFW 2024]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          heading: "1. History and examination",
          points: [
            "Record **duration and character of cough, sputum, haemoptysis, fever pattern, night sweats and quantified weight loss** - each tracks response later. [NTEP TOG 2024]",
            ...
            "Risk factors: **HIV, diabetes, smoking, alcohol, undernutrition, silica or biomass exposure, steroids, occupation, housing** - each shapes the plan. [NTEP TOG 2024]",
            "Examine **weight, height and BMI, pallor, lymph nodes and chest**, then look deliberately for extrapulmonary sites - a node changes the sample sent. [NTEP TOG 2024]",
          ],
        },
        {
          heading: "2. Investigations under the programme",
          points: [
            "**Upfront NAAT on sputum, CBNAAT or Truenat**, detects M. tuberculosis and rifampicin resistance in one run - one test satisfies universal DST. [NTEP TOG 2024]",
            ...
            "**If rifampicin resistance is detected, send first- and second-line LPA with culture and refer to the District DR-TB Centre** that day - delay transmits. [NTEP TOG 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "If HIV positive, give **cotrimoxazole preventive therapy and start ART within two weeks** irrespective of CD4 count - early ART halves mortality. [NACO 2021]",
          ],
        },
        {
          ...
          points: [
            ...
            "**Follow-up smear at month 2 and month 6**; a positive smear at month 2 prompts NAAT with DST, not extension - dead bacilli stain too. [NTEP TOG 2024]",
            "**Sputum positive at month 5 or later is treatment failure** - re-evaluate with DST and change the regimen. [NTEP TOG 2024]",
            "Watch for **jaundice (hepatitis), colour disturbance (ethambutol), tingling feet (isoniazid), joint pain (pyrazinamide)** - each names the drug to stop. [NTEP TOG 2024]",
        ...
        },
        {
          ...
          points: [
            "**Screen every household contact for symptoms**, with chest radiograph and NAAT for those who are symptomatic - a third are already infected. [NTEP TOG 2024]",
            ...
            "**Ni-kshay Poshan Yojana pays Rs 1,000 a month by direct benefit transfer** for the whole treatment, plus a supplement if undernourished - food raises cure. [MoHFW 2024]",
            "**Pradhan Mantri TB Mukt Bharat Abhiyaan links the patient to a Ni-kshay Mitra** who provides a monthly food basket - undernutrition drives relapse. [MoHFW 2024]",
      ...
      answer: [
        {
          heading: "Definitions",
          points: [
            "**MDR-TB is resistance to at least isoniazid and rifampicin**; RR-TB is rifampicin resistance with or without others - either loses the sterilising drug. [WHO 2021]",
            "**Pre-XDR-TB is MDR/RR-TB with additional resistance to any fluoroquinolone** - the strongest second-line drug is gone. [WHO 2021]",
            ...
            "Resistance is **primary when transmitted, acquired when made** by poor regimens, irregular intake or under-dosing - sub-lethal levels select mutants. [NTEP PMDT 2021]",
          ],
        },
        {
          heading: "Diagnosis",
          points: [
            "**Universal DST: every diagnosed patient has rifampicin resistance tested upfront** by CBNAAT or Truenat MTB-RIF Dx - history alone misses it. [NTEP TOG 2024]",
            "Rifampicin resistance triggers **first- and second-line LPA with liquid culture DST** for fluoroquinolones and bedaquiline - the regimen hangs on it. [NTEP PMDT 2024]",
            "Higher risk: **previously treated patients, treatment failures, contacts of resistant cases and first-line non-responders** - exposure selects mutants. [NTEP PMDT 2024]",
          ],
        },
        {
          heading: "Treatment",
          points: [
            ...
            "**The shorter oral bedaquiline regimen runs 9-11 months and the longer oral regimen 18-20 months** - fewer active drugs need more time to sterilise. [NTEP PMDT 2024]",
            "The longer regimen uses **Group A (fluoroquinolone, bedaquiline, linezolid), Group B (clofazimine, cycloserine), then Group C** - ranked by proven efficacy. [WHO 2022]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Monthly blood counts with neurological and visual checks for linezolid**, thyroid function on ethionamide and PAS - toxicity accumulates over months. [NTEP PMDT 2024]",
            ...
            "Prevention is **correct weight-band first-line treatment and never adding a single drug to a failing regimen** - one drug alone selects resistance. [NTEP PMDT 2024]",
          ],
        },
      ],
      ...
      answer: [
        {
          heading: "Recognition",
          points: [
            "Suspect it with **anorexia, nausea, vomiting, right upper quadrant pain, jaundice or dark urine in the first two months** - most hepatitis strikes early. [NTEP TOG 2024]",
            "Defined as **ALT over three times the upper limit with symptoms, or over five times without**, or rising bilirubin with jaundice - lesser rises adapt. [NTEP TOG 2024]",
            "Check **liver function, bilirubin and prothrombin time**, and exclude hepatitis A, B and E, alcohol and biliary disease - drugs are not the only cause. [NTEP TOG 2024]",
            "Higher risk: **undernutrition, alcohol use, liver disease, hepatitis B or C, HIV, age and slow acetylators** - less reserve, more toxic metabolite. [NTEP TOG 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "If severe or sputum positive, cover with a **non-hepatotoxic holding regimen of levofloxacin, ethambutol and an aminoglycoside** - the load must not grow. [NTEP TOG 2024]",
        ...
        },
        {
          ...
          points: [
            "Restart only when **ALT falls below twice the upper limit of normal, bilirubin normalises and symptoms settle** - a recovering liver is easily hit again. [NTEP TOG 2024]",
            ...
            "Counsel on **alcohol, paracetamol dose limits and over-the-counter or traditional remedies**, and follow liver function until normal - each adds insult. [NTEP TOG 2024]",
          ],
        },
      ],
      mustDraw: [
...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "**CURB-65 scores one point each for Confusion, Urea above 7 mmol/L and Respiratory rate 30 or more** - each marks organ strain. [OHCM 11e 2024]",
        "CURB-65 adds a point for **low Blood pressure and age 65 or over**, because the score predicts 30-day mortality, not the shadow. [OHCM 11e 2024]",
        "Confusion means **new disorientation in person, place or time, or an Abbreviated Mental Test score of 8 or less** - not chronic dementia. [OHCM 11e 2024]",
        "The urea cut-off of 7 mmol/L is **about 19-20 mg/dL of blood urea**, as Indian laboratories report urea in mg/dL. [OHCM 11e 2024]",
        "The blood pressure point is **systolic under 90 or diastolic 60 mmHg or less** - either means the circulation is already failing. [OHCM 11e 2024]",
        "**Score 0-1 is low mortality and treatable at home; 2 needs hospital-supervised care**, as mortality rises steeply per point. [NICE NG250 2025]",
        "Score **3 or more is severe pneumonia needing admission** - mortality at that level is too high for home treatment. [NICE NG250 2025]",
        "**A score of 4-5 prompts assessment for intensive care** - mortality there approaches a third, so the decision cannot wait for deterioration. [OHCM 11e 2024]",
        "**CRB-65 drops the urea** for the clinic with no laboratory, so severity can still be graded at the bedside. [NICE NG250 2025]",
        "CRB-65: **0 treat at home, 1-2 refer for assessment, 3-4 admit urgently** - the higher the score, the less safe home care is. [NICE NG250 2025]",
        "**SpO2 under 92% on room air overrides any score** - hypoxaemia predicts death better than the clinical variables it replaces. [OHCM 11e 2024]",
        ...
        "**In children, fast breathing defines pneumonia** - the count is the only sign that needs no stethoscope. [IMNCI MoHFW 2023]",
        "Cut-offs: **60 or more per minute under 2 months, 50 or more at 2-12 months, 40 or more at 1-5 years**, as normal rate falls with age. [IMNCI MoHFW 2023]",
        "**Chest indrawing, stridor at rest or inability to drink is severe pneumonia** needing referral - the child is already tiring. [IMNCI MoHFW 2023]",
        "So are **convulsion, lethargy or severe undernutrition**, because each predicts death without inpatient oxygen and antibiotics. [IMNCI MoHFW 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "**Pulse oximetry on room air in every patient** - it is the number that decides admission more often than the severity score does. [OHCM 11e 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Thromboprophylaxis for the admitted patient; no chest physiotherapy and no cough suppressants** - neither helps and suppressants retain sputum. [OHCM 11e 2024]",
      ],
    },
    {
      ...
      points: [
        ...
        "Non-resolution may be **a complication: parapneumonic effusion, empyema or lung abscess** - examine and image rather than change the drug. [BTS 2023]",
        ...
        "**Tap any parapneumonic effusion under ultrasound guidance** - the biochemistry, not the size, decides whether it needs a drain. [BTS 2023]",
        "**pH under 7.20, glucose under 40-60 mg/dL or LDH above 1000 IU/L means intercostal drainage** - the fluid is becoming empyema. [BTS 2023]",
        "A **positive Gram stain or frank pus** also demands a drain, because antibiotics cannot sterilise an undrained collection. [BTS 2023]",
        "**Repeat the chest radiograph at 6 weeks in smokers, those over 50 and anyone with persistent symptoms** - to exclude an underlying malignancy. [OHCM 11e 2024]",
        "**Radiographic clearance always lags behind clinical recovery** - a persistent shadow at two weeks is not treatment failure. [OHCM 11e 2024]",
        ...
        "Set expectations: **fever settles in a week, chest pain and sputum in four weeks, cough and fatigue in six weeks to three months** - slow is normal. [NICE NG250 2025]",
        "**Full recovery can take six months in the elderly** - saying so prevents a lingering cough being treated with repeated antibiotics. [NICE NG250 2025]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**CURB-65: one point each for new confusion, urea above 7 mmol/L (about 19-20 mg/dL) and rate 30 or more** - each marks organ strain. [OHCM 11e 2024]",
            "CURB-65 adds a point for **low BP and age 65 or over**, because the score predicts 30-day mortality, not the size of the shadow. [OHCM 11e 2024]",
            "The blood pressure point is **systolic under 90 or diastolic 60 mmHg or less**; he already scores 1 for age - either means failing circulation. [OHCM 11e 2024]",
            "**Score 0-1 home, 2 hospital-supervised, 3 or more severe pneumonia**, with intensive care assessment at 4-5 - mortality rises per point. [OHCM 11e 2024]",
            "Where there is no laboratory use **CRB-65: 0 home, 1-2 refer, 3-4 urgent admission** - the urea adds little to the other four. [NICE NG250 2025]",
            "Override the score and admit for **SpO2 under 92% on air, multilobar disease or effusion** - the score does not measure these. [OHCM 11e 2024]",
            "Admit also for **uncontrolled diabetes, vomiting or an unsafe home**, because oral antibiotics need a gut and a carer to work. [OHCM 11e 2024]",
          ],
        },
        {
        ...
        },
        {
          ...
          points: [
            ...
            "**Non-resolution means looking for empyema, lung abscess, tuberculosis, an obstructing lesion or a resistant organism** - not escalating blindly. [BTS 2023]",
            ...
            "**Aspirate any significant effusion under ultrasound**, because a simple effusion and an empyema look identical on film. [BTS 2023]",
            "**pH under 7.20, glucose under 40-60 mg/dL, LDH over 1000 IU/L or pus** need a drain - drugs cannot sterilise a collection. [BTS 2023]",
        ...
        },
        {
          ...
          points: [
            "**Repeat the chest radiograph at 6 weeks because of his age** - to confirm resolution and exclude an underlying carcinoma. [OHCM 11e 2024]",
            ...
            "**Explain the recovery timeline** so that a lingering cough does not lead to repeated courses of antibiotics. [NICE NG250 2025]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "**Complications: parapneumonic effusion, empyema, lung abscess, necrotising pneumonia and metastatic infection** - drugs do not reach pus. [BTS 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "Repeat the radiograph, then **contrast-enhanced CT of the chest**, because CT defines abscess, empyema, endobronchial obstruction and nodes. [BTS 2023]",
            ...
            "**Ultrasound-guided pleural aspiration** for any effusion - ultrasound finds loculations and avoids a dry tap. [BTS 2023]",
            "Send cell count, protein, LDH, glucose, pH, **ADA**, cytology, Gram stain, NAAT and culture, as one tap answers TB, empyema and cancer. [BTS 2023]",
            "Refer for **bronchoscopy with lavage, brushings and biopsy** where obstruction or malignancy is suspected - sputum cannot sample a blocked lobe. [BTS 2023]",
            "Bronchoscopy also reaches an unusual infection, because lavage samples the alveolus that sputum never represents. [BTS 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Drain empyema early, treat tuberculosis under the programme, and refer suspected malignancy without delay** - each loses ground every week. [BTS 2023]",
  ...
  sections: [
    {
      ...
      points: [
        ...
        "**Influenza-like illness is measured fever of 38 degrees C or more with cough, onset within the last 10 days** - a case definition, not a diagnosis. [IDSP 2023]",
        "**SARI is the same illness in a patient needing admission** - both definitions drive IDSP and the WHO network through NIV Pune and the VRDLs. [IDSP 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "Discriminators forcing a radiograph: **pulse over 100, rate over 24 or temperature over 38 degrees C** - these mark systemic illness. [IDSA/ATS 2019]",
        "Also **focal crackles or SpO2 under 94%**, because either means the alveoli are involved, not just the airway. [IDSA/ATS 2019]",
        ...
        "The exceptions: **pertussis and suspected pneumonia** - both have a bacterial cause that antibiotics actually remove. [ICMR 2022]",
        "Also **a COPD exacerbation meeting antibiotic criteria, and the immunocompromised or very frail**, because the host cannot contain it. [ICMR 2022]",
        "**In each the bacterial load, not the cough, is what antibiotics change** - so the indication is the host, not the symptom. [ICMR 2022]",
        ...
        "**Dextromethorphan has only a small effect in adults** - the cough reflex is not the problem. [NICE 2019]",
        "**Codeine is barred under 12 years and in breastfeeding women**, because ultrarapid metabolisers can stop breathing. [US FDA 2017]",
        "**Salbutamol helps only where there is wheeze** - there is no bronchospasm to reverse otherwise. [NICE 2019]",
        "Inhaled or oral steroids have no place in acute bronchitis without asthma, because the inflammation is viral and self-limiting. [NICE 2019]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Azithromycin 10 mg/kg on day 1 then 5 mg/kg daily on days 2-5**, adults 500 mg then 250 mg, as macrolides clear carriage. [WHO 2018]",
        "Clarithromycin for **7 days** is the alternative, so a macrolide allergy or a supply gap need not leave the household exposed. [WHO 2018]",
        ...
        "**Treat all household contacts whatever their vaccination status** - the adult with a mild cough is usually the source. [WHO 2018]",
        "This matters most where there is **an infant, a pregnant woman or an immunocompromised person**, as the infant is the one who dies. [WHO 2018]",
        ...
        "**Tdap in every pregnancy between 27 and 36 weeks** gives transplacental antibody, so the newborn is covered until its own primary doses. [FOGSI 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "Also high risk: **chronic lung, heart, liver, kidney or neurological disease** - each cuts respiratory reserve or clearance. [MoHFW 2023]",
        "Also **diabetes, cancer, HIV, long-term steroids and obesity**, because each blunts the immune response to the virus. [MoHFW 2023]",
        "Children on long-term aspirin are included, because influenza with aspirin risks Reye syndrome. [MoHFW 2023]",
        "**Category A is mild illness with no high-risk feature: no test, no oseltamivir**, home rest and hygiene - testing would not change anything. [MoHFW 2019]",
        "**Category B(i) adds high-grade fever and severe sore throat: oseltamivir and home isolation, still no test** - treat on the syndrome. [MoHFW 2019]",
        "**Category B(ii) is Category A in any high-risk group: oseltamivir without waiting for a test**, because the drug works best inside 48 hours. [MoHFW 2019]",
        "**Category C is breathlessness, chest pain, drowsiness, hypotension, haemoptysis or cyanosis** - each means the lung or circulation is failing. [MoHFW 2019]",
        "Worsening chronic disease also counts - **test, admit and treat now**, without waiting for the swab result. [MoHFW 2019]",
        "Category C is the group that dies, so admission is the decision, not the test result. [MoHFW 2019]",
        "In a child Category C is **irritability, refusal to feed or fast breathing** - and an unavailable result never delays treatment. [MoHFW 2019]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Effectiveness is 40-60% in a well-matched year**, so the real benefit is fewer admissions and deaths, not fewer colds. [WHO 2024]",
        "Say that plainly, because a patient who expects zero illness calls the vaccine a failure. [WHO 2024]",
        "Vaccinate **every high-risk group, health workers, children from 6 months to 5 years and adults of 65 and over** - these are the ones admitted. [MoHFW 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Moderate is rate 24-30 per minute or SpO2 90-93%**; severe is rate over 30, SpO2 under 90%, ARDS or shock, as the grade sets the drugs. [AIIMS-ICMR 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "Each unnecessary course selects resistance in the patient's **own flora**, not only in the community - the next infection is harder to treat. [NAP-AMR 2023]",
      ...
      answer: [
        {
          ...
          points: [
            "History: **onset, fever pattern, cough, sore throat, breathlessness and chest pain** - abrupt onset with prostration suggests influenza. [MoHFW 2023]",
            "Ask also about **contacts, travel and vaccination status**, plus fetal movements, because pregnancy changes both risk and plan. [MoHFW 2023]",
            "Examine **temperature, pulse, respiratory rate, blood pressure and SpO2 on room air** - the rate and saturation decide the category. [MoHFW 2023]",
            "Examine throat and chest, with **fundal height and fetal heart rate**, because the fetus is the second patient in this consultation. [MoHFW 2023]",
            "Look for Category C: **breathlessness, rate over 24 or SpO2 under 94%** - hypoxia in pregnancy reaches the fetus first. [MoHFW 2019]",
            "Category C also includes **chest pain, drowsiness, hypotension, cyanosis or reduced fetal movements**, as each means admission today. [MoHFW 2019]",
        ...
        },
        {
          ...
          points: [
            "**Category A is mild symptoms with no risk factor** - no test, no antiviral, home care. [MoHFW 2019]",
            "**Category B(i) is high-grade fever with severe sore throat** - oseltamivir and home isolation, no test. [MoHFW 2019]",
            "**Category B(ii) is Category A symptoms in a high-risk group** - pregnancy, under 5 or over 65, chronic disease, immunosuppression, long-term steroids. [MoHFW 2019]",
            "**Category B(ii) gets oseltamivir immediately without testing** - waiting for a swab wastes the window in which the drug works. [MoHFW 2019]",
            "**Category C means admission** and RT-PCR on nasopharyngeal and throat swab through the VRDL, because the diagnosis must be confirmed. [MoHFW 2019]",
            "Start **oseltamivir before the result**, as the benefit falls away after the first 48 hours of symptoms. [MoHFW 2019]",
            "**She is Category B(ii)** - pregnancy alone makes her high risk, so oseltamivir starts without a test. [MoHFW 2019]",
            "Any breathlessness, hypoxaemia or obstetric concern makes her Category C, because she then needs obstetric and intensive care together. [MoHFW 2019]",
          ],
        },
        {
          heading: "3. Treatment",
          points: [
            ...
            "If it does, **add amoxicillin-clavulanate and review for admission**, because secondary bacterial pneumonia follows influenza. [IDSA/ATS 2019]",
            "**Home isolation in a separate ventilated room for 7 days or until 24 hours after the fever settles** - shedding tracks the fever. [MoHFW 2023]",
            "Add a triple-layer mask and hand hygiene, because source control on the patient beats masking the whole household. [MoHFW 2023]",
            "Telephone daily about **breathing, SpO2 where an oximeter exists, and fetal movements** - deterioration in pregnancy is fast and quiet. [MoHFW 2023]",
            "Written instruction to return at once for **breathlessness, chest pain or drowsiness** - each marks the shift to Category C. [MoHFW 2023]",
            "Return also for **bleeding, reduced fetal movements or fever beyond 3 days**, because spoken advice is forgotten by the time it matters. [MoHFW 2023]",
          ],
        },
        {
          ...
          points: [
            ...
            "**Post-exposure prophylaxis is oseltamivir 75 mg once daily for 10 days** for high-risk contacts, as a child under 5 has least reserve. [MoHFW 2023]",
            "Vaccinate the household with **annual influenza vaccine, and her once recovered** - cocooning protects the one who cannot be vaccinated. [FOGSI 2023]",
            "Give Tdap between **27 and 36 weeks** if not already given, because maternal antibody is the newborn's only pertussis cover. [FOGSI 2023]",
            "Counsel on **cough etiquette, masks and ventilation**, and say plainly that antibiotics have no role, as the illness is viral. [ICMR 2022]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Viruses: **influenza A and B, parainfluenza, RSV, rhinovirus, coronaviruses including SARS-CoV-2, adenovirus** - the list is entirely viral. [ICMR 2022]",
            "Bacteria account for under **10%** of acute bronchitis, so a routine antibiotic treats nobody and harms the flora. [ICMR 2022]",
            "**Cough lasts a median of 18 days**, often productive - the purulence is shed epithelium, not evidence of bacteria. [ICMR 2022]",
            "Expect wheeze, retrosternal soreness, low-grade fever and coryza, because the inflammation runs the whole length of the airway. [ICMR 2022]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Point-of-care CRP: under 20 mg/L no antibiotic, 20-100 mg/L delayed prescription, over 100 mg/L treat as pneumonia** - it sorts the uncertain. [NICE 2019]",
            "**Any cough reaching 2 weeks in India is presumptive tuberculosis**, so test the sputum before calling it post-viral. [NTEP TOG 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "Antibiotics only for **pertussis (azithromycin 5 days) or suspected pneumonia** - both have a bacterial cause worth removing. [ICMR 2022]",
            "Also for **a COPD exacerbation with purulent sputum, or the frail and immunocompromised**, because the host cannot clear it alone. [ICMR 2022]",
            "Symptomatic care: **paracetamol, fluids, honey after 1 year of age, and a salbutamol inhaler only if wheezing** - honey risks botulism under 1 year. [ICMR 2022]",
            ...
            "**Explain the expected 3-week course and give a written safety net**, because the patient who expects 3 days returns for antibiotics. [NICE 2019]",
            "Use a delayed prescription where the patient insists on a drug, as most delayed prescriptions are never filled. [NICE 2019]",
          ],
        },
      ],
  ...
  sections: [
    {
      ...
      points: [
        ...
        "**Five mechanisms: raised hydrostatic pressure, low oncotic pressure, leaky capillaries, blocked lymphatics, diaphragm passage** - each names a cause. [Harrison 21e]",
        ...
        "Exudates too: **rheumatoid arthritis, lupus, pancreatitis (left-sided, high amylase), subphrenic abscess, post-cardiac injury** - inflamed pleura leaks. [Harrison 21e]",
        ...
        "**A massive effusion opacifying the hemithorax is malignant first**, then tubercular, then empyema or hepatic hydrothorax - benign causes rarely fill a chest. [BTS 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "A **dry cough** is usual; ask for fever, night sweats, weight loss, smoking, asbestos, past TB, orthopnoea, joint disease, drugs - the cause is in the history. [BTS 2023]",
        ...
        "The signs are **reduced movement, stony dull percussion, absent breath sounds, and reduced vocal fremitus and resonance** - fluid damps every vibration. [Harrison 21e]",
        ...
        "**Bronchial breathing and aegophony just above the fluid level** come from compressed lung, not from pneumonia underneath - airless lung conducts sound. [Harrison 21e]",
        "**The trachea and apex beat shift away from a large effusion**, and a left effusion obliterates Traube's space - the fluid mass pushes, it does not pull. [Harrison 21e]",
        ...
        "**Thoracic ultrasound detects as little as 5-20 mL** and shows septations, loculation and pleural thickening - each predicts a drain that fails. [BTS 2023]",
        ...
        "**Ultrasound guidance is the standard of care for every pleural aspiration and drain**, cutting pneumothorax from 10-20% to under 5% - the needle sees lung. [BTS 2023]",
        ...
        "**Involvement of the mediastinal pleura is the most specific malignant sign**, and CT shows lung, nodes and endobronchial lesions - it finds the primary. [BTS 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "**Tap even that if unilateral or unequal, febrile, painful, without cardiomegaly, or fails to clear after 3 days of diuretics** - each denies simple failure. [BTS 2023]",
        "Sit the patient **leaning forward**, which drops the diaphragm and widens the posterior intercostal spaces - the liver and spleen move away from the needle. [BTS 2023]",
        "Choose the site **by ultrasound, one to two spaces below the top of dullness in the posterior axillary or mid-scapular line** - lower risks the diaphragm. [BTS 2023]",
        ...
        "Relative contraindications: **INR over 1.5-2, platelets under 50,000 per microlitre, uncorrected anticoagulation, skin infection** - bleeding or seeding. [BTS 2023]",
        ...
        "**Third: pleural fluid LDH over two-thirds of the upper limit of normal serum LDH**, about 200 U/L in most laboratories - it marks cell turnover in the space. [BTS 2023]",
        ...
        "**Serum-to-pleural protein gradient over 3.1 g/dL, or albumin gradient over 1.2 g/dL, makes it a transudate** if heart failure is likely - diuresis misleads. [BTS 2023]",
        ...
        "Send **total and differential cell count, with Gram stain and culture into blood-culture bottles** - broth culture raises the bacterial yield markedly. [BTS 2023]",
        "Send **AFB smear, Xpert Ultra NAAT, mycobacterial culture and adenosine deaminase** on every lymphocytic exudate in India - TB is the commonest cause. [NTEP TOG 2024]",
        ...
        "Add **triglycerides for milky fluid, amylase for pancreatitis or oesophageal rupture, haematocrit for bloody fluid** - each test names one cause. [BTS 2023]",
        ...
        "**Risk is highest in a large or old effusion**, where lung collapsed for weeks has lost surfactant and capillary integrity - it leaks on re-expansion. [BTS 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "**ADA over 70 U/L is highly specific**; false positives are empyema, lymphoma and rheumatoid effusion, all rich in activated cells - they make ADA too. [NTEP TOG 2024]",
        "Supporting numbers: **a lymphocyte-to-neutrophil ratio over 0.75, mesothelial cells under 5%, and a modestly low glucose** - fibrin coats the mesothelium. [NTEP TOG 2024]",
        "**Interferon-gamma over 140 pg/mL performs even better than ADA** but is rarely available outside research laboratories - so ADA remains the working test. [Harrison 21e]",
        ...
        "**Closed pleural biopsy with an Abrams or Cope needle shows granulomas in about 80%**, with culture confirming over 90% - bacilli sit in the pleura. [Harrison 21e]",
        ...
        "**NTEP allows a clinically diagnosed EPTB label** for a lymphocytic exudate with high ADA once cancer and empyema are unlikely - fluid holds few bacilli. [NTEP TOG 2024]",
        ...
        "**The continuation phase is extended only for neurological, skeletal and disseminated disease, not for the pleura** - pleural bacilli are few. [NTEP TOG 2024]",
        ...
        "**Residual pleural thickening remains in up to half of patients and needs no extension of treatment** - it is scar, not live disease. [NTEP TOG 2024]",
      ],
    },
    {
      ...
      points: [
        ...
        "**An uncomplicated parapneumonic effusion is small and free-flowing, with pH over 7.20 and glucose over 60 mg/dL**, Gram negative - antibiotics alone clear it. [BTS 2023]",
        ...
        "**A positive Gram stain or culture, or loculation on ultrasound, is equally sufficient** to call it complicated - organisms in the space need a drain. [BTS 2023]",
        ...
        "**Insert it in the safe triangle in the fifth intercostal space**, connected to an underwater seal - the seal lets air out but never back in. [BTS 2023]",
        "**The safe triangle lies between latissimus dorsi in front and pectoralis major laterally**, apex below the axilla - no muscle or vessel. [BTS 2023]",
        ...
        "**Give amoxicillin-clavulanate, or ceftriaxone plus metronidazole, for 2-6 weeks** by clinical and radiological response - pus needs long courses. [BTS 2023]",
        ...
        "**Failure at 5-7 days with persisting sepsis or loculation calls for intrapleural tissue plasminogen activator with DNase**, MIST2 - it liquefies pus. [BTS 2023]",
        ...
        "**In children empyema follows staphylococcal or pneumococcal pneumonia** and needs paediatric surgical referral, not bedside drainage - it loculates fast. [BTS 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Therapeutic aspiration treats symptoms; recurrence needs an indwelling pleural catheter or talc pleurodesis** - repeated taps only re-accumulate. [BTS 2023]",
        ...
        "**Lymphoma is the commonest non-traumatic chylothorax**, then thoracic duct injury at surgery, then lymphangioleiomyomatosis - each blocks the duct. [Harrison 21e]",
        ...
        "**Rheumatoid effusion has the lowest glucose of all, often under 30 mg/dL**, with low pH, high LDH and rheumatoid factor - thick pleura blocks glucose. [Harrison 21e]",
        ...
        "**Post-cardiac injury or Dressler effusion follows infarction or heart surgery** with fever and pericarditis, responding to NSAIDs or colchicine - immune. [Harrison 21e]",
        ...
        "**The family physician's task is the first tap, the notification of tuberculosis, and the end-of-treatment radiograph** - each is where cases are lost. [NTEP TOG 2024]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "**Subphrenic abscess and pancreatitis act from below the diaphragm**, and post-viral or drug-induced effusion completes the list - the diaphragm is porous. [Harrison 21e]",
            "**A transudate is unlikely in a febrile 24-year-old**, but heart failure, nephrotic syndrome and cirrhosis are excluded clinically - fever is inflammation. [BTS 2023]",
          ],
        },
        {
          ...
          points: [
            ...
            "**Tracheal and apical shift to the left in a large effusion**, with bronchial breathing from compressed lung above the fluid - mass pushes, collapse pulls. [Harrison 21e]",
        ...
        },
        {
          ...
          points: [
            "**Chest radiograph for a blunted costophrenic angle with a meniscus**, and for any parenchymal lesion that would raise the sputum yield - cavity means sputum. [BTS 2023]",
            ...
            "**Ultrasound-guided diagnostic thoracentesis** for protein, LDH and glucose with paired serum values, and pH in a heparinised syringe - air raises pH. [BTS 2023]",
            "Also send **cell count and differential, Gram stain and culture, AFB smear, Xpert Ultra, mycobacterial culture, ADA and cytology** - one tap answers all. [NTEP TOG 2024]",
            "**Expected in TB: a straw-coloured exudate by Light's criteria with protein over 5 g/dL** and lymphocyte predominance - hypersensitivity, not pus. [NTEP TOG 2024]",
            "**Lymphocytes over 80%, mesothelial cells under 5% and ADA over 40 U/L**, with Xpert Ultra positive in about half of cases - the fluid holds few bacilli. [NTEP TOG 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "**No routine steroids**; give breathing exercises and paracetamol for the pleuritic pain instead - steroids do not reduce residual thickening. [NTEP TOG 2024]",
            ...
            "**Warn about paradoxical enlargement in the first weeks** and enrol the patient for Ni-kshay Poshan Yojana support - dying bacilli inflame more. [NTEP TOG 2024]",
            "**Screen household contacts by symptom screen and chest radiograph**, and offer TB preventive treatment to the eligible - the source is often at home. [NTEP TOG 2024]",
            ...
            "**If the fluid is purulent or the pH under 7.20, insert an ultrasound-guided intercostal drain** and give antibiotics for 2-6 weeks - drugs do not reach pus. [BTS 2023]",
            "**Use amoxicillin-clavulanate, or ceftriaxone with metronidazole**, to cover the anaerobes that drive most empyemas - cultures miss them. [BTS 2023]",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "**Specificity is limited: about 25% of transudates in patients on diuretics are misclassified** as exudates - concentration mimics protein leak. [BTS 2023]",
            "**Diuresis removes water and concentrates protein and LDH in the residual fluid**, pushing both ratios over their thresholds - so the gradient test is added. [BTS 2023]",
            ...
            "**Pleural NT-proBNP over 1,500 pg/mL supports heart failure** even when Light's criteria call the fluid an exudate - the ventricle, not the pleura, makes it. [BTS 2023]",
            "**Transudates: heart failure, cirrhosis, nephrotic syndrome, hypoalbuminaemia, peritoneal dialysis, hypothyroidism, urinothorax** - pressure or oncotic shifts. [BTS 2023]",
            "**Exudates: tuberculosis, parapneumonic effusion and empyema, malignancy, pulmonary embolism and connective tissue disease** - each inflames the pleura. [BTS 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Bloody fluid means malignancy, embolism or trauma**; a pleural haematocrit over 50% of the blood value makes it a haemothorax - which needs a drain. [BTS 2023]",
            "**Milky fluid is chylothorax, confirmed by triglycerides over 110 mg/dL** rather than by appearance alone, since empyema looks milky too. [Harrison 21e]",
            "**Protein and LDH with paired serum values apply Light's criteria** - an unpaired value simply cannot be scored. [BTS 2023]",
            "**Glucose under 60 mg/dL and pH under 7.30** occur in complicated parapneumonic effusion, empyema, TB, malignancy and rheumatoid effusion - cells eat glucose. [BTS 2023]",
            ...
            "**Neutrophils mean acute infection or embolism; lymphocytes over 80% with mesothelial cells under 5% mean tuberculosis** - fibrin shuts out mesothelium. [Harrison 21e]",
            ...
            "**Gram stain and culture go into blood-culture bottles**, which raise the organism yield above a plain container - broth supports fastidious growth. [BTS 2023]",
            "**Send AFB smear, Xpert Ultra and mycobacterial culture**, and cytology on at least 50 mL, which yields 60% on the first sample - volume is the yield. [NTEP TOG 2024]",
          ],
        },
        {
          ...
          points: [
            ...
            "**Rheumatoid factor and ANA in the fluid for connective tissue disease**, and triglycerides for suspected chylothorax - the routine panel misses both. [Harrison 21e]",
  ...
  sections: [
    {
      ...
      points: [
        "**OSA is repetitive partial or complete collapse of the upper airway during sleep**, each apnoea or hypopnoea ending in an arousal - the arousal reopens it. [AASM 2023]",
        ...
        "The result is **intermittent hypoxaemia with fragmented sleep**, and those two drive every consequence - oxidative stress plus no rest. [AASM 2023]",
        ...
        "Qualifying symptoms are **sleepiness, unrefreshing sleep, insomnia, gasping awakenings and witnessed apnoeas** - with one, an AHI of 5 diagnoses. [AASM 2023]",
        "Qualifying comorbidities are **hypertension, coronary disease, atrial fibrillation, stroke, diabetes and mood disorder** - each worsens with apnoea. [AASM 2023]",
        ...
        "Other risks: **male sex, age over 50, post-menopause, retrognathia, and a crowded pharynx, Mallampati 3-4 or big tonsils** - less room to breathe. [AASM 2023]",
        ...
        "The complaint is instead **fatigue, poor concentration, morning headache, nocturia, resistant hypertension or a road accident** - sleepiness goes unsaid. [AASM 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "Other nocturnal features: **restless sleep, night sweats, nocturia of two or more voids, reflux, insomnia** - each apnoea strains and wakes. [AASM 2023]",
        "Daytime features: **unrefreshing sleep, excessive daytime sleepiness, morning headache and dry mouth** from mouth breathing - CO2 makes the headache. [AASM 2023]",
        "Also **impaired concentration and memory, irritability, low mood, reduced libido and erectile dysfunction** - broken sleep starves the cortex. [AASM 2023]",
        ...
        "**Neck circumference over 43 cm in men and over 41 cm in women is a risk marker**, since it indexes the parapharyngeal fat that loads the airway. [AASM 2023]",
        "Examine the airway: **modified Mallampati score, tonsil size, nasal patency, septal deviation, retrognathia and overbite** - each narrows the pharynx or nose. [AASM 2023]",
        ...
        "Its thresholds are **BMI over 35 kg/m2, Age over 50 years, Neck circumference over 40 cm, and male Gender** - each independently predicts collapse. [AASM 2023]",
        ...
        "**The Epworth Sleepiness Scale scores the chance of dozing in eight everyday situations, 0 to 3 each, total 0-24** - it quantifies what patients under-report. [AASM 2023]",
        "**A score above 10 indicates excessive daytime sleepiness**, but it measures sleepiness, not the severity of obstruction - a low score never excludes OSA. [AASM 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "It records **EEG, EOG, chin and leg EMG, ECG, nasal pressure and oronasal thermal airflow** - EEG stages sleep, so events are scored per hour actually slept. [AASM 2023]",
        ...
        "It yields **the AHI, arousal index, sleep stages, oxygen desaturation index and the lowest SpO2** - together they grade severity and hypoxic burden. [AASM 2023]",
        "**Level 3 home sleep apnoea testing suits uncomplicated adults with a high pre-test probability of moderate-to-severe OSA** - it cannot stage sleep. [AASM 2023]",
        ...
        "**A negative or technically inadequate home study in a symptomatic patient must be followed by full polysomnography** - home tests under-count events. [AASM 2023]",
        "**Home testing is not appropriate with significant cardiorespiratory disease, hypoventilation or neuromuscular weakness** - it misses central events. [AASM 2023]",
        ...
        "**Severity by AHI: mild 5 to under 15, moderate 15 to under 30, severe 30 or more events per hour** - the bands decide who must have CPAP. [AASM 2023]",
        ...
        "Baseline tests that change management: **TSH, fasting glucose or HbA1c, lipid profile, haemoglobin for polycythaemia** - each is a treatable partner. [AASM 2023]",
        ...
        "**Arterial blood gas or venous bicarbonate in the very obese: a raised bicarbonate is the cheap clue to daytime hypercapnia** - the kidney buffers CO2. [AASM 2023]",
        "Exclude first: **insufficient sleep syndrome, the commonest cause of sleepiness in India, plus shift work disorder and narcolepsy** - CPAP treats none. [INOSA 2014]",
    ...
    },
    {
      ...
      points: [
        "**Intermittent hypoxaemia, sympathetic surges and negative intrathoracic pressure swings** are the three mechanisms behind cardiac harm - each strains. [AASM 2023]",
        ...
        "It produces **non-dipping or reverse-dipping nocturnal blood pressure**, which carries excess risk whatever the daytime reading - the night never rests. [AASM 2023]",
        ...
        "**Metabolically it causes insulin resistance and worse glycaemic control independent of obesity**, dyslipidaemia, fatty liver - hypoxia raises cortisol. [AASM 2023]",
        ...
        "**Pulmonary hypertension and cor pulmonale develop in a minority**, usually with coexisting obesity hypoventilation or COPD - daytime hypoxia is needed. [AASM 2023]",
        ...
        "**Neurocognitively it impairs attention, memory and executive function**, with depression, irritability and poor work - sleep is never consolidated. [AASM 2023]",
        "**Marital strain from snoring is a real and reversible harm**, and the partner's own sleep improves measurably with treatment - which aids adherence. [AASM 2023]",
        ...
        "**Undiagnosed OSA raises postoperative hypoxaemia, difficult intubation, arrhythmia and unplanned intensive care admission** - sedation removes the arousal. [AASM 2023]",
        "**STOP-BANG was designed as a pre-operative screening tool**, and a score of 5 or more should prompt caution with sedatives and opioids - both blunt arousal. [AASM 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Bariatric surgery can produce remission in the morbidly obese**, which no other single treatment achieves - it removes the fat that loads the airway. [AASM 2023]",
        "**Set a target weight, a diet plan and 150 minutes a week of activity**, and review at every visit rather than mentioning it once - repetition changes weight. [AASM 2023]",
        ...
        "**CPAP is first-line for moderate and severe OSA at an AHI of 15 or more**, whether or not the patient reports symptoms - the cardiovascular risk is silent. [AASM 2023]",
        "**It is also first-line in mild OSA with symptoms, sleepiness or significant cardiovascular comorbidity** - there the benefit outweighs the burden. [AASM 2023]",
        "**CPAP works as a pneumatic splint holding the pharynx open**, abolishing apnoeas and restoring sleep architecture and oxygenation - pressure beats collapse. [AASM 2023]",
        "**It improves sleepiness, quality of life and accident risk**, and lowers blood pressure by about 2-3 mmHg, more if resistant - sympathetic tone falls. [AASM 2023]",
        ...
        "**Add a heated humidifier for dryness**, the commonest reason a new user abandons the machine in the first fortnight - dry air inflames the nose. [AASM 2023]",
        ...
        "**Adherence is measured, not assumed: at least 4 hours a night on at least 70% of nights** is the accepted target - benefit tracks hours of use. [AASM 2023]",
        ...
        "**Early telephone follow-up, education involving the partner, and treating side effects** convert a trial into long-term use - the first month decides. [AASM 2023]",
        "**A dentist-made mandibular advancement device suits mild-to-moderate OSA, primary snoring, and CPAP refusal** - it pulls the tongue base forward. [AASM 2023]",
        ...
        "**Adenotonsillectomy is first-line in children**, where adenotonsillar hypertrophy rather than obesity is usually the cause - remove the obstruction. [AASM 2023]",
    ...
    },
    {
      ...
      points: [
        "**Obesity hypoventilation is BMI 30 or more with awake daytime hypercapnia, PaCO2 above 45 mmHg**, with no other cause - the load has beaten the drive. [AASM 2023]",
        ...
        "**Overlap syndrome is COPD plus OSA**, giving worse nocturnal desaturation, more pulmonary hypertension and more exacerbations - two hypoxic hits add. [AASM 2023]",
        ...
        "**Long-term oxygen alone without addressing the apnoeas can worsen hypercapnia**, since it removes hypoxic drive while the obstruction persists. [AASM 2023]",
        ...
        "**CPAP is safe throughout pregnancy**, and the pressure often needs raising as weight rises through the third trimester - a heavier neck needs more splint. [AASM 2023]",
        "**In children it presents as mouth breathing, restless sleep, sweating, enuresis, failure to thrive and poor school performance** - not sleepiness. [AASM 2023]",
        ...
        "**Adenotonsillar hypertrophy is the usual cause in children and adenotonsillectomy the first-line treatment** - lymphoid tissue, not fat, blocks the airway. [AASM 2023]",
        ...
        "**Perioperatively, avoid or minimise benzodiazepines and opioids and prefer regional anaesthesia** in known or suspected OSA - both kill the rescue arousal. [AASM 2023]",
        "**Nurse in the non-supine position, continue the patient's own CPAP in hospital, and monitor saturation after surgery** - supine gravity worsens collapse. [AASM 2023]",
        "**Counsel documented sleepiness against driving until treated**, and involve the employer where a commercial licence is held - crash risk is doubled or more. [AASM 2023]",
      ...
      answer: [
        {
          heading: "1. History",
          points: [
            "Take the nocturnal history from the wife: **loudness and habituality of snoring, witnessed apnoeas, and choking or gasping arousals** - he sleeps through it. [AASM 2023]",
            ...
            "By day: **unrefreshing sleep, morning headache and dry mouth, impaired concentration, irritability, low mood, reduced libido** - all fragmented sleep. [AASM 2023]",
            ...
            "Ask about **smoking and any antihistamine or opioid prescription**, each of which independently worsens sleepiness and pharyngeal collapse - both sedate. [AASM 2023]",
            "Comorbidity: **the three antihypertensives, diabetes, ischaemic heart disease, atrial fibrillation, stroke and hypothyroidism**, nasal surgery - each links. [AASM 2023]",
        ...
        },
        {
          ...
          points: [
            "Record **BMI, neck circumference (over 43 cm in men is a risk marker), waist and blood pressure in both arms** - fat distribution predicts collapse. [AASM 2023]",
            "Upper airway: **modified Mallampati grade, tonsil size, macroglossia, retrognathia, overbite, septal deviation and turbinate hypertrophy** - each narrows it. [AASM 2023]",
            ...
            "Consequences: **raised jugular venous pressure, loud P2, pedal oedema and hepatomegaly suggesting cor pulmonale** - nightly hypoxia loads the right side. [AASM 2023]",
            "**STOP-BANG: he scores at least 6 of 8** on snoring, tiredness, observed apnoea, blood pressure, age over 50, male sex, likely BMI and neck - high risk. [AASM 2023]",
        ...
        },
        {
          heading: "3. Investigations",
          points: [
            "**Level 1 attended polysomnography is the gold standard**, giving the AHI, arousal index, oxygen desaturation index and lowest SpO2 - it stages sleep too. [AASM 2023]",
            "It also shows **sleep architecture and body position dependence**, which decides whether positional therapy can contribute at all - supine-only OSA responds. [AASM 2023]",
            "**A level 3 home sleep apnoea test is acceptable here**, given the very high pre-test probability of moderate-to-severe disease - a positive result suffices. [AASM 2023]",
            ...
            "**Grade severity on the AHI: mild 5 to under 15, moderate 15 to under 30, severe 30 or more per hour** - the grade decides CPAP. [AASM 2023]",
            "Supporting tests: **TSH, HbA1c, fasting lipids, haemoglobin for secondary polycythaemia, and an ECG** - each finds a partner condition. [AASM 2023]",
            "**Venous bicarbonate or arterial blood gas excludes obesity hypoventilation**, plus echo if pulmonary hypertension is suspected - both change the device. [AASM 2023]",
          ],
        },
        {
          heading: "4. Non-pharmacological management",
          points: [
            "**Prescribe weight reduction with a stated target: a 10% loss reduces the AHI by roughly 25-30%** - less fat around the pharynx. [AASM 2023]",
            "**Set a diet and 150 minutes a week of activity, and consider bariatric referral if the BMI is 35 or more with comorbidity** - surgery can bring remission. [AASM 2023]",
            ...
            "**Give driving advice today: do not drive while sleepy**, and inform the employer if a commercial licence is held - risk precedes treatment. [AASM 2023]",
            ...
            "**Give driving advice today: do not drive while sleepy**, and inform the employer if a commercial licence is held - the risk is present before treatment. [AASM 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "**It also lowers blood pressure**, which is particularly relevant to his resistant hypertension on three drugs - OSA is its hidden cause. [AASM 2023]",
            "**It also lowers blood pressure**, which is particularly relevant to his resistant hypertension on three drugs - OSA is its commonest hidden cause. [AASM 2023]",
            "**Titrate by attended titration or an auto-titrating device, fit the mask carefully, and add a heated humidifier** - comfort in week one decides adherence. [AASM 2023]",
            ...
            "**Define and audit adherence as 4 hours or more a night on at least 70% of nights**, checked from the machine download - self-report overstates use. [AASM 2023]",
            ...
            "**If CPAP fails, use a dentist-made mandibular advancement device for mild-moderate disease**, or targeted surgery for a defined lesion - match the site. [AASM 2023]",
            "**Use BiPAP if hypoventilation or high-pressure intolerance is present**, and modafinil only for residual sleepiness despite adherence - not instead. [AASM 2023]",
            "**Continue to manage the cluster: blood pressure, glycaemia, lipids, and influenza and pneumococcal vaccination** - CPAP alone does not lower his risk. [AASM 2023]",
      ...
      answer: [
        {
          ...
          points: [
            "**CPAP is a pneumatic splint raising intraluminal pharyngeal pressure above the closing pressure**, abolishing apnoeas and hypopnoeas - physics, not drugs. [AASM 2023]",
            ...
            "**Also at an AHI of 5-14 with hypertension, ischaemic heart disease, atrial fibrillation, stroke or type 2 diabetes** - mild OSA still worsens each. [AASM 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Reduces excessive daytime sleepiness and the Epworth score**, usually within the first two weeks of adherent use - sleep consolidates at once. [AASM 2023]",
            ...
            "**Lowers blood pressure by about 2-3 mmHg on average and more in resistant hypertension**, where OSA is the commonest cause - it cuts sympathetic tone. [AASM 2023]",
            "**Improves insulin sensitivity and reduces recurrence of atrial fibrillation after cardioversion** - hypoxic surges provoked both. [AASM 2023]",
          ],
        },
        {
          heading: "3. Practical set-up and problems",
          points: [
            "**Set the pressure by attended in-laboratory titration, or by an auto-titrating APAP device in uncomplicated OSA** - the needed pressure varies by position. [AASM 2023]",
            ...
            "**Choose a nasal mask first and an oronasal mask for mouth breathers**, adding a chin strap where indicated - mouth leak loses the pressure. [AASM 2023]",
            "**Add a heated humidifier for nasal dryness**, which is the commonest early reason for abandoning the machine - cold dry air inflames the mucosa. [AASM 2023]",
            "**Mask leak and skin pressure marks are fixed by refitting and resizing**, never by tightening the straps further - tightening ulcerates the bridge. [AASM 2023]",
            ...
            "**Aerophagia and abdominal distension are treated by reducing pressure or moving to bilevel**, which lowers the expiratory pressure - less air is swallowed. [AASM 2023]",
            "**Claustrophobia responds to desensitisation with daytime wear**, and noise disturbing the partner should prompt a check for leak - leak is the noise. [AASM 2023]",
          ],
        },
        {
          ...
          points: [
            ...
            "**If sleepiness persists despite adherence, look for insufficient sleep, depression, narcolepsy or periodic limb movements** - CPAP treats only OSA. [AASM 2023]",
