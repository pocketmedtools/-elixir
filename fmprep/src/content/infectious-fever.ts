  ...
  sections: [
    {
      ...
      points: [
        "**Uncomplicated UTI**: acute cystitis or pyelonephritis in a non-pregnant, pre-menopausal woman with a normal urinary tract and no comorbidity. [ICMR 2022]",
        ...
        "**Asymptomatic bacteriuria**: 100,000 CFU/mL of one organism in two consecutive midstream samples in a woman, or one sample in a man, without symptoms. [IDSA 2019]",
        ...
        "Treat asymptomatic bacteriuria only in **pregnancy and before urological procedures that breach the mucosa**. [IDSA 2019]",
        "**Recurrent UTI**: two or more episodes in 6 months or three or more in 12 months. [ICMR 2022]",
        "Relapse: same organism within **2 weeks** of finishing treatment - suggests a persistent focus such as stone, abscess or prostate.",
        "Reinfection: a **new organism after an interval** - reflects host susceptibility rather than a retained focus.",
        "**Escherichia coli causes 70-80%** of community UTI; Klebsiella is next. [ICMR 2022]",
        "Proteus is **urease-producing** - alkaline urine and struvite stones.",
        "Staphylococcus saprophyticus affects **sexually active young women**; Enterococcus is another community isolate.",
        "Pseudomonas and Candida appear in the **catheterised or hospitalised** patient.",
        ...
        "Women are affected far more often - **short urethra** close to the anus.",
        "Modifiable risk factors: **intercourse, spermicide, a new partner, post-menopausal oestrogen loss**, incomplete emptying and constipation.",
      ],
    },
    {
      heading: "Clinical features: cystitis, pyelonephritis and the mimics",
      points: [
        "**Cystitis**: dysuria, frequency, urgency, suprapubic pain and sometimes haematuria - no fever or only low-grade.",
        ...
        "**Acute pyelonephritis** adds fever with rigors, flank pain, renal angle tenderness, nausea and vomiting - may present as sepsis.",
        "Elderly pyelonephritis can present as **confusion or a fall** without any urinary symptom.",
        "Infant pyelonephritis presents as **fever without a focus**, poor feeding, vomiting or jaundice.",
        "Vaginal discharge and pruritus point to **vaginitis or cervicitis** - dysuria without frequency, different drug.",
        "Pelvic pain and dyspareunia point to **pelvic inflammatory disease** rather than UTI.",
        "Urethral discharge in men is **urethritis**; perineal pain with a tender prostate is **prostatitis** - each needs its own treatment.",
        "**Sterile pyuria**: pus cells with a negative routine culture - think genitourinary tuberculosis first in India.",
        "Other causes of sterile pyuria: partially treated UTI, chlamydial urethritis, stones, interstitial nephritis, papillary necrosis, adjacent appendix or diverticular abscess.",
        "Sterile pyuria work-up: **three early-morning urine samples for AFB and CBNAAT**.",
        "Diabetics: **emphysematous pyelonephritis** shows gas in the renal parenchyma on ultrasound or CT.",
        "Diabetics also get papillary necrosis (sloughed papillae obstruct), **perinephric abscess** and fungal infection.",
        "A diabetic with pyelonephritis not improving in **48 hours needs imaging that day**.",
        "**Pyonephrosis is a urological emergency** - fever with a hydronephrotic kidney needs percutaneous nephrostomy or a ureteric stent plus antibiotics.",
        "Antibiotics alone **do not sterilise an obstructed collecting system** - drainage is mandatory.",
      ],
    },
    {
      ...
      points: [
        ...
        "Dipstick nitrite is **about 95% specific** but insensitive - Enterococcus, Pseudomonas and Acinetobacter do not reduce nitrate.",
        "Dipstick leucocyte esterase is **sensitive but less specific**; either positive supports empirical treatment.",
        "**Culture before antibiotics** in every complicated UTI, pyelonephritis, pregnancy, men, children, recurrence, treatment failure and recent antibiotic use. [ICMR 2022]",
        "Sample: midstream clean-catch, **transported within 2 hours or refrigerated**; catheter specimens only from a fresh catheter.",
        "Infants: **suprapubic aspiration or catheter sample** - bag specimens are contaminated. [ISPN 2023]",
        "**Pyuria: more than 10 leucocytes per cubic millimetre** of uncentrifuged urine, or more than 5 per high-power field in the spun deposit.",
        "Bacteria on Gram stain of uncentrifuged urine correlate with **100,000 CFU/mL**; white cell casts localise infection to the kidney.",
        "Culture threshold: **100,000 CFU/mL of a single organism** is the classical Kass criterion.",
        "Lower thresholds are significant: **1,000 CFU/mL in a symptomatic woman**, 10,000 CFU/mL in pyelonephritis or a catheter sample.",
        "Mixed growth of **three organisms is contamination** - repeat the sample rather than treat.",
        "Pyelonephritis: add complete blood count, creatinine and electrolytes, and **blood culture** if febrile or septic.",
        "**Renal ultrasound** in every man, child, pregnant woman, diabetic, stone or obstruction patient, and anyone not improving at 48-72 hours. [ICMR 2022]",
        "**CT with contrast** is the test for abscess, emphysematous infection and small stones.",
        "Children: **ultrasound of kidneys and bladder after the first febrile UTI** in every child. [ISPN 2023]",
        "Micturating cystourethrogram if ultrasound is abnormal, infection is atypical or recurrent, or the child is **under 2 years with a febrile UTI**. [ISPN 2023]",
        "**DMSA scan 4-6 months later** for scarring where reflux is found. [ISPN 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "Alternative first line: **fosfomycin trometamol 3 g as a single oral dose**. [ICMR 2022]",
        ...
        "Nitrofurantoin needs a **creatinine clearance above 30 mL/min** and does not reach the kidney - cystitis only, never pyelonephritis.",
        ...
        "Fluoroquinolones carry **tendon, neuropathy and aortic warnings**, and every course selects resistant gut flora.",
        "Second line by culture: **amoxicillin-clavulanate 625 mg three times daily for 5-7 days**. [ICMR 2022]",
        "**Mild to moderate pyelonephritis** (able to take oral drugs): single IV or IM dose of ceftriaxone 1-2 g or amikacin 15 mg/kg, then oral by culture for 7-10 days. [ICMR 2022]",
        "Oral fluoroquinolone for 7 days only when the isolate is **proven susceptible**.",
        "**Admit for intravenous therapy**: severe pyelonephritis, sepsis, vomiting, pregnancy, obstruction or a known ESBL organism. [ICMR 2022]",
        "Mild ESBL infection: **piperacillin-tazobactam 4.5 g IV 6-hourly** or amikacin 15 mg/kg once daily. [ICMR 2022]",
        "Severe ESBL infection: **meropenem 1 g IV 8-hourly** or ertapenem 1 g daily. [ICMR 2022]",
        "Total duration **7-14 days**, with an oral switch once afebrile for 48 hours. [ICMR 2022]",
        "Supportive: paracetamol, **2-3 litres of fluid a day**, phenazopyridine 200 mg three times daily for 2 days for severe dysuria.",
        "Review at 48-72 hours; **image any patient still febrile at 72 hours** for obstruction or abscess rather than adding a second antibiotic.",
        ...
        "Prostatitis present: **4-6 weeks** of treatment.",
        "Investigate every man with a first UTI for **obstruction, stones or prostatic disease**.",
      ],
    },
    {
      heading: "Pregnancy, children and the catheterised patient",
      points: [
        "**Screen every pregnant woman with a urine culture** at the first antenatal visit or at 12-16 weeks. [IDSA 2019]",
        "Untreated asymptomatic bacteriuria in pregnancy progresses to **pyelonephritis in 20-40%** - linked to preterm labour and low birth weight.",
        "Treat asymptomatic bacteriuria and cystitis in pregnancy for **7 days**, then repeat the culture as a test of cure.",
        "Safe in pregnancy: **nitrofurantoin 100 mg twice daily** - avoid after 36 weeks because of neonatal haemolysis.",
        "Also safe: **cephalexin 500 mg four times daily**, amoxicillin-clavulanate 625 mg three times daily, fosfomycin 3 g single dose.",
        "Avoid in pregnancy: **fluoroquinolones throughout**, tetracyclines, cotrimoxazole in the first trimester (folate antagonist) and near term (kernicterus).",
        "**Pyelonephritis in pregnancy is admitted**: IV ceftriaxone 1-2 g daily or cefotaxime until afebrile for 48 hours, then oral to complete 10-14 days.",
        "After pyelonephritis in pregnancy: nightly **nitrofurantoin 50-100 mg or cephalexin 250 mg** prophylaxis until delivery - recurrence is common.",
        "**Febrile infants under 3 months and any toxic child are admitted** for IV ceftriaxone or cefotaxime. [ISPN 2023]",
        "Older well children: oral **cefixime 8 mg/kg/day** or amoxicillin-clavulanate for 7-10 days; cystitis in older girls 3-5 days. [ISPN 2023]",
        "Fever without a focus under 2 years carries a **5-7% probability of UTI** - a properly collected urine sample is mandatory.",
        ...
        "Remove or replace the catheter; treat symptomatic infection **7 days if prompt response**, 10-14 days if delayed.",
        "**Never treat asymptomatic catheter bacteriuria**. [IDSA 2019]",
    ...
    },
    {
      ...
      points: [
        "Confirm recurrence **by culture**, then exclude a cause: post-void residual on ultrasound, stones, atrophic vaginitis, diabetes, prostatic disease in men.",
        "Cystoscopy only for **haematuria, relapse with the same organism, or a suspected fistula**.",
        "**Extra fluid of at least 1.5 litres a day halves recurrences** - the behavioural advice with the best evidence.",
        "Also advise **voiding after intercourse**, avoiding spermicides and diaphragms, and treating constipation.",
        "Cranberry products and D-mannose have **weak evidence** - optional.",
        "**Topical vaginal oestrogen cream** in post-menopausal women restores lactobacilli and reduces recurrences - first pharmacological step in that group.",
        "**Nitrofurantoin 50-100 mg at night or post-coital for 6-12 months reduces recurrences by 85%** - but selects resistance.",
        ...
        "Self-start therapy: a reliable woman with proven recurrent cystitis keeps a **standby course of nitrofurantoin or fosfomycin** - fill a culture bottle first.",
        "**No UTI vaccine is available in India**.",
        "Children: long-term low-dose antibiotic only for **high-grade reflux** under paediatric nephrology supervision. [ISPN 2023]",
        "Circumcision **reduces UTI in boys with reflux**.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Uncomplicated**: cystitis or pyelonephritis in a non-pregnant pre-menopausal woman with a normal tract. [ICMR 2022]",
            "**Complicated**: men, pregnancy, children, diabetes, catheter, stones, obstruction, reflux, immunosuppression. [ICMR 2022]",
            ...
            "Organisms: **E. coli 70-80%**, Klebsiella, Proteus, Enterococcus, S. saprophyticus; Pseudomonas and Candida in the catheterised.",
            "Risk factors: **intercourse, spermicide, menopause**, incomplete emptying, diabetes.",
          ],
        },
        {
          heading: "2. Clinical features",
          points: [
            "**Cystitis**: dysuria, frequency, urgency, suprapubic pain, haematuria - without fever.",
            "**Pyelonephritis**: fever with rigors, flank pain, renal angle tenderness, vomiting, sepsis.",
            "Mimics: **vaginitis and cervicitis, urethritis, pelvic inflammatory disease, prostatitis**.",
            "Atypical presentations: **confusion or falls in the elderly**, fever without focus in infants.",
          ],
        },
        {
          heading: "3. Investigations",
          points: [
            "Dipstick **nitrite (specific) and leucocyte esterase (sensitive)** - enough for uncomplicated cystitis.",
            "Microscopy: **pyuria over 10 leucocytes per cubic millimetre**; white cell casts localise to the kidney.",
            "Urine culture **before antibiotics** in every complicated case and pyelonephritis. [ICMR 2022]",
            "Significant growth: **100,000 CFU/mL**; 1,000 CFU/mL in a symptomatic woman.",
            "Blood count, creatinine, and **blood culture in the febrile patient**.",
            "**Ultrasound** in men, children, pregnancy, diabetes, stones and non-responders; CT for abscess and emphysematous infection.",
            "Sterile pyuria: **three early-morning urines for AFB** - genitourinary tuberculosis.",
          ],
        },
        {
          heading: "4. Management",
          points: [
            "Cystitis: **nitrofurantoin 100 mg twice daily for 5 days** or fosfomycin 3 g single dose. [ICMR 2022]",
            ...
            "Mild pyelonephritis: **ceftriaxone 1-2 g IV or amikacin 15 mg/kg** as initial dose, then oral by culture for 7-10 days. [ICMR 2022]",
            "Severe, septic, pregnant, vomiting or ESBL: admit for **piperacillin-tazobactam 4.5 g 6-hourly or meropenem 1 g 8-hourly**. [ICMR 2022]",
            "Severe pyelonephritis duration **7-14 days**, oral switch after 48 hours afebrile.",
            "**Drain an obstructed infected kidney** - nephrostomy or stent.",
            "Supportive: fluids, paracetamol, phenazopyridine; review at 48-72 hours and **image if still febrile**.",
            "Pregnancy: screen by culture, treat **7 days with nitrofurantoin or cephalexin**; admit pyelonephritis.",
            "Children: **ultrasound after the first febrile UTI**. [ISPN 2023]",
            "Men: **7-14 days** with a prostate-penetrating drug.",
            "Catheterised: treat **only when symptomatic**, after catheter change. [IDSA 2019]",
          ],
        },
        {
          heading: "5. Prevention of recurrence and stewardship",
          points: [
            "Prevention: **fluids, post-coital voiding, avoid spermicide**, vaginal oestrogen after menopause.",
            "**Nitrofurantoin prophylaxis or methenamine hippurate for 6-12 months**; self-start therapy for reliable women. [ALTAR, BMJ 2022]",
            "Stewardship: **culture-guided therapy and the shortest effective course**.",
            "No treatment of asymptomatic bacteriuria outside **pregnancy and instrumentation**. [IDSA 2019]",
            "Avoid fluoroquinolones - **preserves the remaining oral options**.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Significant: **100,000 CFU/mL of a single organism**.",
            "Cystitis: dysuria and frequency; pyelonephritis: **fever, rigors, flank pain and vomiting**.",
            "Pyelonephritis is commonest in the **second and third trimesters**, right side more often.",
          ],
        },
        {
          heading: "Treatment",
          points: [
            "Asymptomatic bacteriuria and cystitis: **nitrofurantoin 100 mg twice daily for 7 days** - not after 36 weeks.",
            "Alternatives for 7 days: **cephalexin 500 mg four times daily** or amoxicillin-clavulanate 625 mg three times daily; or fosfomycin 3 g single dose.",
            "**Repeat culture after treatment** as a test of cure.",
            ...
            "Pyelonephritis: admit, **IV ceftriaxone 1-2 g daily or cefotaxime**, fluids.",
            "Monitor for **preterm labour and ARDS**.",
            "Switch to oral after **48 hours afebrile** to complete 10-14 days.",
          ],
        },
        {
          heading: "Follow-up and prophylaxis",
          points: [
            "**Monthly urine culture** for the rest of pregnancy after any infection.",
            "Nightly **nitrofurantoin 50-100 mg or cephalexin 250 mg** until delivery after pyelonephritis or recurrent bacteriuria.",
            "**Ultrasound of the renal tract** for recurrent infection or failure to respond.",
            "Group B streptococcal bacteriuria also mandates **intrapartum penicillin prophylaxis**.",
          ],
        },
      ],
