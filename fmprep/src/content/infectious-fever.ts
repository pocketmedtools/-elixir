  ...
  sections: [
    {
      ...
      points: [
        "Dengue is a **flavivirus with four serotypes, DENV 1 to 4**, all circulating in India. [WHO 2023]",
        "Infection with one serotype gives lifelong immunity to that serotype but only transient cross-immunity to the others. [WHO 2023]",
        "**Secondary infection with a different serotype carries the greatest risk of severe dengue** through antibody-dependent enhancement. [WHO 2023]",
        "Severe disease therefore clusters in older children and in adults living in hyperendemic cities. [WHO 2023]",
        "The vector is **Aedes aegypti**, with Aedes albopictus, a day-biting mosquito. [NVBDCP 2024]",
        ...
        "Incubation is **4 to 10 days**. [WHO 2023]",
        "The patient is viraemic and infective to mosquitoes from a day before fever until about **day 5**. [WHO 2023]",
        "India reports well over **100,000 laboratory-confirmed cases a year** to the NVBDCP, with true burden many times higher. [NVBDCP 2024]",
        "Peak transmission follows the monsoon, **August to November**, with a longer season in the south. [NVBDCP 2024]",
        "Case fatality is **below 1% when properly managed**. [WHO 2023]",
    ...
    },
    {
      ...
      points: [
        "**Febrile phase, days 1-3:** abrupt high fever, severe headache, retro-orbital pain, myalgia and arthralgia (break-bone fever). [WHO 2023]",
        "Febrile phase also gives facial flushing, a transient macular rash and a positive tourniquet test. [WHO 2023]",
        "Risks of the febrile phase are **dehydration and febrile seizures**, not shock. [WHO 2023]",
        "**Critical phase, days 3-7**, begins at defervescence and lasts **24-48 hours**. [WHO 2023]",
        ...
        "**Recovery phase, days 7-10:** reabsorption of extravasated fluid, falling haematocrit, rising platelet count and bradycardia. [WHO 2023]",
        "Recovery brings a confluent itchy rash with **islands of white in a sea of red** on the limbs. [WHO 2023]",
        "**Fluid overload and pulmonary oedema are the danger of the recovery phase** - stop intravenous fluids. [WHO 2023]",
        "**Tourniquet test:** inflate the cuff midway between systolic and diastolic pressure for **5 minutes**. [WHO 2023]",
        "More than **10 petechiae per square inch** on the forearm is a positive tourniquet test. [WHO 2023]",
        "The tourniquet test supports dengue but is neither sensitive nor specific - a negative test excludes nothing. [WHO 2023]",
        "**Laboratory hallmark of the critical phase: rising haematocrit with a rapidly falling platelet count**. [WHO 2023]",
        "Progressive leucopenia and hypoalbuminaemia accompany the critical phase. [WHO 2023]",
        "A haematocrit rise of **20% or more above baseline** indicates significant plasma leakage. [WHO 2023]",
    ...
    },
    {
      ...
      points: [
        "**WHO 2009 warning signs:** abdominal pain or tenderness, and persistent vomiting. [WHO 2023]",
        "Warning signs: clinical fluid accumulation - ascites or pleural effusion - and mucosal bleeding. [WHO 2023]",
        "Warning signs: lethargy or restlessness, and liver enlargement more than **2 cm**. [WHO 2023]",
        "Warning sign: a rise in haematocrit with a rapid fall in platelet count. [WHO 2023]",
        "**Group A** is dengue without warning signs in a patient tolerating oral fluids and passing urine at least every **6 hours**. [WHO 2023]",
        "Group A is managed at home with review every day. [WHO 2023]",
        "**Group B** is dengue with warning signs, or with a co-existing condition or adverse social situation. [WHO 2023]",
        "Group B co-existing conditions: infancy, pregnancy, old age, diabetes, renal or heart disease, obesity, haemoglobinopathy. [WHO 2023]",
        "Group B social situations: living alone or living far from hospital - admit for observation and intravenous fluid. [WHO 2023]",
        "**Group C is severe dengue** and needs emergency treatment. [WHO 2023]",
        "Severe dengue: severe plasma leakage causing shock or respiratory distress from fluid accumulation. [WHO 2023]",
        "Severe dengue: severe bleeding, or severe organ involvement. [WHO 2023]",
        "Severe organ involvement means **AST or ALT 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2023]",
        "Indian programme documents still use the old grading of dengue fever, dengue haemorrhagic fever I-IV and dengue shock syndrome. [NVBDCP 2024]",
        "**DHF grade I:** fever with a positive tourniquet test only. [NVBDCP 2024]",
        "**DHF grade II:** grade I plus spontaneous bleeding. [NVBDCP 2024]",
        "**DHF grade III:** circulatory failure with a narrow pulse pressure. [NVBDCP 2024]",
        "**DHF grade IV:** profound shock with unrecordable blood pressure. [NVBDCP 2024]",
        "**Expanded dengue syndrome** covers unusual presentations occurring without classical plasma leakage. [NVBDCP 2024]",
        "Expanded dengue syndrome: encephalitis and encephalopathy, myocarditis, acute liver failure, acute kidney injury. [NVBDCP 2024]",
        "Expanded dengue syndrome: Guillain-Barre syndrome, acalculous cholecystitis and haemophagocytic lymphohistiocytosis. [NVBDCP 2024]",
      ],
    },
    {
      heading: "Diagnosis",
      points: [
        "**NS1 antigen is the test of days 1 to 5**. [WHO 2023]",
        "NS1 sensitivity is **70-90% in primary infection** and lower in secondary infection. [WHO 2023]",
        "NS1 may remain positive up to **day 9** in some patients. [WHO 2023]",
        "**IgM MAC-ELISA is the test from day 5 onwards**, staying positive for **2-3 months**. [WHO 2023]",
        "India confirms dengue by NS1 or IgM MAC-ELISA at a **Sentinel Surveillance Hospital, where the test is free under the NVBDCP**. [NVBDCP 2024]",
        "**Rapid combo IgM and IgG cards are not acceptable for case confirmation** - specificity is poor. [NVBDCP 2024]",
        "An isolated IgG positive means past infection, not current dengue. [NVBDCP 2024]",
        "Serial complete blood counts are the real monitoring tool in dengue. [WHO 2023]",
        "**Record haematocrit and platelet count at least once daily from day 3**. [WHO 2023]",
        ...
        "Do a **right lateral decubitus chest radiograph**, or better an ultrasound, for a right pleural effusion. [WHO 2023]",
        ...
        "Add liver function, renal function, serum albumin, and blood grouping with cross-matching in any patient with warning signs. [WHO 2023]",
        "A **coagulation profile is needed only if there is significant bleeding**. [WHO 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "Group A target: urine passed **at least once every 6 hours**. [WHO 2023]",
        "Group A antipyresis: **paracetamol 500-1000 mg 6-hourly, maximum 4 g a day**. [NVBDCP 2024]",
        "**No aspirin, no NSAIDs, no steroids and no intramuscular injections** in dengue. [NVBDCP 2024]",
        "**Group B with warning signs:** isotonic crystalloid - 0.9% saline or Ringer lactate. [WHO 2023]",
        "Group B: **5-7 mL/kg/hour for 1-2 hours**, reassessing clinically and by haematocrit. [WHO 2023]",
        "Group B: then **3-5 mL/kg/hour for 2-4 hours**, then **2-3 mL/kg/hour**. [WHO 2023]",
        "Reduce the rate as soon as the patient improves - the commonest dengue error is running fluid at a fixed rate. [WHO 2023]",
        "**Group C compensated shock** is a narrow pulse pressure, tachycardia and cold peripheries with a measurable blood pressure. [WHO 2023]",
        "Compensated shock: isotonic crystalloid **5-10 mL/kg over 1 hour**, then reassess. [WHO 2023]",
        "If improving, step down through **5-7, then 3-5, then 2-3 mL/kg/hour** and stop by 24-48 hours. [WHO 2023]",
        "**Group C hypotensive shock:** crystalloid or colloid **20 mL/kg as a bolus over 15-30 minutes**. [WHO 2023]",
        "If the patient improves, reduce to **10 mL/kg/hour** and then step down. [WHO 2023]",
        "No improvement: check the haematocrit before giving anything else. [WHO 2023]",
        "**A rising haematocrit means give more fluid or switch to a colloid**. [WHO 2023]",
        "**A falling haematocrit in continuing shock means occult bleeding** - give blood, not more crystalloid. [WHO 2023]",
        "**Total intravenous fluid should not exceed maintenance plus a 5% deficit over about 48 hours**. [WHO 2023]",
        "Stop the infusion once the patient is haemodynamically stable, appetite has returned and urine output is good. [WHO 2023]",
    ...
    },
    {
      ...
      points: [
        "**Platelet transfusion is not given on a count alone** in dengue. [WHO 2023]",
        "Transfuse platelets for **clinically significant bleeding**. [WHO 2023]",
        "Prophylactic platelets when the count is below **10,000 per cubic millimetre**. [NVBDCP 2024]",
        "Prophylactic platelets below **20,000 per cubic millimetre** if there is a bleeding risk factor such as an invasive procedure or peptic ulcer. [NVBDCP 2024]",
        "**Fresh whole blood or packed cells for significant bleeding with haemodynamic compromise**. [WHO 2023]",
        "Transfusion is guided by a falling haematocrit in a patient still in shock. [WHO 2023]",
        "Fresh frozen plasma and cryoprecipitate are reserved for documented coagulopathy with bleeding. [WHO 2023]",
        "**No role for steroids or intravenous immunoglobulin** in dengue. [WHO 2023]",
        ...
        "Fluid overload with pulmonary oedema: stop fluids, sit the patient up, give oxygen, and cautious furosemide once the leak has stopped. [WHO 2023]",
        "Watch for acute liver failure, myocarditis, encephalopathy and secondary bacterial infection. [NVBDCP 2024]",
        "**Discharge criteria:** afebrile for **48 hours** without an antipyretic, with improving appetite and general condition. [WHO 2023]",
        "Discharge criteria: stable haematocrit off intravenous fluids for **24 hours**, adequate urine output and no respiratory distress. [WHO 2023]",
        "Discharge criterion: a **rising platelet count above 50,000 per cubic millimetre**. [NVBDCP 2024]",
        "Prevention is source reduction: a **weekly dry day**, emptying and scrubbing coolers and containers, covering overhead tanks. [NVBDCP 2024]",
        "Prevention: larvivorous fish, repellents and full-sleeved clothing, plus community action. [NVBDCP 2024]",
        "Notify every case under the **NVBDCP**; the CYD-TDV vaccine is not part of Indian public health practice. [NVBDCP 2024]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Febrile phase, days 1-3:** high fever, headache, retro-orbital pain, severe myalgia and arthralgia. [WHO 2023]",
            "Febrile phase signs: flushing, a transient macular rash and a positive tourniquet test. [WHO 2023]",
            "Risks of the febrile phase are **dehydration and febrile convulsions**. [WHO 2023]",
            "**Critical phase, days 3-7**, begins at defervescence and lasts **24-48 hours**. [WHO 2023]",
            "Critical phase: increased capillary permeability with plasma leakage causing effusions, ascites, haemoconcentration, shock and bleeding. [WHO 2023]",
            "**Recovery phase, days 7-10:** reabsorption of fluid, falling haematocrit, rising platelet count and bradycardia. [WHO 2023]",
            "Recovery brings a confluent itchy rash of **islands of white in a sea of red**. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            "Warning sign: **abdominal pain or tenderness**. [WHO 2023]",
            "Warning sign: **persistent vomiting**. [WHO 2023]",
            "Warning sign: clinical fluid accumulation as **ascites or pleural effusion**. [WHO 2023]",
            "Warning sign: **mucosal bleeding**. [WHO 2023]",
            "Warning sign: **lethargy or restlessness**. [WHO 2023]",
            "Warning sign: **liver enlargement more than 2 cm**. [WHO 2023]",
            "Warning sign: a **rise in haematocrit with a rapid fall in platelet count**. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            "**Group A:** no warning signs, tolerating oral fluids, passing urine at least **6-hourly**, no co-morbidity, reliable home circumstances. [WHO 2023]",
            "Group A disposal: home care with oral fluids, paracetamol, written warning signs and daily review with a haemogram. [WHO 2023]",
            "**Group B:** any warning sign, or a co-existing condition, or an adverse social situation. [WHO 2023]",
            "Group B co-morbidities: infancy, pregnancy, **age above 60**, diabetes, renal, hepatic or cardiac disease, obesity. [WHO 2023]",
            "Group B disposal: admit for observation and intravenous fluid. [WHO 2023]",
            "**Group C:** severe dengue with shock or respiratory distress from plasma leakage, severe bleeding, or severe organ impairment. [WHO 2023]",
            "Group C organ impairment: **transaminases 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2023]",
            "Group C disposal: emergency resuscitation and intensive care. [WHO 2023]",
          ],
        },
        {
          ...
          points: [
            ...
            "Group A: **paracetamol only, with aspirin and NSAIDs prohibited**. [NVBDCP 2024]",
            "**Group B:** isotonic crystalloid **5-7 mL/kg/hour for 1-2 hours**. [WHO 2023]",
            "Group B: then **3-5 mL/kg/hour for 2-4 hours**, then **2-3 mL/kg/hour**. [WHO 2023]",
            "Titrate Group B fluid to clinical status, haematocrit and a urine output of **0.5 mL/kg/hour**. [WHO 2023]",
            "**Group C compensated shock:** isotonic crystalloid **5-10 mL/kg over 1 hour**, then reassess. [WHO 2023]",
            "Then step down through **5-7, 3-5 and 2-3 mL/kg/hour**. [WHO 2023]",
            "**Group C hypotensive shock: 20 mL/kg bolus over 15-30 minutes**, then reduce on improvement. [WHO 2023]",
            "Shock persisting after the bolus with a **rising haematocrit** means more fluid or a colloid. [WHO 2023]",
            "Shock persisting with a **falling haematocrit** means concealed bleeding and the need for blood. [WHO 2023]",
            "Total fluid should approximate **maintenance plus a 5% deficit over 48 hours**. [WHO 2023]",
            "Stop the infusion in the recovery phase to avoid pulmonary oedema. [WHO 2023]",
          ],
        },
        {
          heading: "5. Blood products, monitoring and discharge",
          points: [
            "Transfuse platelets only for **clinically significant bleeding**. [WHO 2023]",
            "Prophylactic platelets below **10,000 per cubic millimetre**. [NVBDCP 2024]",
            "**Fresh whole blood or packed cells** for bleeding with haemodynamic compromise. [WHO 2023]",
            "Monitor pulse, blood pressure with pulse pressure, capillary refill and urine output in Group B and C patients. [WHO 2023]",
            "Monitor the haematocrit **4-6 hourly** in Group B and C patients. [WHO 2023]",
            "**No steroids, no immunoglobulin, no papaya leaf extract, no prophylactic antibiotics**. [NVBDCP 2024]",
            "Discharge when **afebrile for 48 hours without antipyretics** and the appetite is improving. [WHO 2023]",
            "Discharge when the haematocrit is stable off intravenous fluids for **24 hours** with adequate urine output. [WHO 2023]",
            "Discharge when platelets are rising above **50,000 per cubic millimetre**. [NVBDCP 2024]",
          ],
        },
        {
          heading: "6. Prevention and notification",
          points: [
            "Source reduction of Aedes breeding in clean stored water is the core of prevention. [NVBDCP 2024]",
            "**Weekly dry day**, covered tanks, emptied coolers, removal of tyres and discarded containers, and larvivorous fish. [NVBDCP 2024]",
            ...
            "Notify every case under the **NVBDCP and IDSP**. [IDSP 2024]",
            "Confirm cases by NS1 or IgM MAC-ELISA at a **Sentinel Surveillance Hospital**, where the test is free. [NVBDCP 2024]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "Recognition",
          points: [
            "**Compensated shock:** tachycardia, cold clammy peripheries, **capillary refill over 2 seconds**. [WHO 2023]",
            "Compensated shock: narrowed pulse pressure with a normal systolic pressure, restlessness and reduced urine output. [WHO 2023]",
            "**Decompensated shock:** hypotension or unrecordable blood pressure, feeble or absent pulses, mottled skin. [WHO 2023]",
            "Decompensated shock: tachypnoea, metabolic acidosis and altered sensorium. [WHO 2023]",
            "Supporting evidence: **rising haematocrit with a rapidly falling platelet count**. [WHO 2023]",
            "Supporting evidence: pleural effusion on a right lateral decubitus film or ultrasound, ascites, gall bladder wall oedema and hypoalbuminaemia. [WHO 2023]",
          ],
        },
        {
          ...
          points: [
            "**Compensated shock: isotonic crystalloid 5-10 mL/kg over 1 hour**, then reassess. [WHO 2023]",
            "If improving, step down to **5-7, then 3-5, then 2-3 mL/kg/hour** and stop by 24-48 hours. [WHO 2023]",
            "**Hypotensive shock: 20 mL/kg of crystalloid or colloid over 15-30 minutes**, with oxygen. [WHO 2023]",
            "Reassess a shocked dengue patient every **15-30 minutes**. [WHO 2023]",
            "Shock persisting after the bolus: recheck the haematocrit before the next decision. [WHO 2023]",
            ...
            "Correct hypoglycaemia, hypocalcaemia and metabolic acidosis. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            "Monitor pulse, blood pressure with pulse pressure, capillary refill and respiratory rate. [WHO 2023]",
            "Aim for a urine output of **0.5-1 mL/kg/hour**. [WHO 2023]",
            "Check the haematocrit **every 4-6 hours or sooner** in a shocked patient. [WHO 2023]",
            "**Fatal error 1: too little fluid in the first hour of shock**. [WHO 2023]",
            "**Fatal error 2: continuing fluid into the reabsorption phase**, causing pulmonary oedema. [WHO 2023]",
            "Avoid intramuscular injections, NSAIDs, steroids and unnecessary invasive procedures. [NVBDCP 2024]",
            "**Do not transfuse platelets for a count alone**. [WHO 2023]",
            "Prompt recognition with titrated fluid brings mortality **below 1%**. [WHO 2023]",
            "Untreated or mismanaged shock carries a mortality of **10-20%**. [WHO 2023]",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "**Abdominal pain or tenderness**. [WHO 2023]",
            "**Persistent vomiting**. [WHO 2023]",
            "**Clinical fluid accumulation** - ascites or pleural effusion. [WHO 2023]",
            "**Mucosal bleeding**. [WHO 2023]",
            "**Lethargy or restlessness**. [WHO 2023]",
            "**Liver enlargement more than 2 cm** below the costal margin. [WHO 2023]",
            "**Increase in haematocrit with a rapid fall in platelet count**. [WHO 2023]",
          ],
        },
        {
          heading: "Criteria for severe dengue (any one)",
          points: [
            "**Severe plasma leakage** causing shock (dengue shock syndrome) or respiratory distress from fluid accumulation. [WHO 2023]",
            "**Severe bleeding** as judged by the clinician - haematemesis, melaena, intracranial or heavy vaginal bleeding. [WHO 2023]",
            "**Severe organ involvement: AST or ALT 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2023]",
          ],
        },
        {
          heading: "Indications for platelet transfusion",
          points: [
            "**Clinically significant bleeding at any platelet count**. [WHO 2023]",
            "Prophylactic transfusion when the platelet count is below **10,000 per cubic millimetre**. [NVBDCP 2024]",
            ...
            "**A low count alone, however dramatic, is not an indication**. [WHO 2023]",
            "Counts routinely fall to **20,000-30,000** and recover spontaneously within **48-72 hours**. [WHO 2023]",
            "Give **fresh whole blood or packed cells** instead for bleeding with haemodynamic compromise. [WHO 2023]",
            "Blood is especially indicated when the haematocrit falls in a patient still in shock. [WHO 2023]",
          ],
        },
      ],
      markSplit: [
  ...
  sections: [
    {
      ...
      points: [
        "Five Plasmodium species infect humans - in India **P. vivax and P. falciparum** account for almost all cases.",
        "P. malariae is reported from Odisha and the Karnataka coast; P. ovale is rare in India.",
        "Transmission is by the bite of an infected female Anopheles mosquito.",
        "**An. culicifacies** is the main vector in the rural plains; An. stephensi is the urban vector.",
        "**60-65% of Indian malaria is falciparum**; the rest is vivax.",
        "Falciparum dominates Odisha, Chhattisgarh, Jharkhand, Madhya Pradesh and the North-Eastern states.",
        "Vivax dominates the northern and western plains and the cities.",
        "**Vivax and ovale form hypnozoites in the liver** - these cause relapse weeks to months later.",
        "Hypnozoites are why radical cure with **primaquine for 14 days** is mandatory in vivax.",
        "A vivax patient returning with fever 3 months later has relapsed, not been reinfected - ask whether primaquine was completed.",
        "Incubation is about **12 days for falciparum** and 14 days for vivax.",
        "Classical paroxysm: cold stage, then hot stage, then sweating stage.",
        "Paroxysms recur every **48 hours** in vivax and falciparum (tertian) and every 72 hours in malariae (quartan).",
        "**Most Indian patients have a continuous or irregular fever** - do not wait for periodicity before testing.",
        "**National Framework for Malaria Elimination 2016-2030** aims for zero indigenous cases by 2027 and certification by 2030.",
        "Reported malaria cases in India have fallen by more than **85% since 2015**.",
        ...
        "Presumptive antimalarial treatment without a test is no longer acceptable.",
      ],
    },
    {
      heading: "Clinical features and severe malaria",
      points: [
        "Uncomplicated malaria: fever with chills and rigors, headache, myalgia, nausea and vomiting.",
        "Pallor and splenomegaly appear after some days of illness.",
        "**Falciparum is the great mimic** - it can present as diarrhoea, cough, jaundice or an acute abdomen.",
        "**Severe malaria (WHO)** = falciparum parasitaemia (increasingly also vivax) with any one severity criterion. [WHO 2023]",
        "Neurological criteria: impaired consciousness or coma, prostration, or **more than 2 convulsions in 24 hours**.",
        "Metabolic criteria: acidosis, or hypoglycaemia with glucose **below 40 mg/dL**.",
        "Severe anaemia criterion: haemoglobin **below 7 g/dL in adults**, below 5 g/dL in children.",
        "Renal criterion: creatinine **above 3 mg/dL**.",
        "Hepatic criterion: bilirubin **above 3 mg/dL** plus parasitaemia over 100,000/microlitre.",
        "Other criteria: pulmonary oedema, significant bleeding, shock, or **hyperparasitaemia above 10%**.",
        "**Cerebral malaria** = unrousable coma persisting more than 30 minutes after a seizure, with asexual falciparum parasitaemia and no other cause.",
        "Retinal haemorrhages and retinal whitening support the diagnosis of cerebral malaria.",
        "**Neck stiffness and photophobia are absent** in cerebral malaria - this separates it from meningitis.",
        "**Blackwater fever** = massive intravascular haemolysis with haemoglobinuria - cola-coloured urine and acute kidney injury.",
        "Blackwater fever classically follows quinine in a G6PD-deficient or repeatedly infected patient.",
        "Malaria in pregnancy causes maternal anaemia, hypoglycaemia and pulmonary oedema.",
        "Fetal effects of malaria in pregnancy: abortion, stillbirth, low birth weight and placental sequestration.",
        "**Pregnant women and children under 5** are the two groups in whom uncomplicated malaria becomes severe fastest.",
        "Vivax is no longer benign - severe vivax with ARDS, acute kidney injury, severe anaemia and splenic rupture is documented in Indian series.",
        "Thrombocytopenia in vivax is as marked as in falciparum.",
      ],
    },
    {
      heading: "Diagnosis",
      points: [
        "**Giemsa or JSB-stained thick and thin peripheral smear** remains the gold standard.",
        "Thick film detects parasites at low density; thin film speciates and gives the parasite count.",
        "**Bivalent RDTs** detect HRP2 (falciparum-specific) plus pan-species pLDH or aldolase - supplied free under NVBDCP. [NVBDCP 2024]",
        "RDTs are used by ASHAs and at subcentres - no electricity or microscope needed, result in **15-20 minutes**.",
        "**HRP2 stays positive for 2-4 weeks after cure** - an RDT cannot be used to assess response.",
        "HRP2 gene deletions cause false-negative RDTs.",
        "Negative RDT in a strongly suspicious patient: proceed to microscopy and **repeat smears 12-hourly for 48 hours**.",
        "Quantify parasitaemia in falciparum - **more than 10% infected red cells** defines severe malaria.",
        "Serial parasite counts follow the response to artesunate.",
        "Supporting tests in the unwell patient: haemoglobin, platelet count, capillary and laboratory glucose.",
        "Also check creatinine, bilirubin, urine for haemoglobin, and arterial or venous blood gas for acidosis.",
        "**Thrombocytopenia is present in more than half of malaria** - a normal platelet count should make you doubt the diagnosis.",
        "Exclude co-infection - dengue, enteric fever, scrub typhus and leptospirosis often coexist with malaria.",
        "A positive smear does not close the file if the patient is not responding by **48-72 hours**.",
      ],
    },
    {
      ...
      points: [
        ...
        "Adult chloroquine doses: 600 mg base on day 1, 600 mg on day 2, 300 mg on day 3.",
        "Vivax radical cure: **primaquine 0.25 mg/kg once daily for 14 days** - kills the liver hypnozoites. [NVBDCP 2024]",
        "**P. falciparum, all India except the North-East: artesunate 4 mg/kg once daily for 3 days** plus SP. [NVBDCP 2024]",
        "Sulfadoxine-pyrimethamine **25/1.25 mg/kg single dose on day 1** - supplied as the co-blistered AS+SP pack.",
        "Falciparum gametocytocide: **primaquine 0.75 mg/kg single dose on day 2**. [NVBDCP 2024]",
        "**P. falciparum in the North-Eastern states: artemether-lumefantrine (AL) twice daily for 3 days** by age-band blister pack. [NVBDCP 2024]",
        "The NE states are Arunachal Pradesh, Assam, Manipur, Meghalaya, Mizoram, Nagaland and Tripura.",
        "AL replaces AS+SP in the North-East because of documented sulfadoxine-pyrimethamine resistance.",
        "NE falciparum also receives single-dose primaquine 0.75 mg/kg on day 2.",
        "**Mixed infection: full 3-day ACT as for falciparum** plus primaquine 0.25 mg/kg daily for 14 days for vivax hypnozoites. [NVBDCP 2024]",
        "**Primaquine is contraindicated in pregnancy, infants under 1 year and known G6PD deficiency**.",
        "Screen for G6PD deficiency, or ask about family jaundice after fava beans or sulpha drugs.",
        "Warn every patient on primaquine about dark urine - stop the drug if it appears.",
        "G6PD status unknown: alternative vivax radical cure is **primaquine 0.75 mg/kg weekly for 8 weeks** under supervision.",
        "**Pregnancy, vivax: chloroquine is safe throughout** - defer primaquine until after delivery and breastfeeding.",
        "**Pregnancy, falciparum: quinine in the first trimester, ACT in the second and third trimesters**. [NVBDCP 2024]",
        "WHO now also accepts artemether-lumefantrine in the first trimester where quinine is not tolerated. [WHO 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "Children under 20 kg receive **artesunate 3 mg/kg per dose**.",
        "Artesunate reduced mortality by **34.7% versus quinine** in SEAQUAMAT (Asian adults).",
        "Artesunate reduced mortality by 22.5% versus quinine in African children in AQUAMAT.",
        "Give **a minimum of 24 hours of parenteral therapy** and continue until the patient can swallow.",
        "Then complete treatment with a **full 3-day oral ACT** (AS+SP or AL).",
        "Never finish with artesunate monotherapy - it selects resistance.",
        "Alternative if artesunate unavailable: **artemether 3.2 mg/kg IM on day 1, then 1.6 mg/kg daily**.",
        "Alternative: **quinine dihydrochloride 20 mg salt/kg loading over 4 hours, then 10 mg/kg 8-hourly** in 5% dextrose.",
        "Quinine causes hypoglycaemia, cinchonism and QT prolongation - monitor glucose and the ECG.",
        "Omit the quinine loading dose if quinine or mefloquine was taken in the previous 24 hours.",
        "Supportive care decides survival - **check capillary glucose every 4 hours** and treat hypoglycaemia with 25% dextrose.",
        "Control seizures with a benzodiazepine.",
        "Transfuse for haemoglobin **below 7 g/dL in adults** or below 5 g/dL in children.",
        "Manage acidosis and acute kidney injury with careful fluids and early dialysis.",
        "Nurse the comatose patient with attention to airway and pressure areas.",
        "**Avoid fluid overload** - no large boluses in severe malaria.",
        "FEAST trial showed harm from aggressive bolus fluid in African children with febrile shock.",
        "Give judicious fluids guided by perfusion and urine output.",
        "**Post-artesunate delayed haemolysis** occurs 1-3 weeks after treatment in patients with high parasitaemia.",
        "Check haemoglobin at **1 and 2 weeks** after severe malaria; transfuse if needed.",
      ],
    },
    {
      heading: "Prevention, prophylaxis and programme",
      points: [
        "Vector control under NVBDCP: **indoor residual spraying** and long-lasting insecticidal nets (LLIN). [NVBDCP 2024]",
        "**LLINs are distributed free** in high-burden districts.",
        "Larvivorous fish, anti-larval measures and source reduction complete vector control.",
        "Personal protection: nets, repellents and full-sleeved clothing at dusk and dawn - when Anopheles bites.",
        "**Short-term travellers (under 6 weeks) to a high-risk area: doxycycline 100 mg daily** - start 2 days before travel, continue 4 weeks after leaving.",
        "**Long-term travellers: mefloquine 250 mg weekly** - start 2 weeks before, continue 4 weeks after.",
        "Doxycycline and mefloquine prophylaxis are both contraindicated in pregnancy.",
        "Chloroquine prophylaxis is obsolete in India.",
        "Free diagnosis and treatment at all levels - **ASHAs use bivalent RDTs and give the first ACT dose in the village**.",
        "ASHA-level testing and treatment is the backbone of the elimination programme.",
        "Malaria is a **notifiable disease** in most states - report every case to the district vector-borne disease control officer.",
        "Notification drives case-based surveillance and an active fever survey around the index case.",
        "Each case is classified as indigenous or imported.",
        "**Screen every blood donor** and every febrile returning traveller.",
        "Transfusion-transmitted, congenital and airport malaria all occur.",
        "Programme follow-up: **repeat smear on days 3, 7, 14 and 28**.",
      ...
      answer: [
        {
          ...
          points: [
            "Fever with chills and rigors, headache, myalgia and vomiting.",
            "Classical tertian periodicity is often absent - fever may be continuous or irregular.",
            "Pallor, splenomegaly, jaundice and thrombocytopenia support the diagnosis.",
            "Falciparum mimics almost any acute illness - gastroenteritis, hepatitis, acute abdomen.",
            "Take a travel and residence history for endemic districts.",
            "Consider transfusion-transmitted and congenital malaria.",
          ],
        },
        {
          heading: "2. Diagnosis",
          points: [
            "**Giemsa or JSB-stained thick and thin films** are the gold standard.",
            "Thick film for detection; thin film for species and parasite count.",
            "Bivalent RDTs detecting HRP2 and pan-species pLDH are free under NVBDCP - used by ASHAs and subcentres. [NVBDCP 2024]",
            "**HRP2 remains positive 2-4 weeks after cure** - an RDT cannot monitor response.",
            "Negative test with strong suspicion: **repeat smears 12-hourly for 48 hours**.",
        ...
        },
        {
          ...
          points: [
            "P. vivax: **chloroquine 25 mg base/kg over 3 days** as 10, 10 and 5 mg/kg. [NVBDCP 2024]",
            "Vivax radical cure: **primaquine 0.25 mg/kg daily for 14 days**. [NVBDCP 2024]",
            "P. falciparum, India except the North-East: **artesunate 4 mg/kg daily for 3 days** plus SP 25/1.25 mg/kg single dose on day 1. [NVBDCP 2024]",
            "Falciparum gametocytocide: **primaquine 0.75 mg/kg single dose on day 2**.",
            "Seven North-Eastern states: **artemether-lumefantrine twice daily for 3 days** by age-band pack, plus single-dose primaquine. [NVBDCP 2024]",
            "Mixed infection: full 3-day ACT plus **primaquine 0.25 mg/kg for 14 days**.",
            "Primaquine is contraindicated in **pregnancy, infants under 1 year and G6PD deficiency**.",
            "Pregnancy: chloroquine for vivax; for falciparum **quinine in the first trimester**, ACT thereafter.",
          ],
        },
        {
          heading: "4. Severe malaria",
          points: [
            "Define severity by WHO criteria: impaired consciousness, prostration, repeated convulsions, acidosis, hypoglycaemia. [WHO 2023]",
            "Further criteria: severe anaemia, renal impairment, jaundice with high parasitaemia, pulmonary oedema, bleeding, shock, parasitaemia above 10%.",
            "**IV artesunate 2.4 mg/kg at 0, 12 and 24 hours, then daily** is the drug of choice (3 mg/kg per dose if under 20 kg). [WHO 2023]",
            "Give parenteral therapy for a minimum of **24 hours** and until oral therapy is possible.",
            "Complete with a **full 3-day oral ACT**.",
            "Alternatives: IM artemether, or IV quinine **20 mg salt/kg loading then 10 mg/kg 8-hourly**.",
            "Supportive care: **4-hourly capillary glucose** with 25% dextrose for hypoglycaemia.",
            "Benzodiazepine for seizures; transfusion for haemoglobin below 7 g/dL.",
            "Careful fluid balance avoiding boluses; dialysis for acute kidney injury; airway care in coma.",
            "Watch for **post-artesunate delayed haemolysis at 1-3 weeks** - recheck the haemoglobin.",
          ],
        },
        {
          heading: "5. Prevention and programme measures",
          points: [
            "Indoor residual spraying and free long-lasting insecticidal nets in high-burden districts. [NVBDCP 2024]",
            "Larvivorous fish, anti-larval measures, and personal protection at dusk and dawn.",
            "Travel chemoprophylaxis, short stays: **doxycycline 100 mg daily** - start 2 days before, continue 4 weeks after.",
            "Longer stays: **mefloquine 250 mg weekly** - start 2 weeks before, continue 4 weeks after.",
            "Notify every case to the district vector-borne disease control officer.",
            "Active fever survey around an index case; classify each case as indigenous or imported.",
            "Elimination targets are set by the **National Framework for Malaria Elimination 2016-2030**.",
            "Follow-up smears on **days 3, 7, 14 and 28**.",
            "Day 3 asexual parasitaemia above 10% of baseline = report suspected artemisinin partial resistance. [WHO 2023]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Parasitised red cells cytoadhere to cerebral capillary endothelium through **PfEMP1**.",
            "Rosetting and sequestration cause microvascular obstruction, hypoxia and cytokine release.",
            "Onset may be gradual with headache and drowsiness, or abrupt with a generalised seizure followed by coma.",
            "Children deteriorate faster than adults.",
            "Examination: coma with symmetrical upper motor neurone signs, dysconjugate gaze and bruxism.",
            "Fundoscopy: retinal haemorrhages and retinal whitening.",
            "**No neck stiffness and no photophobia** - distinguishes cerebral malaria from meningitis.",
            "Frequent coexisting features: hypoglycaemia, lactic acidosis, severe anaemia, acute kidney injury and pulmonary oedema.",
          ],
        },
        {
          ...
          points: [
            ...
            "Thick and thin smears with parasite count, plus a rapid diagnostic test.",
            "Repeat smears if the first is negative and suspicion remains.",
            "Haemoglobin, platelets, creatinine, bilirubin, electrolytes, blood gas or bicarbonate for acidosis, and blood culture.",
            "Lumbar puncture where meningitis cannot be excluded - after considering coagulopathy and raised intracranial pressure.",
            "CSF in pure cerebral malaria is essentially normal or shows a mildly raised protein.",
          ],
        },
        {
          heading: "Management",
          points: [
            "**IV artesunate 2.4 mg/kg at 0, 12 and 24 hours, then daily** for at least 24 hours. [WHO 2023]",
            "Follow with a full 3-day oral ACT when the patient can swallow.",
            "Treat hypoglycaemia with **25% dextrose**; repeat glucose monitoring 4-hourly.",
            "Control seizures with IV lorazepam or diazepam; treat any precipitant.",
            "Nurse in the lateral position with airway protection; catheterise.",
            "Monitor fluid balance strictly - avoid overload.",
            "Transfuse for severe anaemia; start dialysis early for renal failure.",
            "**Do not give steroids, routine mannitol, heparin or adrenaline** - all useless or harmful in cerebral malaria.",
            "Neurological sequelae in about **10% of children** - ataxia, hemiparesis, cortical blindness, epilepsy; arrange follow-up.",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Vivax invades only reticulocytes - parasitaemia stays low, rarely **above 2%**.",
            "Falciparum invades red cells of all ages - parasitaemia can exceed **10%**.",
            "Vivax forms liver **hypnozoites** - relapse after weeks to months.",
            "Falciparum has no hypnozoite - recurrence is recrudescence or reinfection.",
            "Falciparum sequesters in deep capillaries by knob-mediated cytoadherence - usually only ring forms in the peripheral smear.",
            "Falciparum gametocytes are **banana-shaped**.",
            "Vivax shows all stages, **Schuffner dots** and an enlarged pale red cell.",
            "Vivax: benign tertian fever with marked rigors; falciparum: irregular fever, the great mimic.",
          ],
        },
        {
          heading: "Complications",
          points: [
            "Falciparum causes cerebral malaria, acute kidney injury, ARDS, blackwater fever and severe anaemia.",
            "Falciparum also causes hypoglycaemia, acidosis and death.",
            "Severe vivax with ARDS, acute kidney injury, severe anaemia and splenic rupture is well recognised in Indian series.",
            "Thrombocytopenia is equally common in vivax and falciparum.",
            "**Splenic rupture** is more characteristic of vivax.",
            "Placental sequestration and low birth weight are characteristic of falciparum.",
          ],
        },
        {
          heading: "Treatment under NVBDCP",
          points: [
            "Vivax: **chloroquine 25 mg base/kg over 3 days** plus primaquine 0.25 mg/kg daily for 14 days for radical cure. [NVBDCP 2024]",
            "Falciparum: **artesunate 4 mg/kg daily for 3 days** plus sulfadoxine-pyrimethamine on day 1 (AL in the North-Eastern states). [NVBDCP 2024]",
            "Falciparum gametocytocide: single-dose **primaquine 0.75 mg/kg on day 2**.",
            ...
            "Chloroquine resistance is widespread in Indian falciparum - chloroquine is no longer used for that species.",
            "Vivax remains largely chloroquine-sensitive.",
          ],
        },
      ],
