      ...
      answer: [
        {
          ...
          points: [
            "**Stage 1 (asymptomatic)**: asymptomatic infection; persistent generalised lymphadenopathy. [NACO 2021]",
            "PGL = nodes **1 cm or more at two or more extra-inguinal sites for more than 3 months** without another cause.",
            "**Stage 2 (mild)**: unexplained persistent hepatosplenomegaly; papular pruritic eruption; extensive wart virus infection; extensive molluscum contagiosum. [NACO 2021]",
            "Stage 2: recurrent oral ulcerations; **unexplained persistent parotid enlargement; linear gingival erythema**; herpes zoster.",
            "Stage 2: recurrent or chronic upper respiratory tract infections - **otitis media, otorrhoea, sinusitis, tonsillitis**; fungal nail infections.",
            "**Persistent parotid enlargement and linear gingival erythema are paediatric-specific** - absent from the adult stage 2 list.",
            "Unexplained persistent **hepatosplenomegaly is likewise paediatric-specific**.",
          ],
        },
        {
          heading: "WHO clinical staging in children - Stages 3 and 4",
          points: [
            "**Stage 3 (advanced)**: unexplained moderate malnutrition not adequately responding to standard therapy; unexplained persistent diarrhoea of 14 days or more. [NACO 2021]",
            "Stage 3: unexplained persistent **fever above 37.5 degrees C, intermittent or constant, for more than 1 month**.",
            "Stage 3: **persistent oral candidiasis after the first 6-8 weeks of life**; oral hairy leukoplakia; acute necrotising ulcerative gingivitis or periodontitis.",
            "Stage 3: **lymph node tuberculosis; pulmonary tuberculosis**; severe recurrent bacterial pneumonia.",
            "Stage 3: **symptomatic lymphoid interstitial pneumonitis**; chronic HIV-associated lung disease including bronchiectasis.",
            "Stage 3: **unexplained anaemia below 8 g/dL, neutropenia below 500 per cubic millimetre, or chronic thrombocytopenia below 50,000**.",
            "**Stage 4 (severe, AIDS-defining)**: unexplained severe wasting, stunting or severe malnutrition not responding to standard therapy; Pneumocystis pneumonia. [NACO 2021]",
            "Stage 4: recurrent severe bacterial infections - **empyema, pyomyositis, bone or joint infection or meningitis** - excluding pneumonia.",
            "Stage 4: chronic herpes simplex infection; **oesophageal, tracheal, bronchial or pulmonary candidiasis**.",
            "Stage 4: **extrapulmonary or disseminated tuberculosis; Kaposi sarcoma**.",
            "Stage 4: **cytomegalovirus infection with onset after 1 month of age** including retinitis; CNS toxoplasmosis after the neonatal period.",
            "Stage 4: extrapulmonary cryptococcosis including meningitis; **HIV encephalopathy**; disseminated endemic mycosis.",
            "Stage 4: chronic cryptosporidiosis or isosporiasis; **disseminated non-tuberculous mycobacterial infection**.",
            "Stage 4: **cerebral or B-cell non-Hodgkin lymphoma**; progressive multifocal leukoencephalopathy.",
            "Stage 4: symptomatic **HIV-associated nephropathy or cardiomyopathy**.",
            "Staging is **clinical** - used where CD4 is unavailable and to define advanced disease.",
            "Staging **does not step back down** once a higher stage has been reached. [NACO 2021]",
          ],
        },
        {
