    ...
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            "**Maternal IgG persists in the uninfected child up to 18 months** - an antibody test before that age tells you the mother's status, not the child's.",
            ...
            "EID schedule: **DNA-PCR at 6 weeks** of age or at first contact thereafter. [NACO 2021]",
            "EID: repeat at **6 months and 12 months**, and 6 weeks after complete cessation of breastfeeding. [NACO 2021]",
            "EID: **confirmatory HIV antibody test at 18 months**. [NACO 2021]",
            "A negative result in a breastfed child **excludes infection only up to that point**.",
            ...
            "Suspect HIV in a child with **failure to thrive, persistent or recurrent diarrhoea, recurrent severe infections**, persistent oral thrush beyond the neonatal period.",
            "Also suspect with **persistent generalised lymphadenopathy, persistent parotid swelling**, chronic lung disease, tuberculosis, or developmental regression.",
            "Test **every child of a positive mother**.",
            "**Written informed consent from the parent or guardian** is required. [HIV/AIDS Act 2017]",
            "A child of **12 years or above** who is sufficiently mature may act as guardian for a sibling. [HIV/AIDS Act 2017]",
            "Baseline: **WHO stage, CD4 percentage or count** - percentage is used under 5 years.",
            "Baseline: **weight and height with growth charting**, haemoglobin, renal and liver function, HBsAg.",
            "Baseline: **TB screening by the four-symptom screen and contact history**; developmental assessment.",
          ],
        },
        {
          ...
          points: [
            ...
            "Under NACO drugs, investigations and follow-up are **free at the ART centre**. [NACO 2021]",
            "Paediatric formulations: **dispersible scored tablets rather than syrups** wherever possible.",
            "**First line (4 weeks and at least 3 kg): abacavir + lamivudine + paediatric dispersible dolutegravir 10 mg**, dosed by weight band. [NACO 2021]",
            "Dolutegravir: **roughly 5 mg for 3 to under 6 kg**, 15 mg for 6 to under 10 kg, 20 mg for 10 to under 14 kg. [NACO 2021]",
            "Dolutegravir: **25 mg for 14 to under 20 kg**, 30 mg for 20 to under 25 kg, adult 50 mg tablet at 25 kg and above. [NACO 2021]",
            "Neonates under 4 weeks: **zidovudine + lamivudine with nevirapine or raltegravir** until dolutegravir can be started. [NACO 2021]",
            "**Doses are by weight band, never a fraction of an adult tablet** - revise at every weight gain.",
            "Monitoring: **viral load at 6 months, 12 months and then annually**; CD4 percentage at baseline. [NACO 2021]",
            "Haemoglobin, renal and liver function **according to the drugs used**.",
            "At every visit: **weight, height, developmental milestones, adherence** and the four-symptom TB screen.",
            "**Virological failure = viral load above 1000 copies/mL on two occasions at least 3 months apart** with enhanced adherence counselling between. [NACO 2021]",
            "After failure: switch to a **boosted protease inhibitor with an optimised backbone**. [NACO 2021]",
            "**Adherence in children is a caregiver intervention** - identify one responsible, disclosed caregiver.",
            "Teach **dispersion and administration**; fixed times tied to daily routine; plan for school hours and travel.",
            "Address **caregiver illness, stigma and cost of transport**.",
            "**Disclose to the child gradually from about 8-10 years**, fully by adolescence.",
            "Adolescents need **transition support** and contraception and sexual health counselling.",
            "Cotrimoxazole for every exposed infant **from 6 weeks until infection is excluded and breastfeeding has ended**. [NACO 2021]",
            "Cotrimoxazole for every infected child **under 5 years regardless of CD4**. [NACO 2021]",
            "Routine immunisation with the national schedule - **avoid live vaccines in symptomatic children**.",
            "**Nutritional rehabilitation and growth monitoring**.",
            "TB treatment: **doubled dolutegravir dose while on rifampicin**. [NACO 2021]",
            "Prevent the next case in the family - **test siblings and the parents**.",
            "Warn: **abacavir hypersensitivity (never rechallenge)**, zidovudine anaemia.",
            "Warn: **nevirapine hepatitis and severe rash**; dolutegravir insomnia and weight gain.",
            "Watch for **IRIS in the first 2-12 weeks** - continue ART and treat the unmasked infection.",
          ],
        },
      ],
      mustDraw: [
