  ...
  sections: [
    {
      ...
      points: [
        "SSTI is classified by **depth and by whether pus is present**. [IDSA 2014, Mandell 9e]",
        "Superficial: impetigo, ecthyma, folliculitis; dermal and subcutaneous: **erysipelas, cellulitis**.",
        "Purulent collections: furuncle, carbuncle, abscess; deep necrotising: **necrotising fasciitis, myonecrosis**.",
        "IDSA 2014 separates **purulent from non-purulent** infection and grades each mild, moderate or severe. [IDSA 2014, Mandell 9e]",
        "Moderate = systemic signs; **severe = SIRS with hypotension, immunocompromise, or failed initial therapy**. [IDSA 2014, Mandell 9e]",
        "**Staphylococcus aureus causes almost all purulent infections** - needs an anti-staphylococcal penicillin.",
        "**Streptococcus pyogenes causes almost all non-purulent cellulitis and erysipelas** - a simple penicillin or amoxicillin suffices.",
        "**About 40% of S. aureus isolates in ICMR surveillance are methicillin-resistant**. [ICMR 2022]",
        "Community MRSA carrying the **Panton-Valentine leucocidin** gene causes recurrent furunculosis and abscesses in healthy people.",
        "Add MRSA cover for purulent infection that is **severe, recurrent, in a household cluster, or failing beta-lactam therapy**. [IDSA 2014, Mandell 9e]",
        "Bites: **Pasteurella multocida** in dog and cat bites, Eikenella corrodens in human bites.",
        "Water: **Aeromonas** in fresh-water wounds; Vibrio vulnificus in sea-water wounds and raw shellfish in the cirrhotic.",
        "**Pseudomonas** in the diabetic foot and hot-tub folliculitis; Clostridium perfringens in contaminated crush wounds.",
        "Cellulitis risk factors: **lymphoedema, venous insufficiency, obesity, tinea pedis** and fissured web spaces, previous cellulitis.",
        "Further risk factors: **diabetes, injection drug use and immunosuppression**.",
        ...
        "Diagnosis is **clinical**; swabs of intact cellulitic skin are not helpful.",
        "Culture **pus, bullae, debrided tissue and blood** in the severe or immunocompromised patient. [IDSA 2014, Mandell 9e]",
        "Imaging: **ultrasound for abscess**, radiograph and MRI for osteomyelitis.",
        "CT for gas in necrotising infection - but it **must never delay surgery**.",
      ],
    },
    {
      heading: "Superficial infections: impetigo, folliculitis, furuncle, carbuncle and abscess",
      points: [
        "**Non-bullous impetigo**: honey-coloured crusted erosions on the face and limbs of children - S. aureus or S. pyogenes.",
        "**Bullous impetigo**: flaccid bullae from staphylococcal exfoliative toxin.",
        "Limited impetigo: **topical mupirocin 2% or fusidic acid three times daily for 5-7 days**. [IDSA 2014, Mandell 9e]",
        "Extensive impetigo: oral **cephalexin 25-50 mg/kg/day or cloxacillin for 7 days**. [IDSA 2014, Mandell 9e]",
        "**Post-streptococcal glomerulonephritis** can follow skin infection and is not prevented by antibiotics - warn the family about oedema and dark urine.",
        "**Folliculitis**: hygiene, antiseptic washes and topical mupirocin.",
        "**Furuncle (boil)**: a deep follicular abscess - warm compresses, drainage when fluctuant.",
        "**Carbuncle**: coalescing furuncles with multiple sinuses on the nape or back of a diabetic - drainage, anti-staphylococcal antibiotic and glucose control.",
        "**Incision and drainage is the primary treatment of any cutaneous abscess** - culture the pus. [IDSA 2014, Mandell 9e]",
        "Adjunctive antibiotics for **5-7 days** (cotrimoxazole or clindamycin in the American trials) improve cure and reduce recurrence.",
        "Give antibiotics when the abscess is **over 2 cm**, multiple, surrounded by cellulitis, on the face or hand, in a diabetic or immunocompromised patient, or with systemic signs. [IDSA 2014, Mandell 9e]",
        "Furuncles in the **danger area of the face (nose, upper lip, medial cheek) must never be squeezed** - valveless facial veins drain to the cavernous sinus.",
        "Danger-area furuncle: oral or IV **anti-staphylococcal antibiotic and warm compresses only**.",
        "**Recurrent furunculosis**: decolonise with intranasal mupirocin twice daily for 5 days and chlorhexidine body wash.",
        "Also **hot-wash linen and treat household carriers**.",
        "Check recurrent furunculosis for **diabetes, HIV, iron deficiency and neutrophil disorders**.",
        "Scabies with secondary impetigo is common in Indian children and hostels - **permethrin 5% for the whole household** plus an antibiotic for the pyoderma.",
        "Treat both scabies and pyoderma together - otherwise the **pyoderma recurs**.",
      ],
    },
    {
      heading: "Cellulitis and erysipelas",
      points: [
        "**Cellulitis**: spreading infection of dermis and subcutaneous tissue - warm, red, tender, oedematous area with indistinct margins, commonly on the leg.",
        "Cellulitis often has **fever, lymphangitic streaking and tender regional nodes**.",
        "**Erysipelas**: the superficial variant with a raised, sharply demarcated, bright-red edge - face or leg, almost always streptococcal.",
        "**Mark the margin with a pen and the date**, elevate the limb, treat pain.",
        "Find the portal of entry - **tinea pedis, fissure, ulcer, insect bite, injection site** - treating it prevents the next episode.",
        ...
        "Purulent cellulitis or suspected staphylococcal source: **cloxacillin 500 mg four times daily** or cephalexin. [ICMR 2022]",
        "If MRSA is likely add or substitute **cotrimoxazole double strength twice daily**, doxycycline 100 mg twice daily or clindamycin 300-450 mg three times daily. [IDSA 2014, Mandell 9e]",
        "Moderate infection with fever needs IV therapy: **cefazolin 1-2 g 8-hourly or cloxacillin 1-2 g 4-6 hourly**. [ICMR 2022]",
        "Severe infection (sepsis, immunocompromise, failed oral therapy): **vancomycin or linezolid for MRSA plus piperacillin-tazobactam** until cultures return. [IDSA 2014, Mandell 9e]",
        "Switch to oral once **afebrile for 48 hours and the erythema is receding**.",
        "Differentials of a red hot leg: **deep vein thrombosis** (unilateral swelling without well-defined erythema, risk factors).",
        "Other differentials: **venous eczema** (bilateral, itchy, chronic), gout (joint-centred), contact dermatitis, necrotising fasciitis.",
        "**Bilateral cellulitis is rare** - usually stasis dermatitis or lipodermatosclerosis.",
        "Recurrent cellulitis = **two or more episodes a year**: treat tinea pedis and lymphoedema, compression stockings, skin care.",
        "**Penicillin V 250 mg twice daily for 12 months** prevents recurrent cellulitis. [PATCH I NEJM 2013, Mandell 9e]",
        "Filarial ADLA: **daily foot washing with soap and water**, drying between the toes, antiseptic for entry lesions. [NVBDCP 2024]",
        "ADLA also needs limb elevation and exercise, with **penicillin for each acute attack**. [NVBDCP 2024]",
      ],
    },
    {
      heading: "Necrotising soft tissue infection: recognising the emergency",
      points: [
        "**Necrotising fasciitis**: rapidly spreading infection along the deep fascia with thrombosis of perforating vessels and necrosis of overlying skin.",
        "Type I: **polymicrobial** (aerobes and anaerobes) - diabetics, the perineum (Fournier gangrene) and after surgery.",
        "Type II: **monomicrobial S. pyogenes or S. aureus** in healthy people after minor trauma.",
        "Type III: **clostridial myonecrosis and Vibrio vulnificus**.",
        "**The clinical clue is pain out of proportion to the visible signs**.",
        "Later signs: tense oedema beyond the erythema, **dusky or anaesthetic skin, haemorrhagic bullae, crepitus**, grey dishwater discharge.",
        "Systemic toxicity: **tachycardia, confusion and hypotension** - progression is measured in hours.",
        "**Mortality is 20-30% even with treatment**.",
        "**LRINEC score** uses CRP, leucocyte count, haemoglobin, sodium, creatinine and glucose. [LRINEC 2004, Mandell 9e]",
        ...
        "Bedside **finger test** through a small incision: lack of bleeding, murky fluid and easy separation of fascia confirms it.",
        "CT showing **gas or fascial thickening** supports it - but must never delay surgery.",
        ...
        "Antibiotics alone fail - **thrombosed vessels cannot deliver them**.",
        "Empirical antibiotics: **piperacillin-tazobactam 4.5 g 6-hourly or meropenem 1 g 8-hourly**. [IDSA 2014, Mandell 9e]",
        "Add **clindamycin 600-900 mg 8-hourly to suppress toxin production**. [IDSA 2014, Mandell 9e]",
        "Add **vancomycin or linezolid until MRSA is excluded**. [IDSA 2014, Mandell 9e]",
        "Proven streptococcal disease: **penicillin G 4 million units 4-hourly with clindamycin**. [IDSA 2014, Mandell 9e]",
        "Intravenous immunoglobulin in streptococcal toxic shock - **weak evidence**.",
        "Family clinic task: **recognition and immediate transfer** - IV access, fluids, blood cultures, first antibiotic dose, phone the surgeon.",
        "**Never observe overnight** to see whether the antibiotic works.",
      ],
    },
    {
      heading: "Diabetic foot infection and bite wounds",
      points: [
        "Diabetic foot infection is diagnosed by **two or more of purulence, erythema, warmth, tenderness, induration or swelling** in a foot wound. [IWGDF/IDSA 2023]",
        "Mild: skin and subcutaneous tissue only, **erythema under 2 cm**. [IWGDF/IDSA 2023]",
        "Moderate: deeper structures or **erythema over 2 cm**, no systemic signs; severe: systemic inflammatory response. [IWGDF/IDSA 2023]",
        "**Positive probe-to-bone test** with a sterile blunt probe = osteomyelitis until proved otherwise. [IWGDF/IDSA 2023]",
        "Osteomyelitis support: **ESR above 70 mm in the first hour**, plain radiograph (changes lag 2-3 weeks) and MRI.",
        "A **sausage toe**, a wound over 2 cm square or one present for over 6 weeks also predict bone involvement.",
        "Mild infection: **1-2 weeks of oral cephalexin, cloxacillin or amoxicillin-clavulanate** covering staphylococci and streptococci. [IWGDF/IDSA 2023]",
        "Moderate and severe: admit, **tissue culture from the debrided base** rather than a surface swab.",
        "Moderate and severe: IV **piperacillin-tazobactam or amoxicillin-clavulanate with MRSA cover for 2-3 weeks**. [IWGDF/IDSA 2023]",
        "Osteomyelitis without resection: extend antibiotics to **6 weeks**. [IWGDF/IDSA 2023]",
        "Antibiotics are **one quarter of diabetic foot care** - debridement, complete off-loading and glycaemic control are the other three.",
        "Assess arterial supply with **pulses and ankle-brachial index**; an ischaemic infected foot needs a vascular opinion before any hope of healing.",
        "Bites: **thorough irrigation, debridement, tetanus prophylaxis**, rabies post-exposure prophylaxis for animal bites.",
        "**No primary closure of punctures or hand wounds** after a bite.",
        "Prophylaxis: **amoxicillin-clavulanate 625 mg three times daily for 3-5 days** for hand, face, deep puncture, cat and immunocompromised bites. [IDSA 2014, Mandell 9e]",
        "Infected bite: amoxicillin-clavulanate for **7-14 days**. [IDSA 2014, Mandell 9e]",
        "Amoxicillin-clavulanate covers **Pasteurella, Eikenella and anaerobes** that cephalexin and cloxacillin miss.",
        "**Kanavel signs** - finger held in flexion, pain on passive extension, tenderness along the tendon sheath - mean flexor tenosynovitis.",
        "Flexor tenosynovitis needs **surgical drainage within 24 hours**.",
        "A bite over the knuckle from a **punch to the mouth is a joint injury** until proven otherwise.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Superficial: **impetigo, ecthyma, folliculitis**; dermal-subcutaneous: erysipelas, cellulitis. [IDSA 2014, Mandell 9e]",
            "Purulent: **furuncle, carbuncle, abscess**.",
            "Necrotising: **necrotising fasciitis types I to III**, gas gangrene, Fournier gangrene.",
            "Special: **diabetic foot, bite wounds, surgical site infection**.",
            "Severity: mild - no systemic signs; **moderate - systemic signs**. [IDSA 2014, Mandell 9e]",
            "Severe: **SIRS with hypotension, immunocompromise or failure of initial therapy**. [IDSA 2014, Mandell 9e]",
          ],
        },
        {
          heading: "2. Cellulitis: clinical features and diagnosis",
          points: [
            "Warm, red, tender, oedematous area with **indistinct margins**, usually on the leg, with fever, lymphangitis and regional nodes.",
            "Erysipelas has a **raised, sharply demarcated edge**.",
            "Portal of entry: **tinea pedis, fissures, ulcers, bites, injections**.",
            "Risk factors: **lymphoedema, venous disease, obesity, diabetes**, previous cellulitis.",
            "Differentials: **deep vein thrombosis, venous eczema, gout**, contact dermatitis, necrotising fasciitis.",
            "**Bilateral cellulitis is rare** - think stasis dermatitis.",
            "Diagnosis is **clinical**; blood and pus cultures in severe or purulent disease. [IDSA 2014, Mandell 9e]",
            "**Ultrasound for occult abscess**; mark the margin.",
          ],
        },
        {
          heading: "3. Management of cellulitis",
          points: [
            "Mild non-purulent: **amoxicillin 500 mg TDS or cephalexin 500 mg QID for 5 days**. [IDSA 2014, Mandell 9e]",
            "Purulent or staphylococcal: **cloxacillin 500 mg QID**; cotrimoxazole, doxycycline or clindamycin for MRSA risk. [ICMR 2022]",
            "Moderate: **IV cefazolin or cloxacillin**. [ICMR 2022]",
            "Severe: **vancomycin or linezolid plus piperacillin-tazobactam**; oral switch after 48 hours afebrile. [IDSA 2014, Mandell 9e]",
            "Supportive: **elevation, analgesia, treat the portal of entry**, drain any collection.",
            "Prevent recurrence: **foot care, compression, treat tinea**.",
            "**Penicillin V 250 mg BD for a year** after two or more episodes. [PATCH I NEJM 2013, Mandell 9e]",
        ...
        },
        {
          ...
          points: [
            "Recognition: **pain out of proportion**, oedema beyond erythema, dusky anaesthetic skin.",
            "Also **haemorrhagic bullae, crepitus, dishwater discharge**, rapid progression, systemic toxicity.",
            "**LRINEC 6 or more supports** - a low score does not exclude; finger test at the bedside. [LRINEC 2004, Mandell 9e]",
            "Resuscitate with **fluids and blood cultures**.",
            "First dose of **piperacillin-tazobactam or meropenem plus clindamycin plus vancomycin**. [IDSA 2014, Mandell 9e]",
            "**Immediate surgical debridement**, repeated until clean - transfer to a surgical centre without delay. [IDSA 2014, Mandell 9e]",
            "**Tetanus prophylaxis** and intensive care support.",
      ...
      answer: [
        {
          ...
          points: [
            "Uninfected: no signs; **mild: skin and subcutaneous tissue only, erythema 0.5-2 cm**. [IWGDF/IDSA 2023]",
            "Moderate: **erythema over 2 cm or deeper structures** (abscess, osteomyelitis, tendon, joint), no systemic signs. [IWGDF/IDSA 2023]",
            "Severe: any infection with **systemic inflammatory response**. [IWGDF/IDSA 2023]",
            "Osteomyelitis suspected by **positive probe-to-bone test, ESR above 70**, ulcer over 2 cm square or lasting over 6 weeks, sausage toe.",
            "Osteomyelitis confirmed by **radiograph, MRI or bone biopsy**.",
          ],
        },
        {
          heading: "Assessment",
          points: [
            "**Wound depth and probe-to-bone**; peripheral pulses and ankle-brachial index.",
            "**Neuropathy testing with monofilament**; glycaemic status and renal function.",
            "**Tissue culture from the debrided base** rather than a surface swab. [IWGDF/IDSA 2023]",
          ],
        },
        {
          heading: "Management",
          points: [
            "Mild: **oral cephalexin, cloxacillin or amoxicillin-clavulanate for 1-2 weeks**. [IWGDF/IDSA 2023]",
            "Moderate and severe: admit, **IV piperacillin-tazobactam or amoxicillin-clavulanate plus MRSA cover** with vancomycin or linezolid. [IWGDF/IDSA 2023]",
            "Duration: **2-3 weeks for soft tissue, 6 weeks for osteomyelitis** without resection. [IWGDF/IDSA 2023]",
            "**Surgical debridement** of necrotic tissue and drainage of abscess.",
            "**Off-loading** with total contact cast or removable walker.",
            "**Revascularisation if ischaemic**, glycaemic control, dressing care.",
            "Prevention: **daily foot inspection, appropriate footwear, callus care**, smoking cessation.",
            "**Annual foot risk screening** and education of the patient and family.",
          ],
        },
      ],
  ...
  sections: [
    {
      ...
      points: [
        "**Rabies virus**: bullet-shaped, single-stranded negative-sense RNA virus, genus Lyssavirus, family Rhabdoviridae. [Park 27e]",
        "Entry through a **bite, scratch or lick on broken skin or mucosa**; replicates in muscle first.",
        "Travels centripetally along peripheral nerves at **50-100 mm a day**, multiplies in the brain, then spreads centrifugally to the salivary glands. [Park 27e]",
        "**India accounts for about 36% of world rabies deaths** - an estimated 18,000-20,000 a year. [Park 27e]",
        "**96-97% of Indian cases are transmitted by dogs**; the rest by cats, monkeys, mongooses, jackals and cattle. [Park 27e]",
        "Children under 15 years are **40% of victims** - bitten on the face and head, and often do not report the bite.",
        "**Incubation usually 20-90 days**, range 4 days to several years. [Park 27e]",
        "Incubation is shorter with **face, head and neck bites**, multiple or deep bites, and in children - shorter distance to the brain and larger inoculum.",
        "**Furious rabies (80%)** begins with fever and paraesthesia or itching at the healed bite site.",
        "Then **hydrophobia** - painful pharyngeal spasm on attempting to drink or even seeing water - with aerophobia, agitation, hypersalivation and autonomic instability.",
        "Furious rabies causes **death within a week**.",
        "**Paralytic (dumb) rabies (20%)**: ascending flaccid paralysis mimicking Guillain-Barre syndrome - missed unless the bite history is sought.",
        "**Once symptoms begin rabies is virtually 100% fatal**; the Milwaukee protocol has not reproduced its single success.",
        "Treatment of clinical rabies is **palliative sedation** with barrier precautions for saliva.",
        "Ante-mortem diagnosis: **nuchal skin biopsy for viral antigen by direct fluorescent antibody**, saliva RT-PCR and CSF antibody.",
        "Post-mortem diagnosis: **fluorescent antibody testing of brain** and Negri bodies in hippocampal and Purkinje neurons.",
        "**Rabies is a notifiable disease in India (2021)**, reported through IDSP.",
        "**National Rabies Control Programme (NRCP)** under NCDC was launched in the 12th Five Year Plan. [NCDC 2019]",
        ...
        "The **Semple nerve tissue vaccine was discontinued in 2004**. [Park 27e]",
      ],
    },
    {
      ...
      points: [
        ...
        "Category II in the **immunocompromised**: add rabies immunoglobulin. [WHO 2018]",
        ...
        "A bite through clothing that has broken the skin is **category III**; a scratch that bleeds is category III.",
        "Do not downgrade because the bite was provoked, the dog was a pet or vaccinated, or the wound looks clean - **a provoked bite from a rabid animal transmits rabies just as well**.",
        "**Vaccine failure in dogs is well documented** - a vaccinated dog does not exclude rabies.",
        "Bites from **rats, squirrels, hares and birds** essentially never transmit rabies - no PEP needed.",
        "A healthy dog or cat available for observation is **observed for 10 days**; if it stays healthy the course may be stopped after the doses already given. [NCDC 2019]",
        "**PEP always starts on day 0** and is never delayed for observation - a dog shedding virus in saliva shows signs within 10 days.",
        ...
        "**Pregnancy, lactation, infancy and old age are never contraindications** to PEP. [NCDC 2019]",
      ],
    },
    {
      heading: "Wound management: the step that halves the risk",
      points: [
        "**Wash the wound immediately with soap and running water for 15 minutes**, flushing every puncture. [NCDC 2019]",
        "Washing removes and inactivates virus at the site - alone it **reduces the risk of rabies by about half**.",
        "After washing apply a virucidal agent - **povidone iodine or 70% alcohol**. [NCDC 2019]",
        "**Do not apply chilli, turmeric, lime, oil, plant juice, cow dung** or any traditional irritant, and do not cauterise - they delay healing and do nothing to the virus.",
        "**Do not suture the wound** - primary closure without RIG drives virus into the tissue. [NCDC 2019]",
        "If closure is unavoidable (cosmetic or haemostatic), **infiltrate RIG first, wait several hours**, then place loose sutures.",
        "Give **tetanus toxoid or Td according to immunisation status**.",
        "Antibiotics (**amoxicillin-clavulanate for 3-5 days**) for deep punctures, hand, face and genital bites, cat bites, crush injuries and the immunocompromised.",
        "Assess for **tendon, nerve, joint and vascular injury** and refer when present.",
        "Explore and irrigate deep wounds under local anaesthesia; remove foreign material and devitalised tissue.",
        "Leave the wound **open with a light dressing**; review at 48 hours for infection.",
        "**Record the animal, circumstances, category, wound sites and doses given** in the card and clinic register - the schedule spans a month and others will see the patient.",
      ],
    },
    {
      ...
      points: [
        ...
        "Potency at least **2.5 IU per intramuscular dose**; the whole vial (0.5 mL or 1 mL by brand) is one IM dose regardless of age or weight. [NCDC 2019]",
        "**Essen IM regimen: one dose on days 0, 3, 7, 14 and 28** - five doses, five visits. [NCDC 2019]",
        "IM site: **deltoid in adults, anterolateral thigh under 2 years - never the gluteal region**, where fat delays absorption and lowers the antibody response.",
        ...
        "Intradermal injection must **raise a papule** at each site.",
        "A reconstituted vial must be used within **6-8 hours** and shared between patients - so intradermal is for anti-rabies clinics with adequate throughput.",
        "The intradermal route cuts vaccine cost by **60-80%**.",
        "WHO 2018 abbreviated options: **1-week 2-site intradermal (days 0, 3, 7)** and 4-dose IM (days 0, 3, 7 and 14-28). [WHO 2018]",
        "**Previously fully vaccinated (complete PEP or PrEP with cell culture vaccine): two doses on days 0 and 3**, IM or ID, no RIG, whatever the interval. [NCDC 2019]",
        "WHO 2018 also allows a **single-visit 4-site intradermal dose on day 0** for the previously vaccinated. [WHO 2018]",
        "Those who received **nerve tissue vaccine or an incomplete course** are treated as unvaccinated.",
        "**PrEP** is for veterinarians, animal handlers, laboratory workers, wildlife staff, and children in high-risk settings.",
        "PrEP schedule: **days 0 and 7** (WHO 2018), or days 0, 7 and 21 or 28 in the Indian schedule. [NCDC 2019]",
        "PrEP booster only **on exposure or when the titre falls below 0.5 IU/mL** in those tested.",
        "**Intercurrent illness, chloroquine and steroids reduce the vaccine response**.",
        "Immunocompromised: check an **RFFIT titre of 0.5 IU/mL or more** after the course. [WHO 2018]",
      ],
    },
    {
      heading: "Rabies immunoglobulin and monoclonal antibodies",
      points: [
        "RIG provides **passive antibody at the wound for the 7-10 days** before the vaccine produces active immunity.",
        "RIG is indicated for **every category III exposure** and for category II in the immunocompromised. [NCDC 2019]",
        ...
        "**Equine RIG 40 IU/kg, maximum 3000 IU**. [NCDC 2019]",
        "**Human RIG 20 IU/kg, maximum 1500 IU**. [NCDC 2019]",
        "Rabies monoclonal antibody: **3.33 IU/kg for the single-antibody product** (docaravimab, Rabishield). [NCDC 2019]",
        "Two-antibody monoclonal cocktail (Twinrab): **40 IU/kg**. [NCDC 2019]",
        "Monoclonal products are **Indian-manufactured and free of serum sickness** - now widely used in government anti-rabies clinics.",
        ...
        "If the volume is too small for multiple or large wounds, **dilute two- to three-fold with normal saline** so every wound is infiltrated. [WHO 2018]",
        "Any remaining volume may go IM at a site distant from the vaccine - though **WHO 2018 states this adds nothing**. [WHO 2018]",
        "**Never exceed the calculated dose** of RIG.",
        "Never give RIG in the **same syringe or the same site as the vaccine**.",
        "**Never give RIG to a patient who has completed a full vaccine course** - the memory response is faster than passive antibody and RIG would blunt it.",
        "**Skin sensitivity testing before equine RIG is no longer recommended** - it does not predict anaphylaxis. [NCDC 2019]",
        "Give ERIG with **adrenaline, antihistamine and resuscitation equipment at hand**; observe for 30 minutes.",
        "Warn about **serum sickness at 7-14 days** - treated with antihistamines and a short course of steroids.",
        "Where RIG is unavailable **start the vaccine immediately** and refer to the nearest RIG-stocking centre within 7 days.",
        "A **category III bite on the face with no RIG is an emergency referral**, not a note in the file.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Category III**: transdermal bites with bleeding on the face and hand. [NCDC 2019]",
            "Assess for **tendon, nerve, joint and vascular injury** on the hand and cosmetic injury on the face.",
            "Dog history: **stray, provoked or not, available for observation**.",
            "Child history: **tetanus immunisation status**, previous rabies vaccination, any immunosuppression.",
            "Provoked bite, pet dog or vaccinated dog **does not downgrade the category**.",
            "**No contraindication and no time limit** to PEP. [NCDC 2019]",
          ],
        },
        {
          heading: "2. Wound management",
          points: [
            "**Immediate washing with soap and running water for 15 minutes**, flushing each puncture. [NCDC 2019]",
            "Then **povidone iodine or 70% alcohol**; no irritants, no cautery.",
            "**No suturing**; if facial closure is unavoidable, infiltrate RIG first and place loose sutures after several hours.",
            "**Tetanus toxoid according to status**.",
            "**Amoxicillin-clavulanate for 3-5 days** for hand and face bites; wound review at 48 hours.",
          ],
        },
        {
          heading: "3. Rabies immunoglobulin",
          points: [
            "Given on **day 0, up to day 7** of the first vaccine dose. [NCDC 2019]",
            "**Equine RIG 40 IU/kg (maximum 3000 IU)**; human RIG 20 IU/kg (maximum 1500 IU). [NCDC 2019]",
            "Rabies monoclonal antibody **3.33 IU/kg or 40 IU/kg** according to product. [NCDC 2019]",
            "**Infiltrate the full calculated dose into and around all wounds**, diluting with saline if volume is insufficient.",
            "Any remainder **IM distant from the vaccine site**.",
            "**No skin test before ERIG** but adrenaline ready. [NCDC 2019]",
            "**Never exceed the dose**, never in the same syringe as vaccine.",
          ],
        },
        {
          heading: "4. Vaccination",
          points: [
            "Cell culture vaccine (**PCECV, PVRV or HDCV**), potency at least 2.5 IU per dose. [NCDC 2019]",
            "IM in the **deltoid (anterolateral thigh under 2 years), never gluteal**.",
            "**Essen IM: days 0, 3, 7, 14, 28**. [NCDC 2019]",
            "**Zagreb IM 2-1-1**: two doses day 0, then days 7 and 21. [NCDC 2019]",
            "**Intradermal updated Thai Red Cross**: 0.1 mL at two sites on days 0, 3, 7, 28. [NCDC 2019]",
            "If the dog is available, **observe for 10 days** - the course may stop if it stays healthy, but is never delayed for the observation.",
            "Re-exposure in a fully vaccinated person: **two doses on days 0 and 3, no RIG**. [NCDC 2019]",
            "Counsel the family on **completing every dose**; record on the card.",
            "Report the bite in the **clinic register and to IDSP**.",
          ],
        },
        {
          heading: "5. National Rabies Control Programme",
          points: [
            "**NRCP under NCDC**, launched in the 12th Five Year Plan. [NCDC 2019]",
            "Human health component: **training, vaccine and RIG at anti-rabies clinics**, intradermal vaccination, surveillance and IEC.",
            "Animal health component: **dog vaccination and animal birth control**.",
            "**NAPRE 2021**: One Health approach targeting zero human deaths from dog-mediated rabies by 2030. [NAPRE 2021]",
            "Rabies made **notifiable in 2021**; nerve tissue vaccine discontinued 2004.",
      ...
      answer: [
        {
          ...
          points: [
            "**Equine RIG 40 IU/kg body weight, maximum 3000 IU**. [NCDC 2019]",
            "**Human RIG 20 IU/kg, maximum 1500 IU**. [NCDC 2019]",
            "Indian rabies monoclonal antibodies: **single antibody 3.33 IU/kg**, two-antibody cocktail 40 IU/kg. [NCDC 2019]",
            "**Skin sensitivity testing before ERIG is no longer recommended**. [NCDC 2019]",
            "Administer with **adrenaline and resuscitation facilities available**; observe for 30 minutes.",
            "**Serum sickness at 7-14 days in 1-6%** - treated with antihistamines and steroids.",
          ],
        },
        {
          heading: "Administration",
          points: [
            "**Infiltrate the maximum anatomically feasible volume into and around every wound**, including fingers and face, with a fine needle. [NCDC 2019]",
            "**Dilute two- to three-fold with normal saline** if the volume is insufficient for multiple wounds. [WHO 2018]",
            "Any remainder may be given **IM at a site distant from the vaccine**.",
            "**Never the same syringe, site or limb** as the vaccine.",
            "**Never exceed the calculated dose** - excess suppresses the active response.",
            "If wounds are sutured, **RIG must be infiltrated first**.",
          ],
        },
        {
          heading: "When not to give",
          points: [
            "**Not after day 7** of the first vaccine dose. [NCDC 2019]",
            ...
            "Not for **category I or immunocompetent category II** exposures. [NCDC 2019]",
