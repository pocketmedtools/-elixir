  ...
  theory: [
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            "**Joint preconception consultation**: the wish for a child, the woman's obstetric and menstrual history, both partners' general health.",
            "State explicitly that a serodiscordant couple **can safely have a healthy, HIV-negative child** - this reduces desperation-driven unprotected intercourse.",
            "**Optimise his ART first**: viral load below 50 copies/mL sustained for at least 6 months on a dolutegravir-based regimen.",
            "Reinforce adherence and **treat any intercurrent infection** before attempts.",
            ...
            "Screen both partners: **syphilis (VDRL or RPR with a treponemal test), HBsAg, anti-HCV**, other STIs, TB by the four-symptom screen.",
            "Wife: **haemoglobin, blood group and rubella immunity**.",
            "**Treat everything found before attempting conception** - genital infection raises shedding and complicates pregnancy.",
            "**Assess fertility before assuming HIV is the obstacle**: semen analysis for him; cycle regularity, ovulation and tubal assessment for her.",
            "Refer if either is abnormal - **untreated infertility is a commoner reason for failure to conceive** than anything HIV-related.",
            "Preferred method: **timed unprotected intercourse in the fertile window** with sustained documented suppression.",
            "Fertile window by **cycle length, cervical mucus changes or ovulation prediction kits** - about days 10-16 of a 28-day cycle.",
            "**Condoms at all other times** - minimises exposures while giving the best chance of conception each cycle.",
            "Where suppression is not fully documented or anxiety persists: **PrEP for the wife (tenofovir with emtricitabine or lamivudine)**, started at least a week before attempts and continued through them.",
            "PrEP monitoring: **3-monthly HIV testing**, baseline creatinine and hepatitis B status.",
            "**Sperm washing with IUI, or IVF with ICSI** - the traditional standard, still indicated when suppression is uncertain or there is co-existing infertility.",
            "Sperm washing and IVF are **costly and available in limited Indian centres**.",
            "Had the wife been the positive partner, **self-insemination of his semen with a syringe during the fertile window** would remove transmission risk entirely.",
            "Standard preconception care: **folic acid 400 microgram daily for at least 1-3 months** before conception (5 mg where a usual high-risk indication exists).",
            "Iron and calcium per antenatal protocol; **stop tobacco, alcohol and any teratogenic drug**; optimise weight, blood pressure and glycaemia.",
            "If she becomes positive, the full PPTCT package reduces transmission to the baby to **below 2 per cent**. [NACO 2021]",
            "PPTCT package: **lifelong ART, viral load at 34-36 weeks**, delivery planned on that result, infant nevirapine prophylaxis. [NACO 2021]",
            "PPTCT package: **exclusive breastfeeding for 6 months** with cotrimoxazole from 6 weeks, DNA-PCR early infant diagnosis at 6 weeks. [NACO 2021]",
            "Offer written information, contact numbers, and **adoption or donor insemination** as alternatives if they decline the options above.",
          ],
        },
      ],
      mustDraw: [
