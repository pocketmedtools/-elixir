  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Adults, Stage 3 (advanced)**: unexplained weight loss over 10%; unexplained chronic diarrhoea over 1 month; unexplained persistent fever over 1 month. [NACO 2021]",
    ...
    },
    {
      ...
      points: [
        ...
        "Transmission risk per percutaneous exposure to HIV-infected blood: **about 0.3%**.",
        "Transmission risk per mucous membrane splash **about 0.09%**; per receptive anal intercourse about 1.4%.",
        "**Start PEP as early as possible - ideally within 2 hours; outer limit 72 hours**. [NACO 2021]",
        "No benefit beyond 72 hours - then the correct action is **baseline and follow-up testing with counselling**.",
        ...
        "Baseline HIV test on the exposed person is **mandatory** - prophylaxis is pointless and harmful if they are already positive.",
        ...
        "Test the source for **HIV, hepatitis B and C with consent** wherever identifiable.",
        "A source with a documented sustained undetectable viral load makes transmission extremely unlikely - **guidance varies on omitting PEP**.",
        "Most Indian centres **still give PEP for a high-risk percutaneous injury** from a suppressed source.",
        "**Follow-up HIV testing at 6 weeks, 3 months and 6 months** from the exposure. [NACO 2021]",
        "Some international guidance shortens follow-up to **4 months with a fourth-generation assay**.",
        "During follow-up: **condom use, no blood or organ donation, no pregnancy attempt**; individualised advice for a breastfeeding woman.",
        "**Review at 2 weeks** for adherence and side effects; report the injury formally as an occupational event.",
        "**Non-occupational PEP follows the same drug, timing and testing rules**. [NACO 2021]",
        "nPEP indications: **sexual assault, condom rupture with an unsuppressed positive partner**, unprotected sex with unknown-status high-risk partner, shared injecting equipment.",
        "Sexual exposure: add **emergency contraception - levonorgestrel 1.5 mg within 72 hours or a copper IUD within 5 days**.",
        "Sexual exposure: **presumptive treatment of other STIs**, hepatitis B vaccine with immunoglobulin if unimmunised, tetanus cover.",
        "Assault: **medico-legal documentation, forensic samples** and psychological support.",
        ...
        "PrEP reduces acquisition by **over 90%** when taken consistently.",
        "PrEP needs a **documented negative HIV test before starting and 3-monthly thereafter**, hepatitis B testing and baseline creatinine.",
        "PrEP takes **about 7 days to protect rectal tissue and about 21 days for vaginal tissue**.",
        "Event-driven **2+1+1 dosing is validated only for men who have sex with men**. [WHO 2021]",
        "**Long-acting injectable cabotegravir and the dapivirine ring** are newer WHO-recommended options. [WHO 2021]",
        ...
        "For serodiscordant couples PrEP is used selectively - **check local availability before promising it**.",
      ],
    },
    {
      ...
      points: [
        ...
        "The evidence is **four cohorts with zero linked transmissions** among tens of thousands of condomless acts.",
        "**HPTN 052** (2011 and 2016): 93-96% reduction in linked transmission with early ART, no linked transmission while suppressed.",
        "**PARTNER** (2016): 888 serodifferent couples, about 58,000 condomless acts, zero linked transmissions.",
        "**PARTNER2** (2019): 782 male couples, about 77,000 acts; **Opposites Attract** (2018): 343 male couples.",
        "Undetectable in these studies meant a **plasma viral load below 200 copies/mL**.",
        "Sustained means **suppressed for at least 6 months** with no blip above that level.",
        "Documented means an **actual laboratory result the clinician has seen** - not the patient's belief.",
        "India's viral load schedule (6 months, 12 months, then annually) means the **last result may be up to a year old**.",
        "Before relying on U=U add an **adherence history, a pharmacy refill check**, and a look for intercurrent illness or an untreated STI.",
        "**U=U applies to sexual transmission only** - it does not remove the risk of other STIs or of pregnancy.",
        "U=U does **not apply to shared injecting equipment**.",
        "U=U does not by itself settle breastfeeding - a **small residual risk** means ART plus the recommended feeding advice is still required.",
        "Condom rupture with a suppressed positive partner: **calm the couple and take a history the same day**.",
        "If suppression is sustained and documented, transmission risk is effectively zero - **post-exposure prophylaxis is not indicated**.",
        "Then: **baseline HIV test for the negative partner** if not done recently, and a repeat viral load for him to re-document suppression.",
        "Then: **emergency contraception if pregnancy is not wanted**, and screening for other STIs.",
        "Then: **condom counselling with a demonstration of correct use**, a supply of condoms, reassurance and an open door to return.",
        "Treat the rupture as a significant exposure if **suppression is not documented, the last viral load is old or above 200 copies/mL**, or adherence has been erratic.",
        "Also treat as significant exposure if he has **missed doses, an intercurrent illness or genital ulcer disease**.",
        "Significant exposure: **tenofovir + lamivudine + dolutegravir within 72 hours for 28 days**. [NACO 2021]",
        "Significant exposure: baseline **HIV, hepatitis B and C, liver and renal tests and a pregnancy test**; retest at 6 weeks, 3 months and 6 months. [NACO 2021]",
        "In genuine doubt with the 72-hour clock running, **start prophylaxis and stop it when the viral load result arrives** - do not lose the window.",
        "Safe conception, step 1: confirm **sustained suppression below 50 copies/mL for at least 6 months** on a dolutegravir-based regimen.",
        ...
        "Step 2: screen both partners for **syphilis, hepatitis B and C and other STIs**; treat any genital infection before trying.",
        "Step 3: fertility screen - **semen analysis for him, cycle and tubal assessment for her**.",
        "Step 4: **limit unprotected intercourse to the fertile window** (cycle length, cervical mucus or ovulation prediction kits); condoms at every other time.",
        "Additional option 1: **PrEP for the negative partner**, started at least a week before and continued through the attempts, where suppression is not fully documented or anxiety is high.",
        "Additional option 2: **sperm washing with intrauterine insemination, or IVF with ICSI** - when the man is positive and suppression is uncertain, with co-existing infertility, or for maximum reassurance.",
        "Sperm washing and IVF are available in **limited Indian centres and expensive**.",
        "Additional option 3 (woman positive, man negative): **self-insemination with a syringe during the fertile window** - removes the transmission risk altogether.",
        "Preconception: **folic acid 400 microgram daily (5 mg if a usual high-risk indication)** for at least 1-3 months before conception.",
        "Preconception: **rubella and anaemia screening**, optimise weight and glycaemia, stop tobacco and alcohol.",
        "If the woman is positive, **enrol her in PPTCT from the start**.",
      ],
    },
    {
      ...
      points: [
        ...
        "A woman diagnosed late in pregnancy still benefits - **start the same day**.",
        "**Mode of delivery follows the viral load, not the diagnosis**.",
        ...
        "Viral load **above 1000 copies/mL, unknown, or ART started late or not at all: elective caesarean at 38 completed weeks** before labour and membrane rupture. [NACO 2021]",
        "In labour avoid **artificial rupture of membranes, fetal scalp electrodes and scalp blood sampling**.",
        "Avoid routine episiotomy and instrumental delivery; **minimise the duration of ruptured membranes**; manage the third stage actively.",
        "Infant prophylaxis, low-risk breastfed infant: **syrup nevirapine once daily from birth for 6 weeks**. [NACO 2021]",
        "High-risk infant: nevirapine **extended to 12 weeks**, with zidovudine added for the first 6 weeks in WHO's high-risk arm. [WHO 2021]",
        "High risk = mother **diagnosed late, on ART under 24 weeks, poor adherence, or viral load above 1000**. [NACO 2021]",
        "Nevirapine by birth weight: **about 2 mg/kg under 2000 g**; 10 mg (1 mL) daily for 2000-2499 g; 15 mg (1.5 mL) daily for 2500 g and above. [NACO 2021]",
        "Infant cotrimoxazole **starts at 6 weeks** and continues until infection is excluded and breastfeeding has ended. [NACO 2021]",
        "Feeding in India: **exclusive breastfeeding for 6 months**, then complementary feeds with continued breastfeeding to 12 and up to 24 months, provided the mother is on ART. [NACO 2021]",
        "Reason: in Indian conditions replacement feeding carries a **higher risk of death from diarrhoea and malnutrition** than the residual HIV risk.",
        "**Mixed feeding in the first 6 months is the most dangerous option** - actively discourage it.",
        ...
        "This is where **NACO differs in emphasis from high-income guidance** - follow NACO in India.",
        ...
        "Protection extends to people living with HIV **and those living with them**.",
        ...
        "A provider may inform a partner at significant risk only **after counselling the positive person, giving reasonable time to disclose voluntarily**, and acting in good faith.",
        "Every state appoints an **Ombudsman** to hear complaints of violations within a set period. [HIV/AIDS Act 2017]",
        "Court proceedings are **in camera, with suppression of identity**, on a priority basis.",
        "A child of **12 years or above** who is sufficiently mature may act as guardian of a sibling. [HIV/AIDS Act 2017]",
        "The Act creates a **right to ART and management of opportunistic infections**.",
        "The wording **as far as possible** qualifies that entitlement - the most criticised limitation of the Act.",
      ...
      answer: [
        {
          ...
          points: [
            "**Reassure and see them the same day** - panic drives couples to unnecessary drugs or to abandoning follow-up.",
            "Explain that the risk here is likely **effectively zero**, and that you will confirm it with facts rather than assumption.",
            "**Establish whether suppression is sustained and documented** - ask for the actual laboratory viral load report and its date.",
            "Was the viral load **below 200 copies/mL (ideally below 50)**, and suppressed for at least 6 months with no blip?",
            "Adherence history: **missed doses, recent illness, vomiting or diarrhoea**, recent antitubercular or antiepileptic drugs, antacid or iron use.",
            "Examine for **genital ulcer disease or another STI** - both raise shedding.",
            "**If suppression is sustained and documented, PEP is NOT indicated** - say so explicitly, quoting U=U and the trials. [WHO 2021]",
            "Unnecessary PEP exposes the wife to **28 days of drug, cost and anxiety** and undermines confidence in his treatment.",
            "Treat as a significant exposure if suppression is **not documented, the last report is old or above 200 copies/mL**, adherence erratic, or he is unwell.",
            ...
            "Before PEP: baseline **HIV, HBsAg, anti-HCV, haemogram, liver and renal function** and a pregnancy test in the wife. [NACO 2021]",
            "Follow-up **HIV testing at 6 weeks, 3 months and 6 months**. [NACO 2021]",
            "Genuinely uncertain with the 72-hour window closing: **start PEP and stop it when the viral load result arrives**.",
            "Address what U=U does not cover: **emergency contraception if pregnancy is not desired** - levonorgestrel 1.5 mg within 72 hours or a copper IUD within 5 days.",
            "**Screen both partners for other STIs** - HIV suppression gives no protection against syphilis, gonorrhoea, chlamydia, herpes or hepatitis.",
            "Check the wife's **hepatitis B immunity** and vaccinate if needed.",
            "Prevent the next rupture: demonstrate correct condom use - **correct size, water-based lubricant only**, no oil or petroleum jelly, no double condoms.",
            "Condom technique: **check expiry and storage**, put it on before any contact, hold the base on withdrawal; supply free condoms.",
            "Discuss **PrEP for the wife** as an added layer if she remains anxious or his adherence is unreliable.",
            "In India PrEP comes through **NACO targeted intervention and demonstration projects**, not a universal programme. [NACO 2021]",
            "**Repeat his viral load now** to re-document suppression; reinforce daily adherence.",
            "**Baseline HIV test for the wife** if not tested recently; document the counselling.",
            "Maintain **strict confidentiality under the HIV/AIDS Act 2017**. [HIV/AIDS Act 2017]",
            "Give a **clear line of contact** so they call early rather than in a panic next time.",
          ],
        },
        {
