  ...
  sections: [
    {
      ...
      points: [
        "Enteric fever is caused by **Salmonella enterica serovar Typhi** and by serovar Paratyphi A.",
        "Paratyphi A causes about **20-25% of Indian enteric fever**.",
        "Both serovars are human-restricted - transmission is faecal-oral through contaminated water, ice, street food, cut fruit and salads.",
        "The infective dose is high - **transmission requires substantial faecal contamination**.",
        "Enteric fever is therefore a marker of failed water supply and sanitation.",
        "Cases cluster in urban slums and in summer before the monsoon.",
        "India carries one of the world's largest burdens of enteric fever.",
        "**NSSEFI (National Surveillance System for Enteric Fever in India)** estimates several hundred cases per 100,000 child-years in urban slums.",
        "Peak incidence is in children aged **2-15 years**.",
        "**Incubation is 7-14 days** (range 3-60 days depending on inoculum).",
        "The organism invades Peyer patches and multiplies in mesenteric nodes.",
        "A primary and then a secondary bacteraemia follow - blood culture yield is highest in the **first week**.",
        "About **1-4% of patients become chronic carriers** - excreting organisms for more than a year.",
        "Carriage is usually from a chronically infected gall bladder, often with gallstones.",
        "Mary Mallon is the classic carrier; in India the carrier cook still causes household and canteen outbreaks.",
        "**Untreated typhoid has a case fatality of 10-20%**; it falls below 1% with appropriate antibiotics.",
        "This is the largest single benefit of correct antimicrobial therapy in tropical medicine.",
      ],
    },
    {
      heading: "Clinical course week by week",
      points: [
        "**Week 1: step-ladder rise in fever** with headache, malaise, anorexia and dry cough.",
        "Week 1 bowel habit: constipation in adults, diarrhoea in children.",
        "**Relative bradycardia (Faget sign)** may be present in week 1.",
        "Blood culture is positive in **60-80%** in week 1.",
        "**Week 2: sustained high fever** with a toxic look and coated tongue with clean red edges.",
        "Week 2 abdomen: distension and tenderness, soft splenomegaly and hepatomegaly.",
        "**Rose spots** = crops of 2-4 mm blanching pink macules on the trunk, in 5-30% of patients.",
        "Rose spots are very hard to see on Indian skin.",
        "**Week 3 is the week of complications** - intestinal haemorrhage and perforation of the terminal ileum.",
        "Week 3 also brings typhoid encephalopathy - the coma-vigil or muttering delirium of the typhoid state.",
        "Myocarditis and shock are further week 3 complications.",
        "**Week 4 and beyond:** gradual defervescence and convalescence.",
        "**Relapse occurs in 5-10%**, usually 1-3 weeks after stopping antibiotics - generally milder.",
        "Other complications: acute cholecystitis, hepatitis, nephritis, arthritis, deep vein thrombosis.",
        "Osteomyelitis occurs particularly in sickle cell disease; meningitis in infants.",
        "Haemophagocytic lymphohistiocytosis is a recognised complication.",
        "**Sudden severe abdominal pain, guarding, absent liver dullness and rising pulse in week 3 = ileal perforation** until proved otherwise.",
        "Suspected perforation: erect abdominal film, resuscitation and urgent surgical referral.",
      ],
    },
    {
      heading: "Diagnosis: culture, not serology",
      points: [
        "**Blood culture is the gold standard** for enteric fever.",
        "Take **10-15 mL of blood in adults** (2-4 mL in children) into 45-90 mL of broth.",
        "Send ideally two sets of blood culture before any antibiotic.",
        "Blood culture yield is **60-80% in week 1**, falling to 30-40% by week 3.",
        "Yield falls sharply after even one dose of antibiotic.",
        "**Bone marrow culture is the most sensitive test (80-95%)** and stays positive despite prior antibiotics.",
        "Bone marrow culture is the answer when a partially treated patient must be diagnosed.",
        "Stool and urine cultures become positive from week 2-3 - used to detect carriers.",
        "**The Widal test is a poor test in India.**",
        "Widal measures agglutinins to the O and H antigens.",
        "Widal needs paired sera 7-10 days apart showing a **fourfold rise**.",
        "A single Widal titre is confounded by past infection, prior vaccination and cross-reacting infections.",
        "A single high O titre may support the diagnosis in a non-endemic setting - **never the sole basis for treatment**.",
        "Typhidot, Typhidot-M and Tubex TF detect IgM - quicker than culture.",
        "Rapid IgM tests have **sensitivity and specificity of only about 70-80%** - they do not replace culture.",
        "Rapid tests are acceptable only where culture is unavailable, interpreted against the clinical picture.",
        "Supportive findings: **normal or low leucocyte count with a left shift** and relative lymphopenia.",
        "**Aneosinophilia** is characteristic.",
        "Mild thrombocytopenia and transaminases raised **2-3 times normal** are usual.",
        "Nested PCR for flagellin has good sensitivity in research settings but is not standardised for routine use.",
        "**Send the culture before the first dose of antibiotic** - the practical rule.",
      ],
    },
    {
      heading: "Antimicrobial resistance and current treatment",
      points: [
        "**Classical MDR typhoid** = resistant to chloramphenicol, ampicillin and cotrimoxazole - emerged in the 1990s with the H58 haplotype.",
        "**Fluoroquinolone non-susceptibility is now near-universal in India.**",
        "**XDR typhoid** = MDR plus resistance to third-generation cephalosporins - spread from Sindh, Pakistan since 2016.",
        "Imported XDR typhoid cases have been reported in India.",
        "**Fluoroquinolones must no longer be used empirically for enteric fever in India.** [ICMR 2022]",
        "Nalidixic acid resistance or **ciprofloxacin MIC of 0.12 microgram/mL or more** predicts clinical failure - even if reported sensitive by old breakpoints.",
        "**Uncomplicated, outpatient: azithromycin 500 mg to 1 g PO once daily for 7 days** in adults. [ICMR 2022]",
        "Children: azithromycin **20 mg/kg once daily (maximum 1 g) for 7 days**.",
        "Alternative oral: **cefixime 20 mg/kg/day in two divided doses (adult 200 mg BD) for 14 days** - defervesces more slowly.",
        "**Complicated or hospitalised: ceftriaxone 2 g IV once daily for 10-14 days** in adults. [ICMR 2022]",
        "Children: ceftriaxone **75-100 mg/kg/day for 10-14 days**.",
        "Add azithromycin where response is slow or XDR is suspected.",
        "**Meropenem** is reserved for proven XDR disease.",
        "**Severe typhoid (shock, altered sensorium, typhoid state): dexamethasone 3 mg/kg IV loading, then 1 mg/kg 6-hourly for 48 hours** (8 doses).",
        "Dexamethasone reduced mortality from 55% to 10% in the classic Hoffman trial.",
        "**Defervescence is slow - expect 3-5 days** on an appropriate drug.",
        "Do not switch antibiotics on day 2 for continuing fever.",
        "Fever beyond 7 days: search for a complication, an abscess or a resistant organism - not reflex escalation.",
      ],
    },
    {
      heading: "Supportive care, carriers and follow-up",
      points: [
        "Supportive care: **paracetamol** for fever, oral or intravenous hydration, and a soft low-residue diet.",
        "Examine the abdomen daily for signs of complication.",
        "**Avoid purgatives, enemas and NSAIDs** - all increase the risk of perforation and bleeding.",
        "Nurse with enteric precautions - handwashing, safe disposal of stool and separate utensils.",
        "**Exclude food handlers, cooks and health workers until 3 consecutive stool cultures** at least 24 hours apart are negative.",
        "**Chronic carriage** = excretion of Salmonella Typhi in stool or urine for more than **12 months** after the acute illness.",
        "Carrier treatment: **ciprofloxacin 750 mg twice daily for 28 days**, or high-dose amoxicillin, or azithromycin.",
        "**Cholecystectomy** is reserved for carriers with gallstones and persistent excretion after antibiotics.",
        "**Vi polysaccharide vaccine**: single 0.5 mL IM dose, licensed from 2 years of age. [WHO 2018]",
        "Vi polysaccharide gives about **55-70% protection for 3 years** - revaccinate every 3 years.",
        "**Typhoid conjugate vaccine (Typbar-TCV)** = Vi conjugated to tetanus toxoid, WHO prequalified in 2018. [WHO 2018]",
        "TCV: **single 0.5 mL IM dose from 6 months of age** - better and longer protection with immunological memory.",
        "**IAP recommends TCV at 9-12 months with a booster at 4-6 years**. [IAP 2023]",
        "TCV is in the routine programme in some states and cities, and offered in campaigns.",
        "TCV is the vaccine of choice for travellers, household contacts and outbreak control.",
        "Prevention beyond vaccines: **safe drinking water** by boiling, chlorination or filtration.",
        "Safe food handling, handwashing, and avoiding cut fruit, ice and salads from street vendors.",
        "Notify clusters - the district team can then trace the water source.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "History: **step-ladder fever**, headache, anorexia, dry cough.",
            "Bowel habit: constipation in adults, diarrhoea in children.",
            "Source history: street food, cut fruit, ice, unsafe water, similar illness in the household.",
            "Examination: toxic appearance, **relative bradycardia**, coated tongue with clean edges.",
            "Abdomen: distension and tenderness, soft splenomegaly and hepatomegaly; rose spots on the trunk.",
            "Week 3 complications: abdominal rigidity and absent liver dullness = perforation.",
            "Melaena = haemorrhage; altered sensorium = typhoid state or encephalopathy.",
            "Differential: malaria, scrub typhus, leptospirosis, dengue, tuberculosis.",
            "Also consider amoebic liver abscess, infective endocarditis and brucellosis.",
          ],
        },
        {
          heading: "2. Investigations",
          points: [
            "**Blood culture is the gold standard** - 10-15 mL of blood in adults into 45-90 mL of broth, two sets.",
            "Draw blood cultures before any antibiotic - yield **60-80% in the first week**.",
            "Bone marrow culture where antibiotics have already been given - sensitivity **80-95%**.",
            "Stool and urine cultures from week 2 - to identify carriers and clear food handlers.",
            "Supportive findings: normal or low leucocyte count with left shift, **aneosinophilia**, relative lymphopenia.",
            "Mild thrombocytopenia and transaminases 2-3 times normal.",
            "Widal requires paired sera with a **fourfold rise** - confounded by past infection and vaccination.",
            "A single Widal titre must not drive treatment.",
            "Typhidot and Tubex are rapid but only **70-80% sensitive and specific**.",
          ],
        },
        {
          heading: "3. Antimicrobial resistance in India",
          points: [
            "**MDR typhoid** = resistant to chloramphenicol, ampicillin and cotrimoxazole - emerged with the H58 haplotype in the 1990s.",
            "Fluoroquinolone non-susceptibility is now near universal in India.",
            "Nalidixic acid resistance or **ciprofloxacin MIC of 0.12 microgram/mL or more** predicts clinical failure despite an apparently sensitive report.",
            "**XDR typhoid** = additionally resistant to third-generation cephalosporins - emerged in Sindh in 2016.",
            "XDR typhoid has been imported into India - requires **azithromycin or meropenem**.",
          ],
        },
        {
          heading: "4. Treatment",
          points: [
            "Uncomplicated: **azithromycin 500 mg to 1 g PO once daily for 7 days** in adults; 20 mg/kg once daily in children. [ICMR 2022]",
            "Oral alternative: **cefixime 20 mg/kg/day in two doses for 14 days**.",
            "Hospitalised or complicated: **ceftriaxone 2 g IV once daily for 10-14 days**; 75-100 mg/kg/day in children. [ICMR 2022]",
            "Severe disease with shock or altered sensorium: **dexamethasone 3 mg/kg IV loading, then 1 mg/kg 6-hourly for 48 hours** - reduces mortality substantially.",
            "Supportive care: paracetamol, hydration, soft low-residue diet.",
            "Avoid purgatives, enemas and NSAIDs; surgical referral for perforation.",
            "Expect defervescence in **3-5 days**.",
            "Fever persisting beyond a week calls for reassessment - not reflex escalation.",
          ],
        },
        {
          heading: "5. Prevention and public health",
          points: [
            "Safe water through boiling, chlorination or filtration.",
            "Safe food handling, handwashing, and avoiding street cut fruit, ice and salads.",
            "Enteric precautions in the ward.",
            "Exclude food handlers until **3 consecutive negative stool cultures** 24 hours apart.",
            "Treat chronic carriers with **ciprofloxacin 750 mg twice daily for 28 days**.",
            "Cholecystectomy where gallstones persist with excretion.",
            "**Typhoid conjugate vaccine (Typbar-TCV)**: single IM dose from 6 months of age. [WHO 2018]",
            "IAP recommends TCV at **9-12 months with a booster at 4-6 years**. [IAP 2023]",
            "Vi polysaccharide vaccine from 2 years, with revaccination every 3 years.",
            "Report clusters so the district team can trace and correct the contaminated water source.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Ileal perforation** - typically a single perforation of the terminal ileum in week 3.",
            "Perforation presents with sudden severe abdominal pain, guarding, rigidity, absent liver dullness and rising pulse.",
            "Perforation management: resuscitation, nasogastric decompression, broad-spectrum antibiotics.",
            "Then **urgent laparotomy** with simple closure or resection.",
            "**Intestinal haemorrhage** - melaena or frank bleeding, occasionally massive.",
            "Haemorrhage management: transfusion, correction of coagulopathy and, rarely, surgery.",
            "Both are made more likely by **purgatives, enemas and NSAIDs** - avoid them.",
          ],
        },
        {
          heading: "Systemic complications",
          points: [
            "Typhoid encephalopathy - muttering delirium and the coma-vigil state; rarely meningitis in infants.",
            "Encephalopathy treatment: **dexamethasone 3 mg/kg, then 1 mg/kg 6-hourly for 48 hours** in addition to antibiotics.",
            "Myocarditis - tachycardia, hypotension, ECG changes and heart failure.",
            "Typhoid hepatitis - jaundice and raised transaminases; acute cholecystitis.",
            "Shock, disseminated intravascular coagulation and haemophagocytic lymphohistiocytosis.",
            "Acute kidney injury and nephritis.",
            "Focal infections: osteomyelitis (particularly in **sickle cell disease**) and septic arthritis.",
            "Splenic and hepatic abscess; rarely endocarditis or mycotic aneurysm.",
          ],
        },
        {
          heading: "Late problems and prevention of complications",
          points: [
            "Relapse in **5-10%**, 1-3 weeks after stopping antibiotics - re-culture and re-treat with a full course.",
            "Chronic carriage in **1-4%** = excretion beyond 12 months, usually from a gallbladder with stones.",
            "Carrier treatment: **28 days of ciprofloxacin** or high-dose amoxicillin; consider cholecystectomy.",
            "Complications are prevented by early diagnosis and effective antibiotics.",
            "Examine the abdomen daily during weeks 2-3.",
            "Avoid purgatives, enemas and NSAIDs.",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Chloramphenicol resistance appeared soon after its introduction.",
            "The **H58 haplotype** carrying an MDR plasmid spread across South Asia in the 1990s.",
            "Fluoroquinolones replaced the first-line drugs and were then lost to gyrA mutations.",
            "Nalidixic acid resistance, or **ciprofloxacin MIC of 0.12 microgram/mL or more**, predicts clinical failure even when the report says sensitive.",
            "XDR typhoid emerged in Hyderabad, Sindh in 2016 - an H58 strain acquired a **blaCTX-M-15** plasmid.",
            "Imported XDR cases have been documented in India.",
          ],
        },
        {
          heading: "Rational antibiotic choice",
          points: [
            "Uncomplicated outpatient: **azithromycin 500 mg-1 g once daily for 7 days** (20 mg/kg in children). [ICMR 2022]",
            "Azithromycin achieves high intracellular concentrations and remains reliably active.",
            "Alternative oral: **cefixime 20 mg/kg/day in two divided doses for 14 days** - accept slower defervescence.",
            "Hospitalised or complicated: **ceftriaxone 2 g IV daily for 10-14 days**; add azithromycin if response is slow. [ICMR 2022]",
            "Proven or strongly suspected XDR: **meropenem 1 g 8-hourly** with or without azithromycin.",
            "**Fluoroquinolones should not be used empirically anywhere in India.** [ICMR 2022]",
            "Reserve fluoroquinolones for a culture-confirmed fully susceptible isolate with a low ciprofloxacin MIC.",
          ],
        },
        {
          heading: "Stewardship points",
          points: [
            "**Always send a blood culture before the first dose** - allows de-escalation and generates local resistance data.",
            "Do not change the antibiotic on day 2 for continuing fever - defervescence normally takes **3-5 days**.",
            "Vaccinate with typhoid conjugate vaccine, improve water and sanitation, and treat carriers.",
            "Reducing incidence is the only durable answer to resistance.",
          ],
        },
      ],
  ...
  sections: [
    {
      ...
      points: [
        "**Orientia tsutsugamushi is an obligate intracellular gram-negative bacterium** - separated from the genus Rickettsia in 1995.",
        "Antigenic strains Karp, Kato and Gilliam explain why one infection gives little protection against the next.",
        "Transmitted by the **bite of the larval stage (chigger) of trombiculid mites** - principally Leptotrombidium deliense in India.",
        "The mite is both vector and reservoir - the organism passes transovarially; rodents are only maintenance hosts.",
        "The chigger is 0.2 mm, feeds once, and the bite is painless and usually unnoticed.",
        "The **tsutsugamushi triangle** runs from Japan and Korea through south-east Asia to India, Pakistan and northern Australia.",
        "Indian reports: Tamil Nadu, Puducherry, Kerala, Karnataka, Himachal Pradesh, Uttarakhand, Sikkim, Meghalaya, Rajasthan and Maharashtra.",
        "Scrub typhus is now the commonest identified cause of acute undifferentiated fever in several Indian tertiary series.",
        "Transmission peaks in the **cooler months after the monsoon, August to January**.",
        "Exposure: scrub vegetation, grassland, plantations, paddy fields and forest edges.",
        "Highest risk: farmers, plantation workers, soldiers and children who play in long grass.",
        "Incubation is **6-21 days, usually about 10 days**.",
        "A picnic, harvest or forest trek 2 weeks earlier matters more than exposure in the last few days.",
        "Reporting is through the **Integrated Disease Surveillance Programme (IDSP)**.",
        "Scrub typhus is not under the NVBDCP and has no separate national control programme - recognition rests entirely on the clinician.",
      ],
    },
    {
      heading: "Clinical features and the eschar",
      points: [
        "Abrupt onset of **high fever, severe headache, myalgia, conjunctival injection and generalised lymphadenopathy**.",
        "Cough, abdominal pain, vomiting and loose stools often misdirect the clinician towards a respiratory or gastrointestinal diagnosis.",
        "**The eschar is the pathognomonic sign** - a painless 5-20 mm black necrotic crust with an erythematous halo at the chigger bite.",
        "Eschar sites: axilla, groin, genitalia, perineum, under the breast, neck, behind the ear - typically with tender regional nodes.",
        "Eschar is found in **10-50% of Indian series** - the rate rises the more carefully the patient is undressed and examined.",
        "A maculopapular rash on the trunk spreading to the limbs appears in a minority around day 5-7 - less prominent than in spotted fevers.",
        "**Hepatosplenomegaly** is present in a third to a half.",
        "Laboratory pattern: **normal or raised leucocyte count with neutrophilia** and thrombocytopenia.",
        "Transaminases raised **2-5 times** with a disproportionately raised alkaline phosphatase.",
        "Hypoalbuminaemia and hyponatraemia complete the pattern.",
        "This pattern with a negative malaria test should prompt a search for the eschar and empirical doxycycline.",
        "Dengue differs by leucopenia rather than leucocytosis, and no eschar.",
        "Leptospirosis differs by calf tenderness and jaundice out of proportion - same neutrophilia.",
        "Enteric fever differs by relative bradycardia and blood culture; malaria by the smear.",
        "Fever with lymphadenopathy: also consider infectious mononucleosis, HIV seroconversion and lymphoma.",
        "**Defervescence within 48 hours of doxycycline is itself diagnostic.**",
        "Fever beyond 72 hours on adequate doxycycline: doubt the diagnosis, suspect a complication, or consider a second infection.",
      ],
    },
    {
      heading: "Complications and severity",
      points: [
        "Complications appear in **10-30% of untreated or late-treated patients**, usually in the second week.",
        "Complications are caused by disseminated small-vessel vasculitis of lung, brain, kidney, heart and liver.",
        "**ARDS and interstitial pneumonitis are the leading cause of death.**",
        "Breathlessness, bilateral crepitations and falling saturation need oxygen, referral and IV therapy the same day.",
        "**Meningoencephalitis** presents with headache, altered sensorium, neck stiffness and seizures.",
        "CSF in meningoencephalitis: lymphocytic pleocytosis, mildly raised protein, normal or slightly low glucose.",
        "This CSF is mistaken for tuberculous or viral meningitis unless an eschar is found or the transaminases are noticed.",
        "**Acute kidney injury** arises from pre-renal loss, tubular injury and vasculitis.",
        "**Myocarditis** causes arrhythmia and hypotension; **hepatitis** is common.",
        "Disseminated intravascular coagulation, haemophagocytic lymphohistiocytosis and multi-organ dysfunction complete the list.",
        "In pregnancy scrub typhus causes miscarriage, preterm delivery and stillbirth.",
        "Untreated mortality is **6-35%** depending on strain and delay.",
        "With early doxycycline mortality is **under 2%** - time from first visit to first dose decides outcome.",
        "Admission markers: hypotension, hypoxia, altered sensorium, jaundice, bleeding.",
        "Also admit for oliguria or **creatinine above 2 mg/dL**, or platelets below 50,000 per cubic millimetre.",
        "Admit any patient who cannot take oral medication.",
      ],
    },
    {
      heading: "Diagnosis",
      points: [
        ...
        "Probable case = acute fever with an eschar, or with suggestive features in an endemic area. [DHR-ICMR 2015, Mandell 9e]",
        "Confirmed case = positive IgM ELISA, IFA or PCR. [DHR-ICMR 2015, Mandell 9e]",
        "**IgM ELISA on serum from day 5-7 onwards is the recommended test in India.** [DHR-ICMR 2015, Mandell 9e]",
        "Most laboratories use an IgM ELISA optical density cut-off of about **0.5**.",
        "IgM ELISA is positive in 85-90% by the second week; a fourfold rise in paired sera is confirmatory.",
        "IgM ELISA cannot distinguish recent past infection in a highly endemic area.",
        "**Indirect immunofluorescence assay (IFA) is the reference standard** - needs a fluorescence microscope and trained staff.",
        "IFA is available only at reference laboratories.",
        "**PCR for the 56 kDa type-specific antigen gene** on blood, buffy coat or, best of all, an eschar swab or biopsy.",
        "PCR is positive in the first week before antibodies appear - test of choice in the early or doxycycline-pretreated patient.",
        "**Weil-Felix** exploits cross-reacting Proteus antigens.",
        "OX-K agglutination at a titre of **1 in 80 or higher** suggests scrub typhus.",
        "OX-2 and OX-19 suggest the spotted fever group; OX-19 alone the typhus group.",
        "Weil-Felix is cheap and widely available but has **sensitivity of only 30-50%** and poor specificity.",
        "A negative Weil-Felix never excludes the disease; a positive one should be confirmed.",
        "Supporting tests: complete blood count, liver and renal function, electrolytes for hyponatraemia.",
        "Chest radiograph for interstitial infiltrates or effusion.",
        "Lumbar puncture, ECG and echocardiography as the clinical picture demands.",
        "Always run a malaria test and dengue serology alongside - co-infections occur.",
      ],
    },
    {
      heading: "Treatment: the DHR-ICMR regimens",
      points: [
        "**Doxycycline 100 mg PO twice daily for 7 days is the treatment of choice in adults.** [DHR-ICMR 2015, Mandell 9e]",
        "Doxycycline is cheap, safe and produces defervescence within **24-48 hours**.",
        "Children: doxycycline **4.5 mg/kg/day in two divided doses**. [DHR-ICMR 2015, Mandell 9e]",
        "Short doxycycline courses under 21 days do not stain teeth - permitted in children by DHR-ICMR and the American Academy of Pediatrics.",
        "**Pregnancy: azithromycin 500 mg once daily for 5 days** - also for those intolerant of tetracyclines. [DHR-ICMR 2015, Mandell 9e]",
        "Paediatric azithromycin dose: 10 mg/kg/day for 5 days.",
        "Chloramphenicol 500 mg four times daily for 7 days is a third option where neither is available.",
        "**Severe scrub typhus: IV doxycycline 100 mg twice daily or IV azithromycin 500 mg daily** until the patient can swallow.",
        "Then oral therapy to complete 7 days.",
        "**INTREST trial (Vellore, NEJM 2023): IV doxycycline plus azithromycin for 7 days beat either drug alone** in severe disease.",
        "Combination therapy is now widely used in the intensive care setting.",
        "Supportive care saves the complicated patient - oxygen and early ventilation for ARDS.",
        "Cautious crystalloids with vasopressors for shock; dialysis for acute kidney injury.",
        "Control seizures; correct hyponatraemia.",
        "Steroids have no proven role - except possibly in haemophagocytosis.",
        "**Empirical doxycycline is justified in acute undifferentiated fever in an endemic area with neutrophilia, thrombocytopenia and raised transaminases.**",
        "Empirical doxycycline also treats leptospirosis and the spotted fevers.",
        "The cost of a missed case is far greater than the cost of a week of doxycycline.",
        "Doxycycline counselling: take with a full glass of water and food; do not lie down for 30 minutes.",
        "Avoid antacids, iron and milk within 2 hours of the dose; use sun protection.",
        "Rifampicin is reserved for the rare doxycycline-unresponsive strain reported from Thailand - not first line in India.",
      ],
    },
    {
      heading: "Other rickettsial fevers and prevention",
      points: [
        "**Indian tick typhus (Rickettsia conorii subspecies indica)** belongs to the spotted fever group - transmitted by dog and cattle ticks.",
        "Indian tick typhus: fever with a maculopapular or petechial **rash involving the palms and soles**, sometimes a tache noire at the bite.",
        "Indian tick typhus is reported from Himachal Pradesh, Jammu, Maharashtra, Karnataka and Tamil Nadu - responds to doxycycline.",
        "**Murine (endemic) typhus (Rickettsia typhi)** is transmitted by the rat flea - milder fever with headache and rash.",
        "Murine typhus is reported from Tamil Nadu, Karnataka and Kashmir.",
        "**Epidemic typhus (Rickettsia prowazekii)** is louse-borne - follows overcrowding and war.",
        "Epidemic typhus can recrudesce decades later as **Brill-Zinsser disease**.",
        "Weil-Felix grouping: OX-K for scrub typhus, OX-2 with OX-19 for spotted fevers, OX-19 alone for the typhus group.",
        "**Doxycycline treats every rickettsial fever** - azithromycin is the alternative in pregnancy.",
        "**There is no vaccine for scrub typhus.**",
        "Personal protection: long sleeves and trousers tucked into socks, permethrin-treated clothing, DEET on exposed skin.",
        "Avoid sitting or lying on grass; bathe and change clothes after field work.",
        "Clear scrub vegetation and rodent harbourage around houses.",
        "**Chemoprophylaxis: doxycycline 200 mg PO once weekly** - start before entering a high-risk area, continue up to 6 weeks after leaving.",
        "Chemoprophylaxis prevents disease in soldiers and expedition workers - reserved for short intense exposures, not endemic residents.",
        "Notify cases through IDSP; alert the district surveillance officer to a cluster.",
        "One diagnosis should lower the threshold for empirical doxycycline in the next febrile patient from the same village.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Orientia tsutsugamushi** - antigenic strains Karp, Kato and Gilliam.",
            "The chigger of **Leptotrombidium deliense** is vector and reservoir - transovarial transmission; rodents are maintenance hosts.",
            "Post-monsoon and winter transmission, **August to January**.",
            "Exposure: scrub, grassland, plantations and paddy.",
            "Incubation **6-21 days**.",
            "Endemic in Tamil Nadu, Kerala, Karnataka, Himachal Pradesh, Uttarakhand, the North-East, Rajasthan and Maharashtra.",
            "Reported through IDSP.",
          ],
        },
        {
          heading: "2. Clinical features",
          points: [
            "Abrupt fever, severe headache, myalgia, conjunctival injection and generalised lymphadenopathy.",
            "Cough, abdominal pain and vomiting are common; hepatosplenomegaly in a third to a half.",
            "**Eschar**: painless black necrotic crust with erythematous halo, with tender regional nodes.",
            "Eschar sites: axilla, groin, perineum, under the breast or behind the ear - found in **10-50%** when searched for.",
            "Maculopapular truncal rash in a minority around day 5-7.",
            "Laboratory pattern: **neutrophil leucocytosis**, thrombocytopenia, transaminases 2-5 times normal.",
            "Raised alkaline phosphatase, hypoalbuminaemia and hyponatraemia.",
          ],
        },
        {
          heading: "3. Complications",
          points: [
            "Second-week vasculitic complications occur in **10-30%** of untreated patients.",
            "**ARDS and pneumonitis** are the leading cause of death.",
            "Meningoencephalitis with lymphocytic CSF; acute kidney injury; myocarditis; hepatitis.",
            "DIC, haemophagocytosis and multi-organ failure.",
            "Pregnancy loss, preterm birth and stillbirth.",
            "Untreated mortality **6-35%**; under 2% with early treatment.",
          ],
        },
        {
          heading: "4. Diagnosis",
          points: [
            "Clinical diagnosis with immediate treatment. [DHR-ICMR 2015, Mandell 9e]",
            "Probable case = fever with eschar, or suggestive features in an endemic area. [DHR-ICMR 2015, Mandell 9e]",
            "**IgM ELISA from day 5-7** is the recommended test in India. [DHR-ICMR 2015, Mandell 9e]",
            "IFA is the reference standard.",
            "PCR for the **56 kDa gene** on blood or eschar in the first week.",
            "Weil-Felix OX-K **1 in 80 or more** is supportive but insensitive.",
            "Run a malaria test and dengue serology in parallel.",
            "Chest radiograph, liver and renal function, electrolytes.",
          ],
        },
        {
          heading: "5. Management",
          points: [
            "**Doxycycline 100 mg twice daily for 7 days**; children 4.5 mg/kg/day in two divided doses. [DHR-ICMR 2015, Mandell 9e]",
            "Pregnancy: **azithromycin 500 mg daily for 5 days**; chloramphenicol as third option.",
            "Severe disease: **IV doxycycline plus IV azithromycin for 7 days** (INTREST trial).",
            "Severe disease support: oxygen, ventilation, cautious fluids, vasopressors, dialysis as needed.",
            "Expect defervescence in **48 hours**; re-evaluate if fever persists beyond 72 hours.",
            "Prevention: protective clothing, permethrin, DEET, avoiding grass.",
            "**Doxycycline 200 mg weekly** chemoprophylaxis for short high-risk exposures.",
            "No vaccine; notify through IDSP.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Serum is tested for agglutination of three Proteus strains.",
            "Significant = single titre of **1 in 80 or more**, or a fourfold rise in paired sera 7-10 days apart.",
            "**OX-K** agglutination suggests scrub typhus.",
            "OX-2 and OX-19 suggest the spotted fever group (Indian tick typhus).",
            "OX-19 alone suggests the typhus group (epidemic and murine typhus).",
            "Antibodies appear at the end of the first week - the test is negative early.",
            "False positives: Proteus urinary infection, leptospirosis, brucellosis and liver disease.",
          ],
        },
        {
          heading: "Limitations",
          points: [
            "Sensitivity **30-50%** and specificity poor.",
            "A negative test never excludes rickettsial disease.",
            "A positive test should be confirmed by a specific test where possible.",
        ...
        },
        {
          ...
          points: [
            "**IgM ELISA from day 5-7** is the recommended test in India for scrub typhus and spotted fever. [DHR-ICMR 2015, Mandell 9e]",
            "Indirect immunofluorescence is the reference standard.",
            "PCR on blood or eschar detects infection in the first week.",
            ...
            "Therapeutic test: **defervescence within 48 hours of doxycycline** - the most useful confirmation in a district hospital.",
          ],
        },
      ],
