  ...
  sections: [
    {
      ...
      points: [
        ...
        "Malaria persists in **Odisha, Jharkhand, Chhattisgarh and the North-East**. [NVBDCP 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "Day of illness fixes when the dengue critical phase is due, on **day 4-6**, and whether a negative serology means anything. [WHO 2023]",
        ...
        "Alternate-day tertian paroxysms with rigors and sweating suggest **vivax malaria**. [NVBDCP 2024]",
        "A saddleback biphasic fever curve suggests **dengue**. [WHO 2023]",
        ...
        "**Severe crippling small-joint pain** points to chikungunya. [NVBDCP 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "Narrow pulse pressure of **20 mmHg or less** on day 4-6 of fever is dengue shock until proved otherwise. [WHO 2023]",
        ...
        "A flushed face with a positive tourniquet test suggests **dengue**. [WHO 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "Day 1-4: malaria rapid diagnostic test plus **thick and thin smear**, and dengue NS1 antigen. [NVBDCP 2024]",
        ...
        "An IgM sent **before day 5** wastes the sample and returns a falsely reassuring negative. [WHO 2023]",
        ...
        "Transaminases of **100-500 U/L** with normal or near-normal bilirubin fit dengue, scrub typhus and enteric fever. [WHO 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Fever with rash in dengue:** a macular blanching rash, then islands of white in a sea of red. [WHO 2023]",
        "Fever with rash also covers **chikungunya, measles and rubella**. [NVBDCP 2024]",
        ...
        "**Fever with altered sensorium:** cerebral malaria, meningitis and encephalitis including Japanese encephalitis. [NVBDCP 2024]",
    ...
    },
    {
      ...
      points: [
        ...
        "Add **intravenous artesunate** if a smear or rapid test is positive for falciparum malaria. [NVBDCP 2024]",
        "Safety-net in writing: return at once for bleeding, black stools, severe abdominal pain or persistent vomiting. [WHO 2023]",
        "Return at once for breathlessness, reduced urine output, cold extremities, drowsiness or fever persisting beyond **day 5**. [WHO 2023]",
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "First line: malaria rapid diagnostic test with **thick and thin smear**. [NVBDCP 2024]",
            "First line: dengue **NS1 if within day 5**, plus urine routine. [WHO 2023]",
            ...
            "Ultrasound abdomen for splenomegaly, **gall bladder wall oedema**, ascites or a liver abscess. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "**NSAIDs and aspirin are prohibited until dengue is excluded**. [WHO 2023]",
            "Malaria: artemisinin combination therapy, or **intravenous artesunate** if severe. [NVBDCP 2024]",
            "Scrub typhus and leptospirosis: **doxycycline**. [ICMR 2022]",
            "Enteric fever: **azithromycin or ceftriaxone**. [ICMR 2022]",
            "Dengue: **supportive fluid therapy**, no antiviral and no antibiotic. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            "Review daily through the critical window of **days 3-7**. [WHO 2023]",
            "Repeat the platelet count and haematocrit daily wherever dengue is suspected. [WHO 2023]",
            "Written warning signs: bleeding, black stools, severe abdominal pain, persistent vomiting. [WHO 2023]",
            "Written warning signs: breathlessness, cold extremities, reduced urine, drowsiness, and worsening as the fever settles. [WHO 2023]",
            "Notify dengue, malaria and any cluster of fevers under the **Integrated Disease Surveillance Programme**. [IDSP 2024]",
            "Give source reduction advice for **Aedes** breeding and for rodent control. [NVBDCP 2024]",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Less common infective: chikungunya, and **Kyasanur forest disease in the Western Ghats**. [NVBDCP 2024]",
        ...
        },
        {
          ...
          points: [
            ...
            "Rigors with splenomegaly and a haemolytic picture suggest **malaria**. [NVBDCP 2024]",
            "Step-ladder fever with relative bradycardia suggests **enteric fever**. [API 2019]",
            "Rising haematocrit with a falling platelet count around defervescence is **dengue plasma leakage**. [WHO 2023]",
            "Ascites or a pleural effusion on ultrasound confirms dengue plasma leakage. [WHO 2023]",
        ...
        },
        {
          ...
          points: [
            "Send a complete blood count with peripheral smear and a **haematocrit trend**. [WHO 2023]",
            "Send a malaria RDT and smear, with dengue **NS1 or IgM chosen by the day of illness**. [NVBDCP 2024]",
            ...
            "Malaria: **artemisinin combination therapy**, or artesunate if severe. [NVBDCP 2024]",
            "Rickettsial and leptospiral disease: **doxycycline**; enteric fever: ceftriaxone or azithromycin. [ICMR 2022]",
            "Dengue: **crystalloid guided by the haematocrit**. [WHO 2023]",
            "**Do not transfuse platelets on a count alone** - transfuse for clinically significant bleeding. [WHO 2023]",
            "Prophylactic platelets only below **10,000 per cubic millimetre**, or below 20,000 with a bleeding risk factor. [WHO 2023]",
            "Avoid NSAIDs, aspirin, intramuscular injections and invasive procedures while the count is low. [WHO 2023]",
          ],
        },
      ],
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "Paracetamol and oral fluids, **no NSAIDs**, and daily review through days 3-7. [WHO 2023]",
