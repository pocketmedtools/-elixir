  ...
  sections: [
    {
      ...
      points: [
        "**NACO Strategy III**: three rapid or ELISA tests (A1, A2, A3) using three different antigen preparations or test principles. [NACO 2021]",
        "Three different principles ensure **no two tests share the same false-positive tendency**.",
        "**Reactive on all three = HIV positive**; non-reactive on A1 = reported negative. [NACO 2021]",
        "Reactive on A1 but non-reactive on A2 and A3 = **negative**. [NACO 2021]",
        ...
        "Testing is **free, voluntary and confidential** at an Integrated Counselling and Testing Centre, with pre-test information and post-test counselling. [NACO 2021]",
        "**HIV/AIDS Act 2017 makes written informed consent mandatory** for testing. [HIV/AIDS Act 2017]",
        "Consent exceptions: **court-ordered testing, screening of donated blood, organs, tissue and semen**, anonymised epidemiological research. [HIV/AIDS Act 2017]",
        "**Never test for HIV as a routine add-on to a preoperative panel** without consent.",
        "Window period = interval between infection and a detectable test result.",
        "Window: **3-12 weeks for a third-generation antibody test**.",
        "Window: **2-4 weeks for a fourth-generation antigen-antibody assay** (also detects p24).",
        "Window: **10-14 days for a nucleic acid test**.",
        "A negative test within the window does not exclude infection - **retest at 6 weeks and 3 months** after a defined exposure.",
        "Fourth-generation assays are the standard laboratory test in India, but **most field-level rapid kits remain antibody-only**.",
        "Nucleic acid testing (qualitative DNA-PCR or quantitative RNA) has **four uses**: the infant under 18 months is the first. [NACO 2021]",
        "NAT use 2 and 3: **suspected acute seroconversion with a negative or indeterminate antibody test**, and an indeterminate result that will not resolve.",
        "NAT use 4: **monitoring the diagnosed patient on treatment** (viral load).",
        "NAT is **not a population screening test** - cost and the risk of low-level false positives.",
        "**Maternal IgG persists in the uninfected infant for up to 18 months** - an antibody test tells you the mother's status, not the child's.",
        "Diagnosis before 18 months requires **DNA-PCR on a dried blood spot**. [NACO 2021]",
        "NACO early infant diagnosis: test every HIV-exposed infant at **6 weeks** (or at first contact thereafter). [NACO 2021]",
        "Repeat EID testing at **6 months and 12 months**, and 6 weeks after complete cessation of breastfeeding. [NACO 2021]",
        "**Confirmatory antibody test at 18 months**. [NACO 2021]",
        ...
        "Untreated vertically infected infants have **about 30% mortality by one year**.",
        "A negative DNA-PCR in a breastfed infant excludes infection only up to that point - **keep testing while breastfeeding continues and for 6 weeks after it stops**.",
        "**Acute HIV (seroconversion illness)**: glandular-fever-like picture at 2-6 weeks after exposure.",
        "Seroconversion features: fever, pharyngitis, generalised lymphadenopathy, **maculopapular rash**, oral or genital ulcers, headache, sometimes aseptic meningitis.",
        "In acute HIV the viral load is very high, **transmission risk is at its peak**, and the antibody test may still be negative.",
        "**Think of HIV in any young adult with a mononucleosis-like illness and a negative Monospot** - send a fourth-generation assay or a viral load.",
      ],
    },
    {
      heading: "WHO clinical staging - adults and adolescents, and separately children",
      points: [
        "**WHO clinical staging (2007 revision)** classifies established HIV infection into four stages on clinical grounds alone. [NACO 2021]",
        "Staging allows a decision **where CD4 counting is not available**, defines advanced HIV disease, prioritises care and decides prophylaxis.",
        "**Once a person reaches a higher stage they do not move back down**, even if they improve on treatment. [NACO 2021]",
        "**Adults, Stage 1 (asymptomatic)**: asymptomatic infection, or persistent generalised lymphadenopathy. [NACO 2021]",
        "PGL = nodes **1 cm or larger at two or more extra-inguinal sites for more than 3 months**.",
        "**Adults, Stage 2 (mild)**: unexplained weight loss under 10%; recurrent upper respiratory infections (sinusitis, tonsillitis, otitis media, pharyngitis). [NACO 2021]",
        "Adults, Stage 2 also: **herpes zoster, angular cheilitis, recurrent oral ulceration**, papular pruritic eruption, seborrhoeic dermatitis, fungal nail infections.",
        ...
        "Adults, Stage 3 also: **persistent oral candidiasis, oral hairy leukoplakia, pulmonary tuberculosis**.",
        "Adults, Stage 3 also: severe bacterial infection - **pneumonia, empyema, pyomyositis, bone or joint infection, meningitis, bacteraemia**.",
        "Adults, Stage 3 also: acute necrotising ulcerative gingivitis, stomatitis or periodontitis.",
        "Adults, Stage 3 haematology: **unexplained anaemia under 8 g/dL, neutropenia under 500 per cubic millimetre, chronic thrombocytopenia under 50,000**.",
        "**Adults, Stage 4 (severe, AIDS-defining)**: HIV wasting syndrome; Pneumocystis jirovecii pneumonia; recurrent severe bacterial pneumonia. [NACO 2021]",
        "Adults, Stage 4: chronic herpes simplex - **orolabial, genital or anorectal over 1 month, or visceral**; oesophageal or tracheobronchial candidiasis.",
        "Adults, Stage 4: **extrapulmonary tuberculosis; Kaposi sarcoma**; cytomegalovirus retinitis or other organ disease.",
        "Adults, Stage 4: **cerebral toxoplasmosis; HIV encephalopathy**; extrapulmonary cryptococcosis including meningitis.",
        "Adults, Stage 4: disseminated non-tuberculous mycobacterial infection; **progressive multifocal leukoencephalopathy**; chronic cryptosporidiosis or isosporiasis.",
        "Adults, Stage 4: disseminated mycosis (histoplasmosis, coccidioidomycosis); **recurrent septicaemia including non-typhoidal Salmonella**.",
        "Adults, Stage 4: **lymphoma; invasive cervical carcinoma**; atypical disseminated leishmaniasis.",
        "Adults, Stage 4: symptomatic **HIV-associated nephropathy or cardiomyopathy**.",
        "**Children under 15, Stage 1**: asymptomatic; persistent generalised lymphadenopathy. [NACO 2021]",
        "**Children, Stage 2**: unexplained persistent hepatosplenomegaly; papular pruritic eruption; extensive wart virus infection; extensive molluscum contagiosum. [NACO 2021]",
        "Children, Stage 2 also: recurrent oral ulceration; **unexplained persistent parotid enlargement**; linear gingival erythema; herpes zoster.",
        "Children, Stage 2 also: recurrent or chronic upper respiratory infections (**otitis media, otorrhoea, sinusitis, tonsillitis**); fungal nail infections.",
        "**Children, Stage 3**: unexplained moderate malnutrition not responding to standard therapy; unexplained persistent diarrhoea of 14 days or more. [NACO 2021]",
        "Children, Stage 3: unexplained persistent **fever above 37.5 degrees C for more than 1 month**; persistent oral candidiasis after the first 6-8 weeks of life.",
        "Children, Stage 3: oral hairy leukoplakia; acute necrotising ulcerative gingivitis or periodontitis; **lymph node tuberculosis; pulmonary tuberculosis**.",
        "Children, Stage 3: severe recurrent bacterial pneumonia; **symptomatic lymphoid interstitial pneumonitis**; chronic HIV-associated lung disease including bronchiectasis.",
        "Children, Stage 3 haematology: **unexplained anaemia under 8 g/dL, neutropenia under 500, chronic thrombocytopenia under 50,000**.",
        "**Children, Stage 4**: unexplained severe wasting, stunting or severe malnutrition not responding to therapy; Pneumocystis pneumonia. [NACO 2021]",
        "Children, Stage 4: recurrent severe bacterial infection - **empyema, pyomyositis, bone or joint infection, meningitis**.",
        "Children, Stage 4: chronic herpes simplex; **oesophageal candidiasis**; extrapulmonary or disseminated tuberculosis; Kaposi sarcoma.",
        "Children, Stage 4: **cytomegalovirus disease with onset after 1 month of age**; cerebral toxoplasmosis after the neonatal period.",
        "Children, Stage 4: extrapulmonary cryptococcosis including meningitis; **HIV encephalopathy**; disseminated endemic mycosis.",
        "Children, Stage 4: chronic cryptosporidiosis or isosporiasis; disseminated non-tuberculous mycobacteria; **cerebral or B-cell non-Hodgkin lymphoma**.",
        "Children, Stage 4: progressive multifocal leukoencephalopathy; symptomatic **HIV-associated nephropathy or cardiomyopathy**.",
      ],
    },
    {
      ...
      points: [
        ...
        "**Same-day start**: ART begins on the day of diagnosis or within 7 days once the patient is ready. [NACO 2021]",
        ...
        "**START and TEMPRANO trials** established that immediate ART reduces both AIDS and non-AIDS morbidity.",
        "**First-line adult and adolescent regimen: tenofovir 300 mg + lamivudine 300 mg + dolutegravir 50 mg (TLD)** as one fixed-dose tablet once daily. [NACO 2021]",
        ...
        "**TLE (efavirenz 400 mg)** remains the alternative where dolutegravir cannot be used. [NACO 2021]",
        "**Zidovudine or abacavir replaces tenofovir when creatinine clearance is under 50 mL/min**. [NACO 2021]",
        "**Children are dosed by weight band from the NACO paediatric chart** - never by an adult tablet broken in half. [NACO 2021]",
        "Paediatric first line (at least 3 kg and 4 weeks or more): **abacavir + lamivudine + paediatric dispersible dolutegravir 10 mg**. [NACO 2021]",
        "Dolutegravir by weight: **about 5 mg for 3 to under 6 kg**, 15 mg for 6 to under 10 kg, 20 mg for 10 to under 14 kg. [NACO 2021]",
        "Dolutegravir by weight: **25 mg for 14 to under 20 kg**, 30 mg for 20 to under 25 kg, adult 50 mg tablet at 25 kg and above. [NACO 2021]",
        "Neonates under 4 weeks: **zidovudine + lamivudine with nevirapine or raltegravir** until dolutegravir can be started. [NACO 2021]",
        "**Re-check the dose at every weight gain** - under-dosing a growing child is the commonest cause of paediatric treatment failure.",
        "**Monitoring is by viral load, not CD4**: plasma viral load at 6 months after starting ART, at 12 months, then annually. [NACO 2021]",
        "An **extra viral load whenever failure is suspected**. [NACO 2021]",
        ...
        "Drug monitoring: **creatinine at baseline and 6-12 months on tenofovir**; haemoglobin on zidovudine; blood glucose and weight on dolutegravir.",
        "**Virological failure = viral load above 1000 copies/mL on two consecutive samples at least 3 months apart**, with enhanced adherence counselling between. [NACO 2021]",
        "A single raised viral load is **far more often non-adherence than resistance**.",
        ...
        "Second-line backbone: an **optimised nucleoside pair such as zidovudine + lamivudine**. [NACO 2021]",
        "**Third line** is decided by a state or national expert committee with genotypic resistance testing. [NACO 2021]",
        "**Adherence above 95% is the single determinant of success**.",
        "Assess adherence at every visit by **pill count, pharmacy refill date and open questions**.",
        "Name the barriers: **side effects, alcohol, stigma, migration for work**, cost of travel, depression, disclosure.",
        "Support: a **treatment supporter**, doses linked to a daily routine, the Link ART centre nearest home.",
        "**Loss to follow-up is tracked actively** by the ART centre.",
        "Tenofovir: **renal tubular dysfunction and reduced bone mineral density**.",
        "Zidovudine: **anaemia, neutropenia, lipoatrophy and myopathy**.",
        "Abacavir: **hypersensitivity reaction** (HLA-B*5701, rarely tested in India) - counsel and never rechallenge.",
        "Efavirenz: **vivid dreams, insomnia, dizziness and depression**.",
        "Nevirapine: **hepatitis and severe rash** including Stevens-Johnson syndrome.",
        "Dolutegravir: **insomnia, headache, weight gain and hyperglycaemia**.",
        "**Stopping tenofovir or lamivudine abruptly in hepatitis B co-infection can cause a fatal hepatitis flare**.",
      ],
    },
    {
      ...
      points: [
        ...
        "Doubling = **an extra dolutegravir 50 mg tablet 12 hours after the fixed-dose combination**. [NACO 2021]",
        "Continue the extra dolutegravir **throughout rifampicin and for 2 weeks after it stops**. [NACO 2021]",
        "This is the **most commonly asked HIV drug interaction** and the commonest real-world prescribing error in general practice.",
        "**Multivalent cations chelate integrase inhibitors**: aluminium, magnesium and calcium antacids, calcium, iron, zinc and multivitamins cut dolutegravir absorption substantially.",
        "Give dolutegravir **2 hours before or 6 hours after** the antacid or supplement, or take the supplement with food, which blunts the effect.",
        "Rifampicin drops protease inhibitor levels so far that **rifabutin must be substituted**.",
        "**Carbamazepine, phenytoin, phenobarbitone and St John's wort** lower dolutegravir and protease inhibitor levels.",
        "**Dolutegravir raises metformin levels - cap metformin at about 1000 mg a day** and monitor.",
        "Efavirenz reduces the efficacy of **hormonal implants and some oral contraceptives**; dolutegravir does not.",
        "Once-weekly rifapentine for TB preventive therapy can be given with **standard-dose dolutegravir** (DOLPHIN study), unlike daily rifampicin.",
        "**IRIS = paradoxical worsening or unmasking of an infection 2-12 weeks after starting ART** - the recovering immune system reacts to residual antigen.",
        "IRIS is **not treatment failure and not a reason to stop ART**.",
        "IRIS risk is highest with **baseline CD4 under 50**, a very high viral load, disseminated infection, and a short OI-treatment-to-ART interval.",
        "Infections that most often flare: **tuberculosis** (new nodes, worsening infiltrates, fever) and cryptococcal meningitis (raised intracranial pressure).",
        "Also flare: **cytomegalovirus retinitis, herpes zoster, Kaposi sarcoma** and progressive multifocal leukoencephalopathy.",
        "IRIS management: **continue ART**, continue or start treatment of the underlying infection, give an anti-inflammatory.",
        "TB-IRIS: add **prednisolone 1-1.5 mg/kg tapered over 2-4 weeks**.",
        "Cryptococcal IRIS: **repeat lumbar punctures for pressure**; drain or aspirate collections.",
        "HIV-TB timing: start ATT first, add ART **within 2 weeks if CD4 is under 50, within 8 weeks otherwise**. [NACO 2021]",
        "Tuberculous meningitis: **delay ART to 4-8 weeks**. [NACO 2021]",
        ...
        "Counsel: ART is **lifelong, not a cure**, and does not clear the reservoir.",
        "Counsel: stopping causes **viral rebound within weeks** and risks resistance.",
        "Counsel: the drug is **free at government ART centres**; transfer-out to another centre is arranged so doses are never missed.",
        "Counsel: **generic Indian tablets are the same molecules** used worldwide.",
      ],
    },
    {
      heading: "Opportunistic infections, co-infections and prophylaxis",
      points: [
        "**Cotrimoxazole preventive therapy: one double-strength tablet (sulphamethoxazole 800 mg + trimethoprim 160 mg) daily**. [NACO 2021]",
        "Start CPT in adults with **CD4 under 350 per cubic millimetre or WHO stage 3 or 4**. [NACO 2021]",
        "Start CPT in **every HIV-tuberculosis co-infected patient regardless of CD4**. [NACO 2021]",
        "CPT prevents **Pneumocystis pneumonia, cerebral toxoplasmosis, isosporiasis**, some bacterial diarrhoeas and malaria - and reduces mortality independently of ART.",
        "**Stop CPT when CD4 has been above 350 on two readings at least 6 months apart on ART**; restart if the count falls again. [NACO 2021]",
        "Every HIV-exposed infant takes CPT **from 6 weeks of age until HIV is excluded and breastfeeding has ended**. [NACO 2021]",
        "Every infected child **under 5 years takes CPT regardless of CD4**; above 5 years the adult rule applies. [NACO 2021]",
        "CPT toxicity: watch for **rash, cytopenias and hyperkalaemia**.",
        ...
        "**Screen for TB at every visit with the four-symptom screen**: current cough, fever, weight loss, night sweats. [NACO 2021]",
        "In a child add **poor weight gain and contact history** to the TB screen.",
        "Any symptom present: **Xpert MTB/RIF (CBNAAT)** on sputum or appropriate specimen, plus a chest radiograph. [NTEP 2023]",
        ...
        "TPT alternative: **once-weekly rifapentine with isoniazid for 12 weeks (3HP)** where the NTEP supplies it. [NTEP 2023]",
        ...
        "Antigen positive: **lumbar puncture to exclude meningitis**.",
        "Antigen positive, no meningitis: pre-emptive **fluconazole 800 mg daily for 2 weeks, then 400 mg for 8 weeks, then 200 mg until immune recovery**. [WHO 2022]",
        "WHO-preferred cryptococcal meningitis induction: **single high-dose liposomal amphotericin B 10 mg/kg** with flucytosine and fluconazole. [WHO 2022]",
        "Flucytosine and liposomal amphotericin are not reliably available in India - **amphotericin B deoxycholate 0.7-1 mg/kg plus fluconazole 1200 mg** is the usual induction.",
        "Cryptococcal meningitis: **therapeutic lumbar punctures for raised pressure**.",
        "**Test every patient for HBsAg and anti-HCV antibody at diagnosis**. [NACO 2021]",
        ...
        "Never give **lamivudine as the only anti-hepatitis B drug**, and never stop it abruptly.",
        "Hepatitis C is cured with **sofosbuvir plus velpatasvir or daclatasvir**, free under the National Viral Hepatitis Control Programme.",
        "Check for **interactions before combining DAAs with a protease inhibitor**.",
        "CD4 above 500: the same illnesses as anyone else plus **tuberculosis, bacterial pneumonia and herpes zoster**.",
        "CD4 200-500: **oral candidiasis, oral hairy leukoplakia, pulmonary tuberculosis**, Kaposi sarcoma, recurrent bacterial pneumonia.",
        "CD4 under 200: **Pneumocystis pneumonia, oesophageal candidiasis**, disseminated or extrapulmonary tuberculosis.",
        "CD4 under 100: **cerebral toxoplasmosis, cryptococcal meningitis**, chronic cryptosporidiosis, HIV wasting.",
        "CD4 under 50: **cytomegalovirus retinitis, disseminated Mycobacterium avium complex** and primary CNS lymphoma.",
        "Vaccinate: **hepatitis B if not immune** (double dose schedule if CD4 is low), pneumococcal, annual influenza, HPV where affordable.",
        ...
        "Live vaccines: **BCG avoided in symptomatic infants**; yellow fever only after risk assessment.",
      ],
    },
    {
      ...
      points: [
        ...
        "Splashed eye or mucosa: **flush with plenty of water or saline**, contact lenses removed.",
        "Then assess the exposure, take consent and counsel - **the assessment must not delay the first dose**.",
        "Risk assessment has **two arms: the exposure and the source**.",
        "High-risk exposure: **deep injury, hollow-bore needle, visible blood on the device**, a needle from the source's artery or vein, large-volume mucosal splash.",
        "Low-risk exposure: **solid suture needle, superficial scratch, small splash**.",
        "**No risk, no prophylaxis**: intact skin contact, or urine, faeces, sweat, tears, saliva or vomitus without visible blood.",
