  ...
  sections: [
    {
      ...
      points: [
        "Acute undifferentiated fever: a febrile illness under **14 days** in which history, examination and bedside tests fail to localise the infection. [ICMR 2022]",
        "It is a working label, not a diagnosis - a specific cause must replace it within **5-7 days**. [ICMR 2022]",
        "Accounts for **20-40% of outpatient attendances** in Indian general practice during and after the monsoon. [ICMR 2022]",
        "Drives a large share of medical admissions between **July and November** - the post-monsoon peak. [ICMR 2022]",
        "Five diagnoses carry almost all the mortality: **malaria, dengue, scrub typhus, enteric fever and leptospirosis**. [ICMR 2022]",
        "These five plus influenza account for **60-70%** of cases in which an aetiology is established. [ICMR 2022]",
        "**30-40% stay undiagnosed** even in good laboratories - a negative panel does not exclude a treatable cause. [ICMR 2022]",
        "Scrub typhus dominates the **sub-Himalayan belt, Tamil Nadu, Puducherry and Rajasthan**. [ICMR 2022]",
        "Leptospirosis dominates **coastal Kerala, Gujarat, Maharashtra, the Andamans** and post-flood settings. [ICMR 2022]",
        "Malaria persists in **Odisha, Jharkhand, Chhattisgarh and the North-East**. [NVBDCP MoHFW]",
        "Commonest single error: treating every fever with a **third-generation cephalosporin** - it covers none of the top three tropical causes. [ICMR 2022]",
        "Blind cephalosporin drives resistance and delays the doxycycline or artesunate that would have worked. [ICMR 2022]",
        "Fever with bleeding, breathlessness, altered sensorium, oliguria, hypotension or jaundice is no longer undifferentiated - triage it as an emergency. [ICMR 2022]",
      ],
    },
    {
      heading: "History: the questions that narrow the field",
      points: [
        "**Day of illness is the most important single number in the history** - it decides which test will be positive. [ICMR 2022]",
        "Day of illness fixes when the dengue critical phase is due, on **day 4-6**, and whether a negative serology means anything. [WHO 2009]",
        "Record the day of illness on every prescription - the next clinician cannot re-date the fever. [ICMR 2022]",
        "Step-ladder continuous fever with relative bradycardia suggests **enteric fever**. [API 2019]",
        "Alternate-day tertian paroxysms with rigors and sweating suggest **vivax malaria**. [NVBDCP MoHFW]",
        "A saddleback biphasic fever curve suggests **dengue**. [WHO 2009]",
        "Exposure history: travel in the last **1 month**, forest or plantation visit, wading through flood water or paddy fields. [ICMR 2022]",
        "Ask about contact with rodents or cattle, mosquito exposure, raw milk and street food. [ICMR 2022]",
        "Ask about unprotected sex, injections or transfusions, and any animal bite or scratch. [ICMR 2022]",
        "**Retro-orbital pain with severe myalgia** points to dengue - a one-question shortcut to the diagnosis. [WHO 2009]",
        "**Calf tenderness with red eyes** points to leptospirosis. [ICMR 2022]",
        "**An unnoticed painless scab** points to a scrub typhus eschar. [ICMR 2022]",
        "**Severe crippling small-joint pain** points to chikungunya. [NVBDCP MoHFW]",
        "Partial antibiotic or antimalarial self-treatment blunts the classical picture and turns cultures negative. [ICMR 2022]",
        "Drug fever is itself a diagnosis - take a drug history in every undifferentiated fever. [API 2019]",
        "Ask every woman of reproductive age for the last menstrual period - pregnancy changes both the risk and the drug. [ICMR 2022]",
        "Ask about tuberculosis contact and weight loss - a fever lasting **2 weeks** is where undiagnosed TB and HIV surface. [API 2019]",
      ],
    },
    {
      heading: "Examination: the signs that decide",
      points: [
        "Vital signs first: temperature, pulse, respiratory rate, blood pressure with postural drop, capillary refill and oxygen saturation. [ICMR 2022]",
        "Narrow pulse pressure of **20 mmHg or less** on day 4-6 of fever is dengue shock until proved otherwise. [WHO 2009]",
        "**Relative bradycardia (Faget sign)**: pulse rises less than 10 beats per minute for each 1 degree F of temperature. [API 2019]",
        "Faget sign points to enteric fever, brucellosis, leptospirosis and drug fever rather than to pyogenic sepsis. [API 2019]",
        "Search for an **eschar** in the axillae, groin, perineum, under the breasts, behind the ears and in the natal cleft. [ICMR 2022]",
        "The scrub typhus eschar is painless and black-crusted with an erythematous halo - missed in every patient not undressed. [ICMR 2022]",
        "Conjunctival suffusion without discharge suggests **leptospirosis**. [ICMR 2022]",
        "A flushed face with a positive tourniquet test suggests **dengue**. [WHO 2009]",
        "Splenomegaly points to **malaria, enteric fever, kala-azar or infective endocarditis**. [API 2019]",
        "Generalised lymphadenopathy points to **scrub typhus, HIV or lymphoma**. [API 2019]",
        "Examine for meningism, chest signs, abdominal tenderness, hepatosplenomegaly, murmurs and the perineum or genitalia. [ICMR 2022]",
        "Four commonest hidden foci: the **urinary tract**, the perineum and anorectum, the teeth and sinuses, and an intra-abdominal collection. [ICMR 2022]",
        "Repeat the examination daily - the eschar, rash, splenic tip or murmur often appears on **day 5**, not day 1. [ICMR 2022]",
      ],
    },
    {
      heading: "First-line investigations and what each result changes",
      points: [
        "**Day 1-4 panel:** complete blood count with platelet count and haematocrit, plus urine routine. [ICMR 2022]",
        "Day 1-4: malaria rapid diagnostic test plus **thick and thin smear**, and dengue NS1 antigen. [NVBDCP MoHFW]",
        "Day 1-4: **two sets of blood culture before any antibiotic** - a single set roughly halves the yield. [ICMR 2022]",
        "**Day 5 onwards add** dengue IgM MAC-ELISA, scrub typhus IgM ELISA, leptospira IgM ELISA and a repeat blood culture. [ICMR 2022]",
        "An IgM sent **before day 5** wastes the sample and returns a falsely reassuring negative. [WHO 2009]",
        "The **haemogram** is the cheapest discriminator in an undifferentiated fever. [ICMR 2022]",
        "Leucopenia with thrombocytopenia suggests **dengue, malaria or enteric fever**. [ICMR 2022]",
        "Leucocytosis with neutrophilia suggests **leptospirosis, scrub typhus, a pyogenic focus or amoebic liver abscess**. [API 2019]",
        "Eosinophilia suggests a **parasite or a drug reaction**. [API 2019]",
        "Add liver and renal function and a chest radiograph in anyone unwell, hypoxic or febrile beyond **7 days**. [ICMR 2022]",
        "Transaminases of **100-500 U/L** with normal or near-normal bilirubin fit dengue, scrub typhus and enteric fever. [WHO 2009]",
        "Bilirubin far out of proportion to transaminases suggests **leptospirosis or falciparum malaria**. [API 2019]",
        "**A single Widal test is not a diagnosis of enteric fever** in an endemic country. [ICMR 2022]",
        "Widal turns positive from past infection, vaccination and cross-reaction, and is negative in the **first week** of true disease. [ICMR 2022]",
        "**Blood culture** is the test that counts in enteric fever. [ICMR 2022]",
        "Think population as well as patient - look for a cluster of cases and ask what neighbouring households have. [IDSP MoHFW]",
        "Report fever clusters under the **Integrated Disease Surveillance Programme** - surveillance often makes the diagnosis before the laboratory. [IDSP MoHFW]",
      ],
    },
    {
      heading: "Syndromic pattern recognition",
      points: [
        "**Fever with thrombocytopenia:** dengue, malaria, scrub typhus, leptospirosis, enteric fever and sepsis. [ICMR 2022]",
        "Chronic fever with thrombocytopenia: **kala-azar and haematological disease**. [API 2019]",
        "Fever with thrombocytopenia is the commonest tropical syndrome and the one every examiner asks. [ICMR 2022]",
        "**Fever with rash in dengue:** a macular blanching rash, then islands of white in a sea of red. [WHO 2009]",
        "Fever with rash also covers **chikungunya, measles and rubella**. [NVBDCP MoHFW]",
        "Rickettsial spotted fevers give a rash **involving the palms and soles**. [ICMR 2022]",
        "Enteric fever gives **rose spots**; meningococcaemia gives a purpuric rash and is an emergency. [API 2019]",
        "Drug rash completes the fever-with-rash list - stop the suspect drug before adding another. [API 2019]",
        "**Fever with jaundice:** malaria, leptospirosis, viral hepatitis A and E, enteric fever, dengue hepatitis, cholangitis and liver abscess. [API 2019]",
        "Febrile jaundice with a tender liver and a swinging fever is an **amoebic liver abscess** until imaged. [API 2019]",
        "**Fever with altered sensorium:** cerebral malaria, meningitis and encephalitis including Japanese encephalitis. [NVBDCP MoHFW]",
        "Altered sensorium also fits **scrub typhus meningoencephalitis and enteric encephalopathy**. [ICMR 2022]",
        "Metabolic causes of febrile confusion: **hypoglycaemia and hyponatraemia**. [API 2019]",
        "Do a **capillary glucose before anything else** in a febrile patient with altered sensorium. [API 2019]",
        "**Fever with arthralgia:** chikungunya, dengue, acute rheumatic fever, reactive arthritis, brucellosis and early connective tissue disease. [API 2019]",
        "**Fever with breathlessness or hypoxia:** pneumonia and influenza, and severe dengue with pleural effusion. [ICMR 2022]",
        "Hypoxic fever also fits **scrub typhus with ARDS, leptospiral pulmonary haemorrhage** and pulmonary embolism masquerading as sepsis. [API 2019]",
      ],
    },
    {
      heading: "Empirical treatment, safety-netting and follow-up",
      points: [
        "Antipyresis: **paracetamol 500-1000 mg PO 6-hourly, maximum 4 g in 24 hours**. [ICMR 2022]",
        "Children: paracetamol **15 mg/kg per dose**, with tepid sponging and oral fluids. [ICMR 2022]",
        "**Avoid aspirin, ibuprofen and all NSAIDs until dengue is excluded** - they cause bleeding and acute kidney injury. [WHO 2009]",
        "Withhold blind antibiotics for the first **3 days** of an uncomplicated fever in a well patient with stable vitals. [ICMR 2022]",
        "Review daily and let the day of illness and the test results, not anxiety, choose the antibiotic. [ICMR 2022]",
        "**Doxycycline 100 mg PO twice daily for 7 days** is the highest-yield empirical drug in Indian tropical fever. [ICMR 2022]",
        "Doxycycline covers **scrub typhus, other rickettsioses and leptospirosis** - the three that empirical cephalosporins miss. [ICMR 2022]",
        "**Azithromycin 500 mg PO daily** replaces doxycycline in pregnancy and in young children. [ICMR 2022]",
        "Shock, organ dysfunction or a suspected pyogenic focus: blood cultures, then **ceftriaxone 2 g IV daily plus doxycycline**. [ICMR 2022]",
        "Add **intravenous artesunate** if a smear or rapid test is positive for falciparum malaria. [NVBDCP MoHFW]",
        "Safety-net in writing: return at once for bleeding, black stools, severe abdominal pain or persistent vomiting. [WHO 2009]",
        "Return at once for breathlessness, reduced urine output, cold extremities, drowsiness or fever persisting beyond **day 5**. [WHO 2009]",
        "Give every discharged febrile patient a named **review date within 48 hours**. [ICMR 2022]",
        "**The defervescence day is the dangerous day in dengue** - the patient may worsen just as the fever settles. [WHO 2009]",
        "Warn the family that deterioration follows defervescence - the counselling point that prevents most dengue deaths. [WHO 2009]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          heading: "1. History",
          points: [
            "Record the day of illness, the fever pattern, and whether the fever has ever touched normal. [ICMR 2022]",
            "Ask for retro-orbital pain, myalgia, calf tenderness, joint pain and rash. [ICMR 2022]",
            "Ask for cough, diarrhoea, dysuria and headache - each names a focus and ends the undifferentiated label. [ICMR 2022]",
            "Exposure: travel, forest or plantation visit, wading in flood water or a paddy field. [ICMR 2022]",
            "Exposure: rodent and cattle contact, raw milk and street food. [ICMR 2022]",
            "Exposure: unprotected sexual contact, injections, transfusions and animal bite. [ICMR 2022]",
            "Drug history including self-medication - antibiotics and antimalarials blunt the classical picture and sterilise cultures. [ICMR 2022]",
            "Past history of tuberculosis, diabetes and HIV, and any current pregnancy. [ICMR 2022]",
            "Family and neighbourhood history of similar fevers - it often proves a dengue or chikungunya outbreak before any laboratory. [IDSP MoHFW]",
          ],
        },
        {
          heading: "2. Examination",
          points: [
            "Vital signs with pulse pressure, postural blood pressure, capillary refill, respiratory rate and oxygen saturation. [ICMR 2022]",
            "Look for relative bradycardia - a rise under **10 beats per minute for each 1 degree F** points to enteric fever. [API 2019]",
            "Full skin survey with the patient undressed - axilla, groin, perineum, under the breasts, behind the ears - hunting an **eschar**. [ICMR 2022]",
            "Describe any rash by distribution, blanching, and whether it involves the **palms and soles**. [ICMR 2022]",
            "Look for conjunctival suffusion, jaundice, pallor, lymphadenopathy and hepatosplenomegaly. [ICMR 2022]",
            "Look for meningism, chest signs, a cardiac murmur and abdominal tenderness. [ICMR 2022]",
            "Repeat the examination daily - the discriminating sign usually appears around **day 5**. [ICMR 2022]",
          ],
        },
        {
          heading: "3. Investigations",
          points: [
            "First line: complete blood count with platelet count and haematocrit. [ICMR 2022]",
            "First line: malaria rapid diagnostic test with **thick and thin smear**. [NVBDCP MoHFW]",
            "First line: dengue **NS1 if within day 5**, plus urine routine. [WHO 2009]",
            "First line: **two sets of blood culture before any antibiotic**. [ICMR 2022]",
            "**From day 5:** dengue IgM MAC-ELISA, scrub typhus IgM ELISA and leptospira IgM ELISA. [ICMR 2022]",
            "Supportive: liver and renal function, serum electrolytes and a chest radiograph. [ICMR 2022]",
            "Ultrasound abdomen for splenomegaly, **gall bladder wall oedema**, ascites or a liver abscess. [WHO 2009]",
            "Read the haemogram as a discriminator: leucopenia with thrombocytopenia against neutrophil leucocytosis. [ICMR 2022]",
            "**A single Widal test is not diagnostic** in an endemic setting. [ICMR 2022]",
          ],
        },
        {
          heading: "4. Management",
          points: [
            "Triage first - shock, bleeding, hypoxia, altered sensorium, oliguria or jaundice mandate admission and resuscitation, not an outpatient work-up. [ICMR 2022]",
            "Symptomatic care: **paracetamol 500-1000 mg 6-hourly to a maximum of 4 g a day**, with oral fluids and ORS. [ICMR 2022]",
            "**NSAIDs and aspirin are prohibited until dengue is excluded**. [WHO 2009]",
            "Malaria: artemisinin combination therapy, or **intravenous artesunate** if severe. [NVBDCP MoHFW]",
            "Scrub typhus and leptospirosis: **doxycycline**. [ICMR 2022]",
            "Enteric fever: **azithromycin or ceftriaxone**. [ICMR 2022]",
            "Dengue: **supportive fluid therapy**, no antiviral and no antibiotic. [WHO 2009]",
            "Unavoidable empirical cover in an unwell patient in an endemic area: **doxycycline 100 mg twice daily for 7 days**. [ICMR 2022]",
            "Add **ceftriaxone** to empirical doxycycline if bacterial sepsis is suspected. [ICMR 2022]",
          ],
        },
        {
          heading: "5. Follow-up, safety-netting and public health",
          points: [
            "Review daily through the critical window of **days 3-7**. [WHO 2009]",
            "Repeat the platelet count and haematocrit daily wherever dengue is suspected. [WHO 2009]",
            "Written warning signs: bleeding, black stools, severe abdominal pain, persistent vomiting. [WHO 2009]",
            "Written warning signs: breathlessness, cold extremities, reduced urine, drowsiness, and worsening as the fever settles. [WHO 2009]",
            "Notify dengue, malaria and any cluster of fevers under the **Integrated Disease Surveillance Programme**. [IDSP MoHFW]",
            "Give source reduction advice for **Aedes** breeding and for rodent control. [NVBDCP MoHFW]",
            "Fever beyond **7 days**: restart the whole diagnosis rather than escalating the antibiotic. [ICMR 2022]",
            "Then consider tuberculosis, HIV, abscess, endocarditis and non-infective causes. [API 2019]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "Causes",
          points: [
            "Common infective causes: **dengue, malaria (vivax and falciparum), scrub typhus and other rickettsioses**. [ICMR 2022]",
            "Also leptospirosis, enteric fever, and bacterial sepsis with disseminated intravascular coagulation. [ICMR 2022]",
            "Less common infective: **HIV seroconversion**, viral hepatitis, brucellosis and infective endocarditis. [API 2019]",
            "Less common infective: chikungunya, and **Kyasanur forest disease in the Western Ghats**. [NVBDCP MoHFW]",
            "Non-infective mimics not to be missed: **acute leukaemia, aplastic anaemia, immune thrombocytopenia**. [API 2019]",
            "Non-infective mimics: thrombotic thrombocytopenic purpura, drug-induced thrombocytopenia and megaloblastic anaemia. [API 2019]",
          ],
        },
        {
          heading: "Clinical clues",
          points: [
            "Eschar with leucocytosis and high transaminases suggests **scrub typhus**. [ICMR 2022]",
            "Conjunctival suffusion with calf tenderness and jaundice suggests **leptospirosis**. [ICMR 2022]",
            "Rigors with splenomegaly and a haemolytic picture suggest **malaria**. [NVBDCP MoHFW]",
            "Step-ladder fever with relative bradycardia suggests **enteric fever**. [API 2019]",
            "Rising haematocrit with a falling platelet count around defervescence is **dengue plasma leakage**. [WHO 2009]",
            "Ascites or a pleural effusion on ultrasound confirms dengue plasma leakage. [WHO 2009]",
            "Lymphadenopathy and hepatosplenomegaly with pancytopenia over a long history suggests **leukaemia or kala-azar**, not an acute arbovirus. [API 2019]",
          ],
        },
        {
          heading: "Investigation and management",
          points: [
            "Send a complete blood count with peripheral smear and a **haematocrit trend**. [WHO 2009]",
            "Send a malaria RDT and smear, with dengue **NS1 or IgM chosen by the day of illness**. [NVBDCP MoHFW]",
            "Send scrub typhus and leptospira IgM, blood culture, and liver and renal function. [ICMR 2022]",
            "Send a coagulation profile if there is bleeding. [ICMR 2022]",
            "Malaria: **artemisinin combination therapy**, or artesunate if severe. [NVBDCP MoHFW]",
            "Rickettsial and leptospiral disease: **doxycycline**; enteric fever: ceftriaxone or azithromycin. [ICMR 2022]",
            "Dengue: **crystalloid guided by the haematocrit**. [WHO 2009]",
            "**Do not transfuse platelets on a count alone** - transfuse for clinically significant bleeding. [WHO 2009]",
            "Prophylactic platelets only below **10,000 per cubic millimetre**, or below 20,000 with a bleeding risk factor. [WHO 2009]",
            "Avoid NSAIDs, aspirin, intramuscular injections and invasive procedures while the count is low. [WHO 2009]",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Triage vitals: pulse, pulse pressure, blood pressure, capillary refill, respiratory rate and oxygen saturation. [ICMR 2022]",
            "Triage also on sensorium and urine output - both fall before the blood pressure does. [ICMR 2022]",
            "Any danger sign - shock, bleeding, hypoxia, altered sensorium, oliguria, jaundice or seizure - means resuscitation and admission. [ICMR 2022]",
          ],
        },
        {
          heading: "Step 2: look for a focus",
          points: [
            "Focused system review and examination for pharyngitis, otitis, pneumonia and urinary tract infection. [ICMR 2022]",
            "Also examine for cellulitis, dental or perianal sepsis, diarrhoea and meningism. [ICMR 2022]",
            "A focus found is treated specifically; no focus puts the patient on the undifferentiated fever pathway. [ICMR 2022]",
          ],
        },
        {
          heading: "Step 3: investigate by day of illness",
          points: [
            "**Day 1-4:** complete blood count, malaria RDT and smear, dengue NS1, urine routine and blood culture. [ICMR 2022]",
            "**Day 5 and beyond:** add dengue, scrub typhus and leptospira IgM ELISA, and repeat the haemogram. [ICMR 2022]",
            "Leucopenia with thrombocytopenia against neutrophil leucocytosis directs the next test and the empirical drug. [ICMR 2022]",
          ],
        },
        {
          heading: "Step 4: treat and safety-net",
          points: [
            "Give specific therapy wherever a diagnosis has been made. [ICMR 2022]",
            "**Doxycycline 100 mg twice daily for 7 days** is empirical cover only for the unwell patient in an endemic area. [ICMR 2022]",
            "Paracetamol and oral fluids, **no NSAIDs**, and daily review through days 3-7. [WHO 2009]",
            "Give written warning signs with a named return date. [ICMR 2022]",
            "Fever beyond **7 days** without a diagnosis: restart the evaluation rather than escalate. [ICMR 2022]",
            "Then consider tuberculosis, HIV, abscess, endocarditis, malignancy and connective tissue disease. [API 2019]",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        "Dengue is a **flavivirus with four serotypes, DENV 1 to 4**, all circulating in India. [WHO 2009]",
        "Infection with one serotype gives lifelong immunity to that serotype but only transient cross-immunity to the others. [WHO 2009]",
        "**Secondary infection with a different serotype carries the greatest risk of severe dengue** through antibody-dependent enhancement. [WHO 2009]",
        "Severe disease therefore clusters in older children and in adults living in hyperendemic cities. [WHO 2009]",
        "The vector is **Aedes aegypti**, with Aedes albopictus, a day-biting mosquito. [NVBDCP 2015]",
        "Aedes breeds in clean stored water - coolers, overhead tanks, discarded tyres, flower pots, construction sites. [NVBDCP 2015]",
        "Control is **source reduction, not fogging** - fogging kills adults for a day and leaves the larvae. [NVBDCP 2015]",
        "Incubation is **4 to 10 days**. [WHO 2009]",
        "The patient is viraemic and infective to mosquitoes from a day before fever until about **day 5**. [WHO 2009]",
        "India reports well over **100,000 laboratory-confirmed cases a year** to the NVBDCP, with true burden many times higher. [NVBDCP 2015]",
        "Peak transmission follows the monsoon, **August to November**, with a longer season in the south. [NVBDCP 2015]",
        "Case fatality is **below 1% when properly managed**. [WHO 2009]",
        "Badly managed severe dengue carries a mortality of **10-20%** - almost all the difference is fluid management. [WHO 2009]",
      ],
    },
    {
      heading: "The three phases",
      points: [
        "**Febrile phase, days 1-3:** abrupt high fever, severe headache, retro-orbital pain, myalgia and arthralgia (break-bone fever). [WHO 2009]",
        "Febrile phase also gives facial flushing, a transient macular rash and a positive tourniquet test. [WHO 2009]",
        "Risks of the febrile phase are **dehydration and febrile seizures**, not shock. [WHO 2009]",
        "**Critical phase, days 3-7**, begins at defervescence and lasts **24-48 hours**. [WHO 2009]",
        "The critical phase is plasma leakage from increased capillary permeability - shock, effusions, ascites and severe bleeding. [WHO 2009]",
        "The critical phase is heralded by the **warning signs**, which is why they are checked at every review. [WHO 2009]",
        "**Recovery phase, days 7-10:** reabsorption of extravasated fluid, falling haematocrit, rising platelet count and bradycardia. [WHO 2009]",
        "Recovery brings a confluent itchy rash with **islands of white in a sea of red** on the limbs. [WHO 2009]",
        "**Fluid overload and pulmonary oedema are the danger of the recovery phase** - stop intravenous fluids. [WHO 2009]",
        "**Tourniquet test:** inflate the cuff midway between systolic and diastolic pressure for **5 minutes**. [WHO 2009]",
        "More than **10 petechiae per square inch** on the forearm is a positive tourniquet test. [WHO 2009]",
        "The tourniquet test supports dengue but is neither sensitive nor specific - a negative test excludes nothing. [WHO 2009]",
        "**Laboratory hallmark of the critical phase: rising haematocrit with a rapidly falling platelet count**. [WHO 2009]",
        "Progressive leucopenia and hypoalbuminaemia accompany the critical phase. [WHO 2009]",
        "A haematocrit rise of **20% or more above baseline** indicates significant plasma leakage. [WHO 2009]",
        "Warn the family that **the patient may worsen just as the fever settles** - this counselling saves more lives than any drug. [WHO 2009]",
      ],
    },
    {
      heading: "WHO warning signs and case classification",
      points: [
        "**WHO 2009 warning signs:** abdominal pain or tenderness, and persistent vomiting. [WHO 2009]",
        "Warning signs: clinical fluid accumulation - ascites or pleural effusion - and mucosal bleeding. [WHO 2009]",
        "Warning signs: lethargy or restlessness, and liver enlargement more than **2 cm**. [WHO 2009]",
        "Warning sign: a rise in haematocrit with a rapid fall in platelet count. [WHO 2009]",
        "**Group A** is dengue without warning signs in a patient tolerating oral fluids and passing urine at least every **6 hours**. [WHO 2009]",
        "Group A is managed at home with review every day. [WHO 2009]",
        "**Group B** is dengue with warning signs, or with a co-existing condition or adverse social situation. [WHO 2009]",
        "Group B co-existing conditions: infancy, pregnancy, old age, diabetes, renal or heart disease, obesity, haemoglobinopathy. [WHO 2009]",
        "Group B social situations: living alone or living far from hospital - admit for observation and intravenous fluid. [WHO 2009]",
        "**Group C is severe dengue** and needs emergency treatment. [WHO 2009]",
        "Severe dengue: severe plasma leakage causing shock or respiratory distress from fluid accumulation. [WHO 2009]",
        "Severe dengue: severe bleeding, or severe organ involvement. [WHO 2009]",
        "Severe organ involvement means **AST or ALT 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2009]",
        "Indian programme documents still use the old grading of dengue fever, dengue haemorrhagic fever I-IV and dengue shock syndrome. [NVBDCP 2015]",
        "**DHF grade I:** fever with a positive tourniquet test only. [NVBDCP 2015]",
        "**DHF grade II:** grade I plus spontaneous bleeding. [NVBDCP 2015]",
        "**DHF grade III:** circulatory failure with a narrow pulse pressure. [NVBDCP 2015]",
        "**DHF grade IV:** profound shock with unrecordable blood pressure. [NVBDCP 2015]",
        "**Expanded dengue syndrome** covers unusual presentations occurring without classical plasma leakage. [NVBDCP 2015]",
        "Expanded dengue syndrome: encephalitis and encephalopathy, myocarditis, acute liver failure, acute kidney injury. [NVBDCP 2015]",
        "Expanded dengue syndrome: Guillain-Barre syndrome, acalculous cholecystitis and haemophagocytic lymphohistiocytosis. [NVBDCP 2015]",
      ],
    },
    {
      heading: "Diagnosis",
      points: [
        "**NS1 antigen is the test of days 1 to 5**. [WHO 2009]",
        "NS1 sensitivity is **70-90% in primary infection** and lower in secondary infection. [WHO 2009]",
        "NS1 may remain positive up to **day 9** in some patients. [WHO 2009]",
        "**IgM MAC-ELISA is the test from day 5 onwards**, staying positive for **2-3 months**. [WHO 2009]",
        "India confirms dengue by NS1 or IgM MAC-ELISA at a **Sentinel Surveillance Hospital, where the test is free under the NVBDCP**. [NVBDCP 2015]",
        "**Rapid combo IgM and IgG cards are not acceptable for case confirmation** - specificity is poor. [NVBDCP 2015]",
        "An isolated IgG positive means past infection, not current dengue. [NVBDCP 2015]",
        "Serial complete blood counts are the real monitoring tool in dengue. [WHO 2009]",
        "**Record haematocrit and platelet count at least once daily from day 3**. [WHO 2009]",
        "Record haematocrit and platelet count **4-6 hourly in a Group B or C patient** - the trend, not a single value, guides fluid. [WHO 2009]",
        "Do a **right lateral decubitus chest radiograph**, or better an ultrasound, for a right pleural effusion. [WHO 2009]",
        "Ultrasound also shows ascites and **gall bladder wall thickening over 3 mm** - early objective evidence of plasma leakage. [WHO 2009]",
        "Add liver function, renal function, serum albumin, and blood grouping with cross-matching in any patient with warning signs. [WHO 2009]",
        "A **coagulation profile is needed only if there is significant bleeding**. [WHO 2009]",
      ],
    },
    {
      heading: "Fluid management, the core of treatment",
      points: [
        "**Group A:** oral fluids - ORS, coconut water, rice kanji, buttermilk, fruit juice, soup. [NVBDCP 2015]",
        "Group A target: urine passed **at least once every 6 hours**. [WHO 2009]",
        "Group A antipyresis: **paracetamol 500-1000 mg 6-hourly, maximum 4 g a day**. [NVBDCP 2015]",
        "**No aspirin, no NSAIDs, no steroids and no intramuscular injections** in dengue. [NVBDCP 2015]",
        "**Group B with warning signs:** isotonic crystalloid - 0.9% saline or Ringer lactate. [WHO 2009]",
        "Group B: **5-7 mL/kg/hour for 1-2 hours**, reassessing clinically and by haematocrit. [WHO 2009]",
        "Group B: then **3-5 mL/kg/hour for 2-4 hours**, then **2-3 mL/kg/hour**. [WHO 2009]",
        "Reduce the rate as soon as the patient improves - the commonest dengue error is running fluid at a fixed rate. [WHO 2009]",
        "**Group C compensated shock** is a narrow pulse pressure, tachycardia and cold peripheries with a measurable blood pressure. [WHO 2009]",
        "Compensated shock: isotonic crystalloid **5-10 mL/kg over 1 hour**, then reassess. [WHO 2009]",
        "If improving, step down through **5-7, then 3-5, then 2-3 mL/kg/hour** and stop by 24-48 hours. [WHO 2009]",
        "**Group C hypotensive shock:** crystalloid or colloid **20 mL/kg as a bolus over 15-30 minutes**. [WHO 2009]",
        "If the patient improves, reduce to **10 mL/kg/hour** and then step down. [WHO 2009]",
        "No improvement: check the haematocrit before giving anything else. [WHO 2009]",
        "**A rising haematocrit means give more fluid or switch to a colloid**. [WHO 2009]",
        "**A falling haematocrit in continuing shock means occult bleeding** - give blood, not more crystalloid. [WHO 2009]",
        "**Total intravenous fluid should not exceed maintenance plus a 5% deficit over about 48 hours**. [WHO 2009]",
        "Stop the infusion once the patient is haemodynamically stable, appetite has returned and urine output is good. [WHO 2009]",
        "Stop the infusion when the haematocrit falls in the recovery phase - fluid into reabsorption causes pulmonary oedema. [WHO 2009]",
        "Holliday-Segar maintenance on ideal body weight: **100 mL/kg for the first 10 kg, 50 mL/kg for the next 10 kg, 20 mL/kg thereafter**. [IAP 2020]",
      ],
    },
    {
      heading: "Blood products, complications and prevention",
      points: [
        "**Platelet transfusion is not given on a count alone** in dengue. [WHO 2009]",
        "Transfuse platelets for **clinically significant bleeding**. [WHO 2009]",
        "Prophylactic platelets when the count is below **10,000 per cubic millimetre**. [NVBDCP 2015]",
        "Prophylactic platelets below **20,000 per cubic millimetre** if there is a bleeding risk factor such as an invasive procedure or peptic ulcer. [NVBDCP 2015]",
        "**Fresh whole blood or packed cells for significant bleeding with haemodynamic compromise**. [WHO 2009]",
        "Transfusion is guided by a falling haematocrit in a patient still in shock. [WHO 2009]",
        "Fresh frozen plasma and cryoprecipitate are reserved for documented coagulopathy with bleeding. [WHO 2009]",
        "**No role for steroids or intravenous immunoglobulin** in dengue. [WHO 2009]",
        "**No role for carica papaya leaf extract, platelet-raising tonics or prophylactic antibiotics** - papaya leaf has no evidence on hard outcomes. [NVBDCP 2015]",
        "Fluid overload with pulmonary oedema: stop fluids, sit the patient up, give oxygen, and cautious furosemide once the leak has stopped. [WHO 2009]",
        "Watch for acute liver failure, myocarditis, encephalopathy and secondary bacterial infection. [NVBDCP 2015]",
        "**Discharge criteria:** afebrile for **48 hours** without an antipyretic, with improving appetite and general condition. [WHO 2009]",
        "Discharge criteria: stable haematocrit off intravenous fluids for **24 hours**, adequate urine output and no respiratory distress. [WHO 2009]",
        "Discharge criterion: a **rising platelet count above 50,000 per cubic millimetre**. [NVBDCP 2015]",
        "Prevention is source reduction: a **weekly dry day**, emptying and scrubbing coolers and containers, covering overhead tanks. [NVBDCP 2015]",
        "Prevention: larvivorous fish, repellents and full-sleeved clothing, plus community action. [NVBDCP 2015]",
        "Notify every case under the **NVBDCP**; the CYD-TDV vaccine is not part of Indian public health practice. [NVBDCP 2015]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Febrile phase, days 1-3:** high fever, headache, retro-orbital pain, severe myalgia and arthralgia. [WHO 2009]",
            "Febrile phase signs: flushing, a transient macular rash and a positive tourniquet test. [WHO 2009]",
            "Risks of the febrile phase are **dehydration and febrile convulsions**. [WHO 2009]",
            "**Critical phase, days 3-7**, begins at defervescence and lasts **24-48 hours**. [WHO 2009]",
            "Critical phase: increased capillary permeability with plasma leakage causing effusions, ascites, haemoconcentration, shock and bleeding. [WHO 2009]",
            "**Recovery phase, days 7-10:** reabsorption of fluid, falling haematocrit, rising platelet count and bradycardia. [WHO 2009]",
            "Recovery brings a confluent itchy rash of **islands of white in a sea of red**. [WHO 2009]",
            "**Fluid overload is the danger of the recovery phase** - stop the drip. [WHO 2009]",
          ],
        },
        {
          heading: "2. WHO warning signs",
          points: [
            "Warning sign: **abdominal pain or tenderness**. [WHO 2009]",
            "Warning sign: **persistent vomiting**. [WHO 2009]",
            "Warning sign: clinical fluid accumulation as **ascites or pleural effusion**. [WHO 2009]",
            "Warning sign: **mucosal bleeding**. [WHO 2009]",
            "Warning sign: **lethargy or restlessness**. [WHO 2009]",
            "Warning sign: **liver enlargement more than 2 cm**. [WHO 2009]",
            "Warning sign: a **rise in haematocrit with a rapid fall in platelet count**. [WHO 2009]",
            "Any one warning sign means plasma leakage has begun - admit for observation and intravenous fluid. [WHO 2009]",
          ],
        },
        {
          heading: "3. Classification and disposal",
          points: [
            "**Group A:** no warning signs, tolerating oral fluids, passing urine at least **6-hourly**, no co-morbidity, reliable home circumstances. [WHO 2009]",
            "Group A disposal: home care with oral fluids, paracetamol, written warning signs and daily review with a haemogram. [WHO 2009]",
            "**Group B:** any warning sign, or a co-existing condition, or an adverse social situation. [WHO 2009]",
            "Group B co-morbidities: infancy, pregnancy, **age above 60**, diabetes, renal, hepatic or cardiac disease, obesity. [WHO 2009]",
            "Group B disposal: admit for observation and intravenous fluid. [WHO 2009]",
            "**Group C:** severe dengue with shock or respiratory distress from plasma leakage, severe bleeding, or severe organ impairment. [WHO 2009]",
            "Group C organ impairment: **transaminases 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2009]",
            "Group C disposal: emergency resuscitation and intensive care. [WHO 2009]",
          ],
        },
        {
          heading: "4. Fluid management",
          points: [
            "**Group A:** oral fluids to maintain urine output - ORS, coconut water, kanji and soups. [NVBDCP 2015]",
            "Group A: **paracetamol only, with aspirin and NSAIDs prohibited**. [NVBDCP 2015]",
            "**Group B:** isotonic crystalloid **5-7 mL/kg/hour for 1-2 hours**. [WHO 2009]",
            "Group B: then **3-5 mL/kg/hour for 2-4 hours**, then **2-3 mL/kg/hour**. [WHO 2009]",
            "Titrate Group B fluid to clinical status, haematocrit and a urine output of **0.5 mL/kg/hour**. [WHO 2009]",
            "**Group C compensated shock:** isotonic crystalloid **5-10 mL/kg over 1 hour**, then reassess. [WHO 2009]",
            "Then step down through **5-7, 3-5 and 2-3 mL/kg/hour**. [WHO 2009]",
            "**Group C hypotensive shock: 20 mL/kg bolus over 15-30 minutes**, then reduce on improvement. [WHO 2009]",
            "Shock persisting after the bolus with a **rising haematocrit** means more fluid or a colloid. [WHO 2009]",
            "Shock persisting with a **falling haematocrit** means concealed bleeding and the need for blood. [WHO 2009]",
            "Total fluid should approximate **maintenance plus a 5% deficit over 48 hours**. [WHO 2009]",
            "Stop the infusion in the recovery phase to avoid pulmonary oedema. [WHO 2009]",
          ],
        },
        {
          heading: "5. Blood products, monitoring and discharge",
          points: [
            "Transfuse platelets only for **clinically significant bleeding**. [WHO 2009]",
            "Prophylactic platelets below **10,000 per cubic millimetre**. [NVBDCP 2015]",
            "**Fresh whole blood or packed cells** for bleeding with haemodynamic compromise. [WHO 2009]",
            "Monitor pulse, blood pressure with pulse pressure, capillary refill and urine output in Group B and C patients. [WHO 2009]",
            "Monitor the haematocrit **4-6 hourly** in Group B and C patients. [WHO 2009]",
            "**No steroids, no immunoglobulin, no papaya leaf extract, no prophylactic antibiotics**. [NVBDCP 2015]",
            "Discharge when **afebrile for 48 hours without antipyretics** and the appetite is improving. [WHO 2009]",
            "Discharge when the haematocrit is stable off intravenous fluids for **24 hours** with adequate urine output. [WHO 2009]",
            "Discharge when platelets are rising above **50,000 per cubic millimetre**. [NVBDCP 2015]",
          ],
        },
        {
          heading: "6. Prevention and notification",
          points: [
            "Source reduction of Aedes breeding in clean stored water is the core of prevention. [NVBDCP 2015]",
            "**Weekly dry day**, covered tanks, emptied coolers, removal of tyres and discarded containers, and larvivorous fish. [NVBDCP 2015]",
            "Personal protection: repellents, full-sleeved clothing and **bed nets used in the daytime** - Aedes bites in daylight. [NVBDCP 2015]",
            "Notify every case under the **NVBDCP and IDSP**. [IDSP MoHFW]",
            "Confirm cases by NS1 or IgM MAC-ELISA at a **Sentinel Surveillance Hospital**, where the test is free. [NVBDCP 2015]",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "Recognition",
          points: [
            "**Compensated shock:** tachycardia, cold clammy peripheries, **capillary refill over 2 seconds**. [WHO 2009]",
            "Compensated shock: narrowed pulse pressure with a normal systolic pressure, restlessness and reduced urine output. [WHO 2009]",
            "**Decompensated shock:** hypotension or unrecordable blood pressure, feeble or absent pulses, mottled skin. [WHO 2009]",
            "Decompensated shock: tachypnoea, metabolic acidosis and altered sensorium. [WHO 2009]",
            "Supporting evidence: **rising haematocrit with a rapidly falling platelet count**. [WHO 2009]",
            "Supporting evidence: pleural effusion on a right lateral decubitus film or ultrasound, ascites, gall bladder wall oedema and hypoalbuminaemia. [WHO 2009]",
          ],
        },
        {
          ...
          points: [
            "**Compensated shock: isotonic crystalloid 5-10 mL/kg over 1 hour**, then reassess. [WHO 2009]",
            "If improving, step down to **5-7, then 3-5, then 2-3 mL/kg/hour** and stop by 24-48 hours. [WHO 2009]",
            "**Hypotensive shock: 20 mL/kg of crystalloid or colloid over 15-30 minutes**, with oxygen. [WHO 2009]",
            "Reassess a shocked dengue patient every **15-30 minutes**. [WHO 2009]",
            "Shock persisting after the bolus: recheck the haematocrit before the next decision. [WHO 2009]",
            "A **high or rising haematocrit** means continued leakage - give a further bolus or a colloid such as dextran. [WHO 2009]",
            "A **falling haematocrit** means concealed bleeding - give fresh whole blood or packed cells. [WHO 2009]",
            "Correct hypoglycaemia, hypocalcaemia and metabolic acidosis. [WHO 2009]",
            "**Inotropes only after intravascular volume has been restored** - they fail in an empty circulation. [WHO 2009]",
          ],
        },
        {
          heading: "Monitoring, pitfalls and outcome",
          points: [
            "Monitor pulse, blood pressure with pulse pressure, capillary refill and respiratory rate. [WHO 2009]",
            "Aim for a urine output of **0.5-1 mL/kg/hour**. [WHO 2009]",
            "Check the haematocrit **every 4-6 hours or sooner** in a shocked patient. [WHO 2009]",
            "**Fatal error 1: too little fluid in the first hour of shock**. [WHO 2009]",
            "**Fatal error 2: continuing fluid into the reabsorption phase**, causing pulmonary oedema. [WHO 2009]",
            "Avoid intramuscular injections, NSAIDs, steroids and unnecessary invasive procedures. [NVBDCP 2015]",
            "**Do not transfuse platelets for a count alone**. [WHO 2009]",
            "Prompt recognition with titrated fluid brings mortality **below 1%**. [WHO 2009]",
            "Untreated or mismanaged shock carries a mortality of **10-20%**. [WHO 2009]",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "**Abdominal pain or tenderness**. [WHO 2009]",
            "**Persistent vomiting**. [WHO 2009]",
            "**Clinical fluid accumulation** - ascites or pleural effusion. [WHO 2009]",
            "**Mucosal bleeding**. [WHO 2009]",
            "**Lethargy or restlessness**. [WHO 2009]",
            "**Liver enlargement more than 2 cm** below the costal margin. [WHO 2009]",
            "**Increase in haematocrit with a rapid fall in platelet count**. [WHO 2009]",
          ],
        },
        {
          heading: "Criteria for severe dengue (any one)",
          points: [
            "**Severe plasma leakage** causing shock (dengue shock syndrome) or respiratory distress from fluid accumulation. [WHO 2009]",
            "**Severe bleeding** as judged by the clinician - haematemesis, melaena, intracranial or heavy vaginal bleeding. [WHO 2009]",
            "**Severe organ involvement: AST or ALT 1000 IU/L or more**, impaired consciousness, myocarditis or renal failure. [WHO 2009]",
          ],
        },
        {
          heading: "Indications for platelet transfusion",
          points: [
            "**Clinically significant bleeding at any platelet count**. [WHO 2009]",
            "Prophylactic transfusion when the platelet count is below **10,000 per cubic millimetre**. [NVBDCP 2015]",
            "Prophylactic transfusion below **20,000** with an added bleeding risk - an invasive procedure, peptic ulcer or anticoagulant use. [NVBDCP 2015]",
            "**A low count alone, however dramatic, is not an indication**. [WHO 2009]",
            "Counts routinely fall to **20,000-30,000** and recover spontaneously within **48-72 hours**. [WHO 2009]",
            "Give **fresh whole blood or packed cells** instead for bleeding with haemodynamic compromise. [WHO 2009]",
            "Blood is especially indicated when the haematocrit falls in a patient still in shock. [WHO 2009]",
          ],
        },
      ],
      markSplit: [
