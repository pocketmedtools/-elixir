  ...
  sections: [
    {
      ...
      points: [
        "**First contact care**: the patient can approach the family physician for any new problem without a prior appointment, referral or filter [Starfield 1998]",
        ...
        "Accessibility has **five dimensions** (Penchansky and Thomas): availability, accessibility, affordability, accommodation, acceptability",
        "Penchansky accessibility is geographic; accommodation covers hours and the appointment system",
        "Penchansky acceptability covers gender, language, caste and stigma",
        "In India first contact is often with a **chemist, an informal provider or an AYUSH practitioner**",
        "The family physician therefore competes on availability, cost and trust rather than on knowledge alone",
        "First contact carries a distinct clinical task: **triage and risk stratification** of an unsorted problem with low prior probability",
        "First contact triage uses history and time rather than technology",
        "**Gatekeeping** systems show fewer specialist visits, fewer investigations and lower cost without worse outcomes [Starfield 1998]",
        "Gatekeeping benefit holds only if access is genuinely open",
        "Practical first contact measures in India: **extended evening hours** and a telephone or teleconsultation line",
        "Practical first contact measures: a same-day sick slot and a female attendant for female patients",
        "Practical first contact measures: no-appointment walk-in access for acute illness",
      ],
    },
    {
      heading: "Continuity (longitudinality)",
      points: [
        "**Three types of continuity**: informational, management and relational [Haggerty 2003]",
        "**Informational continuity**: the record travels with the patient [Haggerty 2003]",
        "**Management continuity**: a consistent, agreed plan across providers [Haggerty 2003]",
        "**Relational continuity**: an ongoing personal relationship with one clinician [Haggerty 2003]",
        "Relational continuity is the type unique to family medicine and the one with the strongest evidence",
        "Greater continuity is associated with **lower mortality** [Pereira Gray 2018]",
        "Greater continuity is associated with fewer emergency attendances, fewer admissions, better adherence and lower cost [Pereira Gray 2018]",
        "Continuity converts a series of episodes into a **narrative**",
        "The doctor who saw the first presentation is best placed to recognise the change that matters - continuity is itself a diagnostic tool",
        "Continuity permits the **legitimate use of time as a test**",
        "Reviewing in 48 hours is only safe when someone will actually see the patient again and remember the baseline",
        "Threats to continuity: rotating junior staff, multiple part-time doctors, migration, corporate walk-in models",
        "Threat: **collusion of anonymity** - many specialists mean no one owns the decision",
        "Continuity is not the same as **rigidity** - a personal list must be balanced against timely access",
        "Answer to 'access versus continuity': a personal list for chronic and complex care with open access for acute problems",
      ],
    },
    {
      heading: "Comprehensiveness",
      points: [
        "**Comprehensiveness**: the range of services is wide enough to meet all common needs of the practice population [Starfield 1998]",
        "Comprehensive practice refers out only what genuinely cannot be done in primary care [Starfield 1998]",
        "Comprehensiveness spans the **whole life cycle** - antenatal to palliative - the whole family and all organ systems",
        "Comprehensiveness spans four levels of care - **promotive, preventive, curative, rehabilitative** - with palliative as the fifth",
        "One Indian session may mean immunising an infant, titrating insulin, doing a Pap smear, incising an abscess",
        "The same session may include counselling an adolescent and reviewing a patient on morphine at home",
        "The **Ayushman Arogya Mandir package of 12 services** is the operational definition of comprehensiveness in the public system [AB-HWC 2018]",
        "Packages: pregnancy and childbirth, neonatal and infant care, childhood and adolescent care, family planning and reproductive health [AB-HWC 2018]",
        "Packages: communicable diseases, non-communicable diseases with screening for hypertension, diabetes and oral, breast and cervical cancers [AB-HWC 2018]",
        "Packages: ophthalmic and ENT care, oral health, elderly and palliative care [AB-HWC 2018]",
        "Packages: emergency and trauma, mental health, screening for common cancers [AB-HWC 2018]",
        "Comprehensiveness fails when a practice **narrows itself** - antenatal-only, diabetes-only",
        "Comprehensiveness is defended by maintaining skills, equipment and a formulary that match the practice population's needs",
        "**Multimorbidity** is the clinical expression of comprehensiveness",
        "The average Indian patient over 60 has **two or more chronic conditions**",
        "Single-disease guidelines applied additively produce polypharmacy and treatment burden",
      ],
    },
    {
      heading: "Coordination",
      points: [
        "**Coordination**: pulling together everything done elsewhere into one coherent plan that one doctor owns [Starfield 1998]",
        "Coordination gathers the specialist opinion, the hospital discharge, the laboratory result, the physiotherapist and the AYUSH practitioner",
        "Instruments of coordination: **problem list**, a single consolidated record, a reconciled medication list",
        "Instruments of coordination: the referral letter and the back-referral or reply letter",
        "**Transitions of care are the danger points**: hospital discharge, transfer between specialists, change of doctor",
        "**Medication reconciliation at discharge** is the single highest-yield coordination activity",
        "Coordination for **multimorbidity**: prioritise problems with the patient and agree what will not be treated",
        "Multimorbidity coordination also means deprescribing and one review interval instead of five",
        "Coordination failures show as duplicate investigation, contradictory advice and drug interactions",
        "The patient who has **five specialists and no doctor** is a coordination failure",
        "In India the family physician also coordinates with **non-medical systems**: ASHA, anganwadi, school, employer",
        "Non-medical coordination also includes the insurance scheme (PM-JAY) and the NGO or palliative care network",
      ],
    },
    {
      heading: "Evidence and outcomes",
      points: [
        "**Starfield's international comparisons**: countries with stronger primary care have lower total costs [Starfield 1998]",
        "Stronger primary care countries have better population health indicators and smaller inequities [Starfield 1998]",
        "A greater supply of primary care physicians (not specialists) is associated with **lower all-cause, cancer, cardiovascular and infant mortality** [Starfield 1998]",
        "**Continuity with the same doctor** is associated with about a fifth lower mortality in the best studies [Pereira Gray 2018]",
        "Continuity is associated with reduced use of emergency services [Pereira Gray 2018]",
        "The continuity effect increases with the duration of the relationship [Pereira Gray 2018]",
        "**Comprehensiveness** in a US cohort was associated with lower Medicare spending and fewer hospitalisations",
        "The wider the scope of the family physician's practice, the lower the cost of care",
        "The **Triple Aim (IHI)**: better population health, better patient experience, lower per capita cost - achieved chiefly through primary care",
        "The **Quadruple Aim** adds clinician wellbeing",
        "These findings are the evidence base for **National Health Policy 2017** and comprehensive primary health care through Health and Wellness Centres [AB-HWC 2018]",
      ],
    },
    {
      heading: "Making the four Cs work in a real practice",
      points: [
        "**Register the population**: an enumerated panel with a family folder number converts anonymous attenders into a denominator",
        "Registration makes recall possible",
        "**One record per family, one problem list per person** - the practical basis of informational continuity",
        "Keep an updated drug list on the first page of the record",
        "**A named doctor** for every chronic disease patient, with a booked review slot",
        "Open access for acute illness alongside the named doctor - the compromise between continuity and access",
        "**A recall register** for defaulters - antenatal visits, immunisation, diabetes review, tuberculosis treatment",
        "The recall register is the operational form of the practice as a population at risk",
        ...
        "**Audit one C each year** - for example the proportion of diabetics seen by their named doctor",
        "Another audit example: the proportion of discharges with medication reconciled within a week",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Informational continuity is delivered by a cumulative record or a shared electronic record",
            "**Management continuity**: a consistent and coherent plan across providers and over time [Haggerty 2003]",
            "Management continuity is delivered by care plans, shared protocols and discharge summaries",
            "**Relational continuity**: an ongoing therapeutic relationship with one clinician who knows the patient and the family [Haggerty 2003]",
            "Relational continuity is unique to family medicine",
            "Related concept: chronological continuity - a series of contacts",
            "Related concept: geographical continuity - across sites of care",
            "Related concept: interdisciplinary continuity - across the team",
          ],
        },
        {
          heading: "2. Benefits and evidence",
          points: [
            "**Clinical**: better recognition of change from baseline and fewer diagnostic errors",
            "Clinical: better adherence, better chronic disease control, safer use of time as a diagnostic tool",
            "**Outcome evidence**: continuity with the same doctor is associated with significantly lower mortality [Pereira Gray 2018]",
            "The Pereira Gray systematic review covered **22 studies in nine countries** [Pereira Gray 2018]",
            "**Service use**: fewer emergency department attendances and fewer hospital admissions [Pereira Gray 2018]",
            "Service use: fewer duplicated investigations and lower cost",
            "**Experience**: higher patient and doctor satisfaction, greater trust",
            "Experience: more disclosure of sensitive problems and lower doctor burnout",
            "**Preventive**: higher uptake of immunisation, screening and antenatal care",
            "Preventive uptake rises because the doctor knows what is due and the patient trusts the advice",
          ],
        },
        {
          heading: "3. Threats to continuity",
          points: [
            "**System threats**: rotating residents, shift work, multiple part-time doctors",
            "System threats: corporate walk-in and app-based single-episode consultations",
            "**Patient threats**: urban migration, seasonal work, multiple simultaneous providers",
            "Patient threat: doctor shopping driven by dissatisfaction or by cost",
            "**Professional threats**: fragmentation among specialists producing collusion of anonymity [Balint 1964]",
            "Professional threats: poor referral letters and absent replies",
            "**Practice threat**: no registration or family folder - the same patient is a new patient at every visit",
          ],
        },
        {
          heading: "4. Organising a practice for continuity",
          points: [
            "Register families with a **family folder number**",
            "Keep one record per family and a problem list plus drug list per person",
            "Operate a **personal list**: a named doctor for every patient with a chronic disease",
            "Book review appointments with the named doctor",
            ...
            "Structure referrals: a standard referral letter and an expectation of a written reply",
            "Run a filing and action system for referral replies",
            "**Handover**: a written summary when a doctor leaves, and a covering doctor briefed on complex patients",
            "**Audit continuity annually** - for example the proportion of diabetic reviews conducted by the named doctor",
            "Feed the audit result back to the team",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Twelve packages** make up the expanded service package [AB-HWC 2018]",
            "Packages: pregnancy and childbirth; neonatal and infant health; childhood and adolescent health [AB-HWC 2018]",
            "Packages: family planning and reproductive health; management of communicable diseases [AB-HWC 2018]",
            "Packages: management of common communicable diseases and outpatient care for acute simple illness [AB-HWC 2018]",
            "Packages: non-communicable disease screening, prevention and management; ophthalmic and ENT problems; oral health [AB-HWC 2018]",
            "Packages: elderly and palliative care; emergency and trauma; mental health; screening for common cancers [AB-HWC 2018]",
            "Population enumeration and risk assessment with the **Community Based Assessment Checklist (CBAC)** for those over 30 years [AB-HWC 2018]",
            "CBAC is followed by screening for hypertension, diabetes and oral, breast and cervical cancer [AB-HWC 2018]",
            "Free essential drugs and diagnostics [AB-HWC 2018]",
            "Teleconsultation through **eSanjeevani** and wellness activities including yoga [AB-HWC 2018]",
          ],
        },
        {
          ...
          points: [
            ...
            "The subcentre HWC team is the CHO with **two ANMs and about five ASHAs** [AB-HWC 2018]",
            "Primary health centre HWC is led by a medical officer [AB-HWC 2018]",
            "The district hospital and community health centre provide secondary support [AB-HWC 2018]",
            "Continuum of care runs from the community through the HWC to the referral facility [AB-HWC 2018]",
            "**PM-JAY** covers secondary and tertiary hospitalisation costs up to five lakh rupees per family per year",
          ],
        },
        {
          heading: "Strengths and challenges",
          points: [
            "**Strengths**: population coverage with a denominator, free drugs",
            "Strengths: task sharing and an explicit non-communicable disease screening pathway",
            "**Challenges**: human resource gaps, referral linkage and back-referral",
            "Challenges: drug and diagnostic stock-outs, data burden on the CHO, quality assurance",
            "Quality is measured against **National Quality Assurance Standards** and certified through NQAS",
            "**Kayakalp** awards recognise cleanliness",
          ],
        },
      ],
