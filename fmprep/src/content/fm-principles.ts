  ...
  sections: [
    {
      ...
      points: [
        "**WONCA Europe 2002, revised 2011** defines general practice/family medicine as an academic and scientific discipline - the sentence that earns the definition mark in Paper I [WONCA 2011]",
        "The discipline has its own educational content, research, evidence base and clinical activity [WONCA 2011]",
        "It is also a **clinical specialty oriented to primary care** [WONCA 2011]",
        "**Leeuwenhorst 1974** defines the general practitioner as a licensed medical graduate who gives personal, primary and continuing care [McWhinney 4e]",
        "Leeuwenhorst care is to individuals, families and a practice population, irrespective of age, sex and illness [McWhinney 4e]",
        "The three adjectives **personal, primary, continuing** are the marking points of the Leeuwenhorst definition",
        "**AAFP** defines family medicine as the specialty providing continuing, comprehensive health care for the individual and the family",
        "The AAFP definition integrates the biological, clinical and behavioural sciences",
        "AAFP scope is **not limited by age, sex, organ system or disease entity**",
        "**Ian McWhinney**: family medicine is defined in terms of relationships, especially the doctor-patient relationship [McWhinney 4e]",
        "Family medicine is the only discipline to define itself by relationships - so it is not a residual specialty of what others leave behind [McWhinney 4e]",
        "In India the discipline is recognised as **MD Family Medicine (NMC)** and DNB Family Medicine (NBEMS)",
        "The **National Health Policy 2017** explicitly calls for family physicians and mid-level providers to deliver comprehensive primary health care [NHP 2017]",
        "The **1978 Alma-Ata Declaration** and the 2018 Astana Declaration frame the discipline politically [Park 27e]",
        "Primary health care is the vehicle for health for all - the family physician is its clinical expression [Park 27e]",
      ],
    },
    {
      heading: "McWhinney's nine principles",
      points: [
        "1. **Committed to the person** rather than to a body of knowledge, group of diseases or special technique [McWhinney 4e]",
        "The commitment to the person is open-ended - it has no natural end point [McWhinney 4e]",
        "2. **Seeks to understand the context of the illness** - family, work, money and neighbourhood [McWhinney 4e]",
        "Context matters because illness is often unintelligible outside it [McWhinney 4e]",
        "3. Sees **every contact as an opportunity for prevention** and health education [McWhinney 4e]",
        "An opportunistic BP or blood sugar at a fever visit is good family practice, not overservicing - principle 3 in action",
        "4. Views the practice as a **population at risk** [McWhinney 4e]",
        "Population thinking means denominators - how many diabetics in the panel, how many controlled, how many have not attended",
        "5. Is **part of a community-wide network** of supportive and health care agencies [McWhinney 4e]",
        "In India the network is ASHA, anganwadi, the PHC, the NGO and the palliative care team",
        "6. Should ideally **share the same habitat** as the patients [McWhinney 4e]",
        "Sharing the habitat means exposure to the same water, air, sanitation and social risks",
        "7. **Sees patients in their homes** [McWhinney 4e]",
        "Illness is understood better in an hour at home than in a year of clinic visits [McWhinney 4e]",
        "8. **Attaches importance to the subjective aspects of medicine** - feelings, meanings and the illness experience, not only the disease [McWhinney 4e]",
        "9. Is a **manager of resources** - controls access to investigations, drugs, specialists and admission [McWhinney 4e]",
        "The resource manager is accountable for using those resources well [McWhinney 4e]",
      ],
    },
    {
      heading: "Starfield's four Cs and the core competencies",
      points: [
        "Barbara Starfield reduced primary care to **four attributes**: first contact access, longitudinality (continuity), comprehensiveness and coordination [Starfield 1998]",
        "Family orientation, community orientation and cultural competence are the three **derivative attributes** [Starfield 1998]",
        "Health systems built on strong primary care have **lower cost, better equity and better health outcomes** [Starfield 1998]",
        "The Starfield outcomes sentence is the evidence to quote when asked why family medicine matters",
        "**WONCA six core competencies**: primary care management, person-centred care, specific problem-solving skills, comprehensive approach, community orientation, holistic modelling [WONCA 2011]",
        "The six competencies rest on three **background features** - contextual, attitudinal and scientific [WONCA 2011]",
        "The background features are what distinguish a trained family physician from an untrained general practitioner [WONCA 2011]",
        "The **biopsychosocial model of Engel 1977** underpins the discipline",
        "Disease, illness experience and social context are addressed at every consultation - the biopsychosocial model applied",
        "**Marshall Marinker**: the hospital doctor reduces uncertainty, explores possibility and marginalises error",
        "**Marinker** on the general practitioner: tolerate uncertainty, explore probability and marginalise danger - memorise the aphorism",
      ],
    },
    {
      heading: "How family practice differs from specialist practice",
      points: [
        "The family physician meets illness **early and undifferentiated** - a symptom, not yet a diagnosis [McWhinney 4e]",
        "The specialist meets illness late, filtered and already labelled [McWhinney 4e]",
        "**Prior probability is low** in general practice: chest pain is coronary in under 5% of GP presentations versus 60% of a cardiology clinic",
        "Because prevalence differs, the same test performs completely differently - a positive result in general practice is far more likely to be false",
        "The family physician uses **time as a diagnostic and therapeutic tool** - Braun's watchful waiting with deliberate review",
        "The specialist tends to use technology to shorten the same interval that the GP covers with time",
        "Care is **continuous and cumulative** - the same doctor sees the beginning, middle and end of the story [McWhinney 4e]",
        "The record, not the referral letter, is the unit of information in family practice",
        "The unit of care is the **person and the family** [McWhinney 4e]",
        "One consultation may legitimately deal with a hypertensive husband, an anxious wife and an unimmunised child",
        "The family physician must **rule out the avoidable dangerous course** rather than reach a final pathological diagnosis",
        "Ending a consultation with a symptom label and a safety net is legitimate family practice",
      ],
    },
    {
      heading: "The ecology of medical care and the iceberg",
      points: [
        "**White, Williams and Greenberg 1961**: of 1000 adults per month, about 750 have a symptom [Green 2001]",
        "Of the 1000 adults, **250 consult a physician** per month [Green 2001]",
        "Of the 1000 adults, **9 are admitted** and 5 are referred to another physician [Green 2001]",
        "Of the 1000 adults, only **1 reaches a university teaching hospital** per month [Green 2001]",
        "**Green et al 2001** repeated the study with almost identical proportions - the architecture of care has not changed in 40 years [Green 2001]",
        "The teaching hospital sees fewer than 1 in 1000 symptomatic people, yet trains every doctor [Green 2001]",
        "Medical education is delivered in the setting that sees the **least representative 0.1%** - the argument for training in primary care [Green 2001]",
        "**Last's iceberg of disease 1963**: diagnosed and treated cases are the tip [Park 27e]",
        "Below the waterline lie the presymptomatic, the undiagnosed, the untreated and the unreported [Park 27e]",
        "The family physician is the one who can see below the surface of the iceberg",
        "**Tudor Hart's inverse care law 1971**: availability of good medical care varies inversely with the need of the population served [Park 27e]",
        "The inverse care law operates strongly in rural India and in urban slums",
        "About **90% of illness episodes** are managed entirely outside the formal health system",
        "Outside the formal system illness is managed by self-care, the family, the chemist and traditional practitioners - so health education is a core clinical activity",
      ],
    },
    {
      heading: "The Indian context",
      points: [
        "Roughly **70-80% of first contacts** in India are with the private sector [Park 27e]",
        "Much of Indian private first contact is single-doctor general practice, largely not formally trained in family medicine",
        "**Ayushman Bharat 2018** converted subcentres and PHCs into Health and Wellness Centres, now Ayushman Arogya Mandirs [Park 27e]",
        "Arogya Mandirs deliver an expanded package of comprehensive primary health care [Park 27e]",
        "The expanded package includes screening for hypertension, diabetes and three cancers [Park 27e]",
        "The expanded package also covers mental health, elderly and palliative care, and emergency care [Park 27e]",
        "The **National Health Policy 2017** commits two-thirds of the health budget to primary care [NHP 2017]",
        "NHP 2017 names family medicine training as a priority [NHP 2017]",
        "The **NMC** has since made an MD Family Medicine seat possible in district hospitals",
        "**Out-of-pocket expenditure** remains close to half of total health expenditure in India [NHP 2017]",
        "Rational prescribing, restrained investigation and a considered referral are therefore a direct financial intervention for the family, not academic virtues",
        "The Indian family physician works across a **pluralistic system** - allopathy, AYUSH, chemists, informal providers and faith healers",
        "Ask about parallel treatment without shaming the patient - pluralism is the norm",
        "**Task-sharing** is built into the system: ASHA, ANM, anganwadi worker, community health officer and mid-level provider",
        "These workers are the family physician's team, not competitors",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**WONCA Europe 2002/2011** definition as in the opening line [WONCA 2011]",
            "WONCA lists **eleven characteristics** of the discipline [WONCA 2011]",
            "**Leeuwenhorst 1974**: a licensed medical graduate who gives personal, primary and continuing care [McWhinney 4e]",
            "Leeuwenhorst care goes to individuals, families and a practice population irrespective of age, sex and illness [McWhinney 4e]",
            "**AAFP**: continuing and comprehensive health care for the individual and family",
            "AAFP: integrates the biological, clinical and behavioural sciences",
            "AAFP: scope unlimited by age, sex, organ system or disease entity",
          ],
        },
        {
          heading: "2. McWhinney's nine principles",
          points: [
            "1. **Commitment to the person** rather than to a body of knowledge or a group of diseases [McWhinney 4e]",
            "2. **Seeks to understand the context** of the illness - family, work, finances, community [McWhinney 4e]",
            "3. Sees **every contact as an opportunity for prevention** and health education [McWhinney 4e]",
            "4. Views the practice as a **population at risk** - thinks in denominators [McWhinney 4e]",
            "5. Part of a **community-wide network** of health and social agencies [McWhinney 4e]",
            "6. Ideally **shares the same habitat** as the patients [McWhinney 4e]",
            "7. **Sees patients in their homes** [McWhinney 4e]",
            "8. Attaches importance to the **subjective aspects** of medicine - the illness experience [McWhinney 4e]",
            "9. **Manager of resources** - investigations, drugs, referrals and admissions [McWhinney 4e]",
          ],
        },
        {
          heading: "3. Starfield's attributes as an organising framework",
          points: [
            "Four core attributes: **first contact, longitudinality, comprehensiveness, coordination** [Starfield 1998]",
            "Derived attributes: family orientation, community orientation and cultural competence [Starfield 1998]",
            "Systems with strong primary care show **lower cost, better equity and better population outcomes** [Starfield 1998]",
          ],
        },
        {
          heading: "4. How family practice differs from specialist practice",
          points: [
            "**Stage of illness**: undifferentiated and early in family practice versus filtered and labelled in specialist practice [McWhinney 4e]",
            "Example: a woman with three weeks of tiredness in general practice, versus the same woman referred to haematology with a documented haemoglobin of 6 g/dL",
            "**Prior probability**: chest pain is cardiac in fewer than 5% of general practice presentations but in the majority of a cardiology clinic",
            "An exercise test used indiscriminately in general practice therefore produces mainly false positives",
            "**Unit of care**: the person and the family over time, versus the organ or the episode [McWhinney 4e]",
            "Example: a young man's asthma managed alongside the household kerosene stove and the mother's untreated depression",
            "**Method**: history, relationship and the deliberate use of time, versus technology and procedure",
            "**Goal**: marginalise danger with a safety net and a review date, versus secure a definitive pathological diagnosis",
            "**Accountability**: to a defined practice population as well as to the individual in front of you [Starfield 1998]",
          ],
        },
        {
          heading: "5. Relevance to Indian practice",
          points: [
            "Most first contacts in India are in the private, largely untrained, general practice sector [Park 27e]",
            "Formal **MD and DNB Family Medicine** training exists to correct the untrained-GP gap",
            "**NHP 2017** and Ayushman Bharat Health and Wellness Centres institutionalise comprehensive primary care [NHP 2017]",
            "That comprehensive primary care is delivered by family physicians and mid-level providers [NHP 2017]",
      ...
      answer: [
        {
          ...
          points: [
            "**White 1961**, per 1000 adults per month: about 750 experience at least one symptom [Green 2001]",
            "White 1961: **250 consult a physician** per 1000 adults per month [Green 2001]",
            "White 1961: 9 are admitted to hospital and 5 are referred to another physician [Green 2001]",
            "White 1961: **1 reaches a university teaching hospital** [Green 2001]",
            "**Green 2001** replication: 800 symptomatic, 217 visiting a physician's office [Green 2001]",
            "Green 2001: 113 seen in primary care, 8 admitted, fewer than 1 in an academic medical centre [Green 2001]",
            "Implication: training happens in the setting that sees the **least representative fraction** of illness [Green 2001]",
            "Hospital-based training distorts clinical judgement and thresholds - the case for primary care training",
          ],
        },
        {
          heading: "The iceberg of disease",
          points: [
            "Above the waterline: **diagnosed, treated and notified** cases [Park 27e]",
            "Below the waterline: presymptomatic disease, undiagnosed disease, untreated disease, carriers and the unreported [Park 27e]",
            "Indian example: undiagnosed hypertension and diabetes - **fewer than half** of hypertensives know their diagnosis",
            "Indian examples: latent tuberculosis infection, subclinical hypothyroidism, silent cervical dysplasia",
            "Indian example: unreported domestic violence",
        ...
        },
        {
          ...
          points: [
            ...
            "The **denominator is the practice population**, not the waiting room",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Primary care management**: open and unlimited first contact access, dealing with all health problems [WONCA 2011]",
            "Primary care management also means coordinating care and acting as an effective gatekeeper [WONCA 2011]",
            "**Person-centred care**: a consultation that elicits ideas, concerns and expectations [WONCA 2011]",
            "Person-centred care develops an effective doctor-patient relationship and enables shared decisions [WONCA 2011]",
            "**Specific problem-solving skills**: decision making driven by prevalence and incidence in the community [WONCA 2011]",
            "Problem solving in primary care means using time selectively and tolerating uncertainty [WONCA 2011]",
            "**Comprehensive approach**: managing acute and chronic problems simultaneously [WONCA 2011]",
            "Comprehensive approach integrates promotion, prevention, cure, care and palliation [WONCA 2011]",
            "**Community orientation**: reconciling the individual patient's needs with community health needs within available resources [WONCA 2011]",
            "**Holistic modelling**: a biopsychosocial model that takes in cultural and existential dimensions [WONCA 2011]",
          ],
        },
        {
          heading: "The three background features",
          points: [
            "**Contextual**: understanding the patient's environment, family, culture and the health system [WONCA 2011]",
            "**Attitudinal**: awareness of one's own capabilities, values, ethics and the emotional impact of work [WONCA 2011]",
            "**Scientific**: a critical, research-based approach with continuing professional development and audit [WONCA 2011]",
          ],
        },
      ],
      markSplit: [
