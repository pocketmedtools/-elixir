  ...
  sections: [
    {
      ...
      points: [
        ...
        "A genogram with **three first-degree relatives with diabetes** changes the pre-test probability for the patient in front of you [Rakel 9e]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "Changes that work: a **template field that will not close without an HbA1c date** and a monthly recall list with a named owner [NICE 2002]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Aetiology or harm**: a cohort, or a case-control study when the outcome is rare or the exposure long-delayed [Gordis 6e]",
    ...
    },
    {
      ...
      points: [
        ...
        "State it in one line: the **level of evidence describes the study; the grade describes what you should do** [GRADE Handbook 2013]",
      ],
    },
    {
      ...
      points: [
        ...
        "**Missing allocation concealment is the item most strongly associated with exaggerated treatment effects** across meta-epidemiology [Greenhalgh 6e]",
    ...
    },
    {
      ...
      points: [
        ...
        "**LR+ above 10 or LR- below 0.1** produces a large and usually conclusive change in probability [Straus 5e]",
    ...
    },
    {
      ...
      points: [
        ...
        "Relative measures look impressive and hide baseline risk; **absolute measures and NNT are what the patient needs to hear** [Straus 5e]",
        "Presenting a **25% RRR without the 2% ARR** is the commonest way evidence is used to mislead [Straus 5e]",
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "**LR+ above 10 or LR- below 0.1** gives a large, often conclusive change in probability [Straus 5e]",
...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "**Bias is systematic error in design, conduct or analysis** that makes the estimate differ systematically from the truth [Gordis 6e]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**r-squared, not r, is the proportion of variance explained** - an r of 0.5 explains only 25% of the variance, so r overstates the link [Mahajan 9e]",
    ...
    },
    {
      ...
      points: [
        "The three commonest reporting errors each earn a mark in a critical appraisal question",
        "Error 1: **quoting a mean for skewed data**",
        "Error 2: quoting a **standard error where a standard deviation is meant**",
        "Error 3: quoting a **p value with no effect size or confidence interval**",
        "**Confusing statistical with clinical significance** - a trial of 20000 patients can show a significant 1 mmHg fall in BP that no patient will notice",
        "Always ask for the size of the effect and its confidence interval before deciding to change practice",
        "**Absence of evidence is not evidence of absence** [Altman 1999]",
        "A non-significant result in a small study means the study could not detect a difference - not that no difference exists",
        "Check the confidence interval and the power calculation before concluding equivalence",
        "**Ecological fallacy** is inferring an individual-level relationship from group-level data",
        "**Regression to the mean** explains apparent improvement in extreme values on repeat measurement",
        "Regression to the mean is why an uncontrolled before-and-after study over-states benefit",
        "**Multiple testing** manufactures significance if enough comparisons are made",
        "In the DNB written paper biostatistics appears as short notes - each worth about **5 marks**",
        "Short-note topics: central tendency, standard deviation, normal distribution, tests of significance, sampling methods, standardisation of rates, presentation of data",
        "Each short note is answerable in a definition, a formula, a classification and one worked example",
        "In the thesis viva the examiner will ask **what your outcome variable is, what test you used and why**",
        "The examiner will also ask **what your p value means and how you arrived at your sample size** - four questions answered from this topic alone",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Null hypothesis (H0)**: there is no difference or no association in the population [Mahajan 9e]",
            "**Alternative hypothesis (H1)**: there is a difference or association",
            "The test is applied to the sample data and yields a test statistic and a p value",
            "**Level of significance (alpha)** is fixed before the study, conventionally at 0.05",
            "Alpha is the maximum acceptable probability of a **type I error - rejecting a true null hypothesis, a false positive**",
            "**Type II error (beta)** is failing to reject a false null hypothesis - a false negative",
            "**Power = 1 - beta**, conventionally 80% or 90%",
            "Power depends on sample size, effect size, variability and alpha",
            ...
            "A CI is significant if it excludes 0 for a difference, or 1 for a ratio",
          ],
        },
        {
          ...
          points: [
            ...
            "**Are the assumptions of a parametric test met** - approximately normal distribution, reasonably equal variances, adequate sample size",
            "If parametric assumptions are not met, use the non-parametric equivalent",
          ],
        },
        {
          ...
          points: [
            ...
            "**Paired t test** - comparing mean systolic BP in the same 40 hypertensives before and 12 weeks after starting amlodipine",
            "**One-way ANOVA** with a post-hoc test such as Tukey - comparing mean HbA1c across three treatment groups",
            "ANOVA says that a difference exists somewhere; the post-hoc test says where",
            "**Repeated-measures ANOVA** - peak expiratory flow measured in the same asthmatics at 0, 4 and 12 weeks",
            "**Pearson correlation and linear regression** - the relationship between body mass index and fasting blood glucose",
            "**r-squared, not r, is the proportion of variance explained**",
          ],
        },
        {
          heading: "4. Non-parametric and categorical tests",
          points: [
            "**Mann-Whitney U test** - two independent groups with skewed or ordinal data - length of hospital stay in two treatment arms",
            "**Wilcoxon signed-rank test** - paired ordinal data - pain score before and after an intervention",
            "**Kruskal-Wallis test** - three or more independent groups",
            "**Friedman test** - three or more paired measurements",
            "**Chi-square test** - association between two categorical variables - immunisation status against literacy of the mother",
            "Chi-square is valid only when the **expected count is 5 or more in at least 80% of cells** - otherwise Fisher's exact test",
            "**McNemar's test** - paired categorical data - smoking status in the same subjects before and after a cessation programme",
            "**Kaplan-Meier survival curves compared by the log-rank test**",
            "**Cox proportional hazards regression** where covariates must be adjusted for",
          ],
        },
        {
          heading: "5. Interpretation and common errors",
          points: [
            "**Statistical significance is not clinical significance** - report the effect size and its confidence interval",
            "Judge whether the difference matters to the patient",
            ...
            "Check the assumptions before applying a parametric test",
            "State in the thesis which test was used for which variable and why",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Symmetrical about the mean, bell-shaped, unimodal, and asymptotic to the horizontal axis [Park 27e]",
            "**Mean = median = mode**",
            "Completely described by the mean, which fixes its position, and the standard deviation, which fixes its spread",
            "**68.3% of observations lie within mean plus or minus 1 SD** [Park 27e]",
            "**95.4% lie within 2 SD (95% within 1.96 SD)** [Park 27e]",
            "**99.7% lie within 3 SD (99% within 2.58 SD)** [Park 27e]",
            "The standard normal distribution is obtained by the **z transformation: z = (observation - mean) / SD** [Mahajan 9e]",
            "The standard normal distribution has mean 0 and standard deviation 1 - any percentile can be read off a table",
          ],
        },
        {
          ...
          points: [
            ...
            "SD describes the **scatter of individual observations** - expressed in the same units as the data",
            "**Coefficient of variation = (SD / mean) x 100** - a unitless measure used to compare variability between different variables or units",
            "**Standard error of the mean = SD / square root of n** [Mahajan 9e]",
            "SEM describes the **precision with which the sample mean estimates the population mean**",
            "SEM falls as the sample size rises, whereas the SD does not",
            "**Mean plus or minus 1.96 SD contains 95% of individuals**",
            "**Mean plus or minus 1.96 SEM is the 95% confidence interval of the mean** - this distinction is the most frequently examined point in this note",
          ],
        },
        {
          heading: "3. Applications",
          points: [
            "**Construction of biological reference ranges** - the conventional range of mean plus or minus 2 SD",
            "A mean plus or minus 2 SD range by definition labels 5% of a healthy population abnormal - worth stating when interpreting a mildly out-of-range report",
            "Calculation of **confidence intervals**",
            "The basis of **parametric tests of significance** (t test, ANOVA) and of sample size formulae",
            "Determining the proportion of a population above or below a cut-off using the z score - the proportion of children below a growth standard",
            "**Skewed data** - income, length of stay, incubation period, serum triglycerides - are not normal",
            "Skewed data are described with median and interquartile range, transformed (commonly by logarithms), or analysed by non-parametric tests",
          ],
        },
      ],
      mustDraw: [
