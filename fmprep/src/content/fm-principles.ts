  ...
  sections: [
    {
      ...
      points: [
        "The record is the **only vehicle by which continuity survives the absence of the doctor** [McWhinney 4e]",
        "An unreadable or absent note converts a fifteen-year relationship into a series of unrelated encounters - continuity is lost with the note",
        "The record is the **primary medico-legal document** [NMC 2002]",
        "**NMC (formerly MCI) Code of Ethics Regulations 2002, clause 1.3**: indoor patient records must be kept in the standard proforma [NMC 2002]",
        "Indoor records must be **retained for three years** from the date of commencement of treatment [NMC 2002]",
        "A copy must be supplied to the patient or an authorised attendant **within 72 hours of a request** [NMC 2002]",
        "Records are the evidence base of any complaint under the **Consumer Protection Act 2019**",
        "Under CPA 2019 the burden of showing that reasonable care was taken falls on the doctor",
        "Courts consistently treat **absent documentation as evidence that the act was not performed** - if it is not written, it was not done",
        "The record is the **denominator generator** - audit, recall, immunisation coverage and disease registers all begin with a retrievable list",
        "Any research question about your own practice also begins with a retrievable list",
        "An unindexed pile of prescriptions is therefore not a record system - it yields no denominator",
        "A good record is a **communication device between team members** - ANM, community health officer, pharmacist, night duty doctor and referral consultant all read it",
        "Every entry must be legible, dated, timed and signed with a legible name and registration number - so other readers can act on it",
        ...
        "The family page carries the genogram, household composition and socio-economic classification",
        "The family page also records shared risks - a smear-positive index case or a shared water source",
      ],
    },
    {
      heading: "The problem-oriented medical record",
      points: [
        "The **problem-oriented medical record (POMR) was described by Lawrence Weed in 1968** in the New England Journal of Medicine [Weed 1968]",
        ...
        "The POMR is organised around the patient's problems rather than the source of the data [Weed 1968]",
        ...
        "The **database** is the agreed minimum dataset - identification, presenting complaints, past and family history, drug and allergy list, immunisation",
        "The database also holds social and occupational history, examination and baseline investigations",
        "The database is collected once and updated - not repeated at every visit",
        "The **problem list is the index page of the record** - the single most useful page in family practice",
        "Each problem is numbered and dated at onset",
        "Each problem is carried at the **highest level of certainty currently justified** - chest pain becomes angina becomes ischaemic heart disease as evidence accrues",
        "Problems are never erased - they move to an inactive column with a date of resolution",
        "A problem may be a **diagnosis, symptom, sign, abnormal test result, disability, or a social or psychological issue**",
        "Social or psychological problems include unemployment, caregiver strain or domestic violence - which is exactly why the POMR suits family medicine",
        "**Initial plans are written under three headings per problem - diagnostic, therapeutic and patient education** [Weed 1968]",
        "Progress notes are written in SOAP format against the numbered problem",
        "Problem-numbered notes let a reader follow one problem through years of notes without reading every visit",
      ],
    },
    {
      heading: "SOAP notes and coding the encounter",
      points: [
        "**S - Subjective:** the patient's own account - symptoms and duration",
        "In family practice the S line also records **ideas, concerns and expectations** and why this visit is happening today rather than last week",
        "**O - Objective:** the measurable and observed - vital signs, weight, examination findings, point-of-care and laboratory results",
        "A normal finding relevant to the differential is recorded positively - no neck stiffness documented is worth more later than silence",
        "**A - Assessment:** the interpretation - working diagnosis or differential with the reasoning",
        "The A line also records change since last visit and the stage or control status of a chronic problem",
        "The A line states explicitly the **degree of diagnostic certainty**",
        "**P - Plan:** investigations, treatment with dose, route and duration, patient education given, referral and review interval",
        "The plan records **safety-netting instructions in the words used** - so they can be defended and repeated later",
        "Many practices extend SOAP to **SOAPE or SOAPIER** - adding education, intervention, evaluation and revision",
        "**Coding turns notes into data** - it is what makes registers and audit possible",
        "ICD-10 codes diagnoses; **ICD-11 was adopted by WHO in 2019** and is in staged national implementation",
        "A large minority of primary care encounters never reach a diagnosis - an ICD-only system silently discards them",
        "**ICPC-2 (International Classification of Primary Care, 2nd edition, WONCA)** is biaxial [ICPC-2]",
        "ICPC-2 has **17 chapters by body system coded with a letter** [ICPC-2]",
        "ICPC-2 has **7 components common to every chapter coded 1-99** [ICPC-2]",
        "The 7 components: complaints and symptoms; diagnostic and preventive procedures; medication and treatment; test results; administrative; referrals and follow-up; diagnoses [ICPC-2]",
        "ICPC-2 uniquely codes the **reason for encounter, the problem managed and the process of care** in a single episode structure [ICPC-2]",
        "Episode-based coding of reason for encounter is why ICPC-2 is the classification recommended for family practice [ICPC-2]",
        "In India the **Ayushman Bharat Digital Mission (ABDM, 2021)** provides the ABHA number and the Health Facility and Healthcare Professional Registries [ABDM 2021]",
        "The **EHR Standards for India (2016, MoHFW)** specify SNOMED CT for clinical terms, LOINC for laboratory data and HL7 FHIR for exchange [EHR Standards 2016]",
        "ABDM and the EHR Standards are the framework any new practice software must follow",
      ],
    },
    {
      ...
      points: [
        ...
        "Audit works through systematic review of care against explicit criteria and the implementation of change [NICE 2002]",
        "The **five stages of the audit cycle**: 1 select topic and set criteria and standards; 2 measure current performance; 3 compare and analyse the gap; 4 implement change; 5 re-audit",
        "Stage 5, **re-audit, closes the loop** - an audit that stops at stage 3 is a survey, not an audit",
        "Omitting the re-audit is the commonest reason marks are lost on the audit question",
        "Each completed loop should reach a higher standard rather than return to the start - so the process is drawn as an **audit spiral**, not a closed circle",
        "A **criterion** is a measurable statement of what should happen - every diabetic should have an HbA1c in the last 12 months",
        "A **standard** is the level of performance expected - a percentage with a timeframe, such as 90% within 12 months",
        "Standards may be set as **minimum, ideal or optimum**",
        "**Donabedian (1966) classifies criteria into structure, process and outcome** [Donabedian 1966]",
        "Structure criteria: a working glucometer, a functioning cold chain [Donabedian 1966]",
        "Process criteria: proportion of diabetics with a documented foot examination [Donabedian 1966]",
        "Outcome criteria: proportion with HbA1c below 7% [Donabedian 1966]",
        "**Process criteria are preferred in audit** - under the practice's control, need smaller numbers and less confounded than outcomes",
        "Topic selection: the **problem should be high volume, high risk, high cost or known to be problematic**",
        "The audit must be feasible - data already exist or can be collected in a defined period",
        "A **criterion-based audit** measures care against explicit criteria",
        "A **significant event analysis** examines a single case in structured detail - a missed myocardial infarction, a drug error, a maternal death",
      ],
    },
    {
      heading: "Doing an audit in a small practice, and quality indicators",
      points: [
        "A workable small-practice audit is deliberately narrow - one criterion, a defined population, a defined period",
        "Sample about **50-100 records**, consecutive or by systematic random sampling - so the sample is not the memorable patients",
        "Write-up structure: **title, reason for audit, criteria and standards, method with sample and period, first-cycle results**",
        "Write-up continues: discussion of the gap, changes agreed with names and dates, second-cycle results",
        "This write-up structure is also what the DNB thesis-style audit question expects",
        "Change must be **specific and owned** - a note on the wall changes nothing",
        "Changes that work: a template field that will not close without an HbA1c date, a monthly recall list printed by the receptionist, a named person responsible",
        "**PDSA (Plan-Do-Study-Act) cycles** are the improvement engine within the audit",
        "PDSA means small, rapid, repeated tests of change on a few patients at a time - more effective in a small practice than one large annual effort",
        "**Quality indicators** are routinely measured markers that keep the practice honest between audits",
        "Indicator examples: immunisation coverage of listed under-fives, proportion of hypertensives with BP under 140/90, antibiotic prescribing rate for URTI",
        "Further indicators: proportion of prescriptions by generic name, TB register defaulter rate, appointment waiting time, patient satisfaction",
        "**Audit is not research** - audit asks whether we are doing what we have already agreed is right",
        "Audit never requires the patient to be randomised or exposed to anything new",
        "Audit usually needs **service or institutional approval rather than ethics committee review**",
        "Research asks what the right thing to do is - it requires a formal protocol, ethics committee approval and informed consent",
        "Research is intended to be generalised; audit is local",
      ],
    },
    {
      heading: "Practice management around the record",
      points: [
        "**Registration and the panel:** every practice should be able to state its denominator - the number of individuals and families registered",
        "Coverage, recall and audit are all meaningless without a denominator",
        "In an Indian urban practice the denominator is usually built from the family folder rather than a formal list",
        "**Disease registers** - diabetes, hypertension, tuberculosis, pregnancy, under-fives, elderly, palliative care - are the practical output of coding",
        "Registers drive recall letters, phone reminders and the monthly defaulter list",
        "The tuberculosis register must be reconciled with **Nikshay notification**",
        "**Appointment and flow systems** matter clinically - booked slots plus a daily quota of same-day access preserves both continuity and first-contact care",
        "The **third next available appointment** is a better access indicator than mean waiting time",
        "**Drug and cold chain management** is an examinable practice management item",
        "Keep a limited essential drug list based on the practice's own morbidity data",
        "Rotate stock first-expiry-first-out and keep temperature logs for vaccines",
        "Keep a documented biomedical waste segregation system under the **Bio-Medical Waste Management Rules 2016**",
        "Confidentiality: records are the property of the practice but the **information belongs to the patient**",
        "Access is on a need-to-know basis; digital records need individual logins and audit trails",
        "The **Digital Personal Data Protection Act 2023** now applies to health data held by the practice",
        "**Team and training:** written job descriptions, a practice protocol folder and regular clinical meetings including significant event analysis",
        "Mandatory training in basic life support, injection safety and infection control - these turn a clinic into a practice",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Quality improvement process** reviewing care against explicit criteria, implementing change, and re-measuring to confirm improvement [NICE 2002]",
            "Purpose: to close the gap between the care given and the care the available evidence says should be given",
            "Audit is a professional, local and continuous activity - owned by the clinical team that delivers the care",
          ],
        },
        {
          heading: "2. Stages of the audit cycle",
          points: [
            "**Stage 1** - select the topic: high volume, high risk, high cost or known problem",
            "Stage 1 also sets the criteria and standards",
            "**Stage 2** - measure current performance: define the population, sample, period and data source",
        ...
        },
        {
          ...
          points: [
            "**Criterion**: a measurable statement of what should happen",
            "**Standard**: the percentage of the time it should happen, with a timeframe",
            "**Donabedian (1966)** classifies criteria into structure, process and outcome [Donabedian 1966]",
        ...
        },
        {
          ...
          points: [
            ...
            "Criterion: every registered diabetic should have an HbA1c recorded within the previous 12 months",
            "Standard: **90%**",
            "First cycle: **96 of 150 (64%)** had a recorded HbA1c - a shortfall of 26 percentage points against the standard",
            "Reasons found: no recall system, cost of the test, no template prompt, no ownership of the register",
            "Changes: a monthly recall list printed by the receptionist and a mandatory HbA1c date field in the consultation template",
            "Further changes: a negotiated laboratory rate and a named nurse owning the register",
            "Second cycle at 6 months: **132 of 150 (88%)**",
            "Residual defaulters identified individually for home follow-up",
            "Third cycle raises the standard to include HbA1c below 7% - the spiral, not the circle",
          ],
        },
        {
          heading: "5. Audit compared with research",
          points: [
            "**Audit** asks whether we are doing what we have agreed is right",
            "**Research** asks what the right thing to do is",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Problems are never erased - only moved to inactive with a date",
            "**Initial plans**: written per problem under diagnostic, therapeutic and patient education headings [Weed 1968]",
        ...
        },
        {
          ...
          points: [
            ...
            "**Plan**: investigation, treatment with dose and duration, education, referral and review interval",
            "The plan records safety netting in the words used",
        ...
        },
        {
          ...
          points: [
            ...
            "Makes continuity portable between doctors and across years",
            "Generates the registers that drive recall and audit",
            "Family folder with a family page carrying the genogram, household composition and socio-economic classification",
            "Medico-legal value: **NMC Regulation 1.3** requires records in a standard proforma [NMC 2002]",
            "Records are retained **three years and released within 72 hours** of a request [NMC 2002]",
          ],
        },
        {
          ...
          points: [
            ...
            "Problem lists decay unless someone is responsible for pruning them",
