      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "Quality is measured against the **National Quality Assurance Standards** and certified through NQAS - certification ties funding to measured quality [NQAS 2013]",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Coding turns notes into data** - registers, recall and audit are impossible while the information sits only in free text [ICPC-2]",
        ...
        "A large minority of primary care encounters **never reach a diagnosis** - an ICD-only system silently discards them [ICPC-2]",
        "**ICPC-2 (International Classification of Primary Care, WONCA)** is biaxial - one axis for body system, one for the type of item [ICPC-2]",
        "ICPC-2 has **17 chapters by body system, each coded with a letter** - the letter is the first character of every code [ICPC-2]",
        "ICPC-2 has **7 components common to every chapter, coded 1 to 99** - the same component number means the same thing in each chapter [ICPC-2]",
        "The 7 components: **symptoms, procedures, medication, test results, administrative, referrals, diagnoses** - every chapter carries all seven [ICPC-2]",
        "ICPC-2 codes the **reason for encounter, the problem managed and the process of care** in one episode - the visit is not the unit of analysis [ICPC-2]",
        "Coding the reason for encounter is why **ICPC-2 is recommended for family practice** - it captures symptoms that never become diagnoses [ICPC-2]",
    ...
    },
    {
      ...
      points: [
        ...
        "This structure is **what the DNB audit question expects** - marks follow the stages, so an answer without re-audit loses them [NBEMS]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Disease registers** for diabetes, tuberculosis, pregnancy and under-fives are the practical output of coding - free text yields no register [ICPC-2]",
        ...
        "Mandatory training in **basic life support, injection safety and infection control** - these are what turn a clinic into a practice [NQAS 2013]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "The POMR needs **coding, ICPC-2 or ICD-10**, before the record becomes analysable data - free text alone cannot be counted [ICPC-2]",
          ],
        },
      ],
      mustDraw: [
...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "**Oxford CEBM level 1**: a systematic review of RCTs, or one RCT with a narrow confidence interval - the design least open to bias [OCEBM 2009]",
        "**Level 2**: cohort studies and low-quality RCTs - allocation is not random, so confounding cannot be excluded [OCEBM 2009]",
        "**Level 3**: case-control studies - exposure is measured after the outcome, so recall bias is structural [OCEBM 2009]",
        "**Level 4**: case series and poor-quality cohort or case-control studies - with no comparison group no association can be tested [OCEBM 2009]",
        "**Level 5**: expert opinion or reasoning from physiology - plausible mechanisms have repeatedly proved wrong in trials [OCEBM 2009]",
        "**Grade A** recommendation comes from consistent level 1 studies - the grade summarises the evidence standing behind the advice [OCEBM 2009]",
        "**Grade B**: consistent level 2 or 3 studies, or extrapolation from level 1 - extrapolation always costs a grade [OCEBM 2009]",
        "**Grade C**: level 4 studies, or extrapolation from level 2 or 3 - enough to suggest a practice, not to mandate it [OCEBM 2009]",
        "**Grade D**: level 5 evidence, or troublingly inconsistent studies at any level - inconsistency counts as weakness however high the design [OCEBM 2009]",
        "The hierarchy is a **starting presumption, not a rule** - a large clean cohort can outrank a small unblinded RCT with 40% attrition [OCEBM 2009]",
        ...
        "**GRADE** is used by WHO, NICE and Cochrane - it grades confidence in the estimate rather than the design label alone [GRADE 2011]",
        "In GRADE evidence starts **high for RCTs and low for observational studies** - and then moves on how the study was actually conducted [GRADE 2011]",
        "GRADE **downgrades for risk of bias, inconsistency, indirectness, imprecision and publication bias** - 5 downgrade domains [GRADE 2011]",
        "GRADE **upgrades for a large effect, a dose-response gradient, or confounding that would only shrink the effect** - each argues against bias [GRADE 2011]",
        "GRADE ends with **four certainty levels - high, moderate, low, very low** [GRADE 2011]",
        "GRADE has only **two recommendation strengths - strong (we recommend) and conditional or weak (we suggest)** [GRADE 2011]",
        "Recommendation strength depends on **benefits and harms, values and resources** - not on the quality of the evidence alone [GRADE 2011]",
        "State it in one line: the **level of evidence describes the study; the grade describes what you should do** [GRADE 2011]",
      ],
    },
    {
      ...
      points: [
        ...
        "Check trial registration - CTRI in India, ClinicalTrials.gov - and reporting to **CONSORT 2010** including the flow diagram [CONSORT 2010]",
      ],
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "Best design: a **systematic review of RCTs, or one large RCT with hard endpoints** - a therapy question needs randomised allocation [OCEBM 2009]",
          ],
        },
        {
          ...
          points: [
            ...
            "Was the trial registered - CTRI or ClinicalTrials.gov - and reported to **CONSORT 2010** [CONSORT 2010]",
          ],
        },
        {
  ...
  sections: [
    {
      ...
      points: [
        ...
        "Most DNB family medicine theses are **cross-sectional** for this reason - three years allows one round of data, not a follow-up cohort [NBEMS]",
        ...
        "**Mixed-methods** designs pair a survey with qualitative work - barriers need both counting and explaining, which neither method does alone [IJFMPC]",
      ],
    },
    {
    ...
    },
    {
      ...
      points: [
        "**NBEMS requires the thesis protocol within a defined window of joining** - broadly the first six months [NBEMS]",
        "The completed thesis must be **submitted by the prescribed date** - late submission bars the candidate from that examination session [NBEMS]",
        "**Acceptance of the thesis is a precondition for sitting the final examination** - so the thesis is a scheduling problem as much as a scientific one [NBEMS]",
        ...
        "IMRAD is preceded by **title page, certificates, declaration, acknowledgements, contents, abbreviations and abstract** - the abstract is read first [NBEMS]",
        "IMRAD is followed by **references, annexures and the master chart** - the master chart is what allows the analysis to be checked [NBEMS]",
        ...
        "Report the work by the matching guideline: **CONSORT for trials, STROBE for observational studies** - editors check the checklist before review [CONSORT 2010]",
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "**Study period**: 12 months, with 6 months of data collection - the rest goes to approvals, piloting, analysis and writing up [NBEMS]",
  ...
  sections: [
    {
      ...
      points: [
        "**Biostatistics** is the science of collecting, summarising, presenting, analysing and drawing inferences from data relating to living beings [Mahajan 9e]",
        "A **variable** is any characteristic that differs between individuals [Mahajan 9e]",
        "Identifying the variable type is the first and most examined step - **the type of variable dictates both the summary measure and the statistical test**",
        "**Qualitative (categorical) data** are counted, not measured [Park 27e]",
        "**Nominal** data have named categories with no order - sex, blood group, religion, cause of death [Park 27e]",
        "A two-category nominal variable is called **dichotomous or binary**",
        "**Ordinal** data have categories with a rank but unequal or unknown intervals - pain graded mild, moderate or severe, socio-economic class, NYHA class, Likert responses",
        "**Quantitative (numerical) data** are measured [Park 27e]",
        "**Discrete** data take only whole values obtained by counting - parity, number of episodes of diarrhoea in a year",
        "**Continuous** data can take any value within a range - height, weight, haemoglobin, blood pressure - limited only by the precision of the instrument",
        "The classical **scales of measurement are nominal, ordinal, interval and ratio** [Sundar Rao 5e]",
        "An **interval scale has equal intervals but an arbitrary zero** - temperature in degrees Celsius; 40 degrees is not twice as hot as 20",
        "A **ratio scale has a true zero** - weight, height, pulse rate, serum creatinine - so ratios are meaningful",
        "**Down-grading data always loses information** - haemoglobin recoded as anaemic or not converts continuous data into binary",
        "Down-grading discards the size of the deficit and reduces the statistical power of the study",
        "Measure at the highest scale available and categorise only at the analysis stage if you must",
        "In a research protocol every variable must be listed with its **operational definition, its type and its unit**",
        "The examiner's favourite viva question is what type of variable your outcome is and why you chose your test",
      ],
    },
    {
      heading: "Summarising data: central tendency, dispersion and shape",
      points: [
        "**Measures of central tendency: mean, median and mode** [Park 27e]",
        "**The mean** is the sum of observations divided by their number - uses every value, but is dragged by outliers",
        "**The median** is the middle value when data are arranged in order, or the average of the two middle values when n is even - unaffected by outliers",
        "**The mode** is the most frequently occurring value - the only measure usable for nominal data",
        "**Use the mean for symmetrical (normally distributed) continuous data** [Mahajan 9e]",
        "**Use the median for skewed data** or data with outliers or open-ended classes - income, hospital stay, incubation period",
        "**Use the mode for nominal data**",
        "Reporting a mean income or a mean length of stay is the classic error - both are right-skewed",
        "**Measures of dispersion: range, interquartile range, variance, standard deviation, coefficient of variation** [Park 27e]",
        "**The range** is crude - it uses only the extremes",
        "**The interquartile range** is the middle 50% - quoted with the median",
        ...
        "The CV is used to compare variability between variables measured in different units or on very different scales",
        "**Skewness** describes asymmetry",
        "In a positively (right) skewed distribution the tail is to the right and **mean > median > mode** - income, serum triglycerides, length of stay",
        "In a **negatively (left) skewed** distribution the order is reversed - mode > median > mean",
        "In a perfectly symmetrical distribution the mean, median and mode coincide",
        "**The normal (Gaussian) distribution** is a symmetrical bell-shaped curve completely defined by its mean and standard deviation [Park 27e]",
        "In the normal distribution mean = median = mode, and the total area under the curve equals 1",
        "**68.3% of observations lie within 1 SD of the mean** [Park 27e]",
        "**95.4% lie within 2 SD (95% within 1.96 SD)** [Park 27e]",
        "**99.7% lie within 3 SD (99% within 2.58 SD)** [Park 27e]",
        "These percentages are the basis of biological reference ranges - and must be quoted exactly",
        "**Standard deviation describes the spread of the individual observations** [Altman 1999]",
        "**Standard error of the mean describes the precision of the estimate of the mean** [Altman 1999]",
        "**SEM = SD / square root of n** - so it falls as the sample grows while the SD does not",
        "Quoting SEM instead of SD to make data look tight is a recognised form of misrepresentation",
      ],
    },
    {
      heading: "From sample to population: confidence intervals and hypothesis testing",
      points: [
        "A study measures a **sample** in order to say something about a population [Altman 1999]",
        "**Sampling error** is the difference between the sample estimate and the true population value - quantified by the standard error",
        "**A 95% confidence interval is the sample estimate plus or minus 1.96 standard errors** [Altman 1999]",
        "A 95% CI constructed this way will contain the true population value in 95 of every 100 such samples",
        "A **narrow interval means a precise estimate**",
        "A wide interval means an underpowered study - however impressive the point estimate",
        ...
        "For a **difference between means the interval is significant if it excludes 0**",
        "For a **ratio measure - odds ratio, risk ratio, hazard ratio - it is significant if it excludes 1**",
        "Hypothesis testing begins with the **null hypothesis (H0)**: there is no difference or no association [Mahajan 9e]",
        "The alternative hypothesis (H1) states that there is a difference or association",
        "The **p value** is the probability of observing a difference at least as large as the one found if the null hypothesis were true",
        "**A p value below 0.05 leads to rejection of the null hypothesis**",
        "The p value is **not the probability that the null hypothesis is true** - saying so is the commonest conceptual error in a thesis viva",
        "The p value is not the probability that the result is due to chance alone",
        "The p value is not a measure of the size or clinical importance of the effect",
        "A very large study can produce a highly significant p value for a clinically trivial difference",
        ...
        "**Power = 1 - beta** - conventionally set at 80% or 90%",
        "Power rises with a larger sample, a larger effect size, smaller variability and a higher alpha",
        "**Multiple significance testing inflates the type I error** - so subgroup analyses must be pre-specified and corrected",
      ],
    },
    {
      heading: "Choosing and interpreting a test of significance",
      points: [
        "Choose the test from **four questions: type of outcome data, number of groups, paired or independent, normally distributed or not** [Altman 1999]",
        "Answering those four questions aloud is what earns the mark - not the name of the test",
        "**Parametric tests** are for continuous, normally distributed data",
        "**Unpaired (independent) Student t test**: two independent groups [Mahajan 9e]",
        "**Paired t test**: two measurements on the same subjects - before and after treatment [Mahajan 9e]",
        "**One-way ANOVA**: three or more independent groups - followed by a post-hoc test such as Tukey to say which pairs differ",
        "**Repeated-measures ANOVA**: three or more measurements on the same subjects",
        "**Non-parametric tests** are for continuous but skewed data, ordinal data, or small samples",
        "**Mann-Whitney U test**: two independent groups [Mahajan 9e]",
        "**Wilcoxon signed-rank test**: two paired measurements [Mahajan 9e]",
        "**Kruskal-Wallis test**: three or more independent groups",
        "**Friedman test**: three or more paired measurements",
        "Non-parametric tests make no assumption about the distribution - but have slightly less power when the data really are normal",
        "**Chi-square test**: association between two categorical variables in independent groups [Park 27e]",
        "Chi-square requires an **expected count of 5 or more in at least 80% of cells** - if not, use Fisher's exact test",
        "**McNemar's test**: paired categorical data - before and after in the same subjects, or matched pairs",
        "**Chi-square test for trend**: an ordered exposure",
        "**Pearson's correlation coefficient (r)**: two continuous, normally distributed variables [Mahajan 9e]",
        "**Spearman's rank correlation (rho)**: skewed or ordinal data",
        "**r ranges from -1 to +1** - 0 is no linear relationship",
        "**Correlation is not causation**",
        "**r-squared, not r, is the proportion of variance explained** - an r of 0.5 explains only 25% of the variance",
        "**Linear regression** predicts a continuous outcome from one or more predictors",
        "**Logistic regression** predicts a binary outcome and yields adjusted odds ratios",
        "**Cox proportional hazards regression** analyses time-to-event data and yields hazard ratios",
        "Survival data are summarised by the **Kaplan-Meier curve** - which handles censored observations",
        "Two survival curves are compared by the **log-rank test**",
      ],
    },
    {
      ...
      points: [
        ...
        "**Incidence** is the number of new cases in a defined population at risk in a defined period, divided by the population at risk [Park 27e]",
        "Incidence measures the **risk of developing the disease**",
        "**Prevalence** is the number of existing (old plus new) cases at a point or over a period, divided by the population [Park 27e]",
        "Prevalence measures the **burden of disease**",
        "**Prevalence = incidence x average duration** in a steady state [Park 27e]",
        "A chronic incurable disease therefore has a high prevalence with a low incidence",
        "A successful new cure reduces prevalence while leaving incidence unchanged",
        "**Crude birth rate**: live births per 1000 mid-year population per year [Park 27e]",
        "**Crude death rate**: deaths per 1000 mid-year population per year [Park 27e]",
        "**Infant mortality rate**: deaths under 1 year per 1000 live births per year [Park 27e]",
        "**Neonatal mortality rate**: deaths under 28 days per 1000 live births [Park 27e]",
        "**Under-five mortality rate**: per 1000 live births [Park 27e]",
        "**Maternal mortality ratio**: maternal deaths per 100000 live births [Park 27e]",
        "The denominator and the multiplier are the marks in a vital statistics question",
        ...
        "Case fatality measures the virulence or severity of the disease - not its frequency in the population",
        "**Crude rates cannot be compared between populations with different age structures** - use standardisation [Park 27e]",
        "**Direct standardisation** applies the age-specific rates of each population to a chosen standard population [Park 27e]",
        "**Indirect standardisation** applies the age-specific rates of a standard population to the study population [Park 27e]",
        "Indirect standardisation gives the **standardised mortality ratio (SMR)** - used when study-population age-specific rates are unreliable or unavailable",
        "**Bar chart**: nominal data, with gaps between the bars [Park 27e]",
        "**Histogram**: continuous data, no gaps, area proportional to frequency [Park 27e]",
        "**Pie chart**: parts of a whole",
        "**Line or arithmetic graph**: a trend over time",
        "**Scatter diagram**: the relationship between two continuous variables",
        "**Spot map**: the geographical distribution of cases",
        "Every table needs a title, defined units and totals",
        "Every axis needs a label, with a scale that starts at zero unless the break is declared",
      ],
    },
    {
