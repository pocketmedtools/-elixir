  ...
  sections: [
    {
      ...
      points: [
        "**Sackett 1996 BMJ definition:** EBM is the conscientious, explicit and judicious use of current best evidence in making decisions about the care of individual patients [Sackett 1996]",
        "Quote the Sackett definition verbatim - it is the definition mark",
        "EBM means **integrating individual clinical expertise with the best available external clinical evidence from systematic research** [Sackett 1996]",
        "The three-legged stool of modern EBM: **best research evidence, clinical expertise, patient values and circumstances** [Straus 5e]",
        "An answer that omits patient values misses the point of the discipline - and loses the applied mark",
        "**The five steps (five As): Ask, Acquire, Appraise, Apply, Assess** [Straus 5e]",
        "**Ask** a focused answerable question; Acquire the best evidence efficiently [Straus 5e]",
        "**Appraise** the evidence for validity, importance and applicability [Straus 5e]",
        "**Apply** it to this patient after discussion; Assess or Audit your own performance in doing all four [Straus 5e]",
        "EBM is **not cookbook medicine and not cost-cutting** [Sackett 1996]",
        "Guidelines describe the average patient - the fourth step exists to decide whether this particular patient is the person the evidence describes",
        "This patient may be older, multimorbid, poorer or hold different priorities than the trial population",
        "Commonest EBM failures in Indian family practice: **extrapolation from trials in different populations** and prescribing from a drug representative's abstract",
        "A further common failure is **treating surrogate outcomes** - a lipid level, a bone density - as if they were patient-important outcomes such as fracture, stroke or death",
        "The corresponding skill is **information management, not information accumulation**",
        "Know four or five pre-appraised sources - Cochrane Library, BMJ Best Practice or UpToDate, PubMed Clinical Queries - rather than searching from scratch",
        "National guidelines such as the Standard Treatment Guidelines and the NTEP guidelines are also pre-appraised sources",
      ],
    },
    {
      ...
      points: [
        ...
        "**Foreground questions** ask about a specific decision in a specific patient and are structured as PICO [Straus 5e]",
        "**P - Patient, population or problem**: a 55-year-old man with type 2 diabetes and microalbuminuria",
        "**I - Intervention, exposure, index test or prognostic factor**: an ACE inhibitor",
        "**C - Comparison**: placebo or usual care - state it explicitly; no treatment is a legitimate comparator",
        "**O - Outcome** that matters to the patient: progression to end-stage renal disease, not a fall in albumin excretion",
        "Add **T for time horizon and type of study** where relevant - PICOT - because over 5 years changes both the search and the answer",
        "Match the design to the question - therapy and prevention: **RCT or systematic review of RCTs** [Straus 5e]",
        "**Diagnosis and screening**: cross-sectional study of consecutive patients with an independent, blinded comparison against a reference standard",
        "**Prognosis**: an inception cohort",
        "**Aetiology or harm**: a cohort study, or a case-control study when the outcome is rare or the exposure long-delayed",
        "**Frequency**: a cross-sectional survey",
        "**Patient experience or meaning**: qualitative research",
        "**Rare harms cannot be studied by RCTs** - a trial of 5000 patients cannot detect a 1 in 10 000 event",
        "Pharmacovigilance, case series and observational studies remain the evidence for adverse effects - absence of harm in trials is not evidence of safety",
        "Convert the question into a search: **MeSH terms plus free text, Boolean AND, OR and NOT, truncation, and a methodological filter**",
        "Search order: the Cochrane Library first, then PubMed Clinical Queries, and only then a general search",
      ],
    },
    {
      heading: "Levels of evidence and grades of recommendation",
      points: [
        "**Oxford CEBM level 1**: systematic review of RCTs, or an individual RCT with a narrow confidence interval [OCEBM 2009]",
        "**Level 2**: cohort studies and low-quality RCTs [OCEBM 2009]",
        "**Level 3**: case-control studies [OCEBM 2009]",
        "**Level 4**: case series and poor-quality cohort or case-control studies [OCEBM 2009]",
        "**Level 5**: expert opinion or reasoning from physiology or bench research [OCEBM 2009]",
        "**Grade A** recommendation: from consistent level 1 studies [OCEBM 2009]",
        "**Grade B**: from consistent level 2 or 3 studies, or extrapolation from level 1 [OCEBM 2009]",
        "**Grade C**: from level 4 studies, or extrapolation from level 2 or 3 [OCEBM 2009]",
        "**Grade D**: from level 5 evidence, or troublingly inconsistent or inconclusive studies at any level [OCEBM 2009]",
        "The hierarchy is a **starting presumption, not a rule** - a large, well-conducted cohort can outrank a small, unblinded RCT with 40% attrition",
        "Where randomisation is impossible or unethical, the best available evidence is observational",
        "**GRADE (Grading of Recommendations, Assessment, Development and Evaluation)** is used by WHO, NICE and Cochrane [GRADE 2011]",
        "In GRADE evidence starts **high for RCTs and low for observational studies** [GRADE 2011]",
        ...
        "GRADE **upgrades for a large effect size, a dose-response gradient, or when plausible confounding would only reduce the observed effect** [GRADE 2011]",
        ...
        "Recommendation strength depends on the balance of benefits and harms, values and resources - not on the evidence alone",
        "State the difference in one line: **the level of evidence describes the study; the grade of recommendation describes what you should do about it**",
      ],
    },
    {
      heading: "Critical appraisal of a randomised controlled trial",
      points: [
        "Appraisal asks **three questions in order: is it valid, is it important, is it applicable to my patient** [Greenhalgh 6e]",
        "Validity is internal validity; importance is the size and precision of the effect; applicability is external validity",
        "A trial that fails the validity question is not rescued by a spectacular result",
        "**Randomisation** removes selection bias and balances known and unknown confounders",
        "Truly random methods: computer-generated sequence, random number tables, permuted blocks, stratified randomisation",
        "Quasi-random allocation by alternation, date of birth or hospital number is not randomisation - the investigator can predict it",
        "**Allocation concealment is distinct from blinding** [Greenhalgh 6e]",
        "Allocation concealment is the **single item most strongly associated with exaggerated treatment effects** when absent",
        "Concealment means the recruiter cannot foresee the next assignment - central telephone or web randomisation, or sequentially numbered opaque sealed envelopes",
        "**Blinding** of participants, clinicians, outcome assessors and analysts protects against performance and detection bias",
        "Where blinding is impossible - surgery, physiotherapy - **blinded outcome assessment with objective endpoints** is the minimum substitute",
        "**Follow-up:** were all patients accounted for at the end and analysed in the groups to which they were randomised",
        "**Intention-to-treat analysis preserves randomisation** - the more conservative, more realistic estimate",
        "Per-protocol analysis reintroduces selection bias",
        "**Attrition above 20% seriously threatens validity** - check the worst-case sensitivity analysis",
        "Also check **baseline comparability** of the groups and equal treatment apart from the intervention - no co-intervention",
        "Check the outcome was patient-important and pre-specified - not a composite or a surrogate",
        "Check the size and precision of the effect with its **95% confidence interval**",
        "A trial **stopped early for benefit overestimates the effect**",
    ...
    },
    {
      ...
      points: [
        "Build the **2x2 table** with disease across the top (present, absent) and test result down the side (positive, negative)",
        "The cells are **true positives (a), false positives (b), false negatives (c), true negatives (d)**",
        "Draw the table before calculating anything - most exam errors are errors of orientation",
        "**Sensitivity = a/(a+c)** - the proportion of those with the disease who test positive",
        "**Specificity = d/(b+d)** - the proportion of those without the disease who test negative",
        ...
        "Predictive values answer the question the patient actually asks - given this result, do I have the disease",
        "**Predictive values vary steeply with prevalence** - a test that performs beautifully in a tertiary clinic generates mostly false positives in general practice",
        "**Likelihood ratios are the most useful appraisal statistic** - prevalence-independent yet convert directly to post-test probability",
        "**LR+ = sensitivity / (1 - specificity)**",
        "**LR- = (1 - sensitivity) / specificity**",
        "**LR+ above 10 or LR- below 0.1** produces a large and usually conclusive change in probability",
        "LR+ 5-10 or LR- 0.1-0.2: moderate change; LR+ 2-5 or LR- 0.2-0.5: small change; LR+ 1-2 or LR- 0.5-1: negligible change",
        "**Pre-test probability x LR gives post-test probability** - through Fagan's nomogram or by converting to odds",
        "**Accuracy = (a+d)/total; prevalence = (a+c)/total**",
        "**ROC curve area** summarises test performance across all cut-offs - 0.5 is useless, 1.0 is perfect",
      ],
    },
    {
      heading: "Treatment effects, meta-analysis and the forest plot",
      points: [
        "From a trial's 2x2 table take the **control event rate (CER) and experimental event rate (EER)**",
        "**Relative risk RR = EER/CER**",
        "**Absolute risk reduction ARR = CER - EER**",
        "**Relative risk reduction RRR = (CER - EER)/CER = 1 - RR**",
        "**Number needed to treat NNT = 1/ARR** - always rounded up, always quoted with the time period and the outcome",
        "**Number needed to harm NNH = 1/absolute risk increase**",
        "Relative measures look impressive and are prevalence-blind; **absolute measures and NNT are what the patient needs to hear**",
        "Presenting a 25% RRR without the 2% ARR is the commonest way evidence is used to mislead",
        "**Odds ratio = (a/c)/(b/d)** - used in case-control studies and logistic regression",
        "The OR **approximates the RR only when the outcome is rare (under about 10%)** - otherwise it exaggerates it",
        "A **95% confidence interval is the range within which the true value lies with 95% confidence**",
        "A CI that **crosses 1 for a ratio measure (RR, OR, HR)** is not statistically significant",
        "A CI that **crosses 0 for a difference measure (ARR, mean difference)** is not statistically significant",
        "A wide interval means an imprecise, underpowered study - even when the point estimate is impressive",
        "A **systematic review** uses an explicit, reproducible search and appraisal method to answer a focused question [Cochrane Handbook 6.4]",
        "A systematic review follows **PRISMA 2020** with a flow diagram and a registered protocol (PROSPERO) [PRISMA 2020]",
        "A **meta-analysis** is the optional statistical pooling of those results",
        "Meta-analysis weights each study, usually by the inverse of its variance - so larger, more precise studies count more",
        "**Forest plot:** each horizontal line is one study; the line is its 95% confidence interval",
        "The **square is the point estimate, its area proportional to the study's weight**",
        "The **vertical line is the line of no effect - 1 for ratios, 0 for differences**",
        "The **diamond at the bottom is the pooled estimate; its width is the pooled confidence interval**",
        "The pooled result is significant if the diamond does not touch the line of no effect",
        "Heterogeneity is judged by visual non-overlap of the intervals, the chi-square test with **p below 0.10**, and I-squared [Cochrane Handbook 6.4]",
        "**I-squared: 0-40% may not be important, 30-60% moderate, 50-90% substantial, 75-100% considerable** [Cochrane Handbook 6.4]",
        "Substantial heterogeneity calls for a random-effects model, subgroup analysis or no pooling at all",
        "**Publication bias is examined by a funnel plot** - asymmetry suggests missing small negative trials",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Three components: **best research evidence, clinical expertise, patient values and circumstances** [Straus 5e]",
            "EBM is not cookbook medicine and not a cost-containment tool",
            "The fourth step - apply - exists to individualise",
          ],
        },
        {
          ...
          points: [
            ...
            "**Acquire** the best evidence efficiently - pre-appraised sources first (Cochrane, BMJ Best Practice, national guidelines)",
            "After pre-appraised sources, search PubMed Clinical Queries",
        ...
        },
        {
          ...
          points: [
            ...
            "**O**: patient-important outcomes - stroke, myocardial infarction, cardiovascular death, treatment withdrawal for adverse effects",
            "Outcome time horizon: at least 3 years",
            "The fall in millimetres of mercury is a surrogate - not the outcome",
        ...
        },
        {
          ...
          points: [
            ...
            "Was allocation **concealed** from the recruiter - central randomisation or sequentially numbered opaque sealed envelopes",
            "Allocation concealment is the item most associated with exaggerated effects",
            ...
            "Was follow-up complete, with **attrition below 20%**",
            "Was the analysis by **intention to treat**",
            "Was the outcome pre-specified, patient-important and not a composite dominated by a soft component",
        ...
        },
        {
          ...
          points: [
            "Calculate **CER, EER, RR, RRR, ARR and NNT** with the outcome and the time period stated",
            "Examine the width of the **95% confidence interval** for precision",
            "Was the trial stopped early for benefit",
            "Was the effect driven by a subgroup or a post-hoc analysis",
            "Applicability: is my patient like the trial population in age, comorbidity, baseline risk and concomitant drugs",
            "Is the drug available, affordable and monitorable in my setting",
            "Are the benefits worth the harms, the cost and the burden to this patient - and what does the patient value",
            "Check funding source and conflicts of interest before changing practice",
            "A single trial rarely justifies replacing a proven, cheap first-line drug",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            ...
            "They convert pre-test to post-test probability using Fagan's nomogram or the odds method",
            "**LR+ above 10 or LR- below 0.1** gives a large, often conclusive change in probability",
            "LR values near 1 are useless",
          ],
        },
        {
          ...
          points: [
            ...
            "Moving the cut-off increases one at the expense of the other",
            "The **ROC curve** plots sensitivity against 1 - specificity across all cut-offs",
            "The area under the ROC curve summarises overall discrimination",
            "Screening uses sensitive tests first and confirms with specific tests - a missed case is worse than a temporary false alarm",
          ],
        },
        {
          ...
          points: [
            ...
            "False positives cause anxiety, further invasive tests, cost and labelling",
            "False negatives cause false reassurance",
            "Screening must additionally satisfy the **Wilson and Jungner criteria** - not merely have a good test",
            "Worked illustration: **90% sensitivity, 80% specificity, 10% prevalence gives PPV of only 33%** - two of every three positives are false",
          ],
        },
      ],
      mustDraw: [
