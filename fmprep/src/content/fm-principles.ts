  ...
  sections: [
    {
      ...
      points: [
        "The family is the **primary unit in which health behaviour, illness behaviour and care are learned** and practised [Rakel 9e]",
        "Diet, tobacco, exercise, help-seeking and adherence are all family behaviours before they are individual ones [Rakel 9e]",
        "**Genetic, infective and environmental exposures are shared** within the family [Rakel 9e]",
        "A genogram showing three first-degree relatives with diabetes changes the pre-test probability for the patient in front of you",
        "A smear-positive index case changes the management of the whole household",
        "Illness in one member **redistributes the burden** across the rest",
        "Example: school dropout of a daughter to care for a grandmother",
        "Example: a husband's alcohol dependence presenting as the wife's headache",
        "**Family support is the single strongest predictor of adherence** in chronic disease [Rakel 9e]",
        "Family support also predicts recovery after stroke or myocardial infarction, and survival in palliative care at home",
        "The family is also the source of harm: **domestic violence, child abuse, neglect of the elderly**",
        "Dowry-related stress and enforced dependence are family diagnoses - invisible if only the individual is assessed",
        "Family-oriented care in practice: **one family folder** with a genogram on the first page",
        "Family-oriented care means a habit of asking who else at home has this problem - a few minutes once that pays back for years",
      ],
    },
    {
      heading: "The genogram",
      points: [
        "A **genogram** is a pictorial display of family structure, medical history and relationships across at least three generations [McGoldrick 4e]",
        "The genogram was standardised by McGoldrick and Gerson from Bowen's family systems work [McGoldrick 4e]",
        "**Male is a square, female a circle** - age is written inside the symbol [McGoldrick 4e]",
        "The index patient (proband) is marked with a double outline or an arrow [McGoldrick 4e]",
        "A **deceased person has a cross through the symbol** with the age or year of death [McGoldrick 4e]",
        "**Marriage is a horizontal line** with the year of marriage [McGoldrick 4e]",
        "**Separation is one oblique stroke and divorce two** [McGoldrick 4e]",
        "A cohabiting or live-in relationship is a broken line [McGoldrick 4e]",
        "Children hang from a vertical line, **eldest on the left**; twins from a single point [McGoldrick 4e]",
        "A miscarriage is a small filled circle; a stillbirth is a crossed small symbol [McGoldrick 4e]",
        "**Household membership**: a dotted line drawn around those who live under one roof [McGoldrick 4e]",
        "The household line is the most useful line on an Indian genogram - it distinguishes a joint household from a nuclear one",
        "**Relationship lines**: a double line for close, three lines for fused or over-involved [McGoldrick 4e]",
        "Relationship lines: a jagged or zigzag line for conflict, a broken line for distant, a bar across for cut-off [McGoldrick 4e]",
        "Always record the **date drawn and the informant** - the family changes [McGoldrick 4e]",
        "Annotate each symbol with the significant diagnosis (diabetes, tuberculosis, alcohol dependence, depression) and the age at onset",
        "Uses: **genetic risk assessment** and identifying patterns of illness and behaviour across generations [McGoldrick 4e]",
        "Uses: finding the caregiver, planning home care, and teaching",
        "In the exam, drawing a genogram cleanly is worth more than describing it",
      ],
    },
    {
      heading: "The family life cycle and the family life line",
      points: [
        "**Duvall's eight stages** begin with the married couple without children [Duvall 5e]",
        "Duvall stage 2: childbearing family - oldest child to 30 months [Duvall 5e]",
        "Duvall stage 3: family with preschool children, 2.5-6 years [Duvall 5e]",
        "Duvall stage 4: family with school children, 6-13 years [Duvall 5e]",
        "Duvall stage 5: family with teenagers, 13-20 years [Duvall 5e]",
        ...
        "**Carter and McGoldrick's six stages** are used for the modern and the Indian extended family [Carter 4e]",
        "Carter-McGoldrick stages 1-3: leaving home (the unattached young adult), joining of families through marriage, family with young children [Carter 4e]",
        "Carter-McGoldrick stages 4-6: family with adolescents, launching children and moving on, the family in later life [Carter 4e]",
        "Each stage carries **developmental tasks** and predictable illness clusters [Duvall 5e]",
        "Childbearing stage cluster: colic and immunisation; school stage: injuries and school problems",
        "Adolescence cluster: risk behaviour and eating disorders; launching: empty-nest depression and menopause",
        "Later life cluster: dementia, bereavement and dependency",
        "**Horizontal stressors** are predictable transitions - birth, marriage, retirement [Carter 4e]",
        "**Vertical stressors** are inherited patterns, secrets, family myths and migration history [Carter 4e]",
        "A crisis usually occurs where a horizontal and a vertical stressor intersect [Carter 4e]",
        "**The family life line** is a chronological chart of significant events plotted against dates",
        "Life line events: marriage, births, deaths, migration, job loss, illness onsets",
        "The life line reveals **temporal association between life events and illness onset** - the family equivalent of a timeline",
        "The **Holmes and Rahe Social Readjustment Rating Scale** quantifies recent life change in life-change units",
        "Over **300 life-change units in a year** predicts a substantially raised risk of illness",
        "Death of a spouse scores **100** on the Holmes and Rahe scale",
        "**Hill's ABCX model** of family crisis: A is the stressor event",
        "ABCX: B is the family's crisis-meeting resources, C is the family's perception of the event",
        "ABCX: A interacting with B and C produces X, the crisis",
        "The **double ABCX model** of McCubbin adds pile-up and adaptation over time",
      ],
    },
    {
      heading: "The family APGAR",
      points: [
        "The **family APGAR** was described by Gabriel Smilkstein in 1978 as a five-item screening questionnaire [Smilkstein 1978]",
        ...
        "Each item scores **2 for almost always, 1 for some of the time, 0 for hardly ever** [Smilkstein 1978]",
        "Total APGAR score ranges from 0 to 10 [Smilkstein 1978]",
        "Interpretation: **7-10 highly functional** family [Smilkstein 1978]",
        "Interpretation: **4-6 moderately dysfunctional** [Smilkstein 1978]",
        "Interpretation: **0-3 severely dysfunctional** [Smilkstein 1978]",
        "The APGAR is quick - under two minutes - and can be given to more than one member",
        "The **discrepancy between members' scores** is itself informative",
        "A low score is a signal to explore, not a diagnosis of a dysfunctional family",
        "Limitations: subjective, culturally sensitive, poor at detecting violence or abuse",
        "The APGAR does not identify which relationship is the problem - follow it with a genogram and an interview",
      ],
    },
    {
      heading: "SCREEM and other assessment tools",
      points: [
        "**SCREEM** (Smilkstein) is an inventory of family resources and pathology across six domains [Rakel 9e]",
        "SCREEM domains: **Social interaction, Cultural, Religious, Economic, Educational, Medical** [Rakel 9e]",
        "For each domain ask whether it is a **resource** (helps the family cope) or a **pathology** (a source of strain) [Rakel 9e]",
        "A large extended family may be a resource or a pathology",
        "A strong religious community may provide food and transport, or may block contraception or transfusion",
        "**Economic** covers income, insurance, debt and out-of-pocket cost of the current illness",
        "**Educational** covers literacy and the ability to understand instructions - it determines the form your advice must take",
        "**Medical** covers access to and trust in health services, including previous experience",
        "**Ecomap**: the family is a central circle with lines to external systems - school, workplace, temple, PHC, employer, moneylender",
        "Ecomap line thickness shows strength and arrows show the direction of energy flow - the visual companion of SCREEM",
        "**Family circle** (Thrower): the patient draws a circle and places circles for family members",
        "Family circle size shows importance and distance shows closeness - a quick projective tool with children and adolescents",
        "**PRACTICE model** (Christie-Seely) for family-focused problem assessment: Presenting problem, Roles and structure, Affect",
        "PRACTICE continued: Communication, Time in the life cycle, Illness in the family and coping with stress",
        "PRACTICE continued: Coping with stress and community resources, Environment",
        "**Family types in India**: nuclear, joint, three-generation, extended, blended, single-parent [Kumar 2022]",
        "Skipped-generation family: grandparents raising children after parental migration [Kumar 2022]",
        "More than half of Indian households are now nominally nuclear but function within a joint network",
        "**Socio-economic classification** is part of family assessment [Kumar 2022]",
        "**Modified Kuppuswamy scale** for urban families: education, occupation and monthly family income [Kumar 2022]",
        "Kuppuswamy income slabs are revised annually with the consumer price index",
        "**BG Prasad scale** for rural families: per capita monthly income [Kumar 2022]",
      ],
    },
    {
      heading: "Recognising and managing family dysfunction",
      points: [
        "Clue to family dysfunction: **frequent attendance with unexplained symptoms**",
        "Clue: poor adherence in a well-informed patient",
        "Clue: repeated missed appointments for a child",
        "Clue: a controlling accompanying relative",
        "Clue: injuries with an inconsistent history",
        "Clue: adolescent behaviour change",
        "**Family conferences** are a specific therapeutic tool - convene the family with the patient's consent [Rakel 9e]",
        "Conference method: set an explicit agenda, allow each member to speak, name the shared goal",
        "Conference method: allocate tasks by name and set a review date",
        "**Do not attempt joint counselling where violence is suspected** - see the person alone",
        "In suspected violence: assess immediate safety and document injuries",
        "Offer referral to a one-stop centre or protection officer under the **Protection of Women from Domestic Violence Act 2005**",
        "Evidence-based family intervention: **family-based DOTS support** in tuberculosis",
        "Evidence-based family intervention: family involvement in diabetes self-management",
        "Evidence-based family intervention: family psychoeducation in schizophrenia - **halves relapse**",
        "Evidence-based family intervention: home-based caregiver training in stroke and dementia",
        "The **caregiver** is a patient too - caregiver burden, depression and physical illness are common and unasked-about",
        "Screen the caregiver at the same visit",
        "**Confidentiality within the family** is a constant tension - information given by one member cannot be shared with another without permission",
        "An adolescent's confidentiality must be protected except where there is risk of serious harm",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Illness behaviour and help-seeking are learned in the family [Rakel 9e]",
            "Adherence in chronic disease is largely a **family behaviour**",
        ...
        },
        {
          ...
          points: [
            "A pictorial record of at least **three generations** with standard symbols [McGoldrick 4e]",
            "Square for male, circle for female, age inside the symbol [McGoldrick 4e]",
            "Double outline for the index patient, cross for the deceased [McGoldrick 4e]",
            "Marriage line with year; **one stroke for separation and two for divorce** [McGoldrick 4e]",
            "Children hang below with the eldest on the left [McGoldrick 4e]",
            "A dotted line encloses the household [McGoldrick 4e]",
            "Relationship lines: double for close, jagged for conflictual, broken for distant, bar for cut-off [McGoldrick 4e]",
            "Annotate diagnoses and age at onset",
            "Date the genogram and name the informant [McGoldrick 4e]",
          ],
        },
        {
          heading: "3. Developmental assessment: life cycle and life line",
          points: [
            "**Duvall's eight stages** or Carter and McGoldrick's six stages [Duvall 5e]",
            "Name the developmental tasks of the family's current stage [Duvall 5e]",
            "**Horizontal stressors** (transitions) against vertical stressors (inherited patterns) [Carter 4e]",
            "Crisis occurs at the intersection of a horizontal and a vertical stressor [Carter 4e]",
            "The **family life line** plots dates of major events against illness onsets to reveal temporal associations",
            "The **Holmes and Rahe scale** quantifies recent life change",
            "Over **300 life change units** in a year raises illness risk",
          ],
        },
        {
          heading: "4. Functional assessment: APGAR, SCREEM, ecomap",
          points: [
            "**Family APGAR**: adaptation, partnership, growth, affection, resolve [Smilkstein 1978]",
            "APGAR: each item 0-2, total 0-10 [Smilkstein 1978]",
            "APGAR: **7-10 functional, 4-6 moderately dysfunctional, 0-3 severely dysfunctional** [Smilkstein 1978]",
            "**SCREEM**: social, cultural, religious, economic, educational and medical domains [Rakel 9e]",
            "Each SCREEM domain is classified as resource or pathology [Rakel 9e]",
            "**Ecomap** for external systems; family circle for perceived closeness",
            "**PRACTICE model** for a structured family interview",
            "Socio-economic status by the **modified Kuppuswamy scale** (urban) or BG Prasad scale (rural) [Kumar 2022]",
          ],
        },
        {
          heading: "5. Application to newly diagnosed type 2 diabetes",
          points: [
            "**Genogram**: identify first-degree relatives with diabetes to establish familial risk",
            "Familial risk triggers opportunistic screening of the siblings and adult children who are at risk",
            "**Life cycle**: a man in the middle-aged parent stage has financial obligations and may prioritise work over clinic visits",
            "An elderly man in the ageing stage may depend on a daughter-in-law for insulin injections",
            "**APGAR**: a score of 4 with poor partnership predicts poor adherence [Smilkstein 1978]",
            "A low APGAR identifies the need to involve the wife who cooks and the son who buys the drugs",
            "**SCREEM economic**: can the family afford metformin plus strips?",
            "SCREEM educational: will written instructions work?",
            "SCREEM cultural: fasting practices such as Ramzan, Navratri or Karva Chauth alter drug timing",
            "**Intervention**: a family conference to agree one kitchen, not two",
            "Name the person who will collect the drugs and who will accompany him to review",
            "Screen the spouse and adult children for diabetes and hypertension",
            "Address the caregiver's own health",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Male a square, female a circle**, sex unknown a diamond [McGoldrick 4e]",
            "The current age is written inside the symbol [McGoldrick 4e]",
            "The index patient or proband is marked with a **double outline or an arrow** [McGoldrick 4e]",
            "A deceased person is crossed through, with the age or year and cause of death alongside [McGoldrick 4e]",
            "Marriage: a horizontal line with the year [McGoldrick 4e]",
            "**Separation one oblique stroke, divorce two** [McGoldrick 4e]",
            "Cohabitation is a broken horizontal line; remarriage is drawn to the right [McGoldrick 4e]",
            "Children descend on vertical lines from the marriage line, **eldest to the left** [McGoldrick 4e]",
            "Twins descend from a common point; adopted children on a broken vertical line [McGoldrick 4e]",
            "Miscarriage a small filled circle; stillbirth a small crossed symbol; termination a small cross [McGoldrick 4e]",
            "A **dotted line encircles those sharing a household** - essential in the Indian joint family [McGoldrick 4e]",
            "Relationship lines: double for close, triple for fused, jagged for conflict [McGoldrick 4e]",
            "Relationship lines: single broken for distant, a broken line with two bars for a cut-off [McGoldrick 4e]",
          ],
        },
        {
          heading: "Information recorded",
          points: [
            "Record names, ages, occupations and education [McGoldrick 4e]",
            "Record significant diagnoses with the **age at onset** [McGoldrick 4e]",
            "Record deaths with cause, migration, and major family events [McGoldrick 4e]",
        ...
        },
        {
          ...
          points: [
            ...
            "Teaching, research and medico-legal documentation of family structure",
      ...
      answer: [
        {
          ...
          points: [
            "**Duvall** stages 1-4: married couple; childbearing; preschool children; school-age children [Duvall 5e]",
            "Duvall stages 5-8: teenagers; launching; middle-aged parents; ageing family members [Duvall 5e]",
            "**Carter and McGoldrick** stages 1-3: the unattached young adult; the new couple; families with young children [Carter 4e]",
            "Carter and McGoldrick stages 4-6: families with adolescents; launching children and moving on; the family in later life [Carter 4e]",
            "Each stage has **developmental tasks** [Duvall 5e]",
            "Task examples: establishing a satisfying marital relationship, accommodating a first child",
            "Task examples: permitting adolescent autonomy, releasing young adults",
            "Task examples: adjusting to retirement and to bereavement",
          ],
        },
        {
          ...
          points: [
            ...
            "**Preschool and school age**: diarrhoea, respiratory infection, malnutrition, anaemia",
            "Preschool and school age also bring injuries and school problems",
            "**Adolescence**: substance use, risk-taking, mental health",
            "Adolescence also brings sexual and reproductive health issues and eating disorders",
            "**Launching and middle age**: menopause, empty nest depression",
            "Middle age brings onset of hypertension, diabetes and obesity, and the need for cancer screening",
            "**Later life**: dementia, falls, polypharmacy, bereavement",
            "Later life also brings dependency, elder abuse and palliative needs",
          ],
        },
        {
          heading: "Applications and Indian modifications",
          points: [
            "**Anticipatory guidance** - timing preventive services to the stage rather than to the calendar",
            "Recognising a crisis at the intersection of a **horizontal stressor** (transition) with a vertical stressor (inherited pattern, secret, migration) [Carter 4e]",
            "The Indian joint family blurs stages - several stages are present in one household simultaneously [Kumar 2022]",
            "Migration of the son creates a **skipped-generation household**",
            "The daughter-in-law's entry is a major unlisted transition in the Indian family",
            "The life cycle also predicts **caregiver burden**",
            "The middle-aged woman is the commonest hidden patient in an Indian household",
          ],
        },
      ],
