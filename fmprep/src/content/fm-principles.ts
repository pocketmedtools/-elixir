  ...
  sections: [
    {
      ...
      points: [
        ...
        "The consultation is the only procedure for which no formal training was traditionally given [Silverman 3e]",
        "**Beckman and Frankel 1984**: doctors interrupt the opening statement after about 18 seconds [Silverman 3e]",
        "A 2019 replication found a median interruption time of **11 seconds**",
        "Uninterrupted patients typically finish their opening statement in under 90 seconds [Silverman 3e]",
        "The **golden minute** - letting the patient speak uninterrupted at the start - shortens rather than lengthens the consultation",
        "The golden minute reduces the door-handle problem of a new complaint at the end",
        "**Consultation length in India** is short - BMJ Open 2017 put the average Indian primary care consultation at about 2 minutes",
        "The same 2017 comparison found 22 minutes in Sweden - a short consultation makes explicit structure more necessary, not less",
        "Good communication measurably improves **adherence, symptom control, satisfaction and diagnostic accuracy** [Silverman 3e]",
        ...
        "**Kurtz's dictum**: communication is a clinical skill, not a personality trait [Silverman 3e]",
    ...
    },
    {
      ...
      points: [
        "1. To **define the reason for the patient's attendance** [Pendleton 2003]",
        "Task 1 includes the nature and history of the problem and its aetiology [Pendleton 2003]",
        "Task 1 also includes the patient's **ideas, concerns and expectations** and the effects of the problem [Pendleton 2003]",
        "2. To **consider other problems** - continuing problems and at-risk factors [Pendleton 2003]",
        "Task 2 is where opportunistic prevention enters the consultation",
        "3. To **choose with the patient an appropriate action** for each problem - the word 'with' carries the mark [Pendleton 2003]",
        "4. To achieve a **shared understanding** of the problem with the patient [Pendleton 2003]",
        "5. To **involve the patient in the management** and encourage acceptance of appropriate responsibility [Pendleton 2003]",
        "6. To **use time and resources appropriately** - in the consultation and in the long term [Pendleton 2003]",
        "7. To **establish or maintain a relationship** with the patient which helps to achieve the other tasks [Pendleton 2003]",
        "The **2003 revision** (Pendleton, Schofield, Tate and Havelock) regroups the tasks around the patient's and doctor's agendas [Pendleton 2003]",
        "Despite the revision the seven tasks of 1984 remain the examinable list",
      ],
    },
    {
      heading: "Calgary-Cambridge guide (Kurtz and Silverman)",
      points: [
        "**Five sequential tasks**: initiating the session, gathering information, physical examination, explanation and planning, closing the session [Silverman 3e]",
        "Two tasks run throughout as continuous threads: **providing structure and building the relationship** [Silverman 3e]",
        "Drawing the two continuous tasks as vertical bars alongside the five boxes earns the diagram mark",
        "**Initiating** covers preparation, establishing rapport and identifying the reason for attendance with an open question [Silverman 3e]",
        "Initiating also covers screening ('is there anything else?') and agenda setting [Silverman 3e]",
        "**Gathering information** uses the open-to-closed cone [Silverman 3e]",
        ...
        "Gathering skills: attentive listening, facilitation, signposting and summarising [Silverman 3e]",
        ...
        "Explanation avoids jargon and moves to shared decision making [Silverman 3e]",
        "**Closing** covers summarising, contracting, safety netting and a final check that the patient is comfortable with the plan [Silverman 3e]",
        "The guide names about **70 evidence-based skills** [Silverman 3e]",
        "Calgary-Cambridge is the standard framework for teaching and assessing communication in an OSCE [Silverman 3e]",
      ],
    },
    {
      heading: "Other models the examiner expects",
      points: [
        "**Byrne and Long 1976**, Doctors Talking to Patients: six phases of the consultation",
        "Byrne and Long phases 1-3: relating to the patient, discovering the reason for attendance, verbal or physical examination",
        "Byrne and Long phases 4-6: consideration of the condition, detailing treatment or investigation, terminating",
        "Byrne and Long described doctor-centred versus patient-centred styles from **2500 audio-recorded consultations**",
        "**Stott and Davis 1979**: four potential areas in every consultation, drawn as a 2x2 box",
        "Stott and Davis areas: management of the presenting problem, modification of help-seeking behaviour",
        "Stott and Davis areas: management of continuing problems, opportunistic health promotion",
        ...
        "Housekeeping is the doctor's own emotional clearing before the next patient [Neighbour 2004]",
        "**Balint 1957**, The Doctor, His Patient and the Illness: the doctor as a drug with its own dosage and side effects [Balint 1964]",
        "Balint: the **flash** of insight and the apostolic function [Balint 1964]",
        ...
        "**Helman's folk model 1981**: six questions the patient wants answered",
        "Helman questions 1-3: what has happened, why has it happened, why to me",
        "Helman questions 4-6: why now, what would happen if nothing were done, what should I do or whom should I consult",
        "**Transactional analysis (Berne)**: parent-adult-child ego states",
        "The consultation works best adult-to-adult - a parent-child transaction generates dependency",
      ],
    },
    {
      ...
      points: [
        ...
        "Concerns: 'Is there anything in particular you were worried about?'",
        "Expectations: 'What were you hoping we could do today?'",
        "Add **effects on daily life and feelings** to complete the patient's agenda [Silverman 3e]",
        "The full set is sometimes taught as ICE-E, or as the illness framework opposite the disease framework [Silverman 3e]",
        "ICE must be **asked with genuine curiosity, not recited**",
        "A mechanical 'and what are your ideas, concerns and expectations?' loses marks in an OSCE and rapport in the clinic",
        "**BATHE** (Stuart and Lieberman, The Fifteen Minute Hour) is a one-minute psychosocial screen [Stuart 6e]",
        "**Background**: 'what is going on in your life?' [Stuart 6e]",
        "**Affect**: 'how do you feel about that?' [Stuart 6e]",
        "**Trouble**: 'what about it troubles you most?' [Stuart 6e]",
        "**Handling**: 'how are you handling it?' [Stuart 6e]",
        "**Empathy**: 'that must be very difficult for you' [Stuart 6e]",
        "BATHE is therapeutic as well as diagnostic [Stuart 6e]",
        "BATHE suits a short Indian consultation - the standard answer for addressing psychosocial issues without a separate counselling session",
        "**Motivational interviewing** (Miller and Rollnick) for behaviour change: express empathy, develop discrepancy",
        "Motivational interviewing also means roll with resistance and support self-efficacy",
        "Motivational interviewing uses **OARS** - open questions, affirmation, reflective listening, summarising",
      ],
    },
    {
      heading: "Difficult communication tasks",
      points: [
        "Breaking bad news uses the six-step **SPIKES** protocol [Baile 2000]",
        ...
        "In India the family often asks the doctor to **withhold a diagnosis from the patient**",
        "The ethical route to a non-disclosure request: explore why, then establish what the patient wants to know",
        "Respect a patient who chooses not to know - but never lie to a patient who asks a direct question",
        "**The angry patient**: allow ventilation, do not interrupt, sit down, acknowledge the emotion by name",
        "With anger, separate the grievance from the person and apologise for the experience without admitting negligence",
        "Offer the angry patient a concrete next step",
        "If there is any threat, move to a safe space and do not consult alone",
        "**The silent or somatising patient**: use silence, reflection and the BATHE frame",
        "Explain somatic symptoms with a mechanism rather than a denial - 'real pain caused by muscle tension', not 'nothing wrong'",
        "**Cross-cultural and language barriers**: use a trained interpreter rather than a child",
        "Speak to the patient, not the interpreter, and check understanding by teach-back",
        "**Safety netting** is the medico-legal core of a family practice consultation [Neighbour 2004]",
        "Safety net content: what you expect to happen, what would be unexpected, exactly what to look for, where to go and by when",
        "Record the safety net - an unrecorded safety net cannot be proved",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**Descriptive models**: Byrne and Long six phases (1976), with doctor-centred and patient-centred styles",
            "**Task-based models**: Pendleton's seven tasks (1984) [Pendleton 2003]",
            "Task-based models also include Stott and Davis four areas (1979)",
            "**Skill-based teaching models**: Calgary-Cambridge (1996), the three-function model [Silverman 3e]",
            "**Psychodynamic and relationship models**: Balint (1957), transactional analysis [Balint 1964]",
            "Relationship models also include Neighbour's inner consultation (1987) [Neighbour 2004]",
            "**Anthropological and patient-perspective models**: Helman's folk model (1981)",
            "Patient-perspective models also include the patient-centred clinical method of Stewart and Levenstein",
            "**Focused techniques**: BATHE for psychosocial screening [Stuart 6e]",
            "Focused techniques also include SPIKES for bad news and motivational interviewing for behaviour change [Baile 2000]",
          ],
        },
        {
          heading: "2. The Calgary-Cambridge guide",
          points: [
            "**Initiating the session**: preparation, establishing initial rapport [Silverman 3e]",
            "Initiating: identifying the reasons for the consultation with an open question [Silverman 3e]",
            "Initiating: screening for further problems and setting the agenda [Silverman 3e]",
            "**Gathering information**: exploring the problem with the open-to-closed cone [Silverman 3e]",
            "Gathering skills: attentive listening, facilitation, picking up cues, clarification, internal summary, signposting [Silverman 3e]",
            ...
            "**Physical examination**: explaining and obtaining permission, chaperone where indicated [Silverman 3e]",
            "**Explanation and planning**: the right amount and type of information by chunking and checking [Silverman 3e]",
            "Explanation aids accurate recall by categorisation and repetition [Silverman 3e]",
            "Explanation achieves shared understanding by relating explanations to the patient's illness framework [Silverman 3e]",
            "Explanation ends in shared decision making [Silverman 3e]",
            "**Closing the session**: summarising, contracting the next steps, safety netting and a final check [Silverman 3e]",
            ...
            "Building the relationship includes involving the patient by sharing thinking [Silverman 3e]",
          ],
        },
        {
          heading: "3. Application to three months of tiredness",
          points: [
            "**Initiating**: greet by name, sit at the same level, open with 'tell me about the tiredness'",
            "Let her speak uninterrupted, then screen for other agenda items before diving in",
            "**Gathering, disease framework**: onset, pattern through the day, sleep, weight",
            "Disease framework: menstrual and dietary history, bleeding per rectum or menorrhagia",
            "Disease framework: symptoms of hypothyroidism, diabetes, tuberculosis and depression, plus drug and family history",
            "**Gathering, illness framework**: 'What do you think is causing it?' - she may fear cancer or blood loss",
            "Illness framework: 'Is there anything you are particularly worried about?' and 'What were you hoping we might do?'",
            "Illness framework: the effect on her work and on caring for the family",
            "Screen with **BATHE** if the story is flat [Stuart 6e]",
            "**Examination**: pallor, pulse, BP, thyroid, lymph nodes, abdomen",
            "Examination includes a mental state screen with **PHQ-9**",
            "**Explanation and planning**: explain in chunks that the commonest causes are anaemia, thyroid disease, diabetes, sleep deprivation and depression",
            "Agree a first-line panel: haemoglobin, peripheral smear, blood sugar, TSH and urine routine",
            "Check understanding by **teach-back**",
            "**Closing**: summarise, agree who will bring the reports and when",
            "Safety net for bleeding, breathlessness, fever or weight loss",
            "Record the plan in **SOAP** format",
          ],
        },
        {
          heading: "4. Why models matter",
          points: [
            "Models convert an intuitive act into a **teachable, assessable skill** [Silverman 3e]",
            "Models give a structure to fall back on when the consultation drifts",
            "Models improve diagnostic accuracy, adherence, satisfaction and safety [Silverman 3e]",
            "Models reduce complaints - most of which arise from communication rather than competence [Silverman 3e]",
            "No model is used verbatim in a two-minute consultation",
            "The skilled family physician internalises one model and uses it as a checklist when the consultation goes wrong",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Background often produces the real reason for attendance [Stuart 6e]",
            ...
            "The specific concern is rarely what the doctor assumed [Stuart 6e]",
        ...
        },
        {
          ...
          points: [
            "Screening for **depression, anxiety, somatisation**, domestic stress, alcohol-related problems and caregiver strain [Stuart 6e]",
            "Managing the frequently attending patient with **medically unexplained symptoms** where investigation has been repeatedly negative [Stuart 6e]",
            "Supportive counselling in chronic disease, palliative care and bereavement [Stuart 6e]",
            "Reported benefit: better detection of psychosocial problems [Stuart 6e]",
            "Reported benefit: improved satisfaction [Stuart 6e]",
            "Reported benefit: **no significant lengthening** of the consultation [Stuart 6e]",
          ],
        },
        {
          heading: "Limitations and cautions",
          points: [
            "BATHE is a **screen, not a treatment** [Stuart 6e]",
            "A positive screen needs a fuller assessment with **PHQ-9 or GAD-7** and a management plan",
            "BATHE must not be used to close down a physical complaint that has not been properly evaluated",
      ...
      answer: [
        {
          ...
          points: [
            "**Setting**: a private room, sitting down, adequate time, mobile phone silenced [Baile 2000]",
            "Setting also means the person the patient wants present, and an available nurse or counsellor [Baile 2000]",
            "**Perception**: 'What have you been told about your illness so far, and what do you make of it?' [Baile 2000]",
            ...
            "The invitation question resolves most family conflicts - it lets the patient set the rule",
            "**Knowledge**: a warning shot - 'I am afraid the report is more serious than we hoped' [Baile 2000]",
            "After the warning shot, short chunks in plain language, pausing after each [Baile 2000]",
            "**Emotions**: allow silence, name the emotion, use an empathic statement [Baile 2000]",
            "Offer tissues and touch if culturally appropriate [Baile 2000]",
            "**Strategy and summary**: the treatment plan, who will do what, the symptom control that will be provided [Baile 2000]",
            "Strategy also covers the next appointment and written information [Baile 2000]",
          ],
        },
        {
          heading: "The family's request for non-disclosure",
          points: [
            "Meet the family first and acknowledge their motive",
            "Ask what specifically they fear will happen if he is told",
            "Explain that you will not force information on him",
            "Explain that you **cannot lie** if he asks a direct question",
            "Explain that most patients already suspect",
            "Use the **invitation step** to let the patient choose [Baile 2000]",
            "Document his stated preference - it protects everyone later",
            "Involve the family in the plan whatever he chooses - they will deliver most of the care",
          ],
        },
        {
          heading: "Ethical framework",
          points: [
            "**Autonomy**: the competent adult owns the information about his own body - the family does not",
            ...
            "**Therapeutic privilege** - withholding information because it might harm - is very narrow",
            "Therapeutic privilege cannot be used simply because the news is bad",
          ],
        },
      ],
