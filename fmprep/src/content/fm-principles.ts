  ...
  sections: [
    {
      ...
      points: [
        "Research is first divided into **descriptive studies**, which describe distribution, and analytical studies, which test an association or hypothesis [Park 27e]",
        "Descriptive designs: case report, case series, cross-sectional survey, ecological study [Park 27e]",
        "Analytical studies divide into **observational (case-control, cohort) and experimental or interventional** (RCT, community trial, field trial) [Park 27e]",
        "**Cross-sectional study:** exposure and outcome measured at the same point - so it gives prevalence [Park 27e]",
        "Cross-sectional studies are quick, cheap and useful for planning services",
        "Cross-sectional weakness: **temporality cannot be established** - it generates hypotheses rather than proving causation",
        "Most DNB family medicine theses are cross-sectional for this reason",
        "**Case-control study:** starts from the outcome and looks backwards at exposure - gives an odds ratio [Gordis 6e]",
        "Case-control is **efficient for rare diseases and long latent periods** - needs fewer subjects and less time",
        "Case-control is vulnerable to **recall bias and the choice of controls**, and cannot give incidence",
        "**Cohort study:** starts from the exposure and follows forward to the outcome [Gordis 6e]",
        "Cohort gives **incidence, relative risk and attributable risk**, establishes temporality and can study multiple outcomes of one exposure",
        "Cohort is expensive, slow, needs large numbers and suffers **loss to follow-up**",
        "Cohort is **efficient for rare exposures**",
        "A cohort can be prospective, retrospective (historical) or ambidirectional",
        "**Randomised controlled trial** is the strongest design for a therapeutic question - randomisation balances known and unknown confounders",
        "RCT variants: parallel group, crossover (for stable chronic conditions), factorial, non-inferiority",
        "**Cluster-randomised** trials randomise villages or clinics - which requires adjustment for the design effect",
        "**Qualitative research** - in-depth interviews, focus group discussions of 6 to 12 participants, participant observation",
        "Qualitative research answers questions of meaning, experience and barriers",
        "Qualitative data are analysed by thematic or content analysis, with sampling continued to **data saturation**",
        "Mixed-methods designs combine qualitative work with a survey - increasingly used in family medicine theses",
      ],
    },
    {
      heading: "Sampling, sample size and errors",
      points: [
        "Define the **reference population, study population, sampling frame and sampling unit** before choosing a method [Sundar Rao 5e]",
        "The commonest thesis error is a sampling frame that silently excludes the people the question is about",
        "**Probability sampling** allows statistical generalisation [Park 27e]",
        "**Simple random sampling**: lottery or random number table [Park 27e]",
        ...
        "Cluster sampling requires a design effect and hence a larger sample",
        "**Multistage sampling** is used in the National Family Health Survey [Park 27e]",
        "**Non-probability sampling** - convenience, purposive, quota, snowball - does not permit statistical generalisation",
        "Non-probability sampling is legitimate and often preferable in qualitative work",
        "Snowball sampling is the practical method for hidden populations such as people who inject drugs",
        "**Sample size for a proportion with absolute precision: n = Z squared x p x q / d squared** [Sundar Rao 5e]",
        "At 95% confidence (Z = 1.96, taken as 2) the formula simplifies to **n = 4pq/d squared**",
        "p is the anticipated prevalence in percent, q is 100 - p, d is the absolute precision in percentage points",
        "For **relative precision** substitute d with the fraction of p",
        "Adjust sample size for a **finite population and the design effect in cluster sampling**",
        "Adjust for expected non-response or dropout - usually **adding 10-20%**",
        "For **comparing two groups**, sample size depends on alpha, power, expected difference and variability",
        "**Alpha is conventionally 0.05; power (1 - beta) is conventionally 80% or 90%**",
        "Variability is the standard deviation or the two proportions; effect size is the expected difference",
        "The smaller the difference you wish to detect, the larger the sample - a doubling of precision costs a quadrupling of sample",
        "**Type I (alpha) error is rejecting a true null hypothesis** - a false positive",
        "**Type II (beta) error is failing to reject a false null hypothesis** - a false negative",
        "**Power = 1 - beta**",
        "An underpowered study is not a neutral result but an unethical one - patients were exposed to research that could not answer its question",
      ],
    },
    {
      heading: "Bias and confounding",
      points: [
        "**Bias is any systematic error in design, conduct or analysis that produces an estimate systematically different from the truth** [Gordis 6e]",
        "Unlike random error, bias is not reduced by increasing the sample size",
        "Once present, bias usually cannot be corrected in analysis",
        "**Selection bias** arises when those studied differ systematically from those not studied [Gordis 6e]",
        "**Berkson's (admission rate) bias** occurs in hospital-based case-control studies [Park 27e]",
        "**Neyman's (prevalence-incidence) bias** occurs when rapidly fatal or rapidly resolving cases are missed [Park 27e]",
        "Other selection biases: **healthy worker effect**, non-response bias, loss to follow-up bias",
        "**Information (measurement) bias** arises from how data are collected [Gordis 6e]",
        "**Recall bias**: cases remember exposures better than controls",
        "Other information biases: **interviewer bias and observer bias**",
        "**Social desirability bias** affects questions about alcohol, tobacco or sexual behaviour",
        "**Non-differential misclassification** biases towards the null; differential misclassification biases in either direction",
        "Bias is controlled by **design** - a clearly defined, consistently applied case definition and appropriate controls",
        "Further design controls: standardised and validated instruments, calibrated equipment, trained and blinded observers",
        "Blinding of participants and assessors, and a high response rate with follow-up of defaulters, also control bias",
        "**Confounding is a distortion of the exposure-outcome association by a third variable** [Gordis 6e]",
        "A confounder is independently associated with the exposure and is an independent risk factor for the outcome",
        "A confounder is **not on the causal pathway** between exposure and outcome",
        "Classic example: age or smoking in a study of alcohol and lung cancer",
        "Confounding is controlled **in the design by randomisation, restriction and matching** [Gordis 6e]",
        "Confounding is controlled **in the analysis by stratification (Mantel-Haenszel), standardisation and multivariable regression** [Gordis 6e]",
        "Randomisation is unique in also balancing **unknown and unmeasured** confounders - which is why it sits at the top of the hierarchy",
      ],
    },
    {
      heading: "Ethics, the ethics committee and informed consent",
      points: [
        "The ethics framework begins with the **Nuremberg Code (1947)**",
        "The **Declaration of Helsinki (WMA 1964, last revised 2013)** follows [Helsinki 2013]",
        "The **Belmont Report (1979)** is the third landmark",
        "In India the **ICMR National Ethical Guidelines for Biomedical and Health Research Involving Human Participants (2017)** apply [ICMR 2017]",
        "For drug trials the **New Drugs and Clinical Trials Rules 2019** apply, with registration of the ethics committee with the CDSCO [NDCT Rules 2019]",
        "The four principles: **autonomy, beneficence, non-maleficence and justice**",
        "ICMR expands these into 12 principles: **essentiality, voluntariness, non-exploitation, privacy and confidentiality, precaution and risk minimisation** [ICMR 2017]",
        "Further ICMR principles: **professional competence, accountability and transparency, maximisation of benefit, institutional arrangements** [ICMR 2017]",
        "Remaining ICMR principles: **public domain, totality of responsibility, environmental protection** [ICMR 2017]",
        "**Every study on human participants must have prior written approval from a registered Institutional Ethics Committee** before recruitment [ICMR 2017]",
        "A record review or a questionnaire survey also needs IEC approval",
        "The IEC has **at least seven members** including a chairperson from outside the institution and a member secretary [ICMR 2017]",
        "IEC membership: a basic medical scientist, clinicians, a legal expert, a social scientist or philosopher or NGO representative, and a **lay person** [ICMR 2017]",
        "The IEC must have **both sexes represented** and no more than half its members from the same institution [ICMR 2017]",
        "**Informed consent has three elements - information, comprehension and voluntariness** [ICMR 2017]",
        "Consent must cover purpose, procedures, duration, foreseeable risks and benefits, alternatives, confidentiality and its limits",
        "Consent must also cover compensation for research-related injury and contact details of the investigator and ethics committee",
        "Consent must include the **right to refuse or withdraw at any time without loss of usual care**",
        "Consent is documented on a **participant information sheet in the local language plus a signed or thumb-impressed consent form**",
        "An **impartial witness** is required for an illiterate participant [ICMR 2017]",
        "**Vulnerable groups** require additional safeguards and justification for inclusion [ICMR 2017]",
        "Children: **assent from age 7**, consent from the parent or guardian, and the participant's own consent at 18 [ICMR 2017]",
        "Other vulnerable groups: pregnant women, prisoners, persons with mental illness or cognitive impairment, the economically or socially disadvantaged",
        "Students and employees of the investigator are also a vulnerable group",
        "**Capacity must be formally assessed, and a legally acceptable representative used where it is absent**",
        "The protocol must contain **confidentiality, anonymisation, data storage plans and conflict of interest declarations**",
        "The protocol must contain a plan for **compensation for research-related injury**",
        "**Trial registration with the Clinical Trials Registry - India (CTRI) is mandatory before enrolment of the first participant**",
        "Most journals will not publish an unregistered trial",
      ],
    },
    {
      ...
      points: [
        ...
        "The completed thesis must be submitted by the prescribed date [NBEMS]",
        ...
        "**Protocol structure** opens with title, introduction and rationale, and review of literature",
        "Aims and objectives are written as one primary and a few specific measurable objectives",
        "Methodology: study design, setting, study period, study population, inclusion and exclusion criteria",
        "Methodology continues: sample size with the formula and its assumptions, sampling technique, study tools with their validation",
        "Methodology ends: data collection procedure, operational definitions, statistical analysis plan",
        "After methodology: ethical considerations and consent, budget, timeline as a Gantt chart, references in a consistent style",
        "Annexures: the proforma, the participant information sheet and the consent form",
        "**Write objectives as verbs that can be measured** - to estimate, to compare, to determine, to assess association",
        "Never write an objective as to study - it cannot be assessed",
        "The objectives, the tools, the analysis plan and the tables of the thesis must correspond one to one",
        "**Thesis structure follows IMRAD**: Introduction (why), Materials and Methods (how), Results, Discussion",
        "Results present what was found - in tables and figures without interpretation",
        "Discussion states what it means, compared with the published literature, with limitations stated honestly",
        "The conclusion must answer the objectives",
        "IMRAD is preceded by title page, certificates, declaration, acknowledgements, contents, abbreviations and abstract",
        "IMRAD is followed by references, annexures and the master chart",
        "**Plagiarism is the use of another's work, words, ideas or data without appropriate attribution** [UGC 2018]",
        "Plagiarism includes self-plagiarism, mosaic or patchwork paraphrasing, cut-and-paste without quotation, and fabricated references",
        "The **UGC (Promotion of Academic Integrity and Prevention of Plagiarism) Regulations 2018** grade similarity in four levels [UGC 2018]",
        "**Level 0: up to 10%, no penalty; level 1: above 10 to 40%** [UGC 2018]",
        "**Level 2: above 40 to 60%; level 3: above 60%** - escalating penalties up to withdrawal of the degree [UGC 2018]",
        "Institutions run submissions through similarity software",
        "The defence against plagiarism: **read, understand, write in your own words and cite everything**",
        "**Authorship follows the four ICMJE criteria** - gift, guest and ghost authorship are misconduct",
        "ICMJE criterion 1: substantial contribution to conception or design, or to acquisition, analysis or interpretation",
        "ICMJE criteria 2-4: drafting or critical revision; final approval; accountability for all aspects",
        "Report the finished work using the appropriate guideline: **CONSORT for trials, STROBE for observational studies**",
        "Further reporting guidelines: **PRISMA for systematic reviews, STARD for diagnostic accuracy, COREQ for qualitative research**",
      ],
    },
    {
      heading: "Telemedicine Practice Guidelines, India 2020",
      points: [
        "The **Telemedicine Practice Guidelines were notified on 25 March 2020** by the Board of Governors in supersession of the MCI, with NITI Aayog [TPG 2020]",
        "They were **appended to the IMC (Professional Conduct, Etiquette and Ethics) Regulations 2002 as Regulation 3.8 (Appendix 5)** [TPG 2020]",
        "Being part of the 2002 Regulations makes them legally binding on every registered medical practitioner in India",
        "They apply to **an RMP registered under the National Medical Commission Act or the erstwhile IMC Act** [TPG 2020]",
        "They cover consultations by **video, audio or text** - chat, images, messaging, email, fax [TPG 2020]",
        "Covered pairings: **patient and RMP, caregiver and RMP, health worker and RMP, RMP and RMP** [TPG 2020]",
        "They **exclude** research, remote surgery by digital technology, hard prescriptive protocols and hardware specifications [TPG 2020]",
        "**Consent is implied when the patient initiates** the teleconsultation [TPG 2020]",
        "**Explicit consent must be recorded when the health worker, caregiver or RMP initiates** the teleconsultation [TPG 2020]",
        "The RMP must confirm the patient's identity and their own",
        "The RMP must give their **registration number on every prescription** [TPG 2020]",
        "The RMP must **maintain the consultation log, patient records and prescription** exactly as for an in-person consultation [TPG 2020]",
        "**Prescribing is restricted by four lists: List O, List A, List B and a Prohibited list** [TPG 2020]",
        "**List O**: over-the-counter drugs safe to prescribe by any mode - paracetamol, ORS, lozenges, antiseptics and similar [TPG 2020]",
        "**List A**: drugs prescribable at a first consultation only if by video, or as a refill at follow-up [TPG 2020]",
        "List A examples: ORS-plus items, oral antihistamines, topical antifungals as listed",
        "**List B**: an add-on list prescribable only at a follow-up teleconsultation for a condition already diagnosed in person [TPG 2020]",
        ...
        "In an **emergency the role is limited to first aid, life-saving advice, counselling and facilitating referral** [TPG 2020]",
        "In an emergency the patient must be advised to attend in person at the earliest",
        "Practitioners had to **complete the mandatory online telemedicine course within three years of notification** [TPG 2020]",
        "The RMP must not misuse patient images or data, and must not use telemedicine to advertise or solicit [TPG 2020]",
        "The RMP remains **fully accountable under the same standard of care as an in-person consultation**",
        "The guideline reduces neither the duty of care nor the medico-legal exposure",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "**Rationale**: depression in the elderly is common, under-detected in primary care, presents somatically, and is treatable",
            "Local data are needed to plan screening",
            ...
            "**Secondary objective**: to determine its association with living arrangement, comorbidity, functional dependence and socio-economic status",
            "Further secondary objective: to describe the proportion already diagnosed and treated",
          ],
        },
        {
          heading: "2. Design, setting, population and period",
          points: [
            "**Design**: descriptive cross-sectional study with an analytical component",
            ...
            "**Exclusion**: acute medical emergency, significant cognitive impairment precluding interview, known psychosis",
            "Those unwilling to consent are also excluded",
          ],
        },
        {
          ...
          points: [
            ...
            "Assuming **p = 20%** from previous Indian studies, q = 80% and d = 5%",
            "**n = 4 x 20 x 80 / 25 = 256**",
            "Adding 10% for non-response and incomplete forms gives approximately 285 - rounded to **300**",
            "**Sampling**: systematic random sampling of every kth eligible attender after a random start",
            "k is derived from the expected attendance",
            "Consecutive convenience sampling would be an inferior alternative - and must be declared as a limitation",
          ],
        },
        {
          heading: "4. Tools and data collection",
          points: [
            "A pre-tested, semi-structured **proforma** for sociodemographic data, comorbidity, drugs and living arrangement",
            "Socio-economic status by the **modified Kuppuswamy scale**",
            "Depression screened with the **Geriatric Depression Scale (GDS-15) or PHQ-9** in a locally validated translation, with a stated cut-off",
            "Positive screens confirmed against **ICD-10 or DSM-5 criteria** by clinical interview",
            "Functional status by the **Barthel Index or Katz ADL**",
            "Cognition screened with the **MMSE or MoCA** to apply the exclusion criterion",
            "**Pilot on 20 participants** - then excluded from the main analysis",
            "Check internal consistency with **Cronbach's alpha**",
            "Interviews in a private room by a single trained interviewer",
          ],
        },
        {
          heading: "5. Bias, confounding and the analysis plan",
          points: [
            "**Selection bias** minimised by systematic random sampling from all eligible attenders",
            "Selection bias acknowledged: clinic attenders are not the community elderly",
            ...
            "Data entered in duplicate in Epi Info or MS Excel, analysed in SPSS or R",
            "Prevalence reported as a percentage with a **95% confidence interval**",
            "Categorical comparisons by **chi-square or Fisher's exact test**; continuous by t test or Mann-Whitney",
            "Adjusted odds ratios from logistic regression",
            "**p below 0.05** taken as significant",
          ],
        },
        {
          heading: "6. Ethical considerations",
          points: [
            "Prior written approval from the registered **Institutional Ethics Committee** before recruitment begins [ICMR 2017]",
            "Participant information sheet and written informed consent in the local language",
            "An impartial witness and thumb impression for illiterate participants [ICMR 2017]",
            "Voluntariness and the right to withdraw without any effect on routine care",
            "Privacy and confidentiality - coded data and restricted access",
            "A prospective plan for participants who screen positive or disclose suicidal ideation - a screening study creates a duty of care",
            "That plan: same-day clinical assessment, referral to mental health services and a documented safety plan",
            "No conflict of interest; funding declared",
            "Data retained as per institutional policy; results shared with the department",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Applies to every **RMP registered under the NMC Act or the erstwhile IMC Act** [TPG 2020]",
            "Modes covered: **video, audio, and text** including chat, images, messaging, email and fax [TPG 2020]",
            "Relationships covered: patient to RMP, caregiver to RMP, health worker to RMP, and RMP to RMP [TPG 2020]",
            "Excludes research, remote surgery, hardware specifications and hard prescriptive protocols [TPG 2020]",
          ],
        },
        {
          heading: "2. Consent, identification and records",
          points: [
            "Consent is **implied when the patient initiates** [TPG 2020]",
            "**Explicit consent** must be recorded when the RMP, caregiver or health worker initiates [TPG 2020]",
            "Both parties must be identified",
            "The RMP states name and **registration number, which must appear on the prescription** [TPG 2020]",
            "The RMP maintains the consultation log, patient records, prescriptions and any images - exactly as for an in-person visit",
            "Fees may be charged as for an in-person consultation, with a receipt [TPG 2020]",
          ],
        },
        {
          heading: "3. Prescribing lists",
          points: [
            "**List O**: over-the-counter drugs, prescribable by any mode [TPG 2020]",
            "**List A**: prescribable at a first consultation only if by video, or as a refill at follow-up [TPG 2020]",
            "**List B**: add-on drugs at a follow-up teleconsultation for a condition already diagnosed in person [TPG 2020]",
        ...
        },
        {
          ...
          points: [
            ...
            "In an **emergency** the role is limited to first aid, life-saving advice, counselling and facilitating referral [TPG 2020]",
            "In an emergency an in-person visit is advised at the earliest",
            "The same standard of care, confidentiality and data protection applies as in person",
            "Misuse of patient images or data, and advertising or soliciting through telemedicine, are prohibited [TPG 2020]",
            "The mandatory online telemedicine course was to be completed **within three years of notification** [TPG 2020]",
            "Breaches are dealt with as professional misconduct under the 2002 Regulations",
          ],
        },
      ],
      mustDraw: [
