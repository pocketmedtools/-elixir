  ...
  sections: [
    {
      ...
      points: [
        "**Type 2 diabetes: screen for all complications from the day of diagnosis.** [ADA 2025]",
        "Type 2 diabetes has typically been present unrecognised for **5-10 years** before diagnosis. [ADA 2025]",
        "**15-20% of type 2 patients already have retinopathy at diagnosis**. [ADA 2025]",
        "**Type 1 diabetes: begin screening 5 years after diagnosis**, and from puberty in children. [ADA 2025]",
        "Type 1 onset is dated, and hyperglycaemia was not present before it. [ADA 2025]",
        "Annual package: **dilated fundus examination**. [ADA 2025]",
        "Annual package: **urine albumin-creatinine ratio with serum creatinine and eGFR**. [KDIGO 2022]",
        "Annual package: **foot examination with a 10 g Semmes-Weinstein monofilament** plus palpation of pedal pulses. [IWGDF 2023]",
        "Annual package: fasting lipids, with blood pressure and weight at every visit. [ADA 2025]",
        "Screen for retinopathy **in pregnancy at the first visit and each trimester**. [ADA 2025]",
        "Retinopathy accelerates rapidly with pregnancy and with rapid correction of a very high HbA1c. [ADA 2025]",
    ...
    },
    {
      ...
      points: [
        "Mild non-proliferative diabetic retinopathy: **microaneurysms only**. [ADA 2025]",
        "Severe NPDR is defined by the **4-2-1 rule**; proliferative disease means new vessels at the disc or elsewhere, or vitreous or preretinal haemorrhage. [ADA 2025]",
        "**4-2-1 rule:** severe intraretinal haemorrhages and microaneurysms in **4** quadrants. [ADA 2025]",
        "**4-2-1 rule:** venous beading in **2** quadrants. [ADA 2025]",
        "**4-2-1 rule:** intraretinal microvascular abnormalities in **1** quadrant. [ADA 2025]",
        "**Diabetic macular oedema is the commonest cause of visual loss in type 2 diabetes** and can occur at any retinopathy stage. [ADA 2025]",
        "Macular oedema is retinal thickening or hard exudates within **one disc diameter of the fovea**, confirmed on optical coherence tomography. [ADA 2025]",
        "**Pan-retinal photocoagulation** for proliferative disease, and for severe NPDR in selected patients. [ADA 2025]",
        "**Intravitreal anti-VEGF** - ranibizumab, bevacizumab or aflibercept - for centre-involving macular oedema. [ADA 2025]",
        "Vitrectomy for non-clearing vitreous haemorrhage or tractional retinal detachment. [ADA 2025]",
        ...
        "Screen the eye before intensifying glycaemic control. [ADA 2025]",
        "**Fenofibrate 145-160 mg OD** slows retinopathy progression independent of its lipid effect - FIELD and ACCORD-Eye. [ADA 2025]",
        "Fenofibrate is cheap but is an adjunct, not a substitute for laser. [ADA 2025]",
      ],
    },
    {
      heading: "Diabetic kidney disease",
      points: [
        "**Screen annually with a spot urine albumin-creatinine ratio on an early-morning sample**, plus serum creatinine for eGFR. [KDIGO 2022]",
        "Moderately increased albuminuria, formerly microalbuminuria, is **UACR 30-299 mg/g**. [KDIGO 2022]",
        "Severely increased albuminuria, formerly macroalbuminuria, is **UACR 300 mg/g or more**. [KDIGO 2022]",
        "**Confirm any abnormal UACR with two of three samples over 3-6 months**. [KDIGO 2022]",
        "Fever, exercise, urinary infection, menstruation, heart failure and marked hyperglycaemia all raise albumin excretion transiently. [KDIGO 2022]",
        ...
        "Target blood pressure **below 130/80 mmHg** with HbA1c to target. [KDIGO 2022]",
        "Add an **SGLT2 inhibitor** - it slows eGFR decline down to an eGFR of **20-25 mL/min/1.73 m2**. [KDIGO 2022]",
        "**Finerenone 10-20 mg OD**, a non-steroidal mineralocorticoid receptor antagonist, adds cardio-renal benefit on maximal RAS blockade. [KDIGO 2022]",
        "Finerenone evidence is FIDELIO-DKD and FIGARO-DKD; monitor potassium. [KDIGO 2022]",
        "**Never combine an ACE inhibitor with an ARB**. [KDIGO 2022]",
        "Check creatinine and potassium **1-2 weeks** after starting or up-titrating an ACEi or ARB. [KDIGO 2022]",
        "A creatinine rise **up to 30% is acceptable**; more than 30%, or potassium above **5.5 mmol/L**, means stop and investigate. [KDIGO 2022]",
        "Suspect non-diabetic renal disease with heavy proteinuria but no retinopathy, or active sediment with red cell casts. [KDIGO 2022]",
        "Also suspect it with a rapid fall in eGFR, proteinuria within 5 years of a type 1 diagnosis, or systemic features. [KDIGO 2022]",
        "Refer such patients for nephrology assessment and possible biopsy. [KDIGO 2022]",
      ],
    },
    {
      heading: "The diabetic foot",
      points: [
        "Annual foot inspection: deformity, callus, dryness, fissures, interdigital maceration and nail disease. [IWGDF 2023]",
        "Palpate the **dorsalis pedis and posterior tibial pulses** at every annual review. [IWGDF 2023]",
        ...
        "Test vibration with a **128 Hz tuning fork** or a biothesiometer. [IWGDF 2023]",
        "**Loss of protective sensation** is inability to feel the 10 g monofilament at one or more sites. [IWGDF 2023]",
        ...
        "IWGDF very low risk (no neuropathy, no peripheral artery disease): screen **annually**. [IWGDF 2023]",
        "IWGDF low risk (neuropathy or PAD): screen every **6-12 months**. [IWGDF 2023]",
        "IWGDF moderate risk (neuropathy plus PAD, or neuropathy plus deformity): screen every **3-6 months**. [IWGDF 2023]",
        "IWGDF high risk (previous ulcer or amputation, or end-stage renal disease): screen every **1-3 months**. [IWGDF 2023]",
        "Wagner grade 0 is an at-risk foot with no ulcer; grade 1 a superficial ulcer; grade 2 a deep ulcer to tendon or capsule. [IWGDF 2023]",
        "Wagner grade 3 is deep with abscess or osteomyelitis; grade 4 localised gangrene of forefoot or heel; grade 5 gangrene of the whole foot. [IWGDF 2023]",
        "Ulcer management: debridement of callus and slough, plus a moist wound dressing and infection control. [IWGDF 2023]",
        "**Offloading with a total contact cast is the gold standard**; a removable walker or felted foam is the alternative. [IWGDF 2023]",
        "Assess for revascularisation if pulses are absent or the **ABI is below 0.9**. [IWGDF 2023]",
        "**Probe-to-bone test:** a sterile blunt probe reaching bone in an infected ulcer strongly supports osteomyelitis. [IWGDF 2023]",
        "A positive probe-to-bone with a plain X-ray is enough to start prolonged antibiotics and seek a surgical opinion. [IWGDF 2023]",
        "**MRI is the imaging of choice** for diabetic foot osteomyelitis where available. [IWGDF 2023]",
        "**Patient education is the intervention with the best evidence** in diabetic foot care. [IWGDF 2023]",
        "Never walk barefoot, even indoors or in the temple. [IWGDF 2023]",
        "Inspect the soles daily with a mirror and test bath water with the elbow. [IWGDF 2023]",
        "Cut nails straight across and use closed protective footwear - MCR chappals or moulded insoles. [IWGDF 2023]",
        "Never use hot-water bottles or self-treat corns with chemical pastes. [IWGDF 2023]",
      ],
    },
    {
      ...
      points: [
        ...
        "Symptoms are numbness, burning and tingling with nocturnal exacerbation. [ADA 2025]",
        "It is a **clinical diagnosis after excluding other causes**. [ADA 2025]",
        "Exclude vitamin B12 deficiency including metformin-induced, hypothyroidism, alcohol, uraemia, HIV, leprosy and drugs. [ADA 2025]",
        "**Leprosy is an important Indian differential** for a mononeuropathy or asymmetric sensory loss. [RSSDI 2022]",
        "Look for thickened ulnar, common peroneal or greater auricular nerves and hypopigmented anaesthetic patches. [RSSDI 2022]",
        "Do not attribute every foot numbness to diabetes. [RSSDI 2022]",
        "**Pregabalin 75 mg at night**, titrated to 75-150 mg BD, is first line for painful neuropathy. [ADA 2025]",
        "**Duloxetine 30 mg OD**, increased to 60 mg OD, is an equal first-line alternative. [ADA 2025]",
        "**Amitriptyline 10-25 mg at night** is cheapest but anticholinergic - avoid in the elderly, glaucoma and prostatism. [ADA 2025]",
        "**Gabapentin 300 mg at night**, titrated to 300-600 mg TDS, is an alternative. [ADA 2025]",
        "Cardiac autonomic neuropathy: resting tachycardia, loss of heart-rate variability and postural hypotension. [ADA 2025]",
        "Gastrointestinal autonomic neuropathy: gastroparesis with early satiety and vomiting, and diarrhoea alternating with constipation. [ADA 2025]",
        "Genitourinary autonomic neuropathy: erectile dysfunction and neurogenic bladder; also hypoglycaemia unawareness. [ADA 2025]",
        "**Cardiac autonomic neuropathy predicts silent ischaemia and sudden death**. [ADA 2025]",
        "Correct B12 with **methylcobalamin 1500 mcg daily** and correct hypothyroidism. [RSSDI 2022]",
        "Stop alcohol and optimise glycaemia - it prevents progression but does not reverse established neuropathy. [ADA 2025]",
        "Use non-drug measures too: foot care, sleep hygiene and exercise. [ADA 2025]",
    ...
    },
    {
      ...
      points: [
        "Every diabetic over 40, or with any additional risk factor, needs a **statin**. [ADA 2025]",
        "Primary prevention: **atorvastatin 10-20 mg** or **rosuvastatin 10 mg at night**. [ADA 2025]",
        "Secondary prevention: **atorvastatin 40-80 mg** at night. [ADA 2025]",
        "Screen for peripheral artery disease with pulses, and with an **ankle-brachial index** if claudication or an absent pulse is found. [IWGDF 2023]",
        "**ABI below 0.9** confirms peripheral artery disease. [IWGDF 2023]",
        ...
        "Screen for non-alcoholic fatty liver disease with **ALT and ultrasound** in obesity or metabolic syndrome. [ADA 2025]",
        "Screen for obstructive sleep apnoea by asking about snoring, witnessed apnoea and daytime sleepiness. [ADA 2025]",
        "Screen for depression with the **PHQ-9** - it is twice as common in diabetes. [ADA 2025]",
        "Depression is a strong independent predictor of poor adherence and worse outcomes. [ADA 2025]",
        "Refer annually for dental review to screen for periodontal disease. [ADA 2025]",
        "Offer **influenza vaccine annually**, pneumococcal vaccine, and hepatitis B vaccination to unvaccinated adults with diabetes. [ADA 2025]",
        "Screen for tuberculosis symptoms at every visit under NTEP. [NTEP]",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Motor neuropathy causes small-muscle wasting and clawing of the toes. [IWGDF 2023]",
            "Clawing shifts pressure loading abnormally onto the metatarsal heads. [IWGDF 2023]",
            "Autonomic neuropathy causes anhidrosis with dry, fissured skin and arteriovenous shunting. [IWGDF 2023]",
            "Peripheral artery disease impairs healing. [IWGDF 2023]",
        ...
        },
        {
          ...
          points: [
            "Inspect for deformity, clawing, callus, dryness, fissures, interdigital maceration and nail disease. [IWGDF 2023]",
            "Inspect for previous ulcer or amputation scars - the strongest single predictor of a new ulcer. [IWGDF 2023]",
            "Vascular: palpate dorsalis pedis and posterior tibial pulses. [IWGDF 2023]",
            ...
            "Neurological: **10 g Semmes-Weinstein monofilament at four plantar sites per foot**. [IWGDF 2023]",
            "Neurological: **128 Hz tuning fork** vibration at the hallux, ankle jerks and pinprick. [IWGDF 2023]",
        ...
        },
        {
          ...
          points: [
            ...
            "High-risk feet need a podiatry or surgical service involved, not primary care alone. [IWGDF 2023]",
          ],
        },
        {
          heading: "4. Management of an established ulcer",
          points: [
            "Grade the ulcer by **Wagner or IWGDF/IDSA** and assess for infection, ischaemia and osteomyelitis. [IWGDF 2023]",
            "Include a **probe-to-bone test and a plain X-ray** in that assessment. [IWGDF 2023]",
            "**Offloading is the single most important measure** - total contact cast where available. [IWGDF 2023]",
            "Otherwise offload with a removable walker, felted foam or crutches. [IWGDF 2023]",
            "Sharp debridement of callus and non-viable tissue, with a moist wound dressing. [IWGDF 2023]",
            "Do not use antiseptic soaks - they harm granulation tissue. [IWGDF 2023]",
            "Mild infection: oral **amoxicillin-clavulanate 625 mg TDS** or cefalexin for **1-2 weeks**. [IWGDF 2023]",
            "Moderate to severe infection: admit for intravenous piperacillin-tazobactam, or ceftriaxone with clindamycin. [IWGDF 2023]",
            "Guide antibiotics by **deep tissue culture**, not a superficial swab. [IWGDF 2023]",
            "Osteomyelitis needs **4-6 weeks of therapy** plus a surgical opinion. [IWGDF 2023]",
            "Use insulin for glycaemic control during infection, with adequate protein and correction of anaemia. [IWGDF 2023]",
            "Refer for revascularisation if the **ABI is below 0.9** or the ulcer fails to heal in **4-6 weeks**. [IWGDF 2023]",
          ],
        },
        {
          ...
          points: [
            ...
            "Inspect the feet and soles **daily**, using a mirror or the help of a family member. [IWGDF 2023]",
            "Wash daily in lukewarm water **tested with the elbow**, and dry between the toes. [IWGDF 2023]",
            "Apply emollient to the soles but **not between the toes**. [IWGDF 2023]",
            "Cut nails straight across; do not use blades, corn caps or chemical paring. [IWGDF 2023]",
            "Treat corns and calluses professionally. [IWGDF 2023]",
            "Wear well-fitting closed footwear, or MCR moulded microcellular rubber chappals. [IWGDF 2023]",
            "Buy footwear in the evening and check inside the shoe before wearing it. [IWGDF 2023]",
      ...
      answer: [
        {
          heading: "Screening",
          points: [
            "Spot **early-morning urine albumin-creatinine ratio annually**. [KDIGO 2022]",
            "**30-299 mg/g** is moderately increased albuminuria; **300 mg/g or more** is severely increased. [KDIGO 2022]",
            "Serum creatinine with **eGFR by the CKD-EPI equation** at the same visit. [KDIGO 2022]",
            "Stage the patient on the **KDIGO G and A grid**. [KDIGO 2022]",
            "Confirm an abnormal result on **two of three samples over 3-6 months**. [KDIGO 2022]",
            "First exclude fever, exercise, urinary infection, menstruation, heart failure and marked hyperglycaemia. [KDIGO 2022]",
          ],
        },
        {
          heading: "Management",
          points: [
            "Target blood pressure **below 130/80 mmHg**. [KDIGO 2022]",
            "Use an **ACE inhibitor or ARB at the maximum tolerated dose** for anyone with albuminuria. [KDIGO 2022]",
            "Dose **ramipril 2.5-10 mg OD** or **telmisartan 40-80 mg OD**. [KDIGO 2022]",
            "Add an SGLT2 inhibitor - **dapagliflozin 10 mg OD** or **empagliflozin 10 mg OD** - to slow eGFR decline. [KDIGO 2022]",
            "SGLT2 inhibitors can be continued to an eGFR of about **20-25 mL/min/1.73 m2**. [KDIGO 2022]",
            "Consider **finerenone 10-20 mg OD** in albuminuric disease on maximal RAS blockade, monitoring potassium. [KDIGO 2022]",
            "Glycaemic control to the individualised HbA1c target. [ADA 2025]",
            "Adjust metformin by eGFR and **stop it below an eGFR of 30**. [KDIGO 2022]",
            "Dietary protein about **0.8 g/kg/day** and salt under **5 g/day**. [KDIGO 2022]",
            "Avoid NSAIDs and nephrotoxins, treat anaemia and acidosis, and give a statin. [KDIGO 2022]",
            "Check creatinine and potassium **1-2 weeks** after starting or increasing an ACEi or ARB. [KDIGO 2022]",
            "Accept a creatinine rise of **up to 30%**. [KDIGO 2022]",
          ],
        },
        {
          heading: "When to refer to nephrology",
          points: [
            "Refer at **eGFR below 30 mL/min/1.73 m2**. [KDIGO 2022]",
            "Refer for a rapid decline of **more than 5 mL/min/1.73 m2 per year**. [KDIGO 2022]",
            "Refer for heavy proteinuria without retinopathy, or haematuria with red cell casts. [KDIGO 2022]",
            "Refer for proteinuria within 5 years of a type 1 diagnosis - suspect non-diabetic renal disease. [KDIGO 2022]",
            "Refer for refractory hypertension, refractory hyperkalaemia, or uncertainty about the diagnosis. [KDIGO 2022]",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Measure visual acuity with a **Snellen chart** in each eye, with pinhole correction. [NPCBVI MoHFW]",
            "Dilate with **tropicamide 0.8% plus phenylephrine 5%**, after excluding a shallow anterior chamber. [NPCBVI MoHFW]",
            "Examine with a direct ophthalmoscope, or a **90 D lens on a slit lamp**. [NPCBVI MoHFW]",
            "**Non-mydriatic fundus photography with tele-reporting** is the scalable option under NPCBVI. [NPCBVI MoHFW]",
            "Grade as no retinopathy, mild, moderate or severe NPDR, proliferative disease, or diabetic macular oedema. [ADA 2025]",
          ],
        },
        {
          heading: "The referral rules",
          points: [
            "No retinopathy: **rescreen in 12 months**. [ADA 2025]",
            "Mild NPDR: ophthalmology review in **6-12 months**. [ADA 2025]",
            "Mild NPDR: intensify glycaemic, blood pressure and lipid control at the same visit. [ADA 2025]",
            "Moderate NPDR: ophthalmology review in **3-6 months**. [ADA 2025]",
            "Severe NPDR: refer **within weeks** for consideration of pan-retinal photocoagulation. [ADA 2025]",
            "Proliferative retinopathy or vitreous haemorrhage: **urgent same-week or same-day referral**. [ADA 2025]",
            "Any macular oedema or unexplained visual loss: same urgent referral. [ADA 2025]",
          ],
        },
        {
          heading: "What the family physician controls",
          points: [
            "HbA1c to the individualised target, lowered **gradually** to avoid early worsening of retinopathy. [ADA 2025]",
            "Blood pressure **below 130/80 mmHg**. [ADA 2025]",
            "A statin for lipids in every diabetic over 40 or with a risk factor. [ADA 2025]",
            "**Fenofibrate 145-160 mg OD** as an adjunct with evidence for slowing progression. [ADA 2025]",
            "Smoking cessation and anaemia correction. [ADA 2025]",
