  ...
  sections: [
    {
      ...
      points: [
        "Shock is **acute circulatory failure** in which oxygen delivery fails to meet cellular demand.",
        "Shock produces tissue hypoperfusion and, if untreated, irreversible organ injury.",
        "Shock is a **clinical diagnosis** - it does not require a low blood pressure.",
        "**Hypotension is a late sign** - waiting for it is waiting for decompensation. [ATLS 10e]",
        "Young adults, children and pregnant women compensate by vasoconstriction and tachycardia. [ATLS 10e]",
        "Compensating patients can lose **30% of blood volume** before the systolic pressure falls at all. [ATLS 10e]",
        "Three perfusion windows need no equipment: skin, brain, kidney.",
        "Skin window: **capillary refill more than 3 seconds**, mottling, cold peripheries.",
        "Brain window: anxiety, restlessness, drowsiness, confusion.",
        "Kidney window: urine output **under 0.5 mL/kg/h** in adults, under 1 mL/kg/h in children.",
        "A narrow pulse pressure, **below about 25% of systolic**, is an early reliable marker of hypovolaemic and cardiogenic shock.",
        "Pulse pressure narrows because stroke volume falls while diastolic pressure is held up by vasoconstriction.",
        "**Shock index = heart rate / systolic BP**.",
        "Shock index **above 0.9** predicts significant blood loss and the need for transfusion even when BP still looks acceptable.",
        "Serum lactate **above 2 mmol/L** indicates tissue hypoperfusion. [SSC 2021]",
        "Lactate **above 4 mmol/L** defines a high-risk patient. [SSC 2021]",
        "Where point-of-care lactate is unavailable, the clinical windows are the substitute.",
      ],
    },
    {
      heading: "Classifying shock in the first five minutes",
      points: [
        "**Hypovolaemic** shock from haemorrhage: trauma, upper GI bleed, ruptured ectopic pregnancy, postpartum haemorrhage.",
        "Hypovolaemic shock from fluid loss: cholera and other diarrhoeal disease, burns, diabetic ketoacidosis.",
        "Hypovolaemic signs: cold peripheries, flat neck veins, empty pulse.",
        "**Distributive** shock: sepsis, anaphylaxis, neurogenic (spinal cord injury), adrenal crisis.",
        "Distributive signs: warm peripheries with bounding pulses early, low diastolic pressure, wide pulse pressure.",
        "Neurogenic shock is uniquely **bradycardic** with warm dry skin. [ATLS 10e]",
        "**Cardiogenic** shock: acute MI, myocarditis, arrhythmia, valve failure.",
        "Cardiogenic causes special to India: rheumatic valve disease and peripartum cardiomyopathy.",
        "Cardiogenic signs: raised JVP, basal crepitations, gallop rhythm, cold peripheries.",
        "**Obstructive** shock: tension pneumothorax, cardiac tamponade, massive pulmonary embolism.",
        "Obstructive signs: raised JVP with clear lungs.",
        "Tension pneumothorax adds absent breath sounds with a deviated trachea. [ATLS 10e]",
        "The single most useful bedside discriminator is **JVP combined with the lung fields**.",
        "Empty neck veins with clear lungs mean **fluid**.",
        "Distended neck veins with crackles mean **the pump**.",
        "Distended neck veins with clear lungs mean **an obstruction**.",
        "Shock is often mixed - the septic patient with myocardial depression, the trauma patient with tension pneumothorax plus blood loss.",
        "Reassess after every intervention rather than committing to one label.",
      ],
    },
    {
      heading: "The first hour: fluids",
      points: [
        "Two large-bore cannulae, **16-18 G** in adults. [ATLS 10e]",
        "Intraosseous access if two peripheral attempts fail. [ATLS 10e]",
        "Draw blood at cannulation for grouping, haemoglobin, glucose, creatinine, electrolytes and lactate.",
        "Septic shock: **30 mL/kg balanced crystalloid within the first 3 hours**. [SSC 2021]",
        "Give the 30 mL/kg as repeated boluses with reassessment after each - not an uncritical bag hung wide open. [SSC 2021]",
        "Hypovolaemic and haemorrhagic shock: **500 mL crystalloid boluses** in an adult while arranging blood. [ATLS 10e]",
        "The target in haemorrhage is controlling the bleeding, not normalising the blood pressure. [ATLS 10e]",
        "Permissive hypotension with systolic **80-90 mmHg** is acceptable in penetrating trauma until haemostasis. [ATLS 10e]",
        "Permissive hypotension is not acceptable in head injury - target systolic **above 110 mmHg**.",
        "Children: **10-20 mL/kg** isotonic crystalloid boluses over 5-20 minutes, reassessing after each.",
        "Paediatric septic shock with no ventilator support: cautious **10 mL/kg** boluses. [FEAST 2011]",
        "FEAST showed increased mortality from liberal boluses in febrile African children without critical care backup. [FEAST 2011]",
        "**Balanced crystalloids** (Ringer lactate, Plasmalyte) are preferred to 0.9% saline. [SSC 2021]",
        "Large volumes of 0.9% saline cause hyperchloraemic acidosis and more kidney injury.",
        "Starches are **contraindicated** in shock. [SSC 2021]",
        "Albumin is not a first-line fluid. [SSC 2021]",
        "Cardiogenic shock is the exception: a cautious **250 mL** fluid challenge only if the lungs are clear.",
        "In cardiogenic shock stop at the first crackle - the pump needs inotropes and reperfusion, not volume.",
        "Assess fluid responsiveness rather than guessing.",
        "A **passive leg raise** that improves BP and narrows the pulse pressure predicts a fluid response.",
        "Rising JVP, new crackles or a falling SpO2 mean stop fluids.",
      ],
    },
    {
      heading: "The first hour: vasopressors, oxygen and the cause",
      points: [
        "**Noradrenaline** is the first-line vasopressor in septic, hypovolaemic (after volume) and most other shock. [SSC 2021]",
        "Noradrenaline **0.05-0.5 microgram/kg/min** titrated to a MAP of 65 mmHg. [SSC 2021]",
        ...
        "Add **vasopressin or adrenaline** if noradrenaline requirements escalate. [SSC 2021]",
        "**Dobutamine 2.5-10 microgram/kg/min** when cardiac output is low despite adequate filling pressure and MAP - cardiogenic and some septic shock. [SSC 2021]",
        "**Dopamine is no longer first-line** - more arrhythmias and higher mortality than noradrenaline in septic shock. [SOAP II 2010]",
        "So-called renal-dose dopamine does not protect the kidney.",
        "Septic shock: blood cultures and **broad-spectrum antibiotics within the first hour**. [SSC 2021]",
        "Choose antibiotics empirically by the likely source and local resistance.",
        ...
        "Oxygen to maintain **SpO2 94-98%**, or 88-92% in known chronic hypercapnic lung disease.",
        "Keep the patient warm and treat pain - pain and cold both worsen the physiology.",
        "Do not give steroids routinely. [SSC 2021]",
        "**Hydrocortisone 200 mg/day** in divided doses or infusion only in septic shock still needing vasopressors after adequate fluid. [SSC 2021]",
        "Give hydrocortisone immediately in suspected adrenal crisis.",
        "Reassess **every 15 minutes** in the first hour using the three windows plus catheter urine output.",
        "Escalate rather than repeat an intervention that has already failed twice.",
      ],
    },
    {
      heading: "Shock in special Indian contexts",
      points: [
        "**Dengue shock syndrome**: pulse pressure narrowing to **20 mmHg or less** on days 4-6 of fever. [NVBDCP 2023]",
        "Dengue shock shows a rising haematocrit and falling platelets. [NVBDCP 2023]",
        "Dengue shock: isotonic crystalloid **5-10 mL/kg/h** titrated to pulse pressure and haematocrit. [NVBDCP 2023]",
        "Avoid over-transfusion in dengue. [NVBDCP 2023]",
        "A falling haematocrit with continuing shock in dengue means **bleeding**. [NVBDCP 2023]",
        "Severe malaria and enteric fever produce a distributive picture with hepatosplenomegaly and thrombocytopenia.",
        "Artesunate and appropriate antibiotics are as urgent as the fluid.",
        "**Obstetric shock**: postpartum haemorrhage, ruptured ectopic pregnancy, septic abortion, amniotic fluid embolism.",
        "Assume obstetric shock in any woman of reproductive age with shock and no obvious cause.",
        "A **urine pregnancy test** is mandatory in a shocked woman of reproductive age.",
        "Poisoning-related shock - aluminium phosphide, oleander, organophosphate, snake envenoming - is common in rural practice.",
        "Poisoning shock responds poorly to fluids alone - the **antidote and early referral** matter more.",
        "Anaemic heart failure and severe nutritional anaemia are widespread.",
        "Haemoglobin **3-4 g/dL** with a high-output state needs slow packed cell transfusion with furosemide cover.",
        "Never give rapid crystalloid to a high-output anaemic heart.",
        "Referral is part of resuscitation: stabilise, then communicate directly with the receiving unit.",
        "Transfer with an **escort, oxygen, a running line and written notes**.",
        "A patient in shock sent alone in an auto-rickshaw will not arrive resuscitated.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Hypovolaemic - haemorrhagic. [ATLS 10e]",
            "Hypovolaemic - fluid loss such as diarrhoea, vomiting, burns or diabetic ketoacidosis.",
            "Distributive - septic, anaphylactic, neurogenic, adrenal crisis.",
            ...
            "The classification is confirmed by **JVP, the peripheries and the lung fields**.",
          ],
        },
        {
          ...
          points: [
            "Airway first.",
            "Breathing: SpO2 and respiratory rate.",
            "Circulation: pulse, blood pressure, capillary refill, JVP.",
            "Disability: GCS and **capillary glucose**.",
            "Exposure: rash, cellulitis, abscess, ulcer, pressure sores.",
            "History from relatives: fever pattern, urinary or respiratory symptoms, loose stools.",
            "History: recent surgery or catheter, drug intake, diabetes, any poison or snake bite.",
            "Examine for the source: chest, abdomen, skin, perineum, an infected diabetic foot, meningism.",
            "Bloods: haemogram, glucose, creatinine, electrolytes, liver function, lactate.",
            "Send malaria and dengue tests.",
            "Take **two sets of blood cultures before antibiotics**. [SSC 2021]",
          ],
        },
        {
          ...
          points: [
            ...
            "Oxygen to keep **SpO2 94-98%**.",
            "Monitor pulse, BP, SpO2 and urine output through a catheter.",
            "**Balanced crystalloid 30 mL/kg** (about 2 litres for a 70 kg man) over the first 3 hours. [SSC 2021]",
            "Give it as 500 mL boluses with reassessment after each. [SSC 2021]",
            "Blood cultures first, then **broad-spectrum IV antibiotics within one hour**. [SSC 2021]",
            "Choose antibiotics for the likely source and local resistance.",
            "Example: ceftriaxone with or without doxycycline covering scrub typhus and leptospirosis in a monsoon setting.",
            "If MAP stays **below 65 mmHg** after fluid, start noradrenaline 0.05-0.5 microgram/kg/min. [SSC 2021]",
            "Noradrenaline may start through a large peripheral vein if central access is not available. [SSC 2021]",
            "**Hydrocortisone 200 mg/day** only if vasopressors are still needed after adequate fluid. [SSC 2021]",
            "Paracetamol for fever and treat pain.",
          ],
        },
        {
          ...
          points: [
            ...
            "Dengue - day of illness, platelet count, haematocrit, pulse pressure. [NVBDCP 2023]",
            "Dengue fluids are titrated to the haematocrit and pulse pressure. [NVBDCP 2023]",
            "Scrub typhus - look for an **eschar** in the axilla, groin and under the breast.",
            "Scrub typhus - doxycycline or azithromycin.",
            "Also consider leptospirosis, enteric fever, hepatitis and urinary sepsis.",
            "Remember tuberculosis and HIV as underlying conditions.",
          ],
        },
        {
          heading: "5. Reassessment, referral and documentation",
          points: [
            "Reassess **every 15 minutes**: capillary refill, sensorium, urine output, blood pressure, lactate.",
            "A lactate that does not fall means the resuscitation is failing. [SSC 2021]",
            "Refer to a hospital with intensive care after stabilisation.",
            "Communicate directly with the receiving doctor.",
            "Transfer with an escort, oxygen and a running line.",
            "Send the drugs already given documented with times, and the culture bottles.",
      ...
      answer: [
        {
          ...
          points: [
            "**Passive leg raise** from semi-recumbent for 60-90 seconds gives a reversible auto-transfusion of about 300 mL.",
            "Improvement in BP and pulse pressure on leg raise predicts a response to fluid.",
            "A **fluid challenge of 250-500 mL** over 10-15 minutes is the practical bedside test where no monitoring exists.",
            "Reassess pulse, BP, pulse pressure, capillary refill and urine output after the challenge.",
            "Dynamic markers - pulse pressure variation, IVC collapsibility on ultrasound - beat static ones. [SSC 2021]",
            "**CVP alone is a poor predictor** and should not drive fluid decisions. [SSC 2021]",
            "Signs to stop: rising JVP, new basal crackles, falling SpO2, rising respiratory rate.",
            "In children a tender enlarging liver is a sign to stop.",
          ],
        },
        {
          heading: "Choice and dose of fluid",
          points: [
            "**Balanced crystalloids** (Ringer lactate, Plasmalyte) are preferred. [SSC 2021]",
            "0.9% saline in large volumes causes hyperchloraemic metabolic acidosis and more acute kidney injury.",
            "Septic shock: **30 mL/kg over 3 hours**. [SSC 2021]",
            "Haemorrhagic shock: 500 mL boluses while blood is arranged. [ATLS 10e]",
            "Children: 10-20 mL/kg boluses.",
            "Children with no ventilator support: a more cautious **10 mL/kg**. [FEAST 2011]",
            "**Hydroxyethyl starch is contraindicated** - kidney injury and death. [SSC 2021]",
            "Albumin is second-line in some septic patients - no place as first-line resuscitation. [SSC 2021]",
            "**Blood** is the fluid of choice in haemorrhage. [ATLS 10e]",
            "Massive transfusion: a balanced ratio of packed cells, plasma and platelets. [ATLS 10e]",
            "**Tranexamic acid 1 g IV within 3 hours** of trauma. [ATLS 10e]",
          ],
        },
        {
          ...
          points: [
            ...
            "Dilutional coagulopathy in trauma - worsens bleeding. [ATLS 10e]",
            "Hypothermia from cold fluid in trauma - worsens bleeding. [ATLS 10e]",
            "In children fluid overload is a recognised **cause of death**. [FEAST 2011]",
            "Paediatric boluses are therefore smaller and reassessment after each is mandatory.",
          ],
        },
      ],
  ...
  sections: [
    {
      ...
      points: [
        ...
        "A poisoned patient dies of obstructed airway, aspiration, hypoxia, hypotension, arrhythmia, seizure or hypoglycaemia - all treatable without knowing the molecule.",
        "Universal antidote 1: oxygen to keep **SpO2 94-98%**.",
        "Universal antidote 2: **dextrose 25 g IV** (50 mL of 50% or 100 mL of 25%) through a large vein if glucose is below 70 mg/dL or cannot be measured.",
        "Universal antidote 3: **naloxone 0.4-2 mg IV** every 2-3 minutes to a maximum of 10 mg if respiratory rate is below 12 with pinpoint pupils. [Goldfrank 11e]",
        "Universal antidote 4: **thiamine 100 mg IV** in the malnourished or alcoholic.",
        "Child dextrose: **2 mL/kg of 10% dextrose IV**.",
        "Child naloxone: **0.01 mg/kg IV**, escalating to 0.1 mg/kg if there is no response.",
        ...
        "Wear gloves and an apron; strip all clothing including underclothes. [WHO 2008]",
        "Wash the skin and hair with **soap and copious water** - unwashed skin keeps re-dosing the patient for hours. [WHO 2008]",
        "**Gastric lavage has almost no place.** [WHO 2008]",
        "Lavage is considered only **within 1 hour** of a life-threatening ingestion, with a protected airway. [WHO 2008]",
        "Lavage is absolutely contraindicated after corrosives, hydrocarbons such as kerosene, and in a drowsy patient without a cuffed tube.",
        "Induced emesis, salt water, milk and village remedies are forbidden - they cause aspiration.",
        "**Activated charcoal 1 g/kg** (adult 50 g, child 25 g) single dose within 1 hour is the only decontamination that still earns marks. [Goldfrank 11e]",
        "Charcoal is useless or dangerous for iron, lithium, alcohols, acids and alkalis, and hydrocarbons.",
        "Multiple-dose charcoal: **50 g then 25 g every 4-6 hours**. [de Silva 2003]",
        "Multiple-dose charcoal is specifically useful in yellow oleander, carbamazepine, dapsone, phenobarbitone, quinine and theophylline. [de Silva 2003]",
        "Take the history from whoever is present and **keep the container**.",
        "The label gives the active ingredient and the concentration - concentration converts a volume into a dose.",
        "Record the time of ingestion and the amount in mouthfuls - one adult mouthful is **20-30 mL**.",
        "Record the intent, any co-ingested alcohol or tablets, and what a local practitioner already gave.",
        "Every case of poisoning in India is a **medico-legal case**.",
        "Make a timed, legible entry.",
        "Preserve the bottle, vomitus and gastric aspirate in a labelled sealed container.",
        "Inform the police in writing without delaying treatment.",
        "Never certify the intent yourself.",
        "Consent is never withheld from a life-saving intervention on medico-legal grounds.",
      ],
    },
    {
      ...
      points: [
        ...
        "Cholinergic continued: vomiting, diarrhoea, incontinence, wet noisy chest from bronchorrhoea, fasciculations, weakness. [Eddleston 2008]",
        "DUMBELS is the muscarinic half of the cholinergic picture.",
        "The nicotinic half - fasciculations, weakness, tachycardia, hypertension - is the half that **stops the breathing**. [Eddleston 2008]",
        "**Anticholinergic** toxidrome (Datura seeds, atropine, antihistamines, tricyclics): dilated pupils, dry hot flushed skin, tachycardia.",
        "Anticholinergic continued: urinary retention, agitation, hallucinations.",
        "Mnemonic: hot as a hare, blind as a bat, dry as a bone, red as a beet, mad as a hatter.",
        "In rural India Datura is eaten accidentally in adulterated flour or given criminally to travellers.",
        "**Opioid** toxidrome: pinpoint pupils with respiratory rate **below 12** and coma.",
        ...
        "**Sympathomimetic** toxidrome (amphetamine, cocaine, theophylline, thyroxine): dilated pupils, tachycardia, hypertension, sweating, agitation.",
        "Sweating distinguishes sympathomimetic from anticholinergic, where the skin is dry.",
        "**Cardiac glycoside** toxidrome (yellow oleander, digoxin): vomiting, bradycardia, any arrhythmia, yellow-green visual haloes, hyperkalaemia.",
        "Hyperkalaemia in acute glycoside poisoning is a marker of severity.",
        "Serum potassium **above 5.5 mmol/L** in glycoside poisoning predicts death without antibody therapy.",
        "Garlic or kerosene smell names an organophosphate formulation.",
        "Decaying-fish or garlic smell of phosphine names **aluminium phosphide**.",
        "Burns around the mouth name a corrosive.",
        "Bitter almond smell names cyanide.",
        "Check the axillae for sweating and the chest for crackles before committing to a toxidrome.",
      ],
    },
    {
      heading: "Organophosphate and carbamate poisoning: atropine to a dry chest, then pralidoxime",
      points: [
        "Organophosphates **irreversibly phosphorylate** acetylcholinesterase. [Eddleston 2008]",
        "The phosphorylated enzyme then ages, after which oximes no longer work. [Eddleston 2008]",
        "Carbamates carbamylate the enzyme reversibly and recover in **24-48 hours** - they do not need pralidoxime. [Eddleston 2008]",
        "Confirmation where available: red cell acetylcholinesterase or plasma pseudocholinesterase **below 50% of normal**.",
        "Treatment is always started on the clinical picture, never delayed for the enzyme level. [Eddleston 2008]",
        "Adult atropine: **1.8-3 mg IV bolus** (3-5 ampoules of 0.6 mg). [Eddleston 2008]",
        "Reassess at 5 minutes and **double the dose** at each 5-minute reassessment - 3, 6, 12, 24 mg - until atropinised. [Eddleston 2008]",
        "Under-dosing with 0.6 mg every 15 minutes is the **commonest fatal error**. [Eddleston 2008]",
        "Severe poisoning may need a cumulative **50-100 mg or more** in the first hours. [Eddleston 2008]",
        "Atropinisation end-point 1: clear chest with no crackles or wheeze. [Eddleston 2008]",
        "Atropinisation end-point 2: heart rate **above 80 per minute**. [Eddleston 2008]",
        "Atropinisation end-point 3: systolic BP **above 80 mmHg**. [Eddleston 2008]",
        "Atropinisation end-point 4: dry axillae. [Eddleston 2008]",
        "Atropinisation end-point 5: pupils no longer pinpoint. [Eddleston 2008]",
        "All five end-points must be met together, but the chest and the axillae are the ones that matter. [Eddleston 2008]",
        "Do not stop atropine because the pupils are still small or the heart rate has reached 100. [Eddleston 2008]",
        "Never titrate atropine to pupil size alone.",
        "After atropinisation run an infusion at **10-20% of the total loading dose per hour**. [Eddleston 2008]",
        "Example: 30 mg needed to atropinise means an infusion of 3-6 mg per hour.",
        "Titrate the infusion hourly to the same end-points, tapering over 24-48 hours. [Eddleston 2008]",
        "Atropine toxicity: fever with dry skin, absent bowel sounds, urinary retention, delirium, heart rate **above 140**.",
        "On atropine toxicity stop the infusion, wait, and restart at half the rate.",
        "Paediatric atropine: **0.02-0.05 mg/kg IV** first dose (minimum 0.1 mg), doubled every 5 minutes to the same end-points.",
        "Paediatric atropine infusion at 10-20% of the loading dose per hour.",
        "There is **no maximum dose** of atropine in poisoning. [Eddleston 2008]",
        "Adult pralidoxime loading: **30 mg/kg** (usually 1-2 g) IV in 100 mL saline over 15-30 minutes. [Eddleston 2008]",
        "Pralidoxime infusion: **8-10 mg/kg/hour** (about 500 mg/hour) for at least 24 hours. [Eddleston 2008]",
        "Continue pralidoxime until the patient is off atropine and breathing normally.",
        "Without an infusion pump give pralidoxime **1 g IV every 4-6 hours**.",
        "Paediatric pralidoxime: **25-50 mg/kg IV** over 30 minutes, then 10-20 mg/kg/hour.",
        "Give pralidoxime **only after atropine has started** - never before and never instead. [Eddleston 2008]",
        "Rapid pralidoxime injection causes hypertension, tachycardia and laryngospasm - always dilute and infuse.",
        "Pralidoxime is renally cleared - reduce the dose in renal failure.",
        "Intermediate syndrome appears **24-96 hours** after apparent recovery. [Eddleston 2008]",
        "Intermediate syndrome: proximal limb, neck flexor and respiratory muscle weakness with cranial nerve palsies. [Eddleston 2008]",
        "Intermediate syndrome needs **ventilation, not more atropine**. [Eddleston 2008]",
        "Bedside test for intermediate syndrome: ask the patient to lift the head off the pillow.",
        "Organophosphate-induced delayed polyneuropathy: distal sensorimotor neuropathy at **2-3 weeks**, no specific treatment.",
        "**Never use succinylcholine** to intubate an organophosphate-poisoned patient - the same cholinesterase metabolises it, giving a block lasting hours.",
        "Use a non-depolarising agent such as **rocuronium 1 mg/kg** instead.",
        "Avoid aminoglycosides and morphine - they worsen neuromuscular weakness.",
      ],
    },
    {
      heading: "Paracetamol overdose and N-acetylcysteine",
      points: [
        "Single acute ingestion **above 150 mg/kg, or above 7.5 g in an adult**, is potentially hepatotoxic. [NICE/RCEM 2023]",
        "Threshold falls to **75-100 mg/kg** in the malnourished, the chronic alcoholic and in anorexia.",
        "Threshold also falls to 75-100 mg/kg on enzyme inducers - phenytoin, carbamazepine, rifampicin, isoniazid.",
        "Mechanism: glutathione is depleted and the reactive metabolite **NAPQI** causes centrilobular necrosis.",
        "Stage 1 (**0-24 hours**): nausea and vomiting, or nothing at all - a well-looking patient at 6 hours proves nothing.",
        "Stage 2 (**24-72 hours**): right upper quadrant pain with rising transaminases and INR.",
        "Stage 3 (**72-96 hours**): fulminant hepatic failure with encephalopathy.",
        ...
        "Treat first, ask afterwards if the time of ingestion is unknown. [NICE/RCEM 2023]",
        "Treat first if the ingestion was **staggered over more than an hour**. [NICE/RCEM 2023]",
        "Treat first if the level cannot be obtained **within 8 hours**. [NICE/RCEM 2023]",
        "IV N-acetylcysteine 21-hour regimen, bag 1: **150 mg/kg in 200 mL of 5% dextrose over 60 minutes**. [NICE/RCEM 2023]",
        "Bag 2: **50 mg/kg in 500 mL of 5% dextrose over 4 hours**. [NICE/RCEM 2023]",
        ...
        "Oral N-acetylcysteine where IV is unavailable: **140 mg/kg loading, then 70 mg/kg every 4 hours for 17 doses** (72 hours total).",
        "Vomiting within an hour of an oral dose: repeat that dose after an antiemetic such as ondansetron.",
        "N-acetylcysteine is **nearly 100% protective when started within 8 hours** of ingestion.",
        "N-acetylcysteine is still given **after 24 hours and in established liver failure** - it improves survival, so never withhold it for late presentation.",
        "Anaphylactoid reaction to the first bag - flushing, urticaria, wheeze - is **rate-related, not allergic**.",
        "On an anaphylactoid reaction: stop the infusion, give **chlorphenamine 10 mg IV**, nebulise salbutamol for wheeze, restart slower - never abandon treatment.",
        "King's College criterion 1 for transplant referral: **arterial pH below 7.30** after resuscitation.",
        "King's College criterion 2: the triad of **INR above 6.5, creatinine above 3.4 mg/dL and grade III-IV encephalopathy**.",
        "A rising lactate and a rising INR on day 3 are the practical clinic warnings.",
        "Check INR, creatinine, ALT, glucose and pH in every treated patient.",
      ],
    },
    {
      heading: "Corrosive ingestion: the value is in what you do not do",
      points: [
        "Acids (toilet and drain cleaners with hydrochloric or sulphuric acid) cause **coagulative necrosis** - the eschar limits depth.",
        "Acids injure the **stomach** preferentially.",
        "Alkalis (caustic soda, lye, button batteries) cause **liquefactive necrosis** that burrows deeply.",
        "Alkalis injure the **oesophagus** preferentially.",
        "In India acid ingestion predominates - deliberate, and accidental from cleaners decanted into drink bottles.",
        ...
        "The airway is the emergency: **stridor, hoarseness, drooling or oropharyngeal oedema** means early intubation by the most experienced person, or a surgical airway.",
        "Oedema progresses over hours - intubate on the trend, not after failure.",
        "Blind nasal intubation is dangerous in corrosive injury.",
        "Keep **nil by mouth** and give IV fluids.",
        "Give opioid analgesia.",
        "Give a **proton pump inhibitor IV**.",
        "Antibiotics only if there is perforation or mediastinitis.",
        "Steroids are not routine - they do not prevent stricture and may mask perforation.",
        ...
        "Presence of oral burns does not prove oesophageal injury.",
        "Decide to scope on symptoms and the substance, not on the lips.",
        "Upper GI endoscopy **between 12 and 48 hours** grades the burn (Zargar grade I to IV) and predicts stricture. [Zargar 1991]",
        "Scoping before 12 hours underestimates; after 48 hours it risks perforation. [Zargar 1991]",
        "Erect chest and abdominal radiographs look for free air and mediastinal air.",
        ...
        "Refer every deliberate corrosive ingestion and every symptomatic accidental one to a centre with endoscopy and surgery.",
        "Long-term risks: stricture and gastric outlet obstruction.",
    ...
    },
    {
      ...
      points: [
        "**Aluminium phosphide** (Celphos, Quickphos, the wheat pill) releases phosphine gas on contact with gastric acid and moisture. [Mehrpour 2012]",
        "A single **3 g tablet** of aluminium phosphide contains enough to kill an adult. [Mehrpour 2012]",
        "Aluminium phosphide presents with vomiting, a garlic or decaying-fish smell, profound refractory hypotension and severe metabolic acidosis.",
        ...
        "Give high-flow oxygen and large-volume crystalloid.",
        "Give **noradrenaline** for the vasoplegic shock.",
        "Give sodium bicarbonate for acidosis and magnesium sulphate for arrhythmias, and admit to intensive care.",
        "Ventilate the room and **avoid mouth-to-mouth** - the exhaled phosphine is toxic to the rescuer.",
        "**Superwarfarin rodenticides** (bromadiolone, brodifacoum) are long-acting vitamin K antagonists with a half-life of **weeks**.",
        "A single small accidental paediatric superwarfarin ingestion usually needs only an **INR at 24 and 48 hours**.",
        "In bleeding: **vitamin K1 (phytomenadione) 10 mg by slow IV injection over at least 20 minutes**.",
        "Add **fresh frozen plasma 15 mL/kg** or a prothrombin complex concentrate for active bleeding.",
        "Then continue **oral vitamin K1 10-50 mg daily for weeks to months**, guided by the INR.",
        "Prophylactic vitamin K in the asymptomatic patient is not given - it masks the INR.",
        "**Yellow phosphorus paste (Ratol)** is deceptively benign at first and then destroys the liver.",
        "Yellow phosphorus phase 1: vomiting with luminescent, garlic-smelling, so-called smoking stools.",
        "Yellow phosphorus phase 2: symptom-free window of **1-3 days**.",
        "Yellow phosphorus phase 3: fulminant hepatic failure with renal failure and coagulopathy at **day 4-8**.",
        "Yellow phosphorus has no antidote - the only definitive treatment is liver transplantation, so refer early to a liver unit.",
        "**Yellow oleander** (Thevetia peruviana) and the suicide tree (Cerbera odollam) contain cardiac glycosides. [de Silva 2003]",
        "**Two to five chewed oleander seeds** can kill.",
        "Oleander picture: vomiting, bradycardia, any degree of AV block, ventricular ectopy or bidirectional ventricular tachycardia.",
        "Oleander **hyperkalaemia** reflects sodium-potassium pump blockade, not a potassium load.",
        "Manage oleander with continuous cardiac monitoring.",
        "Multiple-dose activated charcoal **50 g then 25 g every 6 hours** for oleander. [de Silva 2003]",
        "**Atropine 0.6-1.2 mg IV** for symptomatic bradycardia, repeatable to 3 mg.",
        "Correct hypokalaemia and magnesium.",
        "Temporary transvenous pacing for high-grade block.",
        "**Digoxin-specific antibody fragments** are the definitive oleander antidote where affordable.",
        "**Avoid IV calcium** in glycoside toxicity by convention - treat hyperkalaemia with insulin-dextrose and bicarbonate instead.",
        "The deciding factor in Indian practice is transfer - a clinic can atropinise, load pralidoxime, start N-acetylcysteine, give vitamin K and charcoal, and secure an airway.",
        "Ventilators, endoscopy, pacing and dialysis are elsewhere - call the receiving unit.",
        "Send a written note of every drug, dose and time with the patient.",
      ],
    },
  ],
  tables: [
