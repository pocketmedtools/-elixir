  ...
  sections: [
    {
      ...
      points: [
        "Anaphylaxis is a **serious systemic hypersensitivity reaction of rapid onset** that may cause death. [WAO 2020]",
        "WAO and RCUK both define it by sudden onset with **airway, breathing or circulation compromise**, usually with skin and mucosal changes. [RCUK 2021]",
        "Diagnosis is clinical at the bedside - no test is needed before treatment. [RCUK 2021]",
        "Pattern 1: sudden illness with typical skin or mucosal changes plus respiratory or cardiovascular compromise. [WAO 2020]",
        "Pattern 2: sudden hypotension and collapse after exposure to a known allergen for that patient, even with **no rash at all**. [WAO 2020]",
        ...
        "Mechanism is **IgE-mediated mast cell and basophil degranulation** in most cases.",
        "Non-IgE mechanisms (radiocontrast, vancomycin, NSAIDs, opioids) produce an identical picture.",
        "The older term anaphylactoid is no longer used - the treatment is the same. [WAO 2020]",
        "Death from **upper airway obstruction** at a median of 5 minutes in iatrogenic reactions.",
        "Death from bronchospasm at a median of **15 minutes** in food-related reactions.",
        "Death from profound vasodilatory shock with plasma leak - up to **35% of circulating volume** shifts into the interstitium within 10 minutes.",
        "Drug triggers in Indian practice: injectable and oral penicillins and cephalosporins, NSAIDs including diclofenac.",
        "Infusion triggers: iron sucrose and iron dextran, anti-snake venom, radiocontrast, vaccines.",
        "Other triggers: hymenoptera (bee and wasp) stings.",
        "Food triggers: peanut, sesame, prawn, egg, cow milk.",
      ],
    },
    {
      ...
      points: [
        ...
        "Alpha-1 vasoconstriction reverses the vasodilatation and mucosal oedema.",
        "Beta-1 effect is inotropic; beta-2 effect bronchodilates and stabilises mast cells.",
        "There is **no absolute contraindication** to adrenaline in anaphylaxis. [RCUK 2021]",
        "Adult dose: **adrenaline 0.5 mg IM** = 0.5 mL of 1:1000 (1 mg/mL). [RCUK 2021]",
        "Site: anterolateral aspect of the **mid-thigh** (vastus lateralis). [RCUK 2021]",
        "Repeat adrenaline **every 5 minutes** if there is no improvement. [RCUK 2021]",
        "Over 12 years: **0.5 mg** (0.5 mL of 1:1000) IM. [RCUK 2021]",
        "6-12 years: **0.3 mg** (0.3 mL of 1:1000) IM. [RCUK 2021]",
        "6 months to 6 years: **0.15 mg** (0.15 mL of 1:1000) IM. [RCUK 2021]",
        "Under 6 months: **0.1-0.15 mg** IM. [RCUK 2021]",
        "Weight-based equivalent: **0.01 mg/kg** to a maximum of 0.5 mg. [WAO 2020]",
        ...
        "IV adrenaline is only for a trained practitioner with monitoring, in refractory shock. [RCUK 2021]",
        "IV adrenaline is given as **50 microgram boluses** (0.5 mL of 1:10,000) or an infusion. [RCUK 2021]",
        "The thigh beats the deltoid - absorption is faster and peak plasma levels higher.",
        "Subcutaneous and inhaled adrenaline are inadequate and must not be used. [RCUK 2021]",
        "Lay the patient **flat and raise the legs**. [RCUK 2021]",
        "Sit up only if breathing is the dominant problem. [RCUK 2021]",
        "Put a pregnant woman in the **left lateral** position. [RCUK 2021]",
    ...
    },
    {
      ...
      points: [
        "Remove the trigger where possible - stop the drug infusion, scrape off a bee sting. [RCUK 2021]",
        "Never delay adrenaline to remove the trigger. [RCUK 2021]",
        "Never induce vomiting after a food trigger.",
        "**High-flow oxygen 10-15 L/min** by a mask with reservoir bag. [RCUK 2021]",
        "Call for help and for an ambulance in every case. [RCUK 2021]",
        "Adult fluid challenge: **500-1000 mL** balanced crystalloid or 0.9% saline over 5-10 minutes. [RCUK 2021]",
        "Child fluid challenge: **10 mL/kg** crystalloid. [RCUK 2021]",
        ...
        "**Glucagon 1-2 mg IV over 5 minutes**, repeatable, for the patient on beta-blockers who does not respond to adrenaline. [RCUK 2021]",
        "Child glucagon **20-30 microgram/kg**, maximum 1 mg. [RCUK 2021]",
        "Antihistamines and steroids are **third-line and no longer routine**. [RCUK 2021]",
        "RCUK 2021 removed routine chlorphenamine and hydrocortisone from the algorithm - they do nothing for airway, breathing or circulation and delay adrenaline. [RCUK 2021]",
        "If used after stabilisation for skin symptoms: **chlorphenamine 10 mg** IM or slow IV in an adult. [RCUK 2021]",
        "If used after stabilisation: **hydrocortisone 200 mg IV** in an adult. [RCUK 2021]",
        "Call an anaesthetist or the nearest intubation-capable facility at the **first hint of stridor or tongue swelling**.",
        "A delayed airway in anaphylaxis is often an impossible one.",
      ],
    },
    {
      heading: "Refractory anaphylaxis, observation and biphasic reactions",
      points: [
        "Refractory anaphylaxis: persisting airway, breathing or circulation problems despite **two appropriate IM doses** of adrenaline. [RCUK 2021]",
        "Refractory anaphylaxis needs an **adrenaline infusion**, aggressive fluids and expert help. [RCUK 2021]",
        "A refractory patient must be moved to critical care. [RCUK 2021]",
        "Patients on **beta-blockers** have more severe, more refractory reactions - the beta-2 response is blocked.",
        "Patients on **ACE inhibitors** have more severe reactions - bradykinin degradation is impaired.",
        "Biphasic reaction: recurrence after apparent recovery without further exposure. [RCUK 2021]",
        "Biphasic reactions occur in about **3-5%** of cases, typically within 4-12 hours. [RCUK 2021]",
        "Observation is therefore mandatory even if the patient looks perfectly well. [RCUK 2021]",
        "Observe **at least 6 hours** after a reaction that responded promptly to a single dose of adrenaline. [RCUK 2021]",
        "Observe **at least 12 hours or admit overnight** for severe reactions or those needing more than one dose. [RCUK 2021]",
        "Observe at least 12 hours with a history of biphasic reactions or severe asthma. [RCUK 2021]",
        "Observe at least 12 hours if presenting late in the evening or living far from medical care - common in rural India. [RCUK 2021]",
        "Serum **mast cell tryptase** confirms degranulation retrospectively. [RCUK 2021]",
        "Tryptase timing: as soon as possible after treatment, at 1-2 hours, and at 24 hours for baseline. [RCUK 2021]",
        "A normal tryptase does not exclude anaphylaxis - treatment is never delayed for it. [RCUK 2021]",
      ],
    },
    {
      heading: "Discharge, prevention and the family physician's role",
      points: [
        "Prescribe **two adrenaline auto-injectors** where available and affordable, and demonstrate the technique. [EAACI 2021]",
        "Auto-injector dose: **0.3 mg** for over 30 kg, 0.15 mg for 7.5-25 kg. [EAACI 2021]",
        "Where auto-injectors are unavailable, as in much of India, prescribe adrenaline ampoules with a labelled 1 mL syringe.",
        "Train the family in person to draw up and inject adrenaline.",
        "Give a **written anaphylaxis action plan**. [EAACI 2021]",
        "Name the trigger explicitly in the record and on a card the patient carries.",
        "Issue a medical alert bracelet or card where possible.",
        "Refer to an allergy clinic for confirmation of the trigger by **specific IgE or skin testing**. [EAACI 2021]",
        "Allergy referral also gives advice on cross-reactivity.",
        "Consider **venom immunotherapy** after a systemic hymenoptera sting reaction. [EAACI 2021]",
        "Document the drug allergy prominently in the clinic record and on every prescription.",
        "A **written allergy label** is the single most effective preventive measure a family physician can implement.",
        "Teach food label reading and warn about hidden allergens in restaurant food.",
        "Counsel about co-factors that amplify reactions: **exercise, alcohol, NSAIDs, intercurrent infection**. [EAACI 2021]",
        "Ask about drug allergy before every injection.",
        "Keep the patient in the clinic for **20-30 minutes** after an injectable penicillin, iron infusion or vaccine.",
        "Have adrenaline drawn up and checked before the injection is given.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Sudden onset within minutes of a parenteral trigger. [RCUK 2021]",
            "Urticaria and angioedema are the skin and mucosal changes.",
            "Bronchospasm is the breathing problem; dizziness from hypotension is the circulation problem.",
            "Airway: hoarseness, stridor, tongue swelling. [RCUK 2021]",
            "Breathing: wheeze, respiratory rate, SpO2. [RCUK 2021]",
            "Circulation: pulse rate, blood pressure, capillary refill. [RCUK 2021]",
            "Disability: level of consciousness. [RCUK 2021]",
            "Skin signs are absent in up to **20% of fatal reactions**. [RCUK 2021]",
            "Hypotension after a known trigger alone is sufficient for the diagnosis. [WAO 2020]",
          ],
        },
        {
          heading: "2. Immediate treatment",
          points: [
            "**Adrenaline 0.5 mg IM** (0.5 mL of 1:1000) into the anterolateral mid-thigh immediately. [RCUK 2021]",
            "Repeat adrenaline **every 5 minutes** if there is no improvement. [RCUK 2021]",
            "Lay her flat with the legs elevated - do not sit or stand her up. [RCUK 2021]",
            "If breathing is the dominant problem allow her to sit. [RCUK 2021]",
            "Use the left lateral position if she were pregnant. [RCUK 2021]",
            "High-flow oxygen **15 L/min** through a mask with a reservoir bag. [RCUK 2021]",
            "Establish wide-bore IV access.",
            "Give **500-1000 mL crystalloid** rapidly, repeated according to blood pressure. [RCUK 2021]",
            "Call for help and for an ambulance. [RCUK 2021]",
            "Assign one person to monitor pulse, BP, SpO2 and consciousness **every 5 minutes**.",
          ],
        },
        {
          heading: "3. Adjuncts and refractory reaction",
          points: [
            "**Nebulised salbutamol 5 mg** for persistent wheeze. [RCUK 2021]",
            "**Nebulised adrenaline 5 mL of 1:1000** for stridor. [RCUK 2021]",
            "**Glucagon 1-2 mg IV** if she is on a beta-blocker and fails to respond. [RCUK 2021]",
            "Symptoms persisting after two IM doses = **refractory anaphylaxis**. [RCUK 2021]",
            "Refractory: start an adrenaline infusion under monitoring. [RCUK 2021]",
            "Refractory: continue aggressive fluids and arrange critical care transfer. [RCUK 2021]",
            "Chlorphenamine 10 mg IM and hydrocortisone 200 mg IV are **third-line**, only after stabilisation. [RCUK 2021]",
            "Antihistamines and steroids are no longer part of the initial algorithm. [RCUK 2021]",
            "Prepare for airway compromise early - intubation by the most experienced person available.",
            "Have a surgical airway plan if the airway is lost.",
          ],
        },
        {
          heading: "4. Observation and investigation",
          points: [
            "Observe for **at least 6 hours** after full resolution. [RCUK 2021]",
            "Observe **12 hours or overnight** if the reaction was severe or needed more than one dose of adrenaline. [RCUK 2021]",
            "Observe 12 hours if asthma was involved, onset was late at night, or she lives far from medical care. [RCUK 2021]",
            "Serum mast cell tryptase as soon as possible after treatment and at **1-2 hours**. [RCUK 2021]",
            "A baseline tryptase at 24 hours or at follow-up, where the facility exists. [RCUK 2021]",
            "Warn her and her family about biphasic reactions - **3-5%** of cases, up to 12 hours later. [RCUK 2021]",
            "Tell them what to do if symptoms recur.",
          ],
        },
        {
      ...
      answer: [
        {
          ...
          points: [
            "**1:1000 = 1 mg in 1 mL** - the standard ampoule.",
            "1:1000 is used IM in anaphylaxis and by nebuliser for croup and laryngeal oedema.",
            "**1:10,000 = 1 mg in 10 mL** - the pre-filled cardiac arrest syringe, used IV.",
            "An auto-injector delivers a fixed **0.3 mg or 0.15 mg** IM.",
          ],
        },
        {
          heading: "Indications, doses and routes",
          points: [
            "Anaphylaxis adult: **0.5 mg IM of 1:1000** into the anterolateral thigh, repeated every 5 minutes. [RCUK 2021]",
            "Anaphylaxis child: **0.01 mg/kg IM** (max 0.5 mg), repeated every 5 minutes. [RCUK 2021]",
            "Cardiac arrest adult: **1 mg IV/IO of 1:10,000** every 3-5 minutes. [ERC 2021]",
            "Cardiac arrest child: **10 microgram/kg IV/IO** every 3-5 minutes. [ERC 2021]",
            "Croup and post-extubation stridor: **nebulised 5 mL of 1:1000**.",
            "Paediatric nebulised dose: 0.5 mL/kg of 1:1000, maximum 5 mL.",
            "Symptomatic bradycardia and post-arrest shock: adult infusion **2-10 microgram/min**, titrated to response. [AHA 2020]",
            "Added to local anaesthetic at **1:200,000** to prolong action and reduce bleeding.",
            "Traditionally avoided in digits, nose, ear and penis - modern evidence questions the digital rule.",
          ],
        },
        {
          ...
          points: [
            ...
            "IV use requires 1:10,000, monitoring and **50 microgram boluses**. [RCUK 2021]",
            "Subcutaneous administration in anaphylaxis is too slow and no longer recommended. [RCUK 2021]",
            "The deltoid is inferior to the thigh for absorption.",
            "Expected effects: tremor, palpitation, anxiety, headache, pallor - not a reason to withhold the drug in anaphylaxis.",
            ...
            "Discard discoloured or brown solution.",
            "Check expiry monthly as part of the emergency tray audit.",
          ],
        },
      ],
      ...
      answer: [
        {
          heading: "Anaphylaxis",
          points: [
            "Onset within minutes of a trigger.",
            "**Tachycardia** with hypotension - the opposite of vasovagal.",
            "Urticaria, angioedema, itch, wheeze and often gastrointestinal symptoms.",
            "Warm peripheries from vasodilatation early, then cold and shut down as shock deepens.",
            "Treatment: **IM adrenaline**, oxygen, fluids. [RCUK 2021]",
            "Observe for a biphasic reaction. [RCUK 2021]",
          ],
        },
        {
          heading: "Vasovagal syncope",
          points: [
            "Onset often at the sight of the needle or immediately after it.",
            "**Bradycardia**, pallor, sweating, nausea and a brief loss of consciousness.",
            "No urticaria, no itch, no wheeze, no angioedema.",
            "Skin is cold and clammy but not raised.",
            "Recovery within a **minute or two** of lying flat with the legs raised.",
            "Treatment is reassurance and fluids.",
            "Atropine only for prolonged symptomatic bradycardia.",
          ],
        },
        {
          heading: "ACE inhibitor angioedema",
          points: [
            "Bradykinin-mediated, so **no urticaria and no itch**.",
            "Typically isolated lip, tongue, facial or laryngeal swelling.",
            "May occur at any time from the first dose to years after starting the drug.",
            "More common in patients of African origin.",
            "Adrenaline, antihistamines and steroids are usually **ineffective**.",
            "Priorities: airway protection and permanent discontinuation of the drug.",
            "Switch to a non-ACE agent.",
            "**Icatibant** or C1 inhibitor concentrate where available.",
          ],
        },
      ],
