  ...
  sections: [
    {
      ...
      points: [
        ...
        "Listing all of ABCDE and then going back to treat fails the sequence.",
        "The correct answer decompresses the tension pneumothorax at B and does not mention C until it is done.",
        "Modern practice puts **catastrophic external haemorrhage before the airway** - <C>ABCDE. [NICE NG39]",
        "<C>ABCDE: Catastrophic haemorrhage, Airway with cervical spine protection, Breathing and ventilation.",
        "<C>ABCDE continued: Circulation with haemorrhage control, Disability, Exposure with environmental control.",
        "An exsanguinating femoral or scalp wound kills faster than an unprotected airway.",
        "**Reassess from the beginning** after every intervention and whenever the patient deteriorates. [ATLS 10e]",
        "Sudden deterioration in a ventilated or bagged trauma patient is a **tension pneumothorax until proved otherwise** - go back to A and B, not more fluid.",
        ...
        "A family clinic influences only the second peak - every part of the primary survey is aimed at it.",
        "Trauma teams work **horizontally, not vertically** - tasks run at the same time.",
        "With three people: airway is one person's job, chest and lines another's, exposure, monitoring and the record the third's.",
        "One person is nominated team leader and touches nobody.",
      ],
    },
    {
      heading: "C, A and B: haemorrhage, airway and breathing",
      points: [
        "Catastrophic haemorrhage: **firm direct pressure** with a gloved hand and a pad. [ATLS 10e]",
        "If pressure fails on a limb: **windlass tourniquet proximally**, tightened until bleeding stops, time of application written on the patient. [ATLS 10e]",
        "Junctional and scalp bleeding is controlled by packing and sustained pressure.",
        "Do not blindly clamp in a wound.",
        "Airway: **talk to the patient** - a normal voice means a patent airway, breathing and a perfused brain. [ATLS 10e]",
        "Look for blood, vomit, teeth and swelling; suction under direct vision.",
        "Open the airway with a **jaw thrust or chin lift - never a head tilt** in a trauma patient. [ATLS 10e]",
        "Oropharyngeal airway in the unconscious.",
        "Definitive airway indication 1: apnoea. [ATLS 10e]",
        "Definitive airway indication 2: unprotected airway with **GCS of 8 or less**. [ATLS 10e]",
        "Definitive airway indication 3: sustained hypoxia despite oxygen. [ATLS 10e]",
        "Definitive airway indication 4: expanding neck haematoma or airway burn. [ATLS 10e]",
        "Definitive airway indication 5: the combative head injury needing transfer.",
        "When intubation is impossible: supraglottic airway or **surgical cricothyroidotomy**. [ATLS 10e]",
        "Every clinic receiving trauma should own a scalpel, a bougie and a size 6 tube for cricothyroidotomy.",
        "Cervical spine: **manual in-line stabilisation** while the airway is managed. [ATLS 10e]",
        "Then a rigid collar with blocks and tape, or the patient held still and calm.",
        "A collar alone does not immobilise.",
        "A fighting head-injured patient in a collar raises intracranial pressure - allow controlled motion restriction instead.",
        "Breathing: expose the chest, count the respiratory rate, look for asymmetry and paradox. [ATLS 10e]",
        "Feel for surgical emphysema and tracheal deviation, percuss, auscultate both axillae.",
        "**Oxygen 15 L/min by non-rebreathing mask** to every major trauma patient. [ATLS 10e]",
        "Six immediately life-threatening chest injuries: airway obstruction, **tension pneumothorax**, open pneumothorax. [ATLS 10e]",
        "The six continued: massive haemothorax, flail chest with pulmonary contusion, cardiac tamponade. [ATLS 10e]",
        "Every one is a clinical diagnosis - none waits for a radiograph.",
        "Tension pneumothorax: immediate **needle thoracostomy, 14-gauge cannula, fifth intercostal space, anterior axillary line**. [ATLS 10e]",
        "The traditional second space mid-clavicular line often fails to reach the pleura in adults. [ATLS 10e]",
        "In children the second space mid-clavicular line remains appropriate.",
        "Needle decompression is followed at once by an **intercostal drain in the safe triangle**. [ATLS 10e]",
        "Open pneumothorax (sucking chest wound): square dressing **taped on three sides** - air escapes but does not enter. [ATLS 10e]",
        "Place the chest drain away from the open wound.",
        "Massive haemothorax: **more than 1500 mL immediately, or more than 200 mL/hour for 2-4 hours**. [ATLS 10e]",
        "Massive haemothorax needs a drain, blood replacement and thoracotomy. [ATLS 10e]",
        "Tamponade needs pericardiocentesis or thoracotomy. [ATLS 10e]",
      ],
    },
    {
      heading: "C: circulation and haemorrhage control",
      points: [
        "**Hypotension in trauma is haemorrhage until proved otherwise.** [ATLS 10e]",
        "Five places blood hides: on the floor and four more - chest, abdomen, pelvis and retroperitoneum, long bones. [ATLS 10e]",
        "A femoral fracture can hold **1-1.5 litres**; the pelvis several litres.",
        "A narrow pulse pressure and a rising heart rate come **before** a falling blood pressure. [ATLS 10e]",
        "A normal systolic pressure does not exclude significant blood loss.",
        "A fit young adult compensates until about **30% of blood volume** is lost. [ATLS 10e]",
        "A pregnant woman's expanded volume masks loss while the fetus is already shocked.",
        "Elderly patients on beta-blockers do not mount a tachycardia at all.",
        "**Control bleeding mechanically before fluid** - direct pressure and tourniquets for limbs. [ATLS 10e]",
        "Pelvic binder at the level of the **greater trochanters, not the iliac crests**, for a suspected pelvic fracture. [ATLS 10e]",
        "Traction splinting and realignment for long bones.",
        "Do not spring the pelvis repeatedly - it disturbs clot.",
        "Two short wide cannulae (**14 or 16 gauge**) in the antecubital fossae. [ATLS 10e]",
        "Draw blood for cross-match, haemoglobin, glucose and a pregnancy test.",
        "Give **one litre of warmed crystalloid**. [ATLS 10e]",
        "No response, or transient response: the next fluid is **blood, not more crystalloid**. [ATLS 10e]",
        "Children: **20 mL/kg warmed crystalloid, then 10 mL/kg blood**. [ATLS 10e]",
        "**Tranexamic acid 1 g IV over 10 minutes** as early as possible and always within 3 hours of injury. [CRASH-2]",
        "Then tranexamic acid 1 g by infusion over 8 hours. [CRASH-2]",
        "Tranexamic acid **after 3 hours increases mortality** - the time of injury governs the decision. [CRASH-2]",
        "Paediatric tranexamic acid: **15 mg/kg (maximum 1 g) over 10 minutes, then 2 mg/kg/hour**.",
        "Tranexamic acid is one of the very few interventions a small clinic can give that measurably saves lives.",
        "Damage control resuscitation: **permissive hypotension to systolic 80-90 mmHg** (radial pulse present, patient talking) until surgical control. [Spahn 2019]",
        "Warmed balanced blood products in a **1:1:1 ratio** of red cells, plasma and platelets. [Spahn 2019]",
        ...
        "Where haemorrhage and head injury coexist, the brain wins and the pressure is supported.",
        "Prevent the **lethal triad** of hypothermia, acidosis and coagulopathy. [ATLS 10e]",
        "Warm the fluids, warm the patient, remove wet clothing, use a warming blanket, turn up the room heater.",
        "A cold trauma patient will not clot however much plasma is given.",
      ],
    },
    {
      heading: "D and E, adjuncts and the secondary survey",
      points: [
        "Disability: record the **GCS as its three components** (eye 4, verbal 5, motor 6). [ATLS 10e]",
        "Examine pupil size and reaction and look for lateralising signs.",
        "Check capillary glucose in every unconscious trauma patient.",
        "**GCS of 8 or less** means the airway is unprotected. [ATLS 10e]",
        "Hypoxia and hypotension **double the mortality** of traumatic brain injury. [BTF 2016]",
        "Keep SpO2 above 94% and systolic pressure **above 110 mmHg**. [BTF 2016]",
        "Avoid hypercapnia and hypocapnia.",
        "Nurse the head up 30 degrees and treat pain and agitation - these simple measures matter more than any drug.",
        "Herniation signs: unilateral fixed dilated pupil, extensor posturing, or a **fall of 2 or more GCS points**.",
        "For herniation: **mannitol 20% at 0.25-1 g/kg IV over 15-20 minutes**. [BTF 2016]",
        "Alternative: 3% hypertonic saline 3-5 mL/kg.",
        "Mannitol requires an adequate blood pressure and a urinary catheter.",
        "Transfer immediately to a centre with a CT scanner and neurosurgery.",
        "Exposure: undress fully. [ATLS 10e]",
        "**Log roll with four people** and manual in-line stabilisation to inspect and palpate the back. [ATLS 10e]",
        "Rectal examination if indicated.",
        "Cover immediately with warm blankets - hypothermia sets in within minutes on a trolley in a cold room.",
        "Adjuncts: monitoring and pulse oximetry, ECG, chest and pelvic radiographs. [ATLS 10e]",
        "Adjuncts continued: extended FAST scan where available, urinary catheter, gastric tube. [ATLS 10e]",
        "No urethral catheter with **blood at the meatus, perineal or scrotal bruising or a high-riding prostate**. [ATLS 10e]",
        "Pass a gastric tube by the **oral route** if a base-of-skull fracture is suspected. [ATLS 10e]",
        "Secondary survey: head-to-toe examination with an **AMPLE history**. [ATLS 10e]",
        "AMPLE: Allergies, Medications, Past illness and Pregnancy, Last meal, Events and Environment of the injury.",
        "The secondary survey begins only when the primary survey is complete and the patient is not deteriorating. [ATLS 10e]",
        "In a clinic preparing a transfer, the secondary survey often happens at the receiving hospital - that is acceptable.",
        "Analgesia in titrated IV doses: **morphine 0.1 mg/kg** titrated.",
        "Alternative: **ketamine 0.25-0.5 mg/kg IV** - it preserves blood pressure in shock.",
        "Give tetanus prophylaxis.",
        "Antibiotics **within one hour** for an open fracture.",
        "Splint fractures and cover open wounds with saline-soaked gauze.",
        "Photograph or document wounds before dressing.",
      ],
    },
    {
      ...
      points: [
        ...
        "No test that will not change what the clinic can do should delay departure.",
        "The commonest avoidable death in Indian district practice is the patient who spent an hour waiting for a radiograph.",
        ...
        "An unannounced transfer to a hospital with no bed or no surgeon wastes the golden hour twice.",
        "Package: airway secured or a clear plan for it.",
        "Package: oxygen with enough cylinder for **twice the journey time**.",
        "Package: two working cannulae taped and running, with fluids and blood.",
        "Package: haemorrhage controlled with pressure dressings, tourniquets or a binder.",
        "Package: fractures splinted, spine motion restricted.",
        "Package: urinary catheter and gastric tube where indicated, patient wrapped and warm.",
        "**Never transfer** with an untreated tension pneumothorax, uncontrolled external haemorrhage, unprotected airway, or unsplinted pelvis.",
        "Deterioration in a moving ambulance without space, light or help is the situation to avoid at all costs.",
        "Hand over in **ATMIST** format: Age, Time of injury, Mechanism, Injuries found and suspected, Signs with trends, Treatment given with times.",
        "Deliver the handover once, in a quiet room, with everyone listening, and give a written copy with the ambulance.",
        "Send a written record of the times of injury, arrival, drugs and fluids, and the **tranexamic acid time**.",
        "Send radiographs and reports if available, and a cross-match sample.",
        "Send the medico-legal register entry number.",
        "Send the name and telephone number of a relative who has been told where the patient is going.",
        "**Escort every unstable patient with a trained person**, not the driver alone. [AAGBI 2019]",
        "Equip the escort with oxygen, suction, a self-inflating bag, a monitor if available, and the drugs likely to be needed.",
        "Reassess the primary survey immediately before the doors close and again on arrival.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Universal precautions and roles allocated horizontally to the available staff.",
            "Nominate a **team leader** who does not perform procedures.",
            "Control catastrophic external bleeding immediately with **direct pressure** and a pad. [ATLS 10e]",
            "Uncontrolled limb wound: windlass tourniquet applied proximally, time written on the patient. [ATLS 10e]",
        ...
        },
        {
          ...
          points: [
            "Speak to him - restlessness may be **hypoxia or hypoperfusion**, not intoxication.",
            "Inspect for blood, teeth, vomit and swelling; suction under vision.",
            "Open the airway with a **jaw thrust, never a head tilt**; oropharyngeal airway if tolerated. [ATLS 10e]",
            "Manual in-line stabilisation, then collar, blocks and tape. [ATLS 10e]",
            "Give **oxygen 15 L/min** by non-rebreathing mask. [ATLS 10e]",
            "Expose the chest and look, feel, percuss and listen.",
            "Respiratory rate 34 with shock demands exclusion of tension pneumothorax, open pneumothorax, massive haemothorax, flail chest and tamponade.",
            "Tension pneumothorax: decompress at once with a **14-gauge cannula, fifth intercostal space, anterior axillary line**. [ATLS 10e]",
            "Follow needle decompression with an intercostal drain in the safe triangle. [ATLS 10e]",
          ],
        },
        {
          ...
          points: [
            ...
            "Search the five sites of concealed loss: chest, abdomen, pelvis and retroperitoneum, long bones, and the floor. [ATLS 10e]",
            "A femoral fracture alone can hold **1-1.5 litres**.",
            "Pelvic binder at the level of the greater trochanters if a pelvic fracture is suspected. [ATLS 10e]",
            "Splint and gently realign the femur with traction, and dress open wounds.",
            "Two **14-16 gauge cannulae**; blood for cross-match, haemoglobin and glucose. [ATLS 10e]",
            ...
            "Resuscitate to a palpable radial pulse and **systolic 80-90 mmHg**, not a normal blood pressure. [Spahn 2019]",
            "A significant head injury instead requires a systolic **above 110 mmHg**. [BTF 2016]",
          ],
        },
        {
          heading: "4. Disability, exposure and adjuncts",
          points: [
            "Record **GCS in its three components**, pupil size and reaction, lateralising signs and capillary glucose. [ATLS 10e]",
            "Undress fully and log roll with four people to examine the back. [ATLS 10e]",
            "Cover with warm blankets and warm the fluids and the room - prevent the lethal triad.",
            "Adjuncts as available: chest and pelvic radiographs, extended FAST, ECG. [ATLS 10e]",
            "Urinary catheter - withheld with **blood at the meatus, perineal bruising or a high-riding prostate**. [ATLS 10e]",
            "Orogastric tube if a base-of-skull fracture is suspected.",
            "Titrated IV **morphine 0.1 mg/kg** or ketamine 0.25-0.5 mg/kg.",
            "Tetanus prophylaxis, and antibiotics **within one hour** if the femoral fracture is open.",
          ],
        },
        {
          heading: "5. Transfer",
          points: [
            "Decide to transfer on injury pattern and physiology - do not wait for imaging that will not change clinic management.",
            "Telephone the receiving surgeon, confirm **acceptance and a bed**, and call the ambulance early.",
            "Package: airway secure or planned, oxygen for **twice the journey**, two running cannulae.",
            "Package continued: haemorrhage controlled, femur splinted, spine motion restricted, warm and covered.",
            "Escort with a trained person carrying oxygen, suction, a self-inflating bag and drugs. [AAGBI 2019]",
            "Reassess the primary survey before departure.",
            "Hand over in **ATMIST** with a written copy.",
            "Send the cross-match sample and records, complete the medico-legal entry, and tell the family the destination.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Base the decision on **mechanism, injury pattern and physiology**, not on investigation results. [ATLS 10e]",
            "Never delay for a test that will not change what the clinic can do.",
            "Speak **doctor to doctor** - name the receiving consultant and unit, confirm acceptance and a bed. [ATLS 10e]",
            "Agree the destination department - emergency department, theatre or intensive care.",
            "Call the ambulance early and state the level of transport required - the wait is often the longest part of the process.",
          ],
        },
        {
          heading: "Stabilise and package",
          points: [
            "Complete the primary survey and **treat every abnormality found** before departure. [ATLS 10e]",
            "Airway secured or a written plan for it.",
            "Chest decompressed and drained.",
            "Haemorrhage controlled by pressure, tourniquet, binder or splint.",
            "Two secure, taped, running cannulae with warmed fluid and blood as needed.",
            "**Tranexamic acid given within 3 hours**; analgesia and antiemetic given. [CRASH-2]",
            "Urinary catheter and gastric tube where indicated.",
            "Fractures splinted, wounds dressed, spinal motion restricted.",
            "Patient wrapped to prevent hypothermia.",
            "**Never transfer** with an untreated tension pneumothorax, unprotected airway, uncontrolled bleeding or unsplinted pelvis.",
          ],
        },
        {
          heading: "Escort, equipment and monitoring",
          points: [
            "Send a **trained escort** with every unstable patient, never the driver alone. [AAGBI 2019]",
            "Match the escort's skill to the anticipated problems. [AAGBI 2019]",
            "Carry oxygen sufficient for **twice the estimated journey time**.",
            "Carry suction, a self-inflating bag with masks, airway adjuncts and monitoring.",
            "Carry the drugs likely to be needed, including adrenaline and analgesia.",
            "Reassess the primary survey immediately before departure.",
            "Repeat observations at fixed intervals throughout the journey and record them.",
            "Secure the patient and all equipment.",
            "Commonest transfer incidents: displaced cannula, disconnected oxygen supply, exhausted cylinder, lost tube.",
          ],
        },
        {
          heading: "Handover and documentation",
          points: [
            "Hand over once, in a quiet space, using **ATMIST**: Age, Time of injury, Mechanism, Injuries, Signs with trends, Treatment with times.",
            "Send a written copy with radiographs, laboratory results, a cross-match sample and the medico-legal register number.",
            "Document the time of injury, arrival, each intervention and drug, and the observations.",
            "Document the name of the accepting doctor and the time of departure.",
            "Inform the family of the destination and give them the hospital's contact details.",
            "Arrange for a relative to travel or follow.",
            "Complete police intimation where the case is medico-legal.",
          ],
        },
      ],
      mustDraw: [
