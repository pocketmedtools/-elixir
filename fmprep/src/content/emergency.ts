...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "Every immunisation session must have its **own anaphylaxis kit at the table**, not in another room. [AEFI 2015]",
        "Anaphylaxis kit: adrenaline 1:1000 ampoules, 1 mL and 2 mL syringes with needles. [AEFI 2015]",
        "Anaphylaxis kit continued: self-inflating bag with paediatric and infant masks, oral airways, oxygen source where available. [AEFI 2015]",
        "Anaphylaxis kit continued: a written dose card by age. [AEFI 2015]",
        "The vaccinator must state without looking: **adrenaline 1:1000 IM anterolateral thigh, 0.01 mg/kg**. [AEFI 2015]",
        "By age: 0.15 mg under 6 years, 0.3 mg for 6-12 years, 0.5 mg above 12 years. [RCUK 2021]",
        "Repeat every 5 minutes if there is no improvement. [RCUK 2021]",
        "Beneficiaries are **observed for 30 minutes** after immunisation before leaving. [AEFI 2015]",
        "The minor procedure room also needs a means of pressure haemostasis.",
        "Local anaesthetic without and with adrenaline **clearly separated** - prevents digital ischaemia.",
        "**IV lipid emulsion 20%** where regional blocks are performed.",
        "A written protocol for vasovagal syncope - far commoner than anaphylaxis.",
        "Vasovagal syncope is distinguished by **bradycardia with pallor** rather than tachycardia with urticaria.",
        "A home-visit bag is a miniature tray: adrenaline, a benzodiazepine, dextrose, aspirin, glyceryl trinitrate.",
        "Home-visit bag continued: furosemide, hydrocortisone, salbutamol with a spacer.",
        "Home-visit bag continued: self-inflating bag with mask, oral airways, glucometer, pulse oximeter, blood pressure cuff, cannulae with fluid.",
        "The home-visit bag is checked on the same weekly cycle as the clinic tray.",
        "Match the tray to what the clinic actually does.",
        "A clinic that immunises must be ready for anaphylaxis.",
        "A rural clinic in a pesticide belt must carry **enough atropine for hours of doubling doses**.",
        "A clinic that conducts deliveries must carry oxytocin, magnesium sulphate and tranexamic acid.",
        "Keep a thermometer in the vaccine refrigerator with a **twice-daily temperature log**.",
        "Never store emergency drugs inside the vaccine refrigerator - freezing destroys adrenaline and the door is opened all day.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "**One tray, one fixed location** known to all staff, sealed with a numbered breakable tag.",
            "Never locked behind a single key holder.",
            "Contents arranged by indication - anaphylaxis, arrest, seizure, hypoglycaemia, cardiac, respiratory, obstetric - in labelled compartments.",
            "A laminated **weight-based paediatric dose chart** inside the lid. [IAP PALS 2019]",
            "Stock rotated first-expiry-first-out; items within **3 months of expiry** moved to routine use.",
            "Adrenaline kept in its carton away from heat and light.",
            "The tray matched to the clinic's actual work: immunisation means anaphylaxis readiness.",
            "A pesticide belt means abundant atropine; deliveries mean oxytocin, magnesium sulphate and tranexamic acid.",
          ],
        },
        {
          ...
          points: [
            ...
            "Anaphylaxis child: 0.3 mg for 6-12 years, 0.15 mg for 6 months to 6 years. [RCUK 2021]",
            "Cardiac arrest: adrenaline 1 mg IV as 10 mL of 1:10,000 every 3-5 minutes; child 0.01 mg/kg. [AHA 2020]",
            "**Atropine** - bradycardia 0.5-0.6 mg IV every 3-5 minutes to a maximum of 3 mg. [AHA 2020]",
            "Bradycardia child: atropine 0.02 mg/kg (minimum 0.1 mg, maximum single dose 0.5 mg).",
            "Organophosphate poisoning: atropine 2-5 mg IV, **doubled every 5 minutes** until the chest is clear and skin dry. [Eddleston 2008]",
            "**Dextrose 25% 100 mL IV** for adult hypoglycaemia; 10% dextrose 5 mL/kg for a child, 2 mL/kg for a neonate.",
            "Thiamine 100 mg for the alcoholic or malnourished.",
            "Seizures: **lorazepam 4 mg IV** repeated once after 10 minutes, or midazolam 10 mg IM.",
            "Seizures child: lorazepam 0.1 mg/kg (maximum 4 mg) or buccal midazolam 0.2 mg/kg (maximum 10 mg).",
            "Cardiac: aspirin 300 mg chewed, clopidogrel 300 mg.",
            "Glyceryl trinitrate 0.5 mg sublingually up to 3 doses if systolic **above 90 mmHg**.",
            "Furosemide 40 mg IV.",
            "Respiratory: salbutamol nebulisation 5 mg (2.5 mg under 5 years) with ipratropium 500 micrograms (250 micrograms under 5 years).",
            "Hydrocortisone 100 mg IV, or 4 mg/kg in a child.",
            "Magnesium sulphate with **calcium gluconate 10%** as its antidote. [FOGSI 2019]",
            "Oxytocin 10 IU IM; tranexamic acid 1 g IV. [FOGSI 2019]",
            "Naloxone 0.4 mg; chlorpheniramine 10 mg.",
            "Normal saline, Ringer lactate and oral rehydration salts.",
          ],
        },
        {
          heading: "Essential equipment",
          points: [
            "Airway and breathing: oxygen cylinder with regulator and a spare, non-rebreathing mask for **15 L/min**. [IPHS 2022]",
            "Self-inflating bags with reservoirs: adult 1600 mL, paediatric 500 mL, neonatal 240 mL.",
            "Masks 0-5, oropharyngeal airways 000-4.",
            "Suction that works **without mains power**.",
            "Circulation: cannulae 14G to 24G, giving sets, IV fluids, a pressure bag, a tourniquet.",
            "An intraosseous needle where staff are trained.",
            "Monitoring: glucometer with in-date strips, pulse oximeter, thermometer, blood pressure cuffs in three sizes.",
            "ECG machine, and an **automated external defibrillator** with adult and paediatric pads where affordable.",
            "Support items: torch, scissors, tape, spacer with mask, dressings, cervical collar, splint.",
            "Gloves, sharps bin, a timed record sheet and a visible clock.",
          ],
        },
        {
          heading: "The readiness system",
          points: [
            "A **named owner checks the tray weekly** against a printed checklist and signs and dates the log. [NABH 2020]",
            "Shortages are reported the same day and the tray is resealed with a new numbered tag.",
            "Every staff member, clinical and non-clinical, is trained to recognise collapse, shout for help, start compressions and bring the tray.",
            "**Basic life support certification renewed every 2 years.** [AHA 2020]",
            "Fixed roles assigned in advance - compressions, tray, drugs, ambulance call, family, documentation - so no role is vacant in a real event.",
            "An **unannounced mock drill at least quarterly**. [NABH 2020]",
            "Measure times to first compression, to adrenaline drawn up and to the ambulance call.",
            "Same-day blame-free debrief producing one dated, owned change.",
            "Quarterly audit of the proportion of checks completed and of items found expired or missing.",
            "A written referral pathway with working numbers for the nearest hospital with ventilator, blood bank and dialysis, and for the ambulance.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "**Adrenaline 1:1000 ampoules, at least five**, in their carton and within expiry. [AEFI 2015]",
            "1 mL and 2 mL syringes with 23G to 25G needles for IM injection. [AEFI 2015]",
            "A self-inflating bag with reservoir and infant, child and adult masks. [AEFI 2015]",
            "Oropharyngeal airways in paediatric sizes; a suction device where available.",
            "Oxygen source with tubing and mask where available.",
            "IV cannulae, a giving set and normal saline.",
            "A torch, gloves and cotton with spirit swabs.",
            "A **laminated dose card by age** and an AEFI reporting form. [AEFI 2015]",
            "Telephone numbers for the ambulance and the referral hospital.",
          ],
        },
        {
          heading: "Recognition and dose",
          points: [
            "Suspect anaphylaxis with **sudden airway, breathing or circulation compromise** within minutes of the injection. [RCUK 2021]",
            "Usually with skin or mucosal change - urticaria, flushing or angio-oedema. [RCUK 2021]",
            "**Adrenaline 1:1000 IM into the anterolateral thigh, 0.01 mg/kg.** [RCUK 2021]",
            "By age: 0.15 mg for 6 months to 6 years, 0.3 mg for 6-12 years, 0.5 mg above 12 years and in adults. [RCUK 2021]",
            "Repeat the same dose every **5 minutes** if there is no improvement. [RCUK 2021]",
            "Two or more doses define a refractory case needing urgent transfer. [RCUK 2021]",
        ...
        },
        {
          ...
          points: [
            "Observe every beneficiary for **30 minutes** after immunisation before they leave the session site. [AEFI 2015]",
            "Vasovagal syncope is commoner - **bradycardia with pallor and sweating** rather than tachycardia with urticaria.",
            "Vasovagal syncope recovers on lying flat with the legs raised.",
            "After adrenaline, arrange transfer with an escort and oxygen.",
            "Record the vaccine name, batch number, site, time of injection, time of onset and every dose given with its time.",
            "Report as a **serious AEFI within 24 hours** to the district immunisation officer. [AEFI 2015]",
            "Retain the vial and the syringe. [AEFI 2015]",
            "Counsel the family without discouraging future immunisation of the community.",
          ],
        },
      ],
      mustDraw: [
