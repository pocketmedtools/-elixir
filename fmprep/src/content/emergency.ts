  ...
  sections: [
    {
      ...
      points: [
        ...
        "Switch off the electrical supply before touching an electrical casualty.",
        "Brush off dry chemical powder before any water is applied.",
        "Remove burnt clothing, nappies and all rings, bangles and watches before swelling begins. [ATLS 10e]",
        "Leave anything stuck to the wound in place.",
        "**Cool the burn with cool running tap water for 20 minutes** - it still helps up to 3 hours after injury. [EMSB 2021]",
        "Twenty minutes of cooling reduces depth, reduces the need for grafting and reduces pain - the single most valuable thing a clinic does.",
        "**Never use ice or iced water** - vasoconstriction deepens the burn.",
        "Never apply toothpaste, turmeric, ink, kerosene, mud, egg white, butter, ghee or oil - they trap heat, introduce infection and hide the wound.",
        "**Cool the burn but warm the patient** - cooling a large burn, especially in a child, causes hypothermia, which worsens coagulopathy and mortality.",
        "Cool only the burnt area and cover the rest with blankets.",
        "Stop cooling if the patient starts to shiver or the burn exceeds **20% of body surface**.",
        "Cover with **cling film in longitudinal strips, never wrapped circumferentially**, or a clean dry cotton sheet.",
        "Cling film is transparent, sterile from the inner roll, non-adherent and analgesic.",
        "Do not apply creams before the referral centre assesses the wound if transfer is imminent.",
        "Analgesia early and IV: **morphine 0.1 mg/kg IV** titrated in 2 mg increments in an adult, with an antiemetic.",
        "Child morphine **0.05-0.1 mg/kg IV** with an antiemetic.",
        "IM and SC drugs are not absorbed reliably in burn shock - they dump into the circulation later when perfusion returns.",
        "Give **tetanus prophylaxis** according to immunisation status - a burn is a tetanus-prone wound.",
    ...
    },
    {
      ...
      points: [
        "**Wallace rule of nines** in adults: head and neck 9%, each arm 9%, each leg 18%. [ATLS 10e]",
        "Rule of nines continued: front of trunk 18%, back of trunk 18%, perineum 1%. [ATLS 10e]",
        "Count only partial-thickness and full-thickness burn.",
        ...
        "Children have proportionally large heads and small legs - the rule of nines is inaccurate **below about 15 years**.",
        "Use a **Lund and Browder chart** in children.",
        "In an infant the head is about **18%** and each leg about **14%**.",
        "Roughly 1% moves from the head to each leg for every year of age until adult proportions at about 10 years.",
        "For scattered burns, the **patient's own palm including closed fingers is about 1%** of body surface area.",
        "Use the patient's palm, not yours, and only for scattered patches, not a large confluent burn.",
        "Record the estimate on a front and back body diagram with depth marked.",
        "Repeat the estimate at **24 hours** - burns declare their true depth and extent over the first day.",
        "The initial estimate is often 10-20% out in either direction.",
        "**Baux score = age + percentage burn** estimates mortality risk.",
        "Revised Baux score adds **17 points for inhalation injury**.",
        "A score approaching 100 without a burns ICU signals a very poor prognosis - it should shape the honest conversation with the family.",
      ],
    },
    {
      heading: "Estimating the depth",
      points: [
        "**Superficial epidermal burn**: red, dry, painful, no blisters, blanches briskly and refills.",
        "Superficial epidermal burn heals in **5-7 days** without scarring - not counted in the burn area or fluid calculation.",
        "**Superficial partial-thickness (superficial dermal) burn**: blisters, moist, pink, very painful, blanches with brisk capillary refill.",
        "Superficial partial-thickness burn heals in **10-14 days** without grafting and with minimal scarring.",
        "**Deep partial-thickness (deep dermal) burn**: blotchy red or fixed staining, drier, less painful, sluggish or absent blanching.",
        "Deep partial-thickness burn takes **over three weeks** to heal, scars badly and usually needs excision and grafting.",
        "**Full-thickness burn**: white, waxy, brown or charred; dry and leathery; painless and insensate to pin-prick.",
        ...
        "Three bedside tests: **blanching on pressure, pin-prick sensation, and appearance after blisters are removed**.",
        "An insensate, non-blanching burn is deep whatever it looks like.",
        "A burn that is exquisitely painful is superficial.",
        "Depth is dynamic - a burn deepens over **48 hours** if under-resuscitated, hypotensive, hypothermic or infected.",
        "Fluid regimen and warmth therefore matter as much as the dressing.",
      ],
    },
    {
      heading: "Fluid resuscitation: the Parkland formula done correctly",
      points: [
        "Start IV fluid in every adult with **more than 15% TBSA** burnt and every child with **more than 10%**. [ABLS 2023]",
        "Use two large peripheral cannulae, placed through burnt skin if necessary. [ATLS 10e]",
        "Below these thresholds, oral fluid with added salt is usually adequate.",
        "**Parkland formula: 4 mL x weight in kg x % TBSA** = volume of Ringer's lactate for the first 24 hours. [Baxter 1968]",
        "Give **half in the first 8 hours** and the other half over the next 16 hours. [Baxter 1968]",
        "The **8 hours run from the time of the burn, not arrival** - the commonest exam question and the commonest clinical error.",
        "Arrival 3 hours after the burn means the first half is delivered in the remaining 5 hours - run it faster.",
        "Worked example: 60 kg man, 40% burns = 4 x 60 x 40 = **9600 mL** Ringer's lactate in 24 hours.",
        "That is 4800 mL in the first 8 hours (**600 mL/hour**) and 4800 mL over the next 16 hours (300 mL/hour).",
        "Write the sum out in the examination to check the arithmetic.",
        "Children need **maintenance fluid in addition** to the Parkland volume - they have small glycogen stores.",
        "Maintenance by the **4-2-1 rule**: 4 mL/kg/hour for the first 10 kg, 2 mL/kg/hour for the next 10 kg, 1 mL/kg/hour thereafter.",
        "Give paediatric maintenance as a dextrose-containing solution and monitor blood glucose.",
        "The formula is only a starting estimate - titrate hourly to **urine output** through a urinary catheter. [ATLS 10e]",
        "Adult urine target **0.5 mL/kg/hour** (about 30-50 mL/hour). [ATLS 10e]",
        "Child under 30 kg urine target **1 mL/kg/hour**. [ATLS 10e]",
        "Myoglobinuria from an electrical or very deep burn: target **1-2 mL/kg/hour**.",
        "Adjust the infusion rate by about a third up or down each hour rather than by boluses.",
        "ABA now starts adults with thermal burns at **2 mL/kg/%** and titrates upwards. [ABLS 2023]",
        "4 mL/kg/% is reserved for children and electrical injury. [ABLS 2023]",
        "Over-resuscitation causes abdominal and limb compartment syndromes - **fluid creep**.",
        "Quote Parkland as the classical formula and the ABA modification as current practice.",
        "No colloid in the **first 8-12 hours**, when capillary leak is maximal.",
        "Albumin may be added in the second 24 hours in large burns.",
    ...
    },
    {
      ...
      points: [
        "Suspect **inhalation injury** with a fire in an enclosed space, loss of consciousness at the scene, or facial and neck burns. [ATLS 10e]",
        "Inhalation injury continued: singed nasal hair or eyebrows, soot in the mouth or sputum, hoarseness, brassy cough, stridor. [ATLS 10e]",
        "These clinical features decide the airway, not the arterial blood gas.",
        "**Intubate early**, by the most experienced person, with an uncut endotracheal tube of the largest size that will pass. [ATLS 10e]",
        "Oedema progresses for **12-36 hours** - a delayed intubation becomes a surgical airway.",
        "If in doubt before a long transfer, intubate before departure.",
        "Give **100% oxygen by non-rebreathing mask** to every patient from a fire. [ATLS 10e]",
        ...
        "Carboxyhaemoglobin half-life is about **4 hours in air and about 1 hour on 100% oxygen**.",
        "Suspect **cyanide** when plastics or upholstery have burned and lactic acidosis persists with normal or high mixed venous oxygen despite resuscitation.",
        ...
        "A circumferential full-thickness limb burn causes **compartment ischaemia**. [ATLS 10e]",
        "Limb ischaemia signs: increasing pain, tense swelling, paraesthesia, cold pale skin, absent capillary refill, finally absent Doppler pulse.",
        ...
        "A circumferential full-thickness chest burn restricts ventilation - rising airway pressures and hypoxia in a ventilated patient. [ATLS 10e]",
        "Chest escharotomy: incisions in the anterior axillary lines joined transversely below the clavicles and along the costal margin.",
        "Do not wait for the arterial blood gas before chest escharotomy.",
        "Insert a **nasogastric tube in burns above 20%** - gastric stasis and ileus are the rule. [ATLS 10e]",
        "Begin enteral feeding within **6-12 hours** to reduce stress ulceration and translocation.",
        "Add a proton pump inhibitor for **Curling ulcer** prophylaxis.",
      ],
    },
    {
      heading: "Wound care, referral and follow-up",
      points: [
        "Clean with running water or saline and a mild soap.",
        "Deroof large or tense blisters; leave small intact blisters over palms and soles.",
        "Take a photograph or a diagram for the record before dressing.",
        "Dress a superficial partial-thickness burn with **non-adherent paraffin gauze**, an absorbent layer and a light bandage - review at 48 hours.",
        "**Silver sulfadiazine 1% cream** is used for larger and dirtier wounds.",
        "Avoid silver sulfadiazine on the face, in pregnancy, in infants under 2 months and in G6PD deficiency.",
        "Silver sulfadiazine obscures the wound for the surgeon who will assess depth.",
        "Refer: burns **above 10% TBSA in an adult and above 5% in a child**. [ABLS 2023]",
        "Refer: any full-thickness burn above 5%. [ABLS 2023]",
        "Refer: burns of the **face, hands, feet, genitalia, perineum or over a major joint**. [ABLS 2023]",
        "Refer: circumferential burns. [ABLS 2023]",
        "Refer: all electrical and lightning injuries, and all chemical burns. [ABLS 2023]",
        "Refer: suspected inhalation injury. [ABLS 2023]",
        "Refer: burns with associated trauma. [ABLS 2023]",
        "Refer: the very young, the elderly and those with significant comorbidity. [ABLS 2023]",
        "Refer: any burn where non-accidental injury is suspected. [ABLS 2023]",
        "Chemical burns: irrigate with copious running water for **at least 20 minutes**, and 60 minutes or longer for alkalis.",
        "Check the pH of the run-off where possible.",
        "Never attempt chemical neutralisation - it generates heat.",
        "**Hydrofluoric acid** is the named exception: topical calcium gluconate 2.5% gel massaged in.",
        "Hydrofluoric acid continued: local infiltration or intra-arterial calcium, and correction of hypocalcaemia.",
        "Refer immediately when the history does not fit the burn.",
        "Non-accidental injury pattern: scalds with a **clean upper level and no splash marks**, glove-and-stocking or buttock immersion.",
        "Non-accidental injury continued: cigarette burns, delayed presentation, implausible or changing history, burns in a child not yet mobile.",
        "Suspected non-accidental injury requires the child protection pathway.",
        "Suspect a **dowry-related or intimate-partner assault** in any adult woman with a kerosene flame burn.",
        "Take a dying declaration only if the patient is conscious and oriented.",
        "Record the dying declaration verbatim in the patient's own words with a note of who was present.",
        "Burns in a married woman **within seven years of marriage** are a mandatory medico-legal report in India - inform the police.",
        "Follow-up is about function and scar: early physiotherapy and splinting in a position of function.",
        "Pressure garments and silicone for hypertrophic scarring.",
        "Sun protection of the healed area for a year.",
        "Itch controlled with moisturiser and antihistamine.",
        "Screen for post-traumatic stress and depression in the patient and the family.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Airway: look for facial burns, singed nasal hair, soot in the mouth, hoarseness and stridor. [ATLS 10e]",
            "Give **100% oxygen by non-rebreathing mask**. [ATLS 10e]",
            "Intubate early with an uncut tube on any sign of inhalation injury - a kitchen stove fire is an enclosed-space exposure.",
            "Breathing: exclude a circumferential chest burn restricting ventilation.",
            "Consider carbon monoxide poisoning - the pulse oximeter reads falsely normal.",
            "Circulation: **two large-bore cannulae**, through burnt skin if necessary. [ATLS 10e]",
            "Blood for group and cross-match, haemoglobin, urea, electrolytes, glucose and where possible carboxyhaemoglobin.",
            "Hypotension this early suggests another injury.",
            "Disability: record GCS and glucose.",
            "Exposure: remove all clothing and jewellery, keep warm with blankets and a warmed room, record the temperature.",
        ...
        },
        {
          ...
          points: [
            "Estimate the area by the **rule of nines** on a front and back diagram. [ATLS 10e]",
            "Count only partial and full-thickness burn - exclude simple erythema.",
            "Use the patient's palm as 1% for scattered patches.",
            "Estimate depth by appearance, blistering, pin-prick sensation and blanching - record it on the same diagram.",
            "Burn history: the agent, enclosed space or not, duration of exposure, first aid given, and the circumstances.",
            "A sari or kerosene burn in a young married woman requires a careful **medico-legal record and a police report**.",
        ...
        },
        {
          ...
          points: [
            "Parkland: **4 mL x 50 kg x 54% = 10,800 mL** of Ringer's lactate in the first 24 hours. [Baxter 1968]",
            "Half, 5400 mL, goes in the first 8 hours **measured from the time of the burn**.",
            "90 minutes have elapsed, so 5400 mL must run in the remaining 6.5 hours - about **830 mL/hour**.",
            "The remaining 5400 mL goes over the next 16 hours at about 340 mL/hour.",
            "Insert a urinary catheter and titrate hourly to **0.5 mL/kg/hour** - 25 mL/hour in this patient. [ATLS 10e]",
            "Adjust the rate by about a third at a time rather than giving boluses.",
            "Avoid colloid in the first 8-12 hours.",
        ...
        },
        {
          ...
          points: [
            "Cool the wound with running water for **20 minutes** if within 3 hours of the burn. [EMSB 2021]",
            "Keep the rest of the body covered and warm while cooling.",
            ...
            "Do not give prophylactic systemic antibiotics.",
            "Pass a nasogastric tube - the burn exceeds **20%**.",
            "Start early enteral feeding and give a proton pump inhibitor for Curling ulcer prophylaxis.",
        ...
        },
        {
          ...
          points: [
            "She meets multiple referral criteria - burn **above 10% in an adult**, likely inhalation injury, burns crossing major joints - and must go to a burns unit. [ABLS 2023]",
            "Transfer with the airway secured if there is any doubt.",
