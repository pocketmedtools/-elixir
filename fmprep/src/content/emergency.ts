...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "Shockable rhythms: **ventricular fibrillation and pulseless ventricular tachycardia**. [ERC 2021]",
        "Non-shockable rhythms: asystole and pulseless electrical activity. [ERC 2021]",
        "Shocking asystole has **no benefit** - it only wastes compression time.",
        "Biphasic first shock **150-200 J** or the manufacturer's stated setting. [ERC 2021]",
        "Subsequent biphasic shocks the same energy or higher. [ERC 2021]",
        "Monophasic defibrillator: **360 J** for every shock. [ERC 2021]",
        "Paediatric shocks: **4 J/kg** for the first and all subsequent shocks. [ERC 2021]",
        "After a shock resume compressions **immediately for 2 minutes** without checking pulse or rhythm. [ERC 2021]",
        "The myocardium is stunned after a shock - a perfusing rhythm rarely produces a palpable pulse in the first seconds.",
        "Pad position is **sternal-apical**: right infraclavicular and left mid-axillary at the fifth intercostal space. [ERC 2021]",
        "Shave heavy chest hair and wipe the chest dry before applying pads - a poor contact wastes the shock.",
        "Never place a pad over a **pacemaker box** or a transdermal patch.",
        "Use paediatric pads or an attenuator for children **under 8 years or 25 kg**. [AHA 2020]",
        "An AED is **safe in untrained hands** and should be in every clinic that can afford one. [AHA 2020]",
        "An AED will not shock a non-shockable rhythm - its voice prompts substitute for rhythm interpretation.",
        "Precordial thump has almost no place - permitted only for a **monitored, witnessed onset of pulseless VT** when no defibrillator is instantly to hand. [ERC 2021]",
        "A precordial thump must never delay compressions.",
      ],
    },
    {
      heading: "Drugs in cardiac arrest",
      points: [
        "Adult adrenaline in arrest: **1 mg IV or IO** every 3-5 minutes for as long as the arrest continues. [ERC 2021]",
        "1 mg adrenaline is 10 mL of 1:10,000 or 1 mL of 1:1000 diluted to 10 mL.",
        "Adrenaline every 3-5 minutes means **every second 2-minute cycle**.",
        "Non-shockable rhythm: give adrenaline **as soon as IV access is obtained**. [ERC 2021]",
        "Shockable rhythm: give the first adrenaline **after the third shock**, then alternate with 2-minute cycles. [ERC 2021]",
        "**Amiodarone 300 mg IV bolus** after the third shock in refractory VF or pulseless VT. [ERC 2021]",
        "A further **amiodarone 150 mg IV** after the fifth shock. [ERC 2021]",
        "Lidocaine **100 mg (1-1.5 mg/kg) IV** is the alternative where amiodarone is unavailable, repeat 50 mg. [ERC 2021]",
        "Paediatric adrenaline **10 microgram/kg** (0.1 mL/kg of 1:10,000) IV or IO, maximum 1 mg, every 3-5 minutes. [ERC 2021]",
        "Paediatric amiodarone **5 mg/kg** (maximum 300 mg) after the third shock, repeatable once. [ERC 2021]",
        "**Calcium gluconate 10% 10-30 mL IV** for hyperkalaemia, hypocalcaemia or calcium-channel blocker overdose. [ERC 2021]",
        "**Sodium bicarbonate 1 mmol/kg IV** only for hyperkalaemia or tricyclic overdose. [ERC 2021]",
        "**Magnesium sulphate 2 g IV** for torsades de pointes. [ERC 2021]",
        "Thrombolysis if pulmonary embolism is the presumed cause - then continue CPR for **60-90 minutes** afterwards. [ERC 2021]",
        "**Atropine has been removed** from the asystole and PEA algorithms. [AHA 2020]",
        "Routine sodium bicarbonate is not given for the acidosis of arrest - it worsens intracellular acidosis and shifts the oxygen dissociation curve.",
        "Intraosseous access at the **proximal tibia** when a peripheral line fails after two attempts or 90 seconds. [ERC 2021]",
        "The endotracheal drug route is obsolete and unreliable. [ERC 2021]",
      ],
    },
    {
