  ...
  sections: [
    {
      ...
      points: [
        "Altered sensorium is an acute disturbance of **arousal** (level of consciousness) or **content** (awareness, attention, cognition). [Harrison 21e]",
        "Altered sensorium is a **symptom, never a diagnosis** - the examiner wants that in the first line.",
        "A drowsy patient has reduced arousal; a confused but awake patient has disordered content - both are emergencies until a cause is found.",
        "Grade immediately with **AVPU** - Alert, responds to Voice, responds to Pain, Unresponsive - it takes five seconds.",
        "A patient who is P or U has a GCS of about **8 or less** and an unprotected airway.",
        "Convert to a formal GCS with the three components written separately (E, V, M) once the airway is safe. [Teasdale 2014]",
        "Work in the fixed order airway, breathing, circulation, disability, exposure.",
        "The commonest avoidable death is **aspiration or obstruction from an unsupported airway**, not the underlying disease.",
        "Head-tilt chin-lift or jaw thrust, suction, an oropharyngeal airway and the recovery position come before any history taking.",
        "Oxygen to keep saturation **94-98%** (88-92% in known chronic hypercapnic lung disease).",
        "Attach a pulse oximeter, take the blood pressure, count the respiratory rate, check the temperature.",
        "Hypoxia, hypotension, hypoglycaemia and hyperthermia are all causes of coma correctable in the clinic itself.",
        "**Check capillary glucose in every patient with altered sensorium**, without exception, before anything else diagnostic.",
        "Hypoglycaemia is the one cause that is both instantly reversible and instantly fatal if missed.",
        "No clinical sign reliably separates hypoglycaemia from stroke or sepsis.",
        "Send a named person to call the ambulance and a named person to bring the emergency tray and glucometer.",
        "Ask a relative the three questions that solve most cases: **what drugs and alcohol, what illnesses, what happened in the last 24 hours**.",
      ],
    },
    {
      heading: "The structured cause list: AEIOU TIPS in Indian practice",
      points: [
        "**AEIOU TIPS**: Alcohol and Acidosis; Epilepsy, Endocrine and Electrolytes; Insulin (hypo- and hyperglycaemia).",
        "AEIOU TIPS continued: Opiates and Oxygen lack; Uraemia; Trauma and Temperature; Infection.",
        "AEIOU TIPS continued: Psychiatric and Porphyria; Stroke, Shock, Space-occupying lesion and Snake bite.",
        "Reciting a structured list is worth more marks than naming ten diseases at random.",
        "Commonest adult causes in Indian practice: **hypoglycaemia from sulfonylureas or insulin**, alcohol intoxication and withdrawal.",
        "Adult causes continued: sepsis with delirium in the elderly, stroke, uraemic and hepatic encephalopathy.",
        "Adult causes continued: organophosphate or other deliberate self-poisoning.",
        "Add cerebral malaria, enteric fever and tuberculous meningitis where those are endemic.",
        "Child priorities: **hypoglycaemia, febrile status epilepticus, acute bacterial meningitis, cerebral malaria**. [IAP 2022]",
        "Child priorities continued: dengue with shock, first-presentation diabetic ketoacidosis, accidental kerosene or drug ingestion, inflicted head injury.",
        "A child with fever and altered sensorium has **meningitis until proved otherwise**.",
        "In the elderly, altered sensorium is usually **delirium from a systemic cause outside the brain**. [Harrison 21e]",
        "Elderly precipitants: urinary or chest infection, dehydration, urinary retention, constipation, hypoxia.",
        "Elderly drug precipitants: a newly added anticholinergic, benzodiazepine, opioid or steroid - the drug chart is part of the neurological examination.",
        "Never accept the label of alcohol intoxication, psychiatric illness or postictal state at first contact.",
        "A patient who smells of alcohol may still have a **subdural haematoma, hypoglycaemia or Wernicke encephalopathy**.",
        "A functional cause is a diagnosis of exclusion - made after glucose, oxygenation and a neurological examination are documented as normal.",
        "Tempo: sudden onset over **seconds to minutes** suggests vascular, seizure or cardiac causes.",
        "Tempo: **hours to days** suggests infection, metabolic or drug causes.",
        "Tempo: **days to weeks** suggests a space-occupying lesion, chronic subdural haematoma, tuberculous meningitis or hypothyroidism.",
      ],
    },
    {
      heading: "The focused examination that localises the problem",
      points: [
        "Record the **GCS as its three components** (for example E2 V2 M4 = 8), not the total alone. [Teasdale 2014]",
        "The motor score carries most of the prognostic weight; a total hides deterioration in one component. [Teasdale 2014]",
        "A **fall of 2 or more GCS points, or any fall to 8 or below**, mandates immediate airway support and transfer.",
        "**Pupils are the single most useful sign** in an unconscious patient. [Adams and Victor 12e]",
        "Pinpoint reactive pupils: opioids or pontine haemorrhage.",
        "**Unilateral fixed dilated pupil**: uncal herniation from an expanding mass - an emergency.",
        "Mid-position fixed pupils: midbrain injury.",
        "Widely dilated reactive pupils: anticholinergic or sympathomimetic poisoning.",
        "Look for lateralising signs - spontaneous movement and the response to pain on each side.",
        "**Asymmetry** of movement, tone or plantar response points to a structural lesion.",
        "A symmetrical picture with preserved brainstem reflexes points to a metabolic or toxic cause.",
        "Neck stiffness - absent in the very young, the very old and the deeply comatose.",
        "Fundus: papilloedema and subhyaloid haemorrhage.",
        "Skin: rash, needle marks, jaundice, cyanosis, injury.",
        "Breath: alcohol, ketones, or the **garlic odour of organophosphate**.",
        "Scalp and mastoids: injury.",
        "**Cholinergic** toxidrome: pinpoint pupils, sweating, salivation, bradycardia, fasciculations - organophosphate.",
        "**Opioid** toxidrome: pinpoint pupils, slow shallow respiration, coma.",
        "**Anticholinergic** toxidrome: dry, hot, flushed, dilated pupils, retention.",
        "**Sympathomimetic** toxidrome: dilated pupils, sweating, tachycardia, hypertension.",
        "Document the time of every observation - a single GCS has limited value.",
        "The **trend of GCS, pupils and vital signs at 15-minute intervals** is what the receiving hospital and the court will read.",
        "The trend decides whether transfer becomes urgent.",
      ],
    },
    {
      heading: "The bedside cocktail: what to give, at what dose, and when",
      points: [
        "Hypoglycaemia: capillary glucose **below 70 mg/dL**, or any unconscious diabetic whatever the reading.",
        "Adult: **25% dextrose 100 mL (25 g) IV over 1-3 minutes** through a large-bore cannula.",
        "Repeat after 10-15 minutes if the patient has not woken and glucose remains low.",
        "Recheck glucose 15 minutes after every dose.",
        "Paediatric hypoglycaemia: **10% dextrose 5 mL/kg (0.5 g/kg) IV**. [IAP 2022]",
        "Neonate: 10% dextrose 2 mL/kg.",
        "**Never give 25% or 50% dextrose to a small child** through a peripheral vein - hyperosmolar, scleroses veins, tissue necrosis on extravasation.",
        "No vein: **glucagon 1 mg IM** for an adult or child over 25 kg, 0.5 mg if under 25 kg.",
        "**Thiamine 100 mg IV or IM before or with glucose** in anyone malnourished, alcoholic, vomiting in pregnancy or on dialysis.",
        "A glucose load in thiamine deficiency can precipitate Wernicke encephalopathy.",
        "Suspected Wernicke: **thiamine 500 mg IV three times a day for 2 days**, then 250 mg daily.",
        "Suspected opioid overdose: respiratory rate **below 12**, pinpoint pupils, coma.",
        "**Naloxone 0.4 mg IV**, repeated every 2-3 minutes, titrated to an adequate respiratory rate rather than full wakefulness.",
        "Reconsider the diagnosis after a total of about **10 mg** naloxone.",
        "No vein: the same naloxone dose IM.",
        "Child naloxone **0.01 mg/kg IV**, repeated every 2-3 minutes.",
        "Naloxone is shorter acting than every opioid it reverses - effect wanes in **30-90 minutes**.",
        "A patient who wakes on naloxone must still be observed or transferred.",
        "Long-acting agents such as methadone or sustained-release morphine need a naloxone infusion.",
        "Sudden full reversal in a dependent patient causes agitation, vomiting and aspiration - titrate.",
        "**Do not give flumazenil routinely** for suspected benzodiazepine overdose.",
        "Flumazenil in a mixed overdose or a dependent patient precipitates intractable seizures and arrhythmia - supportive airway care is safer.",
        "Avoid empirical sedation of an agitated confused patient until glucose and hypoxia have been excluded.",
      ],
    },
    {
      heading: "Cause-specific treatment started before transfer",
      points: [
        "Convulsive status epilepticus: a seizure lasting **5 minutes or more**, or repeated seizures without recovery between. [Glauser 2016]",
        "Adult: **lorazepam 4 mg IV over 2 minutes**, repeated once after 10 minutes. [Glauser 2016]",
        "No IV access: **midazolam 10 mg IM** (5 mg if 13-40 kg). [Glauser 2016]",
        "Child: lorazepam **0.1 mg/kg IV**, maximum 4 mg per dose. [Glauser 2016]",
        "Child alternative: buccal or intranasal midazolam 0.2 mg/kg (maximum 10 mg), or rectal diazepam 0.5 mg/kg (maximum 20 mg).",
        "Seizures continuing after two benzodiazepine doses: give a second-line agent while arranging transfer. [Glauser 2016]",
        "Second line: **levetiracetam 60 mg/kg IV over 10 minutes** (maximum 4500 mg). [Glauser 2016]",
        "Second-line alternatives: sodium valproate 40 mg/kg (maximum 3000 mg), or fosphenytoin 20 mg phenytoin-equivalents/kg. [Glauser 2016]",
        "Plain phenytoin 20 mg/kg: dilute in **normal saline only**, infuse at no more than 50 mg/min in an adult (1 mg/kg/min in a child), with cardiac monitoring.",
        "Suspected bacterial meningitis: fever, headache, neck stiffness, altered sensorium, purpuric rash.",
        "Give the **first dose of ceftriaxone before transfer** - adult 2 g IV, then 12-hourly.",
        "Child ceftriaxone **50 mg/kg per dose** - 100 mg/kg/day in two divided doses, maximum 4 g/day. [IAP 2022]",
        "**Dexamethasone 0.15 mg/kg IV 6-hourly**, given with or just before the first antibiotic dose.",
