...
topics.push({
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        "**Hypoxia** is the commonest cause of arrest in children, drowning, asthma and airway obstruction. [ERC 2021]",
        "Fix hypoxia with a patent airway, high-flow oxygen and adequate ventilation - not with drugs.",
        "**Hypovolaemia**: trauma, gastrointestinal or obstetric haemorrhage, ruptured ectopic pregnancy, severe dehydration. [ERC 2021]",
        "Treat hypovolaemic arrest with rapid crystalloid and blood, and stop the bleeding.",
        ...
        "If hyperkalaemia is likely give calcium, insulin-dextrose and bicarbonate empirically. [ERC 2021]",
        "Check **capillary glucose in every arrest** - hypoglycaemia is reversible in seconds.",
        "**Hypothermia**: drowning, exposure, the elderly found on the floor. [ERC 2021]",
        "In hypothermia continue resuscitation while rewarming - neurological recovery is possible after very prolonged arrest.",
        "No one is dead until **warm and dead**. [ERC 2021]",
        "**Tension pneumothorax**: needle decompression at the fifth intercostal space anterior axillary line, then a chest drain. [ATLS 10e]",
        "The traditional needle site is the second intercostal space mid-clavicular line. [ATLS 10e]",
        "**Tamponade**: pericardiocentesis or thoracotomy. [ERC 2021]",
        "**Toxins**: organophosphate, aluminium phosphide, oleander, tricyclics, opioids.",
        "**Thrombosis**: coronary or pulmonary. [ERC 2021]",
        "Reversible causes that actually turn up in an Indian clinic arrest: hypoxia, haemorrhage, hyperkalaemia in dialysis patients, poisoning, acute MI.",
        "Rehearse those **five causes** - they are the ones a family clinic will meet.",
      ],
    },
    {
      ...
      points: [
        ...
        "**12-lead ECG within 10 minutes** of ROSC looking for ST elevation. [ERC 2021]",
        "Arrange transfer to a centre with catheterisation and intensive care. [ERC 2021]",
        "Target **SpO2 94-98%** after ROSC - do not leave the patient on 100% oxygen. [ERC 2021]",
        "Ventilate to normocapnia, **PaCO2 35-45 mmHg**. [ERC 2021]",
        "Both hyperoxia and hypocapnia worsen neurological outcome after arrest.",
        "Maintain systolic BP **above 100 mmHg** and MAP above 65 mmHg with fluids and noradrenaline. [ERC 2021]",
        "Treat glucose **above 180 mg/dL** after ROSC. [ERC 2021]",
        "Treat seizures after ROSC. [ERC 2021]",
        "Actively prevent fever - keep core temperature **at or below 37.5 degrees C for at least 72 hours**. [ERC 2021]",
        "Stopping is a **team decision**, never one person's. [ERC 2021]",
        "Stop after at least **20 minutes** of advanced life support with persistent asystole and no reversible cause. [ERC 2021]",
        "An end-tidal CO2 that stays **below 10 mmHg** despite good compressions supports stopping. [ERC 2021]",
        "Continue longer than usual in hypothermia, drowning, poisoning and the young. [ERC 2021]",
        "In pregnancy continue and perform **perimortem caesarean within 5 minutes** - it may save both mother and child. [ERC 2021]",
        "Debrief the team after every arrest.",
        "Document the arrest with times: collapse, CPR start, first shock, drugs, ROSC.",
        "Speak to the family in a **private room** with a named person and plain words - the communication is examined as often as the algorithm.",
      ],
    },
  ],
  tables: [
