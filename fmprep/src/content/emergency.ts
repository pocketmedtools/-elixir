  ...
  sections: [
    {
      ...
      points: [
        "**The tray exists to remove decisions from the emergency.**",
        "Everything on it treats a condition that kills within minutes - nothing is there because it might one day be useful.",
        "A crowded tray costs seconds, and seconds are the whole point.",
        "Keep a **single tray in a single fixed location** known to every member of staff.",
        "Seal it with a numbered breakable tag.",
        "Never lock it in a cupboard whose key is with one person - a locked emergency cupboard has caused more deaths in audits than an empty one.",
        "One named person - usually the senior nurse - owns the tray. [NABH 2020]",
        "Check it against a printed checklist on a **fixed day each week**, sign and date the log. [NABH 2020]",
        "Report shortages to the doctor the same day.",
        "**A tray without a signed dated log is presumed unchecked.**",
        "Arrange drugs by indication, not alphabetically: anaphylaxis, arrest, seizure, hypoglycaemia, cardiac, respiratory, obstetric.",
        ...
        "Anything within **3 months of expiry** is moved into routine clinic use and replaced.",
        "**Adrenaline degrades with light and heat** - keep ampoules in their carton, away from the window.",
        "Never store the tray on top of a refrigerator or near a sterilizer.",
        "The tray is only half the system - the other half is a **written referral pathway**.",
        "The pathway names and numbers the nearest hospital with a ventilator, blood bank and dialysis.",
        "The pathway carries the ambulance number - **108** in most Indian states.",
        "A standing arrangement means a call is answered rather than negotiated.",
      ],
    },
    {
      ...
      points: [
        ...
        "Anaphylaxis adult and child over 12 years: **0.5 mg (0.5 mL) IM into the anterolateral thigh**. [RCUK 2021]",
        "Anaphylaxis 6-12 years: 0.3 mg IM; 6 months to 6 years: 0.15 mg IM. [RCUK 2021]",
        "Repeat anaphylaxis adrenaline every **5 minutes** as needed. [RCUK 2021]",
        "Cardiac arrest adult: **adrenaline 1 mg IV** as 10 mL of 1:10,000 every 3-5 minutes. [AHA 2020]",
        "Cardiac arrest child: 0.01 mg/kg (0.1 mL/kg of 1:10,000, maximum 1 mg) every 3-5 minutes. [AHA 2020]",
        "**Atropine** - Indian ampoules are commonly 0.6 mg/mL.",
        "Symptomatic bradycardia adult: **0.5-0.6 mg IV** every 3-5 minutes to a maximum of 3 mg. [AHA 2020]",
        "Symptomatic bradycardia child: 0.02 mg/kg, minimum single dose 0.1 mg, maximum single dose 0.5 mg. [AHA 2020]",
        "Organophosphate poisoning adult: **2-5 mg IV** (child 0.05 mg/kg), doubled every 5 minutes until the chest is clear and skin dry. [Eddleston 2008]",
        "Stock **at least 25 ampoules of atropine** where pesticide poisoning is common.",
        "**Dextrose 25% (100 mL)** for adult hypoglycaemia - 25 g IV over 1-3 minutes.",
        "10% dextrose for children at **5 mL/kg**, neonates at 2 mL/kg.",
        "**Thiamine 100 mg** ampoules - before or with dextrose in the alcoholic or malnourished.",
        "Glucagon 1 mg IM (0.5 mg if under 25 kg) covers the patient with no venous access.",
        "Seizures adult: **lorazepam 4 mg IV over 2 minutes**, repeated once after 10 minutes.",
        "No vein: midazolam 10 mg IM, buccal or intranasal; or diazepam 10 mg IV or per rectum.",
        "Seizures child: lorazepam 0.1 mg/kg IV (maximum 4 mg per dose).",
        "Child no vein: midazolam 0.2 mg/kg buccal or intranasal (maximum 10 mg), or rectal diazepam 0.5 mg/kg (maximum 20 mg).",
        "Suspected myocardial infarction: **soluble aspirin 300 mg chewed** and clopidogrel 300 mg.",
        "Glyceryl trinitrate 0.5 mg sublingually every 5 minutes, up to 3 doses, only while systolic stays **above 90 mmHg**.",
        "Acute pulmonary oedema: **furosemide 40 mg slow IV**.",
        "Salbutamol nebuliser 5 mg for adults and children over 5 years; 2.5 mg under 5 years.",
        "Ipratropium 500 micrograms nebulised; 250 micrograms under 5 years.",
        "**Hydrocortisone 100 mg IV** (child 4 mg/kg).",
        "Eclampsia: **magnesium sulphate 4 g of 20% IV over 5 minutes** plus 10 g of 50% IM (5 g into each buttock). [FOGSI 2019]",
        "Then magnesium sulphate 5 g IM 4-hourly. [FOGSI 2019]",
        "Magnesium antidote: **calcium gluconate 10%, 10 mL IV over 10 minutes**.",
        "Postpartum haemorrhage: **oxytocin 10 IU IM**. [FOGSI 2019]",
        "**Tranexamic acid 1 g IV over 10 minutes** within 3 hours of trauma or postpartum bleeding.",
        "Also stock naloxone 0.4 mg and chlorpheniramine 10 mg.",
        "Also stock oral rehydration salts, normal saline and Ringer lactate.",
      ],
    },
    {
      heading: "Equipment: airway, oxygen, circulation and monitoring",
      points: [
        "Oxygen: a **full cylinder with regulator, flowmeter and key kept attached**, plus a spare cylinder. [IPHS 2022]",
        "A non-rebreathing mask with reservoir delivers about **85% oxygen at 15 L/min** - what an emergency needs.",
        "Nasal cannulae at 1-4 L/min are for the stable patient.",
        "Log the cylinder pressure at every weekly check.",
        "Self-inflating bags in three sizes: **adult 1500-1600 mL, paediatric about 500 mL, neonatal 240 mL**.",
        "Each bag needs a reservoir - without it delivered oxygen falls from about **90% to 50%**.",
        "Masks in sizes 0 to 5.",
        "A paediatric mask must cover the bridge of the nose to the cleft of the chin without covering the eyes.",
        "Oropharyngeal airways in sizes **000 to 4**.",
        "Size from the incisors to the angle of the mandible, or the angle of the mouth to the tragus.",
        "Adult insertion: upside down, then rotated.",
        "Child insertion: **the right way up over a tongue depressor** - rotation damages the palate.",
        "An airway that provokes gagging means the patient does not need one.",
        "Suction that works without mains electricity - **foot-operated or manual pump** with wide-bore Yankauer and soft catheters.",
        "Power fails exactly when it matters - test suction at every check and listen for the vacuum.",
        "Circulation: IV cannulae **14G to 24G**, an intraosseous needle where staff are trained, giving sets, a pressure infusion bag.",
        "A tourniquet for catastrophic limb haemorrhage.",
        "Monitoring: glucometer with in-date strips, pulse oximeter, thermometer.",
        "Blood pressure cuffs in paediatric, adult and large-adult sizes.",
        "An ECG machine, and an **automated external defibrillator** with adult and paediatric pads where affordable.",
        "Small things that stop a resuscitation dead: a torch with working cells, scissors, adhesive tape.",
        "A spacer with mask for a wheezing child.",
        "Sterile dressings and a bandage, a cervical collar, a splint.",
        "Gloves and eye protection, a sharps bin.",
        "A written record sheet with a **clock visible from the couch**.",
      ],
    },
    {
      heading: "The readiness drill: checks, mock drills and audit",
      points: [
        "Run a **mock drill at least once every 3 months**, unannounced, using a real scenario. [NABH 2020]",
        "Drill scenarios: anaphylaxis after an injection, a collapsed adult in the waiting room, a fitting child, postpartum haemorrhage.",
        "Time three things: **seconds to first compression, seconds to adrenaline drawn up, minutes to the ambulance call**.",
        "Record the times and improve them.",
        "Give every person a fixed role before the emergency happens.",
        "Roles: who compresses, who brings the tray, who draws up drugs, who calls the ambulance.",
        "Roles continued: who manages the family and clears the corridor, who writes the timed record.",
        "**Unassigned roles produce a crowd around the patient and an empty doorway.**",
        "Every staff member, including the receptionist and the cleaner, should recognise a collapsed patient, shout for help, start compressions and call for the tray.",
        "**Basic life support certification renewed every 2 years** is the standard to quote. [AHA 2020]",
        "Debrief the same day, blame-free, on three questions: what went well, what delayed us, what will change by next week.",
        "Record the change with a named owner and a date.",
        "**An undocumented drill has no value** in accreditation or in a negligence claim.",
        "Audit quarterly: the proportion of weekly tray checks completed and signed.",
        "Audit quarterly: the proportion of items found expired or missing at an unannounced spot check.",
        "NABH entry-level standards require documented emergency drugs and equipment, a defined referral pathway and evidence of staff training. [NABH 2020]",
        "The log is the evidence. [NABH 2020]",
        "**Restock immediately after every use**, before the next patient is called, and reseal with a new numbered tag.",
        "The commonest cause of an empty tray is the previous emergency, not slow purchasing.",
      ],
    },
    {
