  ...
  sections: [
    {
      ...
      points: [
        ...
        "Lavage is absolutely contraindicated after **corrosives and hydrocarbons such as kerosene**, or in a drowsy patient with no cuffed tube. [WHO 2008]",
        ...
        "The label gives the active ingredient and the concentration - concentration converts a volume into a dose.",
    ...
    },
    {
      ...
      points: [
        "**Cholinergic** toxidrome (organophosphate, carbamate): pinpoint pupils, bradycardia, salivation, lacrimation, sweating. [Eddleston 2008]",
        ...
        "Small pupils with a slow respiratory rate separate opioid from organophosphate - in organophosphate the chest is wet and the patient sweats.",
    ...
    },
    {
      ...
      points: [
        ...
        "All five end-points must be met together, but the chest and the axillae are the ones that matter. [Eddleston 2008]",
    ...
    },
    {
      ...
      points: [
        ...
        "Stage 1 (**0-24 hours**): nausea and vomiting, or nothing at all - a well-looking patient at 6 hours proves nothing.",
        ...
        "The first bag was formerly given over 15 minutes - **60 minutes halves anaphylactoid reactions** without losing efficacy.",
        ...
        "On an anaphylactoid reaction **stop the infusion and give chlorphenamine 10 mg IV**, nebulising salbutamol for wheeze. [NICE/RCEM 2023]",
    ...
    },
    {
      ...
      points: [
        ...
        "**Do not induce vomiting** - re-exposing the mucosa converts a survivable burn into a perforation.",
        "**Do not pass a gastric lavage tube** - it re-exposes the mucosa and risks perforation.",
        "**Do not give activated charcoal** - it blinds the endoscopist.",
        "**Do not neutralise** with milk, vinegar or bicarbonate - the exothermic reaction adds a thermal burn.",
        ...
        "Absence of oral burns does not exclude oesophageal injury - about **a third** with significant oesophageal burns have a normal-looking mouth.",
        ...
        "**Oesophageal carcinoma risk is raised 1000-fold** decades later - these patients need lifelong follow-up.",
      ],
    },
    {
      heading: "Rodenticides and yellow oleander",
      points: [
        "**Aluminium phosphide** (Celphos, Quickphos, the wheat pill) releases phosphine on contact with gastric acid and moisture. [Mehrpour 2012]",
        ...
        "Decontamination: **coconut oil and sodium bicarbonate lavage** - oil is said to retard phosphine release, bicarbonate to reduce acid-driven hydrolysis.",
        ...
        "Ventilate the room and **avoid mouth-to-mouth** - the exhaled phosphine is toxic to the rescuer.",
        ...
        "**Avoid IV calcium** in glycoside toxicity by convention - treat hyperkalaemia with insulin-dextrose and bicarbonate instead.",
      ...
      answer: [
        {
          ...
          points: [
            ...
            "Position left lateral, suction the airway, give high-flow oxygen, attach a monitor and pulse oximeter.",
            "Secure two IV lines and check capillary glucose.",
            "Give **dextrose 25 g IV** (50 mL of 50%) if glucose is low or unmeasurable.",
            "Remove all clothing and wash skin and hair with soap and water - unwashed skin keeps absorbing poison. [WHO 2008]",
            "Intubate for **GCS below 8**, respiratory rate below 8 or above 30, SpO2 below 90% on oxygen, or secretions that cannot be cleared.",
          ],
        },
        {
          heading: "2. Confirming the diagnosis",
          points: [
            "**Cholinergic toxidrome** is diagnostic at the bedside: miosis, bradycardia, salivation, lacrimation, sweating. [Eddleston 2008]",
            "Cholinergic continued: vomiting, diarrhoea, incontinence, bronchorrhoea, bronchospasm - DUMBELS.",
            ...
            "Grade severity with the **Peradeniya Organophosphorus Poisoning scale**: 0-3 mild, 4-7 moderate, 8-11 severe.",
            "Peradeniya scores pupils, respiratory rate, heart rate, fasciculations, consciousness and seizures.",
            "Red cell acetylcholinesterase or plasma pseudocholinesterase **below 50% of normal** supports the diagnosis.",
            "Treatment is never delayed for the enzyme level. [Eddleston 2008]",
            "Obtain the container and read the label for compound and concentration.",
          ],
        },
        {
          heading: "3. Atropine, titrated",
          points: [
            "**Atropine 1.8-3 mg IV bolus**, reassess at 5 minutes. [Eddleston 2008]",
            "Double the dose at every 5-minute reassessment - 3, 6, 12, 24 mg - until atropinised. [Eddleston 2008]",
            "End-points: **clear chest**, heart rate above 80 per minute, systolic BP above 80 mmHg, dry axillae, pupils no longer pinpoint. [Eddleston 2008]",
            "The chest and axillae are the end-points to trust.",
            "Then infuse at **10-20% of the total loading dose per hour**, titrated hourly, tapering over 24-48 hours. [Eddleston 2008]",
            "Atropine toxicity: fever with dry skin, absent bowel sounds, retention, delirium, heart rate **above 140**.",
            "On atropine toxicity stop the infusion and restart at half the rate.",
            "Paediatric atropine **0.02-0.05 mg/kg IV**, minimum 0.1 mg, doubled every 5 minutes to the same end-points.",
          ],
        },
        {
          heading: "4. Pralidoxime and other measures",
          points: [
            "**Pralidoxime 30 mg/kg** (1-2 g) IV in 100 mL normal saline over 15-30 minutes. [Eddleston 2008]",
            "Then pralidoxime infusion **8-10 mg/kg/hour** for at least 24 hours. [Eddleston 2008]",
            "Without a pump: pralidoxime 1 g IV every 4-6 hours.",
            "Paediatric pralidoxime **25-50 mg/kg over 30 minutes**, then 10-20 mg/kg/hour.",
            "Pralidoxime is renally cleared - reduce in renal failure.",
            "Give pralidoxime **only after atropine has started**. [Eddleston 2008]",
            "Always infuse pralidoxime - rapid injection causes hypertension and laryngospasm.",
            "**Activated charcoal 50 g** once within one hour if the airway is protected.",
            "Gastric lavage is not routine; induced emesis is forbidden. [WHO 2008]",
            "Seizures: **lorazepam 4 mg IV** (child 0.1 mg/kg, maximum 4 mg) or diazepam 5-10 mg IV.",
            "Benzodiazepines also reduce central toxicity.",
          ],
        },
        {
          heading: "5. Complications, transfer and after-care",
          points: [
            "Anticipate aspiration pneumonitis and respiratory failure.",
            "Anticipate arrhythmias including **prolonged QT and torsades**, pancreatitis and hyperglycaemia.",
            ...
            "Delayed polyneuropathy appears at **2-3 weeks**.",
            "Avoid **succinylcholine**, aminoglycosides, morphine, phenothiazines and theophylline.",
            "Transfer to a ventilator bed with a written record of every dose and time.",
            "Escort with oxygen, suction, atropine and a self-inflating bag.",
            "Complete medico-legal formalities and preserve the container and gastric aspirate.",
            "Arrange psychiatric assessment and family counselling before discharge - repeat attempts are common.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "Assessment",
          points: [
            "Establish the time, the dose in **mg/kg**, and whether the ingestion was single or staggered.",
            "Ask about co-ingestants, particularly alcohol.",
            "High-risk patients, threshold **75-100 mg/kg**: chronic alcohol use, malnutrition, anorexia.",
            "Enzyme inducers also lower the threshold: phenytoin, carbamazepine, rifampicin, isoniazid.",
            "Recognise the four clinical stages - the patient looks well in the **first 24 hours**.",
            "Send paracetamol level at **4 hours or later**, with ALT, INR, creatinine, glucose, arterial pH and lactate. [Rumack 1975]",
          ],
        },
        {
          heading: "Decontamination and the decision to treat",
          points: [
            "**Activated charcoal 50 g** if presenting within 1 hour of a substantial ingestion with a protected airway.",
            ...
            "Treat empirically without a level if the time is unknown or the ingestion was staggered. [NICE/RCEM 2023]",
            "Treat empirically if presentation is **beyond 8 hours** or the level cannot be obtained in time. [NICE/RCEM 2023]",
          ],
        },
        {
          heading: "N-acetylcysteine regimens",
          points: [
            "IV 21-hour regimen bag 1: **150 mg/kg in 200 mL of 5% dextrose over 60 minutes**. [NICE/RCEM 2023]",
            "Bag 2: 50 mg/kg in 500 mL over 4 hours. [NICE/RCEM 2023]",
            "Bag 3: 100 mg/kg in 1000 mL over 16 hours - total **300 mg/kg**. [NICE/RCEM 2023]",
            "Oral regimen: **140 mg/kg loading, then 70 mg/kg every 4 hours for 17 doses**.",
            "Repeat any oral dose vomited within an hour, after an antiemetic.",
            "Extend the final infusion beyond 21 hours if ALT is still rising, INR is **above 1.3**, or paracetamol remains detectable.",
            "Anaphylactoid reactions are rate-related: stop, give **chlorphenamine 10 mg IV**, nebulise salbutamol for wheeze, restart slower.",
          ],
        },
        {
          ...
          points: [
            ...
            "King's College criterion 1: **arterial pH below 7.30** after resuscitation.",
            "King's College criterion 2: **INR above 6.5 with creatinine above 3.4 mg/dL and grade III-IV encephalopathy**.",
            "Manage hypoglycaemia, coagulopathy and encephalopathy supportively.",
            "Avoid unnecessary fresh frozen plasma - it masks the prognostic INR.",
            "Every deliberate overdose needs psychiatric assessment and a risk assessment before discharge.",
            "Counsel about the danger of over-the-counter combination products containing paracetamol.",
          ],
        },
      ],
      mustDraw: [
