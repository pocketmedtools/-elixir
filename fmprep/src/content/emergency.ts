  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "Do not delay antibiotics for imaging or lumbar puncture.",
        "Cerebral malaria: **IV artesunate 2.4 mg/kg at 0, 12 and 24 hours**, then daily. [WHO 2023]",
        "Children under 20 kg: artesunate **3 mg/kg per dose**. [WHO 2023]",
        "Treat the hypoglycaemia that accompanies cerebral malaria and avoid fluid overload.",
        "Never use quinine as first line where artesunate is available. [WHO 2023]",
        "Hepatic encephalopathy: find and stop the precipitant - GI bleeding, sepsis, constipation, diuretics, sedatives, high protein load.",
        "**Lactulose 30 mL** orally or by nasogastric tube two to four times a day, titrated to two or three soft stools daily.",
        "Severe symptomatic hyponatraemia with seizures or coma: **3% saline 100 mL IV over 10 minutes**, repeated up to three times until symptoms improve.",
        "Keep total sodium correction **within 8 mmol/L in 24 hours** - faster correction risks osmotic demyelination.",
        "Hypertensive encephalopathy: lower mean arterial pressure by **no more than 20-25% in the first hour**, with a titratable agent such as labetalol.",
      ],
    },
    {
      heading: "Airway, transfer and the medico-legal record",
      points: [
        "**GCS of 8 or less**, loss of the gag reflex, or vomit or blood in the airway means the airway must be secured.",
        "Without intubation skills: jaw thrust, suction, oropharyngeal airway, left lateral recovery position, high-flow oxygen, fastest escorted transfer.",
        "Restrict spinal motion in any unconscious patient in whom trauma cannot be excluded - log-roll rather than lift.",
        "A patient found unconscious at the roadside or at the bottom of stairs is a **trauma patient until the mechanism is known**.",
        "Send the timed observation chart including serial GCS and pupils.",
        "Send the capillary glucose readings and everything given, with times and doses.",
        "Send the drug packets or poison container brought by the family.",
        "Send a written referral naming the accepting doctor if one has been contacted.",
        "**Do not send an unconscious patient in a private car with only a relative.**",
        "Send a trained escort, a self-inflating bag with mask, suction, and the drugs already needed.",
        "Carry oxygen sufficient for **at least twice the journey time**, and hand over face to face.",
        "Record medico-legal essentials when the cause may be poisoning, assault, road traffic injury, burns or a suspicious fall.",
        "Medico-legal essentials: time and place found, who brought the patient, the exact words of the informant.",
        "Medico-legal essentials continued: the findings, the police intimation, the identifying marks.",
        "Alcohol should be described as an **odour, never certified**.",
        "Explain honestly to the family that the cause is not yet known.",
        "Explain that transfer is because the clinic cannot provide imaging and intensive care.",
        "Document the explanation and the consent for transfer.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Assess responsiveness with **AVPU** - P or U means a GCS of about 8 or less and an unprotected airway.",
            "Open the airway with head-tilt chin-lift, or **jaw thrust if trauma is possible**.",
            "Suction secretions or vomit, insert an oropharyngeal airway if tolerated, place in the left lateral recovery position.",
            "Oxygen to maintain saturation **94-98%**; attach a pulse oximeter.",
            "Bag and mask ventilation if the respiratory rate is **below 8** or breathing is inadequate.",
            "Secure two IV cannulae; record pulse, blood pressure, respiratory rate and temperature.",
            "Treat shock with a fluid bolus while looking for its cause.",
        ...
        },
        {
          ...
          points: [
            "Hypoglycaemia adult: **25% dextrose 100 mL (25 g) IV over 1-3 minutes**, repeated after 10-15 minutes if not awake and glucose still low.",
            "Child: 10% dextrose **5 mL/kg**; neonate: 10% dextrose 2 mL/kg. [IAP 2022]",
            "Recheck glucose 15 minutes after each dose.",
            "**Thiamine 100 mg IV or IM** before or with dextrose in the malnourished or alcoholic patient.",
            "Suspected Wernicke: thiamine 500 mg IV three times daily for 2 days.",
            "Suspected opioid toxicity: **naloxone 0.4 mg IV** every 2-3 minutes, titrated to an adequate respiratory rate, maximum about 10 mg.",
            "Child naloxone 0.01 mg/kg.",
            "Observe after waking - naloxone wears off in **30-90 minutes**.",
            "Seizure lasting 5 minutes or more: **lorazepam 4 mg IV over 2 minutes**, repeated once after 10 minutes. [Glauser 2016]",
            "No venous access: midazolam 10 mg IM. [Glauser 2016]",
            "Avoid flumazenil for suspected benzodiazepine overdose - it precipitates seizures in a mixed overdose or dependent patient.",
          ],
        },
        {
          heading: "Focused history and examination",
          points: [
            "History from the family: diabetes and its drugs, alcohol, epilepsy, liver or kidney disease, psychiatric illness.",
            "History continued: recent fever or headache, trauma, all prescribed and traditional medicines, access to poisons or pesticides.",
            "Examine: **GCS recorded as E, V and M**; pupil size, symmetry and reaction; lateralising motor signs. [Teasdale 2014]",
            "Examine: neck stiffness, fundus for papilloedema.",
            "Head-to-toe survey for injury, needle marks, rash and jaundice.",
            "Identify toxidromes - cholinergic, opioid, anticholinergic, sympathomimetic - each has a specific antidote or supportive treatment.",
            "Repeat and chart observations at **15-minute intervals** - the trend, not the single reading, drives decisions.",
          ],
        },
        {
          ...
          points: [
            ...
            "E: Epilepsy, Endocrine (thyroid, adrenal) and Electrolytes.",
            "I: Insulin - both hypoglycaemia and hyperglycaemic emergencies.",
            "O: Opiates and Oxygen lack.",
            "U: Uraemia and other organ failures including hepatic encephalopathy.",
            "T: Trauma including chronic subdural haematoma, and Temperature (heat stroke, hypothermia).",
            "I: Infection - meningitis, encephalitis, cerebral malaria, enteric fever, sepsis with delirium in the elderly.",
            "P: Psychiatric and Porphyria.",
            "S: Stroke, Shock, Space-occupying lesion and Snake bite.",
            "Neurotoxic snake envenomation presents as **ptosis and paralysis** rather than true coma.",
          ],
        },
        {
          heading: "Investigations and definitive plan",
          points: [
            "At the clinic: capillary glucose, pulse oximetry, ECG, urine dipstick.",
            "Where available: haemoglobin, urea, creatinine, sodium, potassium, malaria rapid test.",
            "At the referral centre: **CT head**, lumbar puncture where meningitis is suspected and not contraindicated.",
            "Referral centre continued: arterial blood gas, liver and thyroid function, ammonia, blood cultures, toxicology screen.",
            "Suspected bacterial meningitis before transfer: **ceftriaxone 2 g IV plus dexamethasone 0.15 mg/kg**.",
            "Cerebral malaria: **artesunate 2.4 mg/kg IV**. [WHO 2023]",
            "Organophosphate poisoning: atropine.",
            "Transfer with a trained escort, oxygen, suction, a self-inflating bag.",
            "Send the timed observation chart and the drug or poison containers.",
            "Hand over face to face and complete medico-legal documentation where required.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Protect from injury - do not restrain the limbs and **do not put anything into the mouth**.",
            "Turn into the left lateral position and suction the airway.",
            "High-flow oxygen, pulse oximeter, note the time the seizure began, secure IV access.",
            "Check capillary blood glucose in every fitting patient.",
            "Correct hypoglycaemia: **25% dextrose 100 mL IV** in an adult, or 10% dextrose 5 mL/kg in a child.",
            "**Thiamine 100 mg IV before glucose** in the alcoholic or malnourished patient.",
          ],
        },
        {
          ...
          points: [
            ...
            "Adult without IV access: **midazolam 10 mg IM**, or diazepam 10 mg rectally. [Glauser 2016]",
            "Child: lorazepam **0.1 mg/kg IV**, maximum 4 mg per dose. [Glauser 2016]",
            "Child without access: buccal or intranasal midazolam 0.2 mg/kg (maximum 10 mg), or rectal diazepam 0.5 mg/kg (maximum 20 mg).",
            "**Never exceed two doses of benzodiazepine** - a third adds respiratory depression without adding seizure control.",
          ],
        },
        {
          heading: "Second line and transfer",
          points: [
            "**Levetiracetam 60 mg/kg IV over 10 minutes** (maximum 4500 mg). [Glauser 2016]",
            "Alternatives: sodium valproate 40 mg/kg (maximum 3000 mg), or fosphenytoin 20 mg phenytoin-equivalents/kg. [Glauser 2016]",
            "Plain phenytoin 20 mg/kg: dilute in **normal saline only, never dextrose**.",
            "Phenytoin no faster than **50 mg/min** in an adult or 1 mg/kg/min in a child, with pulse and blood pressure monitoring.",
            "Seizures persisting after the second-line agent are **refractory status** - needs anaesthesia and ventilation.",
            "Refractory status: arrange immediate escorted transfer with airway support.",
            "Precipitants: missed antiepileptic doses, alcohol withdrawal, hypoglycaemia, hyponatraemia.",
            "Precipitants continued: meningitis, cerebral malaria, eclampsia, head injury, space-occupying lesion.",
          ],
        },
        {
          heading: "Special situation",
          points: [
            "A pregnant or recently delivered woman with a seizure is treated as **eclampsia**. [FOGSI 2019]",
            "Loading: **magnesium sulphate 4 g of 20% solution IV over 5 minutes** plus 10 g of 50% solution IM (5 g into each buttock). [FOGSI 2019]",
            "Maintenance: 5 g IM every 4 hours. [FOGSI 2019]",
            "Recurrent fit: 2 g IV. [FOGSI 2019]",
            "Monitor for magnesium toxicity: knee jerks present, respiratory rate **above 16 per minute**, urine output above 30 mL per hour.",
            "Antidote: **calcium gluconate 10%, 10 mL IV over 10 minutes**.",
          ],
        },
      ],
      mustDraw: [
