      ...
      answer: [
        {
          ...
          points: [
            "Ensure the scene is safe before approaching. [ERC 2021]",
            "Check responsiveness by shaking and shouting. [ERC 2021]",
            "Open the airway with head tilt and chin lift. [ERC 2021]",
            "Look, listen and feel for normal breathing for **no more than 10 seconds**. [ERC 2021]",
            "Agonal gasping is **not breathing** - treat it as arrest. [ERC 2021]",
            "Shout for help and send a named person for the defibrillator, oxygen and emergency tray.",
            "Send a second named person to activate the ambulance service on **108**.",
        ...
        },
        {
          ...
          points: [
            "Chest compressions on the **lower half of the sternum**. [ERC 2021]",
            "Depth **5-6 cm**, rate 100-120 per minute, allowing full recoil. [ERC 2021]",
            "Compression to ventilation ratio **30:2**. [ERC 2021]",
            "Ventilate with a bag-valve-mask and reservoir on high-flow oxygen. [ERC 2021]",
            "Deliver just enough volume over **one second** to make the chest rise. [ERC 2021]",
            "Avoid hyperventilation - it reduces venous return.",
            "Rotate the person compressing **every 2 minutes**. [ERC 2021]",
            "Keep every interruption **under 10 seconds**. [ERC 2021]",
            "Once an advanced airway is placed, give continuous compressions with **10 breaths per minute**. [AHA 2020]",
          ],
        },
        {
          heading: "3. Defibrillation and the rhythm-specific algorithm",
          points: [
            "Attach the defibrillator or AED as soon as it arrives. [ERC 2021]",
            "Pause compressions for the **rhythm analysis only**. [ERC 2021]",
            "Shockable rhythm (VF or pulseless VT): a single shock at **150-200 J biphasic** (360 J monophasic). [ERC 2021]",
            "After the shock resume compressions immediately for **2 minutes** without a pulse check. [ERC 2021]",
            "Shockable arm: **adrenaline 1 mg IV after the third shock**, repeat every 3-5 minutes. [ERC 2021]",
            "Shockable arm: **amiodarone 300 mg IV** after the third shock, 150 mg after the fifth. [ERC 2021]",
            "Non-shockable rhythm (asystole or PEA): **adrenaline 1 mg IV as soon as access is available**, repeat every 3-5 minutes. [ERC 2021]",
            "Continue 2-minute cycles with rhythm checks between them. [ERC 2021]",
            "Obtain IV access, or **intraosseous access at the proximal tibia** if two peripheral attempts fail. [ERC 2021]",
          ],
        },
        {
          heading: "4. Reversible causes",
          points: [
            "4 Hs: hypoxia, hypovolaemia, hyperkalaemia and other metabolic causes including hypoglycaemia, hypothermia. [ERC 2021]",
            "4 Ts: tension pneumothorax, tamponade, toxins, thrombosis (coronary or pulmonary). [ERC 2021]",
            "Check **capillary glucose in every arrest**.",
            "Decompress a tension pneumothorax with a needle **before imaging**. [ATLS 10e]",
            "Give **calcium gluconate 10% 10-30 mL IV** if hyperkalaemia is likely. [ERC 2021]",
            "A team member takes history from bystanders about chest pain, poisoning, dialysis or trauma while resuscitation continues.",
          ],
        },
        {
          heading: "5. Post-resuscitation care and transfer",
          points: [
            "After ROSC reassess airway, breathing and circulation. [ERC 2021]",
            "Record a **12-lead ECG within 10 minutes** of ROSC. [ERC 2021]",
            "Check glucose and electrolytes after ROSC.",
            "Titrate oxygen to **SpO2 94-98%** and ventilate to normocapnia. [ERC 2021]",
            "Keep systolic BP **above 100 mmHg** with fluids and noradrenaline. [ERC 2021]",
            "Treat seizures and prevent fever. [ERC 2021]",
            "Pre-alert and transfer to a hospital with a catheterisation laboratory and intensive care.",
            "Transfer accompanied by a trained person with oxygen, monitor and drugs.",
            "Document collapse time, CPR start time, shocks, drugs with times, and time of ROSC.",
            "Debrief the team and speak to the family.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Adults: compressions first. [ERC 2021]",
            "Adults: compression-only CPR is acceptable for an untrained rescuer. [ERC 2021]",
            "Children and infants: **five initial rescue breaths** before compressions - hypoxia is the mechanism. [ERC 2021]",
            "In children ventilation is never omitted.",
        ...
        },
        {
          ...
          points: [
            "Adult: two hands on the lower half of the sternum, depth **5-6 cm**. [ERC 2021]",
            "Child: one or two hands, depth at least one-third of the chest diameter, about **5 cm**. [ERC 2021]",
            "Infant: two fingers for a single rescuer. [ERC 2021]",
            "Infant: **two-thumb encircling technique** for two rescuers. [ERC 2021]",
            "Infant depth about **4 cm**. [ERC 2021]",
            "Infant head is kept **neutral** - over-extension occludes the soft trachea.",
            "Rate is **100-120 per minute** at every age. [ERC 2021]",
          ],
        },
        {
          heading: "Drugs, energy and access",
          points: [
            "Adult adrenaline: **1 mg IV** every 3-5 minutes. [ERC 2021]",
            "Child adrenaline: **10 microgram/kg** (0.1 mL/kg of 1:10,000), maximum 1 mg, every 3-5 minutes. [ERC 2021]",
            "Amiodarone: 300 mg in the adult, **5 mg/kg** in the child. [ERC 2021]",
            "Defibrillation: 150-200 J biphasic in the adult. [ERC 2021]",
            "Defibrillation: **4 J/kg at every shock** in the child. [ERC 2021]",
            "Paediatric pads or an attenuator under **8 years or 25 kg**. [AHA 2020]",
            "Intraosseous access is the early default in children - peripheral access is often impossible. [ERC 2021]",
          ],
        },
        {
          heading: "Causes to look for",
          points: [
            "Adult causes: acute coronary syndrome, arrhythmia, pulmonary embolism, haemorrhage.",
            "Child causes: **hypoxia** from airway obstruction, foreign body, pneumonia, bronchiolitis, asthma, drowning.",
            "Child causes: shock from gastroenteritis, sepsis or trauma.",
            "The paediatric emphasis is therefore on recognising and treating the **compensated child** before arrest ever happens.",
          ],
        },
      ],
      ...
      answer: [
        {
          heading: "The 4 Hs",
          points: [
            "Hypoxia - open the airway and ventilate with high-flow oxygen. [ERC 2021]",
            "Hypoxia - relieve any foreign body or airway obstruction.",
            "Hypovolaemia - two wide-bore cannulae, rapid crystalloid and blood. [ERC 2021]",
            "Hypovolaemia - surgical or obstetric control of the bleeding source.",
            "Hyperkalaemia - **calcium gluconate 10% 10-30 mL IV**. [ERC 2021]",
            "Hyperkalaemia - insulin **10 units with 25 g dextrose** IV. [ERC 2021]",
            "Hyperkalaemia or acidosis - sodium bicarbonate **50 mmol IV**. [ERC 2021]",
            "Hypokalaemia - potassium replacement. [ERC 2021]",
            "Hypoglycaemia - **25 g dextrose IV**.",
            "Hypothermia - active rewarming with warmed fluids and blankets, prolonged CPR. [ERC 2021]",
            "Hypothermia - withhold repeated drug doses until core temperature is **above 30 degrees C**. [ERC 2021]",
          ],
        },
        {
          heading: "The 4 Ts",
          points: [
            "Tension pneumothorax - **immediate needle decompression** followed by an intercostal drain. [ATLS 10e]",
            "Tamponade - pericardiocentesis, or resuscitative thoracotomy in penetrating trauma. [ERC 2021]",
            "Toxins - **naloxone** for opioids.",
            "Toxins - atropine and pralidoxime for organophosphates.",
            "Toxins - sodium bicarbonate for tricyclics.",
            "Toxins - digoxin-specific Fab for digoxin and oleander.",
            "Toxins - calcium and high-dose insulin for calcium channel blockers.",
            "Toxins - intravenous lipid emulsion for local anaesthetic toxicity.",
            "Coronary thrombosis - thrombolysis or primary PCI after ROSC. [ERC 2021]",
            "Pulmonary thrombosis - thrombolysis during CPR, then continue compressions for **60-90 minutes**. [ERC 2021]",
          ],
        },
        {
          heading: "How they are found",
          points: [
            "History from relatives while CPR continues.",
            "A rapid look at the drug chart or poison container.",
            "Capillary glucose in every arrest.",
            "Bedside ultrasound where available - tamponade, pneumothorax and hypovolaemia are all visible.",
            "Distended neck veins with absent breath sounds point to **tension pneumothorax**.",
            "Pinpoint pupils point to opioid poisoning.",
            "A fistula in a dialysis patient points to hyperkalaemia.",
          ],
        },
      ],
      markSplit: [
