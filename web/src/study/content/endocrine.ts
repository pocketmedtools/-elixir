  ...
  sections: [
    {
      ...
      points: [
        "**Any one of four criteria diagnoses diabetes:** fasting plasma glucose 126 mg/dL or more (8 h fast), 2-hour plasma glucose 200 mg/dL or more after a 75 g oral glucose load, HbA1c 6.5% or more, or a random plasma glucose 200 mg/dL or more in a patient with polyuria, polydipsia and weight loss.",
        "In the **absence of unequivocal hyperglycaemia, confirm with a repeat test** on a separate sample - ideally the same test repeated. Two different abnormal tests on one sample (for example FPG 132 mg/dL and HbA1c 6.8%) also confirm the diagnosis.",
        "**Prediabetes:** impaired fasting glucose 100-125 mg/dL (ADA) or 110-125 mg/dL (WHO), impaired glucose tolerance 2-h 140-199 mg/dL, HbA1c 5.7-6.4%. Roughly one in four Indians with prediabetes converts to diabetes within 5 years.",
        "**ICMR-INDIAB (Lancet Diabetes Endocrinol, 2023)** estimated 11.4% of Indian adults have diabetes and 15.3% prediabetes, with prediabetes now exceeding diabetes in most states - the pipeline of future disease is larger than the current disease.",
        "**NFHS-5 (2019-21)** found about one in seven adults aged 15 and above with a random blood glucose above 140 mg/dL or already on medication, with the urban excess narrowing as rural prevalence rises.",
        "**Asian Indian phenotype:** onset a decade earlier than in Europeans, at a lower BMI, with more visceral and hepatic fat, lower muscle mass, early beta-cell failure and a strong family history - a normal BMI must never reassure you.",
      ],
    },
    {
      heading: "Whom to screen and how",
      points: [
        "ICMR advises **screening all adults from age 30**, and earlier if overweight with any risk factor: first-degree relative with diabetes, hypertension, dyslipidaemia, PCOS, prior gestational diabetes, acanthosis nigricans or sedentary work.",
        "Under **NP-NCD, population-based screening** of everyone aged 30 and above is done by the ASHA and ANM at the Health and Wellness Centre using the CBAC form, with a capillary glucose as the first filter and venous confirmation of every positive.",
        "**Indian Diabetes Risk Score (IDRS, MDRF)** uses four items - age, waist circumference, physical activity and family history - scored to a maximum of 100; **60 or more is high risk** and mandates a blood test. It is free, needs only a measuring tape and works in camps.",
        "Use **fasting plasma glucose plus HbA1c** as the practical screening pair. Venous plasma, laboratory method, NGSP-certified assay; a glucometer reading never diagnoses diabetes.",
        "**HbA1c is unreliable** in iron deficiency (falsely high), recent transfusion, blood loss or haemolysis (falsely low), haemoglobinopathies such as HbE, HbD and sickle trait (uninterpretable), and in advanced chronic kidney disease - all common in India, so cross-check against plasma glucose.",
        "Repeat screening every 3 years if normal, **annually if prediabetes**, always alongside structured lifestyle advice rather than instead of it.",
      ],
    },
    {
      heading: "Is it really type 2? Sorting the phenotype",
      points: [
        "**Type 1 / ketosis-prone:** lean, age under 35, rapid weight loss over weeks, ketonuria, poor response to oral agents. Send C-peptide (fasting, with a paired glucose) and GAD antibodies rather than guessing.",
        "**LADA:** adult onset, lean, apparent type 2 that fails oral agents within 6-12 months; GAD antibody positive. Move to insulin early and avoid sulfonylureas, which accelerate beta-cell exhaustion.",
        "**Fibrocalculous pancreatic diabetes (FCPD):** young, very lean, recurrent epigastric pain from childhood, steatorrhoea, pancreatic calculi on plain abdominal X-ray or CT - described from Kerala, Odisha and Tamil Nadu; needs insulin plus pancreatic enzyme replacement and characteristically resists ketosis.",
        "**Secondary diabetes:** corticosteroids, antiretrovirals, atypical antipsychotics, post-pancreatitis, chronic pancreatitis, haemochromatosis, Cushing syndrome and acromegaly.",
        "**MODY** if three generations are affected, onset is before 25, the patient is non-obese, there is no ketosis and fasting hyperglycaemia is mild and stable - HNF1A MODY responds beautifully to low-dose sulfonylurea and needs no insulin.",
        "The single most useful bedside discriminator is **body habitus plus the speed of the story**: obese with years of creeping numbers is type 2; lean with weeks of weight loss is not.",
      ],
    },
    {
      heading: "Targets and the first consultation",
      points: [
        "**HbA1c below 7%** for most; **6.5% or lower** for the young, newly diagnosed, with long life expectancy and no cardiovascular disease; **8%** is acceptable in the frail elderly, advanced complications, hypoglycaemia unawareness or short life expectancy.",
        "Fasting glucose 80-130 mg/dL and 2-hour postprandial below 180 mg/dL correspond to those targets. In Indian high-carbohydrate diets the **postprandial excursion dominates the HbA1c**, so measure the post-lunch value and not only the fasting.",
        "**Baseline work-up:** HbA1c, fasting lipids, serum creatinine with eGFR, urine albumin-creatinine ratio, ALT, TSH, ECG, dilated fundus examination, foot examination with a 10 g monofilament, blood pressure, weight and waist circumference.",
        "Ask every patient about **cough for 2 weeks or more, fever, night sweats and weight loss** - under NTEP, bidirectional screening means every diabetic is screened for TB symptoms and every TB patient is tested for diabetes.",
        "Write the **non-drug prescription** explicitly: 150 minutes a week of brisk activity plus two sessions of resistance work, 5-7% weight loss, refined cereal replaced by whole grain and millets, and a written portion plan - this alone is worth roughly 1-1.5% of HbA1c.",
        "Register the patient in the **NCD clinic / NP-NCD register** at the first visit so that follow-up, free drugs and annual complication screening are actually delivered rather than promised.",
      ],
    },
    {
      heading: "Choosing the oral agent",
      points: [
        "**Metformin is first line for nearly everyone:** start 500 mg once or twice daily after food, uptitrate weekly to 1000 mg twice daily; expect a 1-1.5% HbA1c fall, weight neutrality, no hypoglycaemia and the lowest cost. Extended-release helps when diarrhoea limits the dose.",
        "**Add an SGLT2 inhibitor** (dapagliflozin 10 mg OD or empagliflozin 10-25 mg OD) when there is established atherosclerotic disease, heart failure or chronic kidney disease - the benefit on heart-failure hospitalisation and eGFR decline is independent of glucose lowering.",
        "**Add a GLP-1 receptor agonist** (dulaglutide 0.75-1.5 mg weekly SC, injectable semaglutide 0.25 mg weekly titrated to 1 mg, oral semaglutide 3-14 mg daily) when obesity or atherosclerotic disease dominates - best weight loss and 1-1.5% HbA1c, but cost limits use in the public sector.",
        "**Use a sulfonylurea** (glimepiride 1-2 mg before breakfast, gliclazide MR 30-60 mg OD) when cost decides and hypoglycaemia risk is low - cheap and potent, but causes weight gain and hypoglycaemia and loses effect over years. Avoid glibenclamide entirely in the elderly and in renal impairment.",
        "**DPP-4 inhibitors** are weight-neutral and safe: teneligliptin 20 mg OD is the least expensive gliptin in India and linagliptin 5 mg OD needs no renal dose change. They give a modest 0.5-0.8% and no cardiovascular benefit; never combine one with a GLP-1 agonist.",
        "**Pioglitazone 15-30 mg OD** is cheap and helps marked insulin resistance and fatty liver; avoid in heart failure, oedema, osteoporosis and with a history of bladder cancer. **Acarbose 25-50 mg with the first mouthful of each meal** targets the postprandial spike of a rice- or roti-heavy diet.",
        "**Start insulin from the outset** if HbA1c is above 10%, glucose is above 300 mg/dL, there is ketonuria, or the patient is catabolic - then step down to oral agents once glucotoxicity resolves.",
      ],
    },
    {
      heading: "Prediabetes and prevention",
      points: [
        "The **Indian Diabetes Prevention Programme (IDPP-1, Ramachandran 2006)** showed lifestyle modification reduced progression from IGT to diabetes by 28.5%, metformin by 26.4%, and the combination by 28.2% - so combining them adds nothing over either alone, which is the classic exam point.",
        "Offer **structured lifestyle modification to everyone with prediabetes**: 5-7% weight loss, 150 minutes a week of moderate activity, reduced refined carbohydrate, and follow-up contact rather than a one-off lecture.",
        "**Metformin 500 mg BD may be added** for prediabetes with BMI 35 kg/m2 or more (Asian-Indian: 30 or more), age under 60, prior gestational diabetes, or rising HbA1c despite lifestyle - it is not a blanket prescription.",
        "Recheck **HbA1c or fasting glucose annually** in prediabetes, and screen at the same visit for hypertension, dyslipidaemia and fatty liver, which cluster with it.",
        "Counsel that prediabetes is already **vascular risk**, not a warning of future risk: retinopathy and neuropathy are detectable in a minority even before the diabetes threshold is crossed.",
      ],
    },
    {
      heading: "Follow-up and failure",
      points: [
        "Review at 4-6 weeks for tolerance and at **3 months with an HbA1c**; if not at target, add a drug rather than substitute one, because monotherapy failure reflects progressive beta-cell loss.",
        "Before blaming the drug, check **adherence, dosing technique, diet, an untreated infection, steroid use, thyroid status and depression** - the commonest cause of secondary failure in Indian practice is that the tablets ran out.",
        "Do not stack drugs with the same mechanism - sulfonylurea with a glinide, DPP-4 inhibitor with a GLP-1 agonist - and stop or halve the sulfonylurea when starting bedtime basal insulin if hypoglycaemia appears.",
        "**Check serum vitamin B12 after 3-4 years of metformin**, or sooner if there is neuropathy, since metformin-induced deficiency mimics diabetic neuropathy and is cheap to correct with methylcobalamin 1500 mcg daily.",
        "Annual screen: urine albumin-creatinine ratio, eGFR, dilated fundus, feet with a monofilament, fasting lipids; blood pressure and weight at every visit.",
        "**Sick-day rules** at every review: never stop insulin, hold metformin and SGLT2 inhibitors during vomiting, dehydration or sepsis, test glucose more often, and come in if vomiting prevents fluids.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Repeat the venous fasting plasma glucose in the laboratory on a separate day, or send an HbA1c on the same sample - two abnormal tests confirm diabetes.",
            "A capillary glucometer value is a screening tool only and can never confirm the diagnosis.",
            "Check haemoglobin and iron status before relying on HbA1c; iron deficiency falsely raises it and haemoglobinopathy makes it uninterpretable.",
            "If FPG is 100-125 mg/dL only, label prediabetes and perform a 75 g OGTT where impaired glucose tolerance is suspected.",
          ],
        },
        {
          heading: "2. Assessment at diagnosis",
          points: [
            "History: duration of symptoms, osmotic symptoms, weight change, family history, tobacco and alcohol, occupation and shift pattern, drugs (steroids, antipsychotics, antiretrovirals), and four TB symptom questions.",
            "Examination: weight, height, BMI against Asian-Indian cut-offs, waist circumference, blood pressure with a standing reading, acanthosis nigricans, fundus, and both feet with a 10 g monofilament and pedal pulses.",
            "Investigations: HbA1c, fasting lipid profile, serum creatinine with eGFR, urine albumin-creatinine ratio, urine routine, ALT, TSH, and ECG.",
            "Assess phenotype: a lean patient with rapid weight loss and ketonuria needs C-peptide and GAD antibodies before being labelled type 2.",
          ],
        },
        {
          heading: "3. Non-pharmacological management",
          points: [
            "Medical nutrition therapy: 50-55% of energy from complex carbohydrate, whole grains and millets replacing polished rice and maida, 25-30 g fibre daily, salt under 5 g, and fixed portion sizes.",
            "Physical activity: 150 minutes a week of moderate aerobic activity spread over at least five days with no more than two consecutive days missed, plus resistance exercise twice a week.",
            "Weight target: 5-7% loss in the first six months, which alone gives 1-1.5% of HbA1c.",
            "Tobacco cessation in every form including gutkha and khaini, alcohol limitation, foot care education and structured self-monitoring instruction.",
          ],
        },
        {
          heading: "4. Pharmacological management",
          points: [
            "Start metformin 500 mg once daily after food, increasing weekly to 1000 mg twice daily as tolerated, provided eGFR is above 45 mL/min/1.73 m2.",
            "Set an HbA1c target below 7%, or 6.5% in this newly diagnosed man of 45 with no complications.",
            "Reassess HbA1c at 3 months; if above target add a second agent chosen by comorbidity - SGLT2 inhibitor for heart failure or CKD, GLP-1 agonist for obesity or established atherosclerotic disease, sulfonylurea or teneligliptin where cost governs.",
            "Add statin therapy (atorvastatin 10-20 mg at night) for primary prevention, and an ACE inhibitor or ARB if blood pressure is 140/90 mmHg or more, or if albuminuria is present.",
          ],
        },
        {
          heading: "5. Follow-up over the first year",
          points: [
            "Visits at 4-6 weeks, then 3-monthly with HbA1c, weight, blood pressure and a review of adherence and hypoglycaemia.",
            "At 12 months: dilated fundus examination, urine albumin-creatinine ratio, eGFR, lipid profile and foot examination - and repeat these annually.",
            "Register the patient in the NP-NCD clinic register for free drug supply and recall.",
            "Educate on sick-day rules, hypoglycaemia recognition and treatment, and when to attend the same day.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "ICMR-INDIAB (2023) found prediabetes in 15.3% of Indian adults, exceeding the 11.4% with diabetes.",
            "Roughly one in four converts to diabetes within five years without intervention.",
            "Prediabetes already carries excess cardiovascular risk and clusters with hypertension, dyslipidaemia and non-alcoholic fatty liver disease.",
          ],
        },
        {
          heading: "Detection",
          points: [
            "Opportunistic and population screening from age 30 under NP-NCD using the CBAC form, or by IDRS with a cut-off of 60.",
            "Confirm with a venous fasting plasma glucose and HbA1c; use a 75 g OGTT when isolated impaired glucose tolerance is suspected, as in prior gestational diabetes.",
          ],
        },
        {
          heading: "Management",
          points: [
            "Structured lifestyle modification is first line: 5-7% weight loss, 150 minutes a week of moderate activity, whole-grain and millet substitution, reduced refined sugar, and repeated contact rather than a single lecture.",
            "IDPP-1 evidence: lifestyle reduced progression by 28.5%, metformin by 26.4%, and both together by 28.2% - combination gives no additional benefit.",
            "Metformin 500 mg twice daily is added selectively for BMI 30 kg/m2 or more by Asian-Indian criteria, age under 60, prior gestational diabetes, or a rising HbA1c despite lifestyle.",
            "Treat the accompanying risk factors: blood pressure to below 140/90 mmHg, statin if 10-year risk warrants it, and tobacco cessation.",
          ],
        },
        {
          heading: "Follow-up",
          points: [
            "Annual fasting glucose or HbA1c, with waist and weight at every contact.",
            "Screen annually for hypertension and dyslipidaemia, and consider fatty liver evaluation if ALT is raised.",
          ],
        },
      ],
      ...
      answer: [
        {
          ...
          points: [
            "Type 1: onset usually under 35, lean, symptoms over weeks, ketosis-prone, C-peptide low or undetectable, GAD or IA-2 antibodies positive, insulin mandatory from day one.",
            "Type 2: onset usually over 35, overweight or centrally obese, insidious onset over years, ketosis-resistant, C-peptide normal or high, antibodies negative, oral agents effective initially.",
            "LADA: adult onset, lean or normal weight, initially responds to oral agents then fails within 6-12 months, GAD antibody positive with a preserved but falling C-peptide; needs early insulin and avoidance of sulfonylureas.",
            "FCPD: young, very lean, south or east Indian, recurrent abdominal pain from childhood with steatorrhoea, pancreatic calculi on imaging, very high glucose but ketosis-resistant, needs insulin plus pancreatic enzyme replacement.",
          ],
        },
        {
          heading: "Investigations that settle it",
          points: [
            "Fasting C-peptide with a paired plasma glucose - a low C-peptide in the face of hyperglycaemia indicates insulin deficiency.",
            "GAD65 antibody, positive in type 1 and LADA, negative in type 2 and FCPD.",
            "Plain abdominal X-ray or CT abdomen for pancreatic calculi, plus faecal elastase for exocrine insufficiency in suspected FCPD.",
            "Urine ketones at presentation in any lean patient with marked hyperglycaemia.",
          ],
        },
        {
          heading: "Why it matters",
          points: [
            "Misclassifying LADA as type 2 and giving a sulfonylurea hastens beta-cell failure and risks ketoacidosis.",
            "Misclassifying FCPD as type 1 misses the need for pancreatic enzyme replacement and the risk of pancreatic malignancy.",
            "Misclassifying type 1 as type 2 and withholding insulin can be fatal within days.",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        "**At diagnosis:** HbA1c above 10%, fasting glucose above 300 mg/dL, ketonuria, or unintentional weight loss with osmotic symptoms - glucotoxicity must be broken before oral agents can work.",
        "**In established diabetes:** HbA1c persistently above target on two or three optimally dosed oral agents, or when the HbA1c is more than 1.5-2% above target and oral escalation cannot realistically close the gap.",
        "**Compelling situations:** pregnancy, acute myocardial infarction or stroke, sepsis and hospitalisation, tuberculosis on treatment, chronic liver disease, advanced CKD (eGFR below 30), perioperative period, and high-dose corticosteroid therapy.",
        "**Phenotypes that need it:** type 1 diabetes, LADA after early oral failure, fibrocalculous pancreatic diabetes, and any patient with a low C-peptide.",
        "Insulin is **not a punishment and not a last resort** - saying so at the first visit prevents the years of therapeutic inertia that are the commonest reason Indian patients reach insulin with an HbA1c above 10%.",
      ],
    },
    {
      heading: "Choosing the regimen",
      points: [
        "**Basal insulin at bedtime is the standard start** in type 2 diabetes: human NPH (isophane) 10 units at bedtime, or 0.1-0.2 units/kg, is the cheapest and is supplied free in most NP-NCD clinics.",
        "**Analogue basal insulin** (glargine U100 or detemir, given once daily at a fixed time) causes less nocturnal hypoglycaemia and has a flatter profile than NPH, but costs several times more - reserve it for nocturnal hypoglycaemia, erratic meal timing, the elderly, or renal impairment.",
        "**Premixed 30/70 human insulin twice daily** before breakfast and before dinner suits a patient with two large fixed meals, poor literacy or an inability to attend for frequent titration; it is the workhorse of Indian practice but demands regular meals and gives more hypoglycaemia.",
        "**Basal plus** adds a single prandial rapid-acting dose to the largest meal when the fasting glucose is at target but the HbA1c is not; **basal bolus** (basal once daily plus rapid-acting insulin before all three meals) gives the most flexibility and is the regimen for type 1 diabetes.",
        "Rapid-acting analogues (aspart, lispro, glulisine) are given **0-10 minutes before the meal**; regular human insulin must be given **30 minutes before the meal**, which is the single most commonly missed instruction in the clinic.",
        "Continue metformin with insulin - it reduces the dose needed and limits weight gain. Continue an SGLT2 inhibitor or GLP-1 agonist if already prescribed; **stop or halve the sulfonylurea** when basal insulin is started, and stop it altogether when prandial insulin is added.",
      ],
    },
    {
      heading: "Titration - how to actually do it",
      points: [
        "**Basal insulin is titrated against the fasting capillary glucose alone.** Target fasting 80-130 mg/dL (relax to 100-140 mg/dL in the elderly or in those living alone).",
        "**The 3-0-3 rule:** increase the bedtime dose by 2 units every 3 days if the fasting glucose is above target on 3 consecutive days; a simpler patient-led rule is to add 1 unit every day until the fasting value is in range.",
        "**Reduce by 4 units, or by 10-20%, for any documented hypoglycaemia** (glucose below 70 mg/dL) or any nocturnal symptoms - never continue titrating up through hypoglycaemia.",
        "When basal insulin exceeds **0.5 units/kg/day, or 40-60 units, and the fasting glucose is at target but the HbA1c is not**, stop increasing - this is over-basalisation, and the next step is prandial insulin or a GLP-1 agonist, not more basal.",
        "Premix titration: adjust the **morning dose against the pre-dinner glucose** and the **evening dose against the next fasting glucose**, by 2 units every 3 days.",
        "Prandial insulin starts at 4 units, or 10% of the basal dose, with the largest meal, titrated by 1-2 units every 3 days against the 2-hour postprandial or the next pre-meal glucose.",
      ],
    },
    {
      heading: "A high fasting glucose - which of the three causes?",
      points: [
        "**Insufficient basal dose** is by far the commonest cause: the pre-bed and 3 a.m. glucose values are high or normal and there are no nocturnal symptoms. Increase the dose.",
        "**Dawn phenomenon:** the 3 a.m. glucose is normal and rises through the early morning under growth hormone and cortisol. Move the basal dose later (to bedtime rather than dinner), or switch NPH to a long-acting analogue.",
        "**Somogyi (rebound) effect:** the 3 a.m. glucose is low with sweating, nightmares or a morning headache, and the fasting value rebounds high. Reduce the evening dose - increasing it makes things worse.",
        "The bedside instruction is therefore simple: **before increasing the evening insulin for a high fasting sugar, ask for a 3 a.m. reading** at least once.",
        "Also exclude the artefacts: a late heavy dinner, missed dose, expired or frozen insulin, injection into lipohypertrophied skin, and a glucometer never checked against a laboratory value.",
      ],
    },
    {
      heading: "Injection technique, storage and the Indian realities",
      points: [
        "Sites: abdomen (fastest and most predictable absorption), thigh, buttock, upper outer arm. **Rotate systematically within one site** rather than between sites, at least 1 cm from the last injection.",
        "**Lipohypertrophy** is the commonest cause of unexplained erratic control - palpate every injection site at every visit. Injecting into it can reduce absorption by 25% or more, and moving to normal skin without reducing the dose causes hypoglycaemia.",
        "Needle length 4-6 mm; inject at 90 degrees with no pinch for 4 mm needles; **do not reuse needles** (blunting causes pain, bleeding and lipohypertrophy), and count 10 seconds before withdrawing a pen needle.",
        "**Storage:** unopened vials and cartridges at 2-8 degrees Celsius, never frozen. In-use insulin may be kept at room temperature for 28 days away from direct sunlight; where there is no refrigerator, an earthen pot with wet sand or a matka works and is the standard rural advice.",
        "Human insulin in India is supplied as **U-100 in 10 mL vials and 3 mL cartridges/pens**; make sure the syringe is a U-100 (40-unit or 100-unit marked) syringe matched to the insulin strength, as U-40 insulin still exists and mismatched syringes cause 2.5-fold dosing errors.",
        "Teach a family member as well as the patient, provide a written sliding record, and confirm the patient can afford both insulin and the strips before designing an intensive regimen.",
      ],
    },
    {
      heading: "Monitoring, fasting and sick days",
      points: [
        "On basal insulin, **fasting capillary glucose daily during titration** and then 2-3 times a week; on premix, alternate fasting and pre-dinner; on basal bolus, before each meal until stable.",
        "HbA1c every 3 months until at target, then 6-monthly; a 7-point profile once before any major regimen change if strips are affordable.",
        "**Ramadan and religious fasting:** risk-stratify, obtain a fatwa-consistent exemption for very high-risk patients, shift the main insulin dose to iftar, reduce the suhoor (pre-dawn) dose by about half, and instruct the patient to break the fast if glucose falls below 70 mg/dL or rises above 300 mg/dL.",
        "**Sick days:** never omit insulin, check glucose 4-hourly, check urine or blood ketones if glucose exceeds 250 mg/dL, maintain fluid and carbohydrate intake, and attend hospital for persistent vomiting, ketones or drowsiness.",
        "Weight gain of 2-4 kg is expected in the first year - pre-empt it with continued metformin, portion control and activity rather than by under-dosing insulin.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Failure of two or three optimally dosed oral agents to achieve the individualised HbA1c target.",
            "At diagnosis when HbA1c is above 10%, glucose above 300 mg/dL, ketonuria is present, or there is weight loss with osmotic symptoms.",
            "Temporary or mandatory indications: pregnancy and lactation, acute myocardial infarction or stroke, sepsis, surgery, active tuberculosis on treatment, high-dose steroids, decompensated liver disease and eGFR below 30 mL/min/1.73 m2.",
            "Phenotypic indications: type 1 diabetes, LADA, fibrocalculous pancreatic diabetes and any patient with a low C-peptide.",
          ],
        },
        {
          heading: "2. Before starting - preparation",
          points: [
            "Confirm adherence to existing drugs, exclude an occult infection including tuberculosis, and review diet, steroid use and thyroid status.",
            "Assess vision, manual dexterity, literacy, availability of a refrigerator, ability to afford insulin and strips, and identify a family member who can be trained.",
            "Address the fear of injections explicitly - demonstrate the pen needle and let the patient handle it.",
            "Record weight, baseline capillary profile and renal function.",
          ],
        },
        {
          heading: "3. Initiation",
          points: [
            "Start bedtime basal insulin: NPH 10 units at bedtime, or 0.1-0.2 units/kg, which for a 70 kg man is about 10-14 units.",
            "Continue metformin, which limits weight gain and insulin dose; halve or stop glimepiride to avoid hypoglycaemia; the DPP-4 inhibitor may be continued initially but is often stopped later.",
            "Use a long-acting analogue such as glargine instead of NPH if there is nocturnal hypoglycaemia, an erratic schedule, renal impairment, or advanced age and the patient can afford it.",
            "Teach self-monitoring of the fasting capillary glucose and supply a written record chart.",
          ],
        },
        {
          heading: "4. Titration",
          points: [
            "Target fasting capillary glucose 80-130 mg/dL; increase the bedtime dose by 2 units every 3 days while it remains above target.",
            "Reduce the dose by 4 units or 10-20% for any glucose below 70 mg/dL or for nocturnal symptoms.",
            "Recheck HbA1c at 3 months; if the fasting glucose is at target but HbA1c is still above target, or the dose exceeds 0.5 units/kg, add prandial insulin to the largest meal (basal plus, starting 4 units) or a GLP-1 receptor agonist rather than more basal.",
            "For a high fasting value, obtain a 3 a.m. reading to distinguish an inadequate dose from the dawn phenomenon and from a Somogyi rebound.",
          ],
        },
        {
          heading: "5. Patient education",
          points: [
            "Injection technique: sites, systematic rotation within a site, 4-6 mm needle, no needle reuse, 10-second count before withdrawal, and palpation for lipohypertrophy.",
            "Storage: 2-8 degrees Celsius unopened, in-use vial at room temperature for 28 days, never freeze, and use an earthen pot with wet sand where there is no refrigerator.",
            "Hypoglycaemia: recognition, the rule of 15, carrying glucose and an identity card, and never omitting a meal after taking insulin.",
            "Sick-day rules: never stop insulin, monitor 4-hourly, check ketones if glucose exceeds 250 mg/dL, and attend hospital for vomiting or drowsiness.",
            "Safe disposal of needles and lancets, and a plan for driving, fasting and travel.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Inadequate basal dose: bedtime, 3 a.m. and fasting values are all high; there are no nocturnal symptoms. Treatment is to increase the bedtime dose by 2 units every 3 days.",
            "Dawn phenomenon: the 3 a.m. value is normal and the glucose rises in the early morning hours under the influence of growth hormone and cortisol. Treatment is to move NPH from dinner to bedtime, or to switch to a long-acting analogue.",
            "Somogyi (rebound) hyperglycaemia: the 3 a.m. value is low, with sweating, nightmares or a morning headache, followed by counter-regulatory rebound. Treatment is to reduce the evening dose or add a bedtime snack.",
          ],
        },
        {
          heading: "Technical and behavioural causes to exclude",
          points: [
            "Missed or mistimed dose, and NPH not resuspended before drawing up.",
            "Injection into an area of lipohypertrophy, causing erratic absorption - palpate all sites.",
            "Insulin that has been frozen, kept in direct sunlight or is past 28 days in use.",
            "A late, large or high-carbohydrate dinner, and an inaccurate glucometer never validated against a laboratory value.",
            "U-40 insulin drawn into a U-100 syringe or vice versa.",
          ],
        },
        {
          heading: "Evaluation",
          points: [
            "Obtain a bedtime, 3 a.m. and fasting capillary glucose on at least one night, ideally two.",
            "Review the record chart, injection sites, technique and insulin storage at the same visit.",
            "Check for a precipitant such as infection, steroid use or new-onset hypothyroidism.",
            "Where affordable, continuous glucose monitoring for 7-14 days resolves the question definitively.",
          ],
        },
      ],
      mustDraw: [
