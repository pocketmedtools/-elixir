  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**The window of opportunity: begin under the age of 60 or within 10 years of the menopause.** In that window the benefit-risk balance is favourable and cardiovascular risk is not increased; started later, in a woman with established atheroma, the same therapy raises coronary and stroke risk - the timing hypothesis that reconciles the WHI with the observational data that preceded it. Outside the window, non-hormonal treatment is the answer.",
