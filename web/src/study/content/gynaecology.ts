  ...
  sections: [
    {
      ...
      points: [
        "**Infertility is the failure to achieve a clinical pregnancy after 12 months or more of regular unprotected sexual intercourse**; the work-up is begun after 6 months if the woman is aged 35 or more, and immediately at any age if there is amenorrhoea, known tubal disease, previous pelvic surgery or infection, stage III-IV endometriosis, or a partner with a known testicular problem.",
        "**Primary infertility** means the woman has never conceived; **secondary infertility** means there has been a previous conception, however it ended - including a miscarriage, ectopic pregnancy or termination. In India secondary infertility carries a strong signal of previous pelvic infection or unsafe abortion, and the distinction is a diagnostic clue, not merely a label.",
        "**Normal fecundability is about 20-25% per cycle**: roughly 85% of couples conceive within 12 months and a further 7-8% in the second year, which is why the 12-month threshold exists and why it is wrong to investigate a couple at three months or to dismiss one at eighteen.",
        "**Causes divide roughly as: male factor 30-40%, ovulatory dysfunction 25-30%, tubal and peritoneal factor 25-35%, uterine and cervical factors 5-10%, and unexplained 10-15%** - and both partners contribute in around 20-30% of couples, which is the reason the man is investigated from the first visit and not after the woman has been through everything.",
        "**Tubal factor is disproportionately important in India** because of pelvic inflammatory disease and, distinctively, **genital tuberculosis**, which is thought to account for 5-15% of female infertility in Indian series and can present with nothing more than infertility, hypomenorrhoea or secondary amenorrhoea in an otherwise well woman.",
        "The consultation itself is therapeutic. **See the couple together, use the word couple rather than patient, take a private sexual history from each, and name explicitly that infertility is not the woman's fault** - in Indian families the social burden falls almost entirely on her, and the physician who says this aloud earns both the family's trust and the examiner's mark.",
      ],
    },
    {
      heading: "History and examination of both partners",
      points: [
        "**Female history:** age, duration of infertility and of the marriage, menstrual history (menarche, cycle length, regularity, flow, dysmenorrhoea), previous pregnancies and their outcomes, contraceptive history, and any previous pelvic surgery, appendicectomy, ectopic pregnancy, abortion or dilatation and curettage.",
        "Ask directly about **galactorrhoea, hirsutism, acne, weight change, heat or cold intolerance, and deep dyspareunia with cyclical pelvic pain** - these separate hyperprolactinaemia, polycystic ovary syndrome, thyroid disease and endometriosis without any test at all.",
        "**Male history:** previous paternity, childhood mumps orchitis, undescended testis and its age at correction, testicular trauma or torsion, hernia and hydrocele surgery, genital infection or urethral discharge, erectile and ejaculatory function, and occupational heat exposure in a driver, welder or furnace worker.",
        "**Drugs, toxins and habits in both:** tobacco in any form including gutkha and khaini, alcohol, cannabis, anabolic steroids, sulfasalazine, nitrofurantoin, cimetidine, calcium channel blockers, ketoconazole, chemotherapy, radiotherapy, and antipsychotics that raise prolactin.",
        "**Coital history is the commonest omission and the commonest easy fix**: frequency (intercourse every 2-3 days across the cycle beats calendar timing), the use of vaginal lubricants that are spermicidal, complete failure of penetration, dyspareunia, vaginismus, prolonged separation for work, and beliefs about posture after intercourse.",
        "**Examination of the woman:** height, weight and BMI, waist circumference, blood pressure, thyroid, breasts for galactorrhoea, hirsutism scored on the Ferriman-Gallwey scale, acanthosis nigricans, secondary sexual characteristics, and a speculum and bimanual examination for uterine size, mobility, fixity, adnexal masses and nodularity in the pouch of Douglas.",
        "**Examination of the man is part of the family physician's job, not the urologist's alone:** secondary sexual characteristics, gynaecomastia, penis and urethral meatus, **testicular volume by Prader orchidometer (normal 15-25 mL; volume under 15 mL suggests impaired spermatogenesis)**, epididymal thickening or nodularity, palpation of both vasa deferentia, and a varicocele felt on standing with the Valsalva manoeuvre.",
      ],
    },
    {
      heading: "Semen analysis: the first and cheapest test",
      points: [
        "**Semen analysis is the single first-line test in every infertile couple and is done before any invasive test on the woman** - it is inexpensive, non-invasive, and reorders the entire work-up if it is abnormal. Doing a hysterosalpingogram before a semen analysis is a standard examination criticism.",
        "**Collection conditions matter more than the laboratory:** 2-7 days of abstinence, collection by masturbation into a clean wide-mouthed sterile container, no condom or lubricant, the whole ejaculate captured, and delivery to the laboratory within one hour kept close to body temperature.",
        "**WHO 6th edition (2021) lower reference limits are the fifth centile of fertile men, not a threshold of fertility:** semen volume 1.4 mL, sperm concentration 16 million per mL, total sperm number 39 million per ejaculate, total motility 42%, progressive motility 30%, vitality 54%, and normal forms 4% on strict criteria.",
        "**A single abnormal result never makes a diagnosis.** Spermatogenesis takes about 74 days plus epididymal transit, so an abnormal sample is repeated after **at least 3 months** - or sooner, within 2-4 weeks, if the count is severely low - and any recent fever, illness or drug in the preceding three months is recorded as the possible cause.",
        "**Vocabulary examiners ask for:** oligozoospermia (concentration below the reference limit), asthenozoospermia (reduced motility), teratozoospermia (reduced normal forms), oligoasthenoteratozoospermia when all three coexist, **azoospermia (no spermatozoa in the centrifuged pellet on two separate samples)**, and aspermia (no ejaculate at all).",
        "**Azoospermia is the finding that must be acted on, not repeated indefinitely.** Low volume with acidic pH and absent fructose suggests obstruction or congenital absence of the vas deferens (test for cystic fibrosis transmembrane conductance regulator mutations); normal volume with raised FSH and small testes suggests non-obstructive testicular failure, requiring karyotype and Y-chromosome microdeletion testing before referral for surgical sperm retrieval with ICSI.",
      ],
    },
    {
      heading: "Confirming ovulation and assessing ovarian reserve",
      points: [
        "**A regular cycle of 24-38 days with molimina - premenstrual breast tenderness, bloating and mood change - is about 95% predictive of ovulation**, and in such a woman ovulation testing is confirmatory rather than diagnostic. Oligomenorrhoea or amenorrhoea makes anovulation the working diagnosis without further proof.",
        "**Mid-luteal serum progesterone is the standard confirmatory test: draw it 7 days before the expected period (day 21 of a 28-day cycle, day 28 of a 35-day cycle) and a value above 3 ng/mL (about 10 nmol/L) confirms that ovulation occurred**, while values above 10 ng/mL (30 nmol/L) indicate adequate luteal function. Timing it rigidly on day 21 in a woman with a 35-day cycle is the classic error that produces a spuriously low result.",
        "Cheaper or supplementary methods: **urinary LH kits detecting the surge 24-36 hours before ovulation**, serial transvaginal follicular tracking from day 10 showing a follicle growing to 18-24 mm and then collapsing with free fluid, and basal body temperature charting (a biphasic rise of 0.3-0.5 degrees Celsius) - the last is retrospective, unreliable and burdensome, and is no longer recommended.",
        "**Anovulation is classified by the WHO groups**: Group I hypogonadotropic hypogonadal anovulation (low FSH, low oestradiol - hypothalamic amenorrhoea from weight loss, exercise or stress, and Kallmann syndrome); Group II normogonadotropic normo-oestrogenic anovulation, which is overwhelmingly **polycystic ovary syndrome and accounts for about 85% of anovulation**; Group III hypergonadotropic hypo-oestrogenic anovulation, that is primary ovarian insufficiency; and hyperprolactinaemic anovulation as a separate category.",
        "**Endocrine tests are targeted, not a panel:** TSH in every woman (subclinical hypothyroidism is common in Indian women and is easily corrected), serum prolactin if there is oligomenorrhoea, amenorrhoea or galactorrhoea, and day 2-5 FSH, LH and oestradiol where ovarian reserve or WHO group is in question. Androgens are measured only if there is hirsutism or virilisation.",
        "**Ovarian reserve is assessed by anti-Mullerian hormone and the antral follicle count, and both predict the response to stimulation, not the chance of natural conception** - a low AMH in a woman with regular cycles is a reason to avoid delay and to refer earlier, never a reason to tell her she cannot conceive. AFC is counted as follicles of 2-10 mm in both ovaries on early follicular transvaginal ultrasound.",
      ],
    },
    {
      heading: "Testing tubal patency and the uterus, including genital tuberculosis",
      points: [
        "**Hysterosalpingography is the first-line tubal test in a woman with no risk factors for tubal disease.** It is done in the **follicular phase, between day 6 and day 11, after bleeding has stopped and before ovulation**, so that an early pregnancy is not irradiated; radio-opaque contrast is injected through the cervix under fluoroscopy and free spill into the peritoneal cavity confirms patency.",
        "**HSG also images the cavity** and will show a septum, submucosal fibroid, polyp, synechiae or a T-shaped cavity. Its added value is therapeutic as well: oil-soluble contrast flushing is associated with a modest rise in subsequent conception rates in the following months.",
        "**Contraindications and cautions for HSG:** pregnancy, active pelvic infection, and recent uterine bleeding. Give **doxycycline cover in a woman with a history of pelvic inflammatory disease**, warn about cramping and give an NSAID an hour before, and remember that **cornual spasm produces a false diagnosis of proximal block** - a proximal block on HSG must be confirmed before any tube is declared occluded.",
        "**Laparoscopy with chromopertubation is the reference standard** and is preferred as the first tubal test where tubal or peritoneal disease is likely - previous pelvic inflammatory disease, previous ectopic pregnancy or pelvic surgery, suspected endometriosis, or an abnormal pelvic examination - because it both diagnoses and treats adhesions and endometriosis in one sitting. **Hysteroscopy is added when the cavity is abnormal on imaging.**",
        "**Genital tuberculosis must be actively considered in the Indian infertile woman**, particularly with a poor menstrual flow, secondary amenorrhoea, chronic pelvic pain, a beaded or rigid pipe-stem tube, cornual block, or a shrunken cavity with synechiae on HSG. Investigate with **endometrial aspirate taken in the premenstrual phase for AFB smear, mycobacterial culture and cartridge-based nucleic acid amplification testing (CBNAAT), plus histopathology for granulomas**; treat proven disease with standard antitubercular therapy under the national programme.",
        "**A tuberculin test or an interferon-gamma release assay alone must never be used to diagnose genital tuberculosis or to justify empirical antitubercular treatment** - both are markers of exposure in a population where exposure is near-universal, and empirical treatment of the infertile woman on a positive Mantoux test is a widespread and harmful practice that examiners expect you to condemn.",
        "**Transvaginal ultrasound completes the picture** in every woman: uterine size and contour, fibroids and their FIGO type, endometrial thickness, polycystic ovarian morphology (20 or more follicles per ovary or ovarian volume above 10 mL), endometrioma, hydrosalpinx and adnexal masses.",
      ],
    },
    {
      heading: "Management the family physician gives, and when to refer",
      points: [
        "**Preconception care begins at the first visit, before any result comes back:** folic acid 400 micrograms daily (5 mg if there is a previous neural tube defect, diabetes, epilepsy on valproate or carbamazepine, or a BMI above 30), rubella immunity check and vaccination with 28 days of contraception afterwards, screening for anaemia, diabetes and thyroid disease, and blood pressure measurement.",
        "**Lifestyle advice with real numbers:** intercourse every 2-3 days throughout the cycle rather than calendar timing; **complete cessation of all tobacco, which halves fecundability in both partners**; alcohol reduction; weight loss of 5-10% in an obese woman with PCOS, which alone restores ovulation in a substantial minority; weight gain if the BMI is under 19; avoidance of hot baths, saunas and prolonged laptop heat in the man; and stopping any vaginal lubricant that is not sperm-friendly.",
        "**Correct what is correctable in general practice:** treat hypothyroidism to a TSH below 2.5 mIU/L before conception, treat hyperprolactinaemia with cabergoline 0.25-0.5 mg twice weekly after excluding a macroadenoma with MRI, treat a proven genital infection and treat the partner, and optimise glycaemic control in diabetes.",
        "**Ovulation induction for WHO Group II anovulation, principally PCOS: letrozole 2.5-5 mg daily from day 3 to day 7 is now first line** and gives higher live-birth rates than clomiphene citrate in PCOS; **clomiphene citrate 50 mg daily from day 2 to day 6, increased to a maximum of 150 mg**, remains an accepted alternative. Both require follicular tracking and a limit of about 6 ovulatory cycles, and both carry a risk of multiple pregnancy that must be explained.",
        "**Metformin is an adjunct, not an ovulation-induction agent** - it is added for insulin resistance, obesity or clomiphene resistance and improves the ovulation rate in combination, but as a single agent it is inferior to letrozole for live birth.",
        "**Refer to the specialist when:** the woman is 35 or older and has not conceived in 6 months (or is 38 or older, refer at once); there is azoospermia or severe oligoasthenoteratozoospermia; tubal block, hydrosalpinx or proven genital tuberculosis; amenorrhoea, a raised FSH or a very low AMH; suspected moderate to severe endometriosis; a significant uterine anomaly, submucosal fibroid or Asherman syndrome; or **failure to conceive after 6 ovulatory cycles of correctly supervised ovulation induction**.",
        "**Know the ladder you are referring into and quote the law:** intrauterine insemination for mild male factor, cervical factor and unexplained infertility with at least one patent tube; in-vitro fertilisation for tubal factor, failed IUI, endometriosis and unexplained infertility; and ICSI for severe male factor. Practice in India is governed by the **Assisted Reproductive Technology (Regulation) Act 2021 and the Surrogacy (Regulation) Act 2021**, which mandate clinic registration, ban commercial surrogacy and gamete sale, and prohibit sex selection under the PC-PNDT Act 1994.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Female: age, duration of infertility, menstrual history including cycle length, regularity, flow and dysmenorrhoea; previous pregnancies and outcomes; contraceptive history; previous pelvic surgery, appendicectomy, ectopic pregnancy, abortion or curettage; galactorrhoea, hirsutism, weight change and thyroid symptoms.",
            "Male: previous paternity, mumps orchitis, undescended testis, testicular trauma or torsion, hernia or hydrocele surgery, urethral discharge, erectile and ejaculatory function, occupational heat exposure, tobacco, alcohol and drugs.",
        ...
        },
        {
          ...
          points: [
            "Female: BMI, waist circumference, blood pressure, thyroid, breasts for galactorrhoea, hirsutism by Ferriman-Gallwey score, acanthosis nigricans; speculum for the cervix and discharge; bimanual for uterine size, mobility, fixity, adnexal mass and nodularity in the pouch of Douglas.",
            "Male: secondary sexual characteristics, gynaecomastia, penis and meatus, testicular volume by orchidometer (normal 15-25 mL), epididymis, both vasa deferentia, and a varicocele on standing with Valsalva.",
          ],
        },
        {
          heading: "3. Investigations - the first-line panel",
          points: [
            "Semen analysis first, after 2-7 days of abstinence, reported against WHO 6th edition (2021) limits: volume 1.4 mL, concentration 16 million/mL, total 39 million, total motility 42%, progressive motility 30%, vitality 54%, normal forms 4%. Repeat an abnormal sample after 3 months.",
            "Confirmation of ovulation: mid-luteal serum progesterone drawn 7 days before the expected period, with a value above 3 ng/mL confirming ovulation; urinary LH kits or follicular tracking as alternatives.",
            "Endocrine: TSH in every woman, prolactin if there is oligomenorrhoea, amenorrhoea or galactorrhoea, and day 2-5 FSH, LH and oestradiol if ovarian reserve is in question; AMH and antral follicle count for reserve.",
            "Tubal patency: hysterosalpingography on day 6-11 in a low-risk woman, with antibiotic cover if there is a history of pelvic infection; laparoscopy with chromopertubation as the first test where tubal or peritoneal disease is likely.",
            "Transvaginal ultrasound for uterine contour, fibroids, endometrium, ovarian morphology, endometrioma and hydrosalpinx; endometrial aspirate for AFB culture, CBNAAT and histology where genital tuberculosis is suspected.",
        ...
        },
        {
          ...
          points: [
            ...
            "Preconception care: folic acid 400 micrograms daily (5 mg if there is a previous neural tube defect, diabetes, epilepsy on valproate or a BMI above 30), rubella vaccination if non-immune with 28 days of contraception after, correction of anaemia, and control of diabetes and hypertension.",
            "Lifestyle: complete cessation of tobacco in both partners, reduction of alcohol, weight loss of 5-10% if obese, weight gain if BMI is under 19, and avoidance of scrotal heat in the man.",
            "Correct treatable endocrine causes: levothyroxine to a TSH below 2.5 mIU/L, cabergoline 0.25-0.5 mg twice weekly for hyperprolactinaemia after excluding a macroadenoma, and treatment of any proven genital infection in both partners.",
            "Ovulation induction if anovulatory with patent tubes and a normal semen analysis: letrozole 2.5-5 mg on days 3-7 as first line, or clomiphene citrate 50-150 mg on days 2-6, with follicular tracking, a maximum of about 6 ovulatory cycles and counselling about multiple pregnancy; metformin as an adjunct in insulin resistance.",
            "Address the psychosocial dimension: state that infertility is not the woman's fault, involve the family where the couple wishes, screen for depression and anxiety, and warn against unregulated and expensive treatments.",
          ],
        },
        {
          heading: "5. Referral and the treatment ladder",
          points: [
            "Refer for azoospermia or severe oligoasthenoteratozoospermia, tubal block or hydrosalpinx, proven genital tuberculosis, a raised FSH or very low AMH, suspected significant endometriosis, uterine anomaly or Asherman syndrome, and failure after 6 supervised ovulatory cycles.",
            ...
            "The ladder: intrauterine insemination for mild male factor, cervical factor and unexplained infertility with at least one patent tube; IVF for tubal factor, endometriosis, failed IUI and unexplained infertility; ICSI for severe male factor; donor gametes or adoption where indicated.",
            "Practice is governed by the Assisted Reproductive Technology (Regulation) Act 2021 and the Surrogacy (Regulation) Act 2021, with sex selection prohibited under the PC-PNDT Act 1994.",
          ],
        },
      ],
      mustDraw: [
    ...
    },
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            "Endometrial aspirate or curettage taken in the premenstrual (late luteal) phase, sent for AFB smear, mycobacterial culture, cartridge-based nucleic acid amplification testing and histopathology for caseating granulomas - culture or CBNAAT positivity or granulomas constitute proof.",
            "Hysterosalpingography: beaded or rigid pipe-stem tubes, cornual block, tobacco-pouch appearance, calcification, a shrunken T-shaped or irregular cavity, and intravasation of contrast; HSG is suggestive, never diagnostic, and carries a risk of reactivating disease.",
            "Laparoscopy with hysteroscopy: tubercles on the peritoneum and tubes, dense adhesions, beaded tubes with a hydrosalpinx, and a small pale cavity with synechiae; peritoneal biopsy and peritoneal fluid for culture and CBNAAT.",
        ...
        },
        {
          heading: "Management",
          points: [
            "Standard antitubercular therapy under the National Tuberculosis Elimination Programme: two months of isoniazid, rifampicin, pyrazinamide and ethambutol, followed by four months of isoniazid, rifampicin and ethambutol, with weight-band fixed-dose combinations and adherence support.",
            ...
            "In-vitro fertilisation after completion of treatment is the mainstay for those with tubal disease and a preserved cavity; a severely damaged endometrium carries a poor prognosis, and surrogacy or adoption is discussed honestly.",
  ...
  sections: [
    {
      ...
      points: [
        "**Primary dysmenorrhoea is cyclical menstrual pain with no identifiable pelvic pathology**, and it affects 50-90% of adolescent and young women, being the commonest single cause of recurrent short-term absence from school and work in this age group.",
        "**The mechanism is prostaglandin-mediated.** After ovulation, progesterone withdrawal destabilises endometrial lysosomes, arachidonic acid is released, and **prostaglandin F2 alpha and prostaglandin E2 cause intense, dysrhythmic myometrial contractions with intrauterine pressures above 150-200 mmHg**, which occlude the endometrial vessels and cause ischaemic, colicky pain. This explains both the symptoms and why NSAIDs work.",
        "**The clinical picture is diagnostic in itself:** onset 6-24 months after menarche, once ovulatory cycles are established; suprapubic cramping pain radiating to the lower back and inner thighs; **the pain starts a few hours before or with the onset of flow and lasts 8-72 hours**; and it is often accompanied by nausea, vomiting, diarrhoea, headache and fatigue, all prostaglandin effects.",
        "**Examination is normal** - and in an unmarried adolescent in Indian practice an abdominal examination with a careful history is sufficient; a vaginal examination is neither necessary nor appropriate for a typical primary picture, and this restraint is itself examinable.",
        "**NSAIDs are first-line and must be started before or at the very onset of pain, then taken regularly for 2-3 days rather than as needed** - mefenamic acid 500 mg three times a day, ibuprofen 400 mg three times a day, or naproxen 500 mg followed by 250 mg every 8 hours, all taken after food, and avoided in peptic ulcer disease and asthma sensitive to aspirin.",
        "**Hormonal suppression is second-line and works by preventing ovulation and thinning the endometrium:** the combined oral contraceptive, taken cyclically or continuously to skip withdrawal bleeds; the levonorgestrel intrauterine system; depot medroxyprogesterone acetate; or continuous oral progestogens. Check WHO Medical Eligibility Criteria before any combined method - **migraine with aura is Category 4 at any age**.",
        "**Non-drug measures that genuinely help and cost nothing:** local heat applied to the lower abdomen, which is as effective as NSAIDs in trial data; regular aerobic exercise; smoking cessation; and adequate sleep. Reassurance that the pain is real, physiological and treatable matters in a setting where menstrual pain is still dismissed.",
      ],
    },
    {
      heading: "Secondary dysmenorrhoea: recognising it and its causes",
      points: [
        "**Secondary dysmenorrhoea is menstrual pain caused by identifiable pelvic pathology**, and the pattern differs from primary dysmenorrhoea in ways that can be elicited entirely by history.",
        "**Features that point to a secondary cause:** onset years after menarche, typically after the age of 25; **pain that begins several days before the flow and persists after it has stopped**; progressive worsening cycle on cycle; deep dyspareunia; heavy or irregular bleeding; chronic non-cyclical pelvic pain; failure of NSAIDs and the combined pill; and an abnormal pelvic examination.",
        "**The causes to enumerate:** endometriosis, adenomyosis, uterine fibroids (especially submucosal and degenerating ones), chronic pelvic inflammatory disease with adhesions, an intrauterine copper device, endometrial polyps, cervical stenosis after cone biopsy or cautery, pelvic congestion syndrome, and **obstructive Mullerian anomalies in the adolescent** such as an imperforate hymen, transverse vaginal septum or a non-communicating rudimentary horn.",
        "**Severe dysmenorrhoea in an adolescent who has never menstruated, with a cyclical pain and a lower abdominal mass, is cryptomenorrhoea until proved otherwise** - examine the vulva for a bulging bluish imperforate hymen, and arrange ultrasound for haematocolpos and haematometra.",
        "**Examination in secondary dysmenorrhoea is the deciding step**: an enlarged, irregular, firm uterus suggests fibroids; a uniformly bulky, globular, tender uterus suggests adenomyosis; **a fixed retroverted uterus with tender nodules in the pouch of Douglas and along the uterosacral ligaments suggests endometriosis**; and generalised tenderness with cervical motion tenderness and a fixed adnexal mass suggests chronic pelvic inflammatory disease.",
        "**Investigate secondary dysmenorrhoea with transvaginal ultrasound as the first test**, adding a high vaginal and endocervical swab where infection is suspected, a pregnancy test in every case, and MRI where adenomyosis or deep infiltrating endometriosis is suspected and the ultrasound is inconclusive.",
      ],
    },
    {
      heading: "Endometriosis: pathology and presentation",
      points: [
        "**Endometriosis is the presence of functioning endometrial glands and stroma outside the uterine cavity**, most often on the ovaries, uterosacral ligaments, pouch of Douglas, pelvic peritoneum, rectovaginal septum and bladder. It affects **6-10% of women of reproductive age, but 30-50% of women investigated for infertility and up to 70-80% of women with chronic pelvic pain**.",
        "**Sampson's theory of retrograde menstruation** is the dominant explanation - viable endometrial fragments reflux along the tubes and implant - supported by the pelvic distribution of lesions and the association with outflow obstruction. It is supplemented by **coelomic metaplasia** (explaining disease in women without menstruation and at distant sites), **lymphatic and haematogenous spread** (explaining pleural and umbilical deposits), and by permissive immune dysfunction and genetic susceptibility.",
        "**The cardinal symptoms are cyclical and progressive**: secondary dysmenorrhoea beginning days before the period, **deep dyspareunia**, chronic pelvic pain, **cyclical dyschezia and dyskinesia (painful defaecation and painful micturition during menses)**, cyclical rectal bleeding or haematuria with deep infiltrating disease, and infertility. Fatigue is common and under-reported.",
        "**Symptom severity correlates poorly with disease stage** - a woman with a few peritoneal deposits may be crippled by pain while a large endometrioma is silent - and saying this sentence is worth a mark, because it is the reason not to withhold treatment while awaiting a staging laparoscopy.",
        "**Signs to look for:** a fixed retroverted uterus with restricted mobility, tender thickened nodular uterosacral ligaments best felt on rectovaginal or premenstrual examination, tenderness and nodularity in the pouch of Douglas, an adnexal mass (endometrioma, the chocolate cyst, filled with altered blood), and bluish nodules visible in the posterior fornix in rectovaginal disease.",
        "**Diagnosis no longer requires laparoscopy before treatment begins.** ESHRE 2022 accepts a clinical and imaging diagnosis: transvaginal ultrasound reliably shows the ground-glass endometrioma and, in experienced hands, deep infiltrating nodules, while MRI maps rectovaginal, bowel and ureteric disease. **Laparoscopy with histological confirmation remains the reference standard** and is done when imaging is negative but symptoms persist, or when surgery is being undertaken anyway.",
        "**CA-125 is raised in moderate to severe endometriosis but is neither sensitive nor specific** - it also rises in pelvic infection, fibroids, pregnancy, adenomyosis and ovarian malignancy - and it must not be used to diagnose or to exclude endometriosis. A negative test is worthless and a positive one is misleading.",
      ],
    },
    {
      heading: "Managing endometriosis, and endometriosis with infertility",
      points: [
        "**Pain and fertility are two separate problems with two different treatments, and the single commonest error is to treat the infertile woman with ovarian suppression** - suppressing ovulation for six months cannot improve fertility, it only delays her further. Say this explicitly.",
        "**For pain, first-line medical treatment is an NSAID plus a hormonal method:** the combined oral contraceptive taken continuously to induce amenorrhoea; **dienogest 2 mg daily**, an oral progestogen with good evidence and an acceptable side-effect profile; medroxyprogesterone acetate 10-30 mg daily or 150 mg depot every 3 months; or the **levonorgestrel intrauterine system**, which is particularly effective for rectovaginal disease and for recurrence after surgery.",
        "**GnRH agonists (leuprolide 3.75 mg IM monthly, goserelin 3.6 mg subcutaneously monthly) are second-line and are limited to 6 months, always with add-back therapy** - low-dose oestrogen with a progestogen, or tibolone - because of vasomotor symptoms and a loss of bone mineral density of about 6% in six months. They are not a long-term solution and they are not a fertility treatment.",
        "**Surgery is laparoscopic**: excision or ablation of peritoneal deposits, adhesiolysis, and **cystectomy with excision of the endometrioma capsule rather than simple drainage**, since drainage alone has a recurrence rate above 80%. Excision of an endometrioma reduces ovarian reserve, so the surgeon must weigh the pain benefit against AMH loss in a woman who still wants children.",
        "**Definitive surgery - total hysterectomy with bilateral salpingo-oophorectomy and excision of all visible disease - is offered only when the family is complete, pain is refractory and the woman has been counselled about surgical menopause**; hormone therapy is then given, with a progestogen alongside oestrogen to reduce the risk of reactivating residual disease.",
        "**Where endometriosis coexists with infertility**, options are surgical ablation or excision of minimal to mild disease (which produces a small but real increase in spontaneous pregnancy rates), and referral for assisted reproduction - **intrauterine insemination with ovarian stimulation for minimal to mild disease, and IVF for moderate to severe disease, tubal damage or failed conservative treatment**. The Endometriosis Fertility Index helps predict spontaneous conception after surgery.",
        "**Adenomyosis is the near neighbour that must be distinguished**: endometrial glands and stroma within the myometrium, producing a **symmetrically bulky, globular, tender uterus** with heavy painful periods in a parous woman in her late thirties or forties, and a junctional zone thickness above 12 mm on MRI. **The LNG-IUS is first-line treatment**, with GnRH agonists, dienogest or uterine artery embolisation as alternatives, and hysterectomy as the definitive cure.",
      ],
    },
    {
      heading: "Uterine fibroids: classification, presentation and complications",
      points: [
        "**A leiomyoma is a benign, monoclonal tumour of uterine smooth muscle with a surrounding pseudocapsule, whose growth is oestrogen and progesterone dependent** - which is why fibroids grow in pregnancy and regress after the menopause. Around 40-70% carry a MED12 gene mutation.",
        "**They are the commonest pelvic tumour in women**, clinically apparent in 20-40% of women of reproductive age and found in up to 70-80% of uteri at pathological examination by age 50, with an earlier onset, larger size and higher symptom burden in Indian and African women.",
        "**The FIGO leiomyoma subclassification (types 0-8) is what examiners want**: types 0, 1 and 2 are submucosal (0 entirely intracavitary and pedunculated, 1 with less than 50% intramural extension, 2 with 50% or more), types 3-5 are intramural or transmural, types 6 and 7 are subserosal, and type 8 is other (cervical, parasitic or broad ligament). **Only submucosal fibroids reliably cause heavy menstrual bleeding**, which is why the classification matters clinically and not just descriptively.",
        "**50-80% of fibroids are asymptomatic.** When they cause symptoms these are: heavy and prolonged menstrual bleeding with iron deficiency anaemia; pressure effects - urinary frequency, urgency or retention, constipation and tenesmus, backache and leg oedema from venous compression; abdominal swelling; dysmenorrhoea; and subfertility or recurrent miscarriage where the cavity is distorted.",
        "**Examination finds a firm, non-tender, irregular mass arising from the pelvis that moves with the cervix** - the classic sign is that the mass cannot be felt separately from the uterus and cervical movement is transmitted to it, distinguishing it from an ovarian mass.",
        "**Degenerations to name:** hyaline (commonest), cystic, **red or carneous degeneration, which typically occurs in the second trimester of pregnancy and presents with acute localised pain, fever and vomiting and is managed conservatively with analgesia and rest**, calcific (the womb-stone of the postmenopausal woman), fatty, and myxoid. **Sarcomatous change is rare, occurring in 0.1-0.3%**, and is suspected when a fibroid grows rapidly or grows at all after the menopause.",
        "**Fibroids in pregnancy** are associated with miscarriage, malpresentation, obstructed labour if a lower-segment fibroid is present, preterm labour, placental abruption, and postpartum haemorrhage from poor retraction; **myomectomy during caesarean section is generally avoided** because of the risk of torrential haemorrhage, except for a pedunculated subserosal fibroid.",
      ],
    },
    {
      heading: "Treating fibroids, and the contraceptive decisions they force",
      points: [
        "**An asymptomatic fibroid is not a reason to operate.** Expectant management with annual review, a haemoglobin check and pelvic examination is correct for the woman with small asymptomatic fibroids, and it is what an examiner wants to hear before any surgical answer.",
        "**Medical treatment controls the bleeding, not the fibroid:** tranexamic acid 1 g three or four times daily on bleeding days, mefenamic acid 500 mg three times daily, the combined oral contraceptive, oral progestogens, and iron replacement, which is part of treatment and not an afterthought.",
        "**The LNG-IUS is highly effective for fibroid-related heavy menstrual bleeding, but only when the uterine cavity is not distorted** - expulsion rates are high in a cavity deformed by submucosal fibroids. **WHO Medical Eligibility Criteria are explicit: uterine fibroids without distortion of the uterine cavity are Category 1 for both the copper and the levonorgestrel intrauterine device, while fibroids with distortion of the cavity are Category 4.** Knowing that this single anatomical fact flips the category from 1 to 4 is exactly the level of detail that earns the mark.",
        "**GnRH agonists with add-back therapy are used for 3-6 months only, before surgery** - they shrink fibroid volume by 35-60%, correct anaemia and can convert an abdominal operation into a vaginal or laparoscopic one; fibroids regrow within months of stopping, so they are never definitive treatment.",
        "**Surgical options are chosen by the woman's fertility wishes and the fibroid's position:** hysteroscopic resection for FIGO type 0-2 submucosal fibroids, which often cures the bleeding outright; **myomectomy, open or laparoscopic, for the woman who wants to preserve fertility**, with counselling about adhesions, recurrence in 15-30% and the possibility of caesarean delivery if the cavity is breached; and **hysterectomy as the definitive cure for the woman who has completed her family**.",
        "**Uterine artery embolisation** shrinks fibroids by 40-60% and preserves the uterus, but is not recommended for a woman who wants to conceive, and it can be followed by post-embolisation syndrome, fibroid expulsion and, rarely, premature ovarian insufficiency. MRI-guided focused ultrasound is an alternative where available.",
        "**Refer urgently rather than reassure when the picture does not fit**: a rapidly enlarging mass, growth after the menopause, an irregular solid mass with ascites, weight loss, or a raised CA-125 in a postmenopausal woman - a leiomyosarcoma or an ovarian malignancy must be excluded, and morcellation of an unrecognised sarcoma disseminates it.",
      ],
    },
  ],
  tables: [
  ...
  theory: [
    {
      ...
      answer: [
        ...
        },
        {
          ...
          points: [
            "Abdominal examination for a mass or localised tenderness; speculum for bluish nodules in the posterior fornix; bimanual for a fixed retroverted uterus, nodular tender uterosacral ligaments, pouch of Douglas nodules and an adnexal mass.",
            ...
            "Laparoscopy with histological confirmation is the reference standard and allows staging by the revised ASRM system and simultaneous treatment, but a clinical and imaging diagnosis is now accepted and treatment must not be delayed for it.",
            "Do not order CA-125 to diagnose or exclude endometriosis; it is neither sensitive nor specific.",
            "Complete the infertility work-up in parallel: partner semen analysis, mid-luteal progesterone, TSH, and tubal assessment - preferring laparoscopy with chromopertubation over HSG here, because tubal and peritoneal disease is likely.",
          ],
        },
        {
          ...
          points: [
            ...
            "Hormonal suppression: continuous combined oral contraceptive to induce amenorrhoea after checking WHO Medical Eligibility Criteria, dienogest 2 mg daily, medroxyprogesterone acetate, or the levonorgestrel intrauterine system, which is Category 1 in endometriosis.",
      ...
      answer: [
        {
          heading: "Assessment",
          points: [
            "Confirm the symptoms are due to the fibroids: heavy menstrual bleeding, pressure effects, dysmenorrhoea, subfertility or recurrent miscarriage; 50-80% of fibroids are asymptomatic and need no treatment.",
        ...
        },
        {
          ...
          points: [
            ...
            "The levonorgestrel intrauterine system is effective for bleeding but only where the cavity is undistorted - WHO Medical Eligibility Criteria make fibroids without cavity distortion Category 1 and fibroids with cavity distortion Category 4 - and it is contraceptive, so it suits the woman deferring pregnancy rather than seeking it now.",
        ...
        },
        {
          ...
          points: [
            ...
            "Myomectomy, abdominal or laparoscopic, for intramural and subserosal fibroids that are symptomatic or distort the cavity; counsel about blood loss, possible conversion to hysterectomy with informed consent taken beforehand, adhesion formation, recurrence in 15-30%, and delivery by caesarean section if the cavity is entered.",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**HPV DNA testing** detects the high-risk genotypes themselves and has a sensitivity of 90-95% for CIN2+ with a **negative predictive value above 99%**, which is what allows a screening interval of 5-10 years after a negative test; it is objective, can be run on a **self-collected vaginal sample**, and is the test WHO recommends as primary wherever it can be afforded. The trade-off is specificity, since it is positive in many young women with transient infection, so it is **not used below age 30** and positives are triaged, in India usually by VIA or cytology, before colposcopy.",
    ...
    },
    {
      ...
      points: [
        ...
        "Pregnancy is not a contraindication - screening and colposcopy are safe, and pregnancy is often the only time a rural Indian woman reaches a health facility - but **endocervical curettage is forbidden in pregnancy** and treatment of precancer is deferred until 6 weeks postpartum. Equally, **neither prior HPV vaccination nor prior sterilisation is a reason to stop screening**, and that is the single commonest counselling error made in the programme.",
      ],
    },
    {
      ...
      points: [
        ...
        "**Large loop excision of the transformation zone (LLETZ, also called LEEP)** is used for everything else - type 2 or 3 transformation zones, large lesions, suspected glandular disease, recurrence after ablation - and has the great advantage of providing a specimen so that occult microinvasion is not missed. **Cold knife conisation** is reserved for suspected microinvasion, adenocarcinoma in situ or disease deep in the canal, and **hysterectomy is never the primary treatment for CIN**.",
  ...
  sections: [
    ...
    },
    {
      ...
      points: [
        ...
        "**Gabapentin 300-900 mg at night** is particularly useful for night sweats and clonidine has modest efficacy with troublesome side effects, while **cognitive behavioural therapy and clinical hypnosis have good trial evidence** and no drug interaction; phytoestrogens and black cohosh have inconsistent evidence, are not standardised, and black cohosh carries a rare hepatotoxicity warning - say this plainly rather than dismissing the question.",
    ...
    },
    {
      ...
      points: [
        "**Indications are narrow and specific:** moderate to severe vasomotor symptoms affecting quality of life; genitourinary syndrome of menopause (local therapy); **premature ovarian insufficiency and early menopause, where hormone therapy is replacement and is given at least until the average age of natural menopause, about 51 years**; and prevention of osteoporosis in a symptomatic woman under 60 who cannot take alternatives. MHT is **not** started for primary or secondary prevention of cardiovascular disease, or for dementia prevention.",
        "**The window of opportunity: begin under the age of 60 or within 10 years of the menopause.** In that window the benefit-risk balance is favourable and cardiovascular risk is not increased; started later, in a woman with established atheroma, the same therapy raises coronary and stroke risk - the timing hypothesis that reconciles the WHI with the observational data preceding it. Outside the window, non-hormonal treatment is the answer, though local vaginal oestrogen remains available at any age. **Tibolone 2.5 mg** is a bleed-free alternative within the window, helping flushes, libido and bone, but it raises stroke risk over 60. On **duration** there is **no arbitrary limit and no obligation to stop at 5 years**: continue at the lowest effective dose with an **annual review** of symptoms, blood pressure, weight, breast examination and due screening, and stop by tapering rather than abruptly.",
        ...
        "**Route matters.** Oral oestrogen undergoes first-pass hepatic metabolism and roughly doubles the risk of venous thromboembolism; **transdermal oestradiol (patch 25-50 micrograms twice weekly, or gel) does not increase VTE risk and is preferred in obesity, migraine, hypertriglyceridaemia, gallbladder disease, hypertension and any thrombotic risk**. Typical oral doses are oestradiol valerate 1-2 mg or conjugated equine oestrogen 0.3-0.625 mg daily. **Micronised progesterone 100 mg daily continuously, or 200 mg for 12-14 days sequentially, is the preferred progestogen** because it is metabolically neutral and appears not to carry the breast and thrombotic excess of medroxyprogesterone acetate; dydrogesterone is a reasonable alternative, and the **LNG-IUS is licensed for endometrial protection** and conveniently provides contraception in the perimenopause.",
        "**For genitourinary symptoms alone the route is local, not systemic:** estriol cream 0.5-1 mg or a 10 microgram estradiol pessary, daily for 2 weeks and then twice weekly, produces negligible systemic absorption, **needs no added progestogen and can be continued indefinitely**, and may be used with specialist agreement in many breast cancer survivors. Its benefit stops when the treatment stops, so it is continued as long as the symptoms would otherwise persist - which, since GSM is progressive, usually means for life.",
        ...
        "**Absolute contraindications:** undiagnosed abnormal vaginal bleeding, known or suspected breast cancer or other oestrogen-dependent malignancy, current or past venous thromboembolism or known thrombophilia, active or recent arterial thromboembolic disease (angina, myocardial infarction, stroke), active liver disease with deranged function, untreated endometrial hyperplasia, porphyria cutanea tarda and pregnancy. Relative cautions - migraine with aura, gallstones, a strong family history of breast cancer, uncontrolled hypertension and fibroids - argue for the transdermal route rather than for refusing treatment, and the reflex refusal of MHT to any woman with a caution is the commonest reason symptomatic Indian women go untreated.",
      ],
    },
  ],
  tables: [
