  ...
  sections: [
    {
      ...
      points: [
        "**Cirrhosis is a histological diagnosis** - diffuse hepatic fibrosis with conversion of normal architecture into structurally abnormal regenerative nodules - but in practice it is diagnosed clinically from stigmata of chronic liver disease, an ultrasound showing a coarse shrunken liver with a nodular margin, splenomegaly, collaterals and a low platelet count.",
        "The single most useful conceptual split in the exam is **compensated versus decompensated cirrhosis**: compensated cirrhosis may be silent for years with a median survival over 12 years, whereas decompensation - defined by the appearance of **ascites, variceal bleeding, hepatic encephalopathy or jaundice** - drops median survival to about 2 years and is the trigger for transplant referral.",
        "Cirrhosis has two consequences, and every complication belongs to one of them: **portal hypertension** (ascites, varices, splenomegaly, hypersplenism, portosystemic encephalopathy, hepatorenal and hepatopulmonary syndromes) and **hepatocellular failure** (jaundice, coagulopathy, hypoalbuminaemia, gynaecomastia, testicular atrophy, sepsis susceptibility).",
        "Indian aetiology has shifted and this is examined: **alcohol-related liver disease is now the leading cause in most Indian series (about 30-50 percent)**, followed by **metabolic dysfunction-associated steatotic liver disease (MASLD, formerly NAFLD)** which affects roughly a quarter of Indian adults and is rising with diabetes and central obesity, then hepatitis B (about 10-15 percent) and hepatitis C.",
        "Do not forget the causes that are curable or specifically treatable and are therefore examiner favourites: **autoimmune hepatitis, Wilson disease in any cirrhotic under 40, haemochromatosis, primary biliary cholangitis, Budd-Chiari syndrome and cardiac (congestive) hepatopathy**. Wilson disease is asked about in every viva - look for the Kayser-Fleischer ring, low serum ceruloplasmin and high 24-hour urinary copper.",
        "**Acute-on-chronic liver failure (ACLF)** is acute hepatic decompensation with organ failure in a patient with known or unknown chronic liver disease, precipitated in India most often by an alcohol binge, reactivation of hepatitis B, or superimposed hepatitis A or E; it carries a 28-day mortality above 30 percent and needs a tertiary centre.",
      ],
    },
    {
      heading: "Clinical assessment and severity scoring",
      points: [
        "History must quantify **alcohol in grams per day and years of drinking** (one 30 mL peg of 42 percent spirit is about 10 g of ethanol; more than 40-60 g/day in men and 20 g/day in women for more than 10 years is the usual cirrhotic threshold), and must ask about jaundice, blood transfusion, injection or tattoo exposure, unsafe sex, family history of liver disease, diabetes, obesity, and every drug and herbal or ayurvedic preparation taken.",
        "**Anti-tuberculosis therapy is a specific Indian history point** - isoniazid, rifampicin and pyrazinamide can cause drug-induced liver injury and can unmask or decompensate underlying chronic liver disease, and a cirrhotic on ATT needs a modified regimen and close monitoring.",
        "Look for the stigmata and be able to list them: **spider naevi in the distribution of the superior vena cava, palmar erythema, leuconychia, clubbing, Dupuytren contracture, parotid enlargement, gynaecomastia, loss of axillary and pubic hair, testicular atrophy, caput medusae, asterixis and fetor hepaticus**.",
        "Examine the abdomen for shifting dullness and fluid thrill (**shifting dullness needs about 1500 mL of ascites, ultrasound detects about 100 mL**), for a firm nodular liver edge, splenomegaly, and for a venous hum (Cruveilhier-Baumgarten murmur) over recanalised umbilical veins.",
        "**Child-Turcotte-Pugh score** grades severity from five variables - bilirubin, albumin, INR, ascites and encephalopathy - giving class A (5-6), B (7-9) and C (10-15); it predicts operative mortality and is the score usually asked for in the written paper.",
        "**MELD score** (bilirubin, INR, creatinine, and sodium in MELD-Na) is the objective score used for transplant listing and prioritisation; **MELD of 15 or more, or any first decompensation, is the trigger to refer for transplant assessment**.",
        "Baseline work-up: complete blood count (look for the **thrombocytopenia of hypersplenism**, which is often the earliest clue), liver function tests, INR, renal function and electrolytes, viral markers (HBsAg, anti-HCV), ultrasound abdomen with portal vein Doppler, alpha-fetoprotein, and an upper GI endoscopy to screen for varices.",
      ],
    },
    {
      heading: "Ascites: diagnosis, SAAG and stepwise treatment",
      points: [
        "**Every patient with new ascites must have a diagnostic paracentesis**, even if the cause seems obvious - it is safe with any INR (there is no INR or platelet cut-off that contraindicates a diagnostic tap), and it is the only way to detect infection early.",
        "Send ascitic fluid for **cell count with differential, albumin (with a simultaneous serum albumin), protein, Gram stain, culture in blood culture bottles at the bedside, adenosine deaminase and cytology** where tuberculosis or malignancy is possible.",
        "**Serum-ascites albumin gradient (SAAG) = serum albumin minus ascitic albumin**. A **SAAG of 1.1 g/dL or more means portal hypertension** (cirrhosis, cardiac failure, Budd-Chiari, alcoholic hepatitis) with about 97 percent accuracy; a SAAG below 1.1 g/dL means a non-portal cause (tuberculous peritonitis, peritoneal carcinomatosis, pancreatic ascites, nephrotic syndrome).",
        "First-line treatment is **salt restriction to about 2 g sodium (5 g salt) per day plus spironolactone 100 mg with furosemide 40 mg each morning, in that 100:40 ratio**, escalated every 3-5 days to a maximum of spironolactone 400 mg and furosemide 160 mg. Fluid restriction is needed only if serum sodium falls below 125 mmol/L.",
        "**Target weight loss is 0.5 kg/day without peripheral oedema and up to 1 kg/day with oedema**; faster diuresis precipitates azotaemia, hyponatraemia and encephalopathy. Monitor weight, urine output, electrolytes and creatinine.",
        "**Tense ascites is treated by large-volume paracentesis, with 6-8 g of intravenous albumin per litre of fluid removed whenever more than 5 litres are drained** - this prevents post-paracentesis circulatory dysfunction, renal failure and hyponatraemia.",
        "**NSAIDs, aminoglycosides and ACE inhibitors or ARBs must be avoided in a cirrhotic with ascites** because they precipitate acute kidney injury and diuretic resistance; this negative prescribing point is worth a mark in almost every ascites question.",
        "Refractory ascites (not responding to maximal diuretics, or diuretic-intolerant) is managed with serial large-volume paracentesis plus albumin, and by referral for **TIPS (transjugular intrahepatic portosystemic shunt)** or transplantation; beta blockers are usually withdrawn in refractory ascites.",
      ],
    },
    {
      heading: "Spontaneous bacterial peritonitis and infection in cirrhosis",
      points: [
        "**SBP is infection of pre-existing ascitic fluid without any intra-abdominal surgically treatable source, diagnosed by an ascitic polymorphonuclear (neutrophil) count of 250 cells/mm3 or more**, irrespective of whether the culture grows an organism - culture-negative neutrocytic ascites is treated identically.",
        "It must be actively looked for, because up to a third of patients have no abdominal pain at all: **suspect SBP in any cirrhotic with ascites who develops fever, abdominal pain or tenderness, new or worsening encephalopathy, unexplained renal impairment, hypotension, or simply deteriorates without explanation**.",
        "The commonest organisms are gut-derived Gram-negatives - **Escherichia coli and Klebsiella** - and streptococci; a polymicrobial growth with a high protein and low glucose and multiple organisms suggests secondary bacterial peritonitis from a perforated viscus, which needs imaging and surgery, not antibiotics alone.",
        "**Treat with intravenous cefotaxime 2 g eight-hourly (or ceftriaxone 2 g daily) for 5-7 days**, adjusted to local antibiogram; in India, where community and hospital resistance to third-generation cephalosporins is high, nosocomial SBP is often treated with piperacillin-tazobactam or a carbapenem.",
        "**Give intravenous albumin 1.5 g/kg on day 1 and 1 g/kg on day 3** in patients with creatinine above 1 mg/dL, blood urea above 30 mg/dL or bilirubin above 4 mg/dL - albumin reduces hepatorenal syndrome and cuts mortality from about 30 percent to 10 percent, and this is a very commonly asked number.",
        "**Secondary prophylaxis after an episode of SBP is lifelong norfloxacin 400 mg daily** (or ciprofloxacin, or co-trimoxazole where quinolone resistance is high) until the ascites resolves or the patient is transplanted; primary prophylaxis is given during an upper GI bleed (ceftriaxone 1 g daily for 7 days) and in patients with ascitic protein below 1.5 g/dL with advanced disease.",
        "Cirrhotics are functionally immunosuppressed: **urinary tract infection, pneumonia, cellulitis and bacteraemia are all commoner and all precipitate encephalopathy and hepatorenal syndrome**, so a septic screen is part of every decompensation work-up.",
      ],
    },
    {
      heading: "Hepatic encephalopathy",
      points: [
        "Hepatic encephalopathy is **reversible neuropsychiatric dysfunction in liver failure or portosystemic shunting**, driven mainly by ammonia produced by colonic urease-splitting bacteria bypassing hepatic detoxification, with astrocyte swelling, inflammation and altered neurotransmission.",
        "**West Haven grading**: grade 1 - trivial lack of awareness, shortened attention, altered sleep rhythm; grade 2 - lethargy, disorientation to time, obvious personality change, asterixis; grade 3 - somnolent but rousable, gross disorientation; grade 4 - coma. **Covert (minimal) encephalopathy** is detected only on psychometric testing and matters because it causes road traffic accidents and falls.",
        "**Encephalopathy is almost never spontaneous - always hunt the precipitant.** The examinable list is: gastrointestinal bleeding, infection including SBP, constipation, dehydration and over-diuresis, electrolyte disturbance (especially hypokalaemia and hyponatraemia), a high protein load, sedatives and benzodiazepines, alcohol binge, renal failure, and portosystemic shunt or TIPS.",
        "**Serum ammonia is neither necessary for diagnosis nor useful for monitoring** - the diagnosis is clinical and the treatment is directed at the precipitant. A normal ammonia in a patient who looks encephalopathic does not exclude it, and a raised one does not prove it.",
        "**Lactulose 30 mL two or three times daily, titrated to 2-3 soft stools per day, is first-line**; it acidifies the colon, converting ammonia to non-absorbable ammonium and acting as an osmotic laxative. In grade 3-4 encephalopathy give it as a retention enema (300 mL lactulose in 700 mL water).",
        "**Add rifaximin 550 mg twice daily** for patients who breakthrough on lactulose or after a second episode; rifaximin plus lactulose reduces recurrence and hospitalisation better than lactulose alone. L-ornithine L-aspartate and branched-chain amino acids are used adjunctively in Indian practice.",
        "**Protein must not be restricted.** The old teaching of protein restriction is wrong and is a favourite negative-marking point: cirrhotics are catabolic and sarcopenic and need **1.2-1.5 g/kg/day of protein**, spread over frequent small meals with a **late-evening carbohydrate-protein snack** to prevent the overnight fasting catabolic state.",
      ],
    },
    {
      heading: "Long-term care, surveillance and referral",
      points: [
        "**Complete abstinence from alcohol is the single most effective intervention** in alcohol-related cirrhosis and can move a Child C patient back to Child B; support it with brief interventions, family involvement, de-addiction referral, thiamine 100 mg daily, and treatment of coexisting depression. Baclofen is the safest anti-craving drug in cirrhosis.",
        "**Screen every cirrhotic for hepatocellular carcinoma with ultrasound abdomen every 6 months, with or without alpha-fetoprotein** - HCC incidence is 1-6 percent per year in cirrhosis, and only surveillance-detected tumours are small enough to cure.",
        "**Screen for varices by upper GI endoscopy at diagnosis**; if none are found repeat in 2-3 years, if small varices repeat in 1-2 years, and treat medium or large varices with non-selective beta blockade (propranolol or carvedilol) or endoscopic band ligation as primary prophylaxis.",
        "**Vaccinate against hepatitis A and B, influenza annually and pneumococcus**, treat hepatitis B with tenofovir and hepatitis C with direct-acting antivirals irrespective of fibrosis stage - free through the National Viral Hepatitis Control Programme - and treat diabetes, dyslipidaemia and obesity in MASLD-related disease.",
        "Prescribe carefully: **paracetamol up to 2 g/day is the safest analgesic in cirrhosis** (NSAIDs and opioids are not), avoid sedatives and benzodiazepines, halve doses of drugs with high first-pass metabolism, and remember that statins are safe and probably beneficial in compensated cirrhosis.",
        "**Refer for liver transplant assessment at the first decompensation, or MELD 15 or more, or Child-Pugh B or C**, and refer earlier rather than later since deceased-donor waiting lists and living-donor evaluation both take time.",
        "Discuss prognosis honestly, plan for advance care in Child C patients unsuitable for transplant, and support the family - decompensated cirrhosis is a terminal illness in which palliative symptom control of ascites, cramps, itch and encephalopathy is legitimate family medicine.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Quantify the alcohol intake in grams per day and years, and document the date of last drink and any withdrawal symptoms.",
            "Ask about jaundice, haematemesis, melaena, altered sleep or behaviour, reduced urine output, drug and herbal intake, and any NSAID use, which commonly precipitates renal failure.",
            "Look for stigmata of chronic liver disease - spider naevi, palmar erythema, gynaecomastia, testicular atrophy, parotid enlargement, Dupuytren contracture, caput medusae, asterixis and fetor hepaticus.",
            "Confirm ascites by shifting dullness and fluid thrill, measure abdominal girth and weight as the baseline for monitoring, and examine for splenomegaly, a nodular liver and any localised tenderness.",
            "Grade any encephalopathy by the West Haven criteria and record the Glasgow Coma Scale if drowsy.",
          ],
        },
        {
          heading: "2. Investigations, including diagnostic paracentesis",
          points: [
            "Diagnostic paracentesis is mandatory and safe regardless of INR or platelet count; send cell count and differential, albumin with a paired serum albumin, total protein, Gram stain, culture inoculated into blood culture bottles at the bedside, ADA and cytology.",
            "Calculate the serum-ascites albumin gradient: 1.1 g/dL or more confirms portal hypertension, less than 1.1 g/dL points to tuberculous or malignant peritoneal disease.",
            "An ascitic neutrophil count of 250/mm3 or more establishes spontaneous bacterial peritonitis and is treated even when the culture is sterile.",
            "Blood tests: complete blood count, liver function tests, INR, urea, creatinine, electrolytes, blood glucose, blood cultures, urine routine and culture, chest radiograph, HBsAg and anti-HCV.",
            "Ultrasound abdomen with portal vein Doppler to confirm cirrhosis, quantify ascites, exclude portal vein thrombosis and screen for hepatocellular carcinoma with alpha-fetoprotein.",
            "Calculate Child-Turcotte-Pugh and MELD scores to stage severity and guide transplant referral.",
          ],
        },
        {
          heading: "3. Management of the ascites",
          points: [
            "Salt restriction to about 2 g sodium (5 g salt) per day, with dietitian input; fluid restriction only if serum sodium is below 125 mmol/L.",
            "Spironolactone 100 mg with furosemide 40 mg each morning, escalating in the same 100:40 ratio every 3-5 days to maxima of 400 mg and 160 mg.",
            "Target weight loss of 0.5 kg/day without oedema and up to 1 kg/day with oedema, monitoring weight, girth, electrolytes and creatinine.",
            "Large-volume paracentesis for tense ascites, giving 6-8 g of albumin per litre removed when more than 5 litres are drained.",
            "Stop NSAIDs, aminoglycosides, ACE inhibitors and ARBs, all of which precipitate acute kidney injury in this setting.",
            "Refractory ascites is managed with serial paracentesis and albumin, and referral for TIPS or transplantation.",
          ],
        },
        {
          heading: "4. Treatment of spontaneous bacterial peritonitis",
          points: [
            "Start intravenous cefotaxime 2 g eight-hourly, or ceftriaxone 2 g daily, for 5-7 days, modified to local antibiogram and to piperacillin-tazobactam or a carbapenem if the infection is nosocomial.",
            "Give intravenous albumin 1.5 g/kg on day 1 and 1 g/kg on day 3 to prevent hepatorenal syndrome; this reduces mortality from about 30 percent to 10 percent.",
            "Repeat paracentesis at 48 hours if there is no clinical improvement; failure of the neutrophil count to fall by 25 percent suggests resistance or secondary peritonitis.",
            "Withhold beta blockers and diuretics during the acute episode if there is hypotension or renal impairment.",
            "Start lifelong secondary prophylaxis with norfloxacin 400 mg daily after recovery, and give ceftriaxone prophylaxis during any future gastrointestinal bleed.",
          ],
        },
        {
          heading: "5. Other complications, prevention and follow-up",
          points: [
            "Treat hepatic encephalopathy with lactulose titrated to 2-3 soft stools a day, adding rifaximin 550 mg twice daily for recurrence, and correct the precipitant without restricting protein.",
            "Screen for varices by upper GI endoscopy and give non-selective beta blockade or band ligation as primary prophylaxis for medium or large varices.",
            "Six-monthly ultrasound surveillance for hepatocellular carcinoma, with alpha-fetoprotein.",
            "Absolute abstinence with de-addiction support, thiamine and nutritional rehabilitation at 1.2-1.5 g/kg/day protein and 35 kcal/kg/day with a late-evening snack.",
            "Vaccinate against hepatitis A and B, influenza and pneumococcus, and refer for liver transplant assessment given that this is his first decompensation.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Gastrointestinal bleeding, which delivers a large protein load to the colon - always examine the stool and consider varices.",
            "Infection, especially spontaneous bacterial peritonitis, urinary tract infection and pneumonia.",
            "Constipation, dehydration, over-diuresis and large-volume paracentesis without albumin.",
            "Electrolyte disturbance, particularly hypokalaemia, hyponatraemia and metabolic alkalosis.",
            "Sedatives, benzodiazepines and opioids, an alcohol binge, renal failure, and portosystemic shunting including after TIPS.",
          ],
        },
        {
          heading: "2. West Haven grading",
          points: [
            "Covert or minimal: normal examination, abnormal psychometric or number connection testing only, but impaired driving and increased falls.",
            "Grade 1: trivial lack of awareness, euphoria or anxiety, shortened attention span, reversal of sleep rhythm.",
            "Grade 2: lethargy or apathy, disorientation to time, obvious personality change, inappropriate behaviour, asterixis present.",
            "Grade 3: somnolence to semi-stupor but responsive to stimuli, gross disorientation, bizarre behaviour.",
            "Grade 4: coma, unresponsive to painful stimuli, with a risk of cerebral oedema in acute liver failure.",
          ],
        },
        {
          heading: "3. Management",
          points: [
            "Admit grade 2 or worse; protect the airway and nurse head-up in grade 3-4, and exclude hypoglycaemia and other causes of altered sensorium.",
            "Identify and treat the precipitant - stop diuretics and sedatives, correct potassium and sodium, tap the ascites for SBP, treat any bleed.",
            "Lactulose 30 mL two to three times daily titrated to 2-3 soft stools a day; as a 300 mL in 700 mL water retention enema if the patient cannot swallow.",
            "Add rifaximin 550 mg twice daily for breakthrough or recurrent episodes; consider L-ornithine L-aspartate as adjunct.",
            "Maintain nutrition at 1.2-1.5 g/kg/day of protein with a late-evening snack; do not restrict protein.",
            "After recovery continue lactulose with or without rifaximin as secondary prophylaxis and refer for transplant assessment.",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        "**Upper gastrointestinal bleeding arises proximal to the ligament of Treitz** and presents as haematemesis, coffee-ground vomiting or melaena; **lower gastrointestinal bleeding arises distal to it** and presents as haematochezia or bleeding per rectum. Upper bleeding is four to five times commoner and far more lethal.",
        "**Melaena is black, tarry, sticky and offensive stool** and needs only 50-100 mL of blood in the upper tract, held there for 14 hours or more; iron and bismuth blacken the stool but the stool is neither tarry nor offensive and the occult blood test is negative, which is the discriminating point.",
        "**A brisk upper GI bleed can present as haematochezia** - about 10-15 percent of apparent lower GI bleeds are actually massive upper bleeds - so any patient with red rectal bleeding and haemodynamic instability needs a nasogastric aspirate or an upper endoscopy first.",
        "Causes of upper GI bleeding in Indian practice, in rough order: **peptic ulcer disease (about 40-50 percent), oesophagogastric varices (20-30 percent, higher in referral hepatology centres), erosive gastritis and duodenitis, Mallory-Weiss tear, oesophagitis, and gastric or oesophageal malignancy**; Dieulafoy lesion and aorto-enteric fistula are the rare but examinable ones.",
        "Causes of lower GI bleeding: **haemorrhoids and anal fissure (commonest overall in general practice), diverticular disease, angiodysplasia, colorectal carcinoma and polyps, inflammatory bowel disease, infective colitis, ischaemic colitis, and radiation proctitis**; in India also amoebic colitis, tuberculous ulcers and solitary rectal ulcer syndrome.",
        "**The first three questions are always the same: is he shocked, is he on an anticoagulant or antiplatelet, and does he have chronic liver disease?** The answers change the resuscitation, the drug, and the urgency of transfer more than the eventual endoscopic diagnosis does.",
      ],
    },
    {
      heading: "Resuscitation and risk stratification",
      points: [
        "**Airway, breathing, circulation first - two large-bore (16G or 18G) cannulae, crystalloid, and blood sent for group and crossmatch**, complete blood count, urea and creatinine, liver function, INR and blood gas. Protect the airway in a patient with massive haematemesis or grade 3-4 encephalopathy.",
        "**A raised blood urea with a normal creatinine is a useful clue to upper GI bleeding**, produced by absorption of digested blood protein from the small bowel plus prerenal azotaemia.",
        "**Transfuse restrictively to a haemoglobin threshold of 7 g/dL, targeting 7-9 g/dL** - over-transfusion in variceal bleeding raises portal pressure and increases rebleeding and death. Use a threshold of 8 g/dL in patients with ischaemic heart disease.",
        "**The haemoglobin at presentation underestimates the loss** because haemodilution takes hours; treat the pulse, blood pressure, capillary refill and postural drop rather than the first haemoglobin.",
        "**Glasgow-Blatchford score** is calculated before endoscopy from urea, haemoglobin, systolic blood pressure, pulse, melaena, syncope, hepatic disease and cardiac failure; **a score of 0-1 identifies a very low-risk patient who can be managed as an outpatient**, and any higher score means admission.",
        "**Rockall score** (age, shock, comorbidity, endoscopic diagnosis and stigmata of recent haemorrhage) predicts rebleeding and mortality after endoscopy, and the **Forrest classification** grades the ulcer at endoscopy - Ia spurting, Ib oozing, IIa visible vessel, IIb adherent clot, IIc flat pigmented spot, III clean base - with Ia to IIb needing endoscopic therapy.",
        "Correct coagulopathy pragmatically: **stop the NSAID and, in life-threatening bleeding, reverse warfarin with vitamin K and prothrombin complex concentrate**, and use andexanet or idarucizumab where available for direct oral anticoagulants; do not routinely give fresh frozen plasma to a cirrhotic for a raised INR, since it does not correct the balanced coagulopathy and volume expansion raises portal pressure.",
      ],
    },
    {
      heading: "Variceal bleeding",
      points: [
        "Suspect variceal bleeding in any patient with **stigmata of chronic liver disease, splenomegaly, ascites or a known cirrhosis** presenting with haematemesis; it accounts for a third of all deaths in cirrhosis and has a 15-20 percent six-week mortality even with modern care.",
        "**Start a vasoactive drug before endoscopy and continue for 2-5 days: terlipressin 2 mg intravenously six-hourly, reduced to 1 mg six-hourly after control** (or octreotide 50 microgram bolus then 50 microgram/hour, or somatostatin). Watch for hyponatraemia and ischaemic complications with terlipressin.",
        "**Give antibiotic prophylaxis to every cirrhotic with a gastrointestinal bleed - ceftriaxone 1 g intravenously daily for up to 7 days** - because it reduces infection, rebleeding and mortality; this is one of the most commonly asked single interventions in the paper.",
        "**Endoscopic variceal band ligation within 12 hours** is the definitive treatment for oesophageal varices; **gastric fundal varices are treated with cyanoacrylate glue injection** rather than banding.",
        "Balloon tamponade with a **Sengstaken-Blakemore or Minnesota tube is a bridge for a maximum of 24 hours** in uncontrolled bleeding, with the airway secured first; it controls bleeding in 80-90 percent but rebleeding on deflation is the rule, and oesophageal rupture and aspiration are its dangers.",
        "**Early or pre-emptive TIPS within 72 hours** is offered to high-risk patients (Child C 10-13, or Child B with active bleeding at endoscopy) and improves survival; rescue TIPS is used for failure of endoscopic and drug therapy.",
        "Secondary prophylaxis after a variceal bleed is **non-selective beta blockade (propranolol or carvedilol) plus repeated band ligation every 2-4 weeks until obliteration**, then surveillance endoscopy; treat the underlying liver disease and refer for transplant assessment.",
      ],
    },
    {
      heading: "Non-variceal upper gastrointestinal bleeding",
      points: [
        "**Give a high-dose intravenous proton pump inhibitor - pantoprazole 80 mg bolus then 8 mg/hour infusion for 72 hours**, or 40 mg twice daily where an infusion pump is not available - to raise intragastric pH above 6 so that platelet aggregation and clot stability are maintained.",
        "PPI before endoscopy downstages the lesion and reduces the need for endoscopic therapy but **does not reduce rebleeding, surgery or mortality** - the endoscopy is what does that, so a PPI is never a reason to delay transfer.",
        "**Endoscopy within 24 hours for all, and within 12 hours if there is haemodynamic instability**; endoscopic haemostasis uses dual therapy - adrenaline injection combined with a second modality such as a clip, thermal coagulation or haemostatic powder, because adrenaline alone is inadequate.",
        "**Test for and eradicate Helicobacter pylori in every bleeding peptic ulcer and confirm cure**, because eradication reduces rebleeding more than maintenance acid suppression does; a negative test taken during acute bleeding is unreliable and must be repeated after recovery.",
        "**Restarting antithrombotics is an examinable balance**: low-dose aspirin for secondary cardiovascular prevention is restarted within 3-7 days (and often at 24 hours once haemostasis is achieved), because the cardiovascular death avoided outweighs the rebleeding risk, whereas primary-prevention aspirin is usually stopped permanently.",
        "Rebleeding after successful endoscopy is managed by a **second endoscopy; failure then goes to transcatheter arterial embolisation by interventional radiology, or to surgery** (under-running the vessel, with or without gastrectomy) where radiology is not available.",
        "A **Mallory-Weiss tear** after retching, typically after an alcohol binge, stops spontaneously in 90 percent and needs only supportive care; contrast this with **Boerhaave syndrome**, a full-thickness rupture with severe chest pain, surgical emphysema and a mediastinal air on chest radiograph, which is a surgical emergency.",
      ],
    },
    {
      heading: "Lower gastrointestinal bleeding",
      points: [
        "**Take the history from the toilet bowl**: bright red blood coating the stool or dripping after defecation with pain on passing stool suggests a fissure or haemorrhoids, blood mixed through the stool suggests a colonic source, and blood with mucus and tenesmus suggests proctitis, colitis or a rectal tumour.",
        "**Do a digital rectal examination and proctoscopy on every patient - the commonest cause is anorectal and is visible from outside the colonoscope.** Never attribute rectal bleeding to haemorrhoids in a patient over 40 or with alarm features without visualising the colon.",
        "**Diverticular bleeding is the commonest cause of major lower GI haemorrhage**, painless, arterial, large-volume and self-limiting in 75-80 percent; **angiodysplasia** causes recurrent painless bleeding in the elderly and is associated with aortic stenosis and chronic kidney disease.",
        "**Ischaemic colitis** presents with sudden left-sided abdominal pain followed within 24 hours by bloody diarrhoea in an older patient with vascular disease, and is usually managed conservatively; **acute mesenteric ischaemia** by contrast has pain grossly out of proportion to signs and is a catastrophe.",
        "**Colonoscopy is the investigation of choice** after bowel preparation, usually within 24 hours for major bleeding; **CT angiography is used when bleeding is brisk and ongoing** (it detects rates above 0.3-0.5 mL/min) and is followed by embolisation, while a radionuclide-labelled red cell scan detects slower bleeding.",
        "In the Indian setting also consider **amoebic colitis, bacillary dysentery, intestinal tuberculosis, typhoid ileal ulceration in the third week, and hookworm infestation**, and remember that a bleeding Meckel diverticulum is the commonest cause of significant painless rectal bleeding in a child.",
        "**Refer urgently under the two-week suspected cancer pathway** any patient over 40 with rectal bleeding and a change in bowel habit, any age with an abdominal or rectal mass, or with iron-deficiency anaemia - colorectal cancer incidence in India is rising and is being missed as piles.",
      ],
    },
    {
      heading: "Referral, transfer and prevention in general practice",
      points: [
        "**Any active haematemesis, melaena, syncope, tachycardia above 100, systolic pressure below 100 mmHg, or a Glasgow-Blatchford score of 2 or more is admitted the same day.** A first-contact clinic without blood banking and endoscopy stabilises and transfers rather than observes.",
        "**Transfer with two intravenous lines running, oxygen, the patient nil by mouth and in the left lateral position if vomiting**, with a written note of the drugs given, the anticoagulant history and the vital sign trend; call ahead so that blood and the endoscopist are ready.",
        "**Start terlipressin and ceftriaxone before transfer if chronic liver disease is suspected, and an intravenous PPI if it is not** - the treatment that matters is given before the ambulance leaves, not after it arrives.",
        "Outpatient management is acceptable only for the **Glasgow-Blatchford 0-1 patient**: under 60, no melaena, no syncope, no liver or cardiac disease, normal urea and haemoglobin and normal vital signs, who is given a next-working-day endoscopy appointment and clear return instructions.",
        "Prevention is the family physician's real contribution: **review every NSAID prescription, co-prescribe a PPI in patients at risk, eradicate H. pylori before starting long-term aspirin or an NSAID, screen and band varices in known cirrhotics, and counsel on alcohol**.",
        "Follow up after discharge: check haemoglobin and start oral iron for 3 months, confirm H. pylori eradication, reassess the indication for every antiplatelet and anticoagulant, complete the colonoscopy if it was incomplete, and ensure the beta blocker and banding programme is running in a cirrhotic.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Assess airway, breathing and circulation; protect the airway if there is massive haematemesis or altered sensorium, and give oxygen.",
            "Insert two 16G or 18G cannulae, start crystalloid, and send blood for group and crossmatch, complete blood count, urea, creatinine, electrolytes, liver function tests, INR and blood glucose.",
            "Record pulse, blood pressure with a postural drop, capillary refill and urine output, and monitor them serially - the first haemoglobin underestimates the loss.",
            "Transfuse packed cells to a threshold of 7 g/dL, targeting 7-9 g/dL, using 8 g/dL if there is ischaemic heart disease; avoid over-transfusion, which raises portal pressure.",
            "Keep the patient nil by mouth, catheterise if shocked, and correct coagulopathy - vitamin K and prothrombin complex concentrate for warfarin, specific reversal agents for direct oral anticoagulants.",
          ],
        },
        {
          heading: "2. Focused history and examination for the cause",
          points: [
            "Ask about NSAIDs, aspirin, steroids, anticoagulants and antiplatelets, previous ulcer or dyspepsia, alcohol intake, jaundice, known liver disease and previous variceal bleeds.",
            "Ask about retching before the haematemesis, which suggests a Mallory-Weiss tear, and about weight loss and dysphagia, which suggest malignancy.",
            "Examine for stigmata of chronic liver disease, splenomegaly, ascites and encephalopathy, which point to varices, and for epigastric tenderness and a succussion splash.",
            "Do a per rectal examination to confirm melaena, and estimate the blood loss from the clinical picture rather than the haemoglobin.",
            "Note that a raised blood urea with a normal creatinine supports an upper gastrointestinal source.",
          ],
        },
        {
          heading: "3. Risk stratification",
          points: [
            "Calculate the pre-endoscopy Glasgow-Blatchford score from urea, haemoglobin, systolic pressure, pulse, melaena, syncope, hepatic disease and cardiac failure.",
            "A score of 0-1 identifies a very low-risk patient for outpatient management with early endoscopy; any higher score means admission.",
            "After endoscopy use the full Rockall score for rebleeding and mortality, and the Forrest classification of the ulcer to decide endoscopic therapy.",
            "Forrest Ia spurting, Ib oozing, IIa visible vessel and IIb adherent clot need endoscopic haemostasis; IIc and III can be managed with oral acid suppression.",
          ],
        },
        {
          heading: "4. Non-variceal bleeding",
          points: [
            "Give pantoprazole 80 mg intravenous bolus followed by an 8 mg/hour infusion for 72 hours, or 40 mg intravenously twice daily where no infusion pump exists.",
            "Arrange endoscopy within 24 hours, or within 12 hours if the patient is haemodynamically unstable.",
            "Endoscopic haemostasis is dual therapy - adrenaline injection plus a clip, thermal probe or haemostatic powder; adrenaline alone is inadequate.",
            "Test for Helicobacter pylori, eradicate it and confirm cure after recovery, stop the offending NSAID, and step down to oral PPI for 4-8 weeks.",
            "Rebleeding is treated by a second endoscopy, then transcatheter arterial embolisation or surgery.",
            "Restart low-dose aspirin for secondary prevention within 3-7 days; stop it permanently if it was for primary prevention.",
          ],
        },
        {
          heading: "5. Variceal bleeding",
          points: [
            "Start terlipressin 2 mg intravenously six-hourly, reduced to 1 mg six-hourly after control, and continue for 2-5 days; octreotide or somatostatin are alternatives.",
            "Give ceftriaxone 1 g intravenously daily for up to 7 days to every cirrhotic with a gastrointestinal bleed, which reduces infection, rebleeding and mortality.",
            "Endoscopic variceal band ligation within 12 hours for oesophageal varices; cyanoacrylate glue injection for gastric fundal varices.",
            "Balloon tamponade with a Sengstaken-Blakemore tube for a maximum of 24 hours as a bridge with the airway secured, and early or rescue TIPS for failure or for high-risk Child C patients.",
            "Prevent encephalopathy with lactulose, avoid sedatives, and monitor for spontaneous bacterial peritonitis and hepatorenal syndrome.",
            "Secondary prophylaxis with a non-selective beta blocker plus repeat banding every 2-4 weeks to obliteration, and referral for transplant assessment.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Bright red blood dripping after defecation, on the paper or coating the stool, with painful defecation, suggests haemorrhoids or an anal fissure.",
            "Blood mixed through the stool suggests a colonic source; blood with mucus and tenesmus suggests proctitis, colitis or a rectal tumour.",
            "Painless large-volume dark red or maroon bleeding in an elderly patient suggests diverticular disease or angiodysplasia.",
            "Ask about change in bowel habit, weight loss, abdominal pain, fever, recent antibiotic use, travel, NSAIDs, anticoagulants, radiation and family history of colorectal cancer.",
            "Black tarry offensive stool means melaena and an upper source; iron and bismuth blacken stool without making it tarry or occult-blood positive.",
          ],
        },
        {
          heading: "2. Examination and bedside assessment",
          points: [
            "Assess pulse, blood pressure, postural drop and pallor to decide whether this is a major bleed needing admission.",
            "Examine the abdomen for masses, tenderness and hepatosplenomegaly, and examine the perianal region for fissures, fistulae, skin tags and prolapsed piles.",
            "Digital rectal examination and proctoscopy are mandatory in every patient - a rectal carcinoma is felt, not scoped.",
            "Nasogastric aspiration or upper endoscopy first if the patient is shocked with red rectal bleeding.",
          ],
        },
        {
          heading: "3. Investigation and referral",
          points: [
            "Complete blood count, iron studies, renal function, INR if anticoagulated, and stool examination and culture where dysentery is suspected.",
            "Colonoscopy is the investigation of choice, usually within 24 hours after preparation for major bleeding and electively otherwise.",
            "CT angiography for brisk ongoing bleeding, followed by embolisation; a labelled red cell scan for slower intermittent bleeding.",
            "Refer urgently for suspected colorectal cancer if the patient is over 40 with rectal bleeding and a change in bowel habit, has a mass, or has iron-deficiency anaemia.",
            "Admit for shock, ongoing large-volume bleeding, anticoagulation, or significant comorbidity.",
          ],
        },
        {
          heading: "4. Treatment of the common causes in general practice",
          points: [
            "Fissure and haemorrhoids: high-fibre diet with 25-30 g fibre and 2-3 litres of fluid, stool softeners, sitz baths, topical anaesthetic and 0.2 percent glyceryl trinitrate or diltiazem for fissure, and referral for banding or surgery if these fail.",
            "Infective colitis: rehydration, and antibiotics only for dysentery, amoebiasis or proven bacterial cause.",
            "Inflammatory bowel disease and malignancy are referred to gastroenterology and surgery respectively.",
            "Review and where possible modify anticoagulant and antiplatelet therapy after specialist advice.",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        "**Irritable bowel syndrome is a disorder of gut-brain interaction**, no longer called functional in the pejorative sense; the mechanisms are visceral hypersensitivity, altered motility, low-grade mucosal immune activation, altered microbiota, increased intestinal permeability and central pain processing modulated by stress.",
        "**Rome IV criteria: recurrent abdominal pain, on average at least 1 day per week in the last 3 months, associated with two or more of - related to defecation, associated with a change in stool frequency, associated with a change in stool form - with symptom onset at least 6 months before diagnosis.** Note that Rome IV requires pain, not merely discomfort, and dropped the old Rome III requirement of 3 days per month.",
        "**Subtypes are defined by stool form on days with abnormal stools using the Bristol scale**: IBS-C (more than 25 percent hard, Bristol 1-2, and less than 25 percent loose), IBS-D (more than 25 percent loose, Bristol 6-7, and less than 25 percent hard), IBS-M (more than 25 percent of both), and IBS-U (unclassified).",
        "**Functional constipation (Rome IV)** requires two or more of the following in more than a quarter of defecations for 3 months with onset 6 months earlier: straining, lumpy or hard stools, sensation of incomplete evacuation, sensation of anorectal obstruction, need for manual manoeuvres, and fewer than three spontaneous bowel movements a week, with loose stools rarely present without laxatives.",
        "**Constipation with predominant pain is IBS-C; constipation without significant pain is functional constipation** - this distinction decides whether an antispasmodic or a neuromodulator is added to the laxative.",
        "Epidemiology: IBS affects about **4-10 percent of adults worldwide and 4-7 percent in Indian community surveys**, is commoner in women in Western series but shows a male preponderance in several Indian hospital series, and chronic constipation affects **10-15 percent of adults, rising to over 30 percent in the elderly**.",
      ],
    },
    {
      heading: "Clinical assessment and the alarm features",
      points: [
        "Take the history in the patient's own words and quantify: **duration, pain site and relation to defecation, stool frequency and Bristol form, urgency, mucus, bloating, incomplete evacuation, nocturnal symptoms and effect on work and sleep**.",
        "**Nocturnal diarrhoea or pain waking the patient from sleep is never IBS** - it is an organic red flag and must be investigated.",
        "Ask specifically about diet: **excess milk in lactose intolerance, which is very common in Indian adults, wheat, onion, garlic, pulses and legumes, artificial sweeteners (sorbitol, mannitol), tea and coffee load, and fried and spicy foods**; ask about fibre and, crucially, about fluid intake.",
        "Ask about drugs that constipate: **opioids including codeine and tramadol, iron, calcium and aluminium antacids, calcium channel blockers, anticholinergics, tricyclics, antipsychotics, diuretics and ondansetron**.",
        "Screen for the psychosocial dimension without dismissing the symptoms: **anxiety, depression, somatisation, sleep disturbance, past physical or sexual abuse, and the patient's own fear of cancer**, which is often the real reason for the consultation and must be addressed explicitly.",
        "**Alarm features that mandate investigation: age of onset over 50 (over 45 in Indian practice), rectal bleeding or melaena, unexplained weight loss, nocturnal symptoms, progressive dysphagia, fever, anaemia, an abdominal or rectal mass, recent change in bowel habit that is progressive, and a family history of colorectal cancer, coeliac disease or inflammatory bowel disease.**",
        "**A digital rectal examination is mandatory in chronic constipation** - it detects a rectal mass, faecal impaction, anal fissure, poor sphincter tone and, most importantly, **dyssynergic defecation** (paradoxical contraction or failure to relax the puborectalis and external sphincter on simulated straining), which is present in up to half of refractory cases and needs biofeedback rather than more laxatives.",
      ],
    },
    {
      heading: "Investigation: how little is enough",
      points: [
        "**IBS is a positive diagnosis made on the Rome IV criteria in the absence of alarm features, not a diagnosis of exclusion** - saying so explicitly is worth a mark, and repeated normal investigations reinforce illness behaviour rather than reassure.",
        "The minimum in a young patient without alarm features is **complete blood count, ESR or CRP, and in diarrhoea-predominant disease coeliac serology (tissue transglutaminase IgA with total IgA)** plus stool examination for parasites in the Indian setting, where **Giardia lamblia and Entamoeba histolytica are genuine mimics**.",
        "**Faecal calprotectin below 50 microgram/g effectively excludes inflammatory bowel disease** in a patient with diarrhoea and reduces the need for colonoscopy; it is increasingly available in Indian laboratories and is the single most useful discriminating test in IBS-D.",
        "In chronic constipation check **thyroid-stimulating hormone, serum calcium, blood glucose and potassium** to exclude hypothyroidism, hypercalcaemia, diabetes and hypokalaemia; a routine barium enema or abdominal radiograph is not indicated.",
        "**Colonoscopy is indicated if there are any alarm features, if the patient is over 45-50 with new symptoms, if the calprotectin is raised, or if there is a family history of colorectal cancer** - not to reassure a 28-year-old whose symptoms fit Rome IV.",
        "Consider a **hydrogen breath test for lactose intolerance or small intestinal bacterial overgrowth** where bloating dominates, and anorectal manometry with a balloon expulsion test where dyssynergic defecation is suspected on rectal examination.",
      ],
    },
    {
      heading: "Management of irritable bowel syndrome",
      points: [
        "**Begin with explanation and a positive diagnosis**: name the condition, explain gut-brain hypersensitivity in the patient's language, state clearly that it does not cause cancer and does not shorten life, and set the goal as symptom control rather than cure. **The therapeutic relationship itself is the most effective single intervention** and reduces consultation rates.",
        "Diet first: **regular unhurried meals, adequate fluid, reduced caffeine, alcohol, fizzy drinks, fatty and fried food and artificial sweeteners**, with a food and symptom diary. **Soluble fibre (ispaghula or isabgol) helps, whereas insoluble bran worsens pain and bloating** - a favourite exam distinction.",
        "**A low FODMAP diet (fermentable oligosaccharides, disaccharides, monosaccharides and polyols) helps about 50-70 percent of patients**, but must be dietitian-supervised, restricted for only 4-6 weeks and then systematically reintroduced, because long-term restriction harms the microbiota and nutrition. In India it means limiting wheat, rajma and chana, onion, garlic, milk, apples and mangoes during the elimination phase.",
        "For pain and bloating: **antispasmodics - mebeverine 135 mg three times daily, dicyclomine 10-20 mg, hyoscine butylbromide 10 mg - taken before meals, and enteric-coated peppermint oil capsules**, which have good trial evidence.",
        "For IBS-D: **loperamide 2 mg titrated for urgency, and rifaximin 550 mg three times daily for 14 days**, which gives durable benefit in about 40 percent; ondansetron is an option for urgency and bile acid sequestrants for suspected bile acid diarrhoea.",
        "For IBS-C: **soluble fibre, polyethylene glycol, and where available linaclotide or lubiprostone**; **avoid lactulose in IBS because it is a FODMAP and worsens bloating and pain**.",
        "For refractory pain: **low-dose tricyclic antidepressants act as gut neuromodulators - amitriptyline 10-25 mg at night, useful in IBS-D because of the anticholinergic constipating effect** - while SSRIs are preferred in IBS-C. Explain that these are given for gut pain at a low dose and not because the doctor thinks the problem is psychological.",
        "**Gut-directed cognitive behavioural therapy, hypnotherapy, yoga and regular exercise all have trial evidence** and are particularly appropriate where drug access is limited; probiotics may be tried for 4 weeks and stopped if there is no benefit.",
      ],
    },
    {
      heading: "Management of chronic constipation",
      points: [
        "**Treat the treatable first: stop or substitute constipating drugs, correct hypothyroidism, hypercalcaemia and hypokalaemia, and treat any anal fissure or haemorrhoid causing painful defecation and stool withholding.**",
        "Lifestyle measures with real evidence: **fibre 25-30 g/day increased gradually over weeks, fluid 1.5-2 litres/day, and regular physical activity**; increasing fibre without increasing fluid makes constipation and bloating worse and is a common prescribing error.",
        "**Toilet training and posture matter and are often the whole treatment**: use the gastrocolic reflex by sitting on the toilet 20-30 minutes after a meal, ideally after breakfast, allow unhurried time, **do not suppress the call to stool**, and adopt a squatting posture or place a footstool to raise the knees above the hips and straighten the anorectal angle.",
        "**Bulk-forming laxatives - ispaghula (isabgol) 1-2 teaspoons with a full glass of water at night - are first line** but need adequate fluid and are avoided in opioid-induced constipation and in suspected obstruction.",
        "**Osmotic laxatives are second line: polyethylene glycol (macrogol) 13-26 g daily is the best-evidenced and drug of choice, and lactulose 15-30 mL daily is the cheaper alternative that causes more bloating and flatulence.** Magnesium salts are effective but are avoided in renal impairment.",
        "**Stimulant laxatives - bisacodyl 5-10 mg or senna at night - are added or used as rescue**; the old teaching that they cause a cathartic colon or dependence is not supported by evidence, and they are legitimate for regular use in refractory and opioid-induced constipation.",
        "**Faecal impaction with overflow soiling is treated by disimpaction first** - high-dose polyethylene glycol, or glycerine or bisacodyl suppositories and phosphate enemas, occasionally manual evacuation - followed by a maintenance regimen; giving a bulk laxative to an impacted patient makes it worse.",
        "**Dyssynergic defecation is treated with anorectal biofeedback, which is superior to laxatives**, and opioid-induced constipation may need a peripherally acting mu-opioid receptor antagonist such as methylnaltrexone or naloxegol; prucalopride is used in refractory slow-transit constipation.",
      ],
    },
    {
      heading: "Follow-up, prognosis and the traps",
      points: [
        "Review at **4-6 weeks** to reinforce the diagnosis, check adherence to diet and drug, and adjust; most patients improve, and the trajectory is one of remission and relapse over years rather than progression.",
        "**Re-evaluate rather than re-label if the pattern changes** - a new symptom, an alarm feature, weight loss or onset over 50 in a patient carrying an old IBS label demands fresh investigation, because IBS does not protect against colorectal cancer or inflammatory bowel disease.",
        "**Post-infectious IBS** follows about 10 percent of episodes of acute bacterial gastroenteritis, is commoner after severe or prolonged illness and in anxious patients, and usually settles over months - important in India where acute gastroenteritis is ubiquitous.",
        "**Common traps in Indian practice**: undiagnosed lactose intolerance, giardiasis, coeliac disease (increasingly recognised in the wheat-eating north), intestinal tuberculosis presenting with pain and altered bowel habit, and thyroid disease - each of which can be labelled IBS for years.",
        "**Do not over-investigate and do not under-explain.** The two failure modes are the patient who has had four colonoscopies and no explanation, and the patient dismissed with it is only gas, who then consults elsewhere.",
        "Document the diagnosis, the criteria used and the negative investigations clearly in the record, so that the next doctor does not restart the whole cycle - continuity of care is itself the treatment in a disorder of gut-brain interaction.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          heading: "1. History",
          points: [
            "Characterise the pain: site, periodicity, relation to defecation, relief after passing stool, and its relation to meals and to stress.",
            "Record stool frequency and form using the Bristol scale to assign a subtype - IBS-C, IBS-D or IBS-M - and ask about mucus, urgency and a sense of incomplete evacuation.",
            "Ask about diet: milk and milk products for lactose intolerance, wheat, pulses, onion and garlic, artificial sweeteners, caffeine and fried food, and quantify fibre and fluid intake.",
            "Take a drug history, particularly opioids, iron, antacids, calcium channel blockers and anticholinergics.",
            "Explore the psychosocial context - anxiety, depression, sleep, stress at home or work, past abuse - and elicit the patient's own concern, which is usually a fear of cancer.",
            "Screen for alarm features: age over 45-50 at onset, rectal bleeding, weight loss, nocturnal symptoms, fever, anaemia, mass, and a family history of colorectal cancer, coeliac disease or inflammatory bowel disease.",
          ],
        },
        {
          heading: "2. Examination and investigations",
          points: [
            "General examination for pallor, nutrition, thyroid status and lymphadenopathy; abdominal examination for tenderness, masses and organomegaly.",
            "Digital rectal examination and, where indicated, proctoscopy, to exclude a mass and to assess for dyssynergic defecation.",
            "Complete blood count, ESR or CRP, thyroid-stimulating hormone, blood glucose and serum calcium.",
            "Coeliac serology with tissue transglutaminase IgA and total IgA in diarrhoea-predominant disease, and stool examination for Giardia and Entamoeba.",
            "Faecal calprotectin, which if under 50 microgram/g effectively excludes inflammatory bowel disease and avoids colonoscopy.",
            "Colonoscopy only for alarm features, an abnormal calprotectin, onset over 45-50, or a family history of colorectal cancer.",
          ],
        },
        {
          heading: "3. Explanation and non-drug management",
          points: [
            "Make and communicate a positive diagnosis by name, explain visceral hypersensitivity and the gut-brain axis in simple language, and state that IBS does not cause cancer and does not shorten life.",
            "Advise regular unhurried meals, adequate fluid, and reduction of caffeine, alcohol, carbonated drinks, fatty and fried food and artificial sweeteners.",
            "Use soluble fibre such as ispaghula rather than insoluble bran, which worsens pain and bloating.",
            "Offer a dietitian-supervised low FODMAP diet for 4-6 weeks with systematic reintroduction, avoiding indefinite restriction.",
            "Recommend regular physical activity, yoga, sleep hygiene, and gut-directed cognitive behavioural therapy or hypnotherapy where available.",
          ],
        },
        {
          heading: "4. Drug treatment by predominant symptom",
          points: [
            "Pain and spasm: mebeverine 135 mg three times daily before meals, dicyclomine or hyoscine butylbromide, and enteric-coated peppermint oil.",
            "Diarrhoea: loperamide 2 mg titrated to effect, and rifaximin 550 mg three times daily for 14 days for bloating and diarrhoea.",
            "Constipation: soluble fibre and polyethylene glycol, with linaclotide or lubiprostone if available; avoid lactulose because it is a FODMAP.",
            "Refractory pain: low-dose amitriptyline 10-25 mg at night as a neuromodulator, preferred in IBS-D, or an SSRI in IBS-C, explaining the rationale to avoid the perception of a psychiatric label.",
            "A trial of probiotics for 4 weeks, stopped if there is no benefit.",
          ],
        },
        {
          heading: "5. Follow-up and safety-netting",
          points: [
            "Review at 4-6 weeks to reinforce the diagnosis, review the symptom diary and adjust treatment; expect a relapsing and remitting course.",
            "Re-evaluate rather than re-label if the symptom pattern changes or an alarm feature appears, since an IBS label does not protect against organic disease.",
            "Document the criteria used and the negative investigations to prevent needless repetition by other doctors.",
            "Provide continuity, address the fear of cancer explicitly, and treat coexisting anxiety or depression.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          ...
          points: [
            "Define what the patient means by constipation - frequency, straining, hard stool, incomplete evacuation, need for digital manoeuvres - and apply the Rome IV criteria for functional constipation.",
            "Identify alarm features: new onset, rectal bleeding, weight loss, anaemia, a mass, or a family history of colorectal cancer, all of which mandate colonoscopy.",
            "Take a full drug history - opioids including tramadol, iron, calcium and aluminium antacids, calcium channel blockers, anticholinergics, tricyclics, antipsychotics and diuretics.",
            "Look for secondary causes: hypothyroidism, hypercalcaemia, diabetes, hypokalaemia, Parkinson disease, stroke, spinal cord disease and depression.",
            "Perform an abdominal examination and a mandatory digital rectal examination for impaction, mass, fissure, sphincter tone and dyssynergia on simulated straining.",
            "Investigate with complete blood count, thyroid-stimulating hormone, serum calcium, potassium and blood glucose; colonoscopy only if alarm features are present.",
          ],
        },
        {
          heading: "2. Step 1 - remove the cause and correct lifestyle",
          points: [
            "Stop or substitute constipating drugs wherever possible and treat any anal fissure or painful haemorrhoid causing stool withholding.",
            "Correct hypothyroidism, hypercalcaemia and hypokalaemia.",
            "Increase fibre gradually to 25-30 g/day with fluid of 1.5-2 litres/day, and encourage mobility appropriate to the patient.",
            "Toilet training: sit 20-30 minutes after a meal to use the gastrocolic reflex, allow unhurried time, never suppress the call to stool, and use a footstool to raise the knees above the hips.",
          ],
        },
        {
          heading: "3. Step 2 - laxatives in sequence",
          points: [
            "Bulk-forming ispaghula 1-2 teaspoons at night with a full glass of water, provided fluid intake is adequate and there is no impaction or obstruction.",
            "Osmotic polyethylene glycol 13-26 g daily as the best-evidenced agent, or lactulose 15-30 mL if cost is a barrier, accepting more bloating.",
            "Add or use a stimulant - bisacodyl 5-10 mg or senna at night - for rescue or regular use; dependence and cathartic colon are myths.",
            "Rectal glycerine or bisacodyl suppositories and phosphate enemas for the frail, immobile or impacted patient.",
            "Prucalopride or linaclotide in refractory slow-transit constipation, and a peripherally acting mu-opioid antagonist for opioid-induced constipation.",
          ],
        },
        {
          heading: "4. Special situations and follow-up",
          points: [
            "Faecal impaction with overflow soiling must be disimpacted first with high-dose macrogol or rectal measures, before any maintenance regimen or bulk laxative.",
            "Dyssynergic defecation is treated with anorectal biofeedback, which outperforms laxatives.",
            "Review at 4-6 weeks with a stool diary, titrating rather than stopping laxatives abruptly, and continuing them long term where the cause is irreversible.",
            "Educate the family, especially where mobility and toileting depend on a carer, and reassess if the pattern changes or an alarm feature appears.",
          ],
        },
      ],
      mustDraw: [
  ...
  sections: [
    {
      ...
      points: [
        "**The acute abdomen is abdominal pain of less than one week duration, severe enough to bring the patient for urgent attention, in which a decision about urgent surgery or admission must be made.** The family physician's contribution is triage and resuscitation, not a definitive diagnosis.",
        "**Visceral pain** is dull, poorly localised and felt in the midline according to embryological origin - foregut in the epigastrium, midgut periumbilically, hindgut in the hypogastrium; **parietal (somatic) pain** is sharp, well localised and worsened by movement and coughing, and marks inflammation reaching the parietal peritoneum.",
        "**Migration of pain from the periumbilical region to the right iliac fossa** is the classic sequence of appendicitis and is the single most useful historical feature; **pain radiating to the back** suggests pancreatitis or a leaking aortic aneurysm, **to the right shoulder tip** suggests diaphragmatic irritation from blood or biliary disease, and **loin to groin** suggests ureteric colic.",
        "**Colic - severe pain rising to a peak and easing, with the patient restless and unable to lie still - suggests a hollow viscus (intestine, ureter, biliary tree)**, whereas **peritonitis makes the patient lie absolutely still** because movement hurts; this contrast is examined in almost every viva.",
        "Locate by region: right upper quadrant (biliary, hepatic, right basal pneumonia), epigastric (peptic ulcer, pancreatitis, myocardial infarction), right iliac fossa (appendicitis, ileocaecal tuberculosis, ovarian and tubal disease, ureteric colic, mesenteric adenitis), left iliac fossa (diverticulitis, colitis, ovarian pathology), and **generalised pain (perforation, obstruction, mesenteric ischaemia, ruptured aneurysm)**.",
        "**Always ask the last menstrual period in every woman of reproductive age and do a urine pregnancy test - a ruptured ectopic pregnancy is the single commonest avoidable death in this presentation** and can be mistaken for appendicitis or a urinary infection.",
        "Remember the extra-abdominal and medical mimics that must not be operated on: **inferior wall myocardial infarction, diabetic ketoacidosis, lower lobe pneumonia, herpes zoster before the rash, sickle cell crisis, lead poisoning, acute intermittent porphyria and diabetic radiculopathy**.",
      ],
    },
    {
      heading: "Assessment: examination, bedside tests and the first hour",
      points: [
        "Assess **airway, breathing, circulation and consciousness first**; record pulse, blood pressure, respiratory rate, temperature, oxygen saturation and capillary refill, and calculate a **qSOFA or NEWS score** - shock in an acute abdomen means transfer now, whatever the diagnosis.",
        "Inspect for distension, visible peristalsis, scars, hernial orifices (**every acute abdomen must have the hernial orifices examined - an obstructed inguinal or femoral hernia is missed by not looking**), and the flanks for bruising in haemorrhagic pancreatitis (Grey Turner and Cullen signs).",
        "Palpate gently starting away from the pain: **guarding, rigidity and rebound tenderness are the signs of peritonitis**; percussion tenderness is a kinder and more reliable test of peritoneal irritation than rebound. **Loss of liver dullness suggests free gas from perforation.**",
        "Elicit the named signs and know what they mean: **Murphy sign** (arrest of inspiration on palpating the right hypochondrium, acute cholecystitis), **McBurney point tenderness, Rovsing, psoas and obturator signs** (appendicitis), **Cullen and Grey Turner signs** (haemorrhagic pancreatitis, appearing after 24-48 hours).",
        "**Auscultate for bowel sounds - absent in peritonitis and paralytic ileus, exaggerated and tinkling in mechanical obstruction** - and perform a **digital rectal examination and, in women, a vaginal examination**, which detect a pelvic collection, blood, a mass, or cervical excitation in tubal disease.",
        "Bedside tests that change management in a first-contact clinic: **urine pregnancy test, capillary blood glucose, urine dipstick, ECG in anyone over 40 with epigastric pain, haemoglobin, and where available a point-of-care ultrasound**.",
        "First investigations to request: **erect chest radiograph for free gas under the diaphragm, supine abdominal radiograph for dilated loops and air-fluid levels, complete blood count, urea, creatinine, electrolytes, blood glucose, serum amylase and lipase, liver function tests and urinalysis**; ultrasound is first-line imaging in India for biliary disease, appendicitis in the young and thin, gynaecological causes and free fluid, while **contrast-enhanced CT is the gold standard where diagnosis is uncertain**.",
      ],
    },
    {
      heading: "The common surgical causes and their handling",
      points: [
        "**Acute appendicitis** is the commonest surgical acute abdomen; migratory pain, anorexia, low-grade fever and right iliac fossa tenderness with guarding. The **Alvarado score** (MANTRELS: Migration, Anorexia, Nausea, Tenderness in RIF, Rebound, Elevated temperature, Leucocytosis, Shift to left) out of 10 guides management - **7 or more means appendicitis is likely and surgical referral is indicated, 5-6 equivocal needing imaging, 4 or less makes it unlikely**.",
        "**Perforated peptic ulcer**: sudden severe epigastric pain becoming generalised, board-like rigidity, absent liver dullness, and free gas under the diaphragm on an erect chest radiograph in about 70-80 percent. It needs immediate resuscitation, nasogastric aspiration, intravenous antibiotics, analgesia and emergency laparotomy.",
        "**Acute intestinal obstruction**: colicky pain, vomiting (early in high obstruction, late and faeculent in low), distension and absolute constipation, with tinkling bowel sounds and dilated loops on radiograph. In India, **adhesions from previous surgery, obstructed hernia, and abdominal tuberculosis with strictures are the leading causes**, and the classic exam trap is the **obstructed femoral hernia in an elderly woman**.",
        "**Acute cholecystitis and biliary colic**: right upper quadrant pain radiating to the back or shoulder tip after a fatty meal, positive Murphy sign, fever and leucocytosis, confirmed on ultrasound. **Charcot triad of fever with rigors, jaundice and right upper quadrant pain means ascending cholangitis**, and with hypotension and confusion becomes the **Reynolds pentad** - a biliary emergency requiring urgent drainage.",
        "**Acute diverticulitis** presents as left iliac fossa pain with fever in the older patient; **ureteric colic** as loin-to-groin colic with a restless patient and haematuria on dipstick; **acute mesenteric ischaemia** as pain grossly out of proportion to the physical signs in an elderly patient with atrial fibrillation or vascular disease, with a rising lactate and a very high mortality.",
        "**Gynaecological causes must be considered in every woman**: ruptured ectopic pregnancy, ovarian torsion, ruptured ovarian cyst, pelvic inflammatory disease and mittelschmerz. **Ovarian torsion and ectopic pregnancy are time-critical.**",
        "**Analgesia must not be withheld while awaiting the surgeon.** The old teaching that opioids mask signs is disproved - adequate analgesia improves the reliability of examination and is a humane and examinable point.",
      ],
    },
    {
      heading: "Acute pancreatitis: diagnosis and severity",
      points: [
        "**The revised Atlanta classification requires two of three for diagnosis: (1) abdominal pain characteristic of acute pancreatitis - severe, persistent epigastric pain radiating to the back; (2) serum lipase or amylase at least three times the upper limit of normal; (3) characteristic findings on contrast-enhanced CT, MRI or ultrasound.** If two are present, imaging is not needed to make the diagnosis.",
        "**Lipase is more sensitive and more specific than amylase and stays elevated for 8-14 days**, whereas amylase normalises in 3-5 days and is raised in many other conditions (perforated ulcer, mesenteric ischaemia, salivary disease, macroamylasaemia, renal failure). **The height of the enzyme does not correlate with severity** - a very common exam question.",
        "**Causes: gallstones (about 40-50 percent) and alcohol (about 30-35 percent) account for the majority worldwide, and in Indian series alcohol predominates in men and gallstones in women.** The mnemonic **I GET SMASHED** - Idiopathic, Gallstones, Ethanol, Trauma, Steroids, Mumps and other viruses, Autoimmune, Scorpion sting, Hyperlipidaemia and hypercalcaemia, ERCP, Drugs.",
        "**Hypertriglyceridaemia above 1000 mg/dL is an increasingly common Indian cause** and must be looked for in a patient with lipaemic serum, as must drugs (azathioprine, valproate, thiazides, oestrogens, didanosine) and post-ERCP pancreatitis.",
        "**Atlanta severity grading**: **mild** - no organ failure and no local or systemic complications; **moderately severe** - transient organ failure resolving within 48 hours, or local or systemic complications; **severe** - persistent organ failure beyond 48 hours, with mortality of 20-30 percent.",
        "Severity is predicted with **BISAP** (Blood urea above 25 mg/dL, Impaired mental status, SIRS, Age over 60, Pleural effusion - one point each, 3 or more predicts severe disease), the **modified Glasgow (Imrie)** score and the older **Ranson criteria**; **a haematocrit above 44 percent, a rising urea at 24 hours and a persistently elevated CRP above 150 mg/L at 48 hours are simple, powerful markers**.",
        "**Contrast-enhanced CT should be delayed to 72-96 hours** unless the diagnosis is in doubt, because pancreatic necrosis is not radiologically apparent before then and early scanning underestimates severity and risks contrast nephropathy in a volume-depleted patient.",
      ],
    },
    {
      heading: "Acute pancreatitis: management",
      points: [
        "**Fluid resuscitation is the single most important early intervention: moderate goal-directed fluid therapy with Ringer lactate**, about 1.5 mL/kg/hour after an initial bolus of 10 mL/kg in the hypovolaemic patient, titrated to urine output, heart rate, mean arterial pressure and haematocrit. **The WATERFALL trial showed that aggressive over-resuscitation causes fluid overload without benefit, so the older very-high-volume regimens are no longer recommended, and Ringer lactate is preferred to normal saline.**",
        "**Analgesia should be generous - intravenous paracetamol, and opioids including morphine or fentanyl as needed.** The old prohibition on morphine because of theoretical sphincter of Oddi spasm is not evidence-based and is a myth the examiner may test.",
        "**Start early enteral nutrition within 24-72 hours by mouth as tolerated, and nasogastric or nasojejunal feeding if oral intake is not possible - the old dogma of prolonged nil by mouth and total parenteral nutrition is wrong.** Early enteral feeding maintains gut barrier integrity and reduces infected necrosis and mortality.",
        "**Prophylactic antibiotics are not indicated in acute pancreatitis, even in necrotising disease.** Antibiotics are given only for proven or strongly suspected infected necrosis, cholangitis or extrapancreatic infection; **infected necrosis is suspected after 7-10 days when the patient deteriorates with gas in the collection on CT**, and is managed by a step-up approach - drainage first, then minimally invasive necrosectomy.",
        "**Urgent ERCP within 24-48 hours is indicated only for gallstone pancreatitis with concurrent acute cholangitis or persistent biliary obstruction** - not for gallstone pancreatitis in general.",
        "**Cholecystectomy for gallstone pancreatitis should be done during the same admission once mild pancreatitis has settled**, because delay leads to recurrence in 25-30 percent within six weeks; in severe disease with collections it is deferred for about six weeks.",
        "Monitor for local complications - **acute peripancreatic fluid collection and pseudocyst (after 4 weeks), acute necrotic collection and walled-off necrosis** - and for systemic complications - ARDS, acute kidney injury, hypocalcaemia, hyperglycaemia, DIC and abdominal compartment syndrome. Follow up for **exocrine insufficiency needing pancreatic enzyme replacement, new diabetes, and absolute alcohol abstinence**.",
      ],
    },
    {
      heading: "Referral thresholds and the first-contact discipline",
      points: [
        "**Transfer immediately, resuscitating en route, if there is: shock or hypotension, generalised peritonitis with rigidity, free gas under the diaphragm, suspected ruptured ectopic pregnancy or ruptured aortic aneurysm, a pulsatile expansile abdominal mass, or mesenteric ischaemia.**",
        "**Transfer the same day for: suspected appendicitis, cholecystitis, obstruction, an irreducible or tender hernia, acute pancreatitis, cholangitis, an acute abdomen in the elderly, in pregnancy, in the immunocompromised or in a diabetic, and any pain that is not settling.**",
        "**Elderly, diabetic, immunosuppressed and postpartum patients present atypically with minimal signs and normal temperature and white count, and they deteriorate faster** - lower the threshold for referral in every one of them.",
        "**What to do before transfer**: nil by mouth, intravenous access with two cannulae and fluid, nasogastric tube if there is vomiting or obstruction, urinary catheter to monitor output in the shocked patient, adequate analgesia, antibiotics if there is sepsis or perforation, and a written referral note with the vital sign trend, drugs given and time of last meal.",
        "**Do not give a purgative or an enema to an undiagnosed acute abdomen, do not give antibiotics that will mask the picture without transferring, and do not send a patient home on analgesia and antibiotics with an undiagnosed acute abdomen** - the sentence that saves the mark is that observation must be active and in a facility that can operate.",
        "Where the patient is genuinely low risk and can be safely reviewed, use **active observation with a defined review time (4-6 hours or the next morning), explicit written safety-netting - worsening pain, fever, vomiting, fainting, inability to pass flatus - and a documented plan**; serial examination by the same doctor is more diagnostic than any single investigation.",
      ],
    },
  ],
  tables: [
      ...
      answer: [
        {
          ...
          points: [
            "Characterise the pain - sudden onset, severe, epigastric, boring through to the back, relieved by sitting forward, with vomiting that does not relieve it.",
            "Quantify the alcohol intake and the timing of the binge, ask about previous similar episodes, gallstones, biliary colic, jaundice, recent ERCP, trauma, mumps, and drugs such as azathioprine, valproate and thiazides.",
            "Ask about known hypertriglyceridaemia, hypercalcaemia, diabetes and family history of pancreatitis.",
            "Consider the differential - perforated peptic ulcer, acute cholecystitis and cholangitis, inferior wall myocardial infarction, mesenteric ischaemia, leaking aortic aneurysm and diabetic ketoacidosis.",
          ],
        },
        {
          heading: "2. Examination and immediate bedside assessment",
          points: [
            "Record pulse, blood pressure, respiratory rate, temperature, oxygen saturation, urine output and mental status; look for SIRS and calculate a qSOFA or NEWS score.",
            "Examine for epigastric tenderness with guarding, distension, absent bowel sounds from ileus, and jaundice suggesting a biliary cause.",
            "Look for Cullen and Grey Turner signs, which appear only after 24-48 hours and indicate haemorrhagic pancreatitis.",
            "Do an ECG in any patient over 40 with epigastric pain to exclude inferior wall myocardial infarction, and a capillary blood glucose.",
          ],
        },
        {
          heading: "3. Investigations",
          points: [
            "Serum lipase, which is more sensitive and specific than amylase and remains raised for 8-14 days; a level at least three times the upper limit of normal is diagnostic with typical pain.",
            "Complete blood count with haematocrit, urea, creatinine, electrolytes, calcium, blood glucose, liver function tests, triglycerides, C-reactive protein, arterial blood gas and lactate.",
            "Erect chest radiograph to exclude free gas under the diaphragm and to look for a pleural effusion, and ultrasound abdomen to look for gallstones, biliary dilatation and free fluid.",
            "Contrast-enhanced CT is delayed to 72-96 hours unless the diagnosis is in doubt, since necrosis is not apparent earlier.",
            "The height of the enzyme does not correlate with severity and must not be used to grade it.",
          ],
        },
        {
          heading: "4. Severity assessment",
          points: [
            "Revised Atlanta grading - mild with no organ failure, moderately severe with transient organ failure resolving within 48 hours or local complications, severe with persistent organ failure beyond 48 hours.",
            "BISAP score at 24 hours - blood urea over 25 mg/dL, impaired mental status, SIRS, age over 60, pleural effusion - with 3 or more predicting severe disease.",
            "Modified Glasgow (Imrie) and Ranson criteria as alternatives, and simple markers - haematocrit above 44 percent, a rising urea at 24 hours and CRP above 150 mg/L at 48 hours.",
            "Persistent organ failure carries a mortality of 20-30 percent and mandates intensive care.",
          ],
        },
        {
          heading: "5. Management",
          points: [
            "Moderate goal-directed fluid resuscitation with Ringer lactate, about 1.5 mL/kg/hour after a 10 mL/kg bolus if hypovolaemic, titrated to urine output above 0.5 mL/kg/hour, heart rate, mean arterial pressure and falling haematocrit and urea; avoid aggressive over-resuscitation.",
            "Generous analgesia with intravenous paracetamol and opioids; morphine is not contraindicated.",
            "Antiemetics, correction of electrolytes including calcium and magnesium, control of hyperglycaemia, and oxygen with monitoring for ARDS.",
            "Early enteral nutrition orally within 24-72 hours as tolerated, or nasogastric or nasojejunal feeding; no prolonged starvation and no routine total parenteral nutrition.",
            "No prophylactic antibiotics, even in necrotising pancreatitis; treat only proven infected necrosis, cholangitis or extrapancreatic infection, using a step-up drainage approach.",
            "Urgent ERCP within 24-48 hours only if there is concurrent cholangitis or persistent biliary obstruction, and same-admission cholecystectomy for mild gallstone pancreatitis.",
            "Long-term: absolute alcohol abstinence with de-addiction support, treatment of hypertriglyceridaemia, and follow-up for exocrine insufficiency and new-onset diabetes.",
          ],
        },
      ],
      mustDraw: [
      ...
      answer: [
        {
          heading: "1. History",
          points: [
            "Site, onset, character, radiation, aggravating and relieving factors, and progression of the pain; colicky pain with a restless patient suggests a hollow viscus, constant pain with the patient lying still suggests peritonitis.",
            "Associated features - vomiting, its timing and content, bowel habit, passage of flatus, urinary symptoms, fever and weight loss.",
            "Last menstrual period and contraceptive history in every woman of reproductive age, with a urine pregnancy test.",
            "Past surgery for adhesions, known hernia, gallstones, peptic ulcer, alcohol, drugs including NSAIDs and steroids, and cardiovascular disease including atrial fibrillation.",
          ],
        },
        {
          heading: "2. Examination",
          points: [
            "Vital signs, hydration, pallor, jaundice and mental status; calculate a NEWS or qSOFA score.",
            "Inspect for distension, scars and visible peristalsis; examine the hernial orifices in every case.",
            "Palpate for tenderness, guarding, rigidity and rebound or percussion tenderness; elicit Murphy, McBurney, Rovsing, psoas and obturator signs as relevant.",
            "Percuss for loss of liver dullness (perforation) and shifting dullness; auscultate for absent or exaggerated bowel sounds.",
            "Perform a digital rectal examination and, in women, a vaginal examination for cervical excitation and adnexal masses.",
          ],
        },
        {
          heading: "3. Bedside and first-line investigations",
          points: [
            "Urine pregnancy test, urine dipstick, capillary glucose and ECG in anyone over 40 with epigastric pain.",
            "Complete blood count, urea, creatinine, electrolytes, serum lipase or amylase, liver function tests and blood glucose.",
            "Erect chest radiograph for free gas under the diaphragm and supine abdominal radiograph for obstruction.",
            "Ultrasound abdomen and pelvis as first-line imaging, with contrast-enhanced CT where the diagnosis remains uncertain.",
          ],
        },
        {
          heading: "4. Criteria for referral and what to do before transfer",
          points: [
            "Transfer immediately with resuscitation en route for shock, generalised peritonitis, free gas under the diaphragm, suspected ruptured ectopic pregnancy, ruptured aortic aneurysm or mesenteric ischaemia.",
            "Transfer the same day for suspected appendicitis, cholecystitis or cholangitis, obstruction, an irreducible hernia, acute pancreatitis, and for any acute abdomen in the elderly, pregnant, diabetic or immunocompromised patient.",
            "Before transfer: nil by mouth, two intravenous cannulae with fluids, nasogastric tube if vomiting or obstructed, urinary catheter in shock, adequate analgesia, antibiotics if septic or perforated, and a written note of findings, drugs and timings.",
            "Never give purgatives or enemas to an undiagnosed acute abdomen, and never discharge one on antibiotics and analgesia without a review plan.",
            "Where observation is appropriate, it must be active - a defined review time, serial examination by the same doctor, and explicit written safety-netting instructions.",
          ],
        },
      ],
      mustDraw: [
